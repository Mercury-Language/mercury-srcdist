...
#undef	MR_PROC_LABEL
	...
	* (MR_Float *) &MR_sv(2) = (MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_tempr2));
	{
#define	MR_PROC_LABEL	mercury__fn__table_statistics__percentage_str_2_0
...
MR_def_label(fn__table_statistics__percentage_str_2_0,3)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) / MR_word_to_float(MR_r5)));
