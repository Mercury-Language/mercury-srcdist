  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&mercury__table_statistics_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__11_11 = (MR_Word) (&mercury__table_statistics_scalar_common_1[0]);
...
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_121 );
}
  mercury__io__throw_on_error_4_p_0(Var_121, (MR_String) "error writing to output file: ");
  Var_124 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__table_statistics_scalar_common_5[2]));
  mercury__string__format__format_string_component_5_p_0((MR_Word) (&mercury__table_statistics_scalar_common_5[0]), Var_124, (MR_Word) ((MR_Unsigned) 0U), LookupsStr_12, &Var_56);
  Var_126 = (MR_Box) (OutStream_5);
{
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_127 );
}
  mercury__io__throw_on_error_4_p_0(Var_127, (MR_String) "error writing to output file: ");
  Var_130 = (MR_Box) (OutStream_5);
{
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_131 );
}
  mercury__io__throw_on_error_4_p_0(Var_131, (MR_String) "error writing to output file: ");
...
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_135 );
}
    mercury__io__throw_on_error_4_p_0(Var_135, (MR_String) "error writing to output file: ");
    mercury__string__format__format_string_component_5_p_0((MR_Word) (&mercury__table_statistics_scalar_common_5[0]), Var_124, (MR_Word) ((MR_Unsigned) 0U), LookupsIsDuplStr_13, &Var_68);
    Var_140 = (MR_Box) (OutStream_5);
{
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_141 );
}
    mercury__io__throw_on_error_4_p_0(Var_141, (MR_String) "error writing to output file: ");
    Var_144 = (MR_Box) (OutStream_5);
{
#define MR_PROC_LABEL mercury__table_statistics__write_table_stats_4_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_145 );
}
    mercury__io__throw_on_error_4_p_0(Var_145, (MR_String) "error writing to output file: ");
