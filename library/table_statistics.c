  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      AddrStepDiffs_39 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1)));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__3_45, 0) = ((MR_Box) (StepDiff_14));
          MR_hl_field(MR_mktag(1), HeadVar__3_45, 1) = NULL;
        }
        AddrStepDiffs_39 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_45, (MR_Integer) 1)));
