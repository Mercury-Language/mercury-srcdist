...
#define MR_PROC_LABEL mercury__prolog__told_binary_2_p_0
	...
	NewStream = (MercuryFilePtr)Var_13 ;
		{
    ...
    MR_set_thread_local_mutable(MercuryFilePtr, NewStream,
		...
		;}
#undef MR_PROC_LABEL
	Var_17  = (MR_Box) OutStream;
}
  mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_17);
{
#define MR_PROC_LABEL mercury__prolog__told_binary_2_p_0
...
#undef MR_PROC_LABEL
  ...
  mercury__io__throw_on_error_4_p_0(Var_25, (MR_String) "error closing file: ");
}
...
#define MR_PROC_LABEL mercury__prolog__tell_binary_4_p_0
	...
	NewStream = (MercuryFilePtr)Var_18 ;
		{
