...
{
  {
    MR_Word TypeInfo_6_6 = (MR_Word) &mercury__prolog_scalar_common_2[0];
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_5_5 = (MR_Word) &mercury__prolog_scalar_common_2[0];
...
{
  {
    ...
    MR_Box Arg_13;
    MR_Integer Var_15 = (MR_Integer) ((MR_Unsigned) ArgumentIndex_4 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    MR_Box Arg_7;
    MR_Integer Var_9 = (MR_Integer) ((MR_Unsigned) ArgumentIndex_4 - (MR_Unsigned) (MR_Integer) 1);
