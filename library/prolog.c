...
{
  {
    ...
    MR_Integer mercury__prolog__Var_15 = (mercury__prolog__ArgumentIndex_4 - (MR_Integer) 1);

    {
      mercury__prolog__succeeded = mercury__deconstruct__arg_4_p_1(mercury__prolog__TypeInfo_for_T_9, &mercury__prolog__TypeInfo_12_17, mercury__prolog__Type_5, (MR_Integer) 1, mercury__prolog__Var_15, &mercury__prolog__Arg_13);
    }
...
{
  {
    ...
    MR_Integer mercury__prolog__Var_9 = (mercury__prolog__ArgumentIndex_4 - (MR_Integer) 1);

    {
      mercury__prolog__succeeded = mercury__deconstruct__arg_4_p_1(mercury__prolog__TypeInfo_for_T_11, &mercury__prolog__TypeInfo_12_12, mercury__prolog__Type_5, (MR_Integer) 1, mercury__prolog__Var_9, &mercury__prolog__Arg_7);
    }
    if (mercury__prolog__succeeded)
      {
        {
