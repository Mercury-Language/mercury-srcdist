...
#define MR_PROC_LABEL mercury__prolog__told_binary_2_p_0
    ...
    if (mercury_close(Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_15 );
}
  mercury__io__throw_on_error_4_p_0(Var_15, (MR_String) "error closing file: ");
}
  ...
  MR_Word * Argument_6)
{
  MR_bool succeeded;
  MR_Word Arg_7;
  MR_Word TypeInfo__12_14;
  MR_Box Arg_10;
  MR_Integer Var_12 = (MR_Integer) ((MR_Unsigned) ArgumentIndex_4 - (MR_Unsigned) 1);

  succeeded = mercury__deconstruct__arg_4_p_1(TypeInfo_for_T_9, &TypeInfo__12_14, Type_5, (MR_Integer) 1, Var_12, &Arg_10);
  if (succeeded)
  {
    mercury__univ__type_to_univ_2_p_1(TypeInfo__12_14, Arg_10, &Arg_7);
    succeeded = MR_TRUE;
  }
  if (succeeded)
    *Argument_6 = Arg_7;
  ...
  MR_Word * Univ_6)
{
  ...
  succeeded = mercury__deconstruct__arg_4_p_1(TypeInfo_for_T_11, &TypeInfo__12_12, Type_5, (MR_Integer) 1, Var_9, &Arg_7);
  if (succeeded)
  {
    mercury__univ__type_to_univ_2_p_1(TypeInfo__12_12, Arg_7, Univ_6);
    succeeded = MR_TRUE;
  }
  return succeeded;
}
