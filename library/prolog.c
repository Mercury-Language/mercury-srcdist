...
#define MR_PROC_LABEL mercury__prolog__told_binary_2_p_0
	...
	NewStream = (MercuryFilePtr)Var_12 ;
		{
...
#undef MR_PROC_LABEL
  ...
  mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_16);
{
#define MR_PROC_LABEL mercury__prolog__told_binary_2_p_0
...
#undef MR_PROC_LABEL
  ...
  mercury__io__throw_on_error_4_p_0(Var_21, (MR_String) "error closing file: ");
}
...
#define MR_PROC_LABEL mercury__prolog__told_2_p_0
    ...
    MR_set_thread_local_mutable(MercuryFilePtr, NewStream,
		...
		;}
#undef MR_PROC_LABEL
	Var_19  = (MR_Box) OutStream;
}
  mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_19);
{
#define MR_PROC_LABEL mercury__prolog__told_2_p_0
...
#define MR_PROC_LABEL mercury__prolog__tell_binary_4_p_0
	...
	NewStream = (MercuryFilePtr)Var_17 ;
		{
  ...
  MR_Word * Argument_6)
{
  ...
  MR_Box Arg_13;
  MR_Integer Var_15 = (MR_Integer) ((MR_Unsigned) ArgumentIndex_4 - (MR_Unsigned) 1);

  succeeded = mercury__deconstruct__arg_4_p_1(TypeInfo_for_T_9, &TypeInfo_12_17, Type_5, (MR_Integer) 1, Var_15, &Arg_13);
  if (succeeded)
  {
    mercury__univ__type_to_univ_2_p_1(TypeInfo_12_17, Arg_13, &Arg_7);
    succeeded = MR_TRUE;
  }
  if (succeeded)
    *Argument_6 = Arg_7;
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  mercury__deconstruct__deconstruct_5_p_1(TypeInfo_for_T_8, Term_3, (MR_Integer) 1, &Functor_4, &_Arity_6, &Args_5);
  {
    ...
    *HeadVar__2_2 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Functor_4));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Args_5));
  }
}
