...
static /* final */ const MR_Box mercury__version_store_scalar_common_4[1][5];
...
static const MR_Integer mercury__version_store__version_store__functor_number_map_mutvar_2[1] = { (MR_Integer) 0 };
...
static const MR_EnumFunctorDescPtr mercury__version_store__version_store__enum_ordinal_ordered_some_version_store_type_0[1] = { &mercury__version_store__version_store__enum_functor_desc_some_version_store_type_0_0 };

static const MR_EnumFunctorDescPtr mercury__version_store__version_store__enum_name_ordered_some_version_store_type_0[1] = { &mercury__version_store__version_store__enum_functor_desc_some_version_store_type_0_0 };

static const MR_Integer mercury__version_store__version_store__functor_number_map_some_version_store_type_0[1] = { (MR_Integer) 0 };
...
static const MR_Integer mercury__version_store__version_store__functor_number_map_version_store_1[1] = { (MR_Integer) 0 };
  ...
  MR_Box Value_7)
{
  ...
  mercury__version_store__set_mutvar_4_p_0(TypeInfo_for_T_9, TypeInfo_for_S_10, Mutvar_5, Value_7, VS0_6, &VS_8);
  return VS_8;
}
  ...
  MR_Word VS_5)
{
  ...
  mercury__version_store__get_mutvar_4_p_0(TypeInfo_for_T_8, TypeInfo_for_S_9, Mutvar_4, &Value_6, VS_5, &_VS_7);
  return Value_6;
}
  ...
  MR_Word * STATE_VARIABLE_VS_14)
{
  ...
  MR_Word Counter_11;
  MR_Integer Size0_12;
  MR_Word STATE_VARIABLE_VS_1_17;
  MR_Word STATE_VARIABLE_VS_2_19;
  MR_Box Var_20;
  MR_Integer Var_25;
  MR_Box VA_27;
  MR_Word _VS_24;
...
#undef MR_PROC_LABEL
    ...
    STATE_VARIABLE_VS_1_17 = (MR_Word) (VA_30);
  }
  else
    STATE_VARIABLE_VS_1_17 = STATE_VARIABLE_VS_0_13;
  mercury__version_store__set_mutvar_4_p_0((MR_Word) (&mercury__counter__counter__type_ctor_info_counter_0), TypeInfo_for_S_22, CounterMutvar_8, ((MR_Box) (Counter_11)), STATE_VARIABLE_VS_1_17, &STATE_VARIABLE_VS_2_19);
  func_1 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, F_5, 1))));
  Var_20 = func_1(((MR_Box) (F_5)), ((MR_Box) (*Mutvar_6)));
  mercury__version_store__set_mutvar_4_p_0(TypeInfo_for_T_21, TypeInfo_for_S_22, *Mutvar_6, Var_20, STATE_VARIABLE_VS_2_19, STATE_VARIABLE_VS_14);
}
  ...
  MR_Word * STATE_VARIABLE_VS_10)
{
  ...
  MR_Word Counter_21;
  MR_Integer Size0_22;
  MR_Word STATE_VARIABLE_VS_1_25;
  MR_Word STATE_VARIABLE_VS_2_27;
  MR_Integer Var_31;
  MR_Box VA_33;
  MR_Word _VS_30;
...
#undef MR_PROC_LABEL
    ...
    STATE_VARIABLE_VS_1_25 = (MR_Word) (VA_36);
  }
  else
    STATE_VARIABLE_VS_1_25 = STATE_VARIABLE_VS_0_9;
  mercury__version_store__set_mutvar_4_p_0((MR_Word) (&mercury__counter__counter__type_ctor_info_counter_0), TypeInfo_for_S_17, CounterMutvar_18, ((MR_Box) (Counter_21)), STATE_VARIABLE_VS_1_25, &STATE_VARIABLE_VS_2_27);
  mercury__version_store__set_mutvar_4_p_0(TypeInfo_for_T_16, TypeInfo_for_S_17, *Mutvar_6, X_5, STATE_VARIABLE_VS_2_27, STATE_VARIABLE_VS_10);
}
