    ...
    if (mercury__version_store__succeeded)
      *mercury__version_store__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Box mercury__version_store__Var_4 = (MR_Box) mercury__version_store__HeadVar__2_2;
        MR_Box mercury__version_store__Var_5 = (MR_Box) mercury__version_store__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0(mercury__version_store__TypeInfo_9_9, mercury__version_store__HeadVar__1_1, ((MR_Box) (mercury__version_store__Var_4)), ((MR_Box) (mercury__version_store__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__version_store__succeeded)
    ...
    else
      {
        ...
        MR_Box mercury__version_store__Var_3 = (MR_Box) mercury__version_store__HeadVar__1_1;
        MR_Box mercury__version_store__Var_4 = (MR_Box) mercury__version_store__HeadVar__2_2;

        {
          mercury__version_store__succeeded = mercury__version_array____Unify____version_array_1_0(mercury__version_store__TypeCtorInfo_8_8, mercury__version_store__Var_3, mercury__version_store__Var_4);
        }
      }
    return mercury__version_store__succeeded;
  }
...
{
  {
    ...
    if (mercury__version_store__succeeded)
      *mercury__version_store__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__version_store__Var_4 = (MR_Integer) mercury__version_store__HeadVar__2_2;
        MR_Integer mercury__version_store__Var_5 = (MR_Integer) mercury__version_store__HeadVar__3_3;

        mercury__version_store__succeeded = (mercury__version_store__Var_4 < mercury__version_store__Var_5);
        if (mercury__version_store__succeeded)
...
{
  {
    ...
    if (mercury__version_store__succeeded)
      ...
      {
        MR_Integer mercury__version_store__Var_3 = (MR_Integer) mercury__version_store__HeadVar__1_1;
        MR_Integer mercury__version_store__Var_4 = (MR_Integer) mercury__version_store__HeadVar__2_2;

        mercury__version_store__succeeded = (mercury__version_store__Var_3 == mercury__version_store__Var_4);
      }
    return mercury__version_store__succeeded;
  }
}
