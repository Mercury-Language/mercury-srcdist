  ...
  MR_Box * STATE_VARIABLE_A_14)
{
  ...
  if (succeeded)
  {
    ...
    mercury__list__filter_map_foldl_5_p_0(TypeInfo_for_T1_16, TypeInfo_for_T2_17, TypeInfo_for_A_18, P_6, T_8, &PHsTail_12, STATE_VARIABLE_A_15_15, STATE_VARIABLE_A_14);
    {
      MR_Word base;
