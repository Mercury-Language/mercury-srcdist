...
{
  uint16_t B_4;
  uint16_t STATE_VARIABLE_A_1_6;
  uint16_t Var_7;
  uint16_t Var_8;
  uint16_t Var_9 = ~(UINT16_C(21845));
  uint16_t Var_12;
  uint16_t Var_13;
  uint16_t STATE_VARIABLE_A_2_16;
  uint16_t Var_17;
  uint16_t Var_18;
  uint16_t Var_19;
  uint16_t Var_22;
  uint16_t Var_23;
  uint16_t STATE_VARIABLE_A_3_26;
  uint16_t Var_27;
  uint16_t Var_28;
  uint16_t Var_29;
  uint16_t Var_32;
  ...
  STATE_VARIABLE_A_1_6 = (Var_7 | Var_12);
  Var_19 = ~(UINT16_C(13107));
  Var_18 = (Var_19 & STATE_VARIABLE_A_1_6);
  Var_17 = mercury__uint16__f_62_62_2_f_0(Var_18, (MR_Integer) 2);
  Var_23 = (UINT16_C(13107) & STATE_VARIABLE_A_1_6);
  Var_22 = mercury__uint16__f_60_60_2_f_0(Var_23, (MR_Integer) 2);
  STATE_VARIABLE_A_2_16 = (Var_17 | Var_22);
  Var_29 = ~(UINT16_C(3855));
  Var_28 = (Var_29 & STATE_VARIABLE_A_2_16);
  Var_27 = mercury__uint16__f_62_62_2_f_0(Var_28, (MR_Integer) 4);
  Var_33 = (UINT16_C(3855) & STATE_VARIABLE_A_2_16);
  Var_32 = mercury__uint16__f_60_60_2_f_0(Var_33, (MR_Integer) 4);
  STATE_VARIABLE_A_3_26 = (Var_27 | Var_32);
  Var_39 = ~(UINT16_C(255));
  Var_38 = (Var_39 & STATE_VARIABLE_A_3_26);
  Var_37 = mercury__uint16__f_62_62_2_f_0(Var_38, (MR_Integer) 8);
  Var_43 = (UINT16_C(255) & STATE_VARIABLE_A_3_26);
...
uint16_t MR_CALL 
mercury__uint16__clamp_3_f_0(
  uint16_t Min_5,
  uint16_t Max_6,
  uint16_t N_7)
{
  MR_bool succeeded = (Max_6 >= Min_5);
  uint16_t HeadVar__4_4;
  ...
  else
  {
    ...
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint16_0), (MR_String) "function \140uint16.clamp\'/3", (MR_String) "Max < Min");
    HeadVar__4_4 = ((uint16_t) (MR_Word) conv0_HeadVar__4_4);
  }
  return HeadVar__4_4;
}
