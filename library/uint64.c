...
static /* final */ const MR_Box mercury__uint64_scalar_common_3[1][5];
...
MR_bool MR_CALL 
mercury__uint64__unchecked_bit_is_clear_2_p_0(
  uint64_t U_3,
  MR_Unsigned I_4)
{
  MR_bool succeeded;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_bit_is_clear_2_p_0
...
#undef MR_PROC_LABEL
  ...
  Var_6 = (UINT64_C(1) << Var_8);
  Var_5 = (U_3 & Var_6);
  succeeded = (Var_5 == UINT64_C(0));
  return succeeded;
}

MR_bool MR_CALL 
mercury__uint64__bit_is_clear_2_p_0(
  uint64_t U_3,
  MR_Unsigned I_4)
{
  MR_bool succeeded = (I_4 < (MR_Unsigned) 64U);
...
{
#define MR_PROC_LABEL mercury__uint64__bit_is_clear_2_p_0
...
#undef MR_PROC_LABEL
    ...
    Var_9 = (UINT64_C(1) << Var_11);
    Var_8 = (U_3 & Var_9);
    succeeded = (Var_8 == UINT64_C(0));
  }
  else
  {
    mercury__require__error_2_p_0((MR_String) "predicate \140uint64.bit_is_clear\'/2", (MR_String) "bit index exceeds 63 bits");
    succeeded = MR_TRUE;
  }
  return succeeded;
}
...
MR_bool MR_CALL 
mercury__uint64__unchecked_bit_is_set_2_p_0(
  uint64_t U_3,
  MR_Unsigned I_4)
{
  MR_bool succeeded;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_bit_is_set_2_p_0
...
MR_bool MR_CALL 
mercury__uint64__bit_is_set_2_p_0(
  uint64_t U_3,
  MR_Unsigned I_4)
{
  MR_bool succeeded = (I_4 < (MR_Unsigned) 64U);
...
{
#define MR_PROC_LABEL mercury__uint64__bit_is_set_2_p_0
...
#undef MR_PROC_LABEL
  ...
  {
    mercury__require__error_2_p_0((MR_String) "predicate \140uint64.bit_is_set\'/2", (MR_String) "bit index exceeds 63 bits");
    succeeded = MR_TRUE;
  }
  return succeeded;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_flip_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_flip_bit_2_f_0
...
uint64_t MR_CALL 
mercury__uint64__flip_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
  MR_bool succeeded = (I_5 < (MR_Unsigned) 64U);
  uint64_t HeadVar__3_3;
...
{
#define MR_PROC_LABEL mercury__uint64__flip_bit_2_f_0
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    conv0_HeadVar__3_3 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.flip_bit\'/2", (MR_String) "bit index exceeds 63 bits");
    HeadVar__3_3 = MR_unbox_uint64(conv0_HeadVar__3_3);
  }
  return HeadVar__3_3;
}

uint64_t MR_CALL 
mercury__uint64__unchecked_clear_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
  uint64_t HeadVar__3_3;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_clear_bit_2_f_0
...
uint64_t MR_CALL 
mercury__uint64__clear_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
  MR_bool succeeded = (I_5 < (MR_Unsigned) 64U);
...
{
#define MR_PROC_LABEL mercury__uint64__clear_bit_2_f_0
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    conv0_HeadVar__3_3 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.clear_bit\'/2", (MR_String) "bit index exceeds 63 bits");
    HeadVar__3_3 = MR_unbox_uint64(conv0_HeadVar__3_3);
  }
  return HeadVar__3_3;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_set_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
  uint64_t HeadVar__3_3;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_set_bit_2_f_0
...
uint64_t MR_CALL 
mercury__uint64__set_bit_2_f_0(
  uint64_t U_4,
  MR_Unsigned I_5)
{
  MR_bool succeeded = (I_5 < (MR_Unsigned) 64U);
...
{
#define MR_PROC_LABEL mercury__uint64__set_bit_2_f_0
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    conv0_HeadVar__3_3 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.set_bit\'/2", (MR_String) "bit index exceeds 63 bits");
    HeadVar__3_3 = MR_unbox_uint64(conv0_HeadVar__3_3);
  }
  return HeadVar__3_3;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_rotate_right_2_f_0(
  uint64_t X_1,
  MR_Unsigned N_2)
{
  uint64_t Result_3;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_rotate_right_2_f_0
...
uint64_t MR_CALL 
mercury__uint64__rotate_right_2_f_0(
  uint64_t X_4,
  MR_Unsigned N_5)
{
  MR_bool succeeded = (N_5 < (MR_Unsigned) 64U);
  uint64_t HeadVar__3_3;

  if (succeeded)
  {
{
#define MR_PROC_LABEL mercury__uint64__rotate_right_2_f_0
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    conv0_HeadVar__3_3 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.rotate_right\'/2", (MR_String) "rotate amount exceeds 63 bits");
    HeadVar__3_3 = MR_unbox_uint64(conv0_HeadVar__3_3);
  }
  return HeadVar__3_3;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_rotate_left_2_f_0(
  uint64_t X_1,
  MR_Unsigned N_2)
{
  uint64_t Result_3;
...
{
#define MR_PROC_LABEL mercury__uint64__unchecked_rotate_left_2_f_0
...
uint64_t MR_CALL 
mercury__uint64__rotate_left_2_f_0(
  uint64_t X_4,
  MR_Unsigned N_5)
{
  MR_bool succeeded = (N_5 < (MR_Unsigned) 64U);
  ...
  {
{
#define MR_PROC_LABEL mercury__uint64__rotate_left_2_f_0
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    conv0_HeadVar__3_3 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.rotate_left\'/2", (MR_String) "rotate amount exceeds 63 bits");
    HeadVar__3_3 = MR_unbox_uint64(conv0_HeadVar__3_3);
  }
  return HeadVar__3_3;
}
...
{
  uint64_t B_4;
  uint64_t STATE_VARIABLE_A_1_6;
  uint64_t Var_7;
  uint64_t Var_8 = (STATE_VARIABLE_A_0_5 & UINT64_C(6148914691236517205));
  uint64_t Var_11;
  uint64_t Var_12;
  uint64_t STATE_VARIABLE_A_2_15;
  uint64_t Var_16;
  uint64_t Var_17;
  uint64_t Var_20;
  uint64_t Var_21;
  uint64_t STATE_VARIABLE_A_3_24;
  uint64_t Var_25;
  uint64_t Var_26;
  uint64_t Var_29;
  uint64_t Var_30;
  uint64_t STATE_VARIABLE_A_4_33;
  uint64_t Var_34;
  uint64_t Var_35;
  uint64_t Var_38;
  uint64_t Var_39;
  ...
  Var_17 = (STATE_VARIABLE_A_1_6 & UINT64_C(3689348814741910323));
  Var_16 = mercury__uint64__f_60_60_2_f_0(Var_17, (MR_Integer) 2);
  Var_21 = mercury__uint64__f_62_62_2_f_0(STATE_VARIABLE_A_1_6, (MR_Integer) 2);
  Var_20 = (Var_21 & UINT64_C(3689348814741910323));
  STATE_VARIABLE_A_2_15 = (Var_16 | Var_20);
  Var_26 = (STATE_VARIABLE_A_2_15 & UINT64_C(1085102592571150095));
  Var_25 = mercury__uint64__f_60_60_2_f_0(Var_26, (MR_Integer) 4);
  Var_30 = mercury__uint64__f_62_62_2_f_0(STATE_VARIABLE_A_2_15, (MR_Integer) 4);
  Var_29 = (Var_30 & UINT64_C(1085102592571150095));
  STATE_VARIABLE_A_3_24 = (Var_25 | Var_29);
  Var_35 = (STATE_VARIABLE_A_3_24 & UINT64_C(71777214294589695));
  Var_34 = mercury__uint64__f_60_60_2_f_0(Var_35, (MR_Integer) 8);
  Var_39 = mercury__uint64__f_62_62_2_f_0(STATE_VARIABLE_A_3_24, (MR_Integer) 8);
  Var_38 = (Var_39 & UINT64_C(71777214294589695));
  STATE_VARIABLE_A_4_33 = (Var_34 | Var_38);
  Var_45 = mercury__uint64__f_60_60_2_f_0(STATE_VARIABLE_A_4_33, (MR_Integer) 48);
  Var_48 = (STATE_VARIABLE_A_4_33 & UINT64_C(4294901760));
  Var_47 = mercury__uint64__f_60_60_2_f_0(Var_48, (MR_Integer) 16);
  Var_44 = (Var_45 | Var_47);
  Var_52 = mercury__uint64__f_62_62_2_f_0(STATE_VARIABLE_A_4_33, (MR_Integer) 16);
  Var_51 = (Var_52 & UINT64_C(4294901760));
  Var_43 = (Var_44 | Var_51);
  Var_55 = mercury__uint64__f_62_62_2_f_0(STATE_VARIABLE_A_4_33, (MR_Integer) 48);
  B_4 = (Var_43 | Var_55);
  return B_4;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_right_ushift_2_f_0(
  uint64_t HeadVar__1_1,
  MR_Unsigned HeadVar__2_2)
{
  uint64_t HeadVar__3_3 = (HeadVar__1_1 >> (int) HeadVar__2_2);
...
uint64_t MR_CALL 
mercury__uint64__f_62_62_117_2_f_0(
  uint64_t X_4,
  MR_Unsigned Y_5)
{
  ...
  if (succeeded)
    ...
    mercury__exception__throw_1_p_0((MR_Word) (&mercury__exception__exception__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "uint64.(>>u): second operand is out of range")))));
  return Result_6;
}
...
uint64_t MR_CALL 
mercury__uint64__unchecked_left_ushift_2_f_0(
  uint64_t HeadVar__1_1,
  MR_Unsigned HeadVar__2_2)
{
  uint64_t HeadVar__3_3 = (HeadVar__1_1 << (int) HeadVar__2_2);
...
uint64_t MR_CALL 
mercury__uint64__f_60_60_117_2_f_0(
  uint64_t X_4,
  MR_Unsigned Y_5)
{
  MR_bool succeeded = (Y_5 < (MR_Unsigned) 64U);
...
uint64_t MR_CALL 
mercury__uint64__clamp_3_f_0(
  uint64_t Min_5,
  uint64_t Max_6,
  uint64_t N_7)
{
  MR_bool succeeded = (Max_6 >= Min_5);
  uint64_t HeadVar__4_4;
  ...
  else
  {
    ...
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint64_0), (MR_String) "function \140uint64.clamp\'/3", (MR_String) "Max < Min");
    HeadVar__4_4 = MR_unbox_uint64(conv0_HeadVar__4_4);
  }
  return HeadVar__4_4;
}
...
uint64_t MR_CALL 
mercury__uint64__cast_from_uint8_1_f_0(
  uint8_t U8_1)
{
  uint64_t U64_2;

{
#define MR_PROC_LABEL mercury__uint64__cast_from_uint8_1_f_0
...
uint8_t MR_CALL 
mercury__uint64__cast_to_uint8_1_f_0(
  uint64_t U64_1)
{
  uint8_t U8_2;

{
#define MR_PROC_LABEL mercury__uint64__cast_to_uint8_1_f_0
...
MR_Integer MR_CALL 
mercury__uint64__det_to_int_1_f_0(
  uint64_t U64_3)
{
  MR_bool succeeded;
  MR_Integer I_4;
...
{
#define MR_PROC_LABEL mercury__uint64__det_to_int_1_f_0
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
    ...
    mercury__require__error_2_p_0((MR_String) "function \140uint64.det_to_int\'/1", (MR_String) "cannot convert uint64 to int");
  return I_4;
}

MR_bool MR_CALL 
mercury__uint64__to_int_2_p_0(
  uint64_t U64_1,
  MR_Integer * I_2)
{
  MR_bool succeeded;
...
{
#define MR_PROC_LABEL mercury__uint64__to_int_2_p_0
...
uint64_t MR_CALL 
mercury__uint64__cast_from_uint_1_f_0(
  MR_Unsigned U_1)
{
  uint64_t U64_2;

{
#define MR_PROC_LABEL mercury__uint64__cast_from_uint_1_f_0
