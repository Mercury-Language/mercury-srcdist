...
MR_decl_label2(__Unify___thread__channel__channel_1_0, 2,1)
MR_decl_label2(__Unify___thread__channel__item_1_0, 2,1)
MR_decl_label2(__Compare___thread__channel__channel_1_0, 3,7)
MR_decl_label2(__Compare___thread__channel__item_1_0, 3,7)
...
MR_BEGIN_MODULE(thread__channel_module5)
	...
	MR_init_label2(__Unify___thread__channel__channel_1_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___thread__channel__channel_1_0);
	...
	MR_np_call_localret_ent(__Unify___thread__mvar__mvar_1_0,
		__Unify___thread__channel__channel_1_0_i2);
MR_def_label(__Unify___thread__channel__channel_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(thread__channel_module6)
	...
	MR_init_label2(__Compare___thread__channel__channel_1_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___thread__channel__channel_1_0);
	...
	MR_np_call_localret_ent(__Compare___thread__mvar__mvar_1_0,
		__Compare___thread__channel__channel_1_0_i3);
MR_def_label(__Compare___thread__channel__channel_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__channel__channel_1_0_i7);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(thread__channel_module7)
	...
	MR_init_label2(__Unify___thread__channel__item_1_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___thread__channel__item_1_0);
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___thread__channel__item_1_0_i2);
MR_def_label(__Unify___thread__channel__item_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(thread__channel_module8)
	...
	MR_init_label2(__Compare___thread__channel__item_1_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___thread__channel__item_1_0);
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___thread__channel__item_1_0_i3);
MR_def_label(__Compare___thread__channel__item_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__channel__item_1_0_i7);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_CTOR1_ADDR(thread__channel, item);
	MR_tfield(0, MR_r1, 1) = MR_sv(3);
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(__Compare___thread__mvar__mvar_1_0);
MR_def_label(__Compare___thread__channel__item_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
