...
#line 27 "thread.channel.c"
#line 532 "io.int"
#include "io.mh"

#line 31 "thread.channel.c"
#line 540 "io.int"
#include "string.mh"

#line 35 "thread.channel.c"
#line 29 "bitmap.int2"
#include "bitmap.mh"

#line 39 "thread.channel.c"
#line 28 "time.int2"
#include "time.mh"

#line 43 "thread.channel.c"
#line 4 "builtin.opt"
#include "builtin.mh"

#line 47 "thread.channel.c"
#line 37 "builtin.opt"
#include "array.mh"

#line 51 "thread.channel.c"
#line 46 "array.opt"
#include "stm_builtin.mh"

#line 55 "thread.channel.c"
#line 14 "exception.opt"
#include "exception.mh"

#line 59 "thread.channel.c"
#line 23 "store.opt"
#include "store.mh"

#line 63 "thread.channel.c"
#line 12 "pretty_printer.opt"
#include "pretty_printer.mh"

#line 67 "thread.channel.c"
#line 3 "float.opt"
#include "float.mh"

#line 71 "thread.channel.c"
#line 3 "math.opt"
#include "math.mh"

#line 75 "thread.channel.c"
#line 4 "char.opt"
#include "char.mh"

#line 79 "thread.channel.c"
#line 3 "construct.opt"
#include "construct.mh"

#line 83 "thread.channel.c"
#line 3 "list.opt"
#include "list.mh"

#line 87 "thread.channel.c"
#line 6 "type_desc.opt"
#include "type_desc.mh"

#line 91 "thread.channel.c"
#line 4 "int.opt"
#include "int.mh"
...
#line 111 "thread.channel.c"
#line 7 "thread.semaphore.opt"
...
MR_decl_label4(thread__channel__duplicate_4_0, 2,3,4,5)
MR_decl_label5(thread__channel__init_3_0, 2,3,4,5,6)
MR_decl_label3(thread__channel__put_4_0, 2,3,4)
MR_decl_label3(thread__channel__take_4_0, 2,3,4)
MR_decl_label4(thread__channel__try_take_4_0, 2,3,5,6)
MR_decl_label3(thread__channel__untake_4_0, 2,3,4)
MR_decl_label3(__Unify___thread__channel__channel_1_0, 4,8,1)
MR_decl_label3(__Unify___thread__channel__item_1_0, 4,8,1)
MR_decl_label4(__Compare___thread__channel__channel_1_0, 3,2,5,21)
MR_decl_label4(__Compare___thread__channel__item_1_0, 3,2,5,21)
...
MR_BEGIN_MODULE(thread__channel_module0)
	...
	MR_init_label5(thread__channel__init_3_0,2,3,4,5,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__init_3_0);
	...
	MR_r1 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_CTOR1_ADDR(thread__mvar, mvar);
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_sv(4) = MR_tempr2;
	}
	MR_np_call_localret_ent(thread__mvar__init_3_0,
		thread__channel__init_3_0_i2);
MR_def_label(thread__channel__init_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(thread__mvar__init_3_0,
		thread__channel__init_3_0_i3);
MR_def_label(thread__channel__init_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(thread__channel__init_3_0,5)
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__init_3_0_i6);
MR_def_label(thread__channel__init_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(thread__channel_module1)
	...
	MR_init_label3(thread__channel__put_4_0,2,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__put_4_0);
	...
	MR_np_call_localret_ent(thread__mvar__init_3_0,
		thread__channel__put_4_0_i2);
MR_def_label(thread__channel__put_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(thread__channel__put_4_0,3)
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__put_4_0_i4);
MR_def_label(thread__channel__put_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(thread__channel_module2)
	...
	MR_init_label3(thread__channel__take_4_0,2,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__take_4_0);
	...
	MR_np_call_localret_ent(thread__mvar__take_4_0,
		thread__channel__take_4_0_i2);
MR_def_label(thread__channel__take_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(thread__mvar__take_4_0,
		thread__channel__take_4_0_i3);
MR_def_label(thread__channel__take_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(thread__channel_module3)
	...
	MR_init_label4(thread__channel__try_take_4_0,2,3,5,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__try_take_4_0);
	...
	MR_np_call_localret_ent(thread__mvar__take_4_0,
		thread__channel__try_take_4_0_i2);
MR_def_label(thread__channel__try_take_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_ctfield(0, MR_sv(3), 1);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(thread__mvar__try_take_4_0,
		thread__channel__try_take_4_0_i3);
MR_def_label(thread__channel__try_take_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(thread__channel__try_take_4_0_i5);
	}
	MR_r2 = MR_sv(1);
	...
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__try_take_4_0_i6);
MR_def_label(thread__channel__try_take_4_0,5)
	...
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__try_take_4_0_i6);
MR_def_label(thread__channel__try_take_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(thread__channel_module4)
	...
	MR_init_label4(thread__channel__duplicate_4_0,2,3,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__duplicate_4_0);
	...
	MR_np_call_localret_ent(thread__mvar__init_3_0,
		thread__channel__duplicate_4_0_i2);
MR_def_label(thread__channel__duplicate_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(thread__mvar__take_4_0,
		thread__channel__duplicate_4_0_i3);
MR_def_label(thread__channel__duplicate_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
...
MR_def_label(thread__channel__duplicate_4_0,4)
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__duplicate_4_0_i5);
MR_def_label(thread__channel__duplicate_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(thread__channel_module5)
	...
	MR_init_label3(thread__channel__untake_4_0,2,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__thread__channel__untake_4_0);
	...
	MR_np_call_localret_ent(thread__mvar__init_3_0,
		thread__channel__untake_4_0_i2);
MR_def_label(thread__channel__untake_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(thread__channel__untake_4_0,3)
	...
	MR_np_call_localret_ent(thread__mvar__put_4_0,
		thread__channel__untake_4_0_i4);
MR_def_label(thread__channel__untake_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(thread__channel_module6)
	...
	MR_init_label3(__Unify___thread__channel__channel_1_0,4,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___thread__channel__channel_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Unify___thread__channel__channel_1_0_i8);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(__Unify___thread__mvar__mvar_1_0,
		__Unify___thread__channel__channel_1_0_i4);
MR_def_label(__Unify___thread__channel__channel_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(__Unify___thread__channel__channel_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(thread__channel_module7)
	...
	MR_init_label4(__Compare___thread__channel__channel_1_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___thread__channel__channel_1_0,2)
	...
	MR_r1 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_CTOR1_ADDR(thread__mvar, mvar);
	...
	MR_np_call_localret_ent(__Compare___thread__mvar__mvar_1_0,
		__Compare___thread__channel__channel_1_0_i5);
MR_def_label(__Compare___thread__channel__channel_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__channel__channel_1_0_i21);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(__Compare___thread__channel__channel_1_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(thread__channel_module8)
	...
	MR_init_label3(__Unify___thread__channel__item_1_0,4,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___thread__channel__item_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Unify___thread__channel__item_1_0_i8);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(__Unify___thread__channel__item_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(thread__channel_module9)
	...
	MR_init_label4(__Compare___thread__channel__item_1_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___thread__channel__item_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__channel__item_1_0_i21);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(__Compare___thread__channel__item_1_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
