  ...
  MR_Word * HeadVar__2_2)
{
  ...
  MR_Word TypeInfo_19_19;
  MR_Word Write_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 1))));
  MR_Word NewRead_7;
  MR_Word Hole_9;
  ...
  MR_Word * MaybeVal_7)
{
  ...
  {
    MR_Box Val_11;
    MR_Word Var_17 = ((MR_Word) ((MR_hl_field(1, MaybeItem_10, (MR_Integer) 0))));

    Val_11 = (MR_hl_field(0, Var_17, (MR_Integer) 0));
    NewHead_12 = ((MR_Word) ((MR_hl_field(0, Var_17, (MR_Integer) 1))));
    {
      MR_Word base;
  ...
  MR_Box * Val_7)
{
  ...
  *Val_7 = (MR_hl_field(0, Var_14, (MR_Integer) 0));
  NewHead_10 = ((MR_Word) ((MR_hl_field(0, Var_14, (MR_Integer) 1))));
