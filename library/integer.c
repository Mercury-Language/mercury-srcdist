    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer__digits_to_strings_4_p_0(Base_5, Tail_31, (MR_Word) ((MR_Unsigned) 0U), &TailStrs_33);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (HeadStr_32));
          MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) (TailStrs_33));
        }
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__integer__digits_to_strings_4_p_0(Base_5, Tail_62, (MR_Word) ((MR_Unsigned) 0U), &TailStrs_64);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (HeadStr_63));
        MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (TailStrs_64));
      }
      ...
      Ua_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 0))));
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (Var_69));
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                {
                  Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_46));
          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                {
                  Var_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (Var_61));
                  MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (Var_63));
                }
              }
