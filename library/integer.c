...
MR_decl_label8(fn__integer__big_plus_2_0, 4,2,3,8,6,7,10,11)
MR_decl_label8(fn__integer__big_plus_2_0, 12,13,15,16,17,18,14,22)
MR_decl_label8(fn__integer__big_plus_2_0, 25,26,27,30,28,23,35,36)
MR_decl_label4(fn__integer__big_plus_2_0, 37,40,38,33)
MR_decl_label8(fn__integer__big_pow_2_0, 4,2,3,8,6,7,12,10)
MR_decl_label6(fn__integer__big_pow_2_0, 11,16,14,15,20,18)
...
MR_decl_label1(__Unify___integer__integer_0_0, 1)
MR_decl_label2(__Compare___integer__digit_0_0, 2,3)
MR_decl_label4(__Compare___integer__integer_0_0, 4,5,7,11)
...
MR_BEGIN_MODULE(integer_module18)
	...
	MR_init_label8(fn__integer__big_plus_2_0,4,2,3,8,6,7,10,11)
	MR_init_label8(fn__integer__big_plus_2_0,12,13,15,16,17,18,14,22)
	MR_init_label8(fn__integer__big_plus_2_0,25,26,27,30,28,23,35,36)
	MR_init_label4(fn__integer__big_plus_2_0,37,40,38,33)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__integer__big_plus_2_0);
	...
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__integer__big_plus_2_0_i3);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(fn__integer__big_plus_2_0,3)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__integer__big_plus_2_0_i7);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tempr2;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
...
MR_def_label(fn__integer__big_plus_2_0,6)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
MR_def_label(fn__integer__big_plus_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(fn__integer__big_plus_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__integer__big_plus_2_0_i28);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = MR_r3;
	MR_tfield(0, MR_r1, 1) = MR_r2;
	MR_np_call_localret_ent(fn__integer__decap_1_0,
		fn__integer__big_plus_2_0_i30);
...
MR_def_label(fn__integer__big_plus_2_0,35)
	...
	MR_r3 = MR_sv(1);
	MR_GOTO_LAB(fn__integer__big_plus_2_0_i37);
...
MR_def_label(fn__integer__big_plus_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__integer__big_plus_2_0_i38);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = MR_r3;
	MR_tfield(0, MR_r1, 1) = MR_r2;
	MR_np_call_localret_ent(fn__integer__decap_1_0,
		fn__integer__big_plus_2_0_i40);
MR_def_label(fn__integer__big_plus_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_succip_word = MR_sv(5);
...
MR_BEGIN_MODULE(integer_module90)
	...
	MR_init_label8(fn__integer__big_pow_2_0,4,2,3,8,6,7,12,10)
	MR_init_label6(fn__integer__big_pow_2_0,11,16,14,15,20,18)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__integer__big_pow_2_0);
	...
	MR_tempr1 = MR_ctfield(0, MR_tempr2, 0);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__integer__big_pow_2_0_i3);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tempr2;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
...
MR_def_label(fn__integer__big_pow_2_0,3)
	...
	MR_tempr1 = MR_ctfield(0, MR_tempr2, 0);
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__integer__big_pow_2_0_i7);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tempr2;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
...
MR_def_label(fn__integer__big_pow_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__integer__big_pow_2_0_i10);
	}
	MR_r1 = MR_sv(3);
	MR_decr_sp_and_return(4);
...
MR_def_label(fn__integer__big_pow_2_0,11)
	...
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__integer__big_pow_2_0_i15);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_def_label(fn__integer__big_pow_2_0,14)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
MR_def_label(fn__integer__big_pow_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(integer_module98)
	...
	MR_init_label1(__Unify___integer__integer_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(integer_module99)
	...
	MR_init_label4(__Compare___integer__integer_0_0,4,5,7,11)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___integer__integer_0_0);
	...
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___integer__integer_0_0_i4);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___integer__integer_0_0_i7);
	}
MR_def_label(__Compare___integer__integer_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
		MR_GOTO_LAB(__Compare___integer__integer_0_0_i5);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___integer__integer_0_0_i7);
MR_def_label(__Compare___integer__integer_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___integer__integer_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___integer__integer_0_0_i11);
	}
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___integer__integer_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
