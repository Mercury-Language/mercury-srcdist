  ...
  MR_Word * STATE_VARIABLE_Strs_4)
{
  ...
  else
  {
    ...
    AddrSTATE_VARIABLE_Strs_16_20 = (MR_Word *) (&(MR_hl_field(1, *STATE_VARIABLE_Strs_4, 1)));
  ...
  MR_Word * AddrOfSTATE_VARIABLE_Strs_21)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      AddrSTATE_VARIABLE_Strs_16_20 = (MR_Word *) (&(MR_hl_field(1, STATE_VARIABLE_Strs_22, 1)));
