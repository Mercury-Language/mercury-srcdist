...
{
  {
    ...
    if (mercury__integer__succeeded)
      *mercury__integer__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__integer__Var_4 = (MR_Integer) mercury__integer__HeadVar__2_2;
        MR_Integer mercury__integer__Var_5 = (MR_Integer) mercury__integer__HeadVar__3_3;

        mercury__integer__succeeded = (mercury__integer__Var_4 < mercury__integer__Var_5);
        if (mercury__integer__succeeded)
          *mercury__integer__HeadVar__1_1 = (MR_Integer) 1;
        else
          {
...
{
  {
    ...
    if (mercury__integer__succeeded)
      ...
      {
        MR_Integer mercury__integer__Var_3 = (MR_Integer) mercury__integer__HeadVar__1_1;
        MR_Integer mercury__integer__Var_4 = (MR_Integer) mercury__integer__HeadVar__2_2;

        mercury__integer__succeeded = (mercury__integer__Var_3 == mercury__integer__Var_4);
      }
    return mercury__integer__succeeded;
  }
}
...
{
  {
    ...
    if (mercury__integer__succeeded)
      *mercury__integer__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__integer__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__integer__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer mercury__integer__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mercury__integer__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mercury__integer__Var_8;

        mercury__integer__succeeded = (mercury__integer__Var_4 < mercury__integer__Var_6);
        if (mercury__integer__succeeded)
        ...
        if (mercury__integer__succeeded)
          *mercury__integer__HeadVar__1_1 = mercury__integer__Var_8;
        else
          {
            ...
            {
              mercury__builtin__compare_3_p_0(mercury__integer__TypeInfo_12_12, mercury__integer__HeadVar__1_1, ((MR_Box) (mercury__integer__Var_5)), ((MR_Box) (mercury__integer__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (mercury__integer__succeeded)
    ...
    else
      {
        ...
        MR_Integer mercury__integer__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__integer__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__integer__HeadVar__2_2, (MR_Integer) 1)));

        mercury__integer__succeeded = (mercury__integer__Var_3 == mercury__integer__Var_5);
        if (mercury__integer__succeeded)
          {
            mercury__integer__TypeInfo_9_9 = (MR_Word) &mercury__integer_scalar_common_1[0];
            {
              mercury__integer__succeeded = mercury__builtin__unify_2_p_0(mercury__integer__TypeInfo_9_9, ((MR_Box) (mercury__integer__Var_4)), ((MR_Box) (mercury__integer__Var_6)));
            }
          }
      }
    return mercury__integer__succeeded;
...
{
  {
    ...
    {
      mercury__integer____Compare____integer_0_0(&mercury__integer__Var_61, mercury__integer__Ur_6, mercury__integer__V_8);
    }
    mercury__integer__succeeded = ((MR_Integer) 1 == mercury__integer__Var_61);
    if (mercury__integer__succeeded)
      {
        ...
        if (mercury__integer__succeeded)
          {
            ...
            mercury__integer__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__integer__Var_24, (MR_Integer) 1)));
            {
              ...
              MR_Integer mercury__integer__Var_70 = (mercury__integer__L_67 + (MR_Integer) 1);
              MR_Word mercury__integer__Var_72;
              MR_Word mercury__integer__Var_73 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              ...
              MR_Integer mercury__integer__Var_88;
              MR_Word mercury__integer__Var_90;

              {
                mercury__integer__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__integer__Var_72, 0) = ((MR_Box) (mercury__integer__Ua_12));
                MR_hl_field(MR_mktag(1), mercury__integer__Var_72, 1) = ((MR_Box) (mercury__integer__Var_73));
              }
              mercury__integer__TypeCtorInfo_12_74 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
              {
                mercury__list__append_3_p_1(mercury__integer__TypeCtorInfo_12_74, mercury__integer__List_68, mercury__integer__Var_72, &mercury__integer__NewList_69);
              }
              {
                mercury__integer__Var_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), mercury__integer__Var_25, 0) = ((MR_Box) (mercury__integer__Var_70));
                MR_hl_field(MR_mktag(0), mercury__integer__Var_25, 1) = ((MR_Box) (mercury__integer__NewList_69));
              }
              ...
              if ((mercury__integer__Digits_77 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              else
                {
                  ...
                  MR_Integer mercury__integer__Var_78 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__integer__Digits_77, (MR_Integer) 0)));

                  {
                    mercury__integer__Var_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), mercury__integer__Var_26, 0) = ((MR_Box) (mercury__integer__Var_80));
                    MR_hl_field(MR_mktag(0), mercury__integer__Var_26, 1) = ((MR_Box) (mercury__integer__T_79));
                  }
                }
              {
              ...
              mercury__integer__Var_88 = (mercury__integer__L_86 + (MR_Integer) 1);
              {
                mercury__integer__Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__integer__Var_90, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(1), mercury__integer__Var_90, 1) = ((MR_Box) (mercury__integer__List_87));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                *mercury__integer__Quot_9 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (mercury__integer__Var_88));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (mercury__integer__Var_90));
              }
            }
          }
        else
    ...
    else
      {
        ...
        MR_Word mercury__integer__Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__integer__Ur_6, (MR_Integer) 1)));
        MR_Word mercury__integer__Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__integer__V_8, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        MR_bool mercury__integer__succeeded;
        MR_Word mercury__integer__Result_6;
        MR_Unsigned mercury__integer__Var_18;
...
#define MR_PROC_LABEL mercury__integer__uint_to_digits_2_2_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_18  = U;
}
        mercury__integer__succeeded = (mercury__integer__U_4 == mercury__integer__Var_18);
        if (mercury__integer__succeeded)
        ...
        else
          {
            ...
            MR_Word mercury__integer__Var_15;
            MR_Integer mercury__integer__Var_16;
            MR_Unsigned mercury__integer__Var_23;
...
#define MR_PROC_LABEL mercury__integer__uint_to_digits_2_2_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_23  = U;
}
            mercury__integer__Mod_10 = (mercury__integer__U_4 & mercury__integer__Var_23);
            mercury__integer__Var_13 = (mercury__integer__Length_7 + (MR_Integer) 1);
{
#define MR_PROC_LABEL mercury__integer__uint_to_digits_2_2_f_0
    ...
    I = (MR_Integer) U;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_16  = I;
}
            {
              mercury__integer__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__integer__Var_15, 0) = ((MR_Box) (mercury__integer__Var_16));
              MR_hl_field(MR_mktag(1), mercury__integer__Var_15, 1) = ((MR_Box) (mercury__integer__Digits_8));
            }
            {
              mercury__integer__Var_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), mercury__integer__Var_12, 0) = ((MR_Box) (mercury__integer__Var_13));
              MR_hl_field(MR_mktag(0), mercury__integer__Var_12, 1) = ((MR_Box) (mercury__integer__Var_15));
            }
            /* direct tailcall eliminated */
            {
              MR_Unsigned mercury__integer__next_value_of_U_4 = mercury__integer__Div_9;
              MR_Word mercury__integer__next_value_of_Tail_5 = mercury__integer__Var_12;
...
{
  {
    ...
    MR_Unsigned mercury__integer__Var_10;
    MR_Integer mercury__integer__Var_11;
    MR_Word mercury__integer__Var_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Word mercury__integer__C_16;
    MR_Word mercury__integer__C_23;
...
#undef MR_PROC_LABEL
	 mercury__integer__Var_9  = Max;
        ...
        {
          mercury__integer____Compare____integer_0_0(&mercury__integer__C_23, mercury__integer__Integer_3, mercury__integer__Var_8);
        }
        switch (mercury__integer__C_23) {
          default:
            mercury__integer__succeeded = MR_FALSE;
            break;
          case (MR_Integer) 1:
...
{
  {
    MR_bool mercury__integer__succeeded;
    MR_Word mercury__integer__Integer_4;
    MR_Unsigned mercury__integer__Var_13;
...
#define MR_PROC_LABEL mercury__integer__from_uint_1_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_13  = U;
}
    mercury__integer__succeeded = (mercury__integer__U_3 == mercury__integer__Var_13);
    if (mercury__integer__succeeded)
      {
        MR_Word mercury__integer__Var_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      {
        MR_Unsigned mercury__integer__Var_6;
...
#define MR_PROC_LABEL mercury__integer__from_uint_1_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_6  = U;
}
        mercury__integer__succeeded = (mercury__integer__U_3 < mercury__integer__Var_6);
        if (mercury__integer__succeeded)
          {
            MR_Word mercury__integer__Var_9;
            MR_Integer mercury__integer__Var_10;
...
#define MR_PROC_LABEL mercury__integer__from_uint_1_f_0
    ...
    I = (MR_Integer) U;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__integer__Var_10  = I;
}
            mercury__integer__Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              mercury__integer__Var_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__integer__Var_9, 0) = ((MR_Box) (mercury__integer__Var_10));
              MR_hl_field(MR_mktag(1), mercury__integer__Var_9, 1) = ((MR_Box) (mercury__integer__Var_11));
            }
            {
              mercury__integer__Integer_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), mercury__integer__Integer_4, 0) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), mercury__integer__Integer_4, 1) = ((MR_Box) (mercury__integer__Var_9));
            }
          }
        else
          {
            MR_Word mercury__integer__Var_17 = (MR_Word) &mercury__integer_scalar_common_1[9];
            MR_Word mercury__integer__Var_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

            {
              mercury__integer__Integer_4 = mercury__integer__uint_to_digits_2_2_f_0(mercury__integer__U_3, mercury__integer__Var_17);
            }
          }
      }
    return mercury__integer__Integer_4;
