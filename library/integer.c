    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer__digits_to_strings_4_p_0(Base_5, Tail_34, (MR_Word) ((MR_Unsigned) 0U), &TailStrs_36);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (HeadStr_35));
          MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (TailStrs_36));
        }
        Var_58 = mercury__integer__map__ho2_2_f_in__list_0(Var_41);
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__integer__digits_to_strings_4_p_0(HeadVar__1_1, Tail_16, (MR_Word) ((MR_Unsigned) 0U), &TailStrs_18);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) (HeadStr_17));
        MR_hl_field(MR_mktag(1), Var_23, 1) = ((MR_Box) (TailStrs_18));
      }
      Var_40 = mercury__integer__map__ho2_2_f_in__list_0(Var_23);
...
#undef MR_PROC_LABEL
    ...
    mercury__integer__LCMC__func__map__ho2__1_3_p_0(Var_7, AddrSCCcallarg_9_17);
  }
  return HeadVar__3_3;
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      AddrSCCcallarg_12_15 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        AddrSCCcallarg_12_15 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_18, (MR_Integer) 1)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      AddrSCCcallarg_13_16 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        AddrSCCcallarg_13_16 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_19, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      Ua_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 0))));
      {
        ...
        else
        {
          ...
          MR_Integer Var_81 = (MR_Integer) ((MR_Unsigned) Len_75 - (MR_Unsigned) 1);

          {
            Var_26 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (Var_81));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), I_5, 0) = ((MR_Box) (Var_10));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    AddrSCCcallarg_7_8 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
  ...
  MR_Word * AddrOfHeadVar__2_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      AddrSCCcallarg_7_8 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__2_10, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                Var_13 = mercury__integer__decap_1_f_0(Var_50);
              }
              else
              {
                ...
                {
                  Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_51));
                  MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (Var_53));
                }
              }
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                Var_14 = mercury__integer__decap_1_f_0(Var_66);
              }
              else
              {
                ...
                {
                  Var_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (Var_67));
                  MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (Var_69));
                }
              }
