...
float.optdate float.trans_opt_date float.err float.c_date float.java_date : float.m \
	builtin.int \
	exception.int \
	int.int \
	math.int \
...
#   long deps
#   short deps
float.optdate float.trans_opt_date float.err float.c_date float.java_date : \
		float.m \
	\
		builtin.int \
		exception.int \
...
float.trans_opt_date float.err float.c_date float.java_date :  \
	float.opt \
	builtin.opt \
	exception.opt \
	int.opt \
...
float.err float.c_date float.java_date :  \
	float.trans_opt \
	builtin.trans_opt \
	exception.trans_opt \
	int.trans_opt \
