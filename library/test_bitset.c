...
#undef MR_PROC_LABEL
    ...
    mercury__set_ordlist__power_union_2_3_p_0(TypeInfo_15_15, SetsB_6, ((MR_Box) ((MR_Unsigned) 0U)), &SetB_8);
    {
      Var_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (SetA_7));
      MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (SetB_8));
...
{
  {
    ...
    succeeded = mercury__tree_bitset____Unify____tree_bitset_1_0(TypeInfo_for_T_9, A_2, ((MR_Box) (&mercury__test_bitset_scalar_common_4[0])));
    succeeded = !(succeeded);
    if (succeeded)
...
#undef MR_PROC_LABEL
    ...
    Var_4 = mercury__tree_bitset__insert_2_f_0(TypeClassInfo_for_enum_6, ((MR_Box) (&mercury__test_bitset_scalar_common_4[0])), A_3);
{
#define MR_PROC_LABEL mercury__test_bitset__make_singleton_set_1_f_0
