...
static /* final */ const MR_Box mercury__test_bitset_scalar_common_3[3][5];
...
mercury__test_bitset__init_1_p_0(
  ...
  MR_Word * HeadVar__1_1)
{
  *HeadVar__1_1 = (MR_Word) (&mercury__test_bitset_scalar_common_3[2]);
}
...
mercury__test_bitset__init_0_f_0(
  MR_Word TypeInfo_for_T_7)
{
  return (MR_Word) (&mercury__test_bitset_scalar_common_3[2]);
}
