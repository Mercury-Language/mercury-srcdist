...
{
#define MR_PROC_LABEL mercury__random__system_rng__generate_uint64_4_p_0
	...
	Handle = (ML_SystemRandomHandle)Handle_5 ;
		{
...
{
#define MR_PROC_LABEL mercury__random__system_rng__generate_uint32_4_p_0
...
{
#define MR_PROC_LABEL mercury__random__system_rng__generate_uint16_4_p_0
...
{
#define MR_PROC_LABEL mercury__random__system_rng__generate_uint8_4_p_0
...
{
#define MR_PROC_LABEL mercury__random__system_rng__close_system_rng_3_p_0

	ML_SystemRandomHandle Handle;
	MR_Word IsOk;
	MR_String ErrorMsg;

	Handle = (ML_SystemRandomHandle)Handle_4 ;
		{
...
{
#define MR_PROC_LABEL mercury__random__system_rng__open_system_rng_3_p_0
