...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word TypeCtorInfo_12_12 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
      MR_Word Var_11 = (MR_Word) ((MR_Box) ((MR_String) "uint.(>>): second operand is out of range"));

      mercury__exception__throw_1_p_0(TypeCtorInfo_12_12, ((MR_Box) (Var_11)));
    }
    return Result_6;
  }
}
...
{
  {
    MR_bool succeeded = (Y_5 == 0U);
    MR_Unsigned Rem_6;

    if (succeeded)
    {
      MR_Word TypeCtorInfo_9_9 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
      MR_Word Var_7 = (MR_Word) ((MR_Box) ((MR_String) "uint.rem: division by zero"));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_9 = (MR_Word) ((MR_Box) ((MR_String) "uint.rem: division by zero"));
