...
{
  {
    ...
    MR_String mercury__uint__V_4_4;
  ...
  MR_Unsigned mercury__uint__X_2)
{
  {
    MR_bool mercury__uint__succeeded;
    MR_Unsigned mercury__uint__V_3_3;
    MR_Unsigned mercury__uint__V_4_4;
    MR_Unsigned mercury__uint__V_8_8;
...
#define MR_PROC_LABEL mercury__uint__odd_1_p_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__uint__V_4_4  = U;
}
    mercury__uint__V_3_3 = (mercury__uint__X_2 & mercury__uint__V_4_4);
{
#define MR_PROC_LABEL mercury__uint__odd_1_p_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__uint__V_8_8  = U;
}
    mercury__uint__succeeded = (mercury__uint__V_3_3 == mercury__uint__V_8_8);
