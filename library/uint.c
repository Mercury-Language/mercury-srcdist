  ...
  MR_Unsigned mercury__uint__X_2)
{
  {
    MR_bool mercury__uint__succeeded;
    MR_Unsigned mercury__uint__Var_3;
    MR_Unsigned mercury__uint__Var_4;
    MR_Unsigned mercury__uint__Var_8;

{
#define MR_PROC_LABEL mercury__uint__odd_1_p_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__uint__Var_4  = U;
}
    mercury__uint__Var_3 = (mercury__uint__X_2 & mercury__uint__Var_4);
{
#define MR_PROC_LABEL mercury__uint__odd_1_p_0
...
#undef MR_PROC_LABEL
    ...
    mercury__uint__succeeded = (mercury__uint__Var_3 == mercury__uint__Var_8);
...
{
#define MR_PROC_LABEL mercury__uint__even_1_p_0
...
{
  {
    ...
    MR_Unsigned mercury__uint__Var_12;

{
#define MR_PROC_LABEL mercury__uint__rem_2_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__uint__Var_12  = U;
}
    mercury__uint__succeeded = (mercury__uint__Y_5 == mercury__uint__Var_12);
    if (mercury__uint__succeeded)
      {
        MR_Word mercury__uint__TypeCtorInfo_10_10 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
        MR_Word mercury__uint__Var_8 = (MR_Word) ((MR_Box) ((MR_String) "uint.rem: division by zero"));

        {
          mercury__exception__throw_1_p_0(mercury__uint__TypeCtorInfo_10_10, ((MR_Box) (mercury__uint__Var_8)));
        }
      }
    else
...
{
  {
    ...
    MR_Unsigned mercury__uint__Var_14;

{
#define MR_PROC_LABEL mercury__uint__mod_2_f_0
    ...
    U = (MR_Unsigned) I;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__uint__Var_14  = U;
}
    mercury__uint__succeeded = (mercury__uint__Y_5 == mercury__uint__Var_14);
    if (mercury__uint__succeeded)
      {
        MR_Word mercury__uint__TypeCtorInfo_10_12 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
        MR_Word mercury__uint__Var_10 = (MR_Word) ((MR_Box) ((MR_String) "uint.rem: division by zero"));

        {
          mercury__exception__throw_1_p_0(mercury__uint__TypeCtorInfo_10_12, ((MR_Box) (mercury__uint__Var_10)));
        }
      }
    else
...
{
#define MR_PROC_LABEL mercury__uint__f_slash_2_f_0
...
#undef MR_PROC_LABEL
    ...
    if (mercury__uint__succeeded)
      {
        MR_Word mercury__uint__TypeCtorInfo_10_12 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
        MR_Word mercury__uint__Var_10 = (MR_Word) ((MR_Box) ((MR_String) "uint.\'//\': division by zero"));
...
{
#define MR_PROC_LABEL mercury__uint__f_47_47_2_f_0
...
#undef MR_PROC_LABEL
    ...
    if (mercury__uint__succeeded)
      {
        MR_Word mercury__uint__TypeCtorInfo_10_10 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
        MR_Word mercury__uint__Var_8 = (MR_Word) ((MR_Box) ((MR_String) "uint.\'//\': division by zero"));
...
{
#define MR_PROC_LABEL mercury__uint__div_2_f_0
...
{
  {
    ...
    MR_Unsigned mercury__uint__U0_5;
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	 mercury__uint__U0_5  = U;
	}
mercury__uint__succeeded  = SUCCESS_INDICATOR;
}
    if (mercury__uint__succeeded)
      mercury__uint__U_4 = mercury__uint__U0_5;
    else
      {
        {
