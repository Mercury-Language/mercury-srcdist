  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_26 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 2))));
      MR_Word Var_27 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
      MR_Integer Var_28 = ((MR_Integer) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Box Var_29 = (MR_hl_field(0, HeadVar__2_2, (MR_Integer) 0));
    ...
    else
    {
      ...
      MR_Box Var_32 = (MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0));
