...
ifeq ($(TARGET_ASM),yes)
thread.semaphore.mh thread.semaphore.mih : thread.semaphore.s
else
thread.semaphore.mh thread.semaphore.mih : thread.semaphore.c
endif

ifeq ($(TARGET_ASM),yes)
thread.semaphore.module_dep : thread.semaphore.s
else
 ifeq ($(findstring il,$(GRADE)),il)
thread.semaphore.module_dep : thread.semaphore.il
  ifeq ($(findstring java,$(GRADE)),java)
thread.semaphore.module_dep : mercury/thread_/semaphore.java
  else
