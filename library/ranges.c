...
{
  {
    ...
    {
      mercury__exception__throw_1_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, ((MR_Box) ((MR_String) "ranges.median: empty set")));
    }
  ...
  MR_Integer I_2)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
    {
      ...
      conv0_HeadVar__3_3 = mercury__exception__throw_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) ((MR_String) "ranges.element_index: index out of range")));
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      mercury__exception__throw_1_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, ((MR_Box) ((MR_String) "ranges.range: cannot represent min_int")));
    }
    else
    {
