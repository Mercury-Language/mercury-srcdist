  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        AddrResult0_16 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__2_2, (MR_Integer) 2)));
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            HeadVar__2_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), HeadVar__2_20, 0) = ((MR_Box) (LA_8));
            MR_hl_field(MR_mktag(1), HeadVar__2_20, 1) = ((MR_Box) (UA_9));
            MR_hl_field(MR_mktag(1), HeadVar__2_20, 2) = NULL;
          }
          AddrResult0_16 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__2_20, (MR_Integer) 2)));
