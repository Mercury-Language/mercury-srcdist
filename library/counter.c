...
{
  {
    ...
    if (mercury__counter__succeeded)
      *mercury__counter__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__counter__ArgX1_4 = (MR_Integer) mercury__counter__HeadVar__2_2;
        MR_Integer mercury__counter__ArgY1_5 = (MR_Integer) mercury__counter__HeadVar__3_3;

        mercury__counter__succeeded = (mercury__counter__ArgX1_4 < mercury__counter__ArgY1_5);
        if (mercury__counter__succeeded)
...
{
  {
    ...
    if (mercury__counter__succeeded)
      ...
      {
        MR_Integer mercury__counter__ArgX1_3 = (MR_Integer) mercury__counter__HeadVar__1_1;
        MR_Integer mercury__counter__ArgY1_4 = (MR_Integer) mercury__counter__HeadVar__2_2;

        mercury__counter__succeeded = (mercury__counter__ArgX1_3 == mercury__counter__ArgY1_4);
      }
  ...
  MR_Word * mercury__counter__HeadVar__3_3)
{
  {
    MR_bool mercury__counter__succeeded;
    MR_Integer mercury__counter__Var_5;

    *mercury__counter__N_4 = (MR_Integer) mercury__counter__HeadVar__2_2;
    mercury__counter__Var_5 = (*mercury__counter__N_4 + (MR_Integer) 1);
    *mercury__counter__HeadVar__3_3 = (MR_Word) mercury__counter__Var_5;
  }
}
