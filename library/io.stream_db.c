...
static /* final */ const MR_Box mercury__io__stream_db_scalar_common_3[1][5];
...
static const MR_DuFunctorDescPtr mercury__io__stream_db__io__stream_db__du_stag_ordered_maybe_stream_info_0_0[1] = { &mercury__io__stream_db__io__stream_db__du_functor_desc_maybe_stream_info_0_1 };

static const MR_DuFunctorDescPtr mercury__io__stream_db__io__stream_db__du_stag_ordered_maybe_stream_info_0_1[1] = { &mercury__io__stream_db__io__stream_db__du_functor_desc_maybe_stream_info_0_0 };
...
static const MR_DuFunctorDescPtr mercury__io__stream_db__io__stream_db__du_stag_ordered_stream_info_0_0[1] = { &mercury__io__stream_db__io__stream_db__du_functor_desc_stream_info_0_0 };
...
static const MR_DuFunctorDescPtr mercury__io__stream_db__io__stream_db__du_name_ordered_stream_info_0[1] = { &mercury__io__stream_db__io__stream_db__du_functor_desc_stream_info_0_0 };

static const MR_Integer mercury__io__stream_db__io__stream_db__functor_number_map_stream_info_0[1] = { (MR_Integer) 0 };
...
static const MR_PseudoTypeInfo mercury__io__stream_db__io__stream_db__field_types_stream_source_0_0[1] = { (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_string_0) };
...
static const MR_DuFunctorDescPtr mercury__io__stream_db__io__stream_db__du_stag_ordered_stream_source_0_1[1] = { &mercury__io__stream_db__io__stream_db__du_functor_desc_stream_source_0_0 };
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word ArgX2_7 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
    MR_Word ArgY2_8 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__3_3, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Word ArgX2_5 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
    MR_Word ArgY2_6 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word ArgX2_7 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
    MR_Word ArgY2_8 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
    MR_Word ArgX3_10 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 3);
    MR_Word ArgY3_11 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 3);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Integer ArgY1_4;
    MR_Word ArgX2_5 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
    MR_Word ArgY2_6;
    MR_Word ArgX3_7 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 3);
    MR_Word ArgY3_8;
    ...
    if (succeeded)
    {
      ...
      ArgY2_6 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
      ArgY3_8 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 3);
  ...
  MR_Word * StreamInfo_6)
{
  ...
  succeeded = mercury__io__stream_db__get_io_stream_info_3_p_0(TypeInfo_for_T_7, StreamDB_4, Stream_5, StreamInfo_6);
  return succeeded;
}

MR_bool MR_CALL 
mercury__io__stream_db__get_io_stream_info_3_p_0(
  ...
  MR_Word * StreamInfo_6)
{
  ...
  succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo_for_T_17, (MR_Word) (&mercury__io__io__type_ctor_info_text_input_stream_0), Stream_5, &conv0_Var_9);
  if (succeeded)
  {
  ...
  else
  {
    ...
    succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo_for_T_17, (MR_Word) (&mercury__io__io__type_ctor_info_text_output_stream_0), Stream_5, &conv1_Var_10);
    if (succeeded)
    {
...
#undef MR_PROC_LABEL
  ...
  if (succeeded)
  {
    MR_Integer Id_8 = ((MR_Integer) ((MR_hl_field(0, Info0_7, (MR_Integer) 0))));
    MR_Word Source_11 = ((MR_Word) ((MR_hl_field(0, Info0_7, (MR_Integer) 2))));
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Info0_7, (MR_Integer) 1)));

    {
      Info_6 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Info_6, 0) = ((MR_Box) (Id_8));
      MR_hl_field(1, Info_6, 1) = (MR_Box) (packed_word_0);
      MR_hl_field(1, Info_6, 2) = ((MR_Box) (Source_11));
    }
  }
  else
  ...
  MR_String * Name_6)
{
  ...
  {
    MR_Word Info_9 = ((MR_Word) ((MR_hl_field(1, MaybeInfo_8, (MR_Integer) 0))));
    MR_Word Source_13 = ((MR_Word) ((MR_hl_field(0, Info_9, (MR_Integer) 2))));
    ...
    switch (MR_tag((MR_Word) Source_13)) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        *Name_6 = ((MR_String) ((MR_hl_field(1, Source_13, (MR_Integer) 0))));
        break;
    }
  }
}
  ...
  if (succeeded)
    {
      ...
      *MaybeInfo_6 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (Info_9));
    }
  else
...
#undef MR_PROC_LABEL
    ...
    mercury__tree234__delete_2_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__stream_db__io__stream_db__type_ctor_info_stream_info_0), StreamDb0_7, ((MR_Box) (Var_14)), &StreamDb_8, &Var_18);
{
#define MR_PROC_LABEL mercury__io__stream_db__maybe_delete_stream_info_3_p_0
