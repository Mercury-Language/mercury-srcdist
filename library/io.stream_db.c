  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word Var_30 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 3);
    MR_Word Var_31 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
