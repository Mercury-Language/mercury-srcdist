...
MR_decl_label3(fn__assoc_list__map_keys_only_2_0, 13,4,5)
MR_decl_label3(fn__assoc_list__map_values_2_0, 13,4,5)
MR_decl_label3(fn__assoc_list__map_values_only_2_0, 13,4,5)
...
MR_BEGIN_MODULE(assoc_list_module13)
	...
	MR_init_label3(fn__assoc_list__map_keys_only_2_0,13,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__assoc_list__map_keys_only_2_0);
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(fn__assoc_list__map_keys_only_2_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__assoc_list__map_keys_only_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(assoc_list_module14)
	...
	MR_init_label3(fn__assoc_list__map_values_only_2_0,13,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__assoc_list__map_values_only_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(fn__assoc_list__map_values_only_2_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__assoc_list__map_values_only_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(assoc_list_module15)
	...
	MR_init_label3(fn__assoc_list__map_values_2_0,13,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__assoc_list__map_values_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(fn__assoc_list__map_values_2_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__assoc_list__map_values_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
