...
{
  {
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__pair__pair__type_ctor_info_pair_2;
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_7_7 = (MR_Word) &mercury__pair__pair__type_ctor_info_pair_2;
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_6_6 = (MR_Word) &mercury__pair__pair__type_ctor_info_pair_2;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Box _K_25 = (MR_hl_field(MR_mktag(0), KV_20, (MR_Integer) 0));
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word next_value_of_HeadVar__2_2 = KVs_21;
            MR_Box next_value_of_STATE_VARIABLE_Acc1_0_3 = STATE_VARIABLE_Acc1_33_33;
            MR_Box next_value_of_STATE_VARIABLE_Acc2_0_5 = STATE_VARIABLE_Acc2_34_34;
            MR_Box next_value_of_STATE_VARIABLE_Acc3_0_7 = STATE_VARIABLE_Acc3_35_35;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Box _K_19 = (MR_hl_field(MR_mktag(0), KV_15, (MR_Integer) 0));
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = KVs_16;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Box _K_13 = (MR_hl_field(MR_mktag(0), KV_10, (MR_Integer) 0));
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = KVs_11;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Box STATE_VARIABLE_Acc_17_17;
        MR_Box _V_14 = (MR_hl_field(MR_mktag(0), KV_10, (MR_Integer) 1));
        MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), P_1, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_24;
        MR_Box _AV_14 = (MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 1));
        MR_Box _BV_16 = (MR_hl_field(MR_mktag(0), B_10, (MR_Integer) 1));
...
{
  {
    ...
    else
    {
      ...
      HV_8 = (MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 1));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        HV_7 = (MR_hl_field(MR_mktag(0), Var_11, (MR_Integer) 1));
        func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), P_1, (MR_Integer) 1)));
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_33_33 = (MR_Word) &mercury__list__list__type_ctor_info_list_1;
...
#undef MR_PROC_LABEL
	 Var_15  = TypeInfo;
      ...
      mercury__string__int_to_base_string_3_p_0(KeyLength_9, (MR_Integer) 10, &KeyLengthString_10);
      {
        ...
        MR_hl_field(MR_mktag(0), TypeInfo_35_35, 0) = ((MR_Box) (TypeCtorInfo_33_33));
