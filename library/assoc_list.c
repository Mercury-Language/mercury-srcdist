    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__assoc_list__merge_3_p_0(TypeInfo_for_K_21, TypeInfo_for_V_22, HeadVar__1_1, Bs_10, &Cs0_16);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__3_3 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (B_9));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Cs0_16));
          }
        }
        else
        {
          ...
          mercury__assoc_list__merge_3_p_0(TypeInfo_for_K_21, TypeInfo_for_V_22, Var_24, HeadVar__2_2, &Cs0_20);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__3_3 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Var_25));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Cs0_20));
          }
        }
      }
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = mercury__assoc_list__update_4_p_0(TypeInfo_for_K_16, TypeInfo_for_V_17, Key_5, Value_6, TailKVs0_11, &TailKVs_12);
        if (succeeded)
        {
          {
            MR_Word base;
            ...
            *KVs_8 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TailKVs_12));
          }
          succeeded = MR_TRUE;
        }
      }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__assoc_list__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_114_111_109_95_99_111_114_114_101_115_112_111_110_100_105_110_103_95_108_111_111_112_95_95_91_49_44_32_50_93_95_48_3_p_0(As_5, Bs_7, &ABs_8);
        if (succeeded)
        {
          {
            MR_Word base;
