...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__assoc_list__LCMCpr_from_corresponding_loop_1_3_p_0(TypeInfo_for_K_10, TypeInfo_for_V_11, As_5, Bs_7, AddrABs_12);
      }
    }
    return succeeded;
  }
...
MR_bool MR_CALL 
mercury__assoc_list__LCMCpr_from_corresponding_loop_1_3_p_0(
  MR_Word TypeInfo_for_K_10,
  MR_Word TypeInfo_for_V_11,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
