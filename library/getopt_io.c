  ...
  MR_Word * Result_6)
{
  ...
  else
  {
    ...
    mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_22);
{
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      mercury__getopt_io__LCMC__pred__words_loop__ho17__1_4_p_0(HeadVar__2_6, Var_11, AddrSCCcallarg13_14);
    }
  }
}
