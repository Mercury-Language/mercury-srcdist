...
MR_decl_label8(getopt_io__process_special_8_0, 4,18,21,23,19,27,7,10)
MR_decl_label2(getopt_io__process_special_8_0, 8,15)
...
MR_BEGIN_MODULE(getopt_io_module2)
	...
	MR_init_label8(getopt_io__process_special_8_0,4,18,21,23,19,27,7,10)
	MR_init_label2(getopt_io__process_special_8_0,8,15)
MR_BEGIN_CODE
...
MR_def_label(getopt_io__process_special_8_0,19)
	...
	MR_r1 = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_string_const("the handler of option \140", 23);
