    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__getopt_io__skip_to_next_word_start__ho18_4_p_in__string_0(Contents_21, (MR_Integer) 0, &Var_58);
        mercury__getopt_io__words_loop__ho17_4_p_in__string_0(Contents_21, Var_58, &Words_22);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ArgPrime_89 = ((MR_String) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0))));
                        ArgsPrime_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
                      }
                    }
                    if (succeeded)
                    {
                      {
                        ...
                        *STATE_VARIABLE_RevOptionArgs_7 = base;
                        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ArgPrime_89));
