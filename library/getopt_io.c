...
{
  {
    ...
    mercury__getopt_io__skip_to_word_end__ho20_4_p_in__string_0(HeadVar__2_6, HeadVar__3_7, &Var_9);
...
#undef MR_PROC_LABEL
	 Var_10  = SubString;
      ...
      else
      {
        ...
        mercury__getopt_io__LCMCpr_words_loop__ho16_1_4_p_in__string_0(HeadVar__2_6, Var_11, AddrSCCcallarg13_14);
      }
    }
  }
}
