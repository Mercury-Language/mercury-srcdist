...
{
  {
    ...
    mercury__getopt_io__skip_to_word_end__ho19_4_p_in__string_0(V_6_6, V_7_7, &V_9_9);
...
#undef MR_PROC_LABEL
	 V_10_10  = SubString;
      ...
      mercury__getopt_io__skip_to_next_word_start__ho18_4_p_in__string_0(V_6_6, V_9_9, &V_11_11);
      ...
      else
      {
        ...
        mercury__getopt_io__words_loop__ho17_4_p_in__string_0(V_6_6, V_11_11, &V_12_13);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *V_8_8 = base;
