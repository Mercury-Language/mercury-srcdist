...
static void MR_CALL 
mercury__getopt_io__LCMCpr_words_loop__ho16_1_4_p_in__string_0(
  MR_String V_6_6,
  MR_Integer V_7_7,
...
#undef MR_PROC_LABEL
	 V_10_10  = SubString;
      ...
      else
      {
        ...
        mercury__getopt_io__LCMCpr_words_loop__ho16_1_4_p_in__string_0(V_6_6, V_11_11, AddrV_12_14);
      }
    }
  }
}
...
{
#define MR_PROC_LABEL mercury__getopt_io__LCMCpr_words_loop__ho16_1_4_p_in__string_0
...
#undef MR_PROC_LABEL
	 V_7_249  = Res;
                  ...
                  succeeded = (V_7_249 < (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = (MR_Integer) 1;
                  else
                  {
...
#undef MR_PROC_LABEL
	 V_7_289  = Res;
                  ...
                  succeeded = (V_7_289 < (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = (MR_Integer) 1;
                  else
                  {
...
#undef MR_PROC_LABEL
	 V_7_284  = Res;
                          ...
                          succeeded = (V_7_284 < (MR_Integer) 0);
                          if (succeeded)
                            *HeadVar__1_1 = (MR_Integer) 1;
                          else
                          {
...
#undef MR_PROC_LABEL
	 V_7_254  = Res;
                          ...
                          succeeded = (V_7_254 < (MR_Integer) 0);
                          if (succeeded)
                            *HeadVar__1_1 = (MR_Integer) 1;
                          else
                          {
...
#undef MR_PROC_LABEL
	 V_7_259  = Res;
                          ...
                          succeeded = (V_7_259 < (MR_Integer) 0);
                          if (succeeded)
...
#undef MR_PROC_LABEL
	 V_7_264  = Res;
                            ...
                            succeeded = (V_7_264 < (MR_Integer) 0);
                            if (succeeded)
                              *HeadVar__1_1 = (MR_Integer) 1;
                            else
                            {
...
#undef MR_PROC_LABEL
	 V_7_269  = Res;
                          ...
                          succeeded = (V_7_269 < (MR_Integer) 0);
                          if (succeeded)
...
#undef MR_PROC_LABEL
	 V_7_274  = Res;
                            ...
                            succeeded = (V_7_274 < (MR_Integer) 0);
                            if (succeeded)
                              *HeadVar__1_1 = (MR_Integer) 1;
                            else
                            {
...
#undef MR_PROC_LABEL
	 V_7_279  = Res;
                          ...
                          succeeded = (V_7_279 < (MR_Integer) 0);
                          if (succeeded)
                            *HeadVar__1_1 = (MR_Integer) 1;
                          else
                          {
...
{
  {
    ...
    else
    {
      ...
      V_4_22 = (MR_Box) (FileStream_9);
      mercury__io__maybe_delete_stream_info_3_p_0(V_4_22);
{
#define MR_PROC_LABEL mercury__getopt_io__do_read_file_contents_4_p_0
    ...
    if (mercury_close(Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, V_6_24 );
}
      mercury__io__throw_on_error_4_p_0(V_6_24, (MR_String) "error closing file: ");
    }
  }
}
