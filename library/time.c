  ...
  MR_Word * Time_6)
{
  ...
  {
    MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DST_16, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
          Var_17 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__time_scalar_common_5[1]));
        else
        {
          succeeded = (N_15 > (MR_Integer) 0);
          if (succeeded)
            Var_17 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__time_scalar_common_5[2]));
          else
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), TM_4, 8) = ((MR_Box) (Var_17));
        }
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
          Var_23 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__time_scalar_common_5[1]));
        else
        {
          succeeded = (N_18 > (MR_Integer) 0);
          if (succeeded)
            Var_23 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__time_scalar_common_5[2]));
          else
