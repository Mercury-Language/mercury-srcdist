...
static const struct mercury_type_1 mercury_vector_common_1_1[];
...
MR_decl_label2(__Unify___time__time_t_0_0, 2,1)
MR_decl_label2(__Unify___time__time_t_rep_0_0, 2,1)
MR_decl_label1(__Unify___time__tm_0_0, 1)
MR_decl_label1(__Unify___time__tms_0_0, 1)
MR_decl_label2(__Compare___time__clock_t_0_0, 2,3)
MR_decl_label2(__Compare___time__dst_0_0, 2,3)
MR_decl_label2(__Compare___time__time_error_0_0, 2,3)
MR_decl_label8(__Compare___time__tm_0_0, 4,5,7,12,13,15,20,21)
MR_decl_label8(__Compare___time__tm_0_0, 23,28,29,31,36,37,39,44)
MR_decl_label8(__Compare___time__tm_0_0, 45,47,52,53,55,60,61,63)
MR_decl_label1(__Compare___time__tm_0_0, 74)
MR_decl_label8(__Compare___time__tms_0_0, 4,5,7,12,13,15,20,21)
MR_decl_label4(__Compare___time__tms_0_0, 23,26,27,32)
...
;}
#line 568 "time.c"
	MR_RELEASE_GLOBAL_LOCK("c_clock");
	MR_r1 = Ret;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__fn__time__clocks_per_sec_0_0
	MR_OBTAIN_GLOBAL_LOCK("clocks_per_sec");
{
#line 294 "time.m"
...
;}
#line 646 "time.c"
	MR_RELEASE_GLOBAL_LOCK("clocks_per_sec");
	MR_r1 = Ret;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 833 "time.c"
	MR_RELEASE_GLOBAL_LOCK("c_times");
	MR_r1 = Ret;
	MR_r2 = Ut;
	MR_r3 = St;
	MR_r4 = CUt;
...
#define	MR_PROC_LABEL	mercury__fn__time__c_clk_tck_0_0
	MR_OBTAIN_GLOBAL_LOCK("c_clk_tck");
{
#line 393 "time.m"
...
;}
#line 942 "time.c"
	MR_RELEASE_GLOBAL_LOCK("c_clk_tck");
	MR_r1 = Ret;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__time__c_difftime_3_0
	...
	MR_OBTAIN_GLOBAL_LOCK("c_difftime");
{
#line 488 "time.m"
...
;}
#line 1024 "time.c"
	MR_RELEASE_GLOBAL_LOCK("c_difftime");
...
MR_BEGIN_MODULE(time_module13)
	...
	MR_init_label2(fn__time__int_to_maybe_dst_1_0,2,4)
MR_BEGIN_CODE
...
MR_def_label(fn__time__int_to_maybe_dst_1_0,2)
	...
	if (MR_INT_LE(MR_r1,0)) {
		MR_GOTO_LAB(fn__time__int_to_maybe_dst_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,1);
	MR_proceed();
MR_def_label(fn__time__int_to_maybe_dst_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(time_module20)
	...
	MR_init_label4(fn__time__asctime_1_0,2,5,6,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__time__asctime_1_0);
	...
	MR_r10 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_1_0, MR_tempr1);
	MR_r1 = MR_r8;
	MR_r2 = MR_r7;
	MR_r11 = MR_r6;
	MR_r6 = MR_r3;
...
MR_def_label(fn__time__asctime_1_0,5)
	...
	MR_tempr10 = MR_r2;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_1_1, MR_tempr10);
...
MR_BEGIN_MODULE(time_module29)
	...
	MR_init_label2(__Compare___time__time_error_0_0,2,3)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___time__time_error_0_0_i2);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___time__time_error_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___time__time_error_0_0_i3);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___time__time_error_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(time_module30)
	...
	MR_init_label2(__Unify___time__time_t_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___time__time_t_0_0);
	...
	MR_np_call_localret_ent(time__compare_time_t_reps_3_0,
		__Unify___time__time_t_0_0_i2);
MR_def_label(__Unify___time__time_t_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
...
MR_BEGIN_MODULE(time_module32)
	...
	MR_init_label2(__Unify___time__time_t_rep_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___time__time_t_rep_0_0);
	...
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(time__compare_time_t_reps_3_0,
		__Unify___time__time_t_rep_0_0_i2);
MR_def_label(__Unify___time__time_t_rep_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
...
MR_BEGIN_MODULE(time_module34)
	...
	MR_init_label1(__Unify___time__tm_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(time_module35)
	...
	MR_init_label8(__Compare___time__tm_0_0,4,5,7,12,13,15,20,21)
	MR_init_label8(__Compare___time__tm_0_0,23,28,29,31,36,37,39,44)
	MR_init_label8(__Compare___time__tm_0_0,45,47,52,53,55,60,61,63)
	MR_init_label1(__Compare___time__tm_0_0,74)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___time__tm_0_0);
	...
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i4);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i7);
	}
MR_def_label(__Compare___time__tm_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i5);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i7);
MR_def_label(__Compare___time__tm_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i74);
	}
	if (((MR_Integer) MR_sv(1) >= (MR_Integer) MR_sv(9))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i12);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i15);
MR_def_label(__Compare___time__tm_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(1) != MR_sv(9))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i13);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i15);
MR_def_label(__Compare___time__tm_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,15)
	...
	if (((MR_Integer) MR_sv(2) >= (MR_Integer) MR_sv(10))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i20);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i23);
MR_def_label(__Compare___time__tm_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(2) != MR_sv(10))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i21);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i23);
MR_def_label(__Compare___time__tm_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,23)
	...
	if (((MR_Integer) MR_sv(3) >= (MR_Integer) MR_sv(11))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i28);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i31);
MR_def_label(__Compare___time__tm_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(3) != MR_sv(11))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i29);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i31);
MR_def_label(__Compare___time__tm_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,31)
	...
	if (((MR_Integer) MR_sv(4) >= (MR_Integer) MR_sv(12))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i36);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i39);
MR_def_label(__Compare___time__tm_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(4) != MR_sv(12))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i37);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i39);
MR_def_label(__Compare___time__tm_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,39)
	...
	if (((MR_Integer) MR_sv(5) >= (MR_Integer) MR_sv(13))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i44);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i47);
MR_def_label(__Compare___time__tm_0_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(5) != MR_sv(13))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i45);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i47);
MR_def_label(__Compare___time__tm_0_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,47)
	...
	if (((MR_Integer) MR_sv(6) >= (MR_Integer) MR_sv(14))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i52);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i55);
MR_def_label(__Compare___time__tm_0_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(6) != MR_sv(14))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i53);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i55);
MR_def_label(__Compare___time__tm_0_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tm_0_0,55)
	...
	if (((MR_Integer) MR_sv(7) >= (MR_Integer) MR_sv(15))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i60);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i63);
MR_def_label(__Compare___time__tm_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(7) != MR_sv(15))) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i61);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tm_0_0_i63);
MR_def_label(__Compare___time__tm_0_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
...
MR_def_label(__Compare___time__tm_0_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(time_module36)
	...
	MR_init_label1(__Unify___time__tms_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(time_module37)
	...
	MR_init_label8(__Compare___time__tms_0_0,4,5,7,12,13,15,20,21)
	MR_init_label4(__Compare___time__tms_0_0,23,26,27,32)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___time__tms_0_0);
	...
	MR_r2 = MR_ctfield(0, MR_r1, 0);
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i4);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i7);
	}
MR_def_label(__Compare___time__tms_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i5);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i7);
MR_def_label(__Compare___time__tms_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tms_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i32);
	}
	if (((MR_Integer) MR_sv(1) >= (MR_Integer) MR_sv(4))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i12);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i15);
MR_def_label(__Compare___time__tms_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(1) != MR_sv(4))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i13);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i15);
MR_def_label(__Compare___time__tms_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tms_0_0,15)
	...
	if (((MR_Integer) MR_sv(2) >= (MR_Integer) MR_sv(5))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i20);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i23);
MR_def_label(__Compare___time__tms_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(2) != MR_sv(5))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i21);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___time__tms_0_0_i23);
MR_def_label(__Compare___time__tms_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tms_0_0,23)
	...
	if (((MR_Integer) MR_sv(3) >= (MR_Integer) MR_sv(6))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i26);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp(6);
	MR_proceed();
MR_def_label(__Compare___time__tms_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(3) != MR_sv(6))) {
		MR_GOTO_LAB(__Compare___time__tms_0_0_i27);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp(6);
	MR_proceed();
MR_def_label(__Compare___time__tms_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___time__tms_0_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp(6);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__time__write_out_proc_statics(FILE *fp);
#endif
