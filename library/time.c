...
MR_decl_label7(__Compare___time__tm_0_0, 54,55,57,62,63,65,232)
...
MR_BEGIN_MODULE(time_module35)
	...
	MR_init_label7(__Compare___time__tm_0_0,54,55,57,62,63,65,232)
MR_BEGIN_CODE
...
MR_def_label(__Compare___time__tm_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___time__tm_0_0_i232);
	}
	MR_r3 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___time__tm_0_0,232)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__time__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__time);
