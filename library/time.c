...
void MR_CALL 
mercury__time__c_mktime_12_p_0(
  MR_Integer Yr_1,
  MR_Integer Mnt_2,
  MR_Integer MD_3,
  MR_Integer Hrs_4,
  ...
  MR_Box * Time_10)
{
  {
{
#define MR_PROC_LABEL mercury__time__c_mktime_12_p_0
...
void MR_CALL 
mercury__time__c_localtime_12_p_0(
  MR_Box Time_1,
  MR_Integer * Yr_2,
  MR_Integer * Mnt_3,
  MR_Integer * MD_4,
  ...
  MR_Integer * N_10)
{
  {
{
#define MR_PROC_LABEL mercury__time__c_localtime_12_p_0
...
{
  {
    ...
    {
      MR_Word Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DST_16, (MR_Integer) 0))));
...
#define MR_PROC_LABEL mercury__time__mktime_4_p_0
    ...
    Time = mktime(&t);
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(time_t, Time, RawTime_17 );
}
    *Time_6 = (MR_Word) (RawTime_17);
  }
}
...
#undef MR_PROC_LABEL
    ...
    Var_21 = mercury__time__int_to_maybe_dst_1_f_0(N_17);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
      *TM_6 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Yr_9));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Mnt_10));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (MD_11));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Hrs_12));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Min_13));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Sec_14));
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (YD_15));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (WD_16));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        DST_4 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__time_scalar_common_5[2]));
      else
