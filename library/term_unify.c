...
static /* final */ const MR_Box mercury__term_unify_scalar_common_3[1][5];
  ...
  MR_Word * STATE_VARIABLE_Subst_35)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_110 = ((MR_Word) ((MR_hl_field(0, TermX_6, 1))));
      MR_Word Var_111 = ((MR_Word) ((MR_hl_field(0, TermX_6, 0))));

      if (((MR_tag((MR_Word) TermY_7)) == (MR_Integer) 0))
      {
        MR_Word TypeCtorInfo_105_105;
        MR_Word TypeInfo_106_106;
        MR_Word NameY_30 = ((MR_Word) ((MR_hl_field(0, TermY_7, 0))));
        MR_Integer ArityX_32;
        MR_Integer ArityY_33;
        MR_Word ArgTermsY_54 = ((MR_Word) ((MR_hl_field(0, TermY_7, 1))));
      ...
      {
        MR_Word Y_52 = ((MR_Word) ((MR_hl_field(1, TermY_7, 0))));
    ...
    {
      MR_Word Var_113 = ((MR_Word) ((MR_hl_field(1, TermX_6, 0))));

      if (((MR_tag((MR_Word) TermY_7)) == (MR_Integer) 0))
      {
        MR_Word ArgTermsY_22 = ((MR_Word) ((MR_hl_field(0, TermY_7, 1))));
      ...
      {
        MR_Word Y_12 = ((MR_Word) ((MR_hl_field(1, TermY_7, 0))));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Var_107 = ((MR_Word) ((MR_hl_field(1, SubstTermBoundToX_16, 0))));
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_108 = ((MR_Word) ((MR_hl_field(1, SubstTermBoundToY_18, 0))));
  ...
  MR_Word * STATE_VARIABLE_Subst_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TermX_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word TermXs_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word TermY_12;
      MR_Word TermYs_13;
      MR_Word STATE_VARIABLE_Subst_1_18;
      ...
      if (succeeded)
      {
        TermY_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
        TermYs_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
        succeeded = mercury__term_unify__unify_terms_dont_bind_5_p_0(TypeInfo_for_T_19, TermX_10, TermY_12, DontBindVars_3, STATE_VARIABLE_Subst_0_4, &STATE_VARIABLE_Subst_1_18);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          ...
          next_value_of_STATE_VARIABLE_Subst_0_4 = STATE_VARIABLE_Subst_1_18;
  ...
  MR_Word * STATE_VARIABLE_Subst_14)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        NewX_11 = ((MR_Word) ((MR_hl_field(1, TermBoundToX_10, 0))));
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
      Var_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
      {
  ...
  MR_Word * STATE_VARIABLE_Subst_31)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_94 = ((MR_Word) ((MR_hl_field(0, TermX_5, 1))));
      MR_Word Var_95 = ((MR_Word) ((MR_hl_field(0, TermX_5, 0))));

      if (((MR_tag((MR_Word) TermY_6)) == (MR_Integer) 0))
      {
        MR_Word NameY_28 = ((MR_Word) ((MR_hl_field(0, TermY_6, 0))));
        MR_Word ArgTermsY_48 = ((MR_Word) ((MR_hl_field(0, TermY_6, 1))));
      ...
      {
        MR_Word Y_46 = ((MR_Word) ((MR_hl_field(1, TermY_6, 0))));
    ...
    {
      MR_Word Var_97 = ((MR_Word) ((MR_hl_field(1, TermX_5, 0))));

      if (((MR_tag((MR_Word) TermY_6)) == (MR_Integer) 0))
      {
        MR_Word ArgTermsY_20 = ((MR_Word) ((MR_hl_field(0, TermY_6, 1))));
      ...
      {
        MR_Word Y_10 = ((MR_Word) ((MR_hl_field(1, TermY_6, 0))));
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              Var_91 = ((MR_Word) ((MR_hl_field(1, SubstTermBoundToX_14, 0))));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_92 = ((MR_Word) ((MR_hl_field(1, SubstTermBoundToY_16, 0))));
  ...
  MR_Word * STATE_VARIABLE_Subst_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TermX_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word TermXs_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word TermY_10;
      MR_Word TermYs_11;
      ...
      if (succeeded)
      {
        TermY_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
        TermYs_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
        succeeded = mercury__term_unify__unify_terms_4_p_0(TypeInfo_for_T_16, TermX_8, TermY_10, STATE_VARIABLE_Subst_0_3, &STATE_VARIABLE_Subst_1_15);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
