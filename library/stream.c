...
MR_decl_label7(stream__ignore_whitespace_4_0, 33,2,4,5,9,7,12)
MR_decl_label5(stream__input_stream_fold_6_0, 17,2,4,6,8)
MR_decl_label5(stream__input_stream_fold2_state_6_0, 17,2,4,6,8)
MR_decl_label6(stream__input_stream_fold2_state_maybe_stop_6_0, 23,2,4,6,8,10)
MR_decl_label5(stream__input_stream_fold_state_5_0, 22,2,4,5,7)
...
MR_decl_label4(__Unify___stream__result_1_0, 5,15,6,1)
MR_decl_label4(__Unify___stream__result_2_0, 5,19,6,1)
...
MR_decl_label8(__Compare___stream__result_1_0, 7,5,32,11,33,9,14,15)
MR_decl_label8(__Compare___stream__result_2_0, 30,7,5,33,11,9,15,16)
...
MR_BEGIN_MODULE(stream_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__stream__error_message_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'error_message'/2 mode 0 */
...
MR_BEGIN_MODULE(stream_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__name_4_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'name'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__get_4_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(stream_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__bulk_get_9_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'bulk_get'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__flush_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'flush'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__put_4_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(stream_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__unget_4_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'unget'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__seek_5_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'seek'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__get_line_4_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'get_line'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__set_line_4_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'set_line'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold_6_0);
	MR_init_label5(stream__input_stream_fold_6_0,17,2,4,6,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(stream__input_stream_fold_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold_6_0,2)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(stream__input_stream_fold_6_0_i4);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_sv(3);
	MR_decr_sp_and_return(6);
MR_def_label(stream__input_stream_fold_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(stream__input_stream_fold_6_0,6)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_2),
		mercury__stream__input_stream_fold_6_0_i8);
MR_def_label(stream__input_stream_fold_6_0,8)
	...
	MR_GOTO_LAB(stream__input_stream_fold_6_0_i17);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(stream_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold_6_1);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold'/6 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold_state_5_0);
	MR_init_label5(stream__input_stream_fold_state_5_0,22,2,4,5,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold_state'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(stream__input_stream_fold_state_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r1;
...
MR_def_label(stream__input_stream_fold_state_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(stream__input_stream_fold_state_5_0_i4);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(4);
MR_def_label(stream__input_stream_fold_state_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
...
MR_def_label(stream__input_stream_fold_state_5_0,5)
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(stream__input_stream_fold_state_5_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_2),
		mercury__stream__input_stream_fold_state_5_0_i7);
MR_def_label(stream__input_stream_fold_state_5_0,7)
	...
	MR_GOTO_LAB(stream__input_stream_fold_state_5_0_i22);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(stream_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold_state_5_1);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold_state'/5 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold2_state_6_0);
	MR_init_label5(stream__input_stream_fold2_state_6_0,17,2,4,6,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold2_state'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__stream__input_stream_fold2_state_6_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(stream__input_stream_fold2_state_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold2_state_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(stream__input_stream_fold2_state_6_0_i4);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_sv(3);
	MR_decr_sp_and_return(6);
MR_def_label(stream__input_stream_fold2_state_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
...
MR_def_label(stream__input_stream_fold2_state_6_0,6)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__stream__input_stream_fold2_state_6_0_i8);
MR_def_label(stream__input_stream_fold2_state_6_0,8)
	...
	MR_r6 = MR_tempr2;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(stream__input_stream_fold2_state_6_0_i17);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(stream_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold2_state_6_1);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold2_state'/6 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold2_state_maybe_stop_6_0);
	MR_init_label6(stream__input_stream_fold2_state_maybe_stop_6_0,23,2,4,6,8,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold2_state_maybe_stop'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__stream__input_stream_fold2_state_maybe_stop_6_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(stream__input_stream_fold2_state_maybe_stop_6_0_i4);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_sv(3);
	MR_decr_sp_and_return(6);
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
...
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,6)
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(stream__input_stream_fold2_state_maybe_stop_6_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__stream__input_stream_fold2_state_maybe_stop_6_0_i8);
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(stream__input_stream_fold2_state_maybe_stop_6_0_i10);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_r2;
	MR_r2 = MR_r3;
	MR_decr_sp_and_return(6);
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_r6 = MR_tempr2;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(stream__input_stream_fold2_state_maybe_stop_6_0_i23);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(stream_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__input_stream_fold2_state_maybe_stop_6_1);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'input_stream_fold2_state_maybe_stop'/6 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module18)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__ignore_whitespace_4_0);
	MR_init_label7(stream__ignore_whitespace_4_0,33,2,4,5,9,7,12)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'ignore_whitespace'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(stream__ignore_whitespace_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	{
...
MR_def_label(stream__ignore_whitespace_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(stream__ignore_whitespace_4_0_i4);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_decr_sp_and_return(5);
MR_def_label(stream__ignore_whitespace_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
...
MR_def_label(stream__ignore_whitespace_4_0,5)
	...
	MR_np_call_localret_ent(char__is_whitespace_1_0,
		stream__ignore_whitespace_4_0_i9);
MR_def_label(stream__ignore_whitespace_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_GOTO_LAB(stream__ignore_whitespace_4_0_i33);
MR_def_label(stream__ignore_whitespace_4_0,7)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_3),
		mercury__stream__ignore_whitespace_4_0_i12);
MR_def_label(stream__ignore_whitespace_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(stream_module19)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__put_list_6_0);
	MR_init_label5(stream__put_list_6_0,16,3,4,7,19)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'put_list'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__put_list_6_1);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'put_list'/6 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stream__put_list_6_2);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'put_list'/6 mode 2 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__maybe_partial_res_2_0);
...
MR_BEGIN_MODULE(stream_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__maybe_partial_res_2_0);
...
MR_BEGIN_MODULE(stream_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__name_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(stream_module25)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__name_0_0);
...
MR_BEGIN_MODULE(stream_module26)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__res_1_0);
...
MR_BEGIN_MODULE(stream_module27)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__res_1_0);
...
MR_BEGIN_MODULE(stream_module28)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__res_2_0);
...
MR_BEGIN_MODULE(stream_module29)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__res_2_0);
...
MR_BEGIN_MODULE(stream_module30)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__result_1_0);
	MR_init_label4(__Unify___stream__result_1_0,5,15,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__result_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Unify___stream__result_1_0_i15);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,1)) {
		MR_GOTO_LAB(__Unify___stream__result_1_0_i5);
	}
	MR_r1 = (MR_sv(2) == MR_tempr1);
	MR_decr_sp(4);
	MR_proceed();
	}
MR_def_label(__Unify___stream__result_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
	...
	MR_decr_sp_and_return(4);
MR_def_label(__Unify___stream__result_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(stream_module31)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__result_1_0);
	MR_init_label8(__Compare___stream__result_1_0,7,5,32,11,33,9,14,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___stream__result_1_0);
	...
	MR_sv(4) = (MR_Word) MR_succip;
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i33);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r1;
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,1)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i7);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp(4);
	MR_proceed();
MR_def_label(__Compare___stream__result_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i32);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___stream__result_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i9);
	}
	if (MR_LTAGS_TESTR(MR_sv(2),0,1)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i11);
	}
MR_def_label(__Compare___stream__result_1_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___stream__result_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i32);
	}
MR_def_label(__Compare___stream__result_1_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___stream__result_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,1)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i14);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___stream__result_1_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
...
MR_BEGIN_MODULE(stream_module32)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__result_2_0);
	MR_init_label4(__Unify___stream__result_2_0,5,19,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__result_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 == MR_r4)) {
		MR_GOTO_LAB(__Unify___stream__result_2_0_i19);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	{
	...
	MR_sv(4) = MR_r2;
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(__Unify___stream__result_2_0_i5);
	}
	MR_r1 = (MR_sv(2) == MR_tempr1);
	MR_decr_sp(5);
	MR_proceed();
	}
MR_def_label(__Unify___stream__result_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___stream__result_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(stream_module33)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__result_2_0);
	MR_init_label8(__Compare___stream__result_2_0,30,7,5,33,11,9,15,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___stream__result_2_0);
	...
	MR_sv(5) = (MR_Word) MR_succip;
	if ((MR_r3 == MR_r4)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i30);
	}
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r1;
	MR_sv(4) = MR_r2;
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i5);
	}
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i7);
	}
MR_def_label(__Compare___stream__result_2_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___stream__result_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i33);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___stream__result_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(1),2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i9);
	}
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i11);
	}
MR_def_label(__Compare___stream__result_2_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___stream__result_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i33);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___stream__result_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
...
MR_def_label(__Compare___stream__result_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i16);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___stream__result_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_tfield(1, MR_sv(1), 0);
	MR_r3 = MR_tfield(1, MR_sv(2), 0);
...
MR_BEGIN_MODULE(stream_module34)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___stream__whence_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(stream_module35)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___stream__whence_0_0);
...
MR_BEGIN_MODULE(stream_module36)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__f_115_116_114_101_97_109_95_95_111_112_115_95_95_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_67_108_97_115_115_77_101_116_104_111_100_95_102_111_114_95_111_112_115_95_95_111_112_95_116_97_98_108_101_95_95_95_95_111_112_115_95_95_109_101_114_99_117_114_121_95_111_112_95_116_97_98_108_101_95_95_97_114_105_116_121_48_95_95_95_95_95_95_111_112_115_95_95_109_97_120_95_112_114_105_111_114_105_116_121_95_49_95_95_91_49_93_95_48_1_0);
MR_BEGIN_CODE
...
void mercury__stream__init_threadscope_string_table(void);
#endif
...
void mercury__stream__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__stream);
