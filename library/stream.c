      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_16;
          ...
          mercury__builtin__compare_3_p_0(TypeInfo_for_Error_20, HeadVar__1_1, Var_21, ArgY2_15);
      }
      else
        *HeadVar__1_1 = (MR_Integer) 2;
    }
  ...
  MR_Box * STATE_VARIABLE_State_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Xs_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__4_4 = Xs_17;
          MR_Box next_value_of_STATE_VARIABLE_State_0_5 = STATE_VARIABLE_State_24_24;
        ...
        case (MR_Integer) 1:
          {
            ...
            /* direct tailcall eliminated */
            {
              ...
              MR_Box next_value_of_STATE_VARIABLE_S_0_16 = STATE_VARIABLE_S_19_19;
        ...
        case (MR_Integer) 1:
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Box next_value_of_STATE_VARIABLE_S_0_13 = STATE_VARIABLE_S_16_16;
