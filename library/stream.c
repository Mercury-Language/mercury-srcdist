...
extern const MR_TypeClassDeclStruct
	...
	mercury_data_stream__type_class_decl_input_3,
	mercury_data_stream__type_class_decl_error_1;

extern const MR_TypeClassDeclStruct
	mercury_data_stream__type_class_decl_duplex_3;
...
MR_decl_label7(stream__ignore_whitespace_4_0, 27,2,13,5,8,6,11)
MR_decl_label5(stream__input_stream_fold_6_0, 18,2,8,5,6)
MR_decl_label5(stream__input_stream_fold2_state_6_0, 18,2,8,5,6)
MR_decl_label6(stream__input_stream_fold2_state_maybe_stop_6_0, 24,2,10,5,6,8)
MR_decl_label5(stream__input_stream_fold_state_5_0, 18,2,8,5,6)
MR_decl_label5(stream__put_list_6_0, 18,3,4,7,21)
MR_decl_label4(__Unify___stream__maybe_partial_res_2_0, 34,8,35,1)
MR_decl_label2(__Unify___stream__res_1_0, 3,1)
MR_decl_label2(__Unify___stream__result_1_0, 4,1)
MR_decl_label3(__Unify___stream__result_2_0, 8,4,1)
MR_decl_label5(__Compare___stream__maybe_partial_res_2_0, 5,3,40,10,37)
MR_decl_label2(__Compare___stream__name_0_0, 2,3)
MR_decl_label3(__Compare___stream__res_1_0, 5,3,7)
MR_decl_label5(__Compare___stream__result_1_0, 22,5,12,4,16)
MR_decl_label6(__Compare___stream__result_2_0, 10,25,14,4,27,7)
...
extern const MR_TypeClassDeclStruct mercury_data_stream__type_class_decl_input_3;

static const MR_TypeClassConstraint_3Struct mercury_data_stream__type_class_decl_super_reader_4_1 = {
	&mercury_data_stream__type_class_decl_input_3,
	{
	(MR_PseudoTypeInfo) 1,
	(MR_PseudoTypeInfo) 3,
...
const MR_ConstString mercury_data_stream__type_class_id_var_names_input_3[] = {
	"Stream",
	"State",
	"Error",
};

static const MR_TypeClassId mercury_data_stream__type_class_id_input_3 = {
	"stream",
	"input",
	3,
	3,
	0,
	mercury_data_stream__type_class_id_var_names_input_3,
	NULL
};
extern const MR_TypeClassDeclStruct mercury_data_stream__type_class_decl_stream_2;

static const MR_TypeClassConstraint_2Struct mercury_data_stream__type_class_decl_super_input_3_1 = {
	&mercury_data_stream__type_class_decl_stream_2,
	{
	(MR_PseudoTypeInfo) 1,
	(MR_PseudoTypeInfo) 2
...
static const MR_TypeClassConstraint_1Struct mercury_data_stream__type_class_decl_super_input_3_2 = {
	&mercury_data_stream__type_class_decl_error_1,
	{
	(MR_PseudoTypeInfo) 3
	}
...
const MR_TypeClassConstraint mercury_data_stream__type_class_decl_supers_input_3[] = {
	(MR_TypeClassConstraint) &mercury_data_stream__type_class_decl_super_input_3_1,
	(MR_TypeClassConstraint) &mercury_data_stream__type_class_decl_super_input_3_2
};

const MR_TypeClassDeclStruct mercury_data_stream__type_class_decl_input_3 = {
	&mercury_data_stream__type_class_id_input_3,
	0,
	2,
	mercury_data_stream__type_class_decl_supers_input_3
};
...
const MR_ConstString mercury_data_stream__type_class_id_var_names_duplex_3[] = {
	"Stream",
	"State",
	"Error",
};

static const MR_TypeClassId mercury_data_stream__type_class_id_duplex_3 = {
	"stream",
	"duplex",
	3,
	3,
	0,
	mercury_data_stream__type_class_id_var_names_duplex_3,
	NULL
};
extern const MR_TypeClassDeclStruct mercury_data_stream__type_class_decl_input_3;

static const MR_TypeClassConstraint_3Struct mercury_data_stream__type_class_decl_super_duplex_3_1 = {
	&mercury_data_stream__type_class_decl_input_3,
	{
	(MR_PseudoTypeInfo) 1,
	(MR_PseudoTypeInfo) 2,
...
static const MR_TypeClassConstraint_2Struct mercury_data_stream__type_class_decl_super_duplex_3_2 = {
	&mercury_data_stream__type_class_decl_output_2,
	{
	(MR_PseudoTypeInfo) 1,
	(MR_PseudoTypeInfo) 2
...
const MR_TypeClassConstraint mercury_data_stream__type_class_decl_supers_duplex_3[] = {
	(MR_TypeClassConstraint) &mercury_data_stream__type_class_decl_super_duplex_3_1,
	(MR_TypeClassConstraint) &mercury_data_stream__type_class_decl_super_duplex_3_2
};

const MR_TypeClassDeclStruct mercury_data_stream__type_class_decl_duplex_3 = {
	&mercury_data_stream__type_class_id_duplex_3,
	0,
	2,
	mercury_data_stream__type_class_decl_supers_duplex_3
};
...
MR_BEGIN_MODULE(stream_module9)
	...
	MR_init_label5(stream__input_stream_fold_6_0,18,2,8,5,6)
MR_BEGIN_CODE
...
MR_def_label(stream__input_stream_fold_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold_6_0,2)
	...
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(stream__input_stream_fold_6_0_i5);
	}
...
MR_def_label(stream__input_stream_fold_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(3);
	MR_sv(3) = MR_r2;
	{
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_2),
		mercury__stream__input_stream_fold_6_0_i6);
MR_def_label(stream__input_stream_fold_6_0,6)
	...
	MR_GOTO_LAB(stream__input_stream_fold_6_0_i18);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module11)
	...
	MR_init_label5(stream__input_stream_fold_state_5_0,18,2,8,5,6)
MR_BEGIN_CODE
...
MR_def_label(stream__input_stream_fold_state_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(stream__input_stream_fold_state_5_0,2)
	...
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(stream__input_stream_fold_state_5_0_i8);
	}
...
MR_def_label(stream__input_stream_fold_state_5_0,5)
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(stream__input_stream_fold_state_5_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_2),
		mercury__stream__input_stream_fold_state_5_0_i6);
MR_def_label(stream__input_stream_fold_state_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	...
	MR_GOTO_LAB(stream__input_stream_fold_state_5_0_i18);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module13)
	...
	MR_init_label5(stream__input_stream_fold2_state_6_0,18,2,8,5,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__stream__input_stream_fold2_state_6_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(stream__input_stream_fold2_state_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold2_state_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(stream__input_stream_fold2_state_6_0_i5);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
...
MR_def_label(stream__input_stream_fold2_state_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__stream__input_stream_fold2_state_6_0_i6);
MR_def_label(stream__input_stream_fold2_state_6_0,6)
	...
	MR_r4 = MR_sv(2);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(stream__input_stream_fold2_state_6_0_i18);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(stream_module15)
	...
	MR_init_label6(stream__input_stream_fold2_state_maybe_stop_6_0,24,2,10,5,6,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__stream__input_stream_fold2_state_maybe_stop_6_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(stream__input_stream_fold2_state_maybe_stop_6_0_i5);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
...
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(stream__input_stream_fold2_state_maybe_stop_6_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__stream__input_stream_fold2_state_maybe_stop_6_0_i6);
MR_def_label(stream__input_stream_fold2_state_maybe_stop_6_0,6)
	...
	MR_r4 = MR_sv(2);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(stream__input_stream_fold2_state_maybe_stop_6_0_i24);
...
MR_BEGIN_MODULE(stream_module17)
	...
	MR_init_label7(stream__ignore_whitespace_4_0,27,2,13,5,8,6,11)
MR_BEGIN_CODE
...
MR_def_label(stream__ignore_whitespace_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(stream__ignore_whitespace_4_0,2)
	...
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(stream__ignore_whitespace_4_0_i13);
	}
...
MR_def_label(stream__ignore_whitespace_4_0,5)
	...
	MR_np_call_localret_ent(char__is_whitespace_1_0,
		stream__ignore_whitespace_4_0_i8);
MR_def_label(stream__ignore_whitespace_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(stream__ignore_whitespace_4_0_i6);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(stream__ignore_whitespace_4_0_i27);
MR_def_label(stream__ignore_whitespace_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r1 = MR_sv(4);
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_3),
		mercury__stream__ignore_whitespace_4_0_i11);
MR_def_label(stream__ignore_whitespace_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(5);
...
MR_BEGIN_MODULE(stream_module18)
	...
	MR_init_label5(stream__put_list_6_0,18,3,4,7,21)
MR_BEGIN_CODE
...
MR_def_label(stream__put_list_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(stream__put_list_6_0,4)
	...
	if (MR_LTAGS_TEST(MR_sv(4),0,0)) {
		MR_GOTO_LAB(stream__put_list_6_0_i21);
	}
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
...
MR_def_label(stream__put_list_6_0,7)
	...
	MR_GOTO_LAB(stream__put_list_6_0_i18);
MR_def_label(stream__put_list_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(stream_module21)
	...
	MR_init_label4(__Unify___stream__maybe_partial_res_2_0,34,8,35,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__maybe_partial_res_2_0);
	...
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Unify___stream__maybe_partial_res_2_0_i34);
	}
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(__Unify___stream__maybe_partial_res_2_0_i35);
	}
	MR_r2 = MR_ctfield(0, MR_r3, 0);
	MR_r3 = MR_ctfield(0, MR_r4, 0);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___stream__maybe_partial_res_2_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___stream__maybe_partial_res_2_0_i8);
MR_def_label(__Unify___stream__maybe_partial_res_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___stream__maybe_partial_res_2_0_i1);
	}
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___stream__maybe_partial_res_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(stream_module22)
	...
	MR_init_label5(__Compare___stream__maybe_partial_res_2_0,5,3,40,10,37)
MR_BEGIN_CODE
...
MR_def_label(__Compare___stream__maybe_partial_res_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(__Compare___stream__maybe_partial_res_2_0_i40);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___stream__maybe_partial_res_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___stream__maybe_partial_res_2_0_i10);
MR_def_label(__Compare___stream__maybe_partial_res_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___stream__maybe_partial_res_2_0_i37);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___stream__maybe_partial_res_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(stream_module25)
	...
	MR_init_label2(__Unify___stream__res_1_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__res_1_0);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Unify___stream__res_1_0_i3);
	}
	MR_r1 = (MR_r3 == MR_r2);
	MR_proceed();
MR_def_label(__Unify___stream__res_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(stream_module26)
	...
	MR_init_label3(__Compare___stream__res_1_0,5,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___stream__res_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Compare___stream__res_1_0_i3);
	}
...
MR_def_label(__Compare___stream__res_1_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___stream__res_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
...
MR_BEGIN_MODULE(stream_module27)
	...
	MR_init_label2(__Unify___stream__result_1_0,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__result_1_0);
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Unify___stream__result_1_0_i4);
	}
	MR_r1 = (MR_r3 == MR_r2);
	MR_proceed();
MR_def_label(__Unify___stream__result_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(stream_module28)
	...
	MR_init_label5(__Compare___stream__result_1_0,22,5,12,4,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___stream__result_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i4);
	}
...
MR_def_label(__Compare___stream__result_1_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___stream__result_1_0,5)
	...
	if (MR_INT_NE(MR_unmkbody(MR_r3),0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i22);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___stream__result_1_0,12)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___stream__result_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___stream__result_1_0_i16);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___stream__result_1_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_ctfield(1, MR_r2, 0);
	MR_r3 = MR_ctfield(1, MR_r3, 0);
	MR_np_tailcall_ent(builtin__compare_3_0);
...
MR_BEGIN_MODULE(stream_module29)
	...
	MR_init_label3(__Unify___stream__result_2_0,8,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___stream__result_2_0);
	...
	if (MR_PTAG_TEST(MR_r3,1)) {
		MR_GOTO_LAB(__Unify___stream__result_2_0_i4);
	}
	if (MR_PTAG_TEST(MR_r3,2)) {
		MR_GOTO_LAB(__Unify___stream__result_2_0_i8);
	}
	MR_r1 = (MR_r4 == MR_r3);
	MR_proceed();
MR_def_label(__Unify___stream__result_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___stream__result_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r4,1)) {
		MR_GOTO_LAB(__Unify___stream__result_2_0_i1);
	}
...
MR_BEGIN_MODULE(stream_module30)
	...
	MR_init_label6(__Compare___stream__result_2_0,10,25,14,4,27,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___stream__result_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r3,1)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i4);
	}
	if (MR_PTAG_TEST(MR_r3,2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i10);
	}
	if (MR_PTAG_TEST(MR_r4,1)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i25);
	}
	if (MR_PTAG_TEST(MR_r4,2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i27);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___stream__result_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r4,1)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i25);
	}
	if (MR_PTAG_TEST(MR_r4,2)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i14);
	}
MR_def_label(__Compare___stream__result_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___stream__result_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_ctfield(2, MR_r3, 0);
	MR_r3 = MR_ctfield(2, MR_r4, 0);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___stream__result_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r4,1)) {
		MR_GOTO_LAB(__Compare___stream__result_2_0_i7);
	}
MR_def_label(__Compare___stream__result_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
...
void mercury__stream__write_out_proc_statics(FILE *fp);
#endif
