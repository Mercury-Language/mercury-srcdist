...
mercury__stream__seek64_5_p_0(
  ...
  MR_Box * HeadVar__5_5)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_seekable_6, (MR_Integer) 0)), (MR_Integer) 6))));
...
mercury__stream__unboxed_get_5_p_0(
  ...
  MR_Box * HeadVar__5_5)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box *, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_unboxed_reader_6, (MR_Integer) 0)), (MR_Integer) 5))));
  MR_Box conv1_HeadVar__2_2;
...
#undef MR_PROC_LABEL
    ...
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_reader_15, (MR_Integer) 0)), (MR_Integer) 5))));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            void MR_CALL (* func_2)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_putback_14, (MR_Integer) 0)), (MR_Integer) 5))));
  ...
  MR_Box * STATE_VARIABLE_S_14)
{
  while (MR_TRUE)
  {
    ...
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_reader_17, (MR_Integer) 0)), (MR_Integer) 5))));
  ...
  MR_Box * STATE_VARIABLE_S_17)
{
  while (MR_TRUE)
  {
    MR_Word Result_12;
    MR_Box STATE_VARIABLE_S_18_18;
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_reader_19, (MR_Integer) 0)), (MR_Integer) 5))));
