...
void mercury__bool__write_out_proc_statics(FILE *fp);
#endif
...
void mercury__bool__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		...
		MR_field(MR_mktag(0), mercury_data___base_typeclass_info_enum__enum__arity1__bool__bool__arity0__, 5) =
			MR_ENTRY_AP(fn__bool__ClassMethod_for_enum__enum____bool__bool__arity0______enum__to_int_1_1_0);
		MR_field(MR_mktag(0), mercury_data___base_typeclass_info_enum__enum__arity1__bool__bool__arity0__, 6) =
