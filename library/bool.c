              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    MR_Word mercury__bool__next_value_of_HeadVar__1_1 = mercury__bool__Bools_4;

                    mercury__bool__HeadVar__1_1 = mercury__bool__next_value_of_HeadVar__1_1;
                  }
                  continue;
                }
                break;
  ...
  MR_Box mercury__bool__wrapper_arg_1)
{
  {
    MR_Box mercury__bool__wrapper_arg_2;
    MR_Box mercury__bool__closure = mercury__bool__closure_arg;
