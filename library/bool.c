  ...
  MR_Word P_3)
{
  MR_bool succeeded;
  MR_Word HeadVar__2_2;
  MR_bool MR_CALL (* func_0)(MR_Box) = ((MR_bool MR_CALL (*)(MR_Box)) ((MR_hl_field(0, P_3, 1))));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Bool_3 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Bools_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
