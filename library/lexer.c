        ...
        else
          {
            ...
            if ((mercury__lexer__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              *mercury__lexer__HeadVar__1_1 = (MR_Integer) 1;
              ...
              {
                MR_Word mercury__lexer__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__3_3, (MR_Integer) 0)));
                MR_Integer mercury__lexer__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
                MR_Word mercury__lexer__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__3_3, (MR_Integer) 2)));
                MR_Word mercury__lexer__Var_10;

                {
                  mercury__lexer____Compare____token_0_0(&mercury__lexer__Var_10, mercury__lexer__Var_25, mercury__lexer__ArgY1_5);
                }
                ...
                if (mercury__lexer__succeeded)
                  *mercury__lexer__HeadVar__1_1 = mercury__lexer__Var_10;
                else
                  {
                    ...
                    mercury__lexer__succeeded = (mercury__lexer__Var_24 < mercury__lexer__ArgY2_7);
                    if (mercury__lexer__succeeded)
                      ...
                      *mercury__lexer__HeadVar__1_1 = mercury__lexer__Var_11;
                    else
                      {
                        /* direct tailcall eliminated */
                        {
                          ...
                          MR_Word mercury__lexer__next_value_of_HeadVar__3_3 = mercury__lexer__ArgY3_9;
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((mercury__lexer__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word mercury__lexer__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word mercury__lexer__ArgY1_4;
            MR_Integer mercury__lexer__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
            MR_Integer mercury__lexer__ArgY2_6;
            MR_Word mercury__lexer__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__1_1, (MR_Integer) 2)));
            MR_Word mercury__lexer__ArgY3_8;

            mercury__lexer__succeeded = ((MR_tag((MR_Word) mercury__lexer__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mercury__lexer__succeeded)
              {
                mercury__lexer__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)));
                mercury__lexer__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                mercury__lexer__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__2_2, (MR_Integer) 2)));
                {
                  mercury__lexer__succeeded = mercury__lexer____Unify____token_0_0(mercury__lexer__ArgX1_3, mercury__lexer__ArgY1_4);
                }
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__succeeded = (mercury__lexer__ArgX2_5 == mercury__lexer__ArgY2_6);
                    if (mercury__lexer__succeeded)
                      {
                        /* direct tailcall eliminated */
                        {
                          MR_Word mercury__lexer__next_value_of_HeadVar__1_1 = mercury__lexer__ArgX3_7;
                          MR_Word mercury__lexer__next_value_of_HeadVar__2_2 = mercury__lexer__ArgY3_8;
              ...
              *mercury__lexer__HeadVar__1_1 = (MR_Integer) 2;
            else
              {
                ...
                switch (MR_tag((MR_Word) mercury__lexer__HeadVar__2_2)) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_String mercury__lexer__ArgX1_7 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)));
                      MR_String mercury__lexer__ArgY1_8;
                      ...
                      if (mercury__lexer__succeeded)
                        {
                          mercury__lexer__ArgY1_8 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__3_3, (MR_Integer) 0)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	S1 =  mercury__lexer__ArgX1_7 ;
	S2 =  mercury__lexer__ArgY1_8 ;
		{
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_7_94  = Res;
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_String mercury__lexer__ArgX1_9 = ((MR_String) (MR_hl_field(MR_mktag(2), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)));
                      MR_String mercury__lexer__ArgY1_10;
                      ...
                      if (mercury__lexer__succeeded)
                        {
                          mercury__lexer__ArgY1_10 = ((MR_String) (MR_hl_field(MR_mktag(2), mercury__lexer__HeadVar__3_3, (MR_Integer) 0)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	S1 =  mercury__lexer__ArgX1_9 ;
	S2 =  mercury__lexer__ArgY1_10 ;
		{
	 ...
	 mercury__lexer__V_7_104  = Res;
                  ...
                  case (MR_Integer) 3:
                    switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)))) {
                      ...
                      case (MR_Integer) 0:
                        {
                          MR_Word mercury__lexer__ArgX1_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_Word mercury__lexer__ArgY1_12;
                          MR_Word mercury__lexer__ArgX2_13 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 2)));
                          MR_Word mercury__lexer__ArgY2_14;
                          MR_Word mercury__lexer__ArgX3_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 3)));
                          MR_Word mercury__lexer__ArgY3_16;
                          MR_Word mercury__lexer__ArgX4_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 4)));
                          MR_Word mercury__lexer__ArgY4_18;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
                              mercury__lexer__ArgY2_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 2)));
                              mercury__lexer__ArgY3_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 3)));
                              mercury__lexer__ArgY4_18 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 4)));
                              mercury__lexer__Var_51 = (MR_Integer) mercury__lexer__ArgX1_11;
                              mercury__lexer__Var_52 = (MR_Integer) mercury__lexer__ArgY1_12;
                              ...
                              if (mercury__lexer__succeeded)
                              ...
                              else
                                {
                                  ...
                                  {
                                    mercury__integer____Compare____integer_0_0(&mercury__lexer__Var_20, mercury__lexer__ArgX2_13, mercury__lexer__ArgY2_14);
                                  }
                                  ...
                                  if (mercury__lexer__succeeded)
                                  ...
                                  else
                                    {
                                      ...
                                      MR_Integer mercury__lexer__Var_53 = (MR_Integer) mercury__lexer__ArgX3_15;
                                      MR_Integer mercury__lexer__Var_54 = (MR_Integer) mercury__lexer__ArgY3_16;
                                      ...
                                      if (mercury__lexer__succeeded)
                                        ...
                                        {
                                          MR_Integer mercury__lexer__Var_55 = (MR_Integer) mercury__lexer__ArgX4_17;
                                          MR_Integer mercury__lexer__Var_56 = (MR_Integer) mercury__lexer__ArgY4_18;
                      ...
                      case (MR_Integer) 1:
                        {
                          MR_Float mercury__lexer__ArgX1_22 = MR_unbox_float((MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_Float mercury__lexer__ArgY1_23;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_23 = MR_unbox_float((MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
                              mercury__lexer__succeeded = (mercury__lexer__ArgX1_22 < mercury__lexer__ArgY1_23);
                              if (mercury__lexer__succeeded)
                                mercury__lexer__Var_6 = (MR_Integer) 1;
                              else
                                {
                      ...
                      case (MR_Integer) 2:
                        {
                          MR_String mercury__lexer__ArgX1_24 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_String mercury__lexer__ArgY1_25;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_25 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	S1 =  mercury__lexer__ArgX1_24 ;
	S2 =  mercury__lexer__ArgY1_25 ;
		{
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_7_99  = Res;
                      ...
                      case (MR_Integer) 3:
                        {
                          MR_String mercury__lexer__ArgX1_26 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_String mercury__lexer__ArgY1_27;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_27 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	S1 =  mercury__lexer__ArgX1_26 ;
	S2 =  mercury__lexer__ArgY1_27 ;
		{
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_7_70  = Res;
                      ...
                      case (MR_Integer) 4:
                        {
                          MR_Char mercury__lexer__ArgX1_28 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_Char mercury__lexer__ArgY1_29;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_29 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	Character =  mercury__lexer__ArgX1_28 ;
		{
...
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	Character =  mercury__lexer__ArgY1_29 ;
		{
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_8_90  = Int;
                      ...
                      case (MR_Integer) 5:
                        {
                          MR_String mercury__lexer__ArgX1_30 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_String mercury__lexer__ArgY1_31;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_31 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
	...
	S1 =  mercury__lexer__ArgX1_30 ;
	S2 =  mercury__lexer__ArgY1_31 ;
		{
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_7_62  = Res;
                      ...
                      case (MR_Integer) 6:
                        {
                          MR_Word mercury__lexer__ArgX1_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_Word mercury__lexer__ArgY1_33;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
                              mercury__lexer__Var_57 = (MR_String) mercury__lexer__ArgX1_32;
                              mercury__lexer__Var_58 = (MR_String) mercury__lexer__ArgY1_33;
{
#define MR_PROC_LABEL mercury__lexer____Compare____token_0_0
...
#undef MR_PROC_LABEL
	 mercury__lexer__V_7_84  = Res;
                      ...
                      case (MR_Integer) 7:
                        {
                          MR_Word mercury__lexer__ArgX1_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                          MR_Word mercury__lexer__ArgY1_35;
                          ...
                          if (mercury__lexer__succeeded)
                            {
                              mercury__lexer__ArgY1_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__3_3, (MR_Integer) 1)));
                              {
                                mercury__integer____Compare____integer_0_0(&mercury__lexer__Var_6, mercury__lexer__ArgX1_34, mercury__lexer__ArgY1_35);
                              }
                              mercury__lexer__succeeded = MR_TRUE;
                            }
                        }
...
{
  {
    ...
    if (mercury__lexer__succeeded)
      ...
      switch (MR_tag((MR_Word) mercury__lexer__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String mercury__lexer__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__1_1, (MR_Integer) 0)));
            MR_String mercury__lexer__ArgY1_4;

            mercury__lexer__succeeded = ((MR_tag((MR_Word) mercury__lexer__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mercury__lexer__succeeded)
              {
                mercury__lexer__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)));
                mercury__lexer__succeeded = (strcmp(mercury__lexer__ArgX1_3, mercury__lexer__ArgY1_4) == 0);
              }
          }
          break;
        case (MR_Integer) 2:
          {
            MR_String mercury__lexer__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(2), mercury__lexer__HeadVar__1_1, (MR_Integer) 0)));
            MR_String mercury__lexer__ArgY1_6;

            mercury__lexer__succeeded = ((MR_tag((MR_Word) mercury__lexer__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (mercury__lexer__succeeded)
              {
                mercury__lexer__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(2), mercury__lexer__HeadVar__2_2, (MR_Integer) 0)));
                mercury__lexer__succeeded = (strcmp(mercury__lexer__ArgX1_5, mercury__lexer__ArgY1_6) == 0);
              }
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word mercury__lexer__ArgX1_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_Word mercury__lexer__ArgY1_8;
                MR_Word mercury__lexer__ArgX2_9 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 2)));
                MR_Word mercury__lexer__ArgY2_10;
                MR_Word mercury__lexer__ArgX3_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 3)));
                MR_Word mercury__lexer__ArgY3_12;
                MR_Word mercury__lexer__ArgX4_13 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 4)));
                MR_Word mercury__lexer__ArgY4_14;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__ArgY2_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 2)));
                    mercury__lexer__ArgY3_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 3)));
                    mercury__lexer__ArgY4_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 4)));
                    mercury__lexer__succeeded = (mercury__lexer__ArgX1_7 == mercury__lexer__ArgY1_8);
                    if (mercury__lexer__succeeded)
                      {
                        {
                          mercury__lexer__succeeded = mercury__integer____Unify____integer_0_0(mercury__lexer__ArgX2_9, mercury__lexer__ArgY2_10);
                        }
                        if (mercury__lexer__succeeded)
                          {
                            mercury__lexer__succeeded = (mercury__lexer__ArgX3_11 == mercury__lexer__ArgY3_12);
                            if (mercury__lexer__succeeded)
                              mercury__lexer__succeeded = (mercury__lexer__ArgX4_13 == mercury__lexer__ArgY4_14);
                          }
                      }
                  }
              }
            ...
            case (MR_Integer) 1:
              {
                MR_Float mercury__lexer__ArgX1_15 = MR_unbox_float((MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_Float mercury__lexer__ArgY1_16;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_16 = MR_unbox_float((MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__succeeded = (mercury__lexer__ArgX1_15 == mercury__lexer__ArgY1_16);
                  }
              }
              break;
            case (MR_Integer) 2:
              {
                MR_String mercury__lexer__ArgX1_17 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_String mercury__lexer__ArgY1_18;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_18 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__succeeded = (strcmp(mercury__lexer__ArgX1_17, mercury__lexer__ArgY1_18) == 0);
                  }
              }
              break;
            case (MR_Integer) 3:
              {
                MR_String mercury__lexer__ArgX1_19 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_String mercury__lexer__ArgY1_20;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_20 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__succeeded = (strcmp(mercury__lexer__ArgX1_19, mercury__lexer__ArgY1_20) == 0);
                  }
              }
              break;
            case (MR_Integer) 4:
              {
                MR_Char mercury__lexer__ArgX1_41 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_Char mercury__lexer__ArgY1_42;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_42 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__succeeded = (mercury__lexer__ArgX1_41 == mercury__lexer__ArgY1_42);
                  }
              }
              break;
            case (MR_Integer) 5:
              {
                MR_String mercury__lexer__ArgX1_43 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_String mercury__lexer__ArgY1_44;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_44 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__succeeded = (strcmp(mercury__lexer__ArgX1_43, mercury__lexer__ArgY1_44) == 0);
                  }
              }
              break;
            case (MR_Integer) 6:
              {
                MR_Word mercury__lexer__ArgX1_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_Word mercury__lexer__ArgY1_46;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    mercury__lexer__Var_56 = (MR_String) mercury__lexer__ArgX1_45;
                    mercury__lexer__Var_57 = (MR_String) mercury__lexer__ArgY1_46;
            ...
            case (MR_Integer) 7:
              {
                MR_Word mercury__lexer__ArgX1_49 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__1_1, (MR_Integer) 1)));
                MR_Word mercury__lexer__ArgY1_50;
                ...
                if (mercury__lexer__succeeded)
                  {
                    mercury__lexer__ArgY1_50 = ((MR_Word) (MR_hl_field(MR_mktag(3), mercury__lexer__HeadVar__2_2, (MR_Integer) 1)));
                    {
                      mercury__lexer__succeeded = mercury__integer____Unify____integer_0_0(mercury__lexer__ArgX1_49, mercury__lexer__ArgY1_50);
                    }
                  }
              }
              break;
...
{
  {
    ...
    if (mercury__lexer__succeeded)
      *mercury__lexer__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__lexer__ArgX1_4 = (MR_Integer) mercury__lexer__HeadVar__2_2;
        MR_Integer mercury__lexer__ArgY1_5 = (MR_Integer) mercury__lexer__HeadVar__3_3;

        mercury__lexer__succeeded = (mercury__lexer__ArgX1_4 < mercury__lexer__ArgY1_5);
        if (mercury__lexer__succeeded)
          *mercury__lexer__HeadVar__1_1 = (MR_Integer) 1;
        else
          {
...
{
  {
    ...
    if (mercury__lexer__succeeded)
      ...
      {
        MR_Integer mercury__lexer__ArgX1_3 = (MR_Integer) mercury__lexer__HeadVar__1_1;
        MR_Integer mercury__lexer__ArgY1_4 = (MR_Integer) mercury__lexer__HeadVar__2_2;

        mercury__lexer__succeeded = (mercury__lexer__ArgX1_3 == mercury__lexer__ArgY1_4);
      }
    return mercury__lexer__succeeded;
  }
}
...
{
  {
    ...
    if ((((MR_Unsigned) (mercury__lexer__Char_3 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
      if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_3 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_3 - (MR_Integer) 9)) & (MR_Integer) 31))))))
        {
          *mercury__lexer__Action_4 = ((&mercury__lexer_vector_common_7[944 + (mercury__lexer__Char_3 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
          mercury__lexer__succeeded = MR_TRUE;
        }
      else
          ...
          case (MR_Integer) 0:
            {
              ...
              if ((((MR_Unsigned) (mercury__lexer__Char_13 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_13 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_13 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                  {
                    mercury__lexer__Action_15 = ((&mercury__lexer_vector_common_7[826 + (mercury__lexer__Char_13 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                    mercury__lexer__succeeded = MR_TRUE;
                  }
                else
                  mercury__lexer__succeeded = MR_FALSE;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word mercury__lexer__Var_77 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[37]);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word mercury__lexer__Var_71 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[37]);
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_String mercury__lexer__Prefix_12 = ((&mercury__lexer_vector_common_9[0 + mercury__lexer__Base_7]))->mercury__lexer__vector_common_type_9_0__vct_9_f_1;
              ...
              mercury__lexer__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[37]);
              {
...
#undef MR_PROC_LABEL
	 mercury__lexer__FloatString_15  = Str;
              ...
              mercury__lexer__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[37]);
              {
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word mercury__lexer__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[40]);
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word mercury__lexer__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[37]);
...
#undef MR_PROC_LABEL
	 mercury__lexer__Code_18  = Int;
              ...
              mercury__lexer__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[39]);
              {
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word mercury__lexer__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[36]);
          ...
          case (MR_Integer) 7:
            {
              ...
              mercury__lexer__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[38]);
              {
    ...
    if (mercury__lexer__succeeded)
      {
        ...
        if ((((MR_Unsigned) (mercury__lexer__Char_25 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
          if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_25 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_25 - (MR_Integer) 9)) & (MR_Integer) 31))))))
            {
              mercury__lexer__Action_26 = ((&mercury__lexer_vector_common_7[708 + (mercury__lexer__Char_25 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
              mercury__lexer__succeeded = MR_TRUE;
            }
          else
            mercury__lexer__succeeded = MR_FALSE;
            ...
            case (MR_Integer) 11:
              {
                ...
                *mercury__lexer__Token_9 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[3]);
              }
              break;
            case (MR_Integer) 12:
              {
        ...
        if (mercury__lexer__succeeded)
          {
            ...
            if ((((MR_Unsigned) (mercury__lexer__Char_15 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
              if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_15 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_15 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                {
                  mercury__lexer__Action_16 = ((&mercury__lexer_vector_common_7[590 + (mercury__lexer__Char_15 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                  mercury__lexer__succeeded = MR_TRUE;
                }
              else
                mercury__lexer__succeeded = MR_FALSE;
                ...
                case (MR_Integer) 11:
                  {
                    ...
                    *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[3]);
                  }
                  break;
                case (MR_Integer) 12:
                  {
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
    ...
    if (mercury__lexer__succeeded)
                                            ...
                                            if (mercury__lexer__succeeded)
                                            ...
                                            else
                                              {
                                                ...
                                                *mercury__lexer__Context_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 0)));
                                                ...
                                                mercury__lexer__Var_39 = (MR_Word) &mercury__lexer_scalar_common_4[34];
    ...
    else
      {
        ...
        mercury__lexer__Var_44 = (MR_Word) &mercury__lexer_scalar_common_4[34];
        *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_3[2]);
      }
  }
}
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[31]);
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                              ...
                              if (mercury__lexer__succeeded)
                                ...
                                {
                                  *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[28]);
                                }
                            }
                            break;
                          case (MR_Integer) 0:
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
        ...
        if (mercury__lexer__succeeded)
          ...
          {
            *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[28]);
          }
        {
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                      ...
                      case (MR_Integer) 0:
                        {
                          *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[29]);
                          *mercury__lexer__STATE_VARIABLE_Posn_20 = mercury__lexer__STATE_VARIABLE_Posn_26_26;
                        }
                        break;
                    }
            ...
            else
              {
                ...
                if (mercury__lexer__succeeded)
                ...
                else
                  {
                    ...
                    *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[27]);
                    *mercury__lexer__Context_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 0)));
...
#undef MR_PROC_LABEL
	 mercury__lexer__BinaryString_18  = SubString;
                              ...
                              case (MR_Integer) 0:
                                {
                                  *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[27]);
            ...
            else
              {
                ...
                if (mercury__lexer__succeeded)
                ...
                else
                  {
                    ...
                    *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[26]);
                    *mercury__lexer__Context_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 0)));
                    mercury__lexer__Var_45 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 1)));
                    mercury__lexer__Var_46 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 2)));
                  }
...
#undef MR_PROC_LABEL
	 mercury__lexer__BinaryString_18  = SubString;
                              ...
                              case (MR_Integer) 0:
                                {
                                  *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[26]);
                                  mercury__lexer__STATE_VARIABLE_Posn_37_37 = mercury__lexer__STATE_VARIABLE_Posn_35_35;
                                }
                                break;
                            }
            ...
            else
              {
                ...
                if (mercury__lexer__succeeded)
                ...
                else
                  {
                    ...
                    *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[25]);
                    *mercury__lexer__Context_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 0)));
                    mercury__lexer__Var_45 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 1)));
                    mercury__lexer__Var_46 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 2)));
                  }
...
#undef MR_PROC_LABEL
	 mercury__lexer__BinaryString_18  = SubString;
                              ...
                              case (MR_Integer) 0:
                                {
                                  *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[25]);
                                  mercury__lexer__STATE_VARIABLE_Posn_37_37 = mercury__lexer__STATE_VARIABLE_Posn_35_35;
                                }
                                break;
                            }
                ...
                else
                  {
                    ...
                    if (mercury__lexer__succeeded)
                    ...
                    else
                      {
                        ...
                        if (mercury__lexer__succeeded)
                          {
                            *mercury__lexer__Token_16 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[24]);
                            *mercury__lexer__STATE_VARIABLE_Posn_24 = mercury__lexer__STATE_VARIABLE_Posn_25_25;
                          }
                        else
                          {
...
#undef MR_PROC_LABEL
	 mercury__lexer__DigitString_23  = SubString;
          ...
          {
            *mercury__lexer__Token_20 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[24]);
          }
      }
    else
      {
                    ...
                    if (mercury__lexer__succeeded)
                    ...
                    else
                      {
                        ...
                        *mercury__lexer__HaveToken_12 = (MR_Word) mercury__lexer__Context_83;
                        ...
                        mercury__lexer__Var_31 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[19]);
                        {
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                    ...
                    mercury__lexer__Var_41 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[19]);
                    {
        ...
        else
          {
            ...
            *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[18]);
          }
      }
      break;
    }
        ...
        else
          {
            ...
            if (mercury__lexer__succeeded)
            ...
            else
              {
                ...
                *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[2]);
                *mercury__lexer__Context_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_10, (MR_Integer) 0)));
...
{
  {
    ...
    if (mercury__lexer__succeeded)
    ...
    else
      {
        ...
        if (mercury__lexer__succeeded)
          {
            *mercury__lexer__Token_15 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[15]);
          }
        else
          *mercury__lexer__Token_15 = mercury__lexer__Token0_18;
        *mercury__lexer__STATE_VARIABLE_Posn_24 = mercury__lexer__STATE_VARIABLE_Posn_25_25;
            ...
            else
              {
                ...
                if (mercury__lexer__succeeded)
                  if ((mercury__lexer__STATE_VARIABLE_RevOctalChars_0_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      *mercury__lexer__Token_17 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[12]);
                      {
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        ...
                        {
                          *mercury__lexer__Token_17 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[13]);
                          {
                            mercury__lexer__string_get_context_4_p_0(mercury__lexer__Posn0_16, mercury__lexer__Context_18, mercury__lexer__STATE_VARIABLE_Posn_25_25, mercury__lexer__STATE_VARIABLE_Posn_24);
                          }
                        }
                  ...
                  if ((mercury__lexer__STATE_VARIABLE_RevHexChars_0_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      ...
                      *mercury__lexer__Token_17 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[9]);
                    }
                  else
                    {
                      MR_Integer mercury__lexer__Int_64;
                      ...
                      if (mercury__lexer__succeeded)
                      ...
                      else
                        {
                          ...
                          *mercury__lexer__Token_17 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[10]);
                        }
                    }
                else
                  {
                    ...
                    *mercury__lexer__Context_18 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_16, (MR_Integer) 0)));
                    ...
                    mercury__lexer__Var_89 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mercury__lexer__Posn0_16, (MR_Integer) 2)));
                    *mercury__lexer__STATE_VARIABLE_Posn_24 = mercury__lexer__STATE_VARIABLE_Posn_25_25;
                    *mercury__lexer__Token_17 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[11]);
                  }
              }
          }
        else
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
            ...
            if (mercury__lexer__succeeded)
                ...
                if (mercury__lexer__succeeded)
                  {
                    ...
                    *mercury__lexer__Token_19 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[5]);
                  }
                else
                  {
            ...
            else
              {
                ...
                *mercury__lexer__STATE_VARIABLE_Posn_29 = mercury__lexer__STATE_VARIABLE_Posn_0_28;
                *mercury__lexer__Token_19 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[7]);
              }
          }
        else
          {
            ...
            if (mercury__lexer__succeeded)
              {
                ...
                if (mercury__lexer__succeeded)
                ...
                else
                  {
                    ...
                    *mercury__lexer__Token_19 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[8]);
                  }
              }
            else
              {
                                ...
                                else
                                  {
                                    ...
                                    if (mercury__lexer__succeeded)
                                    ...
                                    else
                                      {
                                        ...
                                        *mercury__lexer__Token_15 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[6]);
                                      }
                                  }
                              }
                          }
        ...
        else
          {
            ...
            if (mercury__lexer__succeeded)
            ...
            else
              {
                ...
                *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[1]);
              }
          }
      }
    else
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
        ...
        if (mercury__lexer__succeeded)
        ...
        else
          {
            ...
            *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[2]);
          }
      }
      break;
    }
        ...
        else
          {
            ...
            if (mercury__lexer__succeeded)
            ...
            else
              {
                ...
                *mercury__lexer__Token_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[0]);
              }
          }
      }
    else
...
{
  {
    ...
    switch (mercury__lexer__Char_4) {
      ...
      case (MR_Char) 59:
        {
          mercury__lexer__SpecialToken_7 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[4]);
          mercury__lexer__succeeded = MR_TRUE;
        }
        break;
      case (MR_Char) 91:
                        ...
                        if (mercury__lexer__succeeded)
                        ...
                        else
                          {
                            ...
                            if (mercury__lexer__succeeded)
                              {
                                MR_Word mercury__lexer__Var_63;
                                MR_Word mercury__lexer__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[1]);
                            ...
                            else
                              {
                                ...
                                mercury__lexer__Token1_16 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[0]);
                              }
                          }
                      }
                      break;
          ...
          case (MR_Integer) 0:
            {
              ...
              if ((((MR_Unsigned) (mercury__lexer__Char_22 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_22 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_22 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                  {
                    mercury__lexer__Action_24 = ((&mercury__lexer_vector_common_7[472 + (mercury__lexer__Char_22 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                    mercury__lexer__succeeded = MR_TRUE;
                  }
                else
                  mercury__lexer__succeeded = MR_FALSE;
          ...
          case (MR_Integer) 11:
            {
              ...
              *mercury__lexer__Token_13 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[3]);
            }
            break;
          case (MR_Integer) 12:
            {
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            if ((((MR_Unsigned) (mercury__lexer__Char_101 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                              if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_101 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_101 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                                {
                                  mercury__lexer__Action_103 = ((&mercury__lexer_vector_common_7[0 + (mercury__lexer__Char_101 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                                  mercury__lexer__succeeded = MR_TRUE;
                                }
                              else
                                mercury__lexer__succeeded = MR_FALSE;
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            if ((((MR_Unsigned) (mercury__lexer__Char_165 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                              if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_165 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_165 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                                {
                                  mercury__lexer__Action_167 = ((&mercury__lexer_vector_common_7[118 + (mercury__lexer__Char_165 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                                  mercury__lexer__succeeded = MR_TRUE;
                                }
                              else
                                mercury__lexer__succeeded = MR_FALSE;
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            if ((((MR_Unsigned) (mercury__lexer__Char_229 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                              if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_229 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_229 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                                {
                                  mercury__lexer__Action_231 = ((&mercury__lexer_vector_common_7[236 + (mercury__lexer__Char_229 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                                  mercury__lexer__succeeded = MR_TRUE;
                                }
                              else
                                mercury__lexer__succeeded = MR_FALSE;
          ...
          case (MR_Integer) 5:
            {
              ...
              switch (mercury__lexer__Char_10) {
                ...
                case (MR_Char) 59:
                  {
                    mercury__lexer__SpecialToken_288 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[4]);
                    mercury__lexer__succeeded = MR_TRUE;
                  }
                  break;
                case (MR_Char) 91:
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        if ((((MR_Unsigned) (mercury__lexer__Char_299 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                          if ((((mercury__lexer_scalar_common_8[0])[(((mercury__lexer__Char_299 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__lexer__Char_299 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                            {
                              mercury__lexer__Action_301 = ((&mercury__lexer_vector_common_7[354 + (mercury__lexer__Char_299 - (MR_Integer) 9)]))->mercury__lexer__vector_common_type_7_0__vct_7_f_0;
                              mercury__lexer__succeeded = MR_TRUE;
                            }
                          else
                            mercury__lexer__succeeded = MR_FALSE;
    ...
    switch (MR_tag((MR_Word) mercury__lexer__Result_8)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(mercury__lexer__Result_8)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (mercury__lexer__succeeded)
              ...
              else
                {
                  ...
                  if (mercury__lexer__succeeded)
                    {
                      MR_Word mercury__lexer__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[35]);
                              ...
                              else
                                {
                                  ...
                                  if (mercury__lexer__succeeded)
                                  ...
                                  else
                                    {
                                      ...
                                      if (mercury__lexer__succeeded)
                                        {
                                          MR_Word mercury__lexer__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[35]);
                                          MR_Word mercury__lexer__Var_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                      ...
                                      else
                                        {
                                          ...
                                          if (mercury__lexer__succeeded)
                                            {
                                              MR_Word mercury__lexer__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[35]);
                                              MR_Word mercury__lexer__Var_37 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                          ...
                                          else
                                            {
                                              ...
                                              if (mercury__lexer__succeeded)
                                                {
                                                  MR_Word mercury__lexer__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[35]);
                                              ...
                                              else
                                                {
                                                  ...
                                                  if (mercury__lexer__succeeded)
                                                    {
                                                      MR_Word mercury__lexer__Var_42;
                                                      MR_Word mercury__lexer__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[35]);
                                                  ...
                                                  else
                                                    {
                                                      ...
                                                      mercury__lexer__Var_49 = (MR_Word) &mercury__lexer_scalar_common_4[34];
          ...
          case (MR_Integer) 1:
            {
              MR_Word mercury__lexer__Var_53 = (MR_Word) &mercury__lexer_scalar_common_4[34];
...
{
  {
    ...
    if (mercury__lexer__succeeded)
      ...
      {
        *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[23]);
      }
  }
}
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            if (mercury__lexer__succeeded)
                              ...
                              {
                                mercury__lexer__Token0_15 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[23]);
                              }
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                                        ...
                                        if (mercury__lexer__succeeded)
                                          ...
                                          {
                                            *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[28]);
                                          }
                                      }
                                    else
                                      {
              ...
              else
                {
                  ...
                  if (mercury__lexer__succeeded)
                  ...
                  else
                    {
                      ...
                      *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[29]);
                    }
                }
            }
            break;
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                  ...
                  if (mercury__lexer__succeeded)
                    ...
                    {
                      *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[28]);
                    }
                }
              else
                {
                  *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[23]);
                }
            }
            break;
        }
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                            ...
                            case (MR_Integer) 0:
                              {
                                *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[29]);
                              }
                              break;
                          }
                        }
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                      ...
                      else
                        {
                          ...
                          *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[27]);
                        }
                    }
                }
                break;
                              ...
                              if (mercury__lexer__succeeded)
                              ...
                              else
                                {
                                  ...
                                  switch (mercury__lexer__STATE_VARIABLE_LastDigit_0_15) {
                                    ...
                                    case (MR_Integer) 0:
                                      {
                                        *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[27]);
                                      }
                                      break;
                                  }
                                }
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                      ...
                      else
                        {
                          ...
                          *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[26]);
                        }
                    }
                }
                break;
                              ...
                              if (mercury__lexer__succeeded)
                              ...
                              else
                                {
                                  ...
                                  switch (mercury__lexer__STATE_VARIABLE_LastDigit_0_15) {
                                    ...
                                    case (MR_Integer) 0:
                                      {
                                        *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[26]);
                                      }
                                      break;
                                  }
                                }
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                      ...
                      else
                        {
                          ...
                          *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[25]);
                        }
                    }
                }
                break;
                              ...
                              if (mercury__lexer__succeeded)
                              ...
                              else
                                {
                                  ...
                                  switch (mercury__lexer__STATE_VARIABLE_LastDigit_0_15) {
                                    ...
                                    case (MR_Integer) 0:
                                      {
                                        *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[25]);
                                      }
                                      break;
                                  }
                                }
              ...
              if (mercury__lexer__succeeded)
                {
                  ...
                  if (mercury__lexer__succeeded)
                    ...
                    {
                      *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[23]);
                    }
                }
              else
                {
                      ...
                      else
                        {
                          ...
                          if (mercury__lexer__succeeded)
                          ...
                          else
                            {
                              ...
                              if (mercury__lexer__succeeded)
                                {
                                  *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[24]);
                                }
                              else
                                {
                                  MR_String mercury__lexer__String_74;
              ...
              if (mercury__lexer__succeeded)
                {
                  ...
                  if (mercury__lexer__succeeded)
                    ...
                    {
                      *mercury__lexer__Token_16 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[23]);
                    }
                }
              else
                {
  ...
  MR_Word * mercury__lexer__Token_10)
{
  {
    MR_bool mercury__lexer__succeeded;
    MR_Integer mercury__lexer__BaseInt_11 = ((&mercury__lexer_vector_common_6[0 + mercury__lexer__Base_7]))->mercury__lexer__vector_common_type_6_0__vct_6_f_0;
...
#undef MR_PROC_LABEL
	 mercury__lexer__CharCode_11  = Int;
          ...
          case (MR_Integer) 1:
            {
              *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[22]);
            }
            break;
        }
        break;
                  ...
                  if (mercury__lexer__succeeded)
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        ...
                        {
                          *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[21]);
                        }
                    }
                }
                break;
...
#undef MR_PROC_LABEL
                          ...
                          else
                            {
                              ...
                              *mercury__lexer__Token_9 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[20]);
                            }
                        }
                      else
                        {
...
mercury__lexer__succeeded  = SUCCESS_INDICATOR;
                          ...
                          mercury__lexer__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[19]);
                          {
                            mercury__lexer__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
	 mercury__lexer__Context_77  = LineNum;
                  ...
                  *mercury__lexer__Token_9 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[18]);
                }
                break;
            }
            break;
              ...
              if (mercury__lexer__succeeded)
              ...
              else
                {
                  ...
                  if (mercury__lexer__succeeded)
                    {
                      MR_Word mercury__lexer__Var_19;
                      MR_Word mercury__lexer__Var_21 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[17]);
                  ...
                  else
                    {
                      ...
                      *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[2]);
                    }
                }
            }
            break;
                  ...
                  if (mercury__lexer__succeeded)
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        ...
                        {
                          *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[16]);
                        }
                    }
                }
                break;
...
{
  {
    ...
    if (mercury__lexer__succeeded)
    ...
    else
      {
        ...
        if (mercury__lexer__succeeded)
          {
            *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[15]);
          }
        else
          *mercury__lexer__Token_10 = mercury__lexer__Token0_12;
      }
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        if ((mercury__lexer__STATE_VARIABLE_RevOctalChars_0_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                          {
                            *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[12]);
                          }
                        else
                          {
                            ...
                            if (mercury__lexer__succeeded)
                              ...
                              {
                                *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[13]);
                              }
                          }
                      else
                        {
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        if ((mercury__lexer__STATE_VARIABLE_RevHexChars_0_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                          {
                            *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[9]);
                          }
                        else
                          {
                            MR_Integer mercury__lexer__Int_62;
                            ...
                            if (mercury__lexer__succeeded)
                              ...
                              {
                                *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[10]);
                              }
                          }
                      else
                        {
                          *mercury__lexer__Token_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[11]);
                        }
                    }
                }
                break;
            ...
            if (mercury__lexer__succeeded)
              {
                ...
                if (mercury__lexer__succeeded)
                  {
                    *mercury__lexer__Token_14 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[5]);
                  }
                else
                  {
              ...
              {
                *mercury__lexer__Token_14 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[7]);
              }
          }
        else
          {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        ...
                        {
                          *mercury__lexer__Token_14 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[8]);
                        }
                    }
                    break;
                  case (MR_Integer) 1:
                                      ...
                                      if (mercury__lexer__succeeded)
                                      ...
                                      else
                                        {
                                          ...
                                          if (mercury__lexer__succeeded)
                                            ...
                                            {
                                              *mercury__lexer__Token_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[6]);
                                            }
                                        }
                                    }
                                }
...
mercury__lexer__null_character_error_0_f_0(void)
{
  {
    MR_bool mercury__lexer__succeeded;
    MR_Word mercury__lexer__HeadVar__1_1 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[5]);
...
{
  {
    ...
    if (mercury__lexer__succeeded)
      ...
      {
        *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[4]);
      }
  }
}
                  ...
                  if (mercury__lexer__succeeded)
                    {
                      ...
                      MR_Word mercury__lexer__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[3]);
                      MR_Word mercury__lexer__Var_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...
#undef MR_PROC_LABEL
	 mercury__lexer__Context_80  = LineNum;
                  ...
                  else
                    {
                      ...
                      *mercury__lexer__Token_7 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[1]);
                    }
                }
            }
            break;
...
#undef MR_PROC_LABEL
	 mercury__lexer__Context_40  = LineNum;
                  ...
                  *mercury__lexer__Token_7 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[2]);
                }
                break;
            }
            break;
              ...
              if (mercury__lexer__succeeded)
              ...
              else
                {
                  ...
                  if (mercury__lexer__succeeded)
                    {
                      MR_Word mercury__lexer__Var_15;
                      MR_Word mercury__lexer__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_4[1]);
                  ...
                  else
                    {
                      ...
                      *mercury__lexer__Token_6 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__lexer_scalar_common_5[0]);
                    }
                }
            }
            break;
                  ...
                  if (mercury__lexer__succeeded)
                  ...
                  else
                    {
                      ...
                      if (mercury__lexer__succeeded)
                        ...
                        {
                          *mercury__lexer__Token_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__lexer_scalar_common_4[0]);
                        }
                    }
                }
                break;
