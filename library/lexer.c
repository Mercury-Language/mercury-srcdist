...
MR_def_label(lexer__get_quoted_name_6_0,12)
	...
	if (MR_INT_NE(MR_unmkbody(MR_sv(4)),0)) {
...
MR_def_label(lexer__get_unicode_escape_8_0,50)
	...
	if (MR_INT_NE(MR_unmkbody(MR_sv(6)),0)) {
...
MR_def_label(lexer__token_to_string_2_0,32)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,6,5);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("integer \140", 9);
	MR_tfield(1, MR_r1, 1) = MR_r2;
	MR_succip_word = MR_sv(1);
...
MR_def_label(lexer__token_to_string_2_0,41)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,6,6);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_def_label(lexer__token_to_string_2_0,55)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_tfield(3, MR_r1, 1);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,6,7);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
