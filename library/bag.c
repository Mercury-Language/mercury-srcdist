...
MR_decl_label8(bag__subset_compare_3_0, 67,3,6,8,9,11,14,31)
MR_decl_label6(bag__subset_compare_3_0, 13,16,19,43,2,1)
MR_decl_label8(bag__subtract_3_0, 28,3,6,9,8,10,5,2)
MR_decl_label1(bag__to_list_2_0, 2)
MR_decl_label4(bag__to_list_2_2_0, 20,3,4,8)
MR_decl_label2(bag__to_set_without_duplicates_2_0, 2,4)
MR_decl_label6(bag__union_3_0, 24,3,6,5,9,2)
MR_decl_label2(bag__list__foldl__ho9_4_0, 4,2)
...
MR_decl_static(bag__list__foldl__ho9_4_0)
...
MR_def_label(fn__bag__count_1_0,2)
	...
	MR_decr_sp(1);
	MR_np_tailcall_ent(bag__list__foldl__ho9_4_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(bag_module11)
	...
	MR_init_label4(bag__to_list_2_2_0,20,3,4,8)
MR_BEGIN_CODE
...
MR_def_label(bag__to_list_2_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(bag__to_list_2_2_0,3)
	...
	MR_GOTO_LAB(bag__to_list_2_2_0_i20);
	}
...
MR_def_label(bag__subtract_3_0,6)
	...
	MR_r5 = ((MR_Integer) MR_r2 - (MR_Integer) MR_sv(4));
...
MR_BEGIN_MODULE(bag_module57)
	...
	MR_init_label8(bag__subset_compare_3_0,67,3,6,8,9,11,14,31)
	MR_init_label6(bag__subset_compare_3_0,13,16,19,43,2,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(bag_module67)
	MR_init_entry1(bag__list__foldl__ho9_4_0);
	MR_init_label2(bag__list__foldl__ho9_4_0,4,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(bag__list__foldl__ho9_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(bag__list__foldl__ho9_4_0_i2);
	}
MR_def_label(bag__list__foldl__ho9_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
	...
	break; } /* end while */
MR_def_label(bag__list__foldl__ho9_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
