          ...
          case (MR_Integer) 0:
            {
              ...
              {
                STATE_VARIABLE_RevAuBXNs_26_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_26_26, 0) = ((MR_Box) (HeadXN_20));
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_26_26, 1) = ((MR_Box) (STATE_VARIABLE_RevAuBXNs_0_21));
              }
              // direct tailcall eliminated
              ;
    ...
    if ((AXNs_5 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_21_21, 0) = ((MR_Box) (HeadBXN_8));
    ...
    else
    {
      ...
      if ((BXNs_6 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_23_23, 0) = ((MR_Box) (Var_37));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_27_27, 0) = ((MR_Box) (HeadXN_18));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_29_29, 0) = ((MR_Box) (HeadBXN_31));
  ...
  MR_Word * STATE_VARIABLE_RevAuBXNs_20)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_RevAuBXNs_23_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_23_23, 0) = ((MR_Box) (HeadAXN_10));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAuBXNs_23_23, 1) = ((MR_Box) (STATE_VARIABLE_RevAuBXNs_0_19));
      }
      // direct tailcall eliminated
      ;
    ...
    if ((AXNs_5 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_21_21, 0) = ((MR_Box) (HeadBXN_8));
    ...
    else
    {
      ...
      if ((BXNs_6 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_23_23, 0) = ((MR_Box) (Var_37));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_27_27, 0) = ((MR_Box) (HeadXN_18));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_29_29, 0) = ((MR_Box) (HeadBXN_31));
  ...
  MR_Word * STATE_VARIABLE_RevAlubBXNs_20)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_RevAlubBXNs_23_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_23_23, 0) = ((MR_Box) (HeadAXN_10));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAlubBXNs_23_23, 1) = ((MR_Box) (STATE_VARIABLE_RevAlubBXNs_0_19));
      }
      // direct tailcall eliminated
      ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((BXNs_6 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          STATE_VARIABLE_RevAmBXNs_21_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_21_21, 0) = ((MR_Box) (Var_33));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_21_21, 1) = ((MR_Box) (STATE_VARIABLE_RevAmBXNs_0_19));
        }
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_23_23, 0) = ((MR_Box) (Var_33));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                {
                  STATE_VARIABLE_RevAmBXNs_26_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_26_26, 0) = ((MR_Box) (HeadXN_18));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_26_26, 1) = ((MR_Box) (STATE_VARIABLE_RevAmBXNs_0_19));
                }
              }
              else
  ...
  MR_Word * STATE_VARIABLE_RevAmBXNs_20)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_RevAmBXNs_21_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_21_21, 0) = ((MR_Box) (HeadAXN_8));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevAmBXNs_21_21, 1) = ((MR_Box) (STATE_VARIABLE_RevAmBXNs_0_19));
      }
      // direct tailcall eliminated
      ;
  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Box Var_10 = (MR_hl_field(MR_mktag(1), Xs_5, (MR_Integer) 0));
    MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Xs_5, (MR_Integer) 1))));
  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer XN_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__3_21, 0) = Var_9;
          MR_hl_field(MR_mktag(1), HeadVar__3_21, 1) = NULL;
        }
        AddrSCCcallarg_10_19 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_21, (MR_Integer) 1)));
