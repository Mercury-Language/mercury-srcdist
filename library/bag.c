...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_9 = (MR_Integer) ((MR_Unsigned) Count_6 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Integer * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer V_15_13 = (MR_Integer) ((MR_Unsigned) V_10_9 + (MR_Unsigned) HeadVar__3_3);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_11 = (MR_Integer) ((MR_Unsigned) N_6 - (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_RevXs_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_12 = (MR_Integer) ((MR_Unsigned) N_6 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
