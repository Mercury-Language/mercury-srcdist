...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (STATE_VARIABLE_Map_0_7), ((MR_Box) (X_4)), &conv1_STATE_VARIABLE_Map_8, &V_7_28);
...
{
  {
    ...
    mercury__tree234__values_acc_3_p_0(TypeInfo_for_T_7, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, V_5_18, &Var_5);
...
{
  {
    ...
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_9, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapA_5, V_5_15, &AXNs_7);
    V_5_22 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_9, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapB_6, V_5_22, &BXNs_8);
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_semi tailcalls optimized into a loop
    succeeded = mercury__tree234__remove_smallest_2_5_p_0(TypeInfo_for_T_10, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapA_3, &X_5, &conv0__N_6, &NextMapA_7, &V_9_20);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      succeeded = mercury__tree234__search_3_p_0(TypeInfo_for_T_10, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapB_4, X_5, &conv1_V_5_23);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_MapAiB_14)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    succeeded = mercury__tree234__remove_smallest_2_5_p_0(TypeInfo_for_T_17, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapA_5, &X_8, &conv0_AXN_9, &NextMapA_10, &V_9_29);
    if (succeeded)
    {
...
{
  {
    ...
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_11, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapA_4, V_5_17, &AXNs_7);
    V_5_24 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_11, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapB_5, V_5_24, &BXNs_8);
  ...
  MR_Word * MapAuB_6)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    succeeded = mercury__tree234__remove_smallest_2_5_p_0(TypeInfo_for_T_13, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapB_5, &X_7, &conv0_BXN_8, &NextMapB_9, &V_9_26);
    if (succeeded)
    {
  ...
  MR_Word * MapAmB_6)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    succeeded = mercury__tree234__remove_smallest_2_5_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapB_5, &X_7, &conv0_BXN_8, &NextMapB_9, &V_9_27);
    if (succeeded)
    {
      BXN_8 = ((MR_Integer) (conv0_BXN_8));
      succeeded = MR_TRUE;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), MapA_4, X_7, &NextMapA_12, &V_7_37);
        }
      }
      else
        NextMapA_12 = MapA_4;
...
{
  {
    ...
    mercury__tree234__keys_acc_3_p_0(TypeInfo_for_T_6, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, V_5_12, &Xs_5);
...
{
  {
    ...
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_7, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, V_5_17, &XNs_5);
...
{
  {
    ...
    mercury__tree234__keys_acc_3_p_0(TypeInfo_for_T_5, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, V_5_11, Xs_4);
  }
}
...
{
  {
    ...
    mercury__tree234__keys_acc_3_p_0(TypeInfo_for_T_5, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_7, V_5_13, &Xs_4);
    return Xs_4;
  }
}
...
{
  {
    ...
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_5, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, V_5_11, XNs_4);
  }
}
...
{
  {
    ...
    mercury__tree234__tree234_to_assoc_list_acc_3_p_0(TypeInfo_for_T_5, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_7, V_5_13, &XNs_4);
    return XNs_4;
  }
}
...
{
  {
    ...
    mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_9, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_6, X_4, &STATE_VARIABLE_Map_7, &V_7_17);
...
{
  {
    ...
    mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_9, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_12, X_5, &STATE_VARIABLE_Map_13, &V_7_22);
...
{
  {
    ...
    succeeded = mercury__tree234__remove_2_5_p_0(TypeInfo_for_T_10, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_7, X_4, &conv0__N_6, &STATE_VARIABLE_Map_8, &V_9_20);
    if (succeeded)
    {
      _N_6 = ((MR_Integer) (conv0__N_6));
      succeeded = MR_TRUE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_7, X_4, &STATE_VARIABLE_Map_8, &V_7_27);
      }
    }
    else
...
{
  {
    ...
    succeeded = mercury__tree234__remove_smallest_2_5_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_7, X_4, &conv0_N_6, &STATE_VARIABLE_Map_9_9, &V_9_24);
    if (succeeded)
    {
      N_6 = ((MR_Integer) (conv0_N_6));
      succeeded = MR_TRUE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_T_14, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Map_0_7, X_4, &STATE_VARIABLE_Map_8, &V_7_25);
      }
      *HeadVar__3_3 = (MR_Word) (STATE_VARIABLE_Map_8);
      succeeded = MR_TRUE;
    }
...
{
  {
    ...
    succeeded = mercury__tree234__search_3_p_0(TypeInfo_for_T_5, (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Map_3, X_4, &conv0_V_5_9);
    if (succeeded)
    {
