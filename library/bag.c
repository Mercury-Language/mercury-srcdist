...
MR_decl_label3(bag__insert_list_3_0, 11,4,3)
MR_decl_label5(bag__intersect_2_0, 19,2,5,9,1)
...
MR_decl_label4(bag__remove_list_3_0, 17,4,2,1)
MR_decl_label4(bag__remove_smallest_3_0, 2,5,4,1)
MR_decl_label8(bag__subset_compare_3_0, 67,3,6,8,9,11,13,17)
MR_decl_label6(bag__subset_compare_3_0, 33,16,19,43,2,1)
MR_decl_label8(bag__subtract_3_0, 28,3,6,9,8,10,5,2)
MR_decl_label1(bag__to_list_2_0, 2)
MR_decl_label4(bag__to_list_2_2_0, 17,4,6,3)
MR_decl_label2(bag__to_set_without_duplicates_2_0, 2,4)
MR_decl_label6(bag__union_3_0, 24,3,6,5,9,2)
MR_decl_label2(bag__list__foldl__ho3_4_0, 4,2)
...
MR_decl_label2(fn__bag__to_set_1_0, 2,4)
MR_decl_label2(fn__bag__to_set_without_duplicates_1_0, 2,4)
...
MR_decl_static(bag__list__foldl__ho3_4_0)
...
const MR_TypeCtorInfo_Struct mercury_data_bag__type_ctor_info_bag_1 = {
	...
	"bag",
	{ 0 },
	{ (void *)&mercury_data_tree234__pti_tree234_2__pseudo_1__plain_builtin__type_ctor_info_int_0 },
	-1,
	0,
	NULL
};
...
MR_def_label(fn__bag__count_1_0,2)
	...
	MR_decr_sp(1);
	MR_np_tailcall_ent(bag__list__foldl__ho3_4_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(bag_module6)
	...
	MR_init_label3(bag__insert_list_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_label(bag__insert_list_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(bag__insert_list_3_0,4)
	...
	MR_GOTO_LAB(bag__insert_list_3_0_i11);
...
MR_BEGIN_MODULE(bag_module11)
	...
	MR_init_label4(bag__to_list_2_2_0,17,4,6,3)
MR_BEGIN_CODE
...
MR_def_label(bag__to_list_2_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
...
MR_def_label(bag__to_list_2_2_0,4)
	...
	MR_np_localcall_lab(bag__to_list_2_2_0,
		bag__to_list_2_2_0_i6);
MR_def_label(bag__to_list_2_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(bag_module28)
	...
	MR_init_label2(fn__bag__to_set_without_duplicates_1_0,2,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__bag__to_set_without_duplicates_1_0);
	...
	MR_r4 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(tree234__keys_2_3_0,
		fn__bag__to_set_without_duplicates_1_0_i2);
MR_def_label(fn__bag__to_set_without_duplicates_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__bag__to_set_without_duplicates_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(2);
MR_def_label(fn__bag__to_set_without_duplicates_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(bag_module29)
	...
	MR_init_label2(fn__bag__to_set_1_0,2,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__bag__to_set_1_0);
	...
	MR_r4 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(tree234__keys_2_3_0,
		fn__bag__to_set_1_0_i2);
MR_def_label(fn__bag__to_set_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__bag__to_set_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(2);
MR_def_label(fn__bag__to_set_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(bag_module30)
	...
	MR_init_label4(bag__remove_list_3_0,17,4,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bag__remove_list_3_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(bag__remove_list_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(bag__remove_list_3_0_i2);
	}
	MR_sv(1) = MR_ctfield(1, MR_r3, 1);
	MR_sv(2) = MR_r1;
	MR_r3 = MR_ctfield(1, MR_r3, 0);
...
MR_def_label(bag__remove_list_3_0,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(bag__remove_list_3_0_i17);
MR_def_label(bag__remove_list_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(3);
...
MR_def_label(bag__subtract_3_0,6)
	...
	MR_r5 = ((MR_Integer) MR_r2 - (MR_Integer) MR_sv(3));
...
MR_def_label(bag__union_3_0,6)
	...
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(2);
	MR_r5 = ((MR_Integer) MR_tempr1 + (MR_Integer) MR_sv(3));
	}
	MR_np_call_localret_ent(map__det_update_4_0,
		bag__union_3_0_i9);
...
MR_def_label(bag__intersect_2_4_0,6)
	...
	if (((MR_Integer) MR_sv(4) >= (MR_Integer) MR_r2)) {
...
MR_BEGIN_MODULE(bag_module51)
	...
	MR_init_label5(bag__intersect_2_0,19,2,5,9,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bag__intersect_2_0);
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(bag__intersect_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(3) = MR_r1;
	MR_r3 = MR_r2;
...
MR_def_label(bag__intersect_2_0,2)
	...
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(tree234__search_3_0,
		bag__intersect_2_0_i5);
MR_def_label(bag__intersect_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(bag__intersect_2_0_i9);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(bag__intersect_2_0_i19);
MR_def_label(bag__intersect_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
...
MR_BEGIN_MODULE(bag_module57)
	...
	MR_init_label8(bag__subset_compare_3_0,67,3,6,8,9,11,13,17)
	MR_init_label6(bag__subset_compare_3_0,33,16,19,43,2,1)
MR_BEGIN_CODE
...
MR_def_label(bag__subset_compare_3_0,13)
	...
	MR_np_call_localret_ent(bag__subtract_3_0,
		bag__subset_compare_3_0_i17);
MR_def_label(bag__subset_compare_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(bag__subset_compare_3_0_i1);
	}
MR_def_label(bag__subset_compare_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 1;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(4);
...
MR_def_label(bag__subset_compare_3_0,2)
	...
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(bag__subset_compare_3_0_i33);
	}
	MR_r2 = (MR_Integer) 0;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(4);
...
MR_BEGIN_MODULE(bag_module60)
	MR_init_entry1(bag__list__foldl__ho3_4_0);
	MR_init_label2(bag__list__foldl__ho3_4_0,4,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(bag__list__foldl__ho3_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(bag__list__foldl__ho3_4_0_i2);
	}
MR_def_label(bag__list__foldl__ho3_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
	...
	MR_r2 = ((MR_Integer) MR_ctfield(1, MR_tempr1, 0) + (MR_Integer) MR_r2);
	if (MR_LTAGS_TESTR(MR_r1,0,0))
		continue;
	}
	break; } /* end while */
MR_def_label(bag__list__foldl__ho3_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__bag__write_out_proc_statics(FILE *fp);
#endif
