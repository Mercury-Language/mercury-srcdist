    ...
    if (mercury__bag__succeeded)
      *mercury__bag__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Word mercury__bag__Var_4 = (MR_Word) mercury__bag__HeadVar__2_2;
        MR_Word mercury__bag__Var_5 = (MR_Word) mercury__bag__HeadVar__3_3;

        {
          mercury__tree234____Compare____tree234_2_0(mercury__bag__TypeInfo_for_T_8, mercury__bag__TypeCtorInfo_9_9, mercury__bag__HeadVar__1_1, mercury__bag__Var_4, mercury__bag__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__bag__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__bag__Var_3 = (MR_Word) mercury__bag__HeadVar__1_1;
        MR_Word mercury__bag__Var_4 = (MR_Word) mercury__bag__HeadVar__2_2;

        {
          mercury__bag__succeeded = mercury__tree234____Unify____tree234_2_0(mercury__bag__TypeInfo_for_T_7, mercury__bag__TypeCtorInfo_8_8, mercury__bag__Var_3, mercury__bag__Var_4);
        }
      }
    return mercury__bag__succeeded;
  }
