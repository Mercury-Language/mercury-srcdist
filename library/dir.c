          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  mercury__dir__take_while__ho10_4_p_in__list_0(STATE_VARIABLE_FileName_0_60, &Server_52, &STATE_VARIABLE_FileName_17_63);
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          mercury__dir__take_while__ho9_4_p_in__list_0(STATE_VARIABLE_FileName_19_65, &Share_57, &STATE_VARIABLE_FileName_21_67);
