...
MR_decl_label10(dir__foldl2_process_dir_11_0, 9,6,11,13,18,22,62,24,26,31)
...
MR_decl_label10(dir__make_win32_dir_open_result_ok_5_0, 5,4,6,11,9,13,15,8,20,3)
MR_decl_label1(dir__make_win32_dir_open_result_ok_5_0, 72)
...
MR_decl_label6(dir__read_entry_4_0, 43,4,2,6,11,9)
...
MR_decl_label9(fn__dir__expand_acc_2_0, 29,3,6,8,9,10,11,4,13)
...
MR_BEGIN_MODULE(dir_module38)
	...
	MR_init_label10(dir__foldl2_process_dir_11_0,9,6,11,13,18,22,62,24,26,31)
...
MR_def_label(dir__foldl2_process_dir_11_0,13)
	...
	if (MR_INT_NE(MR_r4,0)) {
		MR_GOTO_LAB(dir__foldl2_process_dir_11_0_i62);
	}
	{
#define	MR_PROC_LABEL	mercury__dir__foldl2_process_dir_11_0
	MR_bool MercurySuccessIndicator;
...
MR_def_label(dir__foldl2_process_dir_11_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(dir_module42)
	...
	MR_init_label9(fn__dir__expand_acc_2_0,29,3,6,8,9,10,11,4,13)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__dir__expand_acc_2_0);
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(fn__dir__expand_acc_2_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(fn__dir__expand_acc_2_0,11)
	...
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(fn__dir__expand_acc_2_0_i29);
	}
...
MR_BEGIN_MODULE(dir_module50)
	...
	MR_init_label6(dir__read_entry_4_0,43,4,2,6,11,9)
MR_BEGIN_CODE
...
MR_def_static(dir__read_entry_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(dir__read_entry_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	{
...
MR_def_label(dir__read_entry_4_0,6)
	...
	MR_sv(2) = MR_r7;
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(dir__read_entry_4_0_i43);
...
MR_BEGIN_MODULE(dir_module56)
	...
	MR_init_label10(dir__make_win32_dir_open_result_ok_5_0,5,4,6,11,9,13,15,8,20,3)
	MR_init_label1(dir__make_win32_dir_open_result_ok_5_0,72)
MR_BEGIN_CODE
...
MR_def_label(dir__make_win32_dir_open_result_ok_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(dir__make_win32_dir_open_result_ok_5_0_i72);
	}
	{
...
MR_def_label(dir__make_win32_dir_open_result_ok_5_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
