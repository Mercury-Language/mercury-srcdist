...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Char1_5 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileNameChars0_3, (MR_Integer) 0)));
      FileNameChars1_6 = ((MR_Word) ((MR_hl_field(1, FileNameChars0_3, (MR_Integer) 1))));
      succeeded = mercury__dir__is_directory_separator_1_p_0(Char1_5);
    }
  }
  if (succeeded)
  {
    MR_Word FileNameChars2_7;
    MR_Char CanonicalChar1_8;
    MR_Word RevFileNameChars_14;
    MR_Char Char2_9;
    MR_Word Var_10;

    mercury__dir__canonicalize_later_path_chars_acc_3_p_0(FileNameChars1_6, (MR_Word) ((MR_Unsigned) 0U), &RevFileNameChars_14);
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), RevFileNameChars_14, &FileNameChars2_7);
{
#define MR_PROC_LABEL mercury__dir__canonicalize_path_chars_1_f_0
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
        CanonicalChar1_8 = (MR_Char) 92;
      else
        CanonicalChar1_8 = (MR_Char) 47;
    }
    succeeded = (FileNameChars2_7 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Char2_9 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileNameChars2_7, (MR_Integer) 0)));
      Var_10 = ((MR_Word) ((MR_hl_field(1, FileNameChars2_7, (MR_Integer) 1))));
      succeeded = (Var_10 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
    ...
    if (succeeded)
      {
        ...
        MR_hl_field(1, FileNameChars_4, 0) = ((MR_Box) (MR_Word) (CanonicalChar1_8));
    ...
    else
      {
        FileNameChars_4 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, FileNameChars_4, 0) = ((MR_Box) (MR_Word) (CanonicalChar1_8));
        MR_hl_field(1, FileNameChars_4, 1) = ((MR_Box) (FileNameChars2_7));
      }
  }
  else
  {
    MR_Word RevFileNameChars_17;

    mercury__dir__canonicalize_later_path_chars_acc_3_p_0(FileNameChars0_3, (MR_Word) ((MR_Unsigned) 0U), &RevFileNameChars_17);
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), RevFileNameChars_17, &FileNameChars_4);
  }
  ...
  MR_Word * STATE_VARIABLE_RevFileNameChars_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word FileNameChars0_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_RevFileNameChars_15_15;
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_RevFileNameChars_0_2;

      succeeded = mercury__dir__is_directory_separator_1_p_0(C0_7);
      if (succeeded)
      {
        MR_Char C1_10;
        MR_Char C2_11;
...
succeeded  = SUCCESS_INDICATOR;
        ...
        succeeded = (FileNameChars0_8 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          C2_11 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileNameChars0_8, (MR_Integer) 0)));
          succeeded = mercury__dir__is_directory_separator_1_p_0(C2_11);
        }
        if (succeeded)
        ...
        else
          {
            ...
            MR_hl_field(1, STATE_VARIABLE_RevFileNameChars_15_15, 0) = ((MR_Box) (MR_Word) (C1_10));
        ...
        {
          STATE_VARIABLE_RevFileNameChars_15_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_RevFileNameChars_15_15, 0) = ((MR_Box) (MR_Word) (C0_7));
          MR_hl_field(1, STATE_VARIABLE_RevFileNameChars_15_15, 1) = ((MR_Box) (STATE_VARIABLE_RevFileNameChars_0_2));
        }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = FileNameChars0_8;
