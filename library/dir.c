    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_71, 3) = ((MR_Box) (TypeInfo_65_65));
            MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) (Var_45));
            MR_hl_field(MR_mktag(0), Var_71, 5) = NULL;
          }
          {
            TypeInfo_21_79 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), TypeInfo_21_79, 0) = ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_tuple_0));
            MR_hl_field(MR_mktag(0), TypeInfo_21_79, 1) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), TypeInfo_21_79, 2) = ((MR_Box) (TypeInfo_65_65));
            MR_hl_field(MR_mktag(0), TypeInfo_21_79, 3) = ((MR_Box) (&mercury__io__io__type_ctor_info_state_0));
          }
          mercury__exception__try_2_p_0(TypeInfo_21_79, (MR_Word) (Var_71), &conv2_Var_72);
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_11_19 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
      mercury__dir__LCMC__pred__take_while__ho8__1_4_p_0(Var_8, AddrSCCcallarg_11_19, HeadVar__4_4);
    }
    else
    {
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__3_21, 0) = ((MR_Box) (MR_Word) (Var_7));
          MR_hl_field(MR_mktag(1), HeadVar__3_21, 1) = NULL;
        }
        AddrSCCcallarg_11_19 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_21, (MR_Integer) 1)));
        *AddrOfHeadVar__3_20 = HeadVar__3_21;
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__2_2 = Var_8;
        next_value_of_AddrOfHeadVar__3_20 = AddrSCCcallarg_11_19;
        HeadVar__2_2 = next_value_of_HeadVar__2_2;
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_11_19 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
      mercury__dir__LCMC__pred__take_while__ho7__1_4_p_0(Var_8, AddrSCCcallarg_11_19, HeadVar__4_4);
    }
    else
    {
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_11_19 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
      mercury__dir__LCMC__pred__take_while__ho9__1_4_p_0(Var_8, AddrSCCcallarg_11_19, HeadVar__4_4);
    }
    else
    {
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
