                        ...
                        if (mercury__dir__succeeded)
                          {
                            ...
                            if (mercury__dir__succeeded)
                              {
                                {
                                  mercury__dir__takewhile__ho7_4_p_in__list_0(mercury__dir__STATE_VARIABLE_FileName_0_55, &mercury__dir__Server_47, &mercury__dir__STATE_VARIABLE_FileName_17_58);
                                }
                                        ...
                                        if (mercury__dir__succeeded)
                                          {
                                            if ((mercury__dir__STATE_VARIABLE_FileName_19_60 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                                            ...
                                            else
                                              {
                                                ...
                                                {
                                                  mercury__dir__takewhile__ho6_4_p_in__list_0(mercury__dir__STATE_VARIABLE_FileName_19_60, &mercury__dir__Share_52, &mercury__dir__STATE_VARIABLE_FileName_21_62);
                                                }
                        ...
                        if (mercury__dir__succeeded)
                          {
                            ...
                            if (mercury__dir__succeeded)
                              {
                                {
                                  mercury__dir__takewhile__ho7_4_p_in__list_0(mercury__dir__STATE_VARIABLE_FileName_0_61, &mercury__dir__Server_53, &mercury__dir__STATE_VARIABLE_FileName_17_64);
                                }
                                        ...
                                        if (mercury__dir__succeeded)
                                          {
                                            if ((mercury__dir__STATE_VARIABLE_FileName_19_66 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                                            ...
                                            else
                                              {
                                                ...
                                                {
                                                  mercury__dir__takewhile__ho6_4_p_in__list_0(mercury__dir__STATE_VARIABLE_FileName_19_66, &mercury__dir__Share_58, &mercury__dir__STATE_VARIABLE_FileName_21_68);
                                                }
