        ...
        else
        {
          ...
          else
          {
            ...
            *STATE_VARIABLE_MaybeUserStop_32 = ((MR_Word) ((MR_hl_field(0, Var_46, 0))));
            STATE_VARIABLE_RevErrors_48_48 = ((MR_Word) ((MR_hl_field(0, Var_46, 1))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              STATE_VARIABLE_FileName_6_21 = ((MR_Word) ((MR_hl_field(1, Var_28, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word STATE_VARIABLE_FileName_18_40 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_17_39, 1))));
                    MR_Char Var_45 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_17_39, 0)));
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            MR_Char Var_46 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_20_42, 0)));

                            STATE_VARIABLE_FileName_7_22 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_20_42, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word STATE_VARIABLE_FileName_18_42 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_17_41, 1))));
                    MR_Char Var_47 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_17_41, 0)));
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            MR_Char Var_48 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_20_44, 0)));
