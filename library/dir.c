  ...
  MR_Word Chars_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word Var_4 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[6]);
    ...
    HeadVar__2_2 = mercury__dir__expand_acc_2_f_0(Chars_3, Var_4);
    return HeadVar__2_2;
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          *Res_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) FileTypeRes_28)) == (MR_mktag((MR_Integer) 1))))
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (((MR_tag((MR_Word) TargetTypeRes_33)) == (MR_mktag((MR_Integer) 1))))
                      {
                        MR_Word TargetTypeError_35 = ((MR_Word) (MR_hl_field(MR_mktag(1), TargetTypeRes_33, (MR_Integer) 0)));

                        Continue1_31 = (MR_Integer) 0;
                        {
                          Res1_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                          ...
                          case (MR_Integer) 10:
                            {
                              ...
                              Res1_32 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                              STATE_VARIABLE_Data_46_46 = STATE_VARIABLE_Data_44_44;
                            }
                            break;
                          case (MR_Integer) 1:
                  ...
                  if (succeeded)
                    succeeded = (Res1_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  if (succeeded)
                  {
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      switch (HaveFileName_9) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *Res_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          break;
        case (MR_Integer) 1:
          {
...
{
  {
    ...
    Var_16 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_15 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[6]);
    ExpandChars_6 = mercury__dir__expand_acc_2_f_0(ArgChar_5, Var_15);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__dir__find_matching_brace_or_comma_6_p_0(Chars_6, Var_31, Var_32, (MR_Integer) 0, &Alternatives0_9, &Left_10);
        TypeInfo_19_19 = (MR_Word) &mercury__dir_scalar_common_1[0];
        AlternativeLists_11 = mercury__dir__map__ho7_2_f_in__list_0(Alternatives0_9);
        TypeCtorInfo_9_41 = (MR_Word) &mercury__list__list__type_ctor_info_list_1;
        TypeInfo_10_51 = (MR_Word) &mercury__dir_scalar_common_1[7];
        mercury__list__reverse_2_p_0(TypeInfo_10_51, AlternativeLists_11, &V_5_38);
        V_6_39 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        mercury__list__condense_acc_3_p_0(TypeInfo_19_19, V_5_38, V_6_39, &Alternatives_12);
        ...
        mercury__list__reverse_2_p_0(TypeInfo_10_51, PrefixLists_13, &V_5_47);
        V_6_48 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        mercury__list__condense_acc_3_p_0(TypeInfo_19_19, V_5_47, V_6_48, &Prefixes1_14);
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Left_10;
          MR_Word next_value_of_HeadVar__2_2 = Prefixes1_14;
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Chars_6;
          MR_Word next_value_of_HeadVar__2_2 = Prefixes1_18;
...
{
  {
    ...
    else
    {
      ...
      MR_Word V_8_8;
      MR_Word V_9_9;
      MR_Word Var_13 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[6]);
      ...
      V_8_8 = mercury__dir__expand_acc_2_f_0(V_6_6, Var_13);
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_10_19 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
      MR_Word V_6_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
      MR_Word V_7_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
      MR_Word V_8_8;
      MR_Word V_9_9;

      mercury__list__append_3_p_1(TypeCtorInfo_10_19, Var_12, V_6_6, &V_8_8);
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_8_17 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
      MR_Word V_6_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
      MR_Word V_7_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
      MR_Word V_8_8;
      MR_Word V_9_9;
      ...
      mercury__list__append_3_p_1(TypeCtorInfo_8_17, V_6_6, Var_15, &V_8_8);
  ...
  MR_Word * Left_6)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        mercury__exception__throw_1_p_0(TypeCtorInfo_42_42, ((MR_Box) ((MR_String) "no matching brace")));
        return;
      }
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          MR_Word Var_21;
          MR_Word Var_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          TypeInfo_43_43 = (MR_Word) &mercury__dir_scalar_common_1[0];
          mercury__list__append_3_p_1(TypeInfo_43_43, Alternatives0_2, Var_21, Alternatives_5);
          *Left_6 = Chars_14;
        }
        else
        {
          MR_Word TypeCtorInfo_44_44 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
          MR_Word Var_23;
          MR_Integer Var_24;
          MR_Word Var_25;
          MR_Word Var_26 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          mercury__list__append_3_p_1(TypeCtorInfo_44_44, CurAlternative_3, Var_25, &Var_23);
          Var_24 = (BraceLevel_4 - (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Chars_14;
            MR_Word next_value_of_CurAlternative_3 = Var_23;
            MR_Integer next_value_of_BraceLevel_4 = Var_24;
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Word TypeCtorInfo_45_45 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
          MR_Word Var_28;
          MR_Integer Var_29;
          MR_Word Var_30;
          MR_Word Var_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          mercury__list__append_3_p_1(TypeCtorInfo_45_45, CurAlternative_3, Var_30, &Var_28);
          Var_29 = (BraceLevel_4 + (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Chars_14;
            MR_Word next_value_of_CurAlternative_3 = Var_28;
            MR_Integer next_value_of_BraceLevel_4 = Var_29;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_46_46 = (MR_Word) &mercury__dir_scalar_common_1[0];
              mercury__list__append_3_p_1(TypeInfo_46_46, Alternatives0_2, Var_33, &Alternatives1_20);
              Var_35 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__1_1 = Chars_14;
                MR_Word next_value_of_Alternatives0_2 = Alternatives1_20;
                MR_Word next_value_of_CurAlternative_3 = Var_35;
            ...
            {
              MR_Word TypeCtorInfo_47_47 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
              MR_Word Var_36;
              MR_Word Var_37;
              MR_Word Var_38 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              ...
              mercury__list__append_3_p_1(TypeCtorInfo_47_47, CurAlternative_3, Var_37, &Var_36);
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__1_1 = Chars_14;
                MR_Word next_value_of_CurAlternative_3 = Var_36;
          ...
          {
            MR_Word TypeCtorInfo_48_48 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
            MR_Word Var_39;
            MR_Word Var_40;
            MR_Word Var_41 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            ...
            mercury__list__append_3_p_1(TypeCtorInfo_48_48, CurAlternative_3, Var_40, &Var_39);
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__1_1 = Chars_14;
              MR_Word next_value_of_CurAlternative_3 = Var_39;
...
{
  {
    ...
    mercury__dir__foldl2_process_dir_12_p_0(TypeInfo_for_T_25, (MR_Integer) 0, P_8, Var_21, Var_22, (MR_Integer) 1, FollowLinks_10, &Var_14, &Res0_15, Data0_11, &Data_16);
    if ((Res0_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word base;
...
{
  {
    ...
    mercury__dir__foldl2_process_dir_12_p_0(TypeInfo_for_T_24, (MR_Integer) 0, P_7, Var_19, Var_20, (MR_Integer) 0, (MR_Integer) 0, &Var_12, &Res0_13, Data0_9, &Data_14);
    if ((Res0_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        *Res_10 = base;
...
{
  {
    ...
    if (((MR_tag((MR_Word) LoopRes_23)) == (MR_mktag((MR_Integer) 1))))
    {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  *Result_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                  *STATE_VARIABLE_Data_33 = STATE_VARIABLE_Data_0_32;
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word TypeCtorInfo_18_75;
                  MR_Word TypeCtorInfo_19_76;
                  ...
                  {
                    Var_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 12 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  TypeCtorInfo_52_52 = (MR_Word) &mercury__bool__bool__type_ctor_info_bool_0;
                  TypeCtorInfo_53_53 = (MR_Word) &mercury__io__io__type_ctor_info_res_0;
                  {
                    TypeInfo_56_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    MR_hl_field(MR_mktag(0), TypeInfo_56_56, 2) = ((MR_Box) (TypeCtorInfo_52_52));
                    MR_hl_field(MR_mktag(0), TypeInfo_56_56, 3) = ((MR_Box) (TypeCtorInfo_53_53));
                    MR_hl_field(MR_mktag(0), TypeInfo_56_56, 4) = ((MR_Box) (TypeInfo_for_T_48));
                  }
                  {
                    V_13_67 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  TypeCtorInfo_19_76 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_tuple_0;
                  TypeCtorInfo_18_75 = (MR_Word) &mercury__io__io__type_ctor_info_state_0;
                  {
                    TypeInfo_21_78 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), TypeInfo_21_78, 0) = ((MR_Box) (TypeCtorInfo_19_76));
                    MR_hl_field(MR_mktag(0), TypeInfo_21_78, 1) = ((MR_Box) ((MR_Integer) 2));
                    MR_hl_field(MR_mktag(0), TypeInfo_21_78, 2) = ((MR_Box) (TypeInfo_56_56));
                    MR_hl_field(MR_mktag(0), TypeInfo_21_78, 3) = ((MR_Box) (TypeCtorInfo_18_75));
                  }
                  mercury__exception__try_2_p_0(TypeInfo_21_78, (MR_Word) V_13_67, &conv2_V_9_69);
                  V_9_69 = (MR_Word) conv2_V_9_69;
                  if (((MR_tag((MR_Word) V_9_69)) == (MR_mktag((MR_Integer) 2))))
                  {
                  ...
                  else
                  {
                    ...
                    {
                      TryResult_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), TryResult_27, 0) = ((MR_Box) (V_10_71));
                    }
                  }
                  mercury__dir__close_4_p_0(Dir_26, &CloseRes_28);
                  if (((MR_tag((MR_Word) TryResult_27)) == (MR_mktag((MR_Integer) 2))))
                  {
                    MR_Word TypeCtorInfo_57_57 = (MR_Word) &mercury__bool__bool__type_ctor_info_bool_0;
                    MR_Word TypeCtorInfo_58_58 = (MR_Word) &mercury__io__io__type_ctor_info_res_0;
                    MR_Word TypeCtorInfo_59_59 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_tuple_0;
                    MR_Word TypeInfo_61_61;

                    {
                      TypeInfo_61_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), TypeInfo_61_61, 0) = ((MR_Box) (TypeCtorInfo_59_59));
                      MR_hl_field(MR_mktag(0), TypeInfo_61_61, 1) = ((MR_Box) ((MR_Integer) 3));
                      MR_hl_field(MR_mktag(0), TypeInfo_61_61, 2) = ((MR_Box) (TypeCtorInfo_57_57));
                      MR_hl_field(MR_mktag(0), TypeInfo_61_61, 3) = ((MR_Box) (TypeCtorInfo_58_58));
                  ...
                  else
                  {
                    ...
                    *STATE_VARIABLE_Data_33 = (MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 2));
                    if ((Result1_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) FileTypeRes_23)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word Error_25 = ((MR_Word) (MR_hl_field(MR_mktag(1), FileTypeRes_23, (MR_Integer) 0)));

        {
          Res0_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        switch (FileType_24) {
          ...
          case (MR_Integer) 10:
            {
              MR_Word Var_28 = (MR_Word) ((MR_Box) ((MR_String) "dir.foldl2: pathname is not a directory"));
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_30 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[4]);

              mercury__io__check_file_accessibility_5_p_0(DirName_5, Var_30, &Res0_8);
            }
            break;
        }
      }
      if ((Res0_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) IdRes_13)) == (MR_mktag((MR_Integer) 1))))
      {
...
{
  {
    ...
    else
    {
      MR_Word Var_7;
      MR_Word Chars1_11;
      MR_Word TypeCtorInfo_6_13 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
      MR_Char Sep_12;
      MR_Box conv0_Sep_12;

      succeeded = mercury__list__split_last_3_p_0(TypeCtorInfo_6_13, DirChars_5, &Chars1_11, &conv0_Sep_12);
      if (succeeded)
      {
	 ...
	 V_6_37  = Msg;
      ...
      if (succeeded)
        ...
        switch (CheckAccess_30) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_43 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[3]);

              mercury__io__check_file_accessibility_5_p_0(PathName_5, Var_43, Result_6);
            }
            break;
        }
    }
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__io__check_file_accessibility_5_p_0(DirName_8, Var_18, &ParentAccessResult_9);
          if ((ParentAccessResult_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            mercury__dir__make_directory_or_check_exists_4_p_0(PathName_5, Result_6);
          else
          {
            ...
            if ((ParentResult_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              mercury__dir__make_directory_or_check_exists_4_p_0(PathName_5, Result_6);
            else
...
{
  {
    ...
    switch (Res0_8) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_30 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[3]);

          mercury__io__check_file_accessibility_5_p_0(DirName_5, Var_30, Res_6);
        }
        break;
      case (MR_Integer) 3:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = ((MR_tag((MR_Word) TypeRes_10)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
          ...
          if (succeeded)
          {
            MR_Word Var_47 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[3]);

            mercury__io__check_file_accessibility_5_p_0(DirName_5, Var_47, Res_6);
          }
          else
          {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      ...
      Var_6 = (MR_Char) 47;
    V_6_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      V_5_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), V_5_13, 0) = ((MR_Box) (MR_Word) (Var_6));
      MR_hl_field(MR_mktag(1), V_5_13, 1) = ((MR_Box) (V_6_14));
    }
...
succeeded  = SUCCESS_INDICATOR;
          ...
          if (succeeded)
            ...
            Var_36 = (MR_Char) 47;
          V_6_83 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) FileNameChars_5)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Word Var_16;
          MR_Word Chars1_26;
          MR_Word TypeCtorInfo_6_28 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
          MR_Char Sep_27;
          MR_Box conv0_Sep_27;
          ...
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_17_17, ((MR_Box) (Var_13)), ((MR_Box) (Var_16)));
          if (succeeded)
            DirName_4 = (MR_String) "..";
          else
            DirName_4 = (MR_String) ".";
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) FileName_2)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
        ...
        else
        {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) Server_47)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                    Var_48 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Server_47, (MR_Integer) 0)));
                    Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), Server_47, (MR_Integer) 1)));
                    if ((STATE_VARIABLE_FileName_17_58 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        if ((STATE_VARIABLE_FileName_19_60 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                        {
                        ...
                        else
                        {
                          ...
                          succeeded = ((MR_tag((MR_Word) Share_52)) == (MR_mktag((MR_Integer) 1)));
                          if (succeeded)
                          {
                            Var_53 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Share_52, (MR_Integer) 0)));
                            Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), Share_52, (MR_Integer) 1)));
                            if ((STATE_VARIABLE_FileName_21_62 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                            {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                if ((STATE_VARIABLE_FileName_0_79 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                {
        ...
        if (succeeded)
        {
          ...
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_8_8, ((MR_Box) (Var_5)), ((MR_Box) (Var_7)));
        }
      }
      else
      {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        ...
        MR_Char Var_48;
        MR_Word Var_49;
        MR_Word STATE_VARIABLE_FileName_6_39;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                STATE_VARIABLE_FileName_6_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_49, (MR_Integer) 1)));
        ...
        else
        {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) Server_53)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                    Var_54 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Server_53, (MR_Integer) 0)));
                    Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), Server_53, (MR_Integer) 1)));
                    if ((STATE_VARIABLE_FileName_17_64 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      succeeded = MR_TRUE;
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        if ((STATE_VARIABLE_FileName_19_66 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                          succeeded = MR_TRUE;
                        else
                        {
                          MR_Word Share_58;
                          ...
                          succeeded = ((MR_tag((MR_Word) Share_58)) == (MR_mktag((MR_Integer) 1)));
                          if (succeeded)
                          {
                            Var_59 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Share_58, (MR_Integer) 0)));
                            Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(1), Share_58, (MR_Integer) 1)));
                            if ((STATE_VARIABLE_FileName_21_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                              succeeded = MR_TRUE;
                            else
                            {
                              MR_Char Var_80 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_FileName_21_68, (MR_Integer) 0)));
                              MR_Word STATE_VARIABLE_FileName_7_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_FileName_21_68, (MR_Integer) 1)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                if ((STATE_VARIABLE_FileName_0_85 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  succeeded = MR_TRUE;
                else
                {
                  MR_Char Char2_84 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_FileName_0_85, (MR_Integer) 0)));
                  MR_Word Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_FileName_0_85, (MR_Integer) 1)));
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) FileName0_3)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      FileName2_8 = mercury__dir__canonicalize_path_chars_2_2_f_0(FileName1_6, Var_10);
      succeeded = ((MR_tag((MR_Word) FileName2_8)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        {
          FileName_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FileName_4, 0) = ((MR_Box) (MR_Word) (CanonicalChar1_7));
          MR_hl_field(MR_mktag(1), FileName_4, 1) = ((MR_Box) (Var_12));
        }
      }
      else
        {
    ...
    else
    {
      ...
      FileName_4 = mercury__dir__canonicalize_path_chars_2_2_f_0(FileName0_3, Var_13);
    }
    return FileName_4;
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      mercury__list__reverse_2_p_0(TypeCtorInfo_12_12, HeadVar__2_2, &HeadVar__3_3);
    }
    else
    {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) FileName0_6)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          C2_10 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), FileName0_6, (MR_Integer) 0)));
          Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), FileName0_6, (MR_Integer) 1)));
      ...
      if (succeeded)
        ...
        {
          RevFileName_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RevFileName_8, 0) = ((MR_Box) (MR_Word) (C_9));
          MR_hl_field(MR_mktag(1), RevFileName_8, 1) = ((MR_Box) (HeadVar__2_2));
        }
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = FileName0_6;
        MR_Word next_value_of_HeadVar__2_2 = RevFileName_8;
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) FileNameChars0_4)) == (MR_mktag((MR_Integer) 1)));
    ...
    if (succeeded)
    {
      Var_7 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), FileNameChars0_4, (MR_Integer) 0)));
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), FileNameChars0_4, (MR_Integer) 1)));
...
succeeded  = SUCCESS_INDICATOR;
          ...
          {
            MR_Word TypeCtorInfo_36_62 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
            ...
            mercury__list__reverse_2_p_0(TypeCtorInfo_36_62, FileNameChars0_4, &RevFileNameChars0_33);
            succeeded = ((MR_tag((MR_Word) RevFileNameChars0_33)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
            ...
            succeeded = ((MR_tag((MR_Word) RevBaseName_37)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
              Var_39 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), RevBaseName_37, (MR_Integer) 0)));
              Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), RevBaseName_37, (MR_Integer) 1)));
              succeeded = ((MR_tag((MR_Word) RevDirName0_38)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
                Var_41 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), RevDirName0_38, (MR_Integer) 0)));
                Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), RevDirName0_38, (MR_Integer) 1)));
              }
            }
            if (succeeded)
            {
...
succeeded  = SUCCESS_INDICATOR;
                  ...
                  if (succeeded)
                  {
                    succeeded = ((MR_tag((MR_Word) RevDirName1_44)) == (MR_mktag((MR_Integer) 1)));
                    if (succeeded)
                    {
                ...
                if (!(succeeded))
                  succeeded = (RevDirName1_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              succeeded = !(succeeded);
              if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
              ...
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) FileNameChars0_4)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((MR_tag((MR_Word) BaseNameChars_47)) == (MR_mktag((MR_Integer) 1)));
                        if (succeeded)
                        {
                          BaseNameFirst_48 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), BaseNameChars_47, (MR_Integer) 0)));
                          Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), BaseNameChars_47, (MR_Integer) 1)));
