...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    MR_Box SystemError_22;
    MR_Word CheckAccess_23;
...
#define MR_PROC_LABEL mercury__dir__make_directory_4_p_0
    ...
    CheckAccess = MR_NO;
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, SystemError_22 );
	CheckAccess_23  = CheckAccess;
}
    mercury__io__is_error_5_p_0(SystemError_22, (MR_String) "cannot make directory: ", &MaybeIOError_24);
    if ((MaybeIOError_24 == (MR_Word) ((MR_Unsigned) 0U)))
      switch (CheckAccess_23) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *Result_6 = (MR_Word) ((MR_Unsigned) 0U);
          break;
    ...
    else
    {
...

      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_6 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_25));
      }
    }
  }
  else
