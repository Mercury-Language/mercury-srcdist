    ...
    {
      {
        ...
        MR_Integer SecondCharIndex_63;
        MR_Char FirstChar_64;
        MR_Char SecondChar_65;
        MR_Integer Var_66;
        MR_Char Var_67;
        MR_Integer Var_69;
        MR_Integer Var_75;
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	SecondCharIndex_63  = NextIndex;
	FirstChar_64  = Ch;
	Var_70  = ReplacedCodeUnit;
	}
succeeded  = SUCCESS_INDICATOR;
}
            if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
                ...
                if (succeeded)
                {
                  succeeded = (SecondChar_65 == (MR_Char) 58);
                  if (succeeded)
                  {
                    succeeded = mercury__char__is_alpha_1_p_0(FirstChar_64);
                    if (succeeded)
                    {
{
#define MR_PROC_LABEL mercury__dir__f_slash_2_f_0
...
#undef MR_PROC_LABEL
	...
	Var_13  = PrevIndex;
	Char_86  = Ch;
	Var_87  = ReplacedCodeUnit;
	}
succeeded  = SUCCESS_INDICATOR;
}
          if (succeeded)
            succeeded = mercury__dir__is_directory_separator_1_p_0(Char_86);
        }
      }
      if (succeeded)
