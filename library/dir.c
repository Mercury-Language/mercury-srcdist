...
MR_decl_label8(dir__split_name_2_3_0, 47,50,45,62,42,40,37,35)
MR_decl_label8(dir__split_name_2_3_0, 66,31,69,72,77,82,84,85)
...
MR_decl_label8(fn__dir__canonicalize_path_chars_1_0, 8,11,5,4,17,20,24,29)
MR_decl_label5(fn__dir__canonicalize_path_chars_1_0, 34,30,31,2,3)
...
MR_decl_static(dir__IntroducedFrom__pred__map__178__1__ho22_5_0)
...
MR_BEGIN_MODULE(dir_module10)
	...
	MR_init_label8(dir__split_name_2_3_0,47,50,45,62,42,40,37,35)
	MR_init_label8(dir__split_name_2_3_0,66,31,69,72,77,82,84,85)
...
MR_def_label(dir__split_name_2_3_0,50)
	...
	if (MR_INT_NE(MR_r1,92)) {
		MR_GOTO_LAB(dir__split_name_2_3_0_i45);
	}
...
MR_def_label(dir__split_name_2_3_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__dir__split_name_2_3_0
	MR_bool MercurySuccessIndicator;
...
MR_def_label(dir__split_name_2_3_0,35)
	...
	MR_np_call_localret_ent(string__from_rev_char_list_2_0,
		dir__split_name_2_3_0_i66);
MR_def_label(dir__split_name_2_3_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
;}
#line 1439 "dir.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(dir__split_name_2_3_0_i69);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	MR_r1 = (MR_Integer) 92;
	MR_GOTO_LAB(dir__split_name_2_3_0_i72);
MR_def_label(dir__split_name_2_3_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 47;
MR_def_label(dir__split_name_2_3_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,92)) {
		MR_GOTO_LAB(dir__split_name_2_3_0_i1);
	}
	...
	MR_np_call_localret_ent(char__is_alpha_1_0,
		dir__split_name_2_3_0_i77);
MR_def_label(dir__split_name_2_3_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(dir__split_name_2_3_0_i1);
	}
	...
	MR_np_call_localret_ent(dir__is_directory_separator_1_0,
		dir__split_name_2_3_0_i82);
MR_def_label(dir__split_name_2_3_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(dir__split_name_2_3_0_i1);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(string__from_char_list_2_0,
		dir__split_name_2_3_0_i84);
MR_def_label(dir__split_name_2_3_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(string__from_char_list_2_0,
		dir__split_name_2_3_0_i85);
MR_def_label(dir__split_name_2_3_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(4);
...
MR_BEGIN_MODULE(dir_module12)
	...
	MR_init_label8(fn__dir__canonicalize_path_chars_1_0,8,11,5,4,17,20,24,29)
	MR_init_label5(fn__dir__canonicalize_path_chars_1_0,34,30,31,2,3)
MR_BEGIN_CODE
...
MR_def_label(fn__dir__canonicalize_path_chars_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,92)) {
		MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i5);
	}
	if (MR_LTAGS_TEST(MR_sv(1),0,0)) {
		MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i5);
	}
...
MR_def_label(fn__dir__canonicalize_path_chars_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	{
#define	MR_PROC_LABEL	mercury__fn__dir__canonicalize_path_chars_1_0
...
#undef	MR_PROC_LABEL
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i3);
	}
	MR_sv(1) = MR_r1;
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_sv(3) = MR_ctfield(1, MR_sv(1), 1);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(dir__is_directory_separator_1_0,
		fn__dir__canonicalize_path_chars_1_0_i17);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
;}
#line 1780 "dir.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i20);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	...
	MR_np_call_localret_ent(fn__dir__canonicalize_path_chars_2_2_0,
		fn__dir__canonicalize_path_chars_1_0_i29);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__fn__dir__canonicalize_path_chars_1_0
	MR_bool MercurySuccessIndicator;
...
;}
#line 1807 "dir.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i24);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	...
	MR_np_call_localret_ent(fn__dir__canonicalize_path_chars_2_2_0,
		fn__dir__canonicalize_path_chars_1_0_i29);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
...
MR_def_label(fn__dir__canonicalize_path_chars_1_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__dir__canonicalize_path_chars_1_0_i31);
	}
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(dir__is_directory_separator_1_0,
		fn__dir__canonicalize_path_chars_1_0_i34);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(fn__dir__canonicalize_path_chars_1_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
MR_def_label(fn__dir__canonicalize_path_chars_1_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_static(dir__list__map__ho15_3_0)
	...
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(dir__IntroducedFrom__pred__map__178__1__ho22_5_0,
...
MR_BEGIN_MODULE(dir_module66)
	MR_init_entry1(dir__IntroducedFrom__pred__map__178__1__ho22_5_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(dir__IntroducedFrom__pred__map__178__1__ho22_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,5,2);
	MR_np_tailcall_ent(fn__dir__expand_acc_2_0);
#ifdef MR_maybe_local_thread_engine_base
