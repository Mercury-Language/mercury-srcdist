  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_17_49 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
      mercury__dir__LCMC__pred__take_while__ho8__1_4_p_0(Var_13, AddrSCCcallarg_17_49, HeadVar__4_4);
    }
    else
    {
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__3_51, 0) = ((MR_Box) (MR_Word) (Var_12));
          MR_hl_field(MR_mktag(1), HeadVar__3_51, 1) = NULL;
        }
        AddrSCCcallarg_17_49 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_51, (MR_Integer) 1)));
        *AddrOfHeadVar__3_50 = HeadVar__3_51;
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__2_2 = Var_13;
        next_value_of_AddrOfHeadVar__3_50 = AddrSCCcallarg_17_49;
        HeadVar__2_2 = next_value_of_HeadVar__2_2;
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_17_53 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
      mercury__dir__LCMC__pred__take_while__ho7__1_4_p_0(Var_13, AddrSCCcallarg_17_53, HeadVar__4_4);
    }
    else
    {
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__3_55, 0) = ((MR_Box) (MR_Word) (Var_12));
          MR_hl_field(MR_mktag(1), HeadVar__3_55, 1) = NULL;
        }
        AddrSCCcallarg_17_53 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_55, (MR_Integer) 1)));
        *AddrOfHeadVar__3_54 = HeadVar__3_55;
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__2_2 = Var_13;
        next_value_of_AddrOfHeadVar__3_54 = AddrSCCcallarg_17_53;
        HeadVar__2_2 = next_value_of_HeadVar__2_2;
