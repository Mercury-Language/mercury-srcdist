        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                mercury__dir__take_while__ho8_4_p_in__list_0(STATE_VARIABLE_FileName_0_61, &Server_53, &STATE_VARIABLE_FileName_17_64);
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        mercury__dir__take_while__ho7_4_p_in__list_0(STATE_VARIABLE_FileName_19_66, &Share_58, &STATE_VARIABLE_FileName_21_68);
...
succeeded  = SUCCESS_INDICATOR;
        ...
        else
        {
          ...
          mercury__dir__take_while__ho9_4_p_in__list_0(RevFileNameChars_36, &RevBaseName_37, &RevDirName0_38);
