    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_9, (MR_String) "cannot create directory: ", &IOError_10);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Result_6 = base;
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Box MaybeWin32Error_32;

      mercury__dir__make_single_directory_2_5_p_0(PathName_5, &MakeDirStatus_31, &MaybeWin32Error_32);
      switch (MakeDirStatus_31) {
        ...
        case (MR_Integer) 3:
          {
            ...
            mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_32, (MR_String) "cannot create directory: ", &IOError_41);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *Result_6 = base;
        ...
        case (MR_Integer) 1:
          {
            MR_Word TypeResult_33;
            MR_Word Var_38;

            mercury__io__file__file_type_5_p_0((MR_Integer) 1, PathName_5, &TypeResult_33);
            succeeded = ((MR_tag((MR_Word) TypeResult_33)) == (MR_Integer) 0);
            if (succeeded)
            {
              Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_33, (MR_Integer) 0))));
            ...
            else
            {
              ...
              mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_32, (MR_String) "cannot create directory: ", &IOError_34);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *Result_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_34));
              }
            }
          }
          break;
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word MakeDirStatus_44;
        MR_Box MaybeWin32Error_45;

        mercury__dir__make_single_directory_2_5_p_0(PathName_5, &MakeDirStatus_44, &MaybeWin32Error_45);
        switch (MakeDirStatus_44) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
            mercury__io__file__check_file_accessibility_5_p_0(PathName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
            break;
          case (MR_Integer) 3:
            {
              ...
              mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_45, (MR_String) "cannot create directory: ", &IOError_54);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *Result_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_54));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word TypeResult_46;
              MR_Word Var_51;

              mercury__io__file__file_type_5_p_0((MR_Integer) 1, PathName_5, &TypeResult_46);
              succeeded = ((MR_tag((MR_Word) TypeResult_46)) == (MR_Integer) 0);
              if (succeeded)
              {
                Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_46, (MR_Integer) 0))));
              ...
              else
              {
                ...
                mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_45, (MR_String) "cannot create directory: ", &IOError_47);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_6 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_47));
                }
              }
            }
            break;
      ...
      else
      {
        ...
        {
          MR_Word MakeDirStatus_70;
          MR_Box MaybeWin32Error_71;

          mercury__dir__make_single_directory_2_5_p_0(PathName_5, &MakeDirStatus_70, &MaybeWin32Error_71);
          switch (MakeDirStatus_70) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
              mercury__io__file__check_file_accessibility_5_p_0(PathName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
              break;
            case (MR_Integer) 3:
              {
                ...
                mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_71, (MR_String) "cannot create directory: ", &IOError_80);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_6 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_80));
                }
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word TypeResult_72;
                MR_Word Var_77;

                mercury__io__file__file_type_5_p_0((MR_Integer) 1, PathName_5, &TypeResult_72);
                succeeded = ((MR_tag((MR_Word) TypeResult_72)) == (MR_Integer) 0);
                if (succeeded)
                {
                  Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_72, (MR_Integer) 0))));
                ...
                else
                {
                  ...
                  mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_71, (MR_String) "cannot create directory: ", &IOError_73);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_6 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_73));
                  }
                }
              }
              break;
        ...
        else
        {
          ...
          {
            MR_Word MakeDirStatus_57;
            MR_Box MaybeWin32Error_58;

            mercury__dir__make_single_directory_2_5_p_0(PathName_5, &MakeDirStatus_57, &MaybeWin32Error_58);
            switch (MakeDirStatus_57) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 2:
                mercury__io__file__check_file_accessibility_5_p_0(PathName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
                break;
              case (MR_Integer) 3:
                {
                  ...
                  mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_58, (MR_String) "cannot create directory: ", &IOError_67);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_6 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_67));
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word TypeResult_59;
                  MR_Word Var_64;

                  mercury__io__file__file_type_5_p_0((MR_Integer) 1, PathName_5, &TypeResult_59);
                  succeeded = ((MR_tag((MR_Word) TypeResult_59)) == (MR_Integer) 0);
                  if (succeeded)
                  {
                    Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_59, (MR_Integer) 0))));
                  ...
                  else
                  {
                    ...
                    mercury__io__make_io_error_from_maybe_win32_error_5_p_0(MaybeWin32Error_58, (MR_String) "cannot create directory: ", &IOError_60);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      *Result_6 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_60));
                    }
                  }
                }
                break;
