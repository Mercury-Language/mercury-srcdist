  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__list__condense_acc_3_p_0((MR_Word) &mercury__dir_scalar_common_1[0], V_5_38, V_6_39, &Alternatives_12);
        ...
        mercury__list__condense_acc_3_p_0((MR_Word) &mercury__dir_scalar_common_1[0], V_5_47, V_6_48, &Prefixes1_14);
        // direct tailcall eliminated
