...
succeeded  = SUCCESS_INDICATOR;
        ...
        {
          Var_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_37, 0) = ((MR_Box) (FileName_8));
          MR_hl_field(1, Var_37, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
        ...
        {
          Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_33, 0) = ((MR_Box) (DirName_7));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_46 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_37, (MR_Integer) 0)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word STATE_VARIABLE_FileName_19_41 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_17_39, (MR_Integer) 1))));
                    MR_Char Var_47 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_17_39, (MR_Integer) 0)));
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            MR_Char Var_48 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_21_43, (MR_Integer) 0)));

                            STATE_VARIABLE_FileName_7_22 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_21_43, (MR_Integer) 1))));
        ...
        else
        {
          ...
          if (succeeded)
          {
            Char1_49 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileName_2, (MR_Integer) 0)));
            STATE_VARIABLE_FileName_0_51 = ((MR_Word) ((MR_hl_field(1, FileName_2, (MR_Integer) 1))));
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                Var_7 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_0_51, (MR_Integer) 1))));
	...
	Var_21  = Length;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_48 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_39, (MR_Integer) 0)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word STATE_VARIABLE_FileName_19_43 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_FileName_17_41, (MR_Integer) 1))));
                    MR_Char Var_49 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_17_41, (MR_Integer) 0)));
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            MR_Char Var_50 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_21_45, (MR_Integer) 0)));
        ...
        else
        {
          ...
          if (succeeded)
          {
            Char1_51 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_5, (MR_Integer) 0)));
            STATE_VARIABLE_FileName_0_53 = ((MR_Word) ((MR_hl_field(1, Var_5, (MR_Integer) 1))));
            ...
            if (succeeded)
            {
              ...
              {
                MR_Char Char2_52 = ((MR_Char) (MR_Word) (MR_hl_field(1, STATE_VARIABLE_FileName_0_53, (MR_Integer) 0)));
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AddrSCCcallarg_17_25 = (MR_Word *) (&(MR_hl_field(1, *HeadVar__3_3, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(1, HeadVar__3_27, 0) = ((MR_Box) (MR_Word) (Var_12));
          MR_hl_field(1, HeadVar__3_27, 1) = NULL;
        }
        AddrSCCcallarg_17_25 = (MR_Word *) (&(MR_hl_field(1, HeadVar__3_27, (MR_Integer) 1)));
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Char1_5 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileName0_3, (MR_Integer) 0)));
      FileName1_6 = ((MR_Word) ((MR_hl_field(1, FileName0_3, (MR_Integer) 1))));
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      Char2_9 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileName2_8, (MR_Integer) 0)));
      Var_11 = ((MR_Word) ((MR_hl_field(1, FileName2_8, (MR_Integer) 1))));
      succeeded = (Var_11 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
    ...
    if (succeeded)
      {
        FileName_4 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, FileName_4, 0) = ((MR_Box) (MR_Word) (CanonicalChar1_7));
        MR_hl_field(1, FileName_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    else
      {
        FileName_4 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, FileName_4, 0) = ((MR_Box) (MR_Word) (CanonicalChar1_7));
        MR_hl_field(1, FileName_4, 1) = ((MR_Box) (FileName2_8));
      }
  }
  else
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Char C0_5 = ((MR_Char) (MR_Word) (MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0)));
      MR_Word FileName0_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          C2_10 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileName0_6, (MR_Integer) 0)));
      ...
      if (succeeded)
        ...
        {
          RevFileName_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, RevFileName_8, 0) = ((MR_Box) (MR_Word) (C_9));
          MR_hl_field(1, RevFileName_8, 1) = ((MR_Box) (HeadVar__2_2));
        }
      // direct tailcall eliminated
      ;
...
succeeded  = SUCCESS_INDICATOR;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_45 = ((MR_Char) (MR_Word) (MR_hl_field(1, RevDirName1_37, (MR_Integer) 0)));
                    Var_46 = ((MR_Word) ((MR_hl_field(1, RevDirName1_37, (MR_Integer) 1))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Drive_38 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_46, (MR_Integer) 0)));
...
succeeded  = SUCCESS_INDICATOR;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Drive_52 = ((MR_Char) (MR_Word) (MR_hl_field(1, FileNameChars0_4, (MR_Integer) 0)));
                Var_48 = ((MR_Word) ((MR_hl_field(1, FileNameChars0_4, (MR_Integer) 1))));
                succeeded = (Var_48 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Var_49 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_48, (MR_Integer) 0)));
                  BaseNameChars_40 = ((MR_Word) ((MR_hl_field(1, Var_48, (MR_Integer) 1))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          Var_51 = (MR_Word) (MR_mkword(1, &mercury__dir_scalar_common_1[5]));
                          {
                            Var_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(1, Var_50, 0) = ((MR_Box) (MR_Word) (Drive_52));
