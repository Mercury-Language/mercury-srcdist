...
{
  {
    ...
    if ((mercury__dir__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word mercury__dir__V_8_8;
        MR_Word mercury__dir__V_9_9;
        MR_Word mercury__dir__Var_13 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[5]);
...
{
  {
    MR_bool mercury__dir__succeeded;
    MR_Word mercury__dir__HeadVar__2_2;
    MR_Word mercury__dir__Var_4 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[5]);
                                                ...
                                                if (mercury__dir__succeeded)
                                                  {
                                                    ...
                                                    mercury__dir__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[6]);
                                                    {
...
{
  {
    ...
    mercury__dir__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[5]);
    {
