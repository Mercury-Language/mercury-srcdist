              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                    succeeded = (Res1_32 == (MR_Word) ((MR_Integer) 0));
                  if (succeeded)
                  {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__dir__find_matching_brace_or_comma_6_p_0(Chars_6, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, &Alternatives0_9, &Left_10);
        ...
        mercury__list__condense_acc_3_p_0((MR_Word) (&mercury__dir_scalar_common_1[0]), V_5_38, (MR_Word) ((MR_Integer) 0), &Alternatives_12);
        ...
        mercury__list__condense_acc_3_p_0((MR_Word) (&mercury__dir_scalar_common_1[0]), V_5_47, (MR_Word) ((MR_Integer) 0), &Prefixes1_14);
        // direct tailcall eliminated
        ;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              CurAlternative_3 = (MR_Word) ((MR_Integer) 0);
              continue;
            }
            else
            {
...
{
  {
    ...
    mercury__dir__foldl2_process_dir_12_p_0(TypeInfo_for_T_25, (MR_Integer) 0, P_8, Var_21, (MR_Word) ((MR_Integer) 0), (MR_Integer) 1, FollowLinks_10, &Var_14, &Res0_15, Data0_11, &Data_16);
    if ((Res0_15 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word base;
...
{
  {
    ...
    mercury__dir__foldl2_process_dir_12_p_0(TypeInfo_for_T_24, (MR_Integer) 0, P_7, Var_19, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 0, &Var_12, &Res0_13, Data0_9, &Data_14);
    if ((Res0_13 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        *Res_10 = base;
              ...
              case (MR_Integer) 0:
                {
                  ...
                  *Result_20 = (MR_Word) ((MR_Integer) 0);
                  *STATE_VARIABLE_Data_33 = STATE_VARIABLE_Data_0_32;
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    *STATE_VARIABLE_Data_33 = (MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 2));
                    if ((Result1_29 == (MR_Word) ((MR_Integer) 0)))
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      if ((Res0_8 == (MR_Word) ((MR_Integer) 0)))
      {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__io__check_file_accessibility_5_p_0(DirName_8, (MR_Word) ((MR_Integer) 0), &ParentAccessResult_9);
          if ((ParentAccessResult_9 == (MR_Word) ((MR_Integer) 0)))
            mercury__dir__make_directory_or_check_exists_4_p_0(PathName_5, Result_6);
          else
          {
            ...
            if ((ParentResult_11 == (MR_Word) ((MR_Integer) 0)))
              mercury__dir__make_directory_or_check_exists_4_p_0(PathName_5, Result_6);
            else
...
succeeded  = SUCCESS_INDICATOR;
      ...
      Var_6 = (MR_Char) 47;
    {
      ...
      MR_hl_field(MR_mktag(1), V_5_13, 1) = ((MR_Box) ((MR_Integer) 0));
    }
...
succeeded  = SUCCESS_INDICATOR;
            ...
            Var_36 = (MR_Char) 47;
          {
            ...
            MR_hl_field(MR_mktag(1), V_5_82, 1) = ((MR_Box) ((MR_Integer) 0));
          }
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        ...
        else
        {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    if ((STATE_VARIABLE_FileName_17_58 == (MR_Word) ((MR_Integer) 0)))
                    {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        if ((STATE_VARIABLE_FileName_19_60 == (MR_Word) ((MR_Integer) 0)))
                        {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            if ((STATE_VARIABLE_FileName_21_62 == (MR_Word) ((MR_Integer) 0)))
                            {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                if ((STATE_VARIABLE_FileName_0_79 == (MR_Word) ((MR_Integer) 0)))
                {
        ...
        if (succeeded)
        {
          ...
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_8_8, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_7)));
        }
      }
      else
      {
        ...
        else
        {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    if ((STATE_VARIABLE_FileName_17_64 == (MR_Word) ((MR_Integer) 0)))
                      succeeded = MR_TRUE;
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        if ((STATE_VARIABLE_FileName_19_66 == (MR_Word) ((MR_Integer) 0)))
                          succeeded = MR_TRUE;
                        else
                        {
                          MR_Word Share_58;
                          ...
                          if (succeeded)
                          {
                            if ((STATE_VARIABLE_FileName_21_68 == (MR_Word) ((MR_Integer) 0)))
                              succeeded = MR_TRUE;
                            else
                            {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                if ((STATE_VARIABLE_FileName_0_85 == (MR_Word) ((MR_Integer) 0)))
                  succeeded = MR_TRUE;
                else
                {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      FileName2_8 = mercury__dir__canonicalize_path_chars_2_2_f_0(FileName1_6, (MR_Word) ((MR_Integer) 0));
      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(1), FileName_4, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      }
      else
        {
    ...
    {
      FileName_4 = mercury__dir__canonicalize_path_chars_2_2_f_0(FileName0_3, (MR_Word) ((MR_Integer) 0));
    }
    return FileName_4;
  }
}
...
succeeded  = SUCCESS_INDICATOR;
                ...
                if (!(succeeded))
                  succeeded = (RevDirName1_44 == (MR_Word) ((MR_Integer) 0));
              }
              succeeded = !(succeeded);
              if (succeeded)
