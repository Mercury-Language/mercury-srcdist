  ...
  MR_Word Chars_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word Var_4 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[7]);
...
{
  {
    ...
    Var_15 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[7]);
...
{
  {
    ...
    else
    {
      ...
      MR_Word V_8_8;
      MR_Word V_9_9;
      MR_Word Var_13 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[7]);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_10_51 = (MR_Word) &mercury__dir_scalar_common_1[6];
