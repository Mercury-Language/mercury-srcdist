...
{
  {
    ...
    mercury__dir__foldl2_process_dir_13_p_0(TypeInfo_for_T_32, (MR_Word) (&mercury__dir_scalar_common_1[4]), Pred_7, Var_26, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, &_MaybeUserStop_14, (MR_Word) ((MR_Unsigned) 0U), &RevErrors_15, Data0_9, &Data_16);
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__io__check_file_accessibility_5_p_0(DirName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[9])), &CheckResult_26);
        ...
        switch (CheckAccess_30) {
          ...
          case (MR_Integer) 0:
            *Result_6 = (MR_Word) ((MR_Unsigned) 0U);
            break;
          case (MR_Integer) 1:
            mercury__io__check_file_accessibility_5_p_0(PathName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
            break;
        }
      else
      {
...
{
  {
    ...
    switch (MakeDirStatus_8) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 2:
        mercury__io__check_file_accessibility_5_p_0(DirName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
        break;
      case (MR_Integer) 3:
        {
          MR_Word Var_17;
