...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      mercury__io__make_io_error_from_system_error_5_p_0(SystemError_23, (MR_String) "cannot make directory: ", &Var_30);
      {
        MaybeIOError_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeIOError_25, 0) = ((MR_Box) (Var_30));
      }
    }
        ...
        case (MR_Integer) 3:
          {
            ...
            mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_33, IsWin32Error_34, (MR_String) "cannot create directory: ", &IOError_43);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *Result_6 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_43));
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_35, (MR_Integer) 0))));
              succeeded = (Var_40 == (MR_Integer) 1);
            }
            if (succeeded)
              mercury__io__file__check_file_accessibility_5_p_0(PathName_5, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__dir_scalar_common_1[8])), Result_6);
            else
            {
              ...
              mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_33, IsWin32Error_34, (MR_String) "cannot create directory: ", &IOError_36);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *Result_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_36));
              }
            }
          }
          break;
          ...
          case (MR_Integer) 3:
            {
              ...
              mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_47, IsWin32Error_48, (MR_String) "cannot create directory: ", &IOError_57);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *Result_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_57));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_49, (MR_Integer) 0))));
              ...
              else
              {
                ...
                mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_47, IsWin32Error_48, (MR_String) "cannot create directory: ", &IOError_50);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_6 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_50));
                }
              }
            }
            break;
            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_75, IsWin32Error_76, (MR_String) "cannot create directory: ", &IOError_85);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_6 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_85));
                }
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_77, (MR_Integer) 0))));
                ...
                else
                {
                  ...
                  mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_75, IsWin32Error_76, (MR_String) "cannot create directory: ", &IOError_78);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_6 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_78));
                  }
                }
              }
              break;
              ...
              case (MR_Integer) 3:
                {
                  ...
                  mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_61, IsWin32Error_62, (MR_String) "cannot create directory: ", &IOError_71);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_6 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_71));
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeResult_63, (MR_Integer) 0))));
                  ...
                  else
                  {
                    ...
                    mercury__io__make_io_error_from_maybe_win32_error_6_p_0(Error_61, IsWin32Error_62, (MR_String) "cannot create directory: ", &IOError_64);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      *Result_6 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_64));
                    }
                  }
                }
                break;
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Error_7, (MR_String) "dir.current_directory failed: ", &Var_14);
    {
      MaybeIOError_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MaybeIOError_8, 0) = ((MR_Box) (Var_14));
    }
  }
