...
MR_def_label(dir__foldl2_process_dir_11_0,51)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_mask_field(MR_r1, 0);
	MR_r1 = (MR_Integer) 0;
...
MR_def_label(dir__foldl2_process_dir_11_0,28)
	...
	MR_tfield(0, MR_tempr1, 11) = MR_tfield(0, MR_tempr2, 0);
	MR_tfield(0, MR_tempr1, 12) = MR_tfield(0, MR_tempr2, 1);
	...
	MR_sv(1) = MR_tfield(0, MR_tempr1, 11);
	MR_sv(2) = MR_tempr3;
	}
...
MR_BEGIN_MODULE(dir_module64)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__dir__IntroducedFrom__pred__foldl2_process_dir__1307__1_13_0);
