  ...
  MR_Word * Res_7)
{
  ...
  {
    MR_Word ItemOrClosed_11 = ((MR_Word) ((MR_hl_field(1, TryRead_10, 0))));
    ...
    {
      MR_Box Val_12 = (MR_hl_field(1, ItemOrClosed_11, 0));

      NewHead_13 = ((MR_Word) ((MR_hl_field(1, ItemOrClosed_11, 1))));
      {
        MR_Word base;
  ...
  MR_Word * Res_7)
{
  ...
  {
    MR_Box Val_11 = (MR_hl_field(1, ItemOrClosed_10, 0));

    NewHead_12 = ((MR_Word) ((MR_hl_field(1, ItemOrClosed_10, 1))));
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Res_7 = base;
  ...
  MR_Word HeadVar__1_1)
{
  MR_Word TypeInfo_16_16;
  MR_Word TypeInfo_18_18;
  MR_Word Write_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Word Hole_7;
  MR_Box conv0_Hole_7;
  MR_Word _Success_8;
  ...
  MR_Word * Success_9)
{
  ...
  MR_Word Write_7 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Word NewHole_11;
  MR_Word OldHole_12;
  MR_Word Var_17;
