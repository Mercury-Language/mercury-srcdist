        ...
        case (MR_Integer) 2:
          {
            ...
            ;
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_62 = ((MR_Word) ((MR_hl_field(1, ArgTypeDescs_13, (MR_Integer) 1))));
...
label_1:;
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_104 = ((MR_Word) ((MR_hl_field(1, ArgTypeDescs_13, (MR_Integer) 0))));
      Var_103 = ((MR_Word) ((MR_hl_field(1, ArgTypeDescs_13, (MR_Integer) 1))));
