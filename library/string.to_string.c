...
mercury__string__to_string__ordinary_term_to_revstrings_6_p_3(
  MR_Word TypeInfo_for_T_143,
  MR_Word NonCanon_7,
  MR_Word MinTermPrio_9,
  MR_Box X_10,
  MR_Word STATE_VARIABLE_Rs_0_35,
  MR_Word * STATE_VARIABLE_Rs_36);
...
static void MR_CALL 
mercury__string__to_string__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_100_111_95_102_111_108_100_114_95_102_117_110_99_95_95_104_111_50_55_95_95_91_49_44_32_50_44_32_52_44_32_53_93_95_48_5_p_in__version_array_0(
  ...
  MR_Word * STATE_VARIABLE_Rs_36)
{
  ...
  MR_Word STATE_VARIABLE_Rs_44_44;

  mercury__deconstruct__deconstruct_5_p_3(TypeInfo_for_T_143, X_10, NonCanon_7, &Functor_12, &_Arity_13, &Args_14);
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((strcmp(Functor_12, (MR_String) "[]") == 0))
    {
      mercury__string__to_string__add_revstring_3_p_0((MR_String) "[]", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_44_44);
      succeeded = MR_TRUE;
    }
    else
    if ((strcmp(Functor_12, (MR_String) "{}") == 0))
  ...
  {
    MR_Word Var_157 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    MR_Word Var_158 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    ...
    if ((strcmp(Functor_12, (MR_String) "{}") == 0))
    {
      if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MR_Box Var_52;
        MR_Word STATE_VARIABLE_Rs_53_53;

        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{ ", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_51_51);
        Var_52 = mercury__univ__univ_value_1_f_0(&TypeInfo_144_144, Var_158);
        mercury__string__to_string__value_to_revstrings_5_p_3(TypeInfo_144_144, NonCanon_7, Var_52, STATE_VARIABLE_Rs_51_51, &STATE_VARIABLE_Rs_53_53);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) " }", STATE_VARIABLE_Rs_53_53, &STATE_VARIABLE_Rs_44_44);
      }
      else
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_57_57);
        mercury__string__to_string__arg_to_revstrings_5_p_3(NonCanon_7, Var_158, STATE_VARIABLE_Rs_57_57, &STATE_VARIABLE_Rs_58_58);
        mercury__string__to_string__term_args_to_revstrings_5_p_3(NonCanon_7, Var_157, STATE_VARIABLE_Rs_58_58, &STATE_VARIABLE_Rs_59_59);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "}", STATE_VARIABLE_Rs_59_59, &STATE_VARIABLE_Rs_44_44);
      }
      succeeded = MR_TRUE;
    }
    else
    if ((strcmp(Functor_12, (MR_String) "[|]") == 0))
    {
      ...
      if (succeeded)
      {
        ListTail_16 = ((MR_Word) ((MR_hl_field(1, Var_157, (MR_Integer) 0))));
        Var_38 = ((MR_Word) ((MR_hl_field(1, Var_157, (MR_Integer) 1))));
        succeeded = (Var_38 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Var_39 = (MR_String) "[";
          mercury__string__to_string__add_revstring_3_p_0(Var_39, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_40_40);
          mercury__string__to_string__arg_to_revstrings_5_p_3(NonCanon_7, Var_158, STATE_VARIABLE_Rs_40_40, &STATE_VARIABLE_Rs_41_41);
          mercury__string__to_string__univ_list_tail_to_revstrings_5_p_3(NonCanon_7, ListTail_16, STATE_VARIABLE_Rs_41_41, &STATE_VARIABLE_Rs_42_42);
          Var_43 = (MR_String) "]";
          mercury__string__to_string__add_revstring_3_p_0(Var_43, STATE_VARIABLE_Rs_42_42, &STATE_VARIABLE_Rs_44_44);
          succeeded = MR_TRUE;
        }
      }
    }
  ...
  if (succeeded)
    *STATE_VARIABLE_Rs_36 = STATE_VARIABLE_Rs_44_44;
  else
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    mercury__string__to_string__plain_term_to_revstrings_7_p_3(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  else
  {
    MR_Word Var_155 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    ...
    if ((Var_155 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      succeeded = mercury__ops__lookup_op_infos_4_p_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)), Functor_12, &OpInfo_23, &OpInfos_24);
      if (succeeded)
      {
        MR_Word OpPrio_25;
        MR_Word GtOrGeA_26;

        succeeded = mercury__ops__op_infos_prefix_op_4_p_0(OpInfo_23, OpInfos_24, &OpPrio_25, &GtOrGeA_26);
        if (succeeded)
        {
          ...
          mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) "(", MinTermPrio_9, OpPrio_25, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_64_64);
          ...
          switch (GtOrGeA_26) {
            ...
            case (MR_Integer) 1:
              MinPrioA_27 = OpPrio_25;
              break;
            case (MR_Integer) 0:
              MinPrioA_27 = mercury__ops__increment_priority_1_f_0(OpPrio_25);
              break;
          }
          Var_69 = mercury__univ__univ_value_1_f_0(&TypeInfo_146_146, Var_156);
          mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_146_146, NonCanon_7, MinPrioA_27, Var_69, STATE_VARIABLE_Rs_68_68, &STATE_VARIABLE_Rs_70_70);
          mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_25, STATE_VARIABLE_Rs_70_70, STATE_VARIABLE_Rs_36);
        }
        else
        {
          MR_Word OpPrio_123;
          ...
          succeeded = mercury__ops__op_infos_postfix_op_4_p_0(OpInfo_23, OpInfos_24, &OpPrio_123, &GtOrGeA_124);
          if (succeeded)
          {
            MR_Word TypeInfo_147_147;
            MR_Word STATE_VARIABLE_Rs_74_74;
            MR_Box Var_75;
            MR_Word STATE_VARIABLE_Rs_76_76;
            MR_Word STATE_VARIABLE_Rs_78_78;
            MR_String Var_79;
            MR_Word STATE_VARIABLE_Rs_80_80;
            MR_Word MinPrioA_122;

            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) "(", MinTermPrio_9, OpPrio_123, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_74_74);
            switch (GtOrGeA_124) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                MinPrioA_122 = OpPrio_123;
                break;
              case (MR_Integer) 0:
                MinPrioA_122 = mercury__ops__increment_priority_1_f_0(OpPrio_123);
                break;
            }
            Var_75 = mercury__univ__univ_value_1_f_0(&TypeInfo_147_147, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_147_147, NonCanon_7, MinPrioA_122, Var_75, STATE_VARIABLE_Rs_74_74, &STATE_VARIABLE_Rs_76_76);
            mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_76_76, &STATE_VARIABLE_Rs_78_78);
            Var_79 = mercury__term_io__quoted_atom_1_f_0(Functor_12);
            mercury__string__to_string__add_revstring_3_p_0(Var_79, STATE_VARIABLE_Rs_78_78, &STATE_VARIABLE_Rs_80_80);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_123, STATE_VARIABLE_Rs_80_80, STATE_VARIABLE_Rs_36);
          }
          else
            mercury__string__to_string__plain_term_to_revstrings_7_p_3(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
        }
    ...
    {
      MR_Word Var_159 = ((MR_Word) ((MR_hl_field(1, Var_155, (MR_Integer) 1))));
      MR_Word Var_160 = ((MR_Word) ((MR_hl_field(1, Var_155, (MR_Integer) 0))));
      ...
      if ((Var_159 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        succeeded = mercury__ops__lookup_op_infos_4_p_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)), Functor_12, &OpInfo_137, &OpInfos_138);
        if (succeeded)
        {
          MR_Word GtOrGeB_29;
          MR_Word OpPrio_134;
          ...
          succeeded = mercury__ops__op_infos_infix_op_5_p_0(OpInfo_137, OpInfos_138, &OpPrio_134, &GtOrGeA_135, &GtOrGeB_29);
          if (succeeded)
          {
            ...
            MR_Word MinPrioA_126;

            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) "(", MinTermPrio_9, OpPrio_134, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_88_88);
            switch (GtOrGeA_135) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                MinPrioA_126 = OpPrio_134;
                break;
              case (MR_Integer) 0:
                MinPrioA_126 = mercury__ops__increment_priority_1_f_0(OpPrio_134);
                break;
            }
            Var_89 = mercury__univ__univ_value_1_f_0(&TypeInfo_149_149, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_149_149, NonCanon_7, MinPrioA_126, Var_89, STATE_VARIABLE_Rs_88_88, &STATE_VARIABLE_Rs_90_90);
            ...
            switch (GtOrGeB_29) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                MinPrioB_30 = OpPrio_134;
                break;
              case (MR_Integer) 0:
                MinPrioB_30 = mercury__ops__increment_priority_1_f_0(OpPrio_134);
                break;
            }
            Var_99 = mercury__univ__univ_value_1_f_0(&TypeInfo_150_150, Var_160);
            mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_150_150, NonCanon_7, MinPrioB_30, Var_99, STATE_VARIABLE_Rs_92_92, &STATE_VARIABLE_Rs_100_100);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_134, STATE_VARIABLE_Rs_100_100, STATE_VARIABLE_Rs_36);
          }
          else
          {
            MR_Word OpPrio_129;
            ...
            succeeded = mercury__ops__op_infos_binary_prefix_op_5_p_0(OpInfo_137, OpInfos_138, &OpPrio_129, &GtOrGeA_130, &GtOrGeB_132);
            if (succeeded)
            {
              ...
              MR_Word MinPrioA_127;
              MR_Word MinPrioB_128;

              mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) "(", MinTermPrio_9, OpPrio_129, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_104_104);
              ...
              switch (GtOrGeA_130) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  MinPrioA_127 = OpPrio_129;
                  break;
                case (MR_Integer) 0:
                  MinPrioA_127 = mercury__ops__increment_priority_1_f_0(OpPrio_129);
                  break;
              }
              Var_109 = mercury__univ__univ_value_1_f_0(&TypeInfo_151_151, Var_156);
              mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_151_151, NonCanon_7, MinPrioA_127, Var_109, STATE_VARIABLE_Rs_108_108, &STATE_VARIABLE_Rs_110_110);
              mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_110_110, &STATE_VARIABLE_Rs_112_112);
              switch (GtOrGeB_132) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  MinPrioB_128 = OpPrio_129;
                  break;
                case (MR_Integer) 0:
                  MinPrioB_128 = mercury__ops__increment_priority_1_f_0(OpPrio_129);
                  break;
              }
              Var_113 = mercury__univ__univ_value_1_f_0(&TypeInfo_152_152, Var_160);
              mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_152_152, NonCanon_7, MinPrioB_128, Var_113, STATE_VARIABLE_Rs_112_112, &STATE_VARIABLE_Rs_114_114);
              mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_129, STATE_VARIABLE_Rs_114_114, STATE_VARIABLE_Rs_36);
            }
            else
              mercury__string__to_string__plain_term_to_revstrings_7_p_3(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
          }
...
#undef MR_PROC_LABEL
  ...
  mercury__string__to_string__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_100_111_95_102_111_108_100_114_95_102_117_110_99_95_95_104_111_50_55_95_95_91_49_44_32_50_44_32_52_44_32_53_93_95_48_5_p_in__version_array_0(TypeInfo_for_T_18, Array_8, Var_25, (MR_Word) ((MR_Unsigned) 0U), &Var_15);
  {
  ...
  MR_Word * STATE_VARIABLE_Rs_17)
{
  ...
  else
  {
    ...
    MR_Word Priority_37;
    MR_Box Var_38;
    MR_Word * AddrSTATE_VARIABLE_Rs_31_41;
    ...
    Priority_37 = mercury__ops__comma_priority_1_f_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)));
    Var_38 = mercury__univ__univ_value_1_f_0(&TypeInfo_15_40, Y_14);
    mercury__string__to_string__value_to_revstrings_prio_6_p_3(TypeInfo_15_40, NonCanon_8, Priority_37, Var_38, STATE_VARIABLE_Rs_29_29, &STATE_VARIABLE_Rs_30_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    AddrSTATE_VARIABLE_Rs_31_41 = (MR_Word *) (&(MR_hl_field(1, *STATE_VARIABLE_Rs_17, (MR_Integer) 1)));
    mercury__string__to_string__LCMC__pred__term_args_to_revstrings__1_5_p_3(NonCanon_8, Ys_15, STATE_VARIABLE_Rs_30_30, AddrSTATE_VARIABLE_Rs_31_41);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Rs_36)
{
  ...
  mercury__deconstruct__deconstruct_5_p_2(TypeInfo_for_T_143, X_10, NonCanon_7, &Functor_12, &_Arity_13, &Args_14);
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((strcmp(Functor_12, (MR_String) "[]") == 0))
    {
      mercury__string__to_string__add_revstring_3_p_0((MR_String) "[]", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_44_44);
  ...
  else
  {
    ...
    if ((strcmp(Functor_12, (MR_String) "{}") == 0))
    {
      if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{ ", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_51_51);
        Var_52 = mercury__univ__univ_value_1_f_0(&TypeInfo_144_144, Var_158);
        mercury__string__to_string__value_to_revstrings_5_p_2(TypeInfo_144_144, NonCanon_7, Var_52, STATE_VARIABLE_Rs_51_51, &STATE_VARIABLE_Rs_53_53);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) " }", STATE_VARIABLE_Rs_53_53, &STATE_VARIABLE_Rs_44_44);
      }
      else
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_57_57);
        mercury__string__to_string__arg_to_revstrings_5_p_2(NonCanon_7, Var_158, STATE_VARIABLE_Rs_57_57, &STATE_VARIABLE_Rs_58_58);
        mercury__string__to_string__term_args_to_revstrings_5_p_2(NonCanon_7, Var_157, STATE_VARIABLE_Rs_58_58, &STATE_VARIABLE_Rs_59_59);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "}", STATE_VARIABLE_Rs_59_59, &STATE_VARIABLE_Rs_44_44);
      }
      succeeded = MR_TRUE;
    }
    ...
    if ((strcmp(Functor_12, (MR_String) "[|]") == 0))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_39 = (MR_String) "[";
          mercury__string__to_string__add_revstring_3_p_0(Var_39, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_40_40);
          mercury__string__to_string__arg_to_revstrings_5_p_2(NonCanon_7, Var_158, STATE_VARIABLE_Rs_40_40, &STATE_VARIABLE_Rs_41_41);
          mercury__string__to_string__univ_list_tail_to_revstrings_5_p_2(NonCanon_7, ListTail_16, STATE_VARIABLE_Rs_41_41, &STATE_VARIABLE_Rs_42_42);
          Var_43 = (MR_String) "]";
          mercury__string__to_string__add_revstring_3_p_0(Var_43, STATE_VARIABLE_Rs_42_42, &STATE_VARIABLE_Rs_44_44);
          succeeded = MR_TRUE;
        }
  ...
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    mercury__string__to_string__plain_term_to_revstrings_7_p_2(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  else
  {
    MR_Word Var_155 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    ...
    if ((Var_155 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_69 = mercury__univ__univ_value_1_f_0(&TypeInfo_146_146, Var_156);
          mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_146_146, NonCanon_7, MinPrioA_27, Var_69, STATE_VARIABLE_Rs_68_68, &STATE_VARIABLE_Rs_70_70);
          mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_25, STATE_VARIABLE_Rs_70_70, STATE_VARIABLE_Rs_36);
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_75 = mercury__univ__univ_value_1_f_0(&TypeInfo_147_147, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_147_147, NonCanon_7, MinPrioA_122, Var_75, STATE_VARIABLE_Rs_74_74, &STATE_VARIABLE_Rs_76_76);
            mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_76_76, &STATE_VARIABLE_Rs_78_78);
            Var_79 = mercury__term_io__quoted_atom_1_f_0(Functor_12);
            mercury__string__to_string__add_revstring_3_p_0(Var_79, STATE_VARIABLE_Rs_78_78, &STATE_VARIABLE_Rs_80_80);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_123, STATE_VARIABLE_Rs_80_80, STATE_VARIABLE_Rs_36);
      ...
      if ((Var_159 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_89 = mercury__univ__univ_value_1_f_0(&TypeInfo_149_149, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_149_149, NonCanon_7, MinPrioA_126, Var_89, STATE_VARIABLE_Rs_88_88, &STATE_VARIABLE_Rs_90_90);
            succeeded = (strcmp(Functor_12, (MR_String) ",") == 0);
            if (succeeded)
              mercury__string__to_string__add_revstring_3_p_0((MR_String) ", ", STATE_VARIABLE_Rs_90_90, &STATE_VARIABLE_Rs_92_92);
            else
            ...
            Var_99 = mercury__univ__univ_value_1_f_0(&TypeInfo_150_150, Var_160);
            mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_150_150, NonCanon_7, MinPrioB_30, Var_99, STATE_VARIABLE_Rs_92_92, &STATE_VARIABLE_Rs_100_100);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_134, STATE_VARIABLE_Rs_100_100, STATE_VARIABLE_Rs_36);
          }
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_109 = mercury__univ__univ_value_1_f_0(&TypeInfo_151_151, Var_156);
              mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_151_151, NonCanon_7, MinPrioA_127, Var_109, STATE_VARIABLE_Rs_108_108, &STATE_VARIABLE_Rs_110_110);
              mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_110_110, &STATE_VARIABLE_Rs_112_112);
              switch (GtOrGeB_132) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
              ...
              Var_113 = mercury__univ__univ_value_1_f_0(&TypeInfo_152_152, Var_160);
              mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_152_152, NonCanon_7, MinPrioB_128, Var_113, STATE_VARIABLE_Rs_112_112, &STATE_VARIABLE_Rs_114_114);
              mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_129, STATE_VARIABLE_Rs_114_114, STATE_VARIABLE_Rs_36);
            }
            else
              mercury__string__to_string__plain_term_to_revstrings_7_p_2(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  ...
  MR_Word * STATE_VARIABLE_Rs_17)
{
  ...
  else
  {
    ...
    Priority_37 = mercury__ops__comma_priority_1_f_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)));
    Var_38 = mercury__univ__univ_value_1_f_0(&TypeInfo_15_40, Y_14);
    mercury__string__to_string__value_to_revstrings_prio_6_p_2(TypeInfo_15_40, NonCanon_8, Priority_37, Var_38, STATE_VARIABLE_Rs_29_29, &STATE_VARIABLE_Rs_30_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_Rs_17 = base;
    ...
    AddrSTATE_VARIABLE_Rs_31_41 = (MR_Word *) (&(MR_hl_field(1, *STATE_VARIABLE_Rs_17, (MR_Integer) 1)));
    mercury__string__to_string__LCMC__pred__term_args_to_revstrings__1_5_p_2(NonCanon_8, Ys_15, STATE_VARIABLE_Rs_30_30, AddrSTATE_VARIABLE_Rs_31_41);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Rs_36)
{
  ...
  mercury__deconstruct__deconstruct_5_p_0(TypeInfo_for_T_143, X_10, NonCanon_7, &Functor_12, &_Arity_13, &Args_14);
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((strcmp(Functor_12, (MR_String) "[]") == 0))
    {
      mercury__string__to_string__add_revstring_3_p_0((MR_String) "[]", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_44_44);
  ...
  else
  {
    ...
    if ((strcmp(Functor_12, (MR_String) "{}") == 0))
    {
      if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{ ", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_51_51);
        Var_52 = mercury__univ__univ_value_1_f_0(&TypeInfo_144_144, Var_158);
        mercury__string__to_string__value_to_revstrings_5_p_0(TypeInfo_144_144, NonCanon_7, Var_52, STATE_VARIABLE_Rs_51_51, &STATE_VARIABLE_Rs_53_53);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) " }", STATE_VARIABLE_Rs_53_53, &STATE_VARIABLE_Rs_44_44);
      }
      else
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_57_57);
        mercury__string__to_string__arg_to_revstrings_5_p_0(NonCanon_7, Var_158, STATE_VARIABLE_Rs_57_57, &STATE_VARIABLE_Rs_58_58);
        mercury__string__to_string__term_args_to_revstrings_5_p_0(NonCanon_7, Var_157, STATE_VARIABLE_Rs_58_58, &STATE_VARIABLE_Rs_59_59);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "}", STATE_VARIABLE_Rs_59_59, &STATE_VARIABLE_Rs_44_44);
      }
      succeeded = MR_TRUE;
    }
    ...
    if ((strcmp(Functor_12, (MR_String) "[|]") == 0))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_39 = (MR_String) "[";
          mercury__string__to_string__add_revstring_3_p_0(Var_39, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_40_40);
          mercury__string__to_string__arg_to_revstrings_5_p_0(NonCanon_7, Var_158, STATE_VARIABLE_Rs_40_40, &STATE_VARIABLE_Rs_41_41);
          mercury__string__to_string__univ_list_tail_to_revstrings_5_p_0(NonCanon_7, ListTail_16, STATE_VARIABLE_Rs_41_41, &STATE_VARIABLE_Rs_42_42);
          Var_43 = (MR_String) "]";
          mercury__string__to_string__add_revstring_3_p_0(Var_43, STATE_VARIABLE_Rs_42_42, &STATE_VARIABLE_Rs_44_44);
          succeeded = MR_TRUE;
        }
  ...
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    mercury__string__to_string__plain_term_to_revstrings_7_p_0(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  else
  {
    MR_Word Var_155 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    ...
    if ((Var_155 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_69 = mercury__univ__univ_value_1_f_0(&TypeInfo_146_146, Var_156);
          mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_146_146, NonCanon_7, MinPrioA_27, Var_69, STATE_VARIABLE_Rs_68_68, &STATE_VARIABLE_Rs_70_70);
          mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_25, STATE_VARIABLE_Rs_70_70, STATE_VARIABLE_Rs_36);
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_75 = mercury__univ__univ_value_1_f_0(&TypeInfo_147_147, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_147_147, NonCanon_7, MinPrioA_122, Var_75, STATE_VARIABLE_Rs_74_74, &STATE_VARIABLE_Rs_76_76);
            mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_76_76, &STATE_VARIABLE_Rs_78_78);
            Var_79 = mercury__term_io__quoted_atom_1_f_0(Functor_12);
            mercury__string__to_string__add_revstring_3_p_0(Var_79, STATE_VARIABLE_Rs_78_78, &STATE_VARIABLE_Rs_80_80);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_123, STATE_VARIABLE_Rs_80_80, STATE_VARIABLE_Rs_36);
      ...
      if ((Var_159 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_89 = mercury__univ__univ_value_1_f_0(&TypeInfo_149_149, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_149_149, NonCanon_7, MinPrioA_126, Var_89, STATE_VARIABLE_Rs_88_88, &STATE_VARIABLE_Rs_90_90);
            succeeded = (strcmp(Functor_12, (MR_String) ",") == 0);
            if (succeeded)
              mercury__string__to_string__add_revstring_3_p_0((MR_String) ", ", STATE_VARIABLE_Rs_90_90, &STATE_VARIABLE_Rs_92_92);
            else
            ...
            Var_99 = mercury__univ__univ_value_1_f_0(&TypeInfo_150_150, Var_160);
            mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_150_150, NonCanon_7, MinPrioB_30, Var_99, STATE_VARIABLE_Rs_92_92, &STATE_VARIABLE_Rs_100_100);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_134, STATE_VARIABLE_Rs_100_100, STATE_VARIABLE_Rs_36);
          }
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_109 = mercury__univ__univ_value_1_f_0(&TypeInfo_151_151, Var_156);
              mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_151_151, NonCanon_7, MinPrioA_127, Var_109, STATE_VARIABLE_Rs_108_108, &STATE_VARIABLE_Rs_110_110);
              mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_110_110, &STATE_VARIABLE_Rs_112_112);
              switch (GtOrGeB_132) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
              ...
              Var_113 = mercury__univ__univ_value_1_f_0(&TypeInfo_152_152, Var_160);
              mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_152_152, NonCanon_7, MinPrioB_128, Var_113, STATE_VARIABLE_Rs_112_112, &STATE_VARIABLE_Rs_114_114);
              mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_129, STATE_VARIABLE_Rs_114_114, STATE_VARIABLE_Rs_36);
            }
            else
              mercury__string__to_string__plain_term_to_revstrings_7_p_0(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  ...
  MR_Word * STATE_VARIABLE_Rs_17)
{
  ...
  else
  {
    ...
    Priority_37 = mercury__ops__comma_priority_1_f_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)));
    Var_38 = mercury__univ__univ_value_1_f_0(&TypeInfo_15_40, Y_14);
    mercury__string__to_string__value_to_revstrings_prio_6_p_0(TypeInfo_15_40, NonCanon_8, Priority_37, Var_38, STATE_VARIABLE_Rs_29_29, &STATE_VARIABLE_Rs_30_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_Rs_17 = base;
    ...
    AddrSTATE_VARIABLE_Rs_31_41 = (MR_Word *) (&(MR_hl_field(1, *STATE_VARIABLE_Rs_17, (MR_Integer) 1)));
    mercury__string__to_string__LCMC__pred__term_args_to_revstrings__1_5_p_0(NonCanon_8, Ys_15, STATE_VARIABLE_Rs_30_30, AddrSTATE_VARIABLE_Rs_31_41);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Rs_36)
{
  ...
  mercury__deconstruct__deconstruct_5_p_1(TypeInfo_for_T_143, X_10, NonCanon_7, &Functor_12, &_Arity_13, &Args_14);
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((strcmp(Functor_12, (MR_String) "[]") == 0))
    {
      mercury__string__to_string__add_revstring_3_p_0((MR_String) "[]", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_44_44);
  ...
  else
  {
    ...
    if ((strcmp(Functor_12, (MR_String) "{}") == 0))
    {
      if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{ ", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_51_51);
        Var_52 = mercury__univ__univ_value_1_f_0(&TypeInfo_144_144, Var_158);
        mercury__string__to_string__value_to_revstrings_5_p_1(TypeInfo_144_144, NonCanon_7, Var_52, STATE_VARIABLE_Rs_51_51, &STATE_VARIABLE_Rs_53_53);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) " }", STATE_VARIABLE_Rs_53_53, &STATE_VARIABLE_Rs_44_44);
      }
      else
      {
        ...
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "{", STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_57_57);
        mercury__string__to_string__arg_to_revstrings_5_p_1(NonCanon_7, Var_158, STATE_VARIABLE_Rs_57_57, &STATE_VARIABLE_Rs_58_58);
        mercury__string__to_string__term_args_to_revstrings_5_p_1(NonCanon_7, Var_157, STATE_VARIABLE_Rs_58_58, &STATE_VARIABLE_Rs_59_59);
        mercury__string__to_string__add_revstring_3_p_0((MR_String) "}", STATE_VARIABLE_Rs_59_59, &STATE_VARIABLE_Rs_44_44);
      }
      succeeded = MR_TRUE;
    }
    ...
    if ((strcmp(Functor_12, (MR_String) "[|]") == 0))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_39 = (MR_String) "[";
          mercury__string__to_string__add_revstring_3_p_0(Var_39, STATE_VARIABLE_Rs_0_35, &STATE_VARIABLE_Rs_40_40);
          mercury__string__to_string__arg_to_revstrings_5_p_1(NonCanon_7, Var_158, STATE_VARIABLE_Rs_40_40, &STATE_VARIABLE_Rs_41_41);
          mercury__string__to_string__univ_list_tail_to_revstrings_5_p_1(NonCanon_7, ListTail_16, STATE_VARIABLE_Rs_41_41, &STATE_VARIABLE_Rs_42_42);
          Var_43 = (MR_String) "]";
          mercury__string__to_string__add_revstring_3_p_0(Var_43, STATE_VARIABLE_Rs_42_42, &STATE_VARIABLE_Rs_44_44);
          succeeded = MR_TRUE;
        }
  ...
  if ((Args_14 == (MR_Word) ((MR_Unsigned) 0U)))
    mercury__string__to_string__plain_term_to_revstrings_7_p_1(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  else
  {
    MR_Word Var_155 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    ...
    if ((Var_155 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_69 = mercury__univ__univ_value_1_f_0(&TypeInfo_146_146, Var_156);
          mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_146_146, NonCanon_7, MinPrioA_27, Var_69, STATE_VARIABLE_Rs_68_68, &STATE_VARIABLE_Rs_70_70);
          mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_25, STATE_VARIABLE_Rs_70_70, STATE_VARIABLE_Rs_36);
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_75 = mercury__univ__univ_value_1_f_0(&TypeInfo_147_147, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_147_147, NonCanon_7, MinPrioA_122, Var_75, STATE_VARIABLE_Rs_74_74, &STATE_VARIABLE_Rs_76_76);
            mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_76_76, &STATE_VARIABLE_Rs_78_78);
            Var_79 = mercury__term_io__quoted_atom_1_f_0(Functor_12);
            mercury__string__to_string__add_revstring_3_p_0(Var_79, STATE_VARIABLE_Rs_78_78, &STATE_VARIABLE_Rs_80_80);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_123, STATE_VARIABLE_Rs_80_80, STATE_VARIABLE_Rs_36);
      ...
      if ((Var_159 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_89 = mercury__univ__univ_value_1_f_0(&TypeInfo_149_149, Var_156);
            mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_149_149, NonCanon_7, MinPrioA_126, Var_89, STATE_VARIABLE_Rs_88_88, &STATE_VARIABLE_Rs_90_90);
            succeeded = (strcmp(Functor_12, (MR_String) ",") == 0);
            if (succeeded)
              mercury__string__to_string__add_revstring_3_p_0((MR_String) ", ", STATE_VARIABLE_Rs_90_90, &STATE_VARIABLE_Rs_92_92);
            else
            ...
            Var_99 = mercury__univ__univ_value_1_f_0(&TypeInfo_150_150, Var_160);
            mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_150_150, NonCanon_7, MinPrioB_30, Var_99, STATE_VARIABLE_Rs_92_92, &STATE_VARIABLE_Rs_100_100);
            mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_134, STATE_VARIABLE_Rs_100_100, STATE_VARIABLE_Rs_36);
          }
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_109 = mercury__univ__univ_value_1_f_0(&TypeInfo_151_151, Var_156);
              mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_151_151, NonCanon_7, MinPrioA_127, Var_109, STATE_VARIABLE_Rs_108_108, &STATE_VARIABLE_Rs_110_110);
              mercury__string__to_string__add_revstring_3_p_0((MR_String) " ", STATE_VARIABLE_Rs_110_110, &STATE_VARIABLE_Rs_112_112);
              switch (GtOrGeB_132) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
              ...
              Var_113 = mercury__univ__univ_value_1_f_0(&TypeInfo_152_152, Var_160);
              mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_152_152, NonCanon_7, MinPrioB_128, Var_113, STATE_VARIABLE_Rs_112_112, &STATE_VARIABLE_Rs_114_114);
              mercury__string__to_string__maybe_add_revstring_5_p_0((MR_String) ")", MinTermPrio_9, OpPrio_129, STATE_VARIABLE_Rs_114_114, STATE_VARIABLE_Rs_36);
            }
            else
              mercury__string__to_string__plain_term_to_revstrings_7_p_1(NonCanon_7, MinTermPrio_9, Functor_12, Args_14, STATE_VARIABLE_Rs_0_35, STATE_VARIABLE_Rs_36);
  ...
  MR_Word * STATE_VARIABLE_Rs_17)
{
  ...
  else
  {
    ...
    Priority_37 = mercury__ops__comma_priority_1_f_0((MR_Word) (&mercury__string__to_string_scalar_common_1[0]), ((MR_Box) ((MR_Integer) 0)));
    Var_38 = mercury__univ__univ_value_1_f_0(&TypeInfo_15_40, Y_14);
    mercury__string__to_string__value_to_revstrings_prio_6_p_1(TypeInfo_15_40, NonCanon_8, Priority_37, Var_38, STATE_VARIABLE_Rs_29_29, &STATE_VARIABLE_Rs_30_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_Rs_17 = base;
    ...
    AddrSTATE_VARIABLE_Rs_31_41 = (MR_Word *) (&(MR_hl_field(1, *STATE_VARIABLE_Rs_17, (MR_Integer) 1)));
    mercury__string__to_string__LCMC__pred__term_args_to_revstrings__1_5_p_1(NonCanon_8, Ys_15, STATE_VARIABLE_Rs_30_30, AddrSTATE_VARIABLE_Rs_31_41);
  }
}
