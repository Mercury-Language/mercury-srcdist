...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
    ...
    mercury__require__error_2_p_0((MR_String) "function \140type_desc.det_make_type\'/2", (MR_String) "make_type/3 failed (wrong arity)");
  return Type_6;
}

void MR_CALL 
mercury__type_desc__make_type_3_p_1(
  MR_Word * TypeCtorDesc_1,
  MR_Word * ArgTypes_2,
  MR_Word TypeDesc_3)
{
{
#define MR_PROC_LABEL mercury__type_desc__make_type_3_p_1
...
MR_bool MR_CALL 
mercury__type_desc__make_type_3_p_0(
  MR_Word TypeCtorDesc_1,
  MR_Word ArgTypes_2,
  MR_Word * TypeDesc_3)
{
...
{
#define MR_PROC_LABEL mercury__type_desc__make_type_3_p_0
...
MR_bool MR_CALL 
mercury__type_desc__pseudo_type_args_2_p_0(
...
{
#define MR_PROC_LABEL mercury__type_desc__pseudo_type_args_2_p_0
...
MR_bool MR_CALL 
mercury__type_desc__pseudo_type_ctor_2_p_0(
...
{
#define MR_PROC_LABEL mercury__type_desc__pseudo_type_ctor_2_p_0
...
#define MR_PROC_LABEL mercury__type_desc__pseudo_type_ctor_1_f_0
	...
	PseudoTypeInfo = PseudoTypeInfo_3 ;
		{
{
    MR_TypeCtorInfo     type_ctor_info;
    MR_PseudoTypeInfo   pseudo_type_info;
  ...
  MR_Word * AddrOfNames_15)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word HeadTailType_8 = ((MR_Word) ((MR_hl_field(1, TailTypes_5, 0))));
      MR_Word TailTailTypes_9 = ((MR_Word) ((MR_hl_field(1, TailTypes_5, 1))));
      MR_Word Var_12;
      ...
      AddrTailNames_14 = (MR_Word *) (&(MR_hl_field(1, Var_12, 1)));
      {
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Type_53 = ((MR_Word) ((MR_hl_field(1, ArgTypes_6, 0))));
        MR_Word Types_54 = ((MR_Word) ((MR_hl_field(1, ArgTypes_6, 1))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word HeadArgType_17 = ((MR_Word) ((MR_hl_field(1, NonReturnArgTypes_13, 0))));
          MR_Word TailArgTypes_18 = ((MR_Word) ((MR_hl_field(1, NonReturnArgTypes_13, 1))));
      ...
      else
      {
        ...
        {
          MR_Word Type_60 = ((MR_Word) ((MR_hl_field(1, ArgTypes_6, 0))));
          MR_Word Types_61 = ((MR_Word) ((MR_hl_field(1, ArgTypes_6, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
