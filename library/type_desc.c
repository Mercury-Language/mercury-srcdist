              ...
              case (MR_Integer) 0:
                {
                  ...
                  mercury__type_desc____Compare____type_ctor_desc_0_0(&Var_8, Var_36, ArgY1_5);
                  ...
                  {
                    MR_Word TypeInfo_34_34 = (MR_Word) &mercury__type_desc_scalar_common_1[0];

                    mercury__builtin__compare_3_p_0(TypeInfo_34_34, HeadVar__1_1, ((MR_Box) (Var_35)), ((MR_Box) (ArgY2_7)));
                  }
                }
                break;
              case (MR_Integer) 1:
...
#define MR_PROC_LABEL mercury__type_desc__get_type_info_for_type_info_0_f_0
	...
	TypeInfo_for_T =  TypeCtorInfo_5_5 ;
		{
{
...
#undef MR_PROC_LABEL
    ...
    TypeCtorInfo_6_6 = (MR_Word) &mercury__type_desc__type_desc__type_ctor_info_type_desc_0;
{
#define MR_PROC_LABEL mercury__type_desc__get_type_info_for_type_info_0_f_0
	...
	TypeInfo_for_T =  TypeCtorInfo_6_6 ;
		{
{
    TypeInfo = TypeInfo_for_T;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      *TypeDescList_4 = (MR_Word) TypeInfoList_3;
      ...
      mercury__type_desc__map__ho1_3_p_in__list_0(TypeInfoList_3, TypeDescList_4);
  }
}
...
succeeded  = SUCCESS_INDICATOR;
      ...
      mercury__type_desc__map__ho1_3_p_in__list_0(V_7_7, &V_9_9);
      {
        MR_Word base;
...
{
  {
    ...
    else
    {
      ...
      if ((Types_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_18 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__type_desc_scalar_common_1[1]);
        TypeCtorInfo_43_43 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        mercury__list__append_3_p_1(TypeCtorInfo_43_43, ArgTypeNames_12, Var_18, &TypeStrings0_13);
        {
          TypeStrings_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TypeStrings_14, 0) = ((MR_Box) ((MR_String) "{"));
          MR_hl_field(MR_mktag(1), TypeStrings_14, 1) = ((MR_Box) (TypeStrings0_13));
        }
        UnqualifiedTypeName_10 = mercury__string__append_list_1_f_0(TypeStrings_14);
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_26 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__type_desc_scalar_common_1[2]);
          {
          ...
          UnqualifiedTypeName_10 = mercury__string__append_list_1_f_0(Var_23);
        }
        else
        {
          ...
          switch (IsFunc_11) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word TypeCtorInfo_44_44 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
                MR_Word Var_29 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__type_desc_scalar_common_1[2]);
                MR_Word Var_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

                mercury__list__append_3_p_1(TypeCtorInfo_44_44, ArgTypeNames_39, Var_29, &TypeStrings0_40);
              }
              break;
            case (MR_Integer) 1:
          ...
          {
            TypeNameStrings_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), TypeNameStrings_17, 0) = ((MR_Box) (Name_8));
            MR_hl_field(MR_mktag(1), TypeNameStrings_17, 1) = ((MR_Box) (Var_32));
          }
          UnqualifiedTypeName_10 = mercury__string__append_list_1_f_0(TypeNameStrings_17);
        }
      }
    }
    succeeded = (strcmp(ModuleName_7, (MR_String) "builtin") == 0);
    ...
    else
    {
      ...
      TypeName_4 = mercury__string__append_list_1_f_0(Var_34);
    }
    return TypeName_4;
  }
}
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      succeeded = mercury__type_desc__all_true__ho2_2_p_in__list_0(ArgPseudos_8);
    if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      succeeded = mercury__type_desc__all_true__ho2_2_p_in__list_0(ArgPseudos_7);
      if (succeeded)
      {
        *TypeDesc_4 = (MR_Word) PseudoTypeDesc_3;
        succeeded = MR_TRUE;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      succeeded = mercury__type_desc__all_true__ho2_2_p_in__list_0(ArgPseudos_9);
      if (succeeded)
      {
        *TypeDesc_4 = (MR_Word) PseudoTypeDesc_3;
        succeeded = MR_TRUE;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      {
        PseudoTypeRep_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
        {
          PseudoTypeRep_4 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), PseudoTypeRep_4, 0) = ((MR_Box) (UnivNum_7));
        }
      else
      {
        MR_Integer UnivNum_9;
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	 UnivNum_9  = TypeVarNum;
	}
succeeded  = SUCCESS_INDICATOR;
}
        if (succeeded)
          {
            PseudoTypeRep_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PseudoTypeRep_4, 0) = ((MR_Box) (UnivNum_9));
          }
        else
        {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      succeeded = mercury__type_desc__all_true__ho2_2_p_in__list_0(ArgPseudos_4);
    return succeeded;
  }
}
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        succeeded = mercury__type_desc__all_true__ho2_2_p_in__list_0(ArgPseudos_10);
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = V_6_6;
