      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__13_13 = (MR_Word) (&mercury__type_desc_scalar_common_1[0]);
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_58 = mercury__type_desc__map__ho1_2_f_in__list_0(TupleArgTypeNames_12);
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Type_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
          MR_Word Types_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));

          mercury__type_desc__type_arg_names_lag_3_p_0(Type_62, Types_63, &ArgTypeNames_48);
        }
        {
      ...
      Var_65 = mercury__type_desc__map__ho1_2_f_in__list_0(TypeNameStrs_16);
      mercury__string__unsafe_append_string_pieces_2_p_0(Var_65, &UnqualifiedTypeName_10);
    }
  }
  succeeded = (strcmp(ModuleName_7, (MR_String) "builtin") == 0);
  if (succeeded)
  ...
  else
  {
    ...
    Var_69 = mercury__type_desc__map__ho1_2_f_in__list_0(Var_43);
    mercury__string__unsafe_append_string_pieces_2_p_0(Var_69, &TypeName_4);
  }
  return TypeName_4;
}
