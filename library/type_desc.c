...
#define	MR_PROC_LABEL	mercury__fn__type_desc__type_desc_to_pseudo_type_desc_1_0
	TypeDesc = MR_r1;
{
#line 474 "type_desc.m"

    PseudoTypeDesc = TypeDesc;
;}
#line 715 "type_desc.c"
