  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Type_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
          MR_Word Types_88 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));

          mercury__type_desc__type_arg_names_lag_3_p_0(Type_87, Types_88, &ArgTypeNames_48);
        }
        {
