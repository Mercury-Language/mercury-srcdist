...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Type_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
        MR_Word Types_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));

        mercury__type_desc__type_arg_names_lag_3_p_0(Type_66, Types_67, &ArgTypeNames_11);
      }
      {
      ...
      Var_77 = mercury__type_desc__map__ho1_2_f_in__list_0(TupleArgTypeNames_12);
      mercury__string__unsafe_append_string_pieces_2_p_0(Var_77, &UnqualifiedTypeName_10);
    }
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Type_89 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
          MR_Word Types_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));

          mercury__type_desc__type_arg_names_lag_3_p_0(Type_89, Types_90, &ArgTypeNames_48);
        }
        {
        ...
        TypeNameStrs_16 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_37, (MR_Word) (MR_mkword(MR_mktag(1), &mercury__type_desc_scalar_common_1[2])));
      }
      mercury__string__append_list_2_p_0(TypeNameStrs_16, &UnqualifiedTypeName_10);
    }
  }
  succeeded = (strcmp(ModuleName_7, (MR_String) "builtin") == 0);
  if (succeeded)
  ...
  else
  {
    ...
    mercury__string__append_list_2_p_0(Var_43, &TypeName_4);
  }
  return TypeName_4;
}
