...
succeeded  = SUCCESS_INDICATOR;
      ...
      mercury__type_desc__map__ho2_3_p_in__list_0(V_7_7, &V_9_9);
      {
        MR_Word base;
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_String FuncReturnName_13;
          MR_Word Var_16;
          MR_Word Var_18;

          FuncReturnName_13 = mercury__type_desc__type_name_1_f_0(FuncReturnType_12);
          {
            Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_18, 0) = ((MR_Box) (FuncReturnName_13));
        ...
        else
        {
          ...
          mercury__type_desc__type_arg_names_3_p_0(Types_6, IsFunc_2, &Names_14);
          {
            Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) ((MR_String) ", "));
            MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Names_14));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
	 V_5_14  = Length;
      ...
      V_9_9 = mercury__type_desc__map__ho1_2_f_in__list_0(V_7_7);
      {
