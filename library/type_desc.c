  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_12, 1) = NULL;
      }
      AddrTailNames_14 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), Var_12, (MR_Integer) 1)));
      {
        ...
        MR_hl_field(MR_mktag(1), Names_16, 1) = ((MR_Box) (Var_12));
      }
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Type_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
        MR_Word Types_54 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));
      ...
      Var_64 = mercury__type_desc__map__ho1_2_f_in__list_0(TupleArgTypeNames_12);
      mercury__string__unsafe_append_string_pieces_2_p_0(Var_64, &UnqualifiedTypeName_10);
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        if ((NonReturnArgTypes_13 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (ReturnArgTypeName_15));
            MR_hl_field(MR_mktag(1), Var_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__type_desc_scalar_common_1[2])));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), TypeNameStrs_16, 1) = ((MR_Box) (Var_26));
          }
        }
        else
        {
          ...
          mercury__type_desc__type_arg_names_lag_3_p_0(HeadArgType_17, TailArgTypes_18, &NonReturnArgTypeNames_19);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (NonReturnArgTypeNames_19));
          }
          {
            Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (Name_8));
            MR_hl_field(MR_mktag(1), Var_30, 1) = ((MR_Box) (Var_31));
          }
          {
            Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (ReturnArgTypeName_15));
      ...
      else
      {
        ...
        {
          MR_Word Type_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 0))));
          MR_Word Types_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_6, (MR_Integer) 1))));

          mercury__type_desc__type_arg_names_lag_3_p_0(Type_74, Types_75, &ArgTypeNames_48);
        }
        {
      ...
      Var_85 = mercury__type_desc__map__ho1_2_f_in__list_0(TypeNameStrs_16);
      mercury__string__unsafe_append_string_pieces_2_p_0(Var_85, &UnqualifiedTypeName_10);
    }
  }
  succeeded = (strcmp(ModuleName_7, (MR_String) "builtin") == 0);
  if (succeeded)
  ...
  else
  {
    ...
    Var_91 = mercury__type_desc__map__ho1_2_f_in__list_0(Var_43);
    mercury__string__unsafe_append_string_pieces_2_p_0(Var_91, &TypeName_4);
  }
  return TypeName_4;
}
...
#undef MR_PROC_LABEL
    ...
    mercury__type_desc__LCMC__func__map__ho1__1_3_p_0(Var_7, AddrSCCcallarg_9_17);
  }
  return HeadVar__3_3;
}
