    ...
    if (((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (((MR_tag((MR_Word) mercury__lazy__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word mercury__lazy__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_pred_3_p_0(mercury__lazy__HeadVar__1_1, (MR_Word) mercury__lazy__Var_18, (MR_Word) mercury__lazy__Var_11);
            }
          }
        else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) mercury__lazy__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          *mercury__lazy__HeadVar__1_1 = (MR_Integer) 1;
          ...
          {
            MR_Box mercury__lazy__Var_5 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__3_3, (MR_Integer) 0));

            {
              mercury__builtin__compare_3_p_0(mercury__lazy__TypeInfo_for_T_14, mercury__lazy__HeadVar__1_1, mercury__lazy__Var_19, mercury__lazy__Var_5);
            }
          }
      }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mercury__lazy__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word mercury__lazy__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mercury__lazy__Var_6;

        mercury__lazy__succeeded = ((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mercury__lazy__succeeded)
          {
            mercury__lazy__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__2_2, (MR_Integer) 0)));
            {
              mercury__lazy__succeeded = mercury__private_builtin__builtin_unify_pred_2_p_0((MR_Word) mercury__lazy__Var_5, (MR_Word) mercury__lazy__Var_6);
            }
          }
      }
    else
      {
        MR_Box mercury__lazy__Var_3 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__1_1, (MR_Integer) 0));
        MR_Box mercury__lazy__Var_4;

        mercury__lazy__succeeded = ((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (mercury__lazy__succeeded)
          {
            mercury__lazy__Var_4 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__2_2, (MR_Integer) 0));
            {
              mercury__lazy__succeeded = mercury__builtin__unify_2_p_0(mercury__lazy__TypeInfo_for_T_9, mercury__lazy__Var_3, mercury__lazy__Var_4);
            }
          }
      }
    return mercury__lazy__succeeded;
