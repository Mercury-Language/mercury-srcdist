  ...
  MR_Box * Value_4)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__lazy__lazy__type_ctor_info_lazy_state_1;
    ...
    succeeded = ((MR_tag((MR_Word) State_6)) == (MR_mktag((MR_Integer) 0)));
    if (succeeded)
...
{
  {
    MR_Box Value_4;
    MR_Word Mutvar_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), Lazy_3, (MR_Integer) 0)));
    MR_Word TypeCtorInfo_10_10 = (MR_Word) &mercury__lazy__lazy__type_ctor_info_lazy_state_1;
    ...
    State_6 = ((MR_Word) conv0_State_6);
    if (((MR_tag((MR_Word) State_6)) == (MR_mktag((MR_Integer) 1))))
    {
...
{
  {
    ...
    TypeCtorInfo_7_7 = (MR_Word) &mercury__lazy__lazy__type_ctor_info_lazy_state_1;
    {
