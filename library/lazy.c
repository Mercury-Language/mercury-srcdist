...
{
  {
    ...
    if (((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word mercury__lazy__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__2_2, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) mercury__lazy__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word mercury__lazy__ArgY1_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_pred_3_p_0(mercury__lazy__HeadVar__1_1, (MR_Word) mercury__lazy__Var_18, (MR_Word) mercury__lazy__ArgY1_11);
            }
          }
        else
      ...
      {
        MR_Box mercury__lazy__Var_19 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__2_2, (MR_Integer) 0));

        if (((MR_tag((MR_Word) mercury__lazy__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          *mercury__lazy__HeadVar__1_1 = (MR_Integer) 1;
        else
          {
            MR_Box mercury__lazy__ArgY1_5 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__3_3, (MR_Integer) 0));

            {
              mercury__builtin__compare_3_p_0(mercury__lazy__TypeInfo_for_T_14, mercury__lazy__HeadVar__1_1, mercury__lazy__Var_19, mercury__lazy__ArgY1_5);
            }
          }
      }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mercury__lazy__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word mercury__lazy__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mercury__lazy__ArgY1_6;

        mercury__lazy__succeeded = ((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mercury__lazy__succeeded)
          {
            mercury__lazy__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__lazy__HeadVar__2_2, (MR_Integer) 0)));
            {
              mercury__lazy__succeeded = mercury__private_builtin__builtin_unify_pred_2_p_0((MR_Word) mercury__lazy__ArgX1_5, (MR_Word) mercury__lazy__ArgY1_6);
            }
          }
      }
    else
      {
        MR_Box mercury__lazy__ArgX1_3 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__1_1, (MR_Integer) 0));
        MR_Box mercury__lazy__ArgY1_4;

        mercury__lazy__succeeded = ((MR_tag((MR_Word) mercury__lazy__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (mercury__lazy__succeeded)
          {
            mercury__lazy__ArgY1_4 = (MR_hl_field(MR_mktag(0), mercury__lazy__HeadVar__2_2, (MR_Integer) 0));
            {
              mercury__lazy__succeeded = mercury__builtin__unify_2_p_0(mercury__lazy__TypeInfo_for_T_9, mercury__lazy__ArgX1_3, mercury__lazy__ArgY1_4);
            }
          }
      }
...
{
  {
    ...
    if (mercury__lazy__succeeded)
      *mercury__lazy__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mercury__lazy__Var_10;
        MR_Box mercury__lazy__Var_11;

        {
          mercury__lazy__Var_10 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__HeadVar__2_2);
        }
        {
          mercury__lazy__Var_11 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__HeadVar__3_3);
        }
        {
          mercury__builtin__compare_3_p_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__HeadVar__1_1, mercury__lazy__Var_10, mercury__lazy__Var_11);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__lazy__succeeded)
      ...
      {
        MR_Box mercury__lazy__Var_8;
        MR_Box mercury__lazy__Var_9;

        {
          mercury__lazy__Var_8 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_5, mercury__lazy__HeadVar__1_1);
        }
        {
          mercury__lazy__Var_9 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_5, mercury__lazy__HeadVar__2_2);
        }
        {
          mercury__lazy__succeeded = mercury__builtin__unify_2_p_0(mercury__lazy__TypeInfo_for_T_5, mercury__lazy__Var_8, mercury__lazy__Var_9);
        }
      }
    return mercury__lazy__succeeded;
  }
  ...
  MR_Word mercury__lazy__Y_6)
{
  {
    MR_bool mercury__lazy__succeeded;
    MR_Box mercury__lazy__Var_7;
    MR_Box mercury__lazy__Var_8;

    {
      mercury__lazy__Var_7 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_9, mercury__lazy__X_5);
    }
    {
      mercury__lazy__Var_8 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_9, mercury__lazy__Y_6);
    }
    {
      mercury__builtin__compare_3_p_0(mercury__lazy__TypeInfo_for_T_9, mercury__lazy__R_4, mercury__lazy__Var_7, mercury__lazy__Var_8);
    }
  }
}
  ...
  MR_Word mercury__lazy__Y_4)
{
  {
    MR_bool mercury__lazy__succeeded;
    MR_Box mercury__lazy__Var_5;
    MR_Box mercury__lazy__Var_7;

    {
      mercury__lazy__Var_5 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__X_3);
    }
    {
      mercury__lazy__Var_7 = mercury__lazy__force_1_f_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__Y_4);
    }
    {
      mercury__lazy__succeeded = mercury__builtin__unify_2_p_0(mercury__lazy__TypeInfo_for_T_6, mercury__lazy__Var_5, mercury__lazy__Var_7);
    }
    return mercury__lazy__succeeded;
  }
}
    ...
    if (((MR_tag((MR_Word) mercury__lazy__State_6)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          mercury__lazy__Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), mercury__lazy__Var_8, 0) = mercury__lazy__Value_4;
        }
        {
          mercury__mutvar__set_mutvar_2_p_0(mercury__lazy__TypeInfo_11_11, (MR_Word) mercury__lazy__Mutvar_5, ((MR_Box) (mercury__lazy__Var_8)));
        }
      }
    else
      mercury__lazy__Value_4 = (MR_hl_field(MR_mktag(0), mercury__lazy__State_6, (MR_Integer) 0));
...
{
  {
    ...
    MR_Word mercury__lazy__Var_5;
    MR_Word mercury__lazy__conv0_Mutvar_4;

    {
      mercury__lazy__Var_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mercury__lazy__Var_5, 0) = ((MR_Box) (mercury__lazy__F_3));
    }
    ...
    {
      mercury__mutvar__new_mutvar_2_p_0(mercury__lazy__TypeInfo_8_8, ((MR_Box) (mercury__lazy__Var_5)), &mercury__lazy__conv0_Mutvar_4);
    }
...
{
  {
    ...
    {
      mercury__lazy__Var_5 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mercury__lazy__Var_5, 0) = mercury__lazy__X_3;
    }
    mercury__lazy__TypeCtorInfo_7_7 = (MR_Word) &mercury__lazy__lazy__type_ctor_info_lazy_state_1;
    {
      mercury__lazy__TypeInfo_8_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
