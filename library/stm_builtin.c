...
#undef MR_PROC_LABEL
    ...
    {
      V_14_33 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      TypeInfo_22_45 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
...
#undef MR_PROC_LABEL
	 InnerSTM_B0_15  = (MR_Box) Child;
        ...
        {
          V_14_53 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          TypeInfo_22_65 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
...
#undef MR_PROC_LABEL
    ...
    {
      V_14_24 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      TypeInfo_22_36 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
