...
#undef MR_PROC_LABEL
...
}
    {
      ...
      MR_hl_field(MR_mktag(0), V_14_33, 2) = ((MR_Box) ((MR_Integer) 3));
...
#undef MR_PROC_LABEL
	 InnerSTM_B0_15  = (MR_Box) Child;
}
        {
          ...
          MR_hl_field(MR_mktag(0), V_14_53, 2) = ((MR_Box) ((MR_Integer) 3));
...
#undef MR_PROC_LABEL
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), V_14_24, 2) = ((MR_Box) ((MR_Integer) 3));
