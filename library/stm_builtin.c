...
#undef MR_PROC_LABEL
...
}
  {
    ...
    MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&mercury__stm_builtin_scalar_common_6[0]));
    MR_hl_field(MR_mktag(0), Var_29, 1) = ((MR_Box) (mercury__stm_builtin__or_else_5_p_0_1));
    MR_hl_field(MR_mktag(0), Var_29, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_29, 3) = ((MR_Box) (TypeInfo_for_T_25));
    MR_hl_field(MR_mktag(0), Var_29, 4) = ((MR_Box) (TransA_6));
    MR_hl_field(MR_mktag(0), Var_29, 5) = ((MR_Box) (InnerSTM_A0_11));
  }
  {
    TypeInfo__21_38 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), TypeInfo__21_38, 0) = ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_tuple_0));
    MR_hl_field(MR_mktag(0), TypeInfo__21_38, 1) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), TypeInfo__21_38, 2) = ((MR_Box) (TypeInfo_for_T_25));
    MR_hl_field(MR_mktag(0), TypeInfo__21_38, 3) = ((MR_Box) (&mercury__stm_builtin__stm_builtin__type_ctor_info_stm_0));
  }
  mercury__exception__try_2_p_0(TypeInfo__21_38, (MR_Word) (Var_29), &conv1_Var_30);
  Var_30 = (MR_Word) (conv1_Var_30);
  if (((MR_tag((MR_Word) Var_30)) == (MR_Integer) 2))
  {
    MR_Word Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_30, (MR_Integer) 0))));
    MR_Word Var_35;
    MR_Box conv2_Copy;
...
#undef MR_PROC_LABEL
...
}
    {
      ...
      MR_hl_field(MR_mktag(2), ResultA_12, 0) = ((MR_Box) (Var_35));
    }
    InnerSTM_A_13 = InnerSTM_A0_11;
  }
  else
  {
    MR_Tuple Var_31 = ((MR_Tuple) ((MR_hl_field(MR_mktag(1), Var_30, (MR_Integer) 0))));
    MR_Box Var_32 = (MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 0));
    MR_Box Var_33 = ((MR_Box) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 1))));

    {
      ResultA_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ResultA_12, 0) = Var_32;
    }
...
#undef MR_PROC_LABEL
	InnerSTM_B0_15  = (MR_Box) Child;
}
      {
        ...
        MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&mercury__stm_builtin_scalar_common_6[0]));
        MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (mercury__stm_builtin__or_else_5_p_0_2));
        MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (TypeInfo_for_T_25));
        MR_hl_field(MR_mktag(0), Var_41, 4) = ((MR_Box) (TransB_7));
        MR_hl_field(MR_mktag(0), Var_41, 5) = ((MR_Box) (InnerSTM_B0_15));
      }
      {
        TypeInfo__21_50 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeInfo__21_50, 0) = ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_tuple_0));
        MR_hl_field(MR_mktag(0), TypeInfo__21_50, 1) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), TypeInfo__21_50, 2) = ((MR_Box) (TypeInfo_for_T_25));
        MR_hl_field(MR_mktag(0), TypeInfo__21_50, 3) = ((MR_Box) (&mercury__stm_builtin__stm_builtin__type_ctor_info_stm_0));
      }
      mercury__exception__try_2_p_0(TypeInfo__21_50, (MR_Word) (Var_41), &conv5_Var_42);
      Var_42 = (MR_Word) (conv5_Var_42);
      if (((MR_tag((MR_Word) Var_42)) == (MR_Integer) 2))
      {
        MR_Word Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_42, (MR_Integer) 0))));
        MR_Word Var_47;
        MR_Box conv6_Copy;
...
#undef MR_PROC_LABEL
	conv6_Copy  = (MR_Box) Copy;
...
}
        {
          ...
          MR_hl_field(MR_mktag(2), ResultB_16, 0) = ((MR_Box) (Var_47));
        }
        InnerSTM_B_17 = InnerSTM_B0_15;
      }
      else
      {
        MR_Tuple Var_43 = ((MR_Tuple) ((MR_hl_field(MR_mktag(1), Var_42, (MR_Integer) 0))));
        MR_Box Var_44 = (MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 0));
        MR_Box Var_45 = ((MR_Box) ((MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 1))));

        {
          ResultB_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ResultB_16, 0) = Var_44;
        }
...
#undef MR_PROC_LABEL
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&mercury__stm_builtin_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (mercury__stm_builtin__atomic_transaction_impl_2_p_0_2));
      MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (TypeInfo_for_T_14));
      MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (Var_10));
      MR_hl_field(MR_mktag(0), Var_20, 5) = ((MR_Box) (STM0_5));
    }
    {
      TypeInfo__21_29 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeInfo__21_29, 0) = ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_tuple_0));
      MR_hl_field(MR_mktag(0), TypeInfo__21_29, 1) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), TypeInfo__21_29, 2) = ((MR_Box) (TypeInfo_for_T_14));
      MR_hl_field(MR_mktag(0), TypeInfo__21_29, 3) = ((MR_Box) (&mercury__stm_builtin__stm_builtin__type_ctor_info_stm_0));
    }
    mercury__exception__try_2_p_0(TypeInfo__21_29, (MR_Word) (Var_20), &conv2_Var_21);
    Var_21 = (MR_Word) (conv2_Var_21);
    if (((MR_tag((MR_Word) Var_21)) == (MR_Integer) 2))
    {
      MR_Word Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_21, (MR_Integer) 0))));
      MR_Word Var_26;
      MR_Box conv3_Copy;
...
#undef MR_PROC_LABEL
	conv3_Copy  = (MR_Box) Copy;
...
}
      {
        ...
        MR_hl_field(MR_mktag(2), Result0_6, 0) = ((MR_Box) (Var_26));
      }
      STM_7 = STM0_5;
    }
    else
    {
      MR_Tuple Var_22 = ((MR_Tuple) ((MR_hl_field(MR_mktag(1), Var_21, (MR_Integer) 0))));
      MR_Box Var_23 = (MR_hl_field(MR_mktag(0), Var_22, (MR_Integer) 0));
      MR_Box Var_24 = ((MR_Box) ((MR_hl_field(MR_mktag(0), Var_22, (MR_Integer) 1))));

      {
        Result0_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Result0_6, 0) = Var_23;
      }
      STM_7 = Var_24;
    }
