...
static /* final */ const struct mercury__string__parse_util__vector_common_type_5_0_s mercury__string__parse_util_vector_common_5[5];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__string__parse_util__LCMCpr_gather_non_percent_chars_1_3_p_0(TailChars_8, AddrTailNonConversionSpecChars_10, GatherEndedBy_6);
      }
    }
  }
}
...
void MR_CALL 
mercury__string__parse_util__LCMCpr_gather_non_percent_chars_1_3_p_0(
  MR_Word Chars_4,
