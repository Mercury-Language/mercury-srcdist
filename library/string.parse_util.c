...
static const MR_EnumFunctorDescPtr mercury__string__parse_util__string__parse_util__enum_value_ordered_poly_kind_0[5];

static const MR_EnumFunctorDescPtr mercury__string__parse_util__string__parse_util__enum_name_ordered_poly_kind_0[5];

static const MR_Integer mercury__string__parse_util__string__parse_util__functor_number_map_poly_kind_0[5];
...
static /* final */ const struct mercury__string__parse_util__vector_common_type_5_0_s mercury__string__parse_util_vector_common_5[15];
...
static /* final */ const struct mercury__string__parse_util__vector_common_type_5_0_s mercury__string__parse_util_vector_common_5[15] = {
  ...
  /* row 3 */   {     (MR_String) "an unsigned integer" },
  /* row 4 */   {     (MR_String) "a float" },
  /* row 5 */   {     (MR_String) "a character" },
  /* row 6 */   {     (MR_String) "a string" },
  /* row 7 */   {     (MR_String) "an integer" },
  /* row 8 */   {     (MR_String) "an unsigned integer" },
  /* row 9 */   {     (MR_String) "a float" },
  /* row 10 */   {     (MR_String) "a character" },
  /* row 11 */   {     (MR_String) "a string" },
  /* row 12 */   {     (MR_String) "an integer" },
  /* row 13 */   {     (MR_String) "an unsigned integer" },
  /* row 14 */   {     (MR_String) "a float" },
};
...
#undef MR_PROC_LABEL
	 V_8_405  = Int;
        ...
        case (MR_Integer) 2:
          {
            MR_Word Var_351 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word ArgY3_93 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__3_3, (MR_Integer) 2))) & (MR_Integer) 7);
...
#undef MR_PROC_LABEL
	 V_8_379  = Int;
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_347 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          MR_Word ArgY2_179 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2))) & (MR_Integer) 7);
            ...
            case (MR_Integer) 3:
              {
                MR_Word Var_345 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
                      ...
                      case (MR_Integer) 3:
                        {
                          ...
                          MR_Word ArgY2_248 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Char ArgY2_14;
            MR_Word ArgX3_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 2))) & (MR_Integer) 7);
            MR_Word ArgY3_16;
            ...
            if (succeeded)
            {
              ...
              ArgY3_16 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Integer ArgY1_22;
                MR_Word ArgX2_23 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))) & (MR_Integer) 7);
                MR_Word ArgY2_24;
                ...
                if (succeeded)
                {
                  ...
                  ArgY2_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Integer ArgY1_28;
                MR_Word ArgX2_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))) & (MR_Integer) 7);
                MR_Word ArgY2_30;
                ...
                if (succeeded)
                {
                  ...
                  ArgY2_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 7);
...
{
  {
    ...
    switch (MR_tag((MR_Word) Error_3)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              MR_String Var_79;
              MR_String Var_80;
              MR_Integer Var_81 = (MR_Integer) ((MR_Unsigned) NumExtraPolyTypes_6 - (MR_Unsigned) 1);
      ...
      case (MR_Integer) 2:
        {
          MR_Word PolyKind_9 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Error_3, (MR_Integer) 2))) & (MR_Integer) 7);
          MR_String Var_57;
          MR_String Var_58;
          MR_String Var_60;
          MR_String Var_61;
          ...
          Var_65 = ((&mercury__string__parse_util_vector_common_5[10 + PolyKind_9]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word PolyKind_90 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Error_3, (MR_Integer) 2))) & (MR_Integer) 7);

              Var_43 = mercury__string__parse_util__nth_specifier_1_f_0(SpecNum_89);
              Var_49 = ((&mercury__string__parse_util_vector_common_5[5 + PolyKind_90]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word PolyKind_93 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Error_3, (MR_Integer) 2))) & (MR_Integer) 7);
