  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__9_9 = (MR_Word) (&mercury__string__parse_util_scalar_common_1[0]);
    ...
    case (MR_Integer) 0:
      {
        ...
        mercury__string__append_3_p_2(Var_75, (MR_String) " is missing", &Msg0_7);
...
#undef MR_PROC_LABEL
	Var_82  = S;
            ...
            mercury__string__append_3_p_2(Var_82, (MR_String) " extra inputs.", &Var_81);
            mercury__string__append_3_p_2((MR_String) ", and there are ", Var_81, &Var_79);
            mercury__string__append_3_p_2(Msg0_7, Var_79, &Msg_4);
          }
        }
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        mercury__string__append_3_p_2(Var_73, (MR_String) ".", &Var_72);
        mercury__string__append_3_p_2((MR_String) " uses the unknown ", Var_72, &Var_70);
        mercury__string__append_3_p_2(Var_69, Var_70, &Msg_4);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_65 = ((&mercury__string__parse_util_vector_common_5[26 + PolyKind_9]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
        Var_68 = mercury__string__parse_util__acceptable_specifier_chars_for_poly_kind_msg_1_f_0(PolyKind_9);
        mercury__string__append_3_p_2((MR_String) ". ", Var_68, &Var_66);
        mercury__string__append_3_p_2(Var_65, Var_66, &Var_64);
        mercury__string__append_3_p_2((MR_String) ", but the corresponding input is ", Var_64, &Var_62);
        mercury__string__append_3_p_2(Var_61, Var_62, &Var_60);
        mercury__string__append_3_p_2((MR_String) " uses the ", Var_60, &Var_58);
        mercury__string__append_3_p_2(Var_57, Var_58, &Msg_4);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__string__append_3_p_2(Var_55, (MR_String) ", is missing its input.", &Var_54);
            mercury__string__append_3_p_2((MR_String) ", which uses ", Var_54, &Var_52);
            mercury__string__append_3_p_2(Var_51, Var_52, &Msg_4);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            Var_49 = ((&mercury__string__parse_util_vector_common_5[13 + PolyKind_92]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
            mercury__string__append_3_p_2(Var_49, (MR_String) ", not an integer.", &Var_48);
            mercury__string__append_3_p_2((MR_String) " but the next input is ", Var_48, &Var_46);
            mercury__string__append_3_p_2((MR_String) " says the width is a runtime input,", Var_46, &Var_44);
            mercury__string__append_3_p_2(Var_43, Var_44, &Msg_4);
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            mercury__string__append_3_p_2((MR_String) " says the width is a runtime input,", (MR_String) " but there is no next input.", &Var_40);
            mercury__string__append_3_p_2(Var_39, Var_40, &Msg_4);
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            Var_37 = ((&mercury__string__parse_util_vector_common_5[0 + PolyKind_95]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
            mercury__string__append_3_p_2(Var_37, (MR_String) ", not an integer.", &Var_36);
            mercury__string__append_3_p_2((MR_String) " but the next input is ", Var_36, &Var_34);
            mercury__string__append_3_p_2((MR_String) " says the precision is a runtime input,", Var_34, &Var_32);
            mercury__string__append_3_p_2(Var_31, Var_32, &Msg_4);
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            mercury__string__append_3_p_2((MR_String) " says the precision is a runtime input,", (MR_String) " but there is no next input.", &Var_28);
            mercury__string__append_3_p_2(Var_27, Var_28, &Msg_4);
          }
          break;
        case (MR_Integer) 5:
          {
            ...
            mercury__string__append_3_p_2(Var_13, (MR_String) " conversion specifier,", &Var_12);
            mercury__string__append_3_p_2((MR_String) "There is no ", Var_12, &Msg0_99);
            ...
            if (succeeded)
            {
              ...
              mercury__string__append_3_p_2(Extra_10, (MR_String) "input.", &Var_17);
              mercury__string__append_3_p_2((MR_String) " but there is an ", Var_17, &Var_15);
              mercury__string__append_3_p_2(Msg0_99, Var_15, &Msg_4);
            }
            else
            {
              MR_String Var_19;
...
#undef MR_PROC_LABEL
	Var_22  = S;
              ...
              mercury__string__append_3_p_2(Extra_10, (MR_String) "inputs.", &Var_25);
              mercury__string__append_3_p_2((MR_String) " ", Var_25, &Var_23);
              mercury__string__append_3_p_2(Var_22, Var_23, &Var_21);
              mercury__string__append_3_p_2((MR_String) " but there are ", Var_21, &Var_19);
              mercury__string__append_3_p_2(Msg0_99, Var_19, &Msg_4);
            }
          }
          break;
      }
