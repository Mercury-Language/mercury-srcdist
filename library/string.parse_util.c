  ...
  MR_Integer * N_5)
{
  ...
  if (succeeded)
  {
    ...
    STATE_VARIABLE_Chars_10_10 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_Chars_0_8, 1))));
  ...
  MR_Integer * N_7)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      STATE_VARIABLE_Chars_13_13 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_Chars_0_11, 1))));
  ...
  MR_Word * STATE_VARIABLE_Flags_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      STATE_VARIABLE_Chars_12_12 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_Chars_0_8, 1))));
