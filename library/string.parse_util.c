...
static /* final */ const struct mercury__string__parse_util__vector_common_type_5_0_s mercury__string__parse_util_vector_common_5[10];
...
static /* final */ const struct mercury__string__parse_util__vector_common_type_5_0_s mercury__string__parse_util_vector_common_5[10] = {
  ...
  /* row 5 */   {     (MR_String) "The only specifier applicable to characters is %c." },
  /* row 6 */   {     (MR_String) "The only specifier applicable to strings is %s." },
  /* row 7 */   {     (MR_String) "The specifiers applicable to ints are %d, %i, %o, %x, %X, %u, and %p." },
  /* row 8 */   {     (MR_String) "The specifiers applicable to uints are %o, %x, %X, %u, and %p." },
  /* row 9 */   {     (MR_String) "The specifiers applicable to floats are %f, %e, %E, %g and %G." },
};
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word PolyKind_92 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Error_3, (MR_Integer) 2))) & (MR_Integer) 7);
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word PolyKind_95 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Error_3, (MR_Integer) 2))) & (MR_Integer) 7);
...
{
  {
    MR_String Msg_4 = ((&mercury__string__parse_util_vector_common_5[5 + Kind_3]))->mercury__string__parse_util__vector_common_type_5_0__vct_5_f_0;
