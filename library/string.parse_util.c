...
{
  {
    ...
    if ((Chars_4 == (MR_Word) ((MR_Integer) 0)))
    {
      *NonConversionSpecChars_5 = (MR_Word) ((MR_Integer) 0);
      *GatherEndedBy_6 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), V_5_12, 1) = ((MR_Box) ((MR_Integer) 0));
    }
