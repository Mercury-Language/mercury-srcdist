        ...
        if (succeeded)
        {
            ...
            GtOrGeB_17 = ((MR_Unsigned) ((MR_hl_field(1, Var_50, (MR_Integer) 1))) & (MR_Integer) 1);
            {
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_63, 1) = ((MR_Box) (MR_mkword(1, &mercury__pretty_printer_scalar_common_4[15])));
                }
                {
                  Var_60 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_60, 0) = ((MR_Box) (MR_mkword(1, &mercury__pretty_printer_scalar_common_5[5])));
              ...
              }
              {
                ...
                MR_hl_field(1, Var_77, 1) = ((MR_Box) (MR_mkword(1, &mercury__pretty_printer_scalar_common_4[16])));
              }
              {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_92 = (MR_Word) (MR_mkword(1, &mercury__pretty_printer_scalar_common_5[5]));
              Var_103 = (MR_Word) (MR_mkword(3, &mercury__pretty_printer_scalar_common_4[5]));
              Var_110 = (MR_Word) (MR_mkword(1, &mercury__pretty_printer_scalar_common_4[16]));
              {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(1, Var_117, 0) = ((MR_Box) (MR_mkword(1, &mercury__pretty_printer_scalar_common_5[3])));
          MR_hl_field(1, Var_117, 1) = ((MR_Box) (Docs0_15));
        }
        *Docs_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__pretty_printer__pretty_printer__type_ctor_info_doc_0), Var_117, (MR_Word) (MR_mkword(1, &mercury__pretty_printer_scalar_common_4[17])));
      }
      else
        *Docs_8 = Docs0_15;
      succeeded = MR_TRUE;
