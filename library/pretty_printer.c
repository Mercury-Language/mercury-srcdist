      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_11;
          ...
          mercury__pretty_printer____Compare____func_symbol_limit_0_0(HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__pretty_printer____Compare____indent_stack_0_0(&Var_12, Var_18, ArgY1_9);
...
{
  {
    MR_Word TypeInfo_6_6 = (MR_Word) &mercury__pretty_printer_scalar_common_2[3];
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_5_5 = (MR_Word) &mercury__pretty_printer_scalar_common_2[3];
...
{
  {
    MR_Word TypeInfo_6_6 = (MR_Word) &mercury__pretty_printer_scalar_common_4[1];
    MR_Word Cast_HeadVar1_4 = HeadVar__2_2;
    MR_Word Cast_HeadVar2_5 = HeadVar__3_3;
...
{
  {
    MR_Word TypeInfo_6_6 = (MR_Word) &mercury__pretty_printer_scalar_common_1[3];
    MR_Word Cast_HeadVar1_4 = HeadVar__2_2;
    MR_Word Cast_HeadVar2_5 = HeadVar__3_3;
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_5_5 = (MR_Word) &mercury__pretty_printer_scalar_common_1[3];
    MR_Word Cast_HeadVar1_3 = HeadVar__1_1;
    MR_Word Cast_HeadVar2_4 = HeadVar__2_2;
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word TypeInfo_177_177 = (MR_Word) &mercury__pretty_printer_scalar_common_1[3];
                    MR_Word ArgY1_45 = ((MR_Word) (MR_hl_field(MR_mktag(2), HeadVar__3_3, (MR_Integer) 0)));

                    mercury__builtin__compare_3_p_0(TypeInfo_177_177, HeadVar__1_1, ((MR_Box) (Var_179)), ((MR_Box) (ArgY1_45)));
                  }
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 0)))) {
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            MR_Word ArgY2_92 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2)));
                            MR_Word Var_93;
                            MR_Word TypeInfo_174_174 = (MR_Word) &mercury__pretty_printer_scalar_common_1[2];

                            mercury__builtin__compare_3_p_0(TypeInfo_174_174, &Var_93, ((MR_Box) (Var_181)), ((MR_Box) (ArgY1_90)));
                            ...
                            else
                            {
                              /* direct tailcall eliminated */
                              {
                                ...
                                MR_Word next_value_of_HeadVar__3_3 = ArgY2_92;
...
#undef MR_PROC_LABEL
	 V_7_191  = Res;
                            ...
                            {
                              MR_Word TypeInfo_173_173 = (MR_Word) &mercury__pretty_printer_scalar_common_1[2];

                              mercury__builtin__compare_3_p_0(TypeInfo_173_173, HeadVar__1_1, ((MR_Box) (Var_183)), ((MR_Box) (ArgY2_124)));
                            }
                          }
                          break;
                        case (MR_Integer) 3:
...
#undef MR_PROC_LABEL
    ...
    Var_4 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[19]);
    X_1 = (MR_Word) &mercury__pretty_printer_scalar_common_2[13];
{
#define MR_PROC_LABEL mercury__pretty_printer__initialise_mutable_io_pp_params_0_p_0
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ArgDescs_5)) == (MR_mktag((MR_Integer) 1)));
    MR_Word HeadVar__3_3;
...
#undef MR_PROC_LABEL
	 TypeInfo_21_21  = TypeInfo_for_T;
          ...
          {
            TypeInfo_24_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[18]);
    }
    return HeadVar__3_3;
  }
}
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_String X_6;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Box conv0_X_6;

    succeeded = mercury__univ__type_to_univ_2_p_2(TypeCtorInfo_8_8, &conv0_X_6, Univ_4);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      MR_Word V_8_16;
      MR_Word V_9_17;
      MR_Word V_10_18 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[13]);
      MR_Word V_12_19;

      {
        V_8_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_8_16, 0) = ((MR_Box) (X_6));
      }
      V_12_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      V_9_17 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[13]);
      {
        V_7_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_7_14, 0) = ((MR_Box) (V_8_16));
        MR_hl_field(MR_mktag(1), V_7_14, 1) = ((MR_Box) (V_9_17));
      }
      {
        V_4_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_4_12, 0) = ((MR_Box) (V_10_18));
        MR_hl_field(MR_mktag(1), V_4_12, 1) = ((MR_Box) (V_7_14));
      }
      {
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_Unsigned X_6;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_uint_0;
    MR_Box conv0_X_6;
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_Integer X_6;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
    MR_Box conv0_X_6;
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_Float X_6;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_float_0;
    MR_Box conv0_X_6;
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_Char X_6;
    MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
    MR_Box conv0_X_6;
...
{
  {
    ...
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv0_FMapTypeArity0_12;

    succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_23_23, TypeInfo_24_24, STATE_VARIABLE_FMap_0_16, ((MR_Box) (ModuleName_7)), &conv0_FMapTypeArity0_12);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      MR_Word TypeCtorInfo_25_25 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      MR_Word TypeInfo_26_26 = (MR_Word) &mercury__pretty_printer_scalar_common_2[1];
      MR_Box conv1_FMapArity0_13;

      succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_25_25, TypeInfo_26_26, FMapTypeArity0_12, ((MR_Box) (TypeName_8)), &conv1_FMapArity0_13);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        MR_Word TypeInfo_28_28 = (MR_Word) &mercury__pretty_printer_scalar_common_4[1];
        MR_Word TypeCtorInfo_29_29;
        MR_Word TypeInfo_30_30;
        MR_Word FMapArity_14;

        mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_p_0(TypeInfo_28_28, Arity_9, ((MR_Box) (Formatter_10)), FMapArity0_13, &FMapArity_14);
        TypeCtorInfo_29_29 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        TypeInfo_30_30 = (MR_Word) &mercury__pretty_printer_scalar_common_2[1];
        mercury__map__det_update_4_p_0(TypeCtorInfo_29_29, TypeInfo_30_30, ((MR_Box) (TypeName_8)), ((MR_Box) (FMapArity_14)), FMapTypeArity0_12, &FMapTypeArity_15);
      }
      else
      {
        ...
        MR_Word V_6_53 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        MR_Word V_7_54 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

        {
          FMapArity_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FMapArity_20, 0) = ((MR_Box) (Arity_9));
          MR_hl_field(MR_mktag(1), FMapArity_20, 1) = ((MR_Box) (Formatter_10));
          MR_hl_field(MR_mktag(1), FMapArity_20, 2) = ((MR_Box) (V_6_53));
          MR_hl_field(MR_mktag(1), FMapArity_20, 3) = ((MR_Box) (V_7_54));
        }
        TypeCtorInfo_33_33 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        TypeInfo_34_34 = (MR_Word) &mercury__pretty_printer_scalar_common_2[1];
        mercury__map__det_insert_4_p_0(TypeCtorInfo_33_33, TypeInfo_34_34, ((MR_Box) (TypeName_8)), ((MR_Box) (FMapArity_20)), FMapTypeArity0_12, &FMapTypeArity_15);
      }
      TypeCtorInfo_35_35 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      TypeInfo_36_36 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
      mercury__map__det_update_4_p_0(TypeCtorInfo_35_35, TypeInfo_36_36, ((MR_Box) (ModuleName_7)), ((MR_Box) (FMapTypeArity_15)), STATE_VARIABLE_FMap_0_16, STATE_VARIABLE_FMap_17);
    }
    else
    {
      ...
      MR_Word V_6_62 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word V_7_63 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word V_6_71;
      MR_Word V_7_72;

      {
        FMapArity_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), FMapArity_21, 0) = ((MR_Box) (Arity_9));
        MR_hl_field(MR_mktag(1), FMapArity_21, 1) = ((MR_Box) (Formatter_10));
        MR_hl_field(MR_mktag(1), FMapArity_21, 2) = ((MR_Box) (V_6_62));
        MR_hl_field(MR_mktag(1), FMapArity_21, 3) = ((MR_Box) (V_7_63));
      }
      TypeCtorInfo_39_39 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      V_6_71 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      V_7_72 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      {
        FMapTypeArity_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 0) = ((MR_Box) (TypeName_8));
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 1) = ((MR_Box) (FMapArity_21));
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 2) = ((MR_Box) (V_6_71));
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 3) = ((MR_Box) (V_7_72));
      }
      TypeInfo_41_41 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
      mercury__map__det_insert_4_p_0(TypeCtorInfo_39_39, TypeInfo_41_41, ((MR_Box) (ModuleName_7)), ((MR_Box) (FMapTypeArity_22)), STATE_VARIABLE_FMap_0_16, STATE_VARIABLE_FMap_17);
    }
  }
}
...
{
  {
    MR_Word TypeClassInfo_for_op_table_32 = (MR_Word) &mercury__pretty_printer_scalar_common_1[0];
    MR_Integer Pri_14;
    ...
    func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_op_table_32, (MR_Integer) 0)), (MR_Integer) 12)));
    conv1_Pri_14 = func_0(((MR_Box) TypeClassInfo_for_op_table_32), ((MR_Box) ((MR_Integer) 0)));
    ...
    Indents_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    ...
    mercury__pretty_printer__do_put_doc_17_p_0(TypeClassInfo_for_writer_31, Stream_8, Canonicalize_9, FMap_10, RemainingWidth_18, Var_28, RemainingWidth_18, &Var_20, Indents_19, &Var_21, MaxLines_16, &Var_22, Limit_17, &Var_23, Pri_14, &Var_24, STATE_VARIABLE_IO_0_25, STATE_VARIABLE_IO_26);
  }
}
      ...
      else
      {
        ...
        else
        {
          ...
          switch (MR_tag((MR_Word) Doc_44)) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    Var_109 = (HeadVar__4_4 - IndentWidth_54);
            ...
            case (MR_Integer) 1:
              {
                ...
                STATE_VARIABLE_RemainingWidth_114_114 = (STATE_VARIABLE_RemainingWidth_0_6 - Var_115);
                Docs_53 = Docs0_45;
                STATE_VARIABLE_Indents_101_101 = STATE_VARIABLE_Indents_0_8;
                STATE_VARIABLE_RemainingLines_111_111 = STATE_VARIABLE_RemainingLines_0_10;
                STATE_VARIABLE_Limit_105_105 = STATE_VARIABLE_Limit_0_12;
            ...
            case (MR_Integer) 2:
              {
                MR_Word TypeCtorInfo_128_128 = (MR_Word) &mercury__pretty_printer__pretty_printer__type_ctor_info_doc_0;
                MR_Word Docs1_55 = ((MR_Word) (MR_hl_field(MR_mktag(2), Doc_44, (MR_Integer) 0)));

                Docs_53 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_128_128, Docs1_55, Docs0_45);
                STATE_VARIABLE_RemainingWidth_114_114 = STATE_VARIABLE_RemainingWidth_0_6;
                STATE_VARIABLE_Indents_101_101 = STATE_VARIABLE_Indents_0_8;
                STATE_VARIABLE_RemainingLines_111_111 = STATE_VARIABLE_RemainingLines_0_10;
                STATE_VARIABLE_Limit_105_105 = STATE_VARIABLE_Limit_0_12;
              ...
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Doc_44, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    ...
                    {
                      Docs_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    switch (MR_tag((MR_Word) Var_129)) {
                      ...
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(Var_129)) {
                          ...
                          case (MR_Integer) 2:
                            {
                              if ((STATE_VARIABLE_Indents_0_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                              {
                                {
                              ...
                              {
                                MR_String _PoppedIndent_63;

                                STATE_VARIABLE_Indents_101_101 = ((MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_Indents_0_8, (MR_Integer) 0)));
                                _PoppedIndent_63 = ((MR_String) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_Indents_0_8, (MR_Integer) 1)));
                              }
                              Docs_53 = Docs0_45;
                              STATE_VARIABLE_RemainingWidth_114_114 = STATE_VARIABLE_RemainingWidth_0_6;
                              STATE_VARIABLE_RemainingLines_111_111 = STATE_VARIABLE_RemainingLines_0_10;
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          {
                            STATE_VARIABLE_Indents_101_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__5_5 = Docs_53;
            MR_Integer next_value_of_STATE_VARIABLE_RemainingWidth_0_6 = STATE_VARIABLE_RemainingWidth_114_114;
            MR_Word next_value_of_STATE_VARIABLE_Indents_0_8 = STATE_VARIABLE_Indents_101_101;
            MR_Integer next_value_of_STATE_VARIABLE_RemainingLines_0_10 = STATE_VARIABLE_RemainingLines_111_111;
            MR_Word next_value_of_STATE_VARIABLE_Limit_0_12 = STATE_VARIABLE_Limit_105_105;
            MR_Integer next_value_of_STATE_VARIABLE_Pri_0_14 = STATE_VARIABLE_Pri_91_91;
            MR_Box next_value_of_STATE_VARIABLE_IO_0_16 = STATE_VARIABLE_IO_113_113;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          if ((Doc_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
            succeeded = MR_TRUE;
          else
          if ((Doc_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            succeeded = MR_TRUE;
          else
            succeeded = MR_FALSE;
        }
        ...
        if (succeeded)
        {
          ...
          *STATE_VARIABLE_Limit_7 = STATE_VARIABLE_Limit_0_6;
          ...
          switch (MR_tag((MR_Word) Doc_26)) {
            ...
            case (MR_Integer) 1:
              {
                ...
                STATE_VARIABLE_RemainingWidth_111_111 = (STATE_VARIABLE_RemainingWidth_0_10 - Var_112);
            ...
            case (MR_Integer) 2:
              {
                MR_Word TypeCtorInfo_129_129 = (MR_Word) &mercury__pretty_printer__pretty_printer__type_ctor_info_doc_0;
                MR_Word Var_103;
                MR_Word Docs1_119 = ((MR_Word) (MR_hl_field(MR_mktag(2), Doc_26, (MR_Integer) 0)));

                Var_103 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_129_129, Docs1_119, Docs0_27);
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_HeadVar__3_3 = Var_103;
              ...
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Doc_26, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word next_value_of_HeadVar__3_3 = Var_99;
                      MR_Word next_value_of_STATE_VARIABLE_Limit_0_6 = STATE_VARIABLE_Limit_98_98;
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word next_value_of_HeadVar__3_3 = Var_94;
                      MR_Word next_value_of_STATE_VARIABLE_Limit_0_6 = STATE_VARIABLE_Limit_93_93;
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      ...
                      MR_Word next_value_of_STATE_VARIABLE_Limit_0_6 = STATE_VARIABLE_Limit_88_88;
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word next_value_of_HeadVar__3_3 = Var_84;
                          ...
                          case (MR_Integer) 0:
                            {
                              ...
                              if (succeeded)
                                ...
                                Var_70 = (MR_Integer) 0;
                              OpenGroups1_42 = (HeadVar__5_5 + Var_70);
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              if (succeeded)
                                ...
                                Var_64 = (MR_Integer) 0;
                              OpenGroups1_128 = (HeadVar__5_5 - Var_64);
...
{
  {
    ...
    if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_25)) == (MR_mktag((MR_Integer) 0))))
    {
    ...
    else
    {
      ...
      MR_Box Value_14 = (MR_hl_field(MR_mktag(0), Univ_10, (MR_Integer) 1));
      MR_Box Var_34;
      MR_String V_5_43;
      MR_Integer V_6_44;
      MR_String V_5_47;
...
#undef MR_PROC_LABEL
	 ...
	 V_6_48  = TypeCtorArity;
      ...
      TypeCtorInfo_32_32 = (MR_Word) &mercury__type_desc__type_desc__type_ctor_info_type_desc_0;
      mercury__list__length_acc_3_p_0(TypeCtorInfo_32_32, ArgTypeDescs_16, (MR_Integer) 0, &Arity_19);
      TypeCtorInfo_13_61 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      TypeInfo_14_62 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
      succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_13_61, TypeInfo_14_62, FMap_9, ((MR_Box) (ModuleName_17)), &conv0_FMapTypeArity_59);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_13_61, TypeInfo_15_63, FMapTypeArity_59, ((MR_Box) (TypeName_18)), &conv1_FMapArity_60);
        if (succeeded)
        {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_25)) == (MR_mktag((MR_Integer) 0))))
        {
          ...
          MR_Integer Var_77 = (N_76 - (MR_Integer) 1);
        ...
        else
        {
          ...
          MR_Integer Var_80 = (N_79 - (MR_Integer) 1);
        ...
        if (((MR_tag((MR_Word) *STATE_VARIABLE_Limit_26)) == (MR_mktag((MR_Integer) 0))))
          *Doc_11 = Doc0_21;
        else
        {
          MR_Word Var_88;
          ...
          {
            Var_91 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_90, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
            MR_hl_field(MR_mktag(3), Var_90, 1) = ((MR_Box) (Var_91));
          }
          Var_92 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
    ...
    TypeClassInfo_for_writer_16 = (MR_Word) &mercury__pretty_printer_scalar_common_4[0];
    mercury__pretty_printer__put_doc_7_p_1(TypeClassInfo_for_writer_16, ((MR_Box) (Stream_5)), (MR_Integer) 2, Formatters_8, Params_9, Doc_6, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_11);
  }
}
...
{
  {
    ...
    MR_Word STATE_VARIABLE_Formatters_4_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    ...
    mercury__pretty_printer__set_formatter__ho9_6_p_0((MR_String) "builtin", (MR_String) "character", (MR_Integer) 0, STATE_VARIABLE_Formatters_4_4, &STATE_VARIABLE_Formatters_9_9);
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[12];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;

    succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_23_23, TypeInfo_24_24, STATE_VARIABLE_FMap_0_16, ((MR_Box) (ModuleName_7)), &conv1_FMapTypeArity0_12);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__tree234__search_3_p_0(TypeCtorInfo_25_25, TypeInfo_26_26, FMapTypeArity0_12, ((MR_Box) (TypeName_8)), &conv2_FMapArity0_13);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[11];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[10];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[9];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[8];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[7];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[6];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[5];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
  ...
  MR_Word * STATE_VARIABLE_FMap_17)
{
  {
    MR_bool succeeded;
    MR_Word Formatter_10 = (MR_Word) &mercury__pretty_printer_scalar_common_2[4];
    MR_Word FMapTypeArity0_12;
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    MR_Word TypeInfo_24_24 = (MR_Word) &mercury__pretty_printer_scalar_common_2[2];
    MR_Box conv1_FMapTypeArity0_12;
...
{
  {
    ...
    mercury__pretty_printer__do_put_doc_17_p_1(TypeClassInfo_for_writer_31, Stream_8, Canonicalize_9, FMap_10, RemainingWidth_18, Var_28, RemainingWidth_18, &Var_20, Indents_19, &Var_21, MaxLines_16, &Var_22, Limit_17, &Var_23, Pri_14, &Var_24, STATE_VARIABLE_IO_0_25, STATE_VARIABLE_IO_26);
  }
}
...
{
  {
    ...
    *STATE_VARIABLE_RemainingLines_16 = (STATE_VARIABLE_RemainingLines_0_15 - (MR_Integer) 1);
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_9)) == (MR_mktag((MR_Integer) 0))))
    {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_9)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        MR_Integer Var_18 = (N_17 - (MR_Integer) 1);
      ...
      else
      {
        ...
        MR_Integer Var_21 = (N_20 - (MR_Integer) 1);
      ...
      if (((MR_tag((MR_Word) *STATE_VARIABLE_Limit_10)) == (MR_mktag((MR_Integer) 0))))
        *Doc_6 = Doc0_8;
      else
      {
        MR_Word Var_29;
        ...
        {
          Var_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_4)) == (MR_mktag((MR_Integer) 0))))
      {
      ...
      if ((Univs_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word Var_32;
        MR_Word Var_33;
        ...
        Var_46 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        Var_45 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[7]);
        {
        ...
        Var_50 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[8]);
        Var_52 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        Var_49 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[9]);
        {
      ...
      else
      {
        ...
        MR_Word Var_22;
        MR_Word Var_23;
        MR_Word Var_24 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        MR_Word Var_25;
        MR_Word Var_26;
        MR_Word Var_27;
        MR_Word Var_28;
        ...
        Var_55 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[7]);
        {
        ...
        Var_61 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
        Var_60 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[8]);
        Var_62 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        Var_59 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[9]);
        {
...
{
  {
    MR_bool succeeded = (Args_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    MR_Word Doc0_12;
    ...
    if (succeeded)
    {
      ...
      {
        Doc0_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Doc0_12, 0) = ((MR_Box) (Var_16));
      }
    }
    else
    {
      if (((MR_tag((MR_Word) STATE_VARIABLE_Limit_0_14)) == (MR_mktag((MR_Integer) 0))))
      {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            MR_Word Var_17;
            MR_Word Var_18 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[5]);
            MR_Word Var_20;
            MR_Word Var_21;
            MR_Word Var_22;
            MR_Word Var_23;
            MR_Word Var_24 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[6]);
            MR_Word Var_26;
            MR_Word Var_27;
            MR_Word Var_28;
            MR_Word Var_30;
            ...
            {
              Var_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            ...
            Var_26 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (Var_26));
            }
            Var_65 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[0]);
            Var_64 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[6]);
            {
            ...
            Var_70 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
            Var_69 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[4]);
            Var_71 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            Var_68 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[5]);
            {
            ...
            Var_28 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[7]);
            Var_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            Var_27 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[12]);
            {
              Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (Var_21));
              MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Var_27));
            }
            {
            ...
            {
              Doc0_12 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            Var_37 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[1]);
            Var_43 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[6]);
            {
            ...
            Var_81 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[0]);
            Var_80 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[6]);
            {
            ...
            Var_86 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
            Var_85 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[4]);
            Var_87 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            Var_84 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[5]);
            {
            ...
            Var_47 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[2]);
            Var_49 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            Var_46 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[10]);
            {
              Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (Var_40));
              MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (Var_46));
            }
            {
            ...
            Var_90 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[7]);
            {
            ...
            Var_96 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
            Var_95 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[8]);
            Var_97 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            Var_94 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[9]);
            {
  ...
  MR_Word * HeadVar__2_2)
{
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
  {
    ...
    MR_Integer Var_4 = (N_3 - (MR_Integer) 1);
  ...
  else
  {
    ...
    MR_Integer Var_7 = (N_6 - (MR_Integer) 1);
  ...
  MR_Word * Doc_3)
{
  ...
  else
  {
    ...
    {
      Var_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    Var_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((Var_110 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Integer OpPri_9;
        MR_Word Assoc_10;
        MR_Word TypeClassInfo_for_op_table_106;

        mercury__ops__init_mercury_op_table_0_f_0();
        TypeClassInfo_for_op_table_106 = (MR_Word) &mercury__pretty_printer_scalar_common_1[0];
        succeeded = mercury__ops__lookup_prefix_op_4_p_0(TypeClassInfo_for_op_table_106, ((MR_Box) ((MR_Integer) 0)), Op_1, &OpPri_9, &Assoc_10);
        if (succeeded)
        {
          MR_Word Doc_11;
          MR_Word Var_14;
          ...
          Var_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (Var_21));
        ...
        {
          MR_Word TypeClassInfo_for_op_table_107;
          MR_Word Var_24;
          MR_Word Var_25;
          MR_Word Var_26;
          MR_Integer Var_27;
          ...
          mercury__ops__init_mercury_op_table_0_f_0();
          TypeClassInfo_for_op_table_107 = (MR_Word) &mercury__pretty_printer_scalar_common_1[0];
          succeeded = mercury__ops__lookup_postfix_op_4_p_0(TypeClassInfo_for_op_table_107, ((MR_Box) ((MR_Integer) 0)), Op_1, &OpPri_33, &Assoc_34);
          if (succeeded)
          {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_56;
              MR_Word Var_57 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[3]);
              MR_Word Var_59;
              MR_Word Var_60;
              MR_Word Var_61;
              MR_Word Var_64;
              ...
              Var_61 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[11]);
              {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_70, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
          ...
          {
            MR_Word TypeClassInfo_for_op_table_109;
            MR_Word Var_78;
            MR_Word Var_79;
            MR_Word Var_80;
            MR_Word Var_81;
            ...
            mercury__ops__init_mercury_op_table_0_f_0();
            TypeClassInfo_for_op_table_109 = (MR_Word) &mercury__pretty_printer_scalar_common_1[0];
            succeeded = mercury__ops__lookup_binary_prefix_op_5_p_0(TypeClassInfo_for_op_table_109, ((MR_Box) ((MR_Integer) 0)), Op_1, &OpPri_102, &AssocA_103, &AssocB_104);
            if (succeeded)
            {
              Var_82 = (MR_String) " ";
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_84, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_95, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
...
{
  {
    ...
    switch (Assoc_5) {
      ...
      case (MR_Integer) 0:
        {
          AdjustedPriority_6 = (Priority_4 - (MR_Integer) 1);
        }
        break;
      case (MR_Integer) 1:
...
{
  {
    ...
    {
      MR_Word Var_8;
      MR_Word Var_9 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[1]);
      MR_Word Var_11;
      MR_Word Var_12 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[10]);
      MR_Word Var_13 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[2]);
      ...
      {
        HeadVar__4_4 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) Doc_30)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          String_36 = ((MR_String) (MR_hl_field(MR_mktag(1), Doc_30, (MR_Integer) 0)));
          {
            ...
            mercury__string__count_codepoints_2_p_0(String_36, &Var_45);
            STATE_VARIABLE_RemainingWidth_44_44 = (STATE_VARIABLE_RemainingWidth_0_7 - Var_45);
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__5_5 = Docs0_31;
              MR_Integer next_value_of_STATE_VARIABLE_RemainingWidth_0_7 = STATE_VARIABLE_RemainingWidth_44_44;
              MR_Box next_value_of_STATE_VARIABLE_IO_0_11 = STATE_VARIABLE_IO_43_43;
        ...
        {
          succeeded = (Doc_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          if (succeeded)
          {
            ...
            MR_Box STATE_VARIABLE_IO_20_85;
            ...
            func_1(((MR_Box) TypeClassInfo_for_writer_71), HeadVar__1_1, ((MR_Box) ((MR_String) "\n")), STATE_VARIABLE_IO_0_11, &STATE_VARIABLE_IO_20_85);
            mercury__pretty_printer__output_indentation_6_p_0(TypeClassInfo_for_writer_71, HeadVar__1_1, HeadVar__3_3, HeadVar__2_2, &STATE_VARIABLE_RemainingWidth_49_49, STATE_VARIABLE_IO_20_85, &STATE_VARIABLE_IO_51_51);
            STATE_VARIABLE_RemainingLines_50_50 = (STATE_VARIABLE_RemainingLines_0_9 - (MR_Integer) 1);
          ...
          else
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Doc_30)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Doc_30, (MR_Integer) 0)))) == (MR_Integer) 4)));
            if (succeeded)
            {
            ...
            if (succeeded)
            {
              MR_Integer Var_57 = (HeadVar__4_4 + (MR_Integer) 1);
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = (Var_62 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              }
              if (succeeded)
              {
                ...
                {
                  MR_Integer Var_63 = (HeadVar__4_4 - (MR_Integer) 1);
  ...
  MR_Box * STATE_VARIABLE_IO_6)
{
  ...
  else
  {
    ...
    mercury__string__count_codepoints_2_p_0(Indent_16, &Var_27);
    *STATE_VARIABLE_RemainingWidth_4 = (STATE_VARIABLE_RemainingWidth_23_23 - Var_27);
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__string__count_codepoints_2_p_0(Indent_4, &Var_6);
      HeadVar__2_2 = (Var_5 + Var_6);
    }
    return HeadVar__2_2;
  }
}
  ...
  MR_Word Doc_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word TypeClassInfo_for_op_table_11 = (MR_Word) &mercury__pretty_printer_scalar_common_1[0];
    MR_Word Var_4;
    MR_Word Var_5;
    MR_Word Var_6;
    MR_Integer Var_7;
    ...
    func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_op_table_11, (MR_Integer) 0)), (MR_Integer) 13)));
    conv1_Var_7 = func_0(((MR_Box) TypeClassInfo_for_op_table_11), ((MR_Box) ((MR_Integer) 0)));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_5, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
...
{
  {
    MR_Word HeadVar__2_2;
    MR_Word Var_4;
    MR_Word Var_5 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[7]);
    ...
    Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
    Var_10 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[8]);
    Var_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_9 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[9]);
    {
...
{
  {
    MR_Word HeadVar__2_2;
    MR_Word Var_7;
    MR_Word Var_8 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[6]);
    MR_Word Var_9 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[0]);
    MR_Word Var_10;
    MR_Word Var_11;
    MR_Word Var_12;
    MR_Word Var_13;
    ...
    Var_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
    Var_13 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[4]);
    Var_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_12 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[5]);
    {
      Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      Var_10 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Var_10, 0) = ((MR_Box) (Docs_5));
    }
    Var_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
    Var_12 = (MR_Word) MR_mkword(MR_mktag(3), &mercury__pretty_printer_scalar_common_1[4]);
    Var_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[5]);
    {
      Var_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
