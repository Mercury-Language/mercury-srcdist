...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ArgDescs_5)) == (MR_Integer) 1);
    MR_Word HeadVar__3_3;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Doc_30)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Doc_30, (MR_Integer) 0))) == (MR_Integer) 4)));
          if (succeeded)
          {
