                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          mercury__builtin__compare_3_p_0((MR_Word) &mercury__pretty_printer_scalar_common_1[2], &Var_93, ((MR_Box) (Var_181)), ((MR_Box) (ArgY1_90)));
...
#undef MR_PROC_LABEL
	 V_7_191  = Res;
                          ...
                          {
                            mercury__builtin__compare_3_p_0((MR_Word) &mercury__pretty_printer_scalar_common_1[2], HeadVar__1_1, ((MR_Box) (Var_183)), ((MR_Box) (ArgY2_124)));
                          }
                        }
                        break;
                      case (MR_Integer) 3:
...
{
  {
    ...
    if (succeeded)
    {
      ...
      V_12_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      {
        ...
        MR_hl_field(MR_mktag(1), V_7_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_1[13])));
      }
      {
        V_4_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_4_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__pretty_printer_scalar_common_5[13])));
