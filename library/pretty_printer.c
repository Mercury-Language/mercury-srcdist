...
mercury__pretty_printer__initial_formatter_map_0_f_0(void)
{
  ...
  mercury__pretty_printer__set_formatter__ho29_6_p_0((MR_String) "builtin", (MR_String) "int32", (MR_Integer) 0, STATE_VARIABLE_Formatters_11_54, &STATE_VARIABLE_Formatters_12_59);
