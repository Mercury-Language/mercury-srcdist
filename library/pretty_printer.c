  ...
  MR_Word * Docs_8)
{
  ...
  if (succeeded)
  {
    ...
    if ((Var_140 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        succeeded = mercury__ops__op_infos_prefix_op_4_p_0(OpInfo_10, OtherOpInfos_11, &Pri_12, &GtOrGeA_13);
        if (succeeded)
        {
          MR_Word PriorityArgA_15;
          MR_Word Var_23;
          MR_Word Var_24;
          MR_Word Var_25;
          MR_Word Var_26;
          ...
          switch (GtOrGeA_13) {
            ...
            case (MR_Integer) 1:
              ...
              break;
            case (MR_Integer) 0:
              PriorityArgA_15 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
              break;
          }
          {
        ...
        else
        {
          ...
          MR_Word Var_42;
          MR_Word Var_43;
          MR_Word PriorityArgA_121;
          MR_Word GtOrGeA_123;

          succeeded = mercury__ops__op_infos_postfix_op_4_p_0(OpInfo_10, OtherOpInfos_11, &OpPriority_14, &GtOrGeA_123);
          if (succeeded)
          {
            switch (GtOrGeA_123) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 0:
                PriorityArgA_121 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
                break;
            }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = mercury__ops__op_infos_infix_op_5_p_0(OpInfo_137, OtherOpInfos_138, &Pri_133, &GtOrGeA_134, &GtOrGeB_18);
          if (succeeded)
          {
            MR_Word PriorityArgB_19;
            MR_Word Var_51;
            MR_Word Var_52;
            MR_Word Var_53;
            MR_Word Var_54;
            ...
            switch (GtOrGeA_134) {
              ...
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 0:
                PriorityArgA_125 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
                break;
            }
            switch (GtOrGeB_18) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 0:
                PriorityArgB_19 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
                break;
            }
            {
          ...
          else
          {
            ...
            MR_Word Var_106;
            MR_Word Var_107;
            MR_Word PriorityArgA_126;
            MR_Word PriorityArgB_127;
            MR_Word GtOrGeA_129;
            MR_Word GtOrGeB_131;

            succeeded = mercury__ops__op_infos_binary_prefix_op_5_p_0(OpInfo_137, OtherOpInfos_138, &OpPriority_14, &GtOrGeA_129, &GtOrGeB_131);
            if (succeeded)
            {
              switch (GtOrGeA_129) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 0:
                  PriorityArgA_126 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
                  break;
              }
              switch (GtOrGeB_131) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 0:
                  PriorityArgB_127 = mercury__ops__increment_priority_1_f_0(OpPriority_14);
                  break;
              }
    ...
    if (succeeded)
    {
      succeeded = mercury__ops__priority_lt_2_p_0(OpPriority_14, EnclosingPriority_7);
      if (succeeded)
      {
        MR_Word Var_114;
