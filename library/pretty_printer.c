...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_11 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
{
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), FMapArity_20, 2) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(1), FMapArity_20, 3) = ((MR_Box) ((MR_Integer) 0));
        }
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), FMapArity_21, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), FMapArity_21, 3) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), FMapTypeArity_22, 3) = ((MR_Box) ((MR_Integer) 0));
      }
...
{
  {
    ...
    Limit_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Params_11, (MR_Integer) 2))));
    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__pretty_printer__do_put_doc_17_p_0(TypeClassInfo_for_writer_31, Stream_8, Canonicalize_9, FMap_10, RemainingWidth_18, Var_28, RemainingWidth_18, &Var_20, (MR_Word) ((MR_Integer) 0), &Var_21, MaxLines_16, &Var_22, Limit_17, &Var_23, Pri_14, &Var_24, STATE_VARIABLE_IO_0_25, STATE_VARIABLE_IO_26);
  }
}
                  ...
                  switch (MR_tag((MR_Word) Var_129)) {
                    ...
                    case (MR_Integer) 0:
                      switch (MR_unmkbody(Var_129)) {
                        ...
                        case (MR_Integer) 2:
                          {
                            if ((STATE_VARIABLE_Indents_0_8 == (MR_Word) ((MR_Integer) 0)))
                            {
                              {
  ...
  MR_Integer * STATE_VARIABLE_RemainingWidth_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        if ((Doc_26 == (MR_Word) ((MR_Integer) 4)))
          succeeded = MR_TRUE;
        else
        if ((Doc_26 == (MR_Word) ((MR_Integer) 0)))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
      }
...
{
  {
    ...
    mercury__pretty_printer__set_formatter__ho9_6_p_0((MR_String) "builtin", (MR_String) "character", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_Formatters_9_9);
...
{
  {
    ...
    mercury__pretty_printer__do_put_doc_17_p_1(TypeClassInfo_for_writer_31, Stream_8, Canonicalize_9, FMap_10, RemainingWidth_18, Var_28, RemainingWidth_18, &Var_20, (MR_Word) ((MR_Integer) 0), &Var_21, MaxLines_16, &Var_22, Limit_17, &Var_23, Pri_14, &Var_24, STATE_VARIABLE_IO_0_25, STATE_VARIABLE_IO_26);
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_30, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
...
{
  {
    ...
    else
    {
      ...
      if ((Univs_12 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_32;
        MR_Word Var_33;
        MR_Word Var_35;
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    MR_bool succeeded = (Args_8 == (MR_Word) ((MR_Integer) 0));
    MR_Word Doc0_12;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) ((MR_Integer) 0));
            }
            {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * Doc_3)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((Var_110 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Integer OpPri_9;
        MR_Word Assoc_10;
        ...
        if (succeeded)
        {
          ...
          }
          {
            Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (Var_21));
            MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
      ...
      else
      {
        ...
        succeeded = (Var_46 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
          mercury__ops__init_mercury_op_table_0_f_0();
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Box * STATE_VARIABLE_IO_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        succeeded = (Doc_30 == (MR_Word) ((MR_Integer) 4));
        if (succeeded)
        {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (Var_56 == (MR_Word) ((MR_Integer) 0));
          }
          if (succeeded)
          {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_62 == (MR_Word) ((MR_Integer) 4));
            }
            if (succeeded)
            {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_9, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
