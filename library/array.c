...
MR_decl_label1(__Unify___array__array_1_0, 1)
MR_decl_label2(__Compare___array__index_out_of_bounds_0_0, 2,3)
...
MR_BEGIN_MODULE(array_module75)
	...
	MR_init_label1(__Unify___array__array_1_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(array_module78)
	...
	MR_init_label2(__Compare___array__index_out_of_bounds_0_0,2,3)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___array__index_out_of_bounds_0_0_i2);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___array__index_out_of_bounds_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___array__index_out_of_bounds_0_0_i3);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___array__index_out_of_bounds_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
