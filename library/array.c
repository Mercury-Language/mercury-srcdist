...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    mercury__univ__type_to_univ_2_p_1(TypeInfo_for_T_28, Var_36, &Var_62);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_35, 1) = ((MR_Box) (Var_62));
    }
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      Var_38 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__array_scalar_common_4[3]));
    else
      Var_38 = (MR_Word) (MR_mkword(MR_mktag(2), &mercury__array_scalar_common_4[6]));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (mercury__array__IntroducedFrom__func__array_to_doc_2__3425__1_3_f_0_1));
