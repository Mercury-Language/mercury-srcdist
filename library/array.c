...
#undef MR_PROC_LABEL
	 mercury__array__Var_54  = Max;
        ...
        if (mercury__array__succeeded)
          {
            mercury__array__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__array_scalar_common_5[2]);
          }
        else
          {
            ...
            mercury__array__Var_39 = (MR_Word) MR_mkword(MR_mktag(2), &mercury__array_scalar_common_5[4]);
          }
        {
...
{
  {
    ...
    if (mercury__array__succeeded)
      *mercury__array__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mercury__array__Var_4 = (MR_String) mercury__array__HeadVar__2_2;
        MR_String mercury__array__Var_5 = (MR_String) mercury__array__HeadVar__3_3;
...
#define MR_PROC_LABEL mercury__array____Compare____index_out_of_bounds_0_0
	...
	S1 =  mercury__array__Var_4 ;
	S2 =  mercury__array__Var_5 ;
		{
...
{
  {
    ...
    if (mercury__array__succeeded)
      ...
      {
        MR_String mercury__array__Var_3 = (MR_String) mercury__array__HeadVar__1_1;
        MR_String mercury__array__Var_4 = (MR_String) mercury__array__HeadVar__2_2;

        mercury__array__succeeded = (strcmp(mercury__array__Var_3, mercury__array__Var_4) == 0);
      }
    return mercury__array__succeeded;
  }
}
...
#undef MR_PROC_LABEL
    ...
    mercury__array__Var_30 = (MR_Word) &mercury__array_scalar_common_5[7];
...
{
  {
    ...
    MR_Word mercury__array__Var_5 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__array_scalar_common_5[1]);
...
#undef MR_PROC_LABEL
    ...
    if (mercury__array__succeeded)
      {
        mercury__array__Var_8 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__array_scalar_common_5[2]);
      }
    else
      {
...
#undef MR_PROC_LABEL
	 mercury__array__Var_39  = Max;
        ...
        if (mercury__array__succeeded)
          {
            mercury__array__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__array_scalar_common_5[2]);
          }
        else
          {
            ...
            mercury__array__Var_24 = (MR_Word) MR_mkword(MR_mktag(2), &mercury__array_scalar_common_5[4]);
          }
        {
    ...
    mercury__array__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__array_scalar_common_5[5]);
