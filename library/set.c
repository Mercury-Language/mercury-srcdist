  ...
  MR_Box * STATE_VARIABLE_A_16)
{
  ...
  {
    Var_23 = (MR_Integer) 0;
    mercury__list__length_acc_3_p_0(TypeInfo_for_T_18, TL_13, Var_23, &Var_22);
    mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_T_18, Var_22, TL_13, &Var_21);
    Var_26 = (MR_Integer) 0;
    *T_9 = (MR_Word) (Var_21);
    mercury__list__length_acc_3_p_0(TypeInfo_for_U_19, UL_14, Var_26, &Var_25);
    mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_U_19, Var_25, UL_14, &Var_24);
    *U_10 = (MR_Word) (Var_24);
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Box * STATE_VARIABLE_A_16)
{
  ...
  mercury__list__length_acc_3_p_0(TypeInfo_for_T_18, TL_13, (MR_Integer) 0, &Var_22);
  mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_T_18, Var_22, TL_13, &Var_21);
  *T_9 = (MR_Word) (Var_21);
  mercury__list__length_acc_3_p_0(TypeInfo_for_U_19, UL_14, (MR_Integer) 0, &Var_25);
  mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_U_19, Var_25, UL_14, &Var_24);
  *U_10 = (MR_Word) (Var_24);
}
  ...
  MR_Box * STATE_VARIABLE_A_13)
{
  ...
  {
    Var_19 = (MR_Integer) 0;
    mercury__list__length_acc_3_p_0(TypeInfo_for_T_15, TL_11, Var_19, &Var_18);
  ...
  MR_Box * STATE_VARIABLE_A_13)
{
  ...
  mercury__list__length_acc_3_p_0(TypeInfo_for_T_15, TL_11, (MR_Integer) 0, &Var_18);
  mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_T_15, Var_18, TL_11, &Var_17);
  *T_8 = (MR_Word) (Var_17);
}
  ...
  MR_Word * STATE_VARIABLE_Set_7)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      STATE_VARIABLE_Set_8_8 = (MR_Word) (Var_22);
      succeeded = MR_TRUE;
    }
  }
  if (succeeded)
