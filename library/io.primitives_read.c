...
static /* final */ const MR_Box mercury__io__primitives_read_scalar_common_3[2][5];
  ...
  MR_Box * Error_10)
{
  ...
  mercury__io__primitives_read__read_char_code_2_6_p_0(Stream_7, ResultCode_8, Char_9, Error_10);
}
