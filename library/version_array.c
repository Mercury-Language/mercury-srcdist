...
#undef MR_PROC_LABEL
    ...
    Var_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      ...
      MR_hl_field(MR_mktag(1), Var_7, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__version_array_scalar_common_4[7])));
    }
    {
      Var_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_4, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__version_array_scalar_common_5[2])));
    ...
    V_14_72 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      ...
      MR_hl_field(MR_mktag(1), V_9_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__version_array_scalar_common_4[10])));
    }
    {
      V_6_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), V_6_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &mercury__version_array_scalar_common_4[8])));
...
{
  {
    ...
    mercury__string__format__format_signed_int_component_5_p_0((MR_Word) &mercury__version_array_scalar_common_5[1], V_7_42, V_8_43, Max_5, &Var_19);
    ...
    mercury__string__format__format_signed_int_component_5_p_0((MR_Word) &mercury__version_array_scalar_common_5[1], V_7_59, V_8_60, Index_4, &Var_29);
