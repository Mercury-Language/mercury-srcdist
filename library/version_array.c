...
{
  {
    ...
    conv0_LambdaHeadVar__1_24 = mercury__version_array__IntroducedFrom__func__version_array_to_doc_2__2072__1_3_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Box) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))));
...
{
  {
    ...
    MR_Integer Var_25 = (I_4 + (MR_Integer) 1);
    MR_Integer Var_32;
    MR_Integer Var_56;
...
#undef MR_PROC_LABEL
	 Var_63  = N;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (mercury__version_array__IntroducedFrom__func__version_array_to_doc_2__2072__1_3_f_0_1));
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        switch (R0_11) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer Var_14 = (I_6 + (MR_Integer) 1);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_I_4 = Var_9;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_I_6 = Var_10;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_I_10 = Var_21;
            MR_Box next_value_of_STATE_VARIABLE_Acc1_0_13 = STATE_VARIABLE_Acc1_19_19;
            MR_Box next_value_of_STATE_VARIABLE_Acc2_0_15 = STATE_VARIABLE_Acc2_20_20;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_I_8 = Var_15;
            MR_Box next_value_of_STATE_VARIABLE_Acc_0_10 = STATE_VARIABLE_Acc_14_14;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_13 = (Hi_9 - (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Acc_8 = Var_11;
          MR_Integer next_value_of_Hi_9 = Var_13;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_Lo_11 = Var_22;
            MR_Box next_value_of_STATE_VARIABLE_Acc1_0_15 = STATE_VARIABLE_Acc1_20_20;
            MR_Box next_value_of_STATE_VARIABLE_Acc2_0_17 = STATE_VARIABLE_Acc2_21_21;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_Lo_9 = Var_16;
            MR_Box next_value_of_STATE_VARIABLE_Acc_0_12 = STATE_VARIABLE_Acc_15_15;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_14 = (Lo_10 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Acc_9 = Var_12;
          MR_Integer next_value_of_Lo_10 = Var_14;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Acc_8 = Var_11;
          MR_Integer next_value_of_Hi_9 = Var_13;
  ...
  MR_Box * STATE_VARIABLE_VA_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_16 = (I_1 - (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_I_1 = Var_16;
        MR_Word next_value_of_HeadVar__2_2 = Xs_11;
        MR_Box next_value_of_STATE_VARIABLE_VA_0_3 = STATE_VARIABLE_VA_15_15;
