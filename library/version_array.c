...
MR_decl_label4(version_array__cmp_version_array_3_0, 2,3,5,26)
...
MR_decl_label4(fn__version_array__version_array_2_3_0, 24,3,5,27)
...
MR_BEGIN_MODULE(version_array_module5)
	...
	MR_init_label4(fn__version_array__version_array_2_3_0,24,3,5,27)
MR_BEGIN_CODE
...
MR_def_label(fn__version_array__version_array_2_3_0,5)
	...
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_array__version_array_2_3_0_i27);
MR_def_label(fn__version_array__version_array_2_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(fn__version_array__version_array_2_3_0_i24);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(version_array_module28)
	...
	MR_init_label4(version_array__cmp_version_array_3_0,2,3,5,26)
MR_BEGIN_CODE
...
MR_def_label(version_array__cmp_version_array_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(version_array__cmp_version_array_3_0_i26);
	}
	MR_r1 = MR_r5;
	MR_r5 = MR_r3;
	MR_r3 = MR_r4;
...
MR_def_label(version_array__cmp_version_array_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
