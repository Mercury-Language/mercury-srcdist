...
{
  {
    ...
    (env).mercury__version_array2d__version_array2d_2_f_0_env_0__HeadVar__1_1 = HeadVar__1_1;
    {
      ...
      else
      {
        ...
        mercury__list__reverse_2_p_0((env).mercury__version_array2d__version_array2d_2_f_0_env_0__TypeInfo_10_40, (MR_Word) ((env).mercury__version_array2d__version_array2d_2_f_0_env_0__HeadVar__1_1), &conv0_V_5_36);
        V_5_36 = (MR_Word) (conv0_V_5_36);
        mercury__list__condense_acc_3_p_0((env).mercury__version_array2d__version_array2d_2_f_0_env_0__TypeInfo_for_T_18, V_5_36, (MR_Word) ((MR_Unsigned) 0U), &Var_15);
