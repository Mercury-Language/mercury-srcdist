...
{
  {
    ...
    HeadVar__2_2 = mercury__version_array2d__lists_2_6_f_0(TypeInfo_for_T_13, Var_6, Var_9, N_4, VA_5, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0));
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    (env).mercury__version_array2d__version_array2d_2_f_0_env_0__HeadVar__1_1 = HeadVar__1_1;
    {
      ...
      if (((env).mercury__version_array2d__version_array2d_2_f_0_env_0__HeadVar__1_1 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Box Var_5;

        Var_5 = mercury__version_array__version_array_1_f_0((env).mercury__version_array2d__version_array2d_2_f_0_env_0__TypeInfo_for_T_19, (MR_Word) ((MR_Integer) 0));
        {
      ...
      else
      {
        ...
        mercury__list__condense_acc_3_p_0((env).mercury__version_array2d__version_array2d_2_f_0_env_0__TypeInfo_for_T_19, V_5_37, (MR_Word) ((MR_Integer) 0), &Var_15);
