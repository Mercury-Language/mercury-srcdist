...
{
  MR_String Msg_9;
  MR_Integer Var_19 = (MR_Integer) ((MR_Unsigned) NumRowsOrColumns_8 - (MR_Unsigned) 1);
  MR_Word Var_22;
  MR_String Var_25;
  MR_String Var_32;
  MR_String Var_34;
  ...
  mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__version_array2d_scalar_common_5[0]), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Var_19, &Var_25);
  mercury__string__append_3_p_2(Var_25, (MR_String) "]", &Var_32);
  mercury__string__append_3_p_2((MR_String) " not in range [0, ", Var_32, &Var_34);
  mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__version_array2d_scalar_common_5[0]), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Index_7, &Var_35);
  mercury__string__append_3_p_2(Var_35, Var_34, &Var_42);
  mercury__string__append_3_p_2((MR_String) " index ", Var_42, &Var_44);
  mercury__string__append_3_p_2(RowOrColumn_6, Var_44, &Var_45);
  mercury__string__append_3_p_2((MR_String) ": ", Var_45, &Var_47);
  mercury__string__append_3_p_2(PredName_5, Var_47, &Msg_9);
  Var_22 = (MR_Word) (Msg_9);
  {
    mercury__exception__throw_1_p_0((MR_Word) (&mercury__version_array__version_array__type_ctor_info_index_out_of_bounds_0), ((MR_Box) (Var_22)));
    return;
  }
}
