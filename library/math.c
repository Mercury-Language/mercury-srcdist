    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 2:
        switch (MR_tag((MR_Word) HeadVar__3_3)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Float ArgX1_6 = MR_unbox_float((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0)));
              MR_Float ArgY1_7 = MR_unbox_float((MR_hl_field(2, HeadVar__3_3, (MR_Integer) 0)));
              MR_Float ArgX2_9 = MR_unbox_float((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 1)));
              MR_Float ArgY2_10 = MR_unbox_float((MR_hl_field(2, HeadVar__3_3, (MR_Integer) 1)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (succeeded)
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Float ArgX1_3 = MR_unbox_float((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0)));
          MR_Float ArgY1_4;

          succeeded = ((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1);
          if (succeeded)
          {
            ArgY1_4 = MR_unbox_float((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Float ArgY1_6;
          MR_Float ArgX2_7 = MR_unbox_float((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 1)));
          MR_Float ArgY2_8;
          ...
          if (succeeded)
          {
            ...
            ArgY2_8 = MR_unbox_float((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 1)));
