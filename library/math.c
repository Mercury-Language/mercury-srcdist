...
MR_define_entry(mercury__fn__math__solve_quadratic_3_0);
	...
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_r2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tempr2);
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Integer) 1;
...
MR_def_label(fn__math__solve_quadratic_3_0,2)
	...
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_r1);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_r2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_r3);
	MR_r1 = MR_r4;
	MR_r2 = (MR_Integer) 2;
	MR_GOTO_LAB(fn__math__solve_quadratic_3_0_i5);
...
MR_def_label(fn__math__solve_quadratic_3_0,7)
	...
	MR_r3 = MR_float_to_word(((MR_Float) -0.50000000000000000 * MR_float_from_dword_ptr(&MR_sv(6))));
	{
...
MR_def_label(fn__math__solve_quadratic_3_0,10)
	...
	MR_tfield(1, MR_r1, 0) = MR_float_to_word((MR_word_to_float(MR_r3) / MR_float_from_dword_ptr(&MR_sv(4))));
	MR_decr_sp_and_return(7);
...
MR_def_label(fn__math__solve_quadratic_3_0,21)
	...
	MR_r3 = MR_float_to_word(((MR_Float) -0.50000000000000000 * (MR_float_from_dword_ptr(&MR_sv(6)) - MR_word_to_float(MR_r1))));
	{
#define	MR_PROC_LABEL	mercury__fn__math__solve_quadratic_3_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
...
MR_def_label(fn__math__solve_quadratic_3_0,25)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tempr1);
	* (MR_Float *) &MR_sv(4) = (MR_word_to_float(MR_tempr1) / MR_float_from_dword_ptr(&MR_sv(4)));
	}
...
MR_def_label(fn__math__solve_quadratic_3_0,23)
	...
	* (MR_Float *) &MR_sv(6) = ((MR_Float) -0.50000000000000000 * MR_word_to_float(MR_r1));
	{
#define	MR_PROC_LABEL	mercury__fn__math__solve_quadratic_3_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
...
MR_def_label(fn__math__solve_quadratic_3_0,41)
	...
	MR_tfield(2, MR_r1, 0) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(6)) / MR_float_from_dword_ptr(&MR_sv(4))));
...
MR_def_label(fn__math__solve_quadratic_3_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 2);
	MR_tfield(2, MR_r1, 0) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	MR_tfield(2, MR_r1, 1) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) / MR_float_from_dword_ptr(&MR_sv(6))));
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(__Compare___math__quadratic_roots_0_0,19)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(2, MR_tempr1, 1));
	MR_tempr2 = MR_sv(4);
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(2, MR_tempr2, 1));
