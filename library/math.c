        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) mercury__math__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Float mercury__math__Var_9 = MR_unbox_float((MR_hl_field(MR_mktag(1), mercury__math__HeadVar__3_3, (MR_Integer) 0)));

                  mercury__math__succeeded = (mercury__math__Var_28 < mercury__math__Var_9);
                  if (mercury__math__succeeded)
                    *mercury__math__HeadVar__1_1 = (MR_Integer) 1;
                  else
                    {
        ...
        case (MR_Integer) 2:
          {
            ...
            switch (MR_tag((MR_Word) mercury__math__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Float mercury__math__Var_20 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Float mercury__math__Var_21 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__3_3, (MR_Integer) 1)));
                  MR_Word mercury__math__Var_22;

                  mercury__math__succeeded = (mercury__math__Var_30 < mercury__math__Var_20);
                  if (mercury__math__succeeded)
                  ...
                  if (mercury__math__succeeded)
                    *mercury__math__HeadVar__1_1 = mercury__math__Var_22;
                    ...
                    {
                      mercury__math__succeeded = (mercury__math__Var_29 < mercury__math__Var_21);
                      if (mercury__math__succeeded)
                        *mercury__math__HeadVar__1_1 = (MR_Integer) 1;
                      else
                        {
...
{
  {
    ...
    if (mercury__math__succeeded)
      ...
      switch (MR_tag((MR_Word) mercury__math__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Float mercury__math__Var_5 = MR_unbox_float((MR_hl_field(MR_mktag(1), mercury__math__HeadVar__1_1, (MR_Integer) 0)));
            MR_Float mercury__math__Var_6;

            mercury__math__succeeded = ((MR_tag((MR_Word) mercury__math__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mercury__math__succeeded)
              {
                mercury__math__Var_6 = MR_unbox_float((MR_hl_field(MR_mktag(1), mercury__math__HeadVar__2_2, (MR_Integer) 0)));
                mercury__math__succeeded = (mercury__math__Var_5 == mercury__math__Var_6);
              }
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Float mercury__math__Var_7 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__1_1, (MR_Integer) 0)));
            MR_Float mercury__math__Var_8 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__1_1, (MR_Integer) 1)));
            MR_Float mercury__math__Var_9;
            MR_Float mercury__math__Var_10;

            mercury__math__succeeded = ((MR_tag((MR_Word) mercury__math__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (mercury__math__succeeded)
              {
                mercury__math__Var_9 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__2_2, (MR_Integer) 0)));
                mercury__math__Var_10 = MR_unbox_float((MR_hl_field(MR_mktag(2), mercury__math__HeadVar__2_2, (MR_Integer) 1)));
                mercury__math__succeeded = (mercury__math__Var_7 == mercury__math__Var_9);
                if (mercury__math__succeeded)
                  mercury__math__succeeded = (mercury__math__Var_8 == mercury__math__Var_10);
              }
          }
          break;
      }
...
{
  {
    ...
    if (mercury__math__succeeded)
      *mercury__math__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mercury__math__Var_4 = (MR_String) mercury__math__HeadVar__2_2;
        MR_String mercury__math__Var_5 = (MR_String) mercury__math__HeadVar__3_3;
...
#define MR_PROC_LABEL mercury__math____Compare____domain_error_0_0
	...
	S1 =  mercury__math__Var_4 ;
	S2 =  mercury__math__Var_5 ;
		{
...
{
  {
    ...
    if (mercury__math__succeeded)
      ...
      {
        MR_String mercury__math__Var_3 = (MR_String) mercury__math__HeadVar__1_1;
        MR_String mercury__math__Var_4 = (MR_String) mercury__math__HeadVar__2_2;

        mercury__math__succeeded = (strcmp(mercury__math__Var_3, mercury__math__Var_4) == 0);
      }
    return mercury__math__succeeded;
  }
}
