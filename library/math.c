...
MR_decl_label10(__Compare___math__quadratic_roots_0_0, 50,12,15,16,23,27,30,31,33,60)
MR_decl_label3(__Compare___math__quadratic_roots_0_0, 36,61,45)
...
MR_def_label(fn__math__solve_quadratic_3_0,41)
	...
	MR_tfield(2, MR_tempr1, 1) = MR_float_to_word(((MR_Float) 0.0000000000000000 - MR_word_to_float(MR_tfield(2, MR_tempr1, 0))));
	MR_decr_sp_and_return(4);
	}
...
MR_BEGIN_MODULE(math_module36)
	...
	MR_init_label10(__Compare___math__quadratic_roots_0_0,50,12,15,16,23,27,30,31,33,60)
	MR_init_label3(__Compare___math__quadratic_roots_0_0,36,61,45)
MR_BEGIN_CODE
