...
{
  {
    ...
    if (succeeded)
      ...
      *Y_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  }
}
  ...
  MR_Box X_7)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Var_8 = (N_6 - (MR_Integer) 1);
      MR_Box Var_10;
      ...
      {
        MR_Integer next_value_of_N_6 = Var_8;
        MR_Box next_value_of_X_7 = Var_10;
