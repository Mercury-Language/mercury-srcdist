  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if (mercury__std_util__succeeded)
          ...
          {
            MR_Integer mercury__std_util__Var_8 = (mercury__std_util__N_6 - (MR_Integer) 1);
            MR_Box mercury__std_util__Var_10;
            ...
            {
              mercury__std_util__Var_10 = mercury__std_util__func_0(((MR_Box) mercury__std_util__F_5), mercury__std_util__X_7);
            }
            /* direct tailcall eliminated */
            {
              MR_Integer mercury__std_util__next_value_of_N_6 = mercury__std_util__Var_8;
              MR_Box mercury__std_util__next_value_of_X_7 = mercury__std_util__Var_10;

              mercury__std_util__X_7 = mercury__std_util__next_value_of_X_7;
              mercury__std_util__N_6 = mercury__std_util__next_value_of_N_6;
            }
            continue;
          }
...
{
  {
    ...
    {
      mercury__std_util__HeadVar__4_4 = mercury__std_util__func_0(((MR_Box) mercury__std_util__F_5), mercury__std_util__Y_7, mercury__std_util__X_6);
    }
    return mercury__std_util__HeadVar__4_4;
  }
}
...
{
  {
    MR_bool mercury__std_util__succeeded;
    MR_Box mercury__std_util__HeadVar__4_4;
    MR_Box mercury__std_util__Var_8;
    ...
    {
      mercury__std_util__Var_8 = mercury__std_util__func_0(((MR_Box) mercury__std_util__G_6), mercury__std_util__X_7);
    }
    mercury__std_util__func_1 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), mercury__std_util__F_5, (MR_Integer) 1)));
    {
      mercury__std_util__HeadVar__4_4 = mercury__std_util__func_1(((MR_Box) mercury__std_util__F_5), mercury__std_util__Var_8);
    }
    return mercury__std_util__HeadVar__4_4;
  }
}
