...
MR_decl_label4(univ__det_univ_to_type_2_0, 3,2,5,6)
...
MR_BEGIN_MODULE(univ_module11)
	...
	MR_init_label4(univ__det_univ_to_type_2_0,3,2,5,6)
MR_BEGIN_CODE
...
MR_def_label(univ__det_univ_to_type_2_0,6)
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("\tUniv Type: ", 12);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("det_univ_to_type: conversion failed\\n", 37);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	{
	MR_Word	Strs;
	MR_String	Str;
...
void mercury__univ__write_out_proc_statics(FILE *fp);
#endif
