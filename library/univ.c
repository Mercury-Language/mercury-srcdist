...
static void MR_CALL 
mercury__univ__LCMCfn_map__ho1_1_3_p_in__list_0(
  MR_Word HeadVar__2_2,
...
{
  {
    ...
    {
      MR_Word TypeInfo_8_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word TypeInfo_9_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))));
...
{
  {
    ...
    {
      MR_Word TypeInfo_7_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0))));
      MR_Word TypeInfo_8_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
  ...
  MR_Word Univ_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word TypeInfo_5_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
...
{
  {
    MR_bool succeeded;
    MR_Box X0_5;
    MR_Word TypeInfo_12_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
    ...
    {
      MR_Word TypeInfo_5_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
	 Var_10  = TypeInfo;
      ...
      V_5_39 = mercury__univ__map__ho1_2_f_in__list_0(Var_11);
      mercury__string__unsafe_append_string_pieces_2_p_0(V_5_39, &ErrorString_8);
      {
...
#undef MR_PROC_LABEL
	 V_5_14  = Length;
      ...
      {
        V_8_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_8_8, 0) = ((MR_Box) (V_6_6));
        MR_hl_field(MR_mktag(1), V_8_8, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), V_8_8, 2) = ((MR_Box) (V_5_14));
      }
      {
      ...
      mercury__univ__LCMCfn_map__ho1_1_3_p_in__list_0(V_7_7, AddrV_9_17);
    }
    return HeadVar__3_3;
  }
}
...
{
#define MR_PROC_LABEL mercury__univ__LCMCfn_map__ho1_1_3_p_in__list_0
  ...
  MR_Word Univ_4)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_12_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_4, (MR_Integer) 0))));
  ...
  MR_Box * X_4)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_12_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
  ...
  MR_Word Univ_2)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_12_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_2, (MR_Integer) 0))));
