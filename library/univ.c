...
{
  {
    ...
    MR_Box Var_4 = (MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 1));
    MR_Box Var_6;
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_20;
      MR_Word Var_21;
      MR_Box Var_33 = (MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 1));
      MR_Box Var_35;
...
#undef MR_PROC_LABEL
	 Var_10  = TypeInfo;
      ...
      ErrorString_8 = mercury__string__append_list_1_f_0(Var_11);
      {
...
{
  {
    ...
    {
      Univ0_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      Univ_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      Univ0_5 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
