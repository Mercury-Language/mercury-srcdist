    ...
    if (mercury__univ__succeeded)
      *mercury__univ__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Box mercury__univ__Var_4 = (MR_hl_field(MR_mktag(0), mercury__univ__HeadVar__2_2, (MR_Integer) 1));
        MR_Box mercury__univ__Var_5 = (MR_hl_field(MR_mktag(0), mercury__univ__HeadVar__3_3, (MR_Integer) 1));

        {
          mercury__private_builtin__typed_compare_3_p_0(mercury__univ__TypeInfo_8_8, mercury__univ__TypeInfo_9_9, mercury__univ__HeadVar__1_1, mercury__univ__Var_4, mercury__univ__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__univ__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__univ__TypeInfo_8_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__univ__HeadVar__2_2, (MR_Integer) 0)));
        MR_Box mercury__univ__Var_3 = (MR_hl_field(MR_mktag(0), mercury__univ__HeadVar__1_1, (MR_Integer) 1));
        MR_Box mercury__univ__Var_4 = (MR_hl_field(MR_mktag(0), mercury__univ__HeadVar__2_2, (MR_Integer) 1));

        {
          mercury__univ__succeeded = mercury__private_builtin__typed_unify_2_p_0(mercury__univ__TypeInfo_7_7, mercury__univ__TypeInfo_8_8, mercury__univ__Var_3, mercury__univ__Var_4);
        }
      }
    return mercury__univ__succeeded;
  }
