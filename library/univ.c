...
{
  {
    ...
    if (mercury__univ__succeeded)
    ...
    else
      {
        ...
        {
          mercury__univ__succeeded = mercury__private_builtin__typed_unify_2_p_0(mercury__univ__TypeInfo_7_7, mercury__univ__TypeInfo_8_8, mercury__univ__V_3_3, mercury__univ__V_4_4);
        }
      }
    return mercury__univ__succeeded;
  }
