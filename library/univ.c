...
MR_def_label(univ__det_univ_to_type_2_0,6)
	...
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("\tObject Type: ", 14);
	...
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_string_const("\tUniv Type: ", 12);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("det_univ_to_type: conversion failed\n", 36);
...
void mercury__univ__init_threadscope_string_table(void);
#endif
...
void mercury__univ__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__univ);
