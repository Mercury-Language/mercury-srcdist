...
#undef MR_PROC_LABEL
    ...
    Var_39 = mercury__univ__map__ho1_2_f_in__list_0(Var_11);
    mercury__string__unsafe_append_string_pieces_2_p_0(Var_39, &ErrorString_8);
    {
...
#undef MR_PROC_LABEL
    ...
    mercury__univ__LCMCfn_map__ho1_1_3_p_in__list_0(Var_7, AddrSCCcallarg9_17);
  }
  return HeadVar__3_3;
}
