  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Word TypeInfo__8_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
    MR_Word TypeInfo__9_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))));
    ...
    mercury__private_builtin__typed_compare_3_p_0(TypeInfo__8_8, TypeInfo__9_9, HeadVar__1_1, ArgX1_4, ArgY1_5);
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  {
    MR_Word TypeInfo__7_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0))));
    MR_Word TypeInfo__8_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
    ...
    succeeded = mercury__private_builtin__typed_unify_2_p_0(TypeInfo__7_7, TypeInfo__8_8, ArgX1_3, ArgY1_4);
  }
  return succeeded;
}
...
mercury__univ__unravel_univ_2_p_0(
  ...
  MR_Box * X_4)
{
  *TypeInfo_for_T_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
  *X_4 = (MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 1));
}
...
{
  {
    ...
    *Univ_4 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TypeInfo_for_T_5));
    MR_hl_field(MR_mktag(0), base, 1) = X_3;
  }
}
  ...
  MR_Word HeadVar__1_1)
{
  ...
  *TypeInfo_for_T_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0))));
  X_3 = (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1));
  return X_3;
}
...
{
  MR_Word HeadVar__2_2;
  MR_Word TypeInfo__5_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
  ...
  MR_Box * X_4)
{
  MR_bool succeeded;
  MR_Box X0_5;
  MR_Word TypeInfo__12_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
  MR_Box T0_30 = (MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 1));

  succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo__12_31, TypeInfo_for_T_22, T0_30, &X0_5);
  if (succeeded)
    *X_4 = X0_5;
  else
  {
    MR_Word TypeInfo__5_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
    ...
    ObjectTypeName_7 = mercury__type_desc__type_name_1_f_0(Var_10);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (ObjectTypeName_7));
      MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_18, 0) = ((MR_Box) ((MR_String) "\tObject Type: "));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_15, 0) = ((MR_Box) (UnivTypeName_6));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_13, 0) = ((MR_Box) ((MR_String) "\tUniv Type: "));
      MR_hl_field(MR_mktag(1), Var_13, 1) = ((MR_Box) (Var_15));
    }
    {
      Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) ((MR_String) "det_univ_to_type: conversion failed\n"));
...
#undef MR_PROC_LABEL
...
}
    {
      ...
      MR_hl_field(MR_mktag(1), Var_8, 2) = ((MR_Box) (Var_13));
    }
    {
...
{
  MR_bool succeeded;
  MR_Word TypeInfo__12_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_4, (MR_Integer) 0))));
  MR_Box T0_13 = (MR_hl_field(MR_mktag(0), Univ_4, (MR_Integer) 1));

  succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo__12_14, TypeInfo_for_T_5, T0_13, X_3);
  return succeeded;
}
  ...
  MR_Box X_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Univ0_8, 0) = ((MR_Box) (TypeInfo_for_T_5));
    MR_hl_field(MR_mktag(0), Univ0_8, 1) = X_3;
  }
  Univ_4 = Univ0_8;
  return Univ_4;
}
  ...
  MR_Box X_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Univ_4, 0) = ((MR_Box) (TypeInfo_for_T_5));
    MR_hl_field(MR_mktag(0), Univ_4, 1) = X_3;
  }
  return Univ_4;
}
  ...
  MR_Box X_4)
{
...

  {
    Univ0_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Univ0_8, 0) = ((MR_Box) (TypeInfo_for_T_5));
    MR_hl_field(MR_mktag(0), Univ0_8, 1) = X_4;
  }
  *Univ_3 = Univ0_8;
}
...
{
  {
    ...
    *Univ_3 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TypeInfo_for_T_5));
    MR_hl_field(MR_mktag(0), base, 1) = X_4;
  }
}
...
{
  MR_bool succeeded;
  MR_Word TypeInfo__12_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
  MR_Box T0_13 = (MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 1));

  succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo__12_14, TypeInfo_for_T_5, T0_13, X_4);
  return succeeded;
}
...
{
  MR_bool succeeded;
  MR_Word TypeInfo__12_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_2, (MR_Integer) 0))));
  MR_Box T0_10 = (MR_hl_field(MR_mktag(0), Univ_2, (MR_Integer) 1));

  succeeded = mercury__private_builtin__typed_unify_2_p_1(TypeInfo__12_12, TypeInfo_for_T_11, T0_10, T_1);
  return succeeded;
}
...
{
  {
    ...
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *Univ_2 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TypeInfo_for_T_11));
    MR_hl_field(MR_mktag(0), base, 1) = T_1;
  }
}
  ...
  MR_Word * Univ_2)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Univ0_5, 0) = ((MR_Box) (TypeInfo_for_T_11));
    MR_hl_field(MR_mktag(0), Univ0_5, 1) = T_1;
  }
  *Univ_2 = Univ0_5;
}
