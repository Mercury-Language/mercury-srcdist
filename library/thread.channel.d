...
thread.channel.optdate thread.channel.trans_opt_date thread.channel.err thread.channel.c_date thread.channel.java_date : thread.channel.m \
	thread.int0 \
	bool.int \
	builtin.int \
	io.int \
...
#   long deps
#   short deps
thread.channel.optdate thread.channel.trans_opt_date thread.channel.err thread.channel.c_date thread.channel.java_date : \
		thread.channel.m \
	\
		thread.int0 \
	\
...
thread.channel.trans_opt_date thread.channel.err thread.channel.c_date thread.channel.java_date :  \
	thread.channel.opt \
	bool.opt \
	builtin.opt \
	io.opt \
...
thread.channel.err thread.channel.c_date thread.channel.java_date :  \
...
#   long dep int3s
#   short dep int3s
thread.channel.date thread.channel.date0 thread.date : \
		thread.channel.m \
	\
		thread.int0 \
	\
...
#   long dep int3s
#   short dep int3s
thread.channel.date0 thread.date0 : \
		thread.channel.m \
	\
		bool.int3 \
		builtin.int3 \
