...
store.optdate store.trans_opt_date store.err store.c_date store.s_date store.pic_s_date store.java_date : store.m \
	builtin.int \
	deconstruct.int \
	io.int \
	private_builtin.int \
...
store.trans_opt_date store.err store.c_date store.s_date store.pic_s_date store.java_date :  \
	store.opt \
	builtin.opt \
	deconstruct.opt \
	io.opt \
...
store.err store.c_date store.s_date store.pic_s_date store.java_date :  \
	store.trans_opt \
	builtin.trans_opt \
