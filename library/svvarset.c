...
MR_decl_label2(svvarset__new_vars_4_0, 2,4)
...
MR_BEGIN_MODULE(svvarset_module4)
	...
	MR_init_label2(svvarset__new_vars_4_0,2,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__svvarset__new_vars_4_0);
	...
	MR_np_call_localret_ent(varset__new_vars_2_5_0,
		svvarset__new_vars_4_0_i2);
MR_def_label(svvarset__new_vars_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(list__reverse_2_0,
		svvarset__new_vars_4_0_i4);
MR_def_label(svvarset__new_vars_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
...
void mercury__svvarset__init_threadscope_string_table(void);
#endif
