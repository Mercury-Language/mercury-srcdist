...
MR_decl_label6(__Unify___cord__cord_1_0, 4,5,9,13,15,1)
MR_decl_label8(__Compare___cord__cord_1_0, 4,11,15,19,24,26,27,32)
MR_decl_label3(__Compare___cord__cord_1_0, 33,35,58)
...
MR_BEGIN_MODULE(cord_module15)
	...
	MR_init_label6(__Unify___cord__cord_1_0,4,5,9,13,15,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___cord__cord_1_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Unify___cord__cord_1_0_i4) MR_AND
		MR_LABEL_AP(__Unify___cord__cord_1_0_i5) MR_AND
		MR_LABEL_AP(__Unify___cord__cord_1_0_i9) MR_AND
		MR_LABEL_AP(__Unify___cord__cord_1_0_i13));
MR_def_label(__Unify___cord__cord_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r3 == MR_r2);
...
MR_def_label(__Unify___cord__cord_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(__Unify___list__list_1_0);
MR_def_label(__Unify___cord__cord_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(cord_module16)
	...
	MR_init_label8(__Compare___cord__cord_1_0,4,11,15,19,24,26,27,32)
	MR_init_label3(__Compare___cord__cord_1_0,33,35,58)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___cord__cord_1_0);
	...
	MR_sv(4) = (MR_Word) MR_succip;
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___cord__cord_1_0_i4) MR_AND
		MR_LABEL_AP(__Compare___cord__cord_1_0_i11) MR_AND
		MR_LABEL_AP(__Compare___cord__cord_1_0_i19) MR_AND
		MR_LABEL_AP(__Compare___cord__cord_1_0_i27));
MR_def_label(__Compare___cord__cord_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r3),0)) {
		MR_GOTO_LAB(__Compare___cord__cord_1_0_i26);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___cord__cord_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		...
		MR_LABEL_AP(__Compare___cord__cord_1_0_i26));
...
MR_def_label(__Compare___cord__cord_1_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		MR_LABEL_AP(__Compare___cord__cord_1_0_i32) MR_AND
		MR_LABEL_AP(__Compare___cord__cord_1_0_i32) MR_AND
...
MR_def_label(__Compare___cord__cord_1_0,26)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___cord__cord_1_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_tag(MR_r3),3)) {
		MR_GOTO_LAB(__Compare___cord__cord_1_0_i33);
	}
MR_def_label(__Compare___cord__cord_1_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___cord__cord_1_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_localcall_lab(__Compare___cord__cord_1_0,
		__Compare___cord__cord_1_0_i35);
MR_def_label(__Compare___cord__cord_1_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___cord__cord_1_0_i58);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(1);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		...
		MR_LABEL_AP(__Compare___cord__cord_1_0_i19) MR_AND
		MR_LABEL_AP(__Compare___cord__cord_1_0_i27));
MR_def_label(__Compare___cord__cord_1_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
