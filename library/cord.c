...
{
  {
    ...
    {
      MR_Word mercury__cord__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 0)));

      if ((mercury__cord__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *mercury__cord__HeadVar__1_1 = (MR_Integer) 2;
      else
      {
        MR_Word mercury__cord__ArgY1_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__3_3, (MR_Integer) 0)));

        mercury__cord____Compare____cord_node_1_0(mercury__cord__TypeInfo_for_T_10, mercury__cord__HeadVar__1_1, mercury__cord__Var_13, mercury__cord__ArgY1_7);
      }
    }
  }
}
      ...
      if (mercury__cord__succeeded)
        *mercury__cord__HeadVar__1_1 = (MR_Integer) 0;
        ...
        switch (MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Box mercury__cord__Var_49 = (MR_hl_field(MR_mktag(0), mercury__cord__HeadVar__2_2, (MR_Integer) 0));

              switch (MR_tag((MR_Word) mercury__cord__HeadVar__3_3)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Box mercury__cord__ArgY1_5 = (MR_hl_field(MR_mktag(0), mercury__cord__HeadVar__3_3, (MR_Integer) 0));

                    mercury__builtin__compare_3_p_0(mercury__cord__TypeInfo_for_T_38, mercury__cord__HeadVar__1_1, mercury__cord__Var_49, mercury__cord__ArgY1_5);
                  }
                  break;
                case (MR_Integer) 1:
                  *mercury__cord__HeadVar__1_1 = (MR_Integer) 1;
          ...
          case (MR_Integer) 1:
            {
              MR_Word mercury__cord__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 1)));
              MR_Box mercury__cord__Var_48 = (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 0));
              ...
              switch (MR_tag((MR_Word) mercury__cord__HeadVar__3_3)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Box mercury__cord__ArgY1_16 = (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__3_3, (MR_Integer) 0));
                    MR_Word mercury__cord__ArgY2_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__3_3, (MR_Integer) 1)));
                    MR_Word mercury__cord__Var_19;

                    mercury__builtin__compare_3_p_0(mercury__cord__TypeInfo_for_T_38, &mercury__cord__Var_19, mercury__cord__Var_48, mercury__cord__ArgY1_16);
                    mercury__cord__succeeded = (mercury__cord__Var_19 == (MR_Integer) 0);
                    mercury__cord__succeeded = !(mercury__cord__succeeded);
                    if (mercury__cord__succeeded)
                      *mercury__cord__HeadVar__1_1 = mercury__cord__Var_19;
                    else
                      mercury__list____Compare____list_1_0(mercury__cord__TypeInfo_for_T_38, mercury__cord__HeadVar__1_1, mercury__cord__Var_47, mercury__cord__ArgY2_18);
                  }
                  break;
                case (MR_Integer) 2:
                  *mercury__cord__HeadVar__1_1 = (MR_Integer) 1;
          ...
          case (MR_Integer) 2:
            {
              MR_Word mercury__cord__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__2_2, (MR_Integer) 1)));
              MR_Word mercury__cord__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__2_2, (MR_Integer) 0)));
              ...
              switch (MR_tag((MR_Word) mercury__cord__HeadVar__3_3)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word mercury__cord__ArgY1_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__3_3, (MR_Integer) 0)));
                    MR_Word mercury__cord__ArgY2_34 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__3_3, (MR_Integer) 1)));
                    MR_Word mercury__cord__Var_35;

                    mercury__cord____Compare____cord_node_1_0(mercury__cord__TypeInfo_for_T_38, &mercury__cord__Var_35, mercury__cord__Var_46, mercury__cord__ArgY1_32);
                    mercury__cord__succeeded = (mercury__cord__Var_35 == (MR_Integer) 0);
                    mercury__cord__succeeded = !(mercury__cord__succeeded);
                    if (mercury__cord__succeeded)
                      *mercury__cord__HeadVar__1_1 = mercury__cord__Var_35;
                    else
                    {
                      /* direct tailcall eliminated */
                      {
                        MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Var_45;
                        MR_Word mercury__cord__next_value_of_HeadVar__3_3 = mercury__cord__ArgY2_34;

                        mercury__cord__HeadVar__2_2 = mercury__cord__next_value_of_HeadVar__2_2;
                        mercury__cord__HeadVar__3_3 = mercury__cord__next_value_of_HeadVar__3_3;
                      }
                      continue;
                    }
                  }
...
{
  {
    ...
    {
      MR_Word mercury__cord__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word mercury__cord__ArgY1_6;

      mercury__cord__succeeded = ((MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (mercury__cord__succeeded)
      {
        mercury__cord__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 0)));
        mercury__cord__succeeded = mercury__cord____Unify____cord_node_1_0(mercury__cord__TypeInfo_for_T_9, mercury__cord__ArgX1_5, mercury__cord__ArgY1_6);
      }
    }
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (mercury__cord__succeeded)
        ...
        switch (MR_tag((MR_Word) mercury__cord__HeadVar__1_1)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Box mercury__cord__ArgX1_3 = (MR_hl_field(MR_mktag(0), mercury__cord__HeadVar__1_1, (MR_Integer) 0));
              MR_Box mercury__cord__ArgY1_4;

              mercury__cord__succeeded = ((MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
              if (mercury__cord__succeeded)
              {
                mercury__cord__ArgY1_4 = (MR_hl_field(MR_mktag(0), mercury__cord__HeadVar__2_2, (MR_Integer) 0));
                mercury__cord__succeeded = mercury__builtin__unify_2_p_0(mercury__cord__TypeInfo_for_T_15, mercury__cord__ArgX1_3, mercury__cord__ArgY1_4);
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Box mercury__cord__ArgX1_5 = (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__1_1, (MR_Integer) 0));
              MR_Box mercury__cord__ArgY1_6;
              MR_Word mercury__cord__ArgX2_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word mercury__cord__ArgY2_8;

              mercury__cord__succeeded = ((MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
              if (mercury__cord__succeeded)
              {
                mercury__cord__ArgY1_6 = (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 0));
                mercury__cord__ArgY2_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 1)));
                mercury__cord__succeeded = mercury__builtin__unify_2_p_0(mercury__cord__TypeInfo_for_T_15, mercury__cord__ArgX1_5, mercury__cord__ArgY1_6);
                if (mercury__cord__succeeded)
                  mercury__cord__succeeded = mercury__list____Unify____list_1_0(mercury__cord__TypeInfo_for_T_15, mercury__cord__ArgX2_7, mercury__cord__ArgY2_8);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word mercury__cord__ArgX1_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__1_1, (MR_Integer) 0)));
              MR_Word mercury__cord__ArgY1_10;
              MR_Word mercury__cord__ArgX2_11 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word mercury__cord__ArgY2_12;

              mercury__cord__succeeded = ((MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
              if (mercury__cord__succeeded)
              {
                mercury__cord__ArgY1_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__2_2, (MR_Integer) 0)));
                mercury__cord__ArgY2_12 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__HeadVar__2_2, (MR_Integer) 1)));
                mercury__cord__succeeded = mercury__cord____Unify____cord_node_1_0(mercury__cord__TypeInfo_for_T_15, mercury__cord__ArgX1_9, mercury__cord__ArgY1_10);
                if (mercury__cord__succeeded)
                {
                  /* direct tailcall eliminated */
                  {
                    MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__ArgX2_11;
                    MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__ArgY2_12;

                    mercury__cord__HeadVar__1_1 = mercury__cord__next_value_of_HeadVar__1_1;
                    mercury__cord__HeadVar__2_2 = mercury__cord__next_value_of_HeadVar__2_2;
                  }
                  continue;
                }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_7;
      MR_Word mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      {
        mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_7, 0) = ((MR_Box) (mercury__cord__N_5));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_7, 1) = ((MR_Box) (mercury__cord__Var_8));
      }
      mercury__cord__HeadVar__3_3 = mercury__cord__to_list_2_2_f_0(mercury__cord__TypeInfo_for_T_9, mercury__cord__Var_7, mercury__cord__L_2);
    }
  ...
  MR_Word mercury__cord__CB_4)
{
  {
    MR_bool mercury__cord__succeeded;
    MR_Word mercury__cord__Var_5;
    MR_Word mercury__cord__Var_7;

    if ((mercury__cord__CA_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      mercury__cord__Var_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word mercury__cord__N_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__CA_3, (MR_Integer) 0)));
      MR_Word mercury__cord__Var_12;
      MR_Word mercury__cord__Var_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word mercury__cord__Var_14;

      {
        mercury__cord__Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_12, 0) = ((MR_Box) (mercury__cord__N_11));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_12, 1) = ((MR_Box) (mercury__cord__Var_13));
      }
      mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__Var_5 = mercury__cord__to_list_2_2_f_0(mercury__cord__TypeInfo_for_T_6, mercury__cord__Var_12, mercury__cord__Var_14);
    }
    if ((mercury__cord__CB_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word mercury__cord__N_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__CB_4, (MR_Integer) 0)));
      MR_Word mercury__cord__Var_17;
      MR_Word mercury__cord__Var_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word mercury__cord__Var_19;

      {
        mercury__cord__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 0) = ((MR_Box) (mercury__cord__N_16));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 1) = ((MR_Box) (mercury__cord__Var_18));
      }
      mercury__cord__Var_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__Var_7 = mercury__cord__to_list_2_2_f_0(mercury__cord__TypeInfo_for_T_6, mercury__cord__Var_17, mercury__cord__Var_19);
    }
    mercury__cord__succeeded = mercury__list____Unify____list_1_0(mercury__cord__TypeInfo_for_T_6, mercury__cord__Var_5, mercury__cord__Var_7);
    return mercury__cord__succeeded;
  }
}
...
mercury__cord__find_first_match_3_p_0(
  MR_Word mercury__cord__TypeInfo_for_X_7,
  MR_Word mercury__cord__P_4,
  MR_Word mercury__cord__HeadVar__2_2,
  MR_Box * mercury__cord__FirstMatch_6)
{
  {
    MR_bool mercury__cord__succeeded = ((MR_tag((MR_Word) mercury__cord__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
    MR_Word mercury__cord__NX_5;

    if (mercury__cord__succeeded)
    {
      mercury__cord__NX_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 0)));
      mercury__cord__succeeded = mercury__cord__find_first_match_node_3_p_0(mercury__cord__TypeInfo_for_X_7, mercury__cord__P_4, mercury__cord__NX_5, mercury__cord__FirstMatch_6);
    }
    return mercury__cord__succeeded;
  }
}
...
mercury__cord__find_first_match_node_3_p_0(
  MR_Word mercury__cord__TypeInfo_for_X_13,
  MR_Word mercury__cord__P_4,
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      switch (MR_tag((MR_Word) mercury__cord__Node_5)) {
        ...
        case (MR_Integer) 0:
          {
            MR_bool MR_CALL (* mercury__cord__func_1)(MR_Box, MR_Box);

            *mercury__cord__FirstMatch_6 = (MR_hl_field(MR_mktag(0), mercury__cord__Node_5, (MR_Integer) 0));
            mercury__cord__func_1 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), mercury__cord__P_4, (MR_Integer) 1)));
            mercury__cord__succeeded = mercury__cord__func_1(((MR_Box) mercury__cord__P_4), *mercury__cord__FirstMatch_6);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Box mercury__cord__XH_8 = (MR_hl_field(MR_mktag(1), mercury__cord__Node_5, (MR_Integer) 0));
            MR_Word mercury__cord__XT_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__Node_5, (MR_Integer) 1)));
            ...
            mercury__cord__succeeded = mercury__cord__func_0(((MR_Box) mercury__cord__P_4), mercury__cord__XH_8);
            if (mercury__cord__succeeded)
            {
              *mercury__cord__FirstMatch_6 = mercury__cord__XH_8;
              mercury__cord__succeeded = MR_TRUE;
            }
            else
              mercury__cord__succeeded = mercury__list__find_first_match_3_p_0(mercury__cord__TypeInfo_for_X_13, mercury__cord__P_4, mercury__cord__XT_9, mercury__cord__FirstMatch_6);
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word mercury__cord__XA_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__Node_5, (MR_Integer) 0)));
            MR_Word mercury__cord__XB_11 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__Node_5, (MR_Integer) 1)));
            MR_Box mercury__cord__FirstMatchPrime_12;

            mercury__cord__succeeded = mercury__cord__find_first_match_node_3_p_0(mercury__cord__TypeInfo_for_X_13, mercury__cord__P_4, mercury__cord__XA_10, &mercury__cord__FirstMatchPrime_12);
            if (mercury__cord__succeeded)
            {
              *mercury__cord__FirstMatch_6 = mercury__cord__FirstMatchPrime_12;
              mercury__cord__succeeded = MR_TRUE;
            }
            else
            {
              /* direct tailcall eliminated */
              {
                MR_Word mercury__cord__next_value_of_Node_5 = mercury__cord__XB_11;

                mercury__cord__Node_5 = mercury__cord__next_value_of_Node_5;
              }
              continue;
            }
          }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      mercury__cord__succeeded = mercury__cord__foldr_node_pred_5_p_5(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 0:
          {
            ...
            if (mercury__cord__succeeded)
            {
              ...
              else
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Y_32;
                  MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Ys_33;
                  MR_Box mercury__cord__next_value_of_STATE_VARIABLE_Acc_0_4 = mercury__cord__STATE_VARIABLE_Acc_19_43;

                  mercury__cord__HeadVar__2_2 = mercury__cord__next_value_of_HeadVar__2_2;
                  mercury__cord__Cs_3 = mercury__cord__next_value_of_Cs_3;
                  mercury__cord__STATE_VARIABLE_Acc_0_4 = mercury__cord__next_value_of_STATE_VARIABLE_Acc_0_4;
                }
                continue;
              }
            }
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              mercury__cord__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 0) = mercury__cord__H_11;
              MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 1) = ((MR_Box) (mercury__cord__T_12));
            }
            mercury__cord__succeeded = mercury__list__foldr_4_p_5(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
              ...
              else
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Y_13;
                  MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Ys_14;
                  MR_Box mercury__cord__next_value_of_STATE_VARIABLE_Acc_0_4 = mercury__cord__STATE_VARIABLE_Acc_19_19;
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word mercury__cord__Var_28;

            {
              mercury__cord__Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_28, 0) = ((MR_Box) (mercury__cord__A_22));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_28, 1) = ((MR_Box) (mercury__cord__Cs_3));
            }
            /* direct tailcall eliminated */
            {
              MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__B_23;
              MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Var_28;
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__succeeded = mercury__cord__foldr_node_pred_5_p_4(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__succeeded = mercury__list__foldr_4_p_4(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__succeeded = mercury__cord__foldr_node_pred_5_p_3(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__succeeded = mercury__list__foldr_4_p_3(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldr_node_pred_5_p_2(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldr_4_p_2(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldr_node_pred_5_p_1(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldr_4_p_1(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldr_node_pred_5_p_0(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldr_4_p_0(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      mercury__cord__foldr_node_5_p_0(mercury__cord__TypeInfo_for_T_12, mercury__cord__TypeInfo_for_U_13, mercury__cord__F_1, mercury__cord__N_8, mercury__cord__Var_11, mercury__cord__HeadVar__3_3, &mercury__cord__Acc_4);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__cord__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 0) = mercury__cord__H_11;
            MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 1) = ((MR_Box) (mercury__cord__T_12));
          }
          mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_114_95_95_104_111_49_95_95_91_49_44_32_50_44_32_52_44_32_53_44_32_54_93_95_48_4_p_in__list_0(mercury__cord__F_1, mercury__cord__Var_18, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
  ...
  MR_Box * mercury__cord__HeadVar__4_4)
{
  ...
  else
  {
    ...
    mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_114_95_95_104_111_49_95_95_91_49_44_32_50_44_32_52_44_32_53_44_32_54_93_95_48_4_p_in__list_0(mercury__cord__Var_18, mercury__cord__V_11_10, mercury__cord__HeadVar__3_3, &mercury__cord__V_15_13);
    mercury__cord__func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), mercury__cord__Var_18, (MR_Integer) 1)));
    *mercury__cord__HeadVar__4_4 = mercury__cord__func_0(((MR_Box) mercury__cord__Var_18), mercury__cord__V_10_9, mercury__cord__V_15_13);
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__succeeded = mercury__cord__foldl_node_pred_5_p_5(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__succeeded = mercury__list__foldl_4_p_5(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              mercury__cord__Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_28, 0) = ((MR_Box) (mercury__cord__B_23));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_28, 1) = ((MR_Box) (mercury__cord__Cs_3));
            }
            /* direct tailcall eliminated */
            {
              MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__A_22;
              MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Var_28;
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__succeeded = mercury__cord__foldl_node_pred_5_p_4(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__succeeded = mercury__list__foldl_4_p_4(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__succeeded = mercury__cord__foldl_node_pred_5_p_3(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
    }
    return mercury__cord__succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__succeeded = mercury__list__foldl_4_p_3(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
            if (mercury__cord__succeeded)
            {
              if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldl_node_pred_5_p_2(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldl_4_p_2(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldl_node_pred_5_p_1(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldl_4_p_1(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
  ...
  MR_Box * mercury__cord__STATE_VARIABLE_Acc_4)
{
  ...
  else
  {
    ...
    mercury__cord__foldl_node_pred_5_p_0(mercury__cord__TypeInfo_for_T_16, mercury__cord__TypeInfo_for_U_17, mercury__cord__HeadVar__1_1, mercury__cord__N_10, mercury__cord__Var_14, mercury__cord__STATE_VARIABLE_Acc_0_3, mercury__cord__STATE_VARIABLE_Acc_4);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldl_4_p_0(mercury__cord__TypeInfo_for_T_30, mercury__cord__TypeInfo_for_U_31, mercury__cord__P_1, mercury__cord__Var_17, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__foldl_node_5_p_0(mercury__cord__TypeInfo_for_T_12, mercury__cord__TypeInfo_for_U_13, mercury__cord__F_1, mercury__cord__N_8, mercury__cord__Var_11, mercury__cord__HeadVar__3_3, &mercury__cord__Acc_4);
    }
    return mercury__cord__Acc_4;
  }
}
  ...
  MR_Box * mercury__cord__HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__V_11_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, (MR_Integer) 1)));
      MR_Box mercury__cord__V_15_13;
      MR_Box MR_CALL (* mercury__cord__func_0)(MR_Box, MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), mercury__cord__Var_18, (MR_Integer) 1)));

      mercury__cord__V_15_13 = mercury__cord__func_0(((MR_Box) mercury__cord__Var_18), mercury__cord__V_10_9, mercury__cord__HeadVar__3_3);
      /* direct tailcall eliminated */
      {
        MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__V_11_10;
        MR_Box mercury__cord__next_value_of_HeadVar__3_3 = mercury__cord__V_15_13;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word mercury__cord__Var_24;

          {
            mercury__cord__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__Var_24, 0) = mercury__cord__H_10;
            MR_hl_field(MR_mktag(1), mercury__cord__Var_24, 1) = ((MR_Box) (mercury__cord__T_11));
          }
          mercury__list__filter_4_p_0(mercury__cord__TypeInfo_for_T_29, mercury__cord__P_5, mercury__cord__Var_24, &mercury__cord__TrueList_12, &mercury__cord__FalseList_13);
          ...
          else
          {
            ...
            MR_Word mercury__cord__Var_25;

            {
              mercury__cord__Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_25, 0) = mercury__cord__TH_14;
              MR_hl_field(MR_mktag(1), mercury__cord__Var_25, 1) = ((MR_Box) (mercury__cord__TT_15));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              *mercury__cord__Trues_7 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_25));
            }
          }
          ...
          else
          {
            ...
            MR_Word mercury__cord__Var_26;

            {
              mercury__cord__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_26, 0) = mercury__cord__FH_16;
              MR_hl_field(MR_mktag(1), mercury__cord__Var_26, 1) = ((MR_Box) (mercury__cord__FT_17));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              *mercury__cord__Falses_8 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_26));
            }
          }
        }
        break;
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__cord__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 0) = mercury__cord__H_8;
            MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 1) = ((MR_Box) (mercury__cord__T_9));
          }
          mercury__list__filter_3_p_0(mercury__cord__TypeInfo_for_T_20, mercury__cord__P_4, mercury__cord__Var_17, &mercury__cord__TrueList_10);
          ...
          else
          {
            ...
            {
              mercury__cord__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 0) = mercury__cord__TH_11;
              MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 1) = ((MR_Box) (mercury__cord__TT_12));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              *mercury__cord__Trues_6 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_18));
            }
          }
        }
        break;
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__Var_7 = mercury__cord__map_node_2_f_0(mercury__cord__TypeInfo_for_T_8, mercury__cord__TypeInfo_for_U_9, mercury__cord__F_1, mercury__cord__N_6);
      {
        mercury__cord__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__3_3, 0) = ((MR_Box) (mercury__cord__Var_7));
      }
    }
    return mercury__cord__HeadVar__3_3;
  }
      ...
      case (MR_Integer) 0:
        {
          ...
          mercury__cord__Var_16 = mercury__cord__func_1(((MR_Box) mercury__cord__F_4), mercury__cord__X_7);
          {
            mercury__cord__PNode_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), mercury__cord__PNode_6, 0) = mercury__cord__Var_16;
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Box mercury__cord__H_8 = (MR_hl_field(MR_mktag(1), mercury__cord__Node_5, (MR_Integer) 0));
          MR_Word mercury__cord__T_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__Node_5, (MR_Integer) 1)));
          MR_Box mercury__cord__Var_14;
          MR_Word mercury__cord__Var_15;
          ...
          mercury__cord__Var_14 = mercury__cord__func_0(((MR_Box) mercury__cord__F_4), mercury__cord__H_8);
          mercury__cord__Var_15 = mercury__list__map_2_f_0(mercury__cord__TypeInfo_for_T_17, mercury__cord__TypeInfo_for_U_18, mercury__cord__F_4, mercury__cord__T_9);
          {
            mercury__cord__PNode_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__PNode_6, 0) = mercury__cord__Var_14;
            MR_hl_field(MR_mktag(1), mercury__cord__PNode_6, 1) = ((MR_Box) (mercury__cord__Var_15));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Word mercury__cord__Var_12;
          MR_Word mercury__cord__Var_13;

          mercury__cord__Var_12 = mercury__cord__map_node_2_f_0(mercury__cord__TypeInfo_for_T_17, mercury__cord__TypeInfo_for_U_18, mercury__cord__F_4, mercury__cord__A_10);
          mercury__cord__Var_13 = mercury__cord__map_node_2_f_0(mercury__cord__TypeInfo_for_T_17, mercury__cord__TypeInfo_for_U_18, mercury__cord__F_4, mercury__cord__B_11);
          {
            mercury__cord__PNode_6 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), mercury__cord__PNode_6, 0) = ((MR_Box) (mercury__cord__Var_12));
            MR_hl_field(MR_mktag(2), mercury__cord__PNode_6, 1) = ((MR_Box) (mercury__cord__Var_13));
          }
        }
        break;
    }
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__cord__member_node_2_p_0(mercury__cord__TypeInfo_for_T_9, mercury__cord__X_3, mercury__cord__B_8, mercury__cord__cont, mercury__cord__cont_env_ptr);
      }
      break;
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_108_95_110_111_100_101_95_95_104_111_56_95_95_91_49_44_32_50_44_32_51_93_95_48_5_p_0(mercury__cord__N_20, mercury__cord__Var_23, (MR_Integer) 0, &mercury__cord__HeadVar__2_2);
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Y_32;
              MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Ys_33;
              MR_Integer mercury__cord__next_value_of_STATE_VARIABLE_Acc_0_4 = mercury__cord__STATE_VARIABLE_Acc_19_43;
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_108_95_95_104_111_50_95_95_104_111_49_50_95_95_91_49_44_32_50_44_32_51_44_32_52_44_32_53_44_32_54_44_32_55_44_32_56_93_95_48_4_p_in__list_0(mercury__cord__Var_18, mercury__cord__STATE_VARIABLE_Acc_0_4, &mercury__cord__STATE_VARIABLE_Acc_19_19);
          if ((mercury__cord__Cs_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *mercury__cord__STATE_VARIABLE_Acc_5 = mercury__cord__STATE_VARIABLE_Acc_19_19;
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Y_13;
              MR_Word mercury__cord__next_value_of_Cs_3 = mercury__cord__Ys_14;
              MR_Integer mercury__cord__next_value_of_STATE_VARIABLE_Acc_0_4 = mercury__cord__STATE_VARIABLE_Acc_19_19;
  ...
  MR_Integer * mercury__cord__HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__V_11_10;
        MR_Integer mercury__cord__next_value_of_HeadVar__3_3 = mercury__cord__V_15_13;
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word mercury__cord__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__Node_3, (MR_Integer) 0)));

          /* direct tailcall eliminated */
          {
            MR_Word mercury__cord__next_value_of_Node_3 = mercury__cord__B_10;

            mercury__cord__Node_3 = mercury__cord__next_value_of_Node_3;
          }
          continue;
        }
        break;
      ...
      case (MR_Integer) 1:
        {
          ...
          *mercury__cord__Head_4 = (MR_hl_field(MR_mktag(1), mercury__cord__Node_3, (MR_Integer) 0));
          mercury__cord__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__Node_3, (MR_Integer) 1)));
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word mercury__cord__A_6 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__Node_3, (MR_Integer) 0)));
          MR_Word mercury__cord__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__cord__Node_3, (MR_Integer) 1)));

          /* direct tailcall eliminated */
          {
            MR_Word mercury__cord__next_value_of_Node_3 = mercury__cord__A_6;
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          MR_Word mercury__cord__Var_16;

          {
            mercury__cord__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 0) = mercury__cord__AllButLastHead_10;
            MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 1) = ((MR_Box) (mercury__cord__AllButLastTail_11));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *mercury__cord__AllButLast_5 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_16));
          }
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        {
          mercury__cord__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mercury__cord__Var_15, 0) = ((MR_Box) (mercury__cord__A_12));
        }
        *mercury__cord__AllButLast_5 = mercury__cord__f_43_43_2_f_0(mercury__cord__TypeInfo_for_T_17, mercury__cord__Var_15, mercury__cord__B_14);
      }
      break;
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        *mercury__cord__Head_5 = (MR_hl_field(MR_mktag(1), mercury__cord__Node_4, (MR_Integer) 0));
        ...
        else
        {
          ...
          {
            mercury__cord__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 0) = mercury__cord__TH_9;
            MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 1) = ((MR_Box) (mercury__cord__TT_10));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          {
            mercury__cord__Var_15 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), mercury__cord__Var_15, 0) = ((MR_Box) (mercury__cord__A_14));
            MR_hl_field(MR_mktag(2), mercury__cord__Var_15, 1) = ((MR_Box) (mercury__cord__B_12));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *mercury__cord__Tail_6 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_15));
          }
        }
      }
      break;
...
{
  {
    ...
    mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_108_95_95_104_111_55_95_95_91_49_44_32_50_44_32_51_44_32_52_44_32_53_44_32_54_44_32_55_44_32_57_44_32_49_48_44_32_49_49_93_95_48_4_p_in__list_0(mercury__cord__TypeInfo_for_T_8, mercury__cord__RevCords_5, mercury__cord__Var_7, &mercury__cord__List_4);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word mercury__cord__Var_52;
        MR_Word mercury__cord__Var_53 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

        {
          mercury__cord__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mercury__cord__Var_52, 0) = ((MR_Box) (mercury__cord__N_50));
          MR_hl_field(MR_mktag(1), mercury__cord__Var_52, 1) = ((MR_Box) (mercury__cord__Var_53));
        }
        mercury__cord__V_15_13 = mercury__cord__to_list_2_2_f_0(mercury__cord__Var_27, mercury__cord__Var_52, mercury__cord__HeadVar__3_3);
      }
      /* direct tailcall eliminated */
      {
        MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__V_11_10;
        MR_Word mercury__cord__next_value_of_HeadVar__3_3 = mercury__cord__V_15_13;
  ...
  MR_Word * mercury__cord__STATE_VARIABLE_C_7)
{
  if ((mercury__cord__STATE_VARIABLE_C_0_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
    ...
    {
      mercury__cord__Var_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mercury__cord__Var_16, 0) = mercury__cord__X_4;
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    {
      mercury__cord__Var_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mercury__cord__Var_15, 0) = mercury__cord__X_4;
    }
    {
      mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), mercury__cord__Var_14, 0) = ((MR_Box) (mercury__cord__N_13));
      MR_hl_field(MR_mktag(2), mercury__cord__Var_14, 1) = ((MR_Box) (mercury__cord__Var_15));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      *mercury__cord__STATE_VARIABLE_C_7 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mercury__cord__Var_14));
    }
  }
}
...
{
  {
    ...
    {
      MR_Word mercury__cord__Var_10;

      {
        mercury__cord__Var_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mercury__cord__Var_10, 0) = mercury__cord__X_5;
      }
      {
        mercury__cord__CX_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__CX_6, 0) = ((MR_Box) (mercury__cord__Var_10));
      }
    }
    else
    {
      MR_Word mercury__cord__N_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__C_4, (MR_Integer) 0)));
      MR_Word mercury__cord__Var_8;
      MR_Word mercury__cord__Var_9;

      {
        mercury__cord__Var_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mercury__cord__Var_9, 0) = mercury__cord__X_5;
      }
      {
        mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), mercury__cord__Var_8, 0) = ((MR_Box) (mercury__cord__N_7));
        MR_hl_field(MR_mktag(2), mercury__cord__Var_8, 1) = ((MR_Box) (mercury__cord__Var_9));
      }
      {
        mercury__cord__CX_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__CX_6, 0) = ((MR_Box) (mercury__cord__Var_8));
      }
    }
  ...
  MR_Word * mercury__cord__STATE_VARIABLE_C_7)
{
  ...
  else
  {
    ...
    {
      mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), mercury__cord__Var_14, 0) = ((MR_Box) (mercury__cord__Var_15));
      MR_hl_field(MR_mktag(2), mercury__cord__Var_14, 1) = ((MR_Box) (mercury__cord__N_13));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((mercury__cord__C_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        mercury__cord__Var_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mercury__cord__Var_10, 0) = mercury__cord__X_4;
      }
      {
        mercury__cord__XC_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__XC_6, 0) = ((MR_Box) (mercury__cord__Var_10));
      }
    }
    else
    {
      ...
      {
        mercury__cord__Var_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mercury__cord__Var_9, 0) = mercury__cord__X_4;
      }
      {
        mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), mercury__cord__Var_8, 0) = ((MR_Box) (mercury__cord__Var_9));
        MR_hl_field(MR_mktag(2), mercury__cord__Var_8, 1) = ((MR_Box) (mercury__cord__N_7));
      }
      {
        mercury__cord__XC_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__XC_6, 0) = ((MR_Box) (mercury__cord__Var_8));
      }
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word mercury__cord__Var_6;

          mercury__cord__Var_6 = mercury__cord__cord_list_to_cord_1_f_0(mercury__cord__TypeInfo_for_T_11, mercury__cord__L_5);
          mercury__cord__HeadVar__2_2 = mercury__cord__f_43_43_2_f_0(mercury__cord__TypeInfo_for_T_11, mercury__cord__C_4, mercury__cord__Var_6);
        }
        break;
      case (MR_Integer) 2:
        {
...
{
  {
    ...
    mercury__cord__RevCords_5 = (MR_Word) mercury__cord__conv0_RevCords_5;
    mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_108_95_95_104_111_54_95_95_91_49_44_32_50_44_32_51_44_32_52_44_32_53_44_32_54_44_32_55_44_32_57_44_32_49_48_44_32_49_49_93_95_48_4_p_in__list_0(mercury__cord__TypeInfo_for_T_8, mercury__cord__RevCords_5, mercury__cord__Var_7, &mercury__cord__Cord_4);
  ...
  MR_Word * mercury__cord__HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__cord__V_15_13 = mercury__cord__f_43_43_2_f_0(mercury__cord__Var_27, mercury__cord__V_10_9, mercury__cord__HeadVar__3_3);
      /* direct tailcall eliminated */
      {
        MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__V_11_10;
        MR_Word mercury__cord__next_value_of_HeadVar__3_3 = mercury__cord__V_15_13;
...
{
  {
    ...
    {
      MR_Word mercury__cord__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__cord__A_4, (MR_Integer) 0)));
      ...
      else
      {
        ...
        {
          mercury__cord__Var_10 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), mercury__cord__Var_10, 0) = ((MR_Box) (mercury__cord__Var_12));
          MR_hl_field(MR_mktag(2), mercury__cord__Var_10, 1) = ((MR_Box) (mercury__cord__BN_9));
        }
        {
          mercury__cord__C_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mercury__cord__C_6, 0) = ((MR_Box) (mercury__cord__Var_10));
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_4;
      MR_Word mercury__cord__Var_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word mercury__cord__Var_6;

      {
        mercury__cord__Var_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_4, 0) = ((MR_Box) (mercury__cord__N_3));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_4, 1) = ((MR_Box) (mercury__cord__Var_5));
      }
      mercury__cord__Var_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__HeadVar__2_2 = mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_116_111_95_114_101_118_95_108_105_115_116_95_50_95_95_91_49_93_95_48_2_f_0(mercury__cord__Var_4, mercury__cord__Var_6);
    }
    return mercury__cord__HeadVar__2_2;
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__cord__Var_6;
      MR_Word mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word mercury__cord__Var_8;

      {
        mercury__cord__Var_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_6, 0) = ((MR_Box) (mercury__cord__N_5));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_6, 1) = ((MR_Box) (mercury__cord__Var_7));
      }
      mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__HeadVar__2_2 = mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_116_111_95_114_101_118_95_108_105_115_116_95_50_95_95_91_49_93_95_48_2_f_0(mercury__cord__Var_6, mercury__cord__Var_8);
    }
    return mercury__cord__HeadVar__2_2;
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                mercury__cord__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 0) = mercury__cord__X_9;
                MR_hl_field(MR_mktag(1), mercury__cord__Var_18, 1) = ((MR_Box) (mercury__cord__HeadVar__2_2));
              }
              /* direct tailcall eliminated */
              {
                MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__Ns_6;
                MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Var_18;
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                mercury__cord__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 0) = mercury__cord__H_10;
                MR_hl_field(MR_mktag(1), mercury__cord__Var_17, 1) = ((MR_Box) (mercury__cord__HeadVar__2_2));
              }
              mercury__cord__Var_16 = mercury__cord__f_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_108_105_115_116_95_114_101_118_101_114_115_101_95_50_95_95_91_49_93_95_48_2_f_0(mercury__cord__T_11, mercury__cord__Var_17);
              /* direct tailcall eliminated */
              {
                MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__Ns_6;
                MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Var_16;
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                mercury__cord__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_15, 0) = ((MR_Box) (mercury__cord__B_13));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_15, 1) = ((MR_Box) (mercury__cord__Ns_6));
              }
              {
                mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_14, 0) = ((MR_Box) (mercury__cord__A_12));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_14, 1) = ((MR_Box) (mercury__cord__Var_15));
              }
              /* direct tailcall eliminated */
              {
                MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__Var_14;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mercury__cord__Var_8, 0) = mercury__cord__X_5;
          MR_hl_field(MR_mktag(1), mercury__cord__Var_8, 1) = ((MR_Box) (mercury__cord__HeadVar__2_2));
        }
        /* direct tailcall eliminated */
        {
          MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__Xs_6;
          MR_Word mercury__cord__next_value_of_HeadVar__2_2 = mercury__cord__Var_8;
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__Var_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__HeadVar__2_2 = mercury__cord__to_list_2_2_f_0(mercury__cord__TypeInfo_for_T_7, mercury__cord__Var_4, mercury__cord__Var_6);
    }
    return mercury__cord__HeadVar__2_2;
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__cord__Var_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__cord__HeadVar__2_2 = mercury__cord__to_list_2_2_f_0(mercury__cord__TypeInfo_for_T_4, mercury__cord__Var_6, mercury__cord__Var_8);
    }
    return mercury__cord__HeadVar__2_2;
  }
}
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__list__append_3_p_1(mercury__cord__TypeInfo_for_T_19, mercury__cord__T_11, mercury__cord__HeadVar__2_2, &mercury__cord__Var_17);
              {
                mercury__cord__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 0) = mercury__cord__H_10;
                MR_hl_field(MR_mktag(1), mercury__cord__Var_16, 1) = ((MR_Box) (mercury__cord__Var_17));
              }
              /* direct tailcall eliminated */
              {
                MR_Word mercury__cord__next_value_of_HeadVar__1_1 = mercury__cord__Ns_6;
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                mercury__cord__Var_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_14, 0) = ((MR_Box) (mercury__cord__B_13));
                MR_hl_field(MR_mktag(1), mercury__cord__Var_14, 1) = ((MR_Box) (mercury__cord__Var_15));
              }
              /* direct tailcall eliminated */
              {
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__cord__Var_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__Var_7, 0) = mercury__cord__H_5;
        MR_hl_field(MR_mktag(1), mercury__cord__Var_7, 1) = ((MR_Box) (mercury__cord__T_6));
      }
      {
        mercury__cord__C_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mercury__cord__C_4, 0) = ((MR_Box) (mercury__cord__Var_7));
      }
    }
...
{
  {
    ...
    {
      mercury__cord__Var_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mercury__cord__Var_4, 0) = mercury__cord__X_3;
    }
    {
      mercury__cord__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mercury__cord__HeadVar__2_2, 0) = ((MR_Box) (mercury__cord__Var_4));
    }
    return mercury__cord__HeadVar__2_2;
  }
}
