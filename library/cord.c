  ...
  MR_Word * STATE_VARIABLE_C_7)
{
  if ((STATE_VARIABLE_C_0_6 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_13, 0) = X_4;
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  {
    MR_Word N_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_C_0_6, (MR_Integer) 0))));
    MR_Word Var_14;
    MR_Word Var_15;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Var_14, 0) = ((MR_Box) (N_12));
  ...
  MR_Word * STATE_VARIABLE_C_7)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Var_14, 1) = ((MR_Box) (N_12));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
