      ...
      case (MR_Integer) 2:
        {
          ...
          Var_15 = mercury__cord__map_func_node_2_f_0(TypeInfo_for_T_17, TypeInfo_for_U_18, F_4, A_10);
          {
            PNode_6 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        AddrSCCcallarg_16_19 = (MR_Word *) (&(MR_hl_field(2, PNode_6, 1)));
        mercury__cord__LCMC__func__map_func_node__1_3_p_0(TypeInfo_for_T_17, TypeInfo_for_U_18, F_4, B_11, AddrSCCcallarg_16_19);
      }
      break;
  }
  return PNode_6;
  ...
  MR_Word * STATE_VARIABLE_C_12)
{
  ...
  else
  {
    ...
    {
      LN_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, LN_8, 0) = H_6;
      MR_hl_field(1, LN_8, 1) = ((MR_Box) (T_7));
    }
    ...
    else
    {
      ...
      {
        CN_10 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, CN_10, 0) = ((MR_Box) (CN0_9));
        MR_hl_field(2, CN_10, 1) = ((MR_Box) (LN_8));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_C_12)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        CN_10 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, CN_10, 0) = ((MR_Box) (LN_8));
        MR_hl_field(2, CN_10, 1) = ((MR_Box) (CN0_9));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
