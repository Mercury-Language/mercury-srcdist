  ...
  MR_Word Cords_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 0) = ((MR_Box) (&mercury__cord__cord__type_ctor_info_cord_1));
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 1) = ((MR_Box) (TypeInfo_for_T_6));
  }
  mercury__list__reverse_2_p_0(TypeInfo__8_8, (MR_Word) (Cords_3), &conv0_RevCords_5);
  ...
  MR_Word * STATE_VARIABLE_C_7)
{
  ...
  {
    MR_Word N_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_C_0_6, (MR_Integer) 0))));
    MR_Word Var_11;
    MR_Word Var_12;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Var_11, 0) = ((MR_Box) (N_10));
  ...
  MR_Word * STATE_VARIABLE_C_7)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Var_11, 1) = ((MR_Box) (N_10));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          TypeInfo__8_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeInfo__8_14, 0) = ((MR_Box) (&mercury__cord__cord__type_ctor_info_cord_1));
          MR_hl_field(MR_mktag(0), TypeInfo__8_14, 1) = ((MR_Box) (TypeInfo_for_T_11));
        }
        mercury__list__reverse_2_p_0(TypeInfo__8_14, (MR_Word) (L_5), &conv0_RevCords_12);
