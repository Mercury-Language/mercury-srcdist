  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word N_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_9, (MR_Integer) 0))));
        MR_Word Var_33;

        {
          Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (N_31));
          MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        Var_13 = mercury__cord__to_list_2_2_f_0(Var_27, Var_33, HeadVar__3_3);
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = Var_10;
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Var_6;
        MR_Word RevCords_12;
        MR_Word conv0_RevCords_12;

        {
          TypeInfo_8_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeInfo_8_14, 0) = ((MR_Box) (&mercury__cord__cord__type_ctor_info_cord_1));
          MR_hl_field(MR_mktag(0), TypeInfo_8_14, 1) = ((MR_Box) (TypeInfo_for_T_11));
        }
        mercury__list__reverse_2_p_0(TypeInfo_8_14, (MR_Word) (L_5), &conv0_RevCords_12);
        RevCords_12 = (MR_Word) (conv0_RevCords_12);
        Var_6 = mercury__cord__rev_cord_list_to_cord_1_f_0(TypeInfo_for_T_11, RevCords_12);
