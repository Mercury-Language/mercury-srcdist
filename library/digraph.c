...
static void MR_CALL 
mercury__digraph__IntroducedFrom__pred__add_cartesian_product__1089__1_5_p_0(
            ...
            if (mercury__digraph__succeeded)
              {
                ...
                if (mercury__digraph__succeeded)
                  {
                    mercury__digraph__IntroducedFrom__pred__add_cartesian_product__1089__1_5_p_0(mercury__digraph__V_38_38, mercury__digraph__V_39_39, mercury__digraph__V_14_15, mercury__digraph__V_19_13, mercury__digraph__V_20_14);
                  }
                else
                  {
                    {
