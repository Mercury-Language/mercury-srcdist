  ...
  MR_Word * Acc_6)
{
  ...
  else
  {
    ...
    func_1 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&mercury__getopt_scalar_common_1[2]), (MR_Integer) 0)), (MR_Integer) 12))));
  ...
  void * cont_env_ptr)
{
  ...
  (env).mercury__getopt__init_option_table_2_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    mercury__getopt__IntroducedFrom__pred__init_option_table__926__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), &(env).mercury__getopt__init_option_table_2_p_0_2_env_0__conv0_LambdaHeadVar__1_10, mercury__getopt__init_option_table_2_p_0_1, &env);
  }
}
