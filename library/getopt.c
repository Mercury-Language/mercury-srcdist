            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__map__set_4_p_0(TypeInfo_for_OptionType_99, (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), Flag_109, ((MR_Box) (MR_mkword(3, &mercury__getopt_scalar_common_1[6]))), STATE_VARIABLE_OptionTable_0_4, &STATE_VARIABLE_OptionTable_48_110);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              mercury__getopt__record_negated_option_6_p_0(TypeInfo_for_OptionType_110, OptionTable_3, Flag_31, OptName_32, &NegMaybeError_33, STATE_VARIABLE_OptionValues_0_9, &STATE_VARIABLE_OptionValues_58_58);
