  ...
  MR_Word * STATE_VARIABLE_NonOptionArgs_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__getopt__recognize_option_6_p_0(TypeInfo_for_OptionType_65, ShortOptionPred_1, LongOptionPred_2, OptionTable_3, HeadVar__4_4, &Args1_38, &Result_39);
  ...
  MR_Word * STATE_VARIABLE_NonOptionArgs_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__getopt__recognize_option_6_p_0(TypeInfo_for_OptionType_57, ShortOptionPred_1, LongOptionPred_2, OptionTable_3, HeadVar__4_4, &Args1_34, &Result_35);
...
#undef MR_PROC_LABEL
	Var_94  = Length;
        ...
        else
        {
          ...
          mercury__getopt__record_unnegated_short_options_9_p_0(TypeInfo_for_OptionType_89, HeadVar__1_1, HeadVar__3_3, ShortOptionsList_30, Args0_14, HeadVar__5_5, &MaybeShortArg_32, &MaybeError_33, (MR_Word) ((MR_Unsigned) 0U), &OVsCord_34);
