...
{
  {
    ...
    mercury__tree234__assoc_list_to_tree234_acc_3_p_0(TypeInfo_for_OptionType_12, (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionDefaultsList_8, (MR_Word) ((MR_Integer) 0), OptionTable_4);
  }
}
