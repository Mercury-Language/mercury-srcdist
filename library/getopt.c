    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__getopt__skip_to_next_word_start__ho18_4_p_in__string_0(Contents_21, (MR_Integer) 0, &Var_58);
        mercury__getopt__words_loop__ho17_4_p_in__string_0(Contents_21, Var_58, &Words_22);
