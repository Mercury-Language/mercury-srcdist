...
MR_decl_label7(getopt__process_special_8_0, 55,21,23,19,54,11,9)
...
MR_BEGIN_MODULE(getopt_module2)
	...
	MR_init_label7(getopt__process_special_8_0,55,21,23,19,54,11,9)
MR_BEGIN_CODE
...
MR_def_static(getopt__process_special_8_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(getopt__process_special_8_0_i54);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(getopt__process_special_8_0_i55);
	}
...
MR_def_label(getopt__process_special_8_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__getopt__process_special_8_0_i21);
MR_def_label(getopt__process_special_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(getopt__process_special_8_0_i19);
	}
	MR_sv(1) = MR_r2;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_r3;
	...
	MR_np_call_localret_ent(list__merge_and_remove_dups_3_0,
		getopt__process_special_8_0_i23);
...
MR_def_label(getopt__process_special_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
...
MR_def_label(getopt__process_special_8_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(getopt__process_special_8_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__getopt__process_special_8_0_i11);
