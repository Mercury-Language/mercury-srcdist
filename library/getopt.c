          ...
          case (MR_Integer) 1:
            {
              ...
              {
                ArgY1_10 = ((MR_Word) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
                TypeInfo_20_20 = (MR_Word) (&mercury__getopt_scalar_common_1[4]);
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_21_21 = (MR_Word) (&mercury__getopt_scalar_common_1[3]);
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_19_19 = (MR_Word) (&mercury__getopt_scalar_common_1[2]);
