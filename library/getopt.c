...
MR_decl_label10(getopt__process_negated_option_7_0, 3,7,6,10,16,15,19,24,30,29)
MR_decl_label10(getopt__process_negated_option_7_0, 37,34,40,42,39,45,47,44,50,52)
MR_decl_label4(getopt__process_negated_option_7_0, 49,56,2,61)
...
MR_BEGIN_MODULE(getopt_module5)
	...
	MR_init_label10(getopt__process_negated_option_7_0,3,7,6,10,16,15,19,24,30,29)
	MR_init_label10(getopt__process_negated_option_7_0,37,34,40,42,39,45,47,44,50,52)
	MR_init_label4(getopt__process_negated_option_7_0,49,56,2,61)
MR_BEGIN_CODE
...
MR_def_label(getopt__process_negated_option_7_0,6)
	...
	MR_np_call_localret_ent(string__append_list_2_0,
		getopt__process_negated_option_7_0_i56);
MR_def_label(getopt__process_negated_option_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,4)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i15);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
	MR_np_call_localret_ent(set__insert_3_0,
		getopt__process_negated_option_7_0_i16);
...
MR_def_label(getopt__process_negated_option_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i19);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(5);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,4,1);
...
MR_def_label(getopt__process_negated_option_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,3)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i24);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(5);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,4,1);
...
MR_def_label(getopt__process_negated_option_7_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i29);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(getopt__process_negated_option_7_0,30)
	...
	MR_r5 = MR_sv(3);
	MR_np_call_localret_ent(map__set_4_0,
		getopt__process_negated_option_7_0_i52);
...
MR_def_label(getopt__process_negated_option_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i44);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(getopt__process_negated_option_7_0,45)
	...
	MR_r5 = MR_sv(3);
	MR_np_call_localret_ent(map__set_4_0,
		getopt__process_negated_option_7_0_i47);
...
MR_def_label(getopt__process_negated_option_7_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(getopt__process_negated_option_7_0_i49);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(getopt__process_negated_option_7_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(5);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,4,1);
	...
	MR_np_call_localret_ent(string__append_list_2_0,
		getopt__process_negated_option_7_0_i56);
MR_def_label(getopt__process_negated_option_7_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_r1 = MR_r2;
...
MR_def_label(getopt__process_negated_option_7_0,2)
	...
	MR_tfield(1, MR_r1, 1) = MR_r2;
	MR_np_call_localret_ent(string__append_list_2_0,
		getopt__process_negated_option_7_0_i61);
MR_def_label(getopt__process_negated_option_7_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
void mercury__getopt__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__getopt);
