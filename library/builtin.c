...
static const MR_EnumFunctorDescPtr mercury__builtin__builtin__enum_ordinal_ordered_comparison_result_0[3];
...
const MR_TypeCtorInfo_Struct mercury__builtin__builtin__type_ctor_info_comparison_result_0 = {
  ...
  { mercury__builtin__builtin__enum_ordinal_ordered_comparison_result_0 },
  (MR_Integer) 3,
  UINT16_C(12),
...
#undef MR_PROC_LABEL
	TypeInfo_Out_1 = TypeInfo_for_ArgT;
	TypeInfo__18_18  = TypeInfo_for_ArgT;
...
#undef MR_PROC_LABEL
	TypeInfo_Out_1 = TypeInfo_for_ArgT;
	TypeInfo__19_19  = TypeInfo_for_ArgT;
	SubTermB_12  = (MR_Box) Arg;
}
      CastSubTermB_13 = SubTermB_12;
      mercury__builtin__compare_representation_3_p_0(TypeInfo__18_18, &SubResult_14, SubTermA_11, CastSubTermB_13);
      switch (SubResult_14) {
...
#undef MR_PROC_LABEL
	...
	SubTermB_12  = (MR_Box) Arg;
      ...
      CastSubTermB_13 = SubTermB_12;
      mercury__builtin__compare_3_p_0(TypeInfo__18_18, &SubResult_14, SubTermA_11, CastSubTermB_13);
      switch (SubResult_14) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
        case (MR_Integer) 2:
...
#undef MR_PROC_LABEL
	TypeInfo_Out_1 = TypeInfo_for_ArgT;
	TypeInfo__15_15  = TypeInfo_for_ArgT;
...
#undef MR_PROC_LABEL
	TypeInfo_Out_1 = TypeInfo_for_ArgT;
	TypeInfo__16_16  = TypeInfo_for_ArgT;
	SubTermB_10  = (MR_Box) Arg;
}
      CastSubTermB_11 = SubTermB_10;
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__15_15, SubTermA_9, CastSubTermB_11);
      if (succeeded)
      {
        Var_13 = (MR_Integer) 1;
