...
static /* final */ const MR_Box mercury__builtin_scalar_common_3[1][5];
...
#define MR_PROC_LABEL mercury__builtin__tuple_arg_3_p_0
	...
	TypeInfo_for_T = TypeInfo_for_T_5 ;
...
#undef MR_PROC_LABEL
	...
	*TypeInfo_for_ArgT_4  = TypeInfo_for_ArgT;
