...
#undef MR_PROC_LABEL
	 ...
	 mercury__builtin__SubTermB_12  = (MR_Box) Arg;
            ...
            switch (mercury__builtin__SubResult_14) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Integer mercury__builtin__Var_15 = (mercury__builtin__Index_9 + (MR_Integer) 1);

                  /* direct tailcall eliminated */
                  {
                    MR_Integer mercury__builtin__next_value_of_Index_9 = mercury__builtin__Var_15;

                    mercury__builtin__Index_9 = mercury__builtin__next_value_of_Index_9;
                  }
                  continue;
                }
                break;
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if (mercury__builtin__succeeded)
        ...
        else
          {
            ...
            MR_Integer mercury__builtin__Var_12;
            MR_Integer mercury__builtin__Var_13;
...
#undef MR_PROC_LABEL
	 ...
	 mercury__builtin__SubTermB_10  = (MR_Box) Arg;
            ...
            if (mercury__builtin__succeeded)
              {
                mercury__builtin__Var_13 = (MR_Integer) 1;
                mercury__builtin__Var_12 = (mercury__builtin__Index_7 + mercury__builtin__Var_13);
                /* direct tailcall eliminated */
                {
                  MR_Integer mercury__builtin__next_value_of_Index_7 = mercury__builtin__Var_12;

                  mercury__builtin__Index_7 = mercury__builtin__next_value_of_Index_7;
                }
                continue;
              }
          }
  ...
  MR_Box mercury__builtin__Y_4)
{
  {
    MR_bool mercury__builtin__succeeded;
    MR_Word mercury__builtin__Var_7;

    {
      mercury__builtin__compare_3_p_0(mercury__builtin__TypeInfo_for_T_6, &mercury__builtin__Var_7, mercury__builtin__X_3, mercury__builtin__Y_4);
    }
    mercury__builtin__succeeded = ((MR_Integer) 1 == mercury__builtin__Var_7);
...
{
  {
    ...
    mercury__builtin__succeeded = ((MR_Integer) 2 == mercury__builtin__Var_7);
    return mercury__builtin__succeeded;
  }
}
