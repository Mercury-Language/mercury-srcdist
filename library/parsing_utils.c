  ...
  MR_Integer * STATE_VARIABLE_PS_20)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      SkipWS0_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_10, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
	SkipWS_81  = SkipWS;
      ...
      succeeded = func_0(((MR_Box) (SkipWS_81)), ((MR_Box) (Src_10)), &conv2_Var_82, ((MR_Box) (STATE_VARIABLE_PS_11_77)), &conv1_STATE_VARIABLE_PS_35_59);
      if (succeeded)
      {
  ...
  MR_Integer * STATE_VARIABLE_PS_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      SkipWS0_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_8, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
	SkipWS_60  = SkipWS;
      ...
      func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_60, (MR_Integer) 1))));
      succeeded = func_0(((MR_Box) (SkipWS_60)), ((MR_Box) (Src_8)), &conv2_Var_61, ((MR_Box) (STATE_VARIABLE_PS_11_56)), &conv1_STATE_VARIABLE_PS_26_43);
      if (succeeded)
      {
  ...
  MR_Integer * STATE_VARIABLE_PS_22)
{
  ...
  MR_Word SkipWS_38;
  MR_Word SkipWS0_42;
  MR_Integer STATE_VARIABLE_PS_11_52;
  MR_Word SkipWS_56;
  MR_Word SkipWS0_60;
  MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *);
  MR_Box conv2_Var_39;
  ...
  if (succeeded)
  {
    SkipWS0_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_13, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
    ...
    func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_38, (MR_Integer) 1))));
    succeeded = func_0(((MR_Box) (SkipWS_38)), ((MR_Box) (Src_13)), &conv2_Var_39, ((MR_Box) (STATE_VARIABLE_PS_11_34)), &conv1_STATE_VARIABLE_PS_23_23);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = mercury__parsing_utils__match_string_4_p_0(R_11, Src_13, STATE_VARIABLE_PS_25_25, &STATE_VARIABLE_PS_11_52);
        if (succeeded)
        {
          SkipWS0_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_13, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__brackets_9_p_0
...
#undef MR_PROC_LABEL
	SkipWS_56  = SkipWS;
          ...
          func_5 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_56, (MR_Integer) 1))));
          succeeded = func_5(((MR_Box) (SkipWS_56)), ((MR_Box) (Src_13)), &conv7_Var_57, ((MR_Box) (STATE_VARIABLE_PS_11_52)), &conv6_STATE_VARIABLE_PS_22);
          if (succeeded)
          {
  ...
  MR_Integer * STATE_VARIABLE_PS_17)
{
  ...
  MR_Word SkipWS_31;
  MR_Word SkipWS0_35;
  MR_Integer STATE_VARIABLE_PS_11_45;
  MR_Word SkipWS_49;
  MR_Word SkipWS0_53;
  MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *);
  MR_Box conv2_Var_32;
  ...
  if (succeeded)
  {
    SkipWS0_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_11, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
    ...
    func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_31, (MR_Integer) 1))));
    succeeded = func_0(((MR_Box) (SkipWS_31)), ((MR_Box) (Src_11)), &conv2_Var_32, ((MR_Box) (STATE_VARIABLE_PS_11_27)), &conv1_STATE_VARIABLE_PS_18_18);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = mercury__parsing_utils__match_string_4_p_0(R_9, Src_11, STATE_VARIABLE_PS_19_19, &STATE_VARIABLE_PS_11_45);
        if (succeeded)
        {
          SkipWS0_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_11, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__brackets_7_p_0
...
#undef MR_PROC_LABEL
	SkipWS_49  = SkipWS;
          ...
          func_5 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_49, (MR_Integer) 1))));
          succeeded = func_5(((MR_Box) (SkipWS_49)), ((MR_Box) (Src_11)), &conv7_Var_50, ((MR_Box) (STATE_VARIABLE_PS_11_45)), &conv6_STATE_VARIABLE_PS_17);
          if (succeeded)
          {
  ...
  MR_Integer * STATE_VARIABLE_PS_10)
{
  ...
  if (succeeded)
  {
    Var_13 = (MR_Integer) 10;
    succeeded = mercury__string__base_string_to_int_3_p_0(Var_13, IntStr_8, Int_6);
  }
  return succeeded;
}
  ...
  MR_Integer * STATE_VARIABLE_PS_15)
{
  ...
  MR_Integer STATE_VARIABLE_PS_25_25;
  MR_Char C_59;
  MR_Integer STATE_VARIABLE_PS_13_61;
  MR_Word SkipWS_78;
  MR_Word SkipWS0_82;
  ...
  MR_Char Var_32;
  MR_Char C_67;
  MR_Integer STATE_VARIABLE_PS_13_69;
  MR_Integer Var_12;
  MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *);
  MR_Box conv2_Var_79;
  MR_Box conv1_STATE_VARIABLE_PS_15;
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_59, STATE_VARIABLE_PS_18_18, &STATE_VARIABLE_PS_13_61);
    if (succeeded)
    {
      succeeded = mercury__char__is_base_digit_2_p_0(Var_20, C_59);
      if (succeeded)
      {
        succeeded = mercury__parsing_utils__digits_2_5_p_0(Var_20, Src_5, STATE_VARIABLE_PS_13_61, &STATE_VARIABLE_PS_25_25);
        if (succeeded)
        {
          Var_22 = (MR_Char) 46;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_67, STATE_VARIABLE_PS_23_23, &STATE_VARIABLE_PS_13_69);
              if (succeeded)
              {
                succeeded = mercury__char__is_base_digit_2_p_0(Var_24, C_67);
                if (succeeded)
                  succeeded = mercury__parsing_utils__digits_2_5_p_0(Var_24, Src_5, STATE_VARIABLE_PS_13_69, &Var_12);
              }
            }
          }
          succeeded = !(succeeded);
          if (succeeded)
          {
            SkipWS0_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_5, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__int_literal_as_string_4_p_0
...
#undef MR_PROC_LABEL
	SkipWS_78  = SkipWS;
            ...
            func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_78, (MR_Integer) 1))));
            succeeded = func_0(((MR_Box) (SkipWS_78)), ((MR_Box) (Src_5)), &conv2_Var_79, ((MR_Box) (STATE_VARIABLE_PS_25_25)), &conv1_STATE_VARIABLE_PS_15);
            if (succeeded)
            {
              *STATE_VARIABLE_PS_15 = ((MR_Integer) (conv1_STATE_VARIABLE_PS_15));
              succeeded = MR_TRUE;
  ...
  MR_Integer * STATE_VARIABLE_PS_15)
{
  ...
  MR_Char C_53;
  MR_Integer STATE_VARIABLE_PS_13_55;
  MR_Word SkipWS_84;
  MR_Word SkipWS0_88;
  MR_Integer STATE_VARIABLE_PS_18_18;
  MR_Char Var_33;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            Var_24 = (MR_Integer) 10;
            succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_53, STATE_VARIABLE_PS_23_23, &STATE_VARIABLE_PS_13_55);
            if (succeeded)
            {
              succeeded = mercury__char__is_base_digit_2_p_0(Var_24, C_53);
              if (succeeded)
              {
                succeeded = mercury__parsing_utils__digits_2_5_p_0(Var_24, Src_5, STATE_VARIABLE_PS_13_55, &STATE_VARIABLE_PS_25_25);
                if (succeeded)
                {
                  Var_26 = (MR_String) "eE";
...
succeeded  = SUCCESS_INDICATOR;
                  ...
                  if (succeeded)
                  {
                    MR_Integer STATE_VARIABLE_PS_28_28;
                    MR_Char C_73;
                    MR_Integer STATE_VARIABLE_PS_13_75;
                    MR_Integer STATE_VARIABLE_PS_9_67;
                    MR_Char Char_66;

                    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &Char_66, STATE_VARIABLE_PS_27_27, &STATE_VARIABLE_PS_9_67);
                    if (succeeded)
                      switch (Char_66) {
                        default:
                          succeeded = MR_FALSE;
                    ...
                    if (succeeded)
                      STATE_VARIABLE_PS_28_28 = STATE_VARIABLE_PS_9_67;
                    else
                      STATE_VARIABLE_PS_28_28 = STATE_VARIABLE_PS_27_27;
                    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_73, STATE_VARIABLE_PS_28_28, &STATE_VARIABLE_PS_13_75);
                    if (succeeded)
                    {
                      succeeded = mercury__char__is_base_digit_2_p_0((MR_Integer) 10, C_73);
                      if (succeeded)
                        succeeded = mercury__parsing_utils__digits_2_5_p_0((MR_Integer) 10, Src_5, STATE_VARIABLE_PS_13_75, &STATE_VARIABLE_PS_31_31);
                    }
                  }
                  else
                  {
                  ...
                  if (succeeded)
                  {
                    SkipWS0_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_5, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__float_literal_as_string_4_p_0
...
#undef MR_PROC_LABEL
	SkipWS_84  = SkipWS;
                    ...
                    func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_84, (MR_Integer) 1))));
                    succeeded = func_0(((MR_Box) (SkipWS_84)), ((MR_Box) (Src_5)), &conv2_Var_85, ((MR_Box) (STATE_VARIABLE_PS_31_31)), &conv1_STATE_VARIABLE_PS_15);
                    if (succeeded)
                    {
                      *STATE_VARIABLE_PS_15 = ((MR_Integer) (conv1_STATE_VARIABLE_PS_15));
                      succeeded = MR_TRUE;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        SkipWS0_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_9, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__identifier_6_p_0
...
#undef MR_PROC_LABEL
	SkipWS_41  = SkipWS;
        ...
        succeeded = func_0(((MR_Box) (SkipWS_41)), ((MR_Box) (Src_9)), &conv2_Var_42, ((MR_Box) (STATE_VARIABLE_PS_21_21)), &conv1_STATE_VARIABLE_PS_17);
        if (succeeded)
        {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      SkipWS0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_9, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__ikeyword_6_p_0
...
#undef MR_PROC_LABEL
	SkipWS_25  = SkipWS;
      ...
      func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_25, (MR_Integer) 1))));
      succeeded = func_0(((MR_Box) (SkipWS_25)), ((MR_Box) (Src_9)), &conv2_Var_26, ((MR_Box) (STATE_VARIABLE_PS_15_15)), &conv1_STATE_VARIABLE_PS_14);
      if (succeeded)
      {
  ...
  MR_Integer * STATE_VARIABLE_PS_10)
{
  ...
  if (succeeded)
  {
    SkipWS0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_7, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
    ...
    func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_15, (MR_Integer) 1))));
    succeeded = func_0(((MR_Box) (SkipWS_15)), ((MR_Box) (Src_7)), &conv2_Var_16, ((MR_Box) (STATE_VARIABLE_PS_11_11)), &conv1_STATE_VARIABLE_PS_10);
    if (succeeded)
    {
