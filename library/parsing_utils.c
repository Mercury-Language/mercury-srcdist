...
{
  {
    ...
    if (succeeded)
    {
      Var_14 = (MR_Integer) 10;
      succeeded = mercury__string__base_string_to_int_3_p_0(Var_14, IntStr_8, Int_6);
    }
    return succeeded;
  }
}
...
#undef MR_PROC_LABEL
	 CodeUnit2_12  = Code;
      ...
      succeeded = mercury__char__lower_upper_2_p_0(Chr1_13, &Var_24);
      if (succeeded)
        Var_16 = Var_24;
      else
        Var_16 = Chr1_13;
      succeeded = mercury__char__lower_upper_2_p_0(Chr2_14, &Var_29);
      if (succeeded)
        Var_19 = Var_29;
      else
        Var_19 = Chr2_14;
