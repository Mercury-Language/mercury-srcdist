...
MR_decl_label10(parsing_utils__parse_3_0, 4,5,10,8,13,14,15,17,18,19)
...
MR_BEGIN_MODULE(parsing_utils_module6)
	...
	MR_init_label10(parsing_utils__parse_3_0,4,5,10,8,13,14,15,17,18,19)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(parsing_utils__offset_to_line_number_and_position_2_6_0,
		parsing_utils__parse_3_0_i19);
MR_def_label(parsing_utils__parse_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 3);
