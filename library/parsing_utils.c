...
#define	MR_PROC_LABEL	mercury__parsing_utils__unsafe_skip_ws_pred_cast_2_0
	SkipWS0 = MR_r1;
{
#line 422 "parsing_utils.m"

    SkipWS = SkipWS0;
;}
#line 1733 "parsing_utils.c"
	MR_r1 = SkipWS;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
