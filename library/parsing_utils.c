  ...
  MR_Integer * STATE_VARIABLE_PS_20)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      SkipWS0_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_10, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
	SkipWS_33  = SkipWS;
      ...
      func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_33, (MR_Integer) 1))));
  ...
  MR_Integer * STATE_VARIABLE_PS_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      SkipWS0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_8, (MR_Integer) 2))));
{
  ...
  MR_Integer * STATE_VARIABLE_PS_22)
{
  ...
  if (succeeded)
  {
    SkipWS0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_13, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          SkipWS0_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_13, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__brackets_9_p_0
...
#undef MR_PROC_LABEL
	SkipWS_37  = SkipWS;
          ...
          func_5 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_37, (MR_Integer) 1))));
  ...
  MR_Integer * STATE_VARIABLE_PS_17)
{
  ...
  if (succeeded)
  {
    SkipWS0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_11, (MR_Integer) 2))));
{
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          SkipWS0_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_11, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__brackets_7_p_0
...
#undef MR_PROC_LABEL
	SkipWS_30  = SkipWS;
          ...
          func_5 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_30, (MR_Integer) 1))));
...
succeeded  = SUCCESS_INDICATOR;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            SkipWS0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_7, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__string_literal_5_p_0
...
#undef MR_PROC_LABEL
	SkipWS_28  = SkipWS;
            ...
            func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), SkipWS_28, (MR_Integer) 1))));
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_35, STATE_VARIABLE_PS_18_18, &STATE_VARIABLE_PS_13_37);
    if (succeeded)
    {
      succeeded = mercury__char__is_base_digit_2_p_0(Var_20, C_35);
      if (succeeded)
      {
        succeeded = mercury__parsing_utils__digits_2_5_p_0(Var_20, Src_5, STATE_VARIABLE_PS_13_37, &STATE_VARIABLE_PS_25_25);
        if (succeeded)
        {
          Var_22 = (MR_Char) 46;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  succeeded = mercury__parsing_utils__digits_2_5_p_0(Var_24, Src_5, STATE_VARIABLE_PS_13_40, &Var_12);
              }
            }
          }
          succeeded = !(succeeded);
          if (succeeded)
          {
            SkipWS0_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_5, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__int_literal_as_string_4_p_0
...
#undef MR_PROC_LABEL
	SkipWS_41  = SkipWS;
            ...
            succeeded = func_0(((MR_Box) (SkipWS_41)), ((MR_Box) (Src_5)), &conv2_Var_42, ((MR_Box) (STATE_VARIABLE_PS_25_25)), &conv1_STATE_VARIABLE_PS_15);
            if (succeeded)
            {
              *STATE_VARIABLE_PS_15 = ((MR_Integer) (conv1_STATE_VARIABLE_PS_15));
              succeeded = MR_TRUE;
...
succeeded  = SUCCESS_INDICATOR;
                  ...
                  if (succeeded)
                  {
                    ...
                    MR_Integer STATE_VARIABLE_PS_9_41;
                    MR_Char Char_40;

                    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &Char_40, STATE_VARIABLE_PS_27_27, &STATE_VARIABLE_PS_9_41);
                    if (succeeded)
                      switch (Char_40) {
                        default:
                          succeeded = MR_FALSE;
                    ...
                    if (succeeded)
                      STATE_VARIABLE_PS_28_28 = STATE_VARIABLE_PS_9_41;
                    else
                      STATE_VARIABLE_PS_28_28 = STATE_VARIABLE_PS_27_27;
                    succeeded = mercury__parsing_utils__next_char_4_p_0(Src_5, &C_42, STATE_VARIABLE_PS_28_28, &STATE_VARIABLE_PS_13_44);
                    if (succeeded)
                    {
                      succeeded = mercury__char__is_base_digit_2_p_0((MR_Integer) 10, C_42);
                      if (succeeded)
                        succeeded = mercury__parsing_utils__digits_2_5_p_0((MR_Integer) 10, Src_5, STATE_VARIABLE_PS_13_44, &STATE_VARIABLE_PS_31_31);
                    }
                  }
                  else
                  {
                  ...
                  if (succeeded)
                  {
                    SkipWS0_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_5, (MR_Integer) 2))));
{
#define MR_PROC_LABEL mercury__parsing_utils__float_literal_as_string_4_p_0
...
#undef MR_PROC_LABEL
	SkipWS_45  = SkipWS;
                    ...
                    succeeded = func_0(((MR_Box) (SkipWS_45)), ((MR_Box) (Src_5)), &conv2_Var_46, ((MR_Box) (STATE_VARIABLE_PS_31_31)), &conv1_STATE_VARIABLE_PS_15);
                    if (succeeded)
                    {
                      *STATE_VARIABLE_PS_15 = ((MR_Integer) (conv1_STATE_VARIABLE_PS_15));
                      succeeded = MR_TRUE;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MutVar_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Src_5, (MR_Integer) 3))));
