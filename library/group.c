...
MR_decl_label4(group__to_set_2_0, 3,4,5,7)
...
MR_BEGIN_MODULE(group_module7)
	...
	MR_init_label4(group__to_set_2_0,3,4,5,7)
MR_BEGIN_CODE
...
MR_def_label(group__to_set_2_0,4)
	...
	MR_np_call_localret_ent(list__merge_sort_2_3_0,
		group__to_set_2_0_i5);
MR_def_label(group__to_set_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(group__to_set_2_0_i7);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(3);
MR_def_label(group__to_set_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
