...
MR_decl_label3(__Unify___group__group_1_0, 4,8,1)
MR_decl_label7(__Compare___group__group_1_0, 3,2,6,7,9,13,39)
...
MR_BEGIN_MODULE(group_module23)
	...
	MR_init_label3(__Unify___group__group_1_0,4,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___group__group_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Unify___group__group_1_0_i8);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___group__group_1_0_i4);
MR_def_label(__Unify___group__group_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___group__group_1_0_i1);
	}
...
MR_def_label(__Unify___group__group_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(group_module24)
	...
	MR_init_label7(__Compare___group__group_1_0,3,2,6,7,9,13,39)
MR_BEGIN_CODE
...
MR_def_label(__Compare___group__group_1_0,9)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i39);
	}
	MR_r3 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___group__group_1_0_i13);
MR_def_label(__Compare___group__group_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i39);
	}
...
MR_def_label(__Compare___group__group_1_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
