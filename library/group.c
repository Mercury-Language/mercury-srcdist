...
MR_decl_label7(group__largest_group_key_2_4_0, 29,3,4,5,6,8,31)
...
MR_BEGIN_MODULE(group_module18)
	...
	MR_init_label7(group__largest_group_key_2_4_0,29,3,4,5,6,8,31)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__largest_group_key_2_4_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(group__largest_group_key_2_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(group__largest_group_key_2_4_0,31)
	...
	MR_GOTO_LAB(group__largest_group_key_2_4_0_i29);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_define_entry(mercury____Unify___group__group_1_0);
	...
	MR_r2 = MR_tempr5;
	MR_tfield(0, MR_tempr5, 0) = (MR_Word) MR_CTOR1_ADDR(set_ordlist, set_ordlist);
