...
MR_decl_label2(group__insert_3_0, 2,3)
MR_decl_label3(group__insert_elements_4_0, 11,4,3)
MR_decl_label1(group__largest_group_key_2_0, 2)
MR_decl_label7(group__largest_group_key_2_4_0, 30,4,5,6,8,31,3)
MR_decl_label3(group__remove_elements_3_0, 11,4,3)
MR_decl_label4(group__remove_group_4_0, 3,2,6,7)
MR_decl_label2(group__same_group_3_0, 2,3)
MR_decl_label1(group__sets_and_keys_2_0, 2)
MR_decl_label4(group__to_set_2_0, 2,3,4,6)
MR_decl_label2(__Unify___group__group_1_0, 2,1)
MR_decl_label5(__Compare___group__group_1_0, 4,5,7,11,16)
...
MR_BEGIN_MODULE(group_module2)
	...
	MR_init_label3(group__insert_elements_4_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_label(group__insert_elements_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(group__insert_elements_4_0,4)
	...
	MR_GOTO_LAB(group__insert_elements_4_0_i11);
...
MR_BEGIN_MODULE(group_module3)
	...
	MR_init_label2(group__insert_3_0,2,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__insert_3_0);
	...
	MR_np_call_localret_ent(tree234__set_4_0,
		group__insert_3_0_i2);
MR_def_label(group__insert_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(5);
...
MR_define_entry(mercury__fn__group__group_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(group__group_3_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(group_module7)
	...
	MR_init_label4(group__to_set_2_0,2,3,4,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__to_set_2_0);
	...
	MR_np_call_localret_ent(tree234__values_2_3_0,
		group__to_set_2_0_i2);
MR_def_label(group__to_set_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
...
MR_def_label(group__to_set_2_0,4)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(group__to_set_2_0_i6);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(3);
MR_def_label(group__to_set_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(group_module9)
	...
	MR_init_label1(group__sets_and_keys_2_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__sets_and_keys_2_0);
	...
	MR_np_call_localret_ent(tree234__tree234_to_assoc_list_2_3_0,
		group__sets_and_keys_2_0_i2);
MR_def_label(group__sets_and_keys_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_sv(1);
...
MR_define_entry(mercury__fn__group__sets_and_keys_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(group__sets_and_keys_2_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(group_module15)
	...
	MR_init_label3(group__remove_elements_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(group__remove_elements_3_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(group__remove_elements_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_def_label(group__remove_elements_3_0,4)
	...
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(group__remove_elements_3_0_i11);
...
MR_BEGIN_MODULE(group_module16)
	...
	MR_init_label4(group__remove_group_4_0,3,2,6,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__remove_group_4_0);
	...
	MR_np_call_localret_ent(tree234__remove_2_5_0,
		group__remove_group_4_0_i3);
MR_def_label(group__remove_group_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(group__remove_group_4_0,2)
	...
	MR_np_call_localret_ent(require__error_1_0,
		group__remove_group_4_0_i6);
MR_def_label(group__remove_group_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(group__remove_elements_3_0,
		group__remove_group_4_0_i7);
...
MR_BEGIN_MODULE(group_module18)
	...
	MR_init_label7(group__largest_group_key_2_4_0,30,4,5,6,8,31,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__largest_group_key_2_4_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(group__largest_group_key_2_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_def_label(group__largest_group_key_2_4_0,8)
	...
	if (MR_INT_EQ(MR_r5,2)) {
		MR_GOTO_LAB(group__largest_group_key_2_4_0_i31);
	}
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(2);
MR_def_label(group__largest_group_key_2_4_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(group__largest_group_key_2_4_0_i30);
...
MR_BEGIN_MODULE(group_module19)
	...
	MR_init_label1(group__largest_group_key_2_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__group__largest_group_key_2_0);
	...
	MR_np_call_localret_ent(tree234__tree234_to_assoc_list_2_3_0,
		group__largest_group_key_2_0_i2);
MR_def_label(group__largest_group_key_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r3 = (MR_Integer) 0;
...
MR_BEGIN_MODULE(group_module23)
	...
	MR_init_label2(__Unify___group__group_1_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___group__group_1_0);
	...
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_LIST_CTOR_ADDR;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_sv(1) = MR_ctfield(0, MR_tempr4, 2);
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___group__group_1_0_i2);
MR_def_label(__Unify___group__group_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___group__group_1_0_i1);
	}
...
MR_BEGIN_MODULE(group_module24)
	...
	MR_init_label5(__Compare___group__group_1_0,4,5,7,11,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___group__group_1_0);
	...
	if (((MR_Integer) MR_r3 >= (MR_Integer) MR_r4)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i4);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___group__group_1_0_i7);
	}
MR_def_label(__Compare___group__group_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r4)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i5);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___group__group_1_0_i7);
MR_def_label(__Compare___group__group_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___group__group_1_0,7)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i16);
	}
	MR_r1 = MR_sv(5);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___group__group_1_0_i11);
MR_def_label(__Compare___group__group_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___group__group_1_0_i16);
	}
...
MR_def_label(__Compare___group__group_1_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__group__write_out_proc_statics(FILE *fp);
#endif
