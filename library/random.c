  ...
  MR_Word * STATE_VARIABLE_RS_12)
{
  ...
  if (succeeded)
  {
    ...
    mercury__random__LCMC__pred__test_2__1_4_p_0(N1_8, AddrIs0_17, STATE_VARIABLE_RS_15_15, STATE_VARIABLE_RS_12);
  }
  else
  {
...
void MR_CALL 
mercury__random__LCMC__pred__test_2__1_4_p_0(
  MR_Integer N_5,
  MR_Word * AddrOfIs_18,
  MR_Word STATE_VARIABLE_RS_0_11,
  MR_Word * STATE_VARIABLE_RS_12)
