...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__get_mutvar_2_p_0(TypeInfo__16_16, V_6, &S0_9);
  S1_10 = S0_9;
...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__set_mutvar_2_p_0(TypeInfo__17_17, V_6, S_11);
}
...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__get_mutvar_2_p_0(TypeInfo__14_14, V_5, &R0_8);
...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__set_mutvar_2_p_0(TypeInfo__15_15, V_5, R_9);
}
...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__new_mutvar_2_p_1(TypeInfo__15_15, S_7, &V_10);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *Pio_8 = base;
...
#undef MR_PROC_LABEL
  ...
  mercury__mutvar__new_mutvar_2_p_0(TypeInfo__13_13, R_5, &V_8);
  *Pio_6 = (MR_Word) (V_8);
}
...
#undef MR_PROC_LABEL
  ...
  mercury__random__shuffle_2_9_p_0(TypeInfo_for_T_16, TypeClassInfo_for_urandom_15, P_6, Lo_17, Lo_17, Hi_18, Sz_19, A0_10, &A_11, STATE_VARIABLE_S_0_12, STATE_VARIABLE_S_13);
  ...
  MR_Box * STATE_VARIABLE_S_15)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    mercury__random__uniform_float_in_01_4_p_0(TypeClassInfo_for_urandom_23, P_6, &N0_24, STATE_VARIABLE_S_0_14, &STATE_VARIABLE_S_18_18);
    Var_25 = (N0_24 * ((MR_Float) 2.0000000000000000));
    X_10 = (((MR_Float) -1.0000000000000000) + Var_25);
    mercury__random__uniform_float_in_01_4_p_0(TypeClassInfo_for_urandom_23, P_6, &N0_26, STATE_VARIABLE_S_18_18, &STATE_VARIABLE_S_21_21);
    Var_27 = (N0_26 * ((MR_Float) 2.0000000000000000));
    Y_11 = (((MR_Float) -1.0000000000000000) + Var_27);
...
#undef MR_PROC_LABEL
  ...
  mercury__random__shuffle_2_8_p_0(TypeInfo_for_T_14, TypeClassInfo_for_random_13, Lo_15, Lo_15, Hi_16, Sz_17, A0_8, &A_9, STATE_VARIABLE_R_0_10, STATE_VARIABLE_R_11);
  ...
  MR_Box * STATE_VARIABLE_R_13)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    mercury__random__uniform_float_in_01_3_p_0(TypeClassInfo_for_random_21, &N0_22, STATE_VARIABLE_R_0_12, &STATE_VARIABLE_R_16_16);
    Var_23 = (N0_22 * ((MR_Float) 2.0000000000000000));
    X_8 = (((MR_Float) -1.0000000000000000) + Var_23);
    mercury__random__uniform_float_in_01_3_p_0(TypeClassInfo_for_random_21, &N0_24, STATE_VARIABLE_R_16_16, &STATE_VARIABLE_R_19_19);
    Var_25 = (N0_24 * ((MR_Float) 2.0000000000000000));
    Y_9 = (((MR_Float) -1.0000000000000000) + Var_25);
