...
MR_decl_label7(random__perform_sampling_6_0, 14,2,3,4,5,6,7)
MR_decl_label7(random__perform_sampling_6_1, 14,2,3,4,5,6,7)
...
MR_decl_label2(random__random_5_0, 2,4)
MR_decl_label2(random__random_5_1, 2,4)
MR_decl_label1(random__test_4_0, 2)
MR_decl_label3(random__test_2_4_0, 3,4,2)
MR_decl_label3(random__test_2_4_1, 3,4,2)
MR_decl_label2(__Compare___random__supply_0_0, 2,3)
...
MR_BEGIN_MODULE(random_module6)
	...
	MR_init_label2(random__random_5_0,2,4)
MR_BEGIN_CODE
...
MR_def_label(random__random_5_0,2)
	...
	{
#define	MR_PROC_LABEL	mercury__random__random_5_0
...
;}
#line 418 "random.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(random__random_5_0_i4);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	if (MR_INT_NE((MR_Integer) 233280,0)) {
		MR_GOTO_LAB(random__random_5_0_i4);
	}
...
MR_def_label(random__random_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(1) + ((MR_Integer) MR_sv(3) / (MR_Integer) 233280));
...
MR_BEGIN_MODULE(random_module7)
	...
	MR_init_label2(random__random_5_1,2,4)
MR_BEGIN_CODE
...
MR_def_label(random__random_5_1,2)
	...
	MR_sv(3) = ((MR_Integer) MR_sv(2) * (MR_Integer) MR_r1);
	{
#define	MR_PROC_LABEL	mercury__random__random_5_1
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
{
...
;}
#line 479 "random.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(random__random_5_1_i4);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	if (MR_INT_NE((MR_Integer) 233280,0)) {
		MR_GOTO_LAB(random__random_5_1_i4);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(math, domain_error);
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("int.\'//\'", 8);
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(exception__throw_1_0);
MR_def_label(random__random_5_1,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(1) + ((MR_Integer) MR_sv(3) / (MR_Integer) 233280));
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(random_module10)
	...
	MR_init_label7(random__perform_sampling_6_0,14,2,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_label(random__perform_sampling_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(random__perform_sampling_6_0,5)
	...
	MR_np_call_localret_ent(array__set_4_0,
		random__perform_sampling_6_0_i6);
MR_def_label(random__perform_sampling_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(7);
	MR_r3 = MR_sv(3);
...
MR_def_label(random__perform_sampling_6_0,7)
	...
	MR_GOTO_LAB(random__perform_sampling_6_0_i14);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(random_module11)
	...
	MR_init_label7(random__perform_sampling_6_1,14,2,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury__random__perform_sampling_6_1);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(random__perform_sampling_6_1,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_GT(MR_r2,0)) {
...
MR_def_label(random__perform_sampling_6_1,5)
	...
	MR_np_call_localret_ent(array__set_4_0,
		random__perform_sampling_6_1_i6);
MR_def_label(random__perform_sampling_6_1,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(7);
	MR_r3 = MR_sv(3);
...
MR_def_label(random__perform_sampling_6_1,7)
	...
	MR_r5 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(random__perform_sampling_6_1_i14);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(random_module18)
	...
	MR_init_label2(__Compare___random__supply_0_0,2,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___random__supply_0_0);
	...
	if (((MR_Integer) MR_r1 >= (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(__Compare___random__supply_0_0_i2);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___random__supply_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 != MR_r2)) {
		MR_GOTO_LAB(__Compare___random__supply_0_0_i3);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___random__supply_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__random__write_out_proc_statics(FILE *fp);
#endif
