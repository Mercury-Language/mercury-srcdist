...
#undef MR_PROC_LABEL
    ...
    *Max_8 = (MR_Integer) ((MR_Unsigned) 233280 - (MR_Unsigned) 1);
    mercury__random__test_2_4_p_0(N_6, Nums_7, RS1_10, &_RS2_11);
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      AddrIs0_17 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *Is_6, (MR_Integer) 1)));
      mercury__random__LCMCpr_test_2_1_4_p_0(N1_8, AddrIs0_17, STATE_VARIABLE_RS_15_15, STATE_VARIABLE_RS_12);
    }
    else
    {
...
void MR_CALL 
mercury__random__LCMCpr_test_2_1_4_p_0(
  MR_Integer N_5,
  MR_Word * AddrOfIs_18,
  MR_Word STATE_VARIABLE_RS_0_11,
  MR_Word * STATE_VARIABLE_RS_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word * next_value_of_AddrOfIs_18;
      MR_Word next_value_of_STATE_VARIABLE_RS_0_11;

      mercury__random__random_3_p_0(&I_9, STATE_VARIABLE_RS_0_11, &STATE_VARIABLE_RS_15_15);
      {
        Is_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Is_6, 0) = ((MR_Box) (I_9));
        MR_hl_field(MR_mktag(1), Is_6, 1) = NULL;
      }
      AddrIs0_17 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), Is_6, (MR_Integer) 1)));
      *AddrOfIs_18 = Is_6;
      // direct tailcall eliminated
      ;
      next_value_of_N_5 = N1_8;
      next_value_of_AddrOfIs_18 = AddrIs0_17;
      next_value_of_STATE_VARIABLE_RS_0_11 = STATE_VARIABLE_RS_15_15;
      N_5 = next_value_of_N_5;
      AddrOfIs_18 = next_value_of_AddrOfIs_18;
      STATE_VARIABLE_RS_0_11 = next_value_of_STATE_VARIABLE_RS_0_11;
      continue;
    }
    else
    {
      *AddrOfIs_18 = (MR_Word) ((MR_Unsigned) 0U);
      *STATE_VARIABLE_RS_12 = STATE_VARIABLE_RS_0_11;
    }
    break;
  }
...
{
  {
    ...
    Var_18 = mercury__int__div_2_f_0(Var_11, (MR_Integer) 233280);
    Var_17 = (MR_Integer) ((MR_Unsigned) Var_18 * (MR_Unsigned) 233280);
    *I_4 = (MR_Integer) ((MR_Unsigned) Var_11 - (MR_Unsigned) Var_17);
{
...
#define MR_PROC_LABEL mercury__random__shuffle_2_9_p_0
	...
	Index = J_17 ;
	Item = (MR_Word) Var_34 ;
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, (MR_ArrayPtr) (Var_36) , Array0);
		{
...
#define MR_PROC_LABEL mercury__random__shuffle_2_8_p_0
    ...
    Array = Array0;
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, Var_34 );
}
{
#define MR_PROC_LABEL mercury__random__shuffle_2_8_p_0
	...
	Index = J_15 ;
	Item = (MR_Word) Var_32 ;
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, Var_34 , Array0);
		{
