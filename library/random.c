...
{
  {
    ...
    if (mercury__random__succeeded)
      *mercury__random__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mercury__random__Var_4 = (MR_Integer) mercury__random__HeadVar__2_2;
        MR_Integer mercury__random__Var_5 = (MR_Integer) mercury__random__HeadVar__3_3;

        mercury__random__succeeded = (mercury__random__Var_4 < mercury__random__Var_5);
        if (mercury__random__succeeded)
...
{
  {
    ...
    if (mercury__random__succeeded)
      ...
      {
        MR_Integer mercury__random__Var_3 = (MR_Integer) mercury__random__HeadVar__1_1;
        MR_Integer mercury__random__Var_4 = (MR_Integer) mercury__random__HeadVar__2_2;

        mercury__random__succeeded = (mercury__random__Var_3 == mercury__random__Var_4);
      }
    return mercury__random__succeeded;
  }
}
