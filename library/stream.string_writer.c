        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              if (succeeded)
              {
                UInt8_17 = ((uint8_t) conv6_UInt8_17);
                succeeded = MR_TRUE;
              }
              if (succeeded)
              {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Int16_18 = ((int16_t) conv8_Int16_18);
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    UInt16_19 = ((uint16_t) conv10_UInt16_19);
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      Int32_20 = ((int32_t) conv12_Int32_20);
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                    {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        UInt32_21 = ((uint32_t) conv14_UInt32_21);
                        succeeded = MR_TRUE;
                      }
                      if (succeeded)
                      {
...
#undef MR_PROC_LABEL
	 Var_33  = S;
          ...
          else
          {
            ...
            if (succeeded)
            {
              UInt8_14 = ((uint8_t) conv8_UInt8_14);
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
...
#undef MR_PROC_LABEL
	 Var_36  = S;
            ...
            else
            {
              ...
              if (succeeded)
              {
                Int16_15 = ((int16_t) conv10_Int16_15);
                succeeded = MR_TRUE;
              }
              if (succeeded)
              {
...
#undef MR_PROC_LABEL
	 Var_39  = S;
              ...
              else
              {
                ...
                if (succeeded)
                {
                  UInt16_16 = ((uint16_t) conv12_UInt16_16);
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
...
#undef MR_PROC_LABEL
	 Var_42  = S;
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    Int32_17 = ((int32_t) conv14_Int32_17);
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
...
#undef MR_PROC_LABEL
	 Var_45  = S;
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      UInt32_18 = ((uint32_t) conv16_UInt32_18);
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                    {
