  ...
  MR_Word * Result_10)
{
  if (((MR_tag((MR_Word) Parse_6)) == (MR_Integer) 1))
  {
    ...
    if ((MaybeBadTokenMsg_13 == (MR_Word) ((MR_Unsigned) 0U)))
      if ((ErrorTokens_12 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        if ((Tokens_8 == (MR_Word) ((MR_Unsigned) 0U)))
          ...
          LineNum_15 = ((MR_Integer) ((MR_hl_field(1, Tokens_8, (MR_Integer) 1))));
        mercury__string__append_3_p_2((MR_String) "Syntax error: ", ErrorMessage_11, &Message_14);
      }
      else
      {
        MR_Word ErrorTok_16 = ((MR_Word) ((MR_hl_field(1, ErrorTokens_12, (MR_Integer) 0))));
        MR_String TokString_19;
        MR_String Var_61;
        MR_String Var_62;

        LineNum_15 = ((MR_Integer) ((MR_hl_field(1, ErrorTokens_12, (MR_Integer) 1))));
    ...
    {
      MR_Tuple Var_25 = ((MR_Tuple) ((MR_hl_field(1, MaybeBadTokenMsg_13, (MR_Integer) 0))));

      Message_14 = ((MR_String) ((MR_hl_field(0, Var_25, (MR_Integer) 0))));
      LineNum_15 = ((MR_Integer) ((MR_hl_field(0, Var_25, (MR_Integer) 1))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  {
    MR_Word Term_22 = ((MR_Word) ((MR_hl_field(0, Parse_6, (MR_Integer) 0))));
    ...
    if ((MaybeBadTokenMsg_56 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      {
        MR_Word Token_23 = ((MR_Word) ((MR_hl_field(1, LeftOverTokens_9, (MR_Integer) 0))));
        MR_String Message_44;
        MR_Integer LineNum_45 = ((MR_Integer) ((MR_hl_field(1, LeftOverTokens_9, (MR_Integer) 1))));
    ...
    {
      MR_Tuple Var_37 = ((MR_Tuple) ((MR_hl_field(1, MaybeBadTokenMsg_56, (MR_Integer) 0))));
      MR_String Message_42 = ((MR_String) ((MR_hl_field(0, Var_37, (MR_Integer) 0))));
      MR_Integer LineNum_43 = ((MR_Integer) ((MR_hl_field(0, Var_37, (MR_Integer) 1))));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer LineNum0_4 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word Tokens_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 2))));
      ...
      switch (MR_tag((MR_Word) Token_3)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word next_value_of_HeadVar__1_1 = Tokens_5;
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, Token_3, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
            case (MR_Integer) 1:
            case (MR_Integer) 2:
            ...
            case (MR_Integer) 4:
              {
                MR_Char Char_10 = ((MR_Char) (MR_Word) (MR_hl_field(3, Token_3, (MR_Integer) 1)));
                MR_Integer Code_11;
                MR_String Decimal_12;
                MR_String Hex_13;
                MR_Tuple Var_38;
                MR_String Message_44;
                MR_String Var_47;
...
#undef MR_PROC_LABEL
	Code_11  = Int;
                ...
                mercury__string__int_to_base_string_3_p_0(Code_11, (MR_Integer) 10, &Decimal_12);
                mercury__string__int_to_base_string_3_p_0(Code_11, (MR_Integer) 16, &Hex_13);
                mercury__string__append_3_p_2(Decimal_12, (MR_String) ") in input", &Var_47);
                ...
                mercury__string__append_3_p_2((MR_String) "Syntax error: illegal character 0x", Var_50, &Message_44);
                {
                  ...
                  MR_hl_field(0, Var_38, 1) = ((MR_Box) (LineNum0_4));
                }
                {
                  MR_Word base;
            ...
            case (MR_Integer) 5:
              {
                MR_String ErrorMessage_14 = ((MR_String) ((MR_hl_field(3, Token_3, (MR_Integer) 1))));
                MR_Tuple Var_43;
                MR_String Message_45;

                mercury__string__append_3_p_2((MR_String) "Syntax error: ", ErrorMessage_14, &Message_45);
                {
                  Var_43 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Var_43, 0) = ((MR_Box) (Message_45));
                  MR_hl_field(0, Var_43, 1) = ((MR_Box) (LineNum0_4));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 6:
              {
                MR_Word IO_Error_7 = ((MR_Word) ((MR_hl_field(3, Token_3, (MR_Integer) 1))));
                MR_String IO_ErrorMessage_8;
                MR_String Message_9;
                MR_Tuple Var_29;

                mercury__io__error_message_2_p_0(IO_Error_7, &IO_ErrorMessage_8);
                mercury__string__append_3_p_2((MR_String) "I/O error: ", IO_ErrorMessage_8, &Message_9);
                {
                  Var_29 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Var_29, 0) = ((MR_Box) (Message_9));
                  MR_hl_field(0, Var_29, 1) = ((MR_Box) (LineNum0_4));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
