...
;}
#line 540 "term_size_prof_builtin.c"
	MR_r1 = Slot;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
void mercury__term_size_prof_builtin__init_threadscope_string_table(void);
#endif
...
void mercury__term_size_prof_builtin__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__term_size_prof_builtin);
