      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          *RestOfList_6 = RestOfList0_45;
          {
            Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            ...
            MR_hl_field(MR_mktag(1), Var_26, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_30, 0) = Z_18;
            MR_hl_field(MR_mktag(1), Var_30, 1) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(1), Var_30, 2) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Var_30, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            *RestOfList_6 = RestOfList0_46;
            {
              Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_36, 0) = X_47;
              MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(1), Var_36, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), Var_36, 3) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      ...
      if (succeeded)
        ...
        else
        {
          ...
          else
          {
            ...
            if ((Y_70 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              {
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if ((Y_13 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
