        ...
        else
          {
            ...
            if ((mercury__set_bbbtree__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              *mercury__set_bbbtree__HeadVar__1_1 = (MR_Integer) 2;
              ...
              {
                MR_Box mercury__set_bbbtree__Var_16 = (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__3_3, (MR_Integer) 0));
                MR_Integer mercury__set_bbbtree__Var_17 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__3_3, (MR_Integer) 1)));
                MR_Word mercury__set_bbbtree__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__3_3, (MR_Integer) 2)));
                MR_Word mercury__set_bbbtree__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__3_3, (MR_Integer) 3)));
                MR_Word mercury__set_bbbtree__Var_20;

                {
                  mercury__builtin__compare_3_p_0(mercury__set_bbbtree__TypeInfo_for_T_25, &mercury__set_bbbtree__Var_20, mercury__set_bbbtree__Var_34, mercury__set_bbbtree__Var_16);
                }
                ...
                if (mercury__set_bbbtree__succeeded)
                  *mercury__set_bbbtree__HeadVar__1_1 = mercury__set_bbbtree__Var_20;
                else
                  {
                    ...
                    mercury__set_bbbtree__succeeded = (mercury__set_bbbtree__Var_33 < mercury__set_bbbtree__Var_17);
                    if (mercury__set_bbbtree__succeeded)
                    ...
                    if (mercury__set_bbbtree__succeeded)
                      *mercury__set_bbbtree__HeadVar__1_1 = mercury__set_bbbtree__Var_21;
                    else
                      {
                        ...
                        {
                          mercury__set_bbbtree____Compare____set_bbbtree_1_0(mercury__set_bbbtree__TypeInfo_for_T_25, &mercury__set_bbbtree__Var_22, mercury__set_bbbtree__Var_32, mercury__set_bbbtree__Var_18);
                        }
                          ...
                          *mercury__set_bbbtree__HeadVar__1_1 = mercury__set_bbbtree__Var_22;
                        else
                          {
                            /* direct tailcall eliminated */
                            {
                              ...
                              MR_Word mercury__set_bbbtree__next_value_of_HeadVar__3_3 = mercury__set_bbbtree__Var_19;
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((mercury__set_bbbtree__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Box mercury__set_bbbtree__Var_5 = (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__1_1, (MR_Integer) 0));
            MR_Integer mercury__set_bbbtree__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word mercury__set_bbbtree__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__1_1, (MR_Integer) 2)));
            MR_Word mercury__set_bbbtree__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__1_1, (MR_Integer) 3)));
            MR_Box mercury__set_bbbtree__Var_9;
            MR_Integer mercury__set_bbbtree__Var_10;
            MR_Word mercury__set_bbbtree__Var_11;
            ...
            if (mercury__set_bbbtree__succeeded)
              {
                mercury__set_bbbtree__Var_9 = (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__2_2, (MR_Integer) 0));
                mercury__set_bbbtree__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__2_2, (MR_Integer) 1)));
                mercury__set_bbbtree__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__2_2, (MR_Integer) 2)));
                mercury__set_bbbtree__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__set_bbbtree__HeadVar__2_2, (MR_Integer) 3)));
                {
                  mercury__set_bbbtree__succeeded = mercury__builtin__unify_2_p_0(mercury__set_bbbtree__TypeInfo_for_T_15, mercury__set_bbbtree__Var_5, mercury__set_bbbtree__Var_9);
                }
                if (mercury__set_bbbtree__succeeded)
                  {
                    mercury__set_bbbtree__succeeded = (mercury__set_bbbtree__Var_6 == mercury__set_bbbtree__Var_10);
                    if (mercury__set_bbbtree__succeeded)
                      {
                        {
                          mercury__set_bbbtree__succeeded = mercury__set_bbbtree____Unify____set_bbbtree_1_0(mercury__set_bbbtree__TypeInfo_for_T_15, mercury__set_bbbtree__Var_7, mercury__set_bbbtree__Var_11);
                        }
                        if (mercury__set_bbbtree__succeeded)
                          {
                            /* direct tailcall eliminated */
                            {
                              MR_Word mercury__set_bbbtree__next_value_of_HeadVar__1_1 = mercury__set_bbbtree__Var_8;
