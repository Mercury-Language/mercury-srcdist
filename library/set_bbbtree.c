  ...
  MR_Integer HeadVar__3_3)
{
  ...
  else
  {
    ...
    {
      {
        mercury__require__error_2_p_0((MR_String) "predicate \140set_bbbtree.sorted_list_to_set_len\'/3", (MR_String) "sorted_list_to_set_r");
        return;
      }
    }
  }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        {
          mercury__require__error_2_p_0((MR_String) "predicate \140set_bbbtree.sorted_list_to_set_len2\'/4", (MR_String) "sorted_list_to_set_len2.1");
          return;
        }
      }
      else
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          {
            mercury__require__error_2_p_0((MR_String) "predicate \140set_bbbtree.sorted_list_to_set_len2\'/4", (MR_String) "sorted_list_to_set_len2.2");
            return;
          }
        }
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            {
              mercury__require__error_2_p_0((MR_String) "predicate \140set_bbbtree.sorted_list_to_set_len2\'/4", (MR_String) "sorted_list_to_set_len2.3");
              return;
            }
          }
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              {
                mercury__require__error_2_p_0((MR_String) "predicate \140set_bbbtree.sorted_list_to_set_len2\'/4", (MR_String) "sorted_list_to_set_len2.4");
                return;
              }
            }
          }
