        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__1_1 = ArgX4_11;
                MR_Word next_value_of_HeadVar__2_2 = ArgY4_12;
  ...
  MR_Integer HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Intersect1_11;
        MR_Word next_value_of_HeadVar__2_2 = Sets_9;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Var_30;
          MR_Word next_value_of_HeadVar__2_2 = Intersection1_27;
  ...
  MR_Word * List_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = L_7;
        MR_Word next_value_of_HeadVar__2_2 = Var_12;
    ...
    else
    {
      ...
      if (succeeded)
      {
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_Set_0_2 = STATE_VARIABLE_Set_12_12;
  ...
  MR_Integer HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = STATE_VARIABLE_Set_13_13;
        MR_Word next_value_of_HeadVar__2_2 = Xs_9;
