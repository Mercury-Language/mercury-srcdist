...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        succeeded = (IsReplaced_9 == (MR_Integer) 0);
      if (succeeded)
        succeeded = MR_TRUE;
      else
      {
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        succeeded = (IsReplaced_10 == (MR_Integer) 0);
        if (succeeded)
        {
{
#define MR_PROC_LABEL mercury__string__char_to_string_2_p_1
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	 J_9  = PrevIndex;
	 Char_10  = Ch;
	 IsReplaced_11  = IsReplaced;
	}
succeeded  = SUCCESS_INDICATOR;
}
    if (succeeded)
    {
      succeeded = (IsReplaced_11 == (MR_Integer) 0);
      if (succeeded)
...
{
  {
    ...
    succeeded = mercury__string__first_char_rest_out_3_p_1(S0_3, &C_5, &S1_6);
    if (succeeded)
    {
      MR_Char LowerC_7;
      MR_Char V_5_25;

      succeeded = mercury__char__lower_upper_2_p_1(&V_5_25, C_5);
      if (succeeded)
        LowerC_7 = V_5_25;
      else
        LowerC_7 = C_5;
      mercury__string__first_char_str_out_3_p_0(S_4, LowerC_7, S1_6);
    }
    else
      *S_4 = S0_3;
  }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__char__lower_upper_2_p_0(C_5, &V_5_25);
      if (succeeded)
        UpperC_7 = V_5_25;
      else
        UpperC_7 = C_5;
      mercury__string__first_char_str_out_3_p_0(S_4, UpperC_7, S1_6);
    }
    else
      *S_4 = S0_3;
  }
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	 ...
	 Char_13  = Ch;
	 IsReplaced_14  = IsReplaced;
	}
succeeded  = SUCCESS_INDICATOR;
}
    if (succeeded)
    {
      succeeded = (IsReplaced_14 == (MR_Integer) 0);
      if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_Word CodeList1_13;
      MR_Integer next_value_of_Index_6;
      MR_Word next_value_of_CodeList0_7;

      switch (IsReplaced_11) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word CharCodes_12;

            succeeded = mercury__char__to_utf16_2_p_0(Char_10, &CharCodes_12);
            if (succeeded)
              mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), CharCodes_12, CodeList0_7, &CodeList1_13);
            else
              {
      ...
      next_value_of_CodeList0_7 = CodeList1_13;
