...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      End_17 = Var_19;
    mercury__string__foldl_between_2__ho42_6_p_0(String_3, (MR_Integer) 0, End_17, (MR_Integer) 0, &Length_4);
  }
  return Length_4;
}
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__string__decode_utf16_3_p_0(CodeUnits_3, (MR_Word) ((MR_Unsigned) 0U), &RevChars_5);
    if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    succeeded = mercury__string__decode_utf8_3_p_0(CodeUnits_3, (MR_Word) ((MR_Unsigned) 0U), &RevChars_5);
    if (succeeded)
      succeeded = mercury__string__semidet_from_rev_char_list_2_p_0(RevChars_5, String_4);
  }
  return succeeded;
...
#undef MR_PROC_LABEL
    ...
    mercury__string__utf8_to_utf16_code_units_rev_loop_4_p_0(String_3, NumCodeUnits_5, (MR_Word) ((MR_Unsigned) 0U), CodeUnits_4);
  }
  else
  {
...
#undef MR_PROC_LABEL
    ...
    mercury__string__to_code_unit_list_loop_4_p_0(String_3, (MR_Integer) 0, NumCodeUnits_7, CodeUnits_4);
  }
}
...
mercury__string__utf8_to_utf16_code_units_rev_loop_4_p_0(
  MR_String String_5,
  MR_Integer Index_6,
  MR_Word StrCodeUnits0_7,
  MR_Word * StrCodeUnits_8)
{
  while (MR_TRUE)
  {
    MR_bool succeeded;
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      MR_Word StrCodeUnits1_14;
      MR_Integer next_value_of_Index_6;
      MR_Word next_value_of_StrCodeUnits0_7;

      if ((MaybeReplaced_11 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word CharCodeUnits_13;

        succeeded = mercury__char__to_utf16_2_p_0(Char_10, &CharCodeUnits_13);
        if (succeeded)
          mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), CharCodeUnits_13, StrCodeUnits0_7, &StrCodeUnits1_14);
        else
          {
      ...
      next_value_of_StrCodeUnits0_7 = StrCodeUnits1_14;
      Index_6 = next_value_of_Index_6;
      StrCodeUnits0_7 = next_value_of_StrCodeUnits0_7;
      continue;
    }
    else
      *StrCodeUnits_8 = StrCodeUnits0_7;
    break;
  }
}
