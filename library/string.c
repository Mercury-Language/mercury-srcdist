...
mercury__string__IntroducedFrom__func__word_wrap_loop__4797__1_2_f_0(
  MR_String WordSep_2,
...
{
  {
    ...
    if (succeeded)
      ...
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140string.encode_utf16\'/3", (MR_String) "char.to_utf16 failed");
        return;
      }
  }
}
...
{
  {
    ...
    if (succeeded)
      ...
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140string.encode_utf8\'/3", (MR_String) "char.to_utf8 failed");
        return;
      }
  }
}
...
{
  {
    ...
    else
    {
      ...
      V_8_8 = mercury__string__IntroducedFrom__func__word_wrap_loop__4797__1_2_f_0(Var_12, V_6_6);
...
{
#define MR_PROC_LABEL mercury__string__IntroducedFrom__func__word_wrap_loop__4797__1_2_f_0
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__char__to_utf16_2_p_0(Char_13, &CharCodes_27);
      if (succeeded)
