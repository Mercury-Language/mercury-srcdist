...
mercury__string__IntroducedFrom__func__word_wrap_loop__4929__1_2_f_0(
  MR_String WordSep_2,
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    Var_8 = mercury__string__IntroducedFrom__func__word_wrap_loop__4929__1_2_f_0(Var_12, Var_6);
    {
      HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (Var_8));
      MR_hl_field(MR_mktag(1), HeadVar__3_3, 1) = NULL;
...
{
#define MR_PROC_LABEL mercury__string__IntroducedFrom__func__word_wrap_loop__4929__1_2_f_0
