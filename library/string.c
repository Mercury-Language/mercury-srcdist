  ...
  MR_String Sep_9)
{
  ...
  if (succeeded)
  {
    ...
    mercury__string__int_to_base_string_group_loop_6_p_0(N_6, Base_7, (MR_Integer) 0, GroupLength_8, Sep_9, &Str1_11);
{
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    mercury__string__int_to_base_string_group_loop_6_p_0(N1_12, Base_7, (MR_Integer) 0, GroupLength_8, Sep_9, &Str_10);
  }
  return Str_10;
}
  ...
  MR_String * Str_6)
{
  ...
  if (succeeded)
    mercury__string__int_to_base_string_loop_4_p_0(N_4, Base_5, (MR_Word) (MR_mkword(1, &mercury__string_scalar_common_1[2])), &RevChars_7);
  else
  {
    MR_Integer NegN_8 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) N_4);

    mercury__string__int_to_base_string_loop_4_p_0(NegN_8, Base_5, (MR_Word) ((MR_Unsigned) 0U), &RevChars_7);
  }
  succeeded = mercury__string__semidet_from_rev_char_list_2_p_0(RevChars_7, &Str0_19);
  if (succeeded)
    *Str_6 = Str0_19;
  else
    {
