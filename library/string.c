  ...
  MR_String S_3)
{
  ...
  mercury__term_io__format_quoted_string_4_p_0((MR_Word) (&mercury__string_scalar_common_4[0]), ((MR_Box) ((MR_Integer) 0)), S_3, ((MR_Box) (((MR_Box) ((MR_Unsigned) 0U)))), &conv0_Var_7);
