...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      {
        Chars_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
	 Var_71  = S3;
      ...
      V_8_8 = mercury__string__f_43_43_2_f_0(V_6_6, Var_71);
...
#undef MR_PROC_LABEL
	 Length_22  = Length;
      ...
      succeeded = mercury__string__codepoint_offset_loop_5_p_0(Str_5, (MR_Integer) 0, Length_22, Start_6, &StartOffset0_10);
      if (succeeded)
...
#undef MR_PROC_LABEL
	 Length_42  = Length;
      ...
      succeeded = mercury__string__codepoint_offset_loop_5_p_0(Str_5, (MR_Integer) 0, Length_42, End_7, &EndOffset0_12);
      if (succeeded)
