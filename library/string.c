...
mercury__string__IntroducedFrom__func__word_wrap_loop__5029__1_2_f_0(
...
{
  {
    ...
    if ((mercury__string__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          mercury__string__V_8_8 = mercury__string__IntroducedFrom__func__word_wrap_loop__5029__1_2_f_0(mercury__string__V_12_12, mercury__string__V_6_6);
        }
        {
...
{
#define MR_PROC_LABEL mercury__string__IntroducedFrom__func__word_wrap_loop__5029__1_2_f_0
