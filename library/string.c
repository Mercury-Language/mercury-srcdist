...
mercury__string__IntroducedFrom__func__word_wrap_loop__4902__1_2_f_0(
  MR_String WordSep_2,
...
{
  {
    ...
    else
    {
      ...
      Var_8 = mercury__string__IntroducedFrom__func__word_wrap_loop__4902__1_2_f_0(Var_12, Var_6);
      {
        HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (Var_8));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 1) = NULL;
...
{
#define MR_PROC_LABEL mercury__string__IntroducedFrom__func__word_wrap_loop__4902__1_2_f_0
...
#undef MR_PROC_LABEL
    ...
    mercury__string__split_at_string_loop_5_p_0(Total_5, Needle_4, Var_7, (MR_Integer) 0, &Out_6);
    return Out_6;
  }
}
...
mercury__string__split_at_string_loop_5_p_0(
  MR_String Total_6,
  MR_String Needle_7,
  MR_Integer NeedleLen_8,
  MR_Integer StartAt_9,
  MR_Word * Out_10)
{
  {
    MR_bool succeeded;
		...
		{
{
    ...
    SubString[Count] = '\0';
		...
		;}
#undef MR_PROC_LABEL
	 BeforeNeedle_12  = SubString;
}
      Var_15 = (MR_Integer) ((MR_Unsigned) NeedlePos_11 + (MR_Unsigned) NeedleLen_8);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *Out_10 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (BeforeNeedle_12));
        MR_hl_field(MR_mktag(1), base, 1) = NULL;
      }
      AddrTail_34 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *Out_10, (MR_Integer) 1)));
      mercury__string__LCMCpr_split_at_string_loop_1_5_p_0(Total_6, Needle_7, NeedleLen_8, Var_15, AddrTail_34);
    }
    else
    {
      MR_String Last_14;
...
#undef MR_PROC_LABEL
	 Last_14  = SubString;
}
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *Out_10 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Last_14));
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      MR_Word Out_10;
      MR_Word * AddrTail_34;
      MR_Integer next_value_of_StartAt_9;
      MR_Word * next_value_of_AddrOfOut_35;
...
#undef MR_PROC_LABEL
	 BeforeNeedle_12  = SubString;
      ...
      Var_15 = (MR_Integer) ((MR_Unsigned) NeedlePos_11 + (MR_Unsigned) NeedleLen_8);
      {
        Out_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Out_10, 0) = ((MR_Box) (BeforeNeedle_12));
        MR_hl_field(MR_mktag(1), Out_10, 1) = NULL;
      }
      AddrTail_34 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), Out_10, (MR_Integer) 1)));
      *AddrOfOut_35 = Out_10;
      // direct tailcall eliminated
      ;
      next_value_of_StartAt_9 = Var_15;
      next_value_of_AddrOfOut_35 = AddrTail_34;
      StartAt_9 = next_value_of_StartAt_9;
      AddrOfOut_35 = next_value_of_AddrOfOut_35;
      continue;
    }
    else
    {
...
#undef MR_PROC_LABEL
	 Last_14  = SubString;
      ...
      {
        Out_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Out_36, 0) = ((MR_Box) (Last_14));
        MR_hl_field(MR_mktag(1), Out_36, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      *AddrOfOut_35 = Out_36;
    }
    break;
