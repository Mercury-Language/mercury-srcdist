...
mercury__string__IntroducedFrom__func__word_wrap_loop__4980__1_2_f_0(
  MR_String WordSep_2,
  ...
  MR_Integer I_6)
{
  while (MR_TRUE)
  {
    ...
    MR_Char IndexChar_8;
    MR_Word Var_10;
    MR_Integer ReplacedCodeUnit_16;
...
#undef MR_PROC_LABEL
	if (SUCCESS_INDICATOR) {
	 J_7  = NextIndex;
	 IndexChar_8  = Ch;
	 ReplacedCodeUnit_16  = ReplacedCodeUnit;
	}
succeeded  = SUCCESS_INDICATOR;
}
    if (succeeded)
    {
      succeeded = (ReplacedCodeUnit_16 == (MR_Integer) -1);
      if (succeeded)
...
#undef MR_PROC_LABEL
	 CodeUnit_17  = U8;
}
        {
          ...
          MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (MR_Word) (CodeUnit_17));
        }
      }
      succeeded = mercury__string____Unify____maybe_replaced_0_0((MR_Word) ((MR_Unsigned) 0U), Var_10);
      if (succeeded)
      {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_15 = mercury__uint__det_from_int_1_f_0(Base_3);
              {
                ...
                MR_hl_field(MR_mktag(0), Pred_4, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Pred_4, 3) = ((MR_Box) (Var_15));
                MR_hl_field(MR_mktag(0), Pred_4, 4) = ((MR_Box) (Base_3));
              }
            }
            else
...
{
  {
    ...
    else
    {
      ...
      Var_8 = mercury__string__IntroducedFrom__func__word_wrap_loop__4980__1_2_f_0(Var_12, Var_6);
      {
        HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (Var_8));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 1) = NULL;
...
{
#define MR_PROC_LABEL mercury__string__IntroducedFrom__func__word_wrap_loop__4980__1_2_f_0
