...
string.builder.optdate string.builder.trans_opt_date string.builder.err string.builder.c_date string.builder.s_date string.builder.pic_s_date string.builder.java_date : string.builder.m \
	string.int0 \
	assoc_list.int \
	builtin.int \
	char.int \
...
string.builder.trans_opt_date string.builder.err string.builder.c_date string.builder.s_date string.builder.pic_s_date string.builder.java_date :  \
	string.builder.opt \
	assoc_list.opt \
	builtin.opt \
	char.opt \
...
string.builder.err string.builder.c_date string.builder.s_date string.builder.pic_s_date string.builder.java_date :  \
