      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__count_codepoints_loop_4_p_0(Text_22, (MR_Integer) 0, (MR_Integer) 0, &Var_50);
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = mercury__pprint__fits_flat_width_left_3_p_0(DocA_55, Var_41, &_WidthLeft_60);
              if (succeeded)
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__from_char_list_2_p_0(Var_63, &Var_31);
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = mercury__pprint__fits_flat_width_left_3_p_0(DocA_55, Var_41, &_WidthLeft_62);
              if (succeeded)
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__from_char_list_2_p_0(Var_65, &Var_31);
              mercury__string__append_3_p_2(AfterNlStr_11, Var_31, &NewAfterNlStr_18);
              // direct tailcall eliminated
              ;
              next_value_of_AfterNlStr_11 = NewAfterNlStr_18;
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__from_char_list_2_p_0(Var_77, &Var_31);
              mercury__string__append_3_p_2(AfterNlStr_11, Var_31, &NewAfterNlStr_18);
              // direct tailcall eliminated
              ;
              next_value_of_AfterNlStr_11 = NewAfterNlStr_18;
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                *STATE_VARIABLE_LayoutStream_26 = base;
                ...
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_LayoutStream_39_39));
              }
            }
            break;
        }
