...
MR_decl_label10(fn__pprint__packed_3_0, 52,8,7,10,11,12,5,16,17,19)
...
MR_decl_label6(fn__pprint__separated_3_0, 28,4,8,9,10,11)
...
MR_BEGIN_MODULE(pprint_module17)
	...
	MR_init_label10(fn__pprint__packed_3_0,52,8,7,10,11,12,5,16,17,19)
...
MR_BEGIN_MODULE(pprint_module23)
	...
	MR_init_label6(fn__pprint__separated_3_0,28,4,8,9,10,11)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__pprint__separated_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(fn__pprint__separated_3_0_i28);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__pprint__separated_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_def_label(pprint__lb_8_0,34)
	...
	if (MR_INT_EQ(MR_tfield(3, MR_r6, 0),1)) {
		MR_GOTO_LAB(pprint__lb_8_0_i27);
	}
	if (MR_INT_EQ(MR_tfield(3, MR_r6, 0),2)) {
