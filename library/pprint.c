              ...
              case (MR_Integer) 1:
                {
                  MR_String mercury__pprint__T_54 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__pprint__HeadVar__4_4, (MR_Integer) 1)));
                  MR_Integer mercury__pprint__V_57_57;
                  MR_Box mercury__pprint__V_5_77;
                  MR_Box mercury__pprint__V_8_78;
...
#define MR_PROC_LABEL mercury__pprint__layout_flat__ho49_6_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__pprint__V_5_77  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__pprint__layout_flat__ho49_6_p_0
	...
	Stream = (MercuryFilePtr) mercury__pprint__V_5_77 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__pprint__V_8_78 );
}
                  {
                    mercury__io__throw_on_error_4_p_0(mercury__pprint__V_8_78, (MR_String) "error writing to output file: ");
                  }
                }
                break;
              case (MR_Integer) 2:
