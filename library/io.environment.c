...
static /* final */ const MR_Box mercury__io__environment_scalar_common_5[1][1];
  ...
  MR_Word * STATE_VARIABLE_EnvVarAL_9)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (EnvVarName_5));
    MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (EnvVarValue_6));
  }
  {
    MR_Word base;
    ...
    *STATE_VARIABLE_EnvVarAL_9 = base;
    ...
    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_EnvVarAL_0_8));
  }
}
  ...
  MR_Word * STATE_VARIABLE_EnvVarAL_12)
{
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (EnvVarName_7));
      MR_hl_field(MR_mktag(0), Var_15, 1) = ((MR_Box) (EnvVarValue_10));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_EnvVarAL_12 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_EnvVarAL_0_11));
    }
  }
  else
    {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    *Res_8 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__io__environment_scalar_common_5[0]));
}
