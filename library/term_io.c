      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__io__write_int_3_p_0(mercury__term_io__I_5);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Box mercury__term_io__V_5_72;
          MR_Box mercury__term_io__V_8_73;
          MR_Box mercury__term_io__V_5_90;
          MR_Box mercury__term_io__V_8_91;
...
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_72  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_72 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_73 );
}
          {
            mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_73, (MR_String) "error writing to output file: ");
          }
{
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_90  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_90 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_91 );
}
          {
            mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_91, (MR_String) "error writing to output file: ");
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                mercury__io__write_float_3_p_0(mercury__term_io__F_22);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              {
                mercury__io__write_string_3_p_0(mercury__term_io__N_40);
              }
            }
            break;
        }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mercury__term_io__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Box mercury__term_io__V_5_52;
            MR_Box mercury__term_io__V_8_53;
            MR_Integer mercury__term_io__V_70_70;
            MR_Box MR_CALL (* mercury__term_io__func_0)(MR_Box, MR_Box);
            MR_Box mercury__term_io__conv1_V_70_70;
...
#define MR_PROC_LABEL mercury__term_io__write_term_args_8_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_52  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_term_args_8_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_52 ;
	Message =  (MR_String) ", " ;
		{
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_53 );
}
            {
              mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_53, (MR_String) "error writing to output file: ");
            }
            ...
            {
              mercury__term_io__conv1_V_70_70 = mercury__term_io__func_0(((MR_Box) mercury__term_io__TypeClassInfo_for_op_table_39), mercury__term_io__Ops_1);
            }
            mercury__term_io__V_70_70 = ((MR_Integer) mercury__term_io__conv1_V_70_70);
            {
              mercury__term_io__write_term_3_9_p_0(mercury__term_io__TypeInfo_for_T_40, mercury__term_io__TypeClassInfo_for_op_table_39, mercury__term_io__Ops_1, mercury__term_io__X_20, mercury__term_io__V_70_70, mercury__term_io__STATE_VARIABLE_VarSet_0_3, &mercury__term_io__STATE_VARIABLE_VarSet_33_33, mercury__term_io__STATE_VARIABLE_N_0_5, &mercury__term_io__STATE_VARIABLE_N_34_34);
            }
            /* direct tailcall eliminated */
            {
            ...
            if (mercury__term_io__succeeded)
              {
                ...
                MR_Box mercury__term_io__V_5_79;
                MR_Box mercury__term_io__V_8_80;
...
#define MR_PROC_LABEL mercury__term_io__write_list_tail_8_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_79  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_list_tail_8_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_79 ;
	Message =  (MR_String) ", " ;
		{
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_80 );
}
                {
                  mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_80, (MR_String) "error writing to output file: ");
                }
                {
                  mercury__term_io__write_arg_term_8_p_0(mercury__term_io__TypeInfo_for_T_52, mercury__term_io__TypeClassInfo_for_op_table_51, mercury__term_io__Ops_9, mercury__term_io__ListHead_17, mercury__term_io__STATE_VARIABLE_VarSet_0_21, &mercury__term_io__STATE_VARIABLE_VarSet_37_37, mercury__term_io__STATE_VARIABLE_N_0_23, &mercury__term_io__STATE_VARIABLE_N_38_38);
                }
                /* direct tailcall eliminated */
                {
...
{
  {
    ...
    if (mercury__term_io__succeeded)
    ...
    else
      {
        ...
        if (mercury__term_io__succeeded)
          {
            MR_Box mercury__term_io__V_5_76;
            MR_Box mercury__term_io__V_8_77;
...
#define MR_PROC_LABEL mercury__term_io__write_variable_2_8_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_76  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_variable_2_8_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_76 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_77 );
}
            {
              mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_77, (MR_String) "error writing to output file: ");
            }
        ...
        else
          {
            ...
            *mercury__term_io__STATE_VARIABLE_N_22 = (mercury__term_io__STATE_VARIABLE_N_0_21 + (MR_Integer) 1);
            {
              mercury__io__write_string_3_p_0(mercury__term_io__VarName_18);
            }
          }
      }
  }
...
{
  {
    ...
    MR_Box mercury__term_io__V_5_44;
    MR_Box mercury__term_io__V_8_45;
...
#define MR_PROC_LABEL mercury__term_io__quote_char_3_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_44  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__quote_char_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_44 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_45 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_45, (MR_String) "error writing to output file: ");
    }
  }
}
...
{
  {
    ...
    MR_Integer mercury__term_io__V_42_42;
    MR_Box mercury__term_io__V_5_55;
    MR_Box mercury__term_io__V_8_56;
...
#define MR_PROC_LABEL mercury__term_io__write_term_nl_with_op_table_5_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_5_55  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__term_io__write_term_nl_with_op_table_5_p_0
	...
	Stream = (MercuryFilePtr) mercury__term_io__V_5_55 ;
	Message =  (MR_String) ".\n" ;
		{
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__term_io__V_8_56 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__term_io__V_8_56, (MR_String) "error writing to output file: ");
    }
  }
}
...
{
  {
    ...
    mercury__term_io__TypeClassInfo_for_op_table_14 = (MR_Word) &mercury__term_io_scalar_common_1[0];
    {
      mercury__term_io__write_term_nl_with_op_table_5_p_0(mercury__term_io__TypeInfo_for_T_13, mercury__term_io__TypeClassInfo_for_op_table_14, ((MR_Box) ((MR_Integer) 0)), mercury__term_io__VarSet_5, mercury__term_io__Term_6);
    }
  }
}
