...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), V_5_36, 1) = ((MR_Box) ((MR_Integer) 0));
      }
	 ...
	 Var_42  = Int;
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), V_5_50, 1) = ((MR_Box) ((MR_Integer) 0));
        }
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      V_13_52 = V_17_53;
    mercury__term_io__foldl_between_2__ho30_6_p_in__string_0(String_3, (MR_Integer) 0, V_13_52, (MR_Word) ((MR_Integer) 0), &Var_5);
      ...
      if (((MR_tag((MR_Word) Term_13)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              succeeded = (Args_21 == (MR_Word) ((MR_Integer) 0));
          }
          if (succeeded)
          {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = (Var_132 == (MR_Word) ((MR_Integer) 0));
                          if (succeeded)
                          {
                            succeeded = ((MR_tag((MR_Word) Functor_20)) == (MR_mktag((MR_Integer) 0)));
                            if (succeeded)
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          if ((Args_21 == (MR_Word) ((MR_Integer) 0)))
                          {
                            STATE_VARIABLE_VarSet_52 = STATE_VARIABLE_VarSet_0_51;
                            STATE_VARIABLE_N_54 = STATE_VARIABLE_N_0_53;
                          }
