  ...
  MR_Word Term_10)
{
  ...
  conv1_Var_21 = func_0(((MR_Box) (TypeClassInfo_for_op_table_16)), Ops_8);
...
#undef MR_PROC_LABEL
  ...
  conv1_Var_22 = func_0(((MR_Box) (TypeClassInfo_for_op_table_14)), Ops_6);
  ...
  MR_Word Term_10)
{
  ...
  conv1_Var_19 = func_0(((MR_Box) (TypeClassInfo_for_op_table_17)), Ops_8);
...
#undef MR_PROC_LABEL
  ...
  OutStream_10 = (MR_Word) (Var_16);
  func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_op_table_14, (MR_Integer) 0)), (MR_Integer) 12))));
  conv1_Var_20 = func_0(((MR_Box) (TypeClassInfo_for_op_table_14)), Ops_6);
...
#undef MR_PROC_LABEL
  ...
  Var_20 = ((MR_Word) (conv1_Var_20));
  mercury__term_io__write_term_prio_anon_vars_10_p_0(TypeInfo_for_T_12, (MR_Word) (&mercury__term_io_scalar_common_1[0]), OutStream_8, ((MR_Box) ((MR_Integer) 0)), Term_6, Var_20, VarSet_5, &Var_17, (MR_Integer) 0, &Var_18);
}
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = mercury__ops__lookup_prefix_op_4_p_0(TypeClassInfo_for_op_table_203, Ops_12, OpName_32, &OpPriority_33, &OpGtOrGe_34);
                    }
                  }
                }
                if (succeeded)
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = mercury__ops__lookup_postfix_op_4_p_0(TypeClassInfo_for_op_table_203, Ops_12, OpName_189, &OpPriority_199, &OpGtOrGe_200);
                      }
                    }
                  }
                  if (succeeded)
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            succeeded = mercury__ops__lookup_infix_op_5_p_0(TypeClassInfo_for_op_table_203, Ops_12, OpName_196, &OpPriority_197, &LeftGtOrGe_39, &RightGtOrGe_40);
                          }
                        }
                      }
                    }
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = mercury__ops__lookup_binary_prefix_op_5_p_0(TypeClassInfo_for_op_table_203, Ops_12, OpName_191, &OpPriority_193, &FirstGtOrGe_44, &SecondGtOrGe_45);
                            }
                          }
                        }
                      }
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              Var_171 = mercury__ops__loosest_op_priority_1_f_0(TypeClassInfo_for_op_table_203, Ops_12);
...
top_of_proc_2:;
  {
    ...
    if (succeeded)
    {
      ...
      conv18_Var_42 = func_17(((MR_Box) (TypeClassInfo_for_op_table_32)), Ops_11);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          conv4_Var_61 = func_3(((MR_Box) (TypeClassInfo_for_op_table_50)), Ops_11);
