...
{
  {
    ...
    if (mercury__term_io__succeeded)
      {
        MR_Integer mercury__term_io__V_65_65;
        MR_Integer mercury__term_io__V_69_69;

        {
          mercury__term_io__V_69_69 = mercury__ops__max_priority_1_f_0(mercury__term_io__TypeClassInfo_for_op_table_36, mercury__term_io__Ops_11);
        }
        mercury__term_io__V_65_65 = (mercury__term_io__V_69_69 + (MR_Integer) 1);
        {
          mercury__term_io__write_term_3_10_p_0(mercury__term_io__TypeInfo_for_T_37, mercury__term_io__TypeClassInfo_for_op_table_36, mercury__term_io__OutStream_10, mercury__term_io__Ops_11, mercury__term_io__Val_16, mercury__term_io__V_65_65, mercury__term_io__STATE_VARIABLE_VarSet_0_21, mercury__term_io__STATE_VARIABLE_VarSet_22, mercury__term_io__STATE_VARIABLE_N_0_23, mercury__term_io__STATE_VARIABLE_N_24);
        }
      }
    else
      {
