...
static /* final */ const struct mercury__term_io__vector_common_type_7_0_s mercury__term_io_vector_common_7[44] = {
  ...
  /* row 16 */   {     (MR_String) "" },
  /* row 17 */   {     (MR_String) "i8" },
  /* row 18 */   {     (MR_String) "i16" },
  /* row 19 */   {     (MR_String) "i32" },
  /* row 20 */   {     (MR_String) "i64" },
  /* row 21 */   {     (MR_String) "u" },
  /* row 22 */   {     (MR_String) "u8" },
  /* row 23 */   {     (MR_String) "u16" },
  /* row 24 */   {     (MR_String) "u32" },
  /* row 25 */   {     (MR_String) "u64" },
  /* row 26 */   {     (MR_String) "0b" },
  /* row 27 */   {     (MR_String) "0o" },
  /* row 28 */   {     (MR_String) "" },
  /* row 29 */   {     (MR_String) "0x" },
  /* row 30 */   {     (MR_String) "" },
  /* row 31 */   {     (MR_String) "i8" },
  /* row 32 */   {     (MR_String) "i16" },
  /* row 33 */   {     (MR_String) "i32" },
  /* row 34 */   {     (MR_String) "i64" },
  /* row 35 */   {     (MR_String) "u" },
  /* row 36 */   {     (MR_String) "u8" },
  /* row 37 */   {     (MR_String) "u16" },
  /* row 38 */   {     (MR_String) "u32" },
  /* row 39 */   {     (MR_String) "u64" },
  /* row 40 */   {     (MR_String) "!" },
  /* row 41 */   {     (MR_String) ";" },
  /* row 42 */   {     (MR_String) "[]" },
  /* row 43 */   {     (MR_String) "{}" },
      ...
      do
        {
          ...
          mercury__term_io__result_3 = MR_strcmp(mercury__term_io__S_7, ((&mercury__term_io_vector_common_7[40 + mercury__term_io__mid_2]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0);
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) mercury__term_io__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String mercury__term_io__Var_12 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Integer mercury__term_io__Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__3_3, (MR_Integer) 1)));
	 ...
	 mercury__term_io__V_7_46  = Res;
                  ...
                  if (mercury__term_io__succeeded)
                    *mercury__term_io__HeadVar__1_1 = mercury__term_io__Var_14;
                    ...
                    {
                      mercury__term_io__succeeded = (mercury__term_io__Var_39 < mercury__term_io__Var_13);
                      if (mercury__term_io__succeeded)
                        *mercury__term_io__HeadVar__1_1 = (MR_Integer) 1;
                      else
                        {
        ...
        case (MR_Integer) 2:
          {
            ...
            switch (MR_tag((MR_Word) mercury__term_io__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word mercury__term_io__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Word mercury__term_io__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__3_3, (MR_Integer) 1)));
                  MR_Word mercury__term_io__Var_29;

                  {
                    mercury__varset____Compare____varset_1_0(mercury__term_io__TypeInfo_for_T_32, &mercury__term_io__Var_29, mercury__term_io__Var_42, mercury__term_io__Var_27);
                  }
                  ...
                  if (mercury__term_io__succeeded)
                    *mercury__term_io__HeadVar__1_1 = mercury__term_io__Var_29;
                    ...
                    {
                      mercury__term____Compare____term_1_0(mercury__term_io__TypeInfo_for_T_32, mercury__term_io__HeadVar__1_1, mercury__term_io__Var_41, mercury__term_io__Var_28);
                    }
                }
                break;
            }
...
{
  {
    ...
    if (mercury__term_io__succeeded)
      ...
      switch (MR_tag((MR_Word) mercury__term_io__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String mercury__term_io__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)));
            MR_Integer mercury__term_io__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 1)));
            MR_String mercury__term_io__Var_7;
            MR_Integer mercury__term_io__Var_8;

            mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mercury__term_io__succeeded)
              {
                mercury__term_io__Var_7 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__2_2, (MR_Integer) 0)));
                mercury__term_io__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__2_2, (MR_Integer) 1)));
                mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_5, mercury__term_io__Var_7) == 0);
                if (mercury__term_io__succeeded)
                  mercury__term_io__succeeded = (mercury__term_io__Var_6 == mercury__term_io__Var_8);
              }
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word mercury__term_io__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word mercury__term_io__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__1_1, (MR_Integer) 1)));
            ...
            if (mercury__term_io__succeeded)
              {
                mercury__term_io__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__2_2, (MR_Integer) 0)));
                mercury__term_io__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__2_2, (MR_Integer) 1)));
                {
                  mercury__term_io__succeeded = mercury__varset____Unify____varset_1_0(mercury__term_io__TypeInfo_for_T_15, mercury__term_io__Var_9, mercury__term_io__Var_11);
                }
                if (mercury__term_io__succeeded)
                  {
                    mercury__term_io__succeeded = mercury__term____Unify____term_1_0(mercury__term_io__TypeInfo_for_T_15, mercury__term_io__Var_10, mercury__term_io__Var_12);
                  }
              }
          }
          break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) mercury__term_io__HeadVar__1_1)) {
      ...
      case (MR_Integer) 0:
        {
          MR_String mercury__term_io__A_16 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)));

          {
            mercury__term_io__HeadVar__3_3 = mercury__term_io__quoted_atom_agt_2_f_0(mercury__term_io__A_16, mercury__term_io__NextToGraphicToken_2);
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word mercury__term_io__Base_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)));
          MR_Word mercury__term_io__I_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 1)));
          MR_Word mercury__term_io__Signedness_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 2)));
          MR_Word mercury__term_io__Size_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__1_1, (MR_Integer) 3)));
          MR_String mercury__term_io__Var_9 = ((&mercury__term_io_vector_common_7[26 + mercury__term_io__Base_4]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
          MR_String mercury__term_io__Var_10;
          MR_String mercury__term_io__Var_11;
          MR_Integer mercury__term_io__Var_12 = ((&mercury__term_io_vector_common_6[8 + mercury__term_io__Base_4]))->mercury__term_io__vector_common_type_6_0__vct_6_f_0;
          MR_String mercury__term_io__Var_13;

          {
            mercury__term_io__Var_11 = mercury__integer__to_base_string_2_f_0(mercury__term_io__I_5, mercury__term_io__Var_12);
          }
          switch (mercury__term_io__Signedness_6) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                mercury__term_io__Var_13 = ((&mercury__term_io_vector_common_7[30 + mercury__term_io__Size_7]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
              }
              break;
            case (MR_Integer) 1:
              {
                mercury__term_io__Var_13 = ((&mercury__term_io_vector_common_7[35 + mercury__term_io__Size_7]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
              }
              break;
          }
          {
            mercury__string__append_3_p_2(mercury__term_io__Var_11, mercury__term_io__Var_13, &mercury__term_io__Var_10);
          }
          {
            mercury__string__append_3_p_2(mercury__term_io__Var_9, mercury__term_io__Var_10, &mercury__term_io__HeadVar__3_3);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_String mercury__term_io__S_18 = ((MR_String) (MR_hl_field(MR_mktag(2), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)));

          {
            mercury__term_io__HeadVar__3_3 = mercury__term_io__quoted_string_1_f_0(mercury__term_io__S_18);
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), mercury__term_io__HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Float mercury__term_io__F_14 = MR_unbox_float((MR_hl_field(MR_mktag(3), mercury__term_io__HeadVar__1_1, (MR_Integer) 1)));
...
#undef MR_PROC_LABEL
	 mercury__term_io__HeadVar__3_3  = Str;
          ...
          case (MR_Integer) 1:
            {
              MR_String mercury__term_io__N_20 = ((MR_String) (MR_hl_field(MR_mktag(3), mercury__term_io__HeadVar__1_1, (MR_Integer) 1)));

              {
                mercury__string__append_3_p_2((MR_String) "\044", mercury__term_io__N_20, &mercury__term_io__HeadVar__3_3);
              }
            }
            break;
        }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            mercury__term_io__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_113_117_111_116_101_95_97_116_111_109_95_97_103_116_95_95_91_83_116_114_101_97_109_32_61_32_105_111_46_111_117_116_112_117_116_95_115_116_114_101_97_109_44_32_83_116_97_116_101_32_61_32_105_111_46_115_116_97_116_101_93_95_48_95_49_5_p_0(mercury__term_io__TypeClassInfo_for_writer_33, mercury__term_io__TypeClassInfo_for_writer_34, mercury__term_io__OutStream_6, mercury__term_io__A_18, mercury__term_io__NextToGraphicToken_8);
          }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_String mercury__term_io__Prefix_14 = ((&mercury__term_io_vector_common_7[12 + mercury__term_io__Base_10]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
          MR_String mercury__term_io__IntString_15;
          MR_String mercury__term_io__Suffix_16;
          MR_Integer mercury__term_io__Var_29 = ((&mercury__term_io_vector_common_6[4 + mercury__term_io__Base_10]))->mercury__term_io__vector_common_type_6_0__vct_6_f_0;
          ...
          switch (mercury__term_io__Signedness_12) {
            ...
            case (MR_Integer) 0:
              {
                mercury__term_io__Suffix_16 = ((&mercury__term_io_vector_common_7[16 + mercury__term_io__Size_13]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
              }
              break;
            case (MR_Integer) 1:
              {
                mercury__term_io__Suffix_16 = ((&mercury__term_io_vector_common_7[21 + mercury__term_io__Size_13]))->mercury__term_io__vector_common_type_7_0__vct_7_f_0;
              }
              break;
          }
          {
        ...
        if (mercury__term_io__succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word mercury__term_io__next_value_of_Term_12 = mercury__term_io__Val_18;
            ...
            if (mercury__term_io__succeeded)
              {
                ...
                {
                  mercury__term_io__write_term_3_10_p_0(mercury__term_io__TypeInfo_for_T_54, mercury__term_io__TypeClassInfo_for_op_table_53, mercury__term_io__OutStream_10, mercury__term_io__Ops_11, mercury__term_io__ListHead_19, mercury__term_io__Var_82, mercury__term_io__STATE_VARIABLE_VarSet_0_23, &mercury__term_io__STATE_VARIABLE_VarSet_39_39, mercury__term_io__STATE_VARIABLE_N_0_25, &mercury__term_io__STATE_VARIABLE_N_40_40);
                }
                /* direct tailcall eliminated */
                {
    ...
    if (((MR_tag((MR_Word) mercury__term_io__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        MR_Word mercury__term_io__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__term_io__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mercury__term_io__ListHead_37;
        MR_Word mercury__term_io__ListTail_38;
        MR_String mercury__term_io__Var_72;
        MR_Word mercury__term_io__Var_73;
        ...
        if (mercury__term_io__succeeded)
          {
            mercury__term_io__Var_72 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__Functor_30, (MR_Integer) 0)));
            mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_72, (MR_String) "[|]") == 0);
            if (mercury__term_io__succeeded)
              {
                ...
                if (mercury__term_io__succeeded)
                  {
                    ...
                    mercury__term_io__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Var_73)) == (MR_mktag((MR_Integer) 1)));
                    if (mercury__term_io__succeeded)
                      {
                        mercury__term_io__ListTail_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_73, (MR_Integer) 0)));
                        mercury__term_io__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_73, (MR_Integer) 1)));
        ...
        if (mercury__term_io__succeeded)
          ...
          {
            MR_String mercury__term_io__Var_85;

            mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
            if (mercury__term_io__succeeded)
              {
                mercury__term_io__Var_85 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__Functor_30, (MR_Integer) 0)));
                mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_85, (MR_String) "[]") == 0);
                if (mercury__term_io__succeeded)
            ...
            if (mercury__term_io__succeeded)
            ...
            else
              {
                ...
                MR_String mercury__term_io__Var_88;
                MR_Word mercury__term_io__Var_89;

                mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                if (mercury__term_io__succeeded)
                  {
                    mercury__term_io__Var_88 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__Functor_30, (MR_Integer) 0)));
                    mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_88, (MR_String) "{}") == 0);
                    if (mercury__term_io__succeeded)
                      {
                        mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Args_31)) == (MR_mktag((MR_Integer) 1)));
                        if (mercury__term_io__succeeded)
                          {
                            ...
                            mercury__term_io__Var_89 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                            mercury__term_io__succeeded = (mercury__term_io__Var_89 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                      }
                  }
                if (mercury__term_io__succeeded)
                ...
                else
                  {
                    ...
                    MR_String mercury__term_io__Var_97;

                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                    if (mercury__term_io__succeeded)
                      {
                        mercury__term_io__Var_97 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__Functor_30, (MR_Integer) 0)));
                        mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_97, (MR_String) "{}") == 0);
                        if (mercury__term_io__succeeded)
                          {
                            mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Args_31)) == (MR_mktag((MR_Integer) 1)));
                            if (mercury__term_io__succeeded)
                    ...
                    if (mercury__term_io__succeeded)
                    ...
                    else
                      {
                        ...
                        MR_String mercury__term_io__Var_108;
                        MR_Word mercury__term_io__Var_109;
                        MR_Word mercury__term_io__Var_110;
                        MR_Word mercury__term_io__Var_43;

                        mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                        if (mercury__term_io__succeeded)
                          {
                            mercury__term_io__Var_108 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__term_io__Functor_30, (MR_Integer) 0)));
                            mercury__term_io__succeeded = (strcmp(mercury__term_io__Var_108, (MR_String) "") == 0);
                            if (mercury__term_io__succeeded)
                              {
                                mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Args_31)) == (MR_mktag((MR_Integer) 1)));
                                if (mercury__term_io__succeeded)
                                  {
                                    mercury__term_io__Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 0)));
                                    mercury__term_io__Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Var_109)) == (MR_mktag((MR_Integer) 1)));
                                    if (mercury__term_io__succeeded)
                                      {
                                        mercury__term_io__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_109, (MR_Integer) 0)));
                                        mercury__term_io__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_109, (MR_Integer) 1)));
                                        mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Var_110)) == (MR_mktag((MR_Integer) 1)));
                                        if (mercury__term_io__succeeded)
                                          {
                                            mercury__term_io__FirstArg_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_110, (MR_Integer) 0)));
                                            mercury__term_io__OtherArgs_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_110, (MR_Integer) 1)));
                                          }
                                      }
                                  }
                              }
                        ...
                        if (mercury__term_io__succeeded)
                        ...
                        else
                          {
                            ...
                            MR_Word mercury__term_io__Var_124;

                            mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Args_31)) == (MR_mktag((MR_Integer) 1)));
                            if (mercury__term_io__succeeded)
                              {
                                mercury__term_io__PrefixArg_46 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 0)));
                                mercury__term_io__Var_124 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                                mercury__term_io__succeeded = (mercury__term_io__Var_124 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                if (mercury__term_io__succeeded)
                                  {
                                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                                    if (mercury__term_io__succeeded)
                            ...
                            if (mercury__term_io__succeeded)
                            ...
                            else
                              {
                                ...
                                MR_Word mercury__term_io__Var_135;
                                ...
                                if (mercury__term_io__succeeded)
                                  {
                                    ...
                                    mercury__term_io__Var_135 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                                    mercury__term_io__succeeded = (mercury__term_io__Var_135 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                    if (mercury__term_io__succeeded)
                                      {
                                        mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                                        if (mercury__term_io__succeeded)
                                ...
                                if (mercury__term_io__succeeded)
                                ...
                                else
                                  {
                                    ...
                                    MR_Word mercury__term_io__Var_146;
                                    MR_Word mercury__term_io__Var_147;

                                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Args_31)) == (MR_mktag((MR_Integer) 1)));
                                    if (mercury__term_io__succeeded)
                                      {
                                        mercury__term_io__Arg1_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 0)));
                                        mercury__term_io__Var_146 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                                        mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Var_146)) == (MR_mktag((MR_Integer) 1)));
                                        if (mercury__term_io__succeeded)
                                          {
                                            mercury__term_io__Arg2_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_146, (MR_Integer) 0)));
                                            mercury__term_io__Var_147 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_146, (MR_Integer) 1)));
                                            mercury__term_io__succeeded = (mercury__term_io__Var_147 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                            if (mercury__term_io__succeeded)
                                              {
                                                mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                                                if (mercury__term_io__succeeded)
                                    ...
                                    if (mercury__term_io__succeeded)
                                    ...
                                    else
                                      {
                                        ...
                                        MR_Word mercury__term_io__Var_166;
                                        MR_Word mercury__term_io__Var_167;
                                        ...
                                        if (mercury__term_io__succeeded)
                                          {
                                            ...
                                            mercury__term_io__Var_166 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Args_31, (MR_Integer) 1)));
                                            mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Var_166)) == (MR_mktag((MR_Integer) 1)));
                                            if (mercury__term_io__succeeded)
                                              {
                                                mercury__term_io__Arg2_207 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_166, (MR_Integer) 0)));
                                                mercury__term_io__Var_167 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__Var_166, (MR_Integer) 1)));
                                                mercury__term_io__succeeded = (mercury__term_io__Var_167 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                                if (mercury__term_io__succeeded)
                                                  {
                                                    mercury__term_io__succeeded = ((MR_tag((MR_Word) mercury__term_io__Functor_30)) == (MR_mktag((MR_Integer) 0)));
                                                    if (mercury__term_io__succeeded)
                                        ...
                                        if (mercury__term_io__succeeded)
                                        ...
                                        else
                                          {
                                            ...
                                            MR_Integer mercury__term_io__Var_183;
                                                ...
                                                if (mercury__term_io__succeeded)
                                                  {
                                                    ...
                                                    if (mercury__term_io__succeeded)
                                                      {
                                                        {
                                                          mercury__term_io__Var_183 = mercury__ops__max_priority_1_f_0(mercury__term_io__TypeClassInfo_for_op_table_214, mercury__term_io__Ops_2);
                                                        }
                                                        mercury__term_io__succeeded = (mercury__term_io__Priority_4 <= mercury__term_io__Var_183);
                                                      }
                                                  }
                                              }
                                            if (mercury__term_io__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__term_io__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__term_io__HeadVar__3_3, (MR_Integer) 1)));
...
{
  {
    ...
    if (mercury__term_io__succeeded)
      {
        MR_Integer mercury__term_io__Var_65;
        MR_Integer mercury__term_io__Var_69;

        {
          mercury__term_io__Var_69 = mercury__ops__max_priority_1_f_0(mercury__term_io__TypeClassInfo_for_op_table_36, mercury__term_io__Ops_11);
        }
        mercury__term_io__Var_65 = (mercury__term_io__Var_69 + (MR_Integer) 1);
        {
          mercury__term_io__write_term_3_10_p_0(mercury__term_io__TypeInfo_for_T_37, mercury__term_io__TypeClassInfo_for_op_table_36, mercury__term_io__OutStream_10, mercury__term_io__Ops_11, mercury__term_io__Val_16, mercury__term_io__Var_65, mercury__term_io__STATE_VARIABLE_VarSet_0_21, mercury__term_io__STATE_VARIABLE_VarSet_22, mercury__term_io__STATE_VARIABLE_N_0_23, mercury__term_io__STATE_VARIABLE_N_24);
        }
      }
    else
      {
        MR_String mercury__term_io__Name_17;
        MR_Word mercury__term_io__TypeCtorInfo_12_78 = (MR_Word) &mercury__term__term__type_ctor_info_var_1;
        MR_Word mercury__term_io__TypeInfo_13_79;
        MR_Word mercury__term_io__TypeCtorInfo_14_80 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        MR_Word mercury__term_io__V_8_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__term_io__STATE_VARIABLE_VarSet_0_21, (MR_Integer) 1)));
        MR_Word mercury__term_io__V_7_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__term_io__STATE_VARIABLE_VarSet_0_21, (MR_Integer) 0)));
        MR_Word mercury__term_io__V_9_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__term_io__STATE_VARIABLE_VarSet_0_21, (MR_Integer) 2)));
        MR_Box mercury__term_io__conv1_Name_17;

        {
          mercury__term_io__TypeInfo_13_79 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), mercury__term_io__TypeInfo_13_79, 0) = ((MR_Box) (mercury__term_io__TypeCtorInfo_12_78));
          MR_hl_field(MR_mktag(0), mercury__term_io__TypeInfo_13_79, 1) = ((MR_Box) (mercury__term_io__TypeInfo_for_T_37));
        }
        {
          mercury__term_io__succeeded = mercury__tree234__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_p_0(mercury__term_io__TypeInfo_for_T_37, mercury__term_io__TypeInfo_13_79, mercury__term_io__TypeCtorInfo_14_80, mercury__term_io__V_8_75, mercury__term_io__Id_12, &mercury__term_io__conv1_Name_17);
        }
        if (mercury__term_io__succeeded)
          {
...
{
  {
    ...
    {
      mercury__term_io__write_variable_2_9_p_0(mercury__term_io__TypeInfo_for_T_19, mercury__term_io__TypeClassInfo_for_op_table_18, mercury__term_io__OutStream_7, mercury__term_io__Ops_8, mercury__term_io__Variable_9, mercury__term_io__VarSet_10, &mercury__term_io__Var_12, (MR_Integer) 0, &mercury__term_io__Var_13);
    }
  }
}
...
#undef MR_PROC_LABEL
    ...
    {
      mercury__term_io__write_variable_2_9_p_0(mercury__term_io__TypeInfo_for_T_16, mercury__term_io__TypeClassInfo_for_op_table_15, mercury__term_io__OutStream_10, mercury__term_io__Ops_6, mercury__term_io__Variable_7, mercury__term_io__VarSet_8, &mercury__term_io__Var_27, (MR_Integer) 0, &mercury__term_io__Var_28);
    }
  }
}
...
{
  {
    ...
    {
      mercury__term_io__write_variable_2_9_p_0(mercury__term_io__TypeInfo_for_T_15, mercury__term_io__TypeClassInfo_for_op_table_16, mercury__term_io__OutStream_6, ((MR_Box) ((MR_Integer) 0)), mercury__term_io__Variable_7, mercury__term_io__VarSet_8, &mercury__term_io__Var_27, (MR_Integer) 0, &mercury__term_io__Var_28);
    }
  }
}
...
#undef MR_PROC_LABEL
    ...
    {
      mercury__term_io__write_variable_2_9_p_0(mercury__term_io__TypeInfo_for_T_13, mercury__term_io__TypeClassInfo_for_op_table_26, mercury__term_io__OutStream_8, ((MR_Box) ((MR_Integer) 0)), mercury__term_io__Variable_5, mercury__term_io__VarSet_6, &mercury__term_io__Var_37, (MR_Integer) 0, &mercury__term_io__Var_38);
    }
  }
}
