      ...
      case (MR_Integer) 2:
        {
          ...
          {
            mercury__io__write_string_3_p_0(mercury__term_io__Prefix_15);
          }
          {
            mercury__io__write_string_3_p_0(mercury__term_io__IntString_16);
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word mercury__term_io__V_8_83;
              MR_String mercury__term_io__V_6_87;
...
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__term_io__V_8_73 , Error);
		{
...
#define MR_PROC_LABEL mercury__term_io__write_constant_4_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_6_87  = Msg;
}
                  mercury__term_io__succeeded = MR_TRUE;
                }
              if (mercury__term_io__succeeded)
                {
                  mercury__term_io__V_8_83 = (MR_Word) mercury__term_io__V_6_87;
                  mercury__term_io__succeeded = MR_TRUE;
                }
              if (mercury__term_io__succeeded)
                {
                  MR_Word mercury__term_io__TypeCtorInfo_10_84 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

                  {
                    mercury__exception__throw_1_p_0(mercury__term_io__TypeCtorInfo_10_84, ((MR_Box) (mercury__term_io__V_8_83)));
                    return;
                  }
                }
              else
    ...
    if (mercury__term_io__succeeded)
    ...
    else
      {
        ...
        if (mercury__term_io__succeeded)
          {
            {
              mercury__io__write_string_3_p_0(mercury__term_io__Name_15);
            }
...
{
  {
    ...
    {
      mercury__io__write_string_3_p_0(mercury__term_io__V_8_8);
    }
  }
}
  ...
  MR_Word * mercury__term_io__Result_6)
{
  {
    MR_bool mercury__term_io__succeeded;
    MR_Word mercury__term_io__V_8_17;
    MR_Box mercury__term_io__V_4_21;
...
#define MR_PROC_LABEL mercury__term_io__read_term_with_op_table_4_p_0
    ...
    Stream = mercury_current_text_input();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_4_21  = (MR_Box) Stream;
}
    mercury__term_io__V_8_17 = (MR_Word) mercury__term_io__V_4_21;
    {
      mercury__parser__read_term_with_op_table_5_p_0(mercury__term_io__TypeInfo_for_T_12, mercury__term_io__TypeClassInfo_for_op_table_11, mercury__term_io__V_8_17, mercury__term_io__Ops_5, mercury__term_io__Result_6);
    }
  }
}
...
{
  {
    ...
    MR_Word mercury__term_io__V_8_26;
    MR_Box mercury__term_io__V_4_30;
...
#define MR_PROC_LABEL mercury__term_io__read_term_3_p_0
    ...
    Stream = mercury_current_text_input();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__term_io__V_4_30  = (MR_Box) Stream;
}
    mercury__term_io__V_8_26 = (MR_Word) mercury__term_io__V_4_30;
    {
      mercury__parser__read_term_with_op_table_5_p_0(mercury__term_io__TypeInfo_for_T_11, mercury__term_io__TypeClassInfo_for_op_table_12, mercury__term_io__V_8_26, ((MR_Box) ((MR_Integer) 0)), mercury__term_io__Result_4);
    }
  }
}
