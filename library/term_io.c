...
MR_decl_label5(__Unify___term_io__read_term_1_0, 45,8,4,47,1)
MR_decl_label2(__Compare___term_io__adjacent_to_graphic_token_0_0, 2,3)
MR_decl_label8(__Compare___term_io__read_term_1_0, 23,100,29,96,99,46,7,10)
MR_decl_label6(__Compare___term_io__read_term_1_0, 11,14,97,50,17,95)
...
MR_BEGIN_MODULE(term_io_module43)
	...
	MR_init_label5(__Unify___term_io__read_term_1_0,45,8,4,47,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___term_io__read_term_1_0);
	...
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Unify___term_io__read_term_1_0_i4);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(__Unify___term_io__read_term_1_0_i45);
	}
	MR_r1 = (MR_r3 == MR_r2);
	MR_proceed();
MR_def_label(__Unify___term_io__read_term_1_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(__Unify___varset__varset_1_0,
		__Unify___term_io__read_term_1_0_i8);
...
MR_def_label(__Unify___term_io__read_term_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,1)) {
		MR_GOTO_LAB(__Unify___term_io__read_term_1_0_i47);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr3 = MR_r2;
...
MR_def_label(__Unify___term_io__read_term_1_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(term_io_module44)
	...
	MR_init_label8(__Compare___term_io__read_term_1_0,23,100,29,96,99,46,7,10)
	MR_init_label6(__Compare___term_io__read_term_1_0,11,14,97,50,17,95)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___term_io__read_term_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i96);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i23);
	}
	if (MR_PTAG_TEST(MR_r3,1)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i97);
	}
	...
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___term_io__read_term_1_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r3,1)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i99);
	}
	if (MR_PTAG_TEST(MR_r3,2)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i100);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___term_io__read_term_1_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___term_io__read_term_1_0_i29);
MR_def_label(__Compare___term_io__read_term_1_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i95);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___term_io__read_term_1_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	if (MR_PTAG_TEST(MR_r3,1)) {
	...
	MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i46);
MR_def_label(__Compare___term_io__read_term_1_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(__Compare___term_io__read_term_1_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i10);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i14);
	}
MR_def_label(__Compare___term_io__read_term_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
...
MR_def_label(__Compare___term_io__read_term_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___term_io__read_term_1_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i95);
	}
	if (((MR_Integer) MR_sv(2) >= (MR_Integer) MR_sv(1))) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i17);
	}
	MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i50);
MR_def_label(__Compare___term_io__read_term_1_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(__Compare___term_io__read_term_1_0,50)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___term_io__read_term_1_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(2) != MR_sv(1))) {
		MR_GOTO_LAB(__Compare___term_io__read_term_1_0_i46);
	}
	MR_r1 = (MR_Integer) 0;
MR_def_label(__Compare___term_io__read_term_1_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
