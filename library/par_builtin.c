...
#line 155 "par_builtin.c"
#line 156 "par_builtin.c"

#endif
#line 159 "par_builtin.c"
...
MR_decl_label1(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0, 1)
...
MR_def_extern_entry(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0)
...
MR_BEGIN_MODULE(par_builtin_module5)
	MR_init_entry1(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0);
	MR_init_label1(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Integer	NumCPUs;
#define	MR_PROC_LABEL	mercury__par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
	NumCPUs = MR_r1;
{
#line 373 "par_builtin.m"
...
#endif
;}
#line 520 "par_builtin.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0_i1);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(par_builtin__par_cond_outstanding_jobs_vs_num_cpus_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
