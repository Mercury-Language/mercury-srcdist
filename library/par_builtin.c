...
extern const MR_TypeCtorInfo_Struct
	...
	mercury_data_par_builtin__type_ctor_info_loop_control_slot_0;
...
MR_def_extern_entry(__Unify___par_builtin__loop_control_slot_0_0)
MR_def_extern_entry(__Compare___par_builtin__loop_control_slot_0_0)
...
const MR_TypeCtorInfo_Struct mercury_data_par_builtin__type_ctor_info_loop_control_slot_0 = {
	0,
	15,
	-1,
	MR_TYPECTOR_REP_FOREIGN,
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Unify___par_builtin__loop_control_slot_0_0)),
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Compare___par_builtin__loop_control_slot_0_0)),
	"par_builtin",
	"loop_control_slot",
	{ 0 },
	{ 0 },
...
#define	MR_PROC_LABEL	mercury__par_builtin__signal_future_2_0
	...
	Value = MR_r2;
{
#line 197 "par_builtin.m"

    MR_par_builtin_signal_future(Future, Value);
;}
#line 353 "par_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__par_builtin__lc_join_and_terminate_2_0
	LC = (MR_LoopControl *) MR_r1;
	LCS = (MR_LoopControlSlot *) MR_r2;
{
#line 486 "par_builtin.m"
...
MR_BEGIN_MODULE(par_builtin_module15)
	MR_init_entry1(__Unify___par_builtin__loop_control_slot_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___par_builtin__loop_control_slot_0_0);
MR_BEGIN_CODE
...
/* code for '__Unify__'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Unify___par_builtin__loop_control_slot_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(__Unify___builtin__c_pointer_0_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(par_builtin_module16)
	MR_init_entry1(__Compare___par_builtin__loop_control_slot_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___par_builtin__loop_control_slot_0_0);
MR_BEGIN_CODE
...
/* code for '__Compare__'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Compare___par_builtin__loop_control_slot_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(__Compare___builtin__c_pointer_0_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(par_builtin_module17)
...
#line 948 "par_builtin.c"
#line 225 "par_builtin.m"
...
static void mercury__par_builtin_maybe_bunch_0(void)
{
	...
	par_builtin_module16();
	par_builtin_module17();
}
...
void mercury__par_builtin__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_par_builtin__type_ctor_info_loop_control_slot_0,
		par_builtin__loop_control_slot_0_0);
