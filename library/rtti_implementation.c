...
mercury__rtti_implementation__IntroducedFrom__pred__deconstruct_2__3074__4_6_p_0(
  ...
  MR_Integer LambdaHeadVar__3_113,
  MR_Integer * LambdaHeadVar__4_114);
      ...
      case (MR_Integer) 19:
        {
          ...
          if (succeeded)
          {
            ...
            Var_121 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_58, (MR_Integer) 1))));
            ...
            else
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (MR_Word) (Char_41));
                  MR_hl_field(MR_mktag(1), Var_102, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__rtti_implementation_scalar_common_4[0])));
                }
                {
                  Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (MR_Word) ((MR_Char) 39));
...
mercury__rtti_implementation__IntroducedFrom__func__deconstruct_2__3123__4_3_f_0(
  ...
  MR_Word LambdaHeadVar__2_126)
{
  MR_Word LambdaHeadVar__3_127;
  MR_Word Var_128;

  Var_128 = mercury__univ__univ_1_f_0(TypeInfo_175_175, LambdaHeadVar__1_125);
  {
    LambdaHeadVar__3_127 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), LambdaHeadVar__3_127, 0) = ((MR_Box) (Var_128));
    MR_hl_field(MR_mktag(1), LambdaHeadVar__3_127, 1) = ((MR_Box) (LambdaHeadVar__2_126));
  }
  return LambdaHeadVar__3_127;
}
  ...
  MR_Integer * LambdaHeadVar__4_114)
{
  ...
  mercury__rtti_implementation__get_tuple_subterm_4_p_0(TypeInfo_for_T_151, &TypeInfo_169_169, Term_10, LambdaHeadVar__3_113, LambdaHeadVar__1_111, &SubTerm_54);
  *LambdaHeadVar__2_112 = mercury__univ__univ_1_f_0(TypeInfo_169_169, SubTerm_54);
  *LambdaHeadVar__4_114 = (MR_Integer) ((MR_Unsigned) LambdaHeadVar__3_113 + (MR_Unsigned) 1);
}
...
#define MR_PROC_LABEL mercury__rtti_implementation__type_ctor_and_args_3_p_0
    ...
    TypeCtorRep = MR_type_ctor_rep(tci);
		...
		;}
#undef MR_PROC_LABEL
	TypeCtorRep_22  = TypeCtorRep;
}
  switch (TypeCtorRep_22) {
    default:
      succeeded = MR_FALSE;
      break;
    case (MR_Integer) 7:
