...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0(TypeInfo_for_T1_11, &Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      else
        mercury__builtin__compare_3_p_0(TypeInfo_for_T2_12, HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = X_4;
      MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = Y_5;
    }
    return HeadVar__3_3;
  }
}
...
{
  {
    MR_Box _X_8 = (MR_hl_field(MR_mktag(0), P_3, (MR_Integer) 0));

    *X_4 = (MR_hl_field(MR_mktag(0), P_3, (MR_Integer) 1));
  }
}
...
{
  {
    MR_Box Y_4 = (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1));
    MR_Box _X_3 = (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0));
...
{
  {
    ...
    *X_4 = (MR_hl_field(MR_mktag(0), P_3, (MR_Integer) 0));
    _Y_8 = (MR_hl_field(MR_mktag(0), P_3, (MR_Integer) 1));
  }
}
...
{
  {
    MR_Box X_3 = (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0));
    MR_Box _Y_4 = (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1));
