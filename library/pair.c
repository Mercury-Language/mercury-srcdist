...
{
  {
    ...
    if (mercury__pair__succeeded)
      *mercury__pair__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mercury__pair__ArgX1_4 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__2_2, (MR_Integer) 0));
        MR_Box mercury__pair__ArgY1_5 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__3_3, (MR_Integer) 0));
        MR_Box mercury__pair__ArgX2_6 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__2_2, (MR_Integer) 1));
        MR_Box mercury__pair__ArgY2_7 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__3_3, (MR_Integer) 1));
        MR_Word mercury__pair__Var_8;

        {
          mercury__builtin__compare_3_p_0(mercury__pair__TypeInfo_for_T1_11, &mercury__pair__Var_8, mercury__pair__ArgX1_4, mercury__pair__ArgY1_5);
        }
        ...
        if (mercury__pair__succeeded)
          *mercury__pair__HeadVar__1_1 = mercury__pair__Var_8;
          ...
          {
            mercury__builtin__compare_3_p_0(mercury__pair__TypeInfo_for_T2_12, mercury__pair__HeadVar__1_1, mercury__pair__ArgX2_6, mercury__pair__ArgY2_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mercury__pair__succeeded)
      ...
      {
        MR_Box mercury__pair__ArgX1_3 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__1_1, (MR_Integer) 0));
        MR_Box mercury__pair__ArgY1_4 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__2_2, (MR_Integer) 0));
        MR_Box mercury__pair__ArgX2_5 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__1_1, (MR_Integer) 1));
        MR_Box mercury__pair__ArgY2_6 = (MR_hl_field(MR_mktag(0), mercury__pair__HeadVar__2_2, (MR_Integer) 1));

        {
          mercury__pair__succeeded = mercury__builtin__unify_2_p_0(mercury__pair__TypeInfo_for_T1_9, mercury__pair__ArgX1_3, mercury__pair__ArgY1_4);
        }
        if (mercury__pair__succeeded)
          {
            mercury__pair__succeeded = mercury__builtin__unify_2_p_0(mercury__pair__TypeInfo_for_T2_10, mercury__pair__ArgX2_5, mercury__pair__ArgY2_6);
          }
      }
    return mercury__pair__succeeded;
  }
