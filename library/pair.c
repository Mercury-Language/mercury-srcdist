...
MR_decl_label2(__Unify___pair__pair_1_0, 2,1)
MR_decl_label2(__Unify___pair__pair_2_0, 2,1)
MR_decl_label2(__Compare___pair__pair_2_0, 3,7)
...
MR_BEGIN_MODULE(pair_module5)
	...
	MR_init_label2(__Unify___pair__pair_1_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___pair__pair_1_0);
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___pair__pair_1_0_i2);
MR_def_label(__Unify___pair__pair_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___pair__pair_1_0_i1);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Unify___pair__pair_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(pair_module7)
	...
	MR_init_label2(__Unify___pair__pair_2_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___pair__pair_2_0);
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___pair__pair_2_0_i2);
MR_def_label(__Unify___pair__pair_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(pair_module8)
	...
	MR_init_label2(__Compare___pair__pair_2_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___pair__pair_2_0);
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___pair__pair_2_0_i3);
MR_def_label(__Compare___pair__pair_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___pair__pair_2_0_i7);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___pair__pair_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__pair__write_out_proc_statics(FILE *fp);
#endif
