  ...
  MR_Word * KVs_6)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo__33_33, 0) = ((MR_Box) (&mercury__list__list__type_ctor_info_list_1));
      MR_hl_field(MR_mktag(0), TypeInfo__33_33, 1) = ((MR_Box) (TypeInfo_for_K_30));
    }
{
#define MR_PROC_LABEL mercury__kv_list__from_corresponding_lists_3_p_0
	...
	TypeInfo_for_T = TypeInfo__33_33 ;
...
#undef MR_PROC_LABEL
...
}
    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo__34_34, 0) = ((MR_Box) (&mercury__list__list__type_ctor_info_list_1));
      MR_hl_field(MR_mktag(0), TypeInfo__34_34, 1) = ((MR_Box) (TypeInfo_for_V_31));
    }
{
#define MR_PROC_LABEL mercury__kv_list__from_corresponding_lists_3_p_0
	...
	TypeInfo_for_T = TypeInfo__34_34 ;
	TypeInfo_In_1 = TypeInfo_for_T;
		{
{
    TypeInfo = TypeInfo_for_T;
