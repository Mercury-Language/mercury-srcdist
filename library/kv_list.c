  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_24 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 2))));
      MR_Box Var_25 = (MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1));
      MR_Box Var_26 = (MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0));
      ...
      else
      {
        ...
        MR_Box ArgY2_14 = (MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1));
