...
struct mercury__kv_list__foldl_4_p_6_env_0_s {
  ...
  MR_Box * mercury__kv_list__foldl_4_p_6_env_0__STATE_VARIABLE_A_4;
  ...
  MR_Box mercury__kv_list__foldl_4_p_6_env_0__STATE_VARIABLE_A_16_16;
};
...
{
  {
    ...
    (env).mercury__kv_list__foldl_4_p_6_env_0__STATE_VARIABLE_A_4 = STATE_VARIABLE_A_4;
    (env).mercury__kv_list__foldl_4_p_6_env_0__cont = cont;
    (env).mercury__kv_list__foldl_4_p_6_env_0__cont_env_ptr = cont_env_ptr;
    if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      *((env).mercury__kv_list__foldl_4_p_6_env_0__STATE_VARIABLE_A_4) = STATE_VARIABLE_A_0_3;
    ...
    else
    {
      ...
      func_0(((MR_Box) ((env).mercury__kv_list__foldl_4_p_6_env_0__HeadVar__1_1)), K_10, V_11, STATE_VARIABLE_A_0_3, &(env).mercury__kv_list__foldl_4_p_6_env_0__STATE_VARIABLE_A_16_16, mercury__kv_list__foldl_4_p_6_1, &env);
    }
  }
}
  ...
  MR_Box * STATE_VARIABLE_A_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = func_0(((MR_Box) (HeadVar__1_1)), K_10, V_11, STATE_VARIABLE_A_0_3, &STATE_VARIABLE_A_16_16);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Box * STATE_VARIABLE_A_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      func_0(((MR_Box) (HeadVar__1_1)), K_10, V_11, STATE_VARIABLE_A_0_3, &STATE_VARIABLE_A_16_16);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = TailKVs_12;
      next_value_of_STATE_VARIABLE_A_0_3 = STATE_VARIABLE_A_16_16;
  ...
  MR_Box HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_A_14_14 = func_0(((MR_Box) (HeadVar__1_1)), K_8, V_9, HeadVar__3_3);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = TailKVs_10;
      next_value_of_HeadVar__3_3 = STATE_VARIABLE_A_14_14;
      HeadVar__2_2 = next_value_of_HeadVar__2_2;
      HeadVar__3_3 = next_value_of_HeadVar__3_3;
      continue;
    }
