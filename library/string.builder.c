...
#undef MR_PROC_LABEL
  ...
  {
    StringList_10 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, StringList_10, 0) = ((MR_Box) (UniqueString_9));
    MR_hl_field(1, StringList_10, 1) = ((MR_Box) (StringList0_8));
  }
  ...
  MR_Word * STATE_VARIABLE_State_11)
{
  ...
  {
    StringList_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, StringList_9, 0) = ((MR_Box) (Var_12));
    MR_hl_field(1, StringList_9, 1) = ((MR_Box) (StringList0_8));
  }
