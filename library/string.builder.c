...
{
  MR_Word RevStrings0_8 = (MR_Word) (STATE_VARIABLE_State_0_11);
...
#undef MR_PROC_LABEL
...
}
  {
    ...
    MR_hl_field(1, RevStrings_10, 0) = ((MR_Box) (UniqueString_9));
    MR_hl_field(1, RevStrings_10, 1) = ((MR_Box) (RevStrings0_8));
  }
  *STATE_VARIABLE_State_12 = (MR_Word) (RevStrings_10);
}
...
{
  MR_Word RevStrings0_8 = (MR_Word) (STATE_VARIABLE_State_0_10);
  MR_Word RevStrings_9;
  MR_String Var_12;

  mercury__string__char_to_string_2_p_0(Char_6, &Var_12);
  {
    RevStrings_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, RevStrings_9, 0) = ((MR_Box) (Var_12));
    MR_hl_field(1, RevStrings_9, 1) = ((MR_Box) (RevStrings0_8));
  }
  *STATE_VARIABLE_State_11 = (MR_Word) (RevStrings_9);
}
