...
{
  {
    ...
    MR_String mercury__string__builder__Var_12;
    ...
    mercury__string__to_char_list_2_p_1(&mercury__string__builder__Var_12, mercury__string__builder__V_5_20);
    {
      ...
      MR_hl_field(MR_mktag(1), mercury__string__builder__StringList_9, 0) = ((MR_Box) (mercury__string__builder__Var_12));
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__string__builder__ArgX1_4 = (MR_Word) mercury__string__builder__HeadVar__2_2;
      MR_Word mercury__string__builder__ArgY1_5 = (MR_Word) mercury__string__builder__HeadVar__3_3;

      mercury__builtin__compare_3_p_0(mercury__string__builder__TypeInfo_8_8, mercury__string__builder__HeadVar__1_1, ((MR_Box) (mercury__string__builder__ArgX1_4)), ((MR_Box) (mercury__string__builder__ArgY1_5)));
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word mercury__string__builder__ArgX1_3 = (MR_Word) mercury__string__builder__HeadVar__1_1;
      MR_Word mercury__string__builder__ArgY1_4 = (MR_Word) mercury__string__builder__HeadVar__2_2;

      mercury__string__builder__succeeded = mercury__builtin__unify_2_p_0(mercury__string__builder__TypeInfo_7_7, ((MR_Box) (mercury__string__builder__ArgX1_3)), ((MR_Box) (mercury__string__builder__ArgY1_4)));
    }
...
{
  {
    ...
    MR_Word mercury__string__builder__Var_6;

    mercury__list__reverse_2_p_0(mercury__string__builder__TypeCtorInfo_7_7, mercury__string__builder__StringList_5, &mercury__string__builder__Var_6);
    mercury__string__builder__String_4 = mercury__string__append_list_1_f_0(mercury__string__builder__Var_6);
...
{
  {
    ...
    MR_Word mercury__string__builder__Var_2 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...
{
  {
    MR_Box mercury__string__builder__closure = mercury__string__builder__closure_arg;
