    ...
    if (mercury__string__builder__succeeded)
      *mercury__string__builder__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Word mercury__string__builder__Var_4 = (MR_Word) mercury__string__builder__HeadVar__2_2;
        MR_Word mercury__string__builder__Var_5 = (MR_Word) mercury__string__builder__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0(mercury__string__builder__TypeInfo_8_8, mercury__string__builder__HeadVar__1_1, ((MR_Box) (mercury__string__builder__Var_4)), ((MR_Box) (mercury__string__builder__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__string__builder__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__string__builder__Var_3 = (MR_Word) mercury__string__builder__HeadVar__1_1;
        MR_Word mercury__string__builder__Var_4 = (MR_Word) mercury__string__builder__HeadVar__2_2;

        {
          mercury__string__builder__succeeded = mercury__builtin__unify_2_p_0(mercury__string__builder__TypeInfo_7_7, ((MR_Box) (mercury__string__builder__Var_3)), ((MR_Box) (mercury__string__builder__Var_4)));
        }
      }
    return mercury__string__builder__succeeded;
  }
