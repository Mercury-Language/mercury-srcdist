      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_9, 0) = ((MR_Box) (MR_Word) (B_7));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (MR_Word) (B_7));
            MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
      ...
      case (MR_Integer) 3:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_14, 0) = ((MR_Box) (MR_Word) (C_8));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_13, 0) = ((MR_Box) (MR_Word) (B_7));
      ...
      case (MR_Integer) 4:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_18, 0) = ((MR_Box) (MR_Word) (D_9));
            MR_hl_field(MR_mktag(1), Var_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (MR_Word) (C_8));
            MR_hl_field(MR_mktag(1), Var_17, 1) = ((MR_Box) (Var_18));
          }
          {
            Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_16, 0) = ((MR_Box) (MR_Word) (B_7));
