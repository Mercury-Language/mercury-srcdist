...
static /* final */ const struct mercury__char__vector_common_type_7_0_s mercury__char_vector_common_7[159];
...
static /* final */ const struct mercury__char__vector_common_type_7_0_s mercury__char_vector_common_7[159] = {
  ...
  /* row 58 */   {     (MR_Integer) 0 },
  /* row 59 */   {     (MR_Integer) 0 },
  /* row 60 */   {     (MR_Integer) 10 },
  /* row 61 */   {     (MR_Integer) 11 },
  /* row 62 */   {     (MR_Integer) 12 },
  /* row 63 */   {     (MR_Integer) 13 },
  /* row 64 */   {     (MR_Integer) 14 },
  /* row 65 */   {     (MR_Integer) 15 },
  /* row 66 */   {     (MR_Integer) 16 },
  /* row 67 */   {     (MR_Integer) 17 },
  /* row 68 */   {     (MR_Integer) 18 },
  /* row 69 */   {     (MR_Integer) 19 },
  /* row 70 */   {     (MR_Integer) 20 },
  /* row 71 */   {     (MR_Integer) 21 },
  /* row 72 */   {     (MR_Integer) 22 },
  /* row 73 */   {     (MR_Integer) 23 },
  /* row 74 */   {     (MR_Integer) 24 },
  /* row 75 */   {     (MR_Integer) 25 },
  /* row 76 */   {     (MR_Integer) 26 },
  /* row 77 */   {     (MR_Integer) 27 },
  /* row 78 */   {     (MR_Integer) 28 },
  /* row 79 */   {     (MR_Integer) 29 },
  /* row 80 */   {     (MR_Integer) 30 },
  /* row 81 */   {     (MR_Integer) 31 },
  /* row 82 */   {     (MR_Integer) 32 },
  /* row 83 */   {     (MR_Integer) 33 },
  /* row 84 */   {     (MR_Integer) 34 },
  /* row 85 */   {     (MR_Integer) 35 },
  /* row 86 */   {     (MR_Integer) 0 },
  /* row 87 */   {     (MR_Integer) 1 },
  /* row 88 */   {     (MR_Integer) 2 },
  /* row 89 */   {     (MR_Integer) 3 },
  ...
  /* row 98 */   {     (MR_Integer) 4 },
  /* row 99 */   {     (MR_Integer) 5 },
  /* row 100 */   {     (MR_Integer) 6 },
  /* row 101 */   {     (MR_Integer) 7 },
  /* row 102 */   {     (MR_Integer) 8 },
  /* row 103 */   {     (MR_Integer) 9 },
  /* row 104 */   {     (MR_Integer) 0 },
  /* row 105 */   {     (MR_Integer) 1 },
  /* row 106 */   {     (MR_Integer) 2 },
  /* row 107 */   {     (MR_Integer) 3 },
  /* row 108 */   {     (MR_Integer) 4 },
  /* row 109 */   {     (MR_Integer) 5 },
  /* row 110 */   {     (MR_Integer) 6 },
  /* row 111 */   {     (MR_Integer) 7 },
  /* row 112 */   {     (MR_Integer) 8 },
  /* row 113 */   {     (MR_Integer) 9 },
  ...
  /* row 121 */   {     (MR_Integer) 10 },
  /* row 122 */   {     (MR_Integer) 11 },
  /* row 123 */   {     (MR_Integer) 12 },
  /* row 124 */   {     (MR_Integer) 13 },
  /* row 125 */   {     (MR_Integer) 14 },
  /* row 126 */   {     (MR_Integer) 15 },
  ...
  /* row 148 */   {     (MR_Integer) 0 },
  /* row 149 */   {     (MR_Integer) 0 },
  /* row 150 */   {     (MR_Integer) 0 },
  /* row 151 */   {     (MR_Integer) 0 },
  /* row 152 */   {     (MR_Integer) 0 },
  /* row 153 */   {     (MR_Integer) 10 },
  /* row 154 */   {     (MR_Integer) 11 },
  /* row 155 */   {     (MR_Integer) 12 },
  /* row 156 */   {     (MR_Integer) 13 },
  /* row 157 */   {     (MR_Integer) 14 },
  /* row 158 */   {     (MR_Integer) 15 },
};
...
#undef MR_PROC_LABEL
    ...
    *H_4 = mercury__uint__hash_1_f_0(Var_7);
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        if ((((MR_Unsigned) Int_5) <= ((MR_Unsigned) 35)))
        {
          *Digit_6 = ((&mercury__char_vector_common_4[86 + Int_5]))->mercury__char__vector_common_type_4_0__vct_4_f_0;
          succeeded = MR_TRUE;
        }
        else
          succeeded = MR_FALSE;
...
{
  {
    ...
    if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 48))) <= ((MR_Unsigned) 54)))
      ...
      {
        *HeadVar__2_2 = ((&mercury__char_vector_common_7[104 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    {
      *HeadVar__2_2 = ((&mercury__char_vector_common_7[94 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
...
{
  {
    ...
    {
      *HeadVar__2_2 = ((&mercury__char_vector_common_7[86 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) Upper_7 - (MR_Unsigned) 48))) <= ((MR_Unsigned) 42)))
          if ((((mercury__char_scalar_common_6[1])[(((MR_Integer) ((MR_Unsigned) Upper_7 - (MR_Unsigned) 48)) >> 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) Upper_7 - (MR_Unsigned) 48)) & (MR_Integer) 31))))))
          {
            *Int_6 = ((&mercury__char_vector_common_7[0 + (MR_Integer) ((MR_Unsigned) Upper_7 - (MR_Unsigned) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
            succeeded = MR_TRUE;
          }
          else
            succeeded = MR_FALSE;
      ...
      if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) Digit_5 - (MR_Unsigned) 48))) <= ((MR_Unsigned) 42)))
        if ((((mercury__char_scalar_common_6[1])[(((MR_Integer) ((MR_Unsigned) Digit_5 - (MR_Unsigned) 48)) >> 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) Digit_5 - (MR_Unsigned) 48)) & (MR_Integer) 31))))))
        {
          *Int_6 = ((&mercury__char_vector_common_7[43 + (MR_Integer) ((MR_Unsigned) Digit_5 - (MR_Unsigned) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
          succeeded = MR_TRUE;
        }
        else
          succeeded = MR_FALSE;
    ...
    {
      mercury__require__error_2_p_0((MR_String) "predicate \140char.base_digit_to_int\'/3", (MR_String) "invalid base");
      succeeded = MR_TRUE;
    }
    return succeeded;
  }
