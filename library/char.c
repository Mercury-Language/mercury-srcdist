...
MR_bool MR_CALL 
mercury__char__from_int_func_1_f_0(
  MR_Integer Int_3,
  MR_Char * Char_4)
{
  MR_bool succeeded;
...
{
#define MR_PROC_LABEL mercury__char__from_int_func_1_f_0
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_1_1_f_0(((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__2_2);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (MR_Word) (conv0_HeadVar__2_2));
    succeeded = MR_TRUE;
