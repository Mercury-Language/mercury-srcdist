...
#undef MR_PROC_LABEL
    ...
    succeeded = (Int_15 < (MR_Integer) 55296);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mercury__char__to_utf16_uint16_2_p_0
...
#undef MR_PROC_LABEL
    ...
    {
      succeeded = (Int_15 <= (MR_Integer) 57343);
      if (succeeded)
        succeeded = MR_FALSE;
      else
      {
        succeeded = (Int_15 <= (MR_Integer) 65535);
        if (succeeded)
        {
{
#define MR_PROC_LABEL mercury__char__to_utf16_uint16_2_p_0
...
#undef MR_PROC_LABEL
	 A_6  = U16;
        ...
        {
          succeeded = (Int_15 <= (MR_Integer) 1114111);
          if (succeeded)
          {
            MR_Integer U_16 = (MR_Integer) ((MR_Unsigned) Int_15 - (MR_Unsigned) 65536);
            MR_Integer Var_22;
            MR_Integer Var_24;
            MR_Integer Var_26;
            MR_Integer Var_28;

            Var_24 = mercury__int__f_62_62_2_f_0(U_16, (MR_Integer) 10);
            Var_22 = ((MR_Integer) 55296 | Var_24);
{
#define MR_PROC_LABEL mercury__char__to_utf16_uint16_2_p_0
...
#undef MR_PROC_LABEL
	 A_6  = U16;
            ...
            Var_28 = (U_16 & (MR_Integer) 1023);
            Var_26 = ((MR_Integer) 56320 | Var_28);
{
#define MR_PROC_LABEL mercury__char__to_utf16_uint16_2_p_0
        ...
        case (MR_Integer) 1:
          {
            ...
            *CodeUnits_4 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MR_Word) (A_6));
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_8, 0) = ((MR_Box) (MR_Word) (B_7));
...
#undef MR_PROC_LABEL
    ...
    succeeded = (Int_18 < (MR_Integer) 55296);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mercury__char__to_utf16_2_p_0
...
#undef MR_PROC_LABEL
    ...
    {
      succeeded = (Int_18 <= (MR_Integer) 57343);
      if (succeeded)
        succeeded = MR_FALSE;
      else
      {
        succeeded = (Int_18 <= (MR_Integer) 65535);
        if (succeeded)
        {
{
#define MR_PROC_LABEL mercury__char__to_utf16_2_p_0
...
#undef MR_PROC_LABEL
	 A_6  = U16;
        ...
        {
          succeeded = (Int_18 <= (MR_Integer) 1114111);
          if (succeeded)
          {
            MR_Integer U_19 = (MR_Integer) ((MR_Unsigned) Int_18 - (MR_Unsigned) 65536);
            MR_Integer Var_25;
            MR_Integer Var_27;
            MR_Integer Var_29;
            MR_Integer Var_31;

            Var_27 = mercury__int__f_62_62_2_f_0(U_19, (MR_Integer) 10);
            Var_25 = ((MR_Integer) 55296 | Var_27);
{
#define MR_PROC_LABEL mercury__char__to_utf16_2_p_0
...
#undef MR_PROC_LABEL
	 A_6  = U16;
            ...
            Var_31 = (U_19 & (MR_Integer) 1023);
            Var_29 = ((MR_Integer) 56320 | Var_31);
{
#define MR_PROC_LABEL mercury__char__to_utf16_2_p_0
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (MR_Word) (B_7));
        ...
        case (MR_Integer) 4:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (MR_Word) (D_9));
              MR_hl_field(MR_mktag(1), Var_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (MR_Word) (C_8));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (MR_Word) (B_7));
...
#undef MR_PROC_LABEL
	 Int_71  = Int;
          ...
          succeeded = (Int_71 >= (MR_Integer) 55296);
          if (succeeded)
          {
            Var_73 = (MR_Integer) 57343;
            succeeded = (Int_71 <= Var_73);
          }
          succeeded = !(succeeded);
          if (succeeded)
          {
