...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__char__lower_upper_2_p_0(DigitStr_5, &UpperStr_14);
      if (succeeded)
        DigitStr_15 = UpperStr_14;
      else
        DigitStr_15 = DigitStr_5;
      succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_6, DigitStr_15);
      if (succeeded)
        succeeded = (*Int_6 < Base_4);
    }
    else
