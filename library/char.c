...
static MR_bool MR_CALL 
mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_2_2_p_0_10001(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
static /* final */ const MR_Box mercury__char_scalar_common_3[1][5];
...
const MR_BaseTypeclassInfo base_typeclass_info_enum__enum__arity1__character__arity0__[7] = {
  ...
  ((MR_Box) (mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_2_2_p_0_10001))
};
...
MR_bool MR_CALL 
mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_2_2_p_0(
...
{
#define MR_PROC_LABEL mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_2_2_p_0
...
MR_bool MR_CALL 
mercury__char__char_int_is_surrogate_1_p_0(
  MR_Integer Int_2)
{
  MR_bool succeeded = (Int_2 >= (MR_Integer) 55296);
  MR_Integer Var_4;

  if (succeeded)
  {
    Var_4 = (MR_Integer) 57343;
    succeeded = (Int_2 <= Var_4);
  }
  return succeeded;
}
	...
	*B_10  = U8;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (Int_13 >= (MR_Integer) 55296);
        if (succeeded)
        {
          Var_69 = (MR_Integer) 57343;
          succeeded = (Int_13 <= Var_69);
        }
        succeeded = !(succeeded);
        if (succeeded)
        {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_2 = mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__to_int_1_1_f_0(((MR_Char) (MR_Word) wrapper_arg_1));
  wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
  return wrapper_arg_2;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = mercury__char__ClassMethod_for_enum__enum____character__arity0______enum__from_int_2_2_p_0(((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__2_2);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (MR_Word) (conv0_HeadVar__2_2));
    succeeded = MR_TRUE;
