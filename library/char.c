...
MR_define_entry(mercury__char__lower_upper_2_0);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_0, ((MR_Integer) MR_r1 - (MR_Integer) 97));
...
MR_define_entry(mercury__char__lower_upper_2_1);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, ((MR_Integer) MR_r1 - (MR_Integer) 65));
	MR_r2 = MR_tfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
...
MR_define_entry(mercury__char__is_alnum_or_underscore_1_0);
	...
	MR_r1 = (((MR_Integer) 1 << (((MR_Integer) MR_r1 - (MR_Integer) 48) & (MR_Integer) 31)) & (MR_Integer) MR_tfield(0, MR_COMMON(1,0), (((MR_Integer) MR_r1 - (MR_Integer) 48) >> (MR_Integer) 5)));
	MR_proceed();
...
MR_define_entry(mercury__char__is_hex_digit_2_0);
	...
	if (!((((MR_Integer) 1 << (((MR_Integer) MR_r1 - (MR_Integer) 48) & (MR_Integer) 31)) & (MR_Integer) MR_tfield(0, MR_COMMON(2,0), (((MR_Integer) MR_r1 - (MR_Integer) 48) >> (MR_Integer) 5))))) {
		MR_GOTO_LAB(char__is_hex_digit_2_0_i1);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, ((MR_Integer) MR_r1 - (MR_Integer) 48));
	MR_r2 = MR_tfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
...
MR_define_entry(mercury__char__int_to_digit_2_0);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_4, (MR_Integer) MR_r1);
	MR_r2 = MR_tfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
...
MR_define_entry(mercury__char__int_to_digit_2_1);
	...
	if (!((((MR_Integer) 1 << (((MR_Integer) MR_r1 - (MR_Integer) 48) & (MR_Integer) 31)) & (MR_Integer) MR_tfield(0, MR_COMMON(2,1), (((MR_Integer) MR_r1 - (MR_Integer) 48) >> (MR_Integer) 5))))) {
		MR_GOTO_LAB(char__int_to_digit_2_1_i1);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_5, ((MR_Integer) MR_r1 - (MR_Integer) 48));
	MR_r2 = MR_tfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
