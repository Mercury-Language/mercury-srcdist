...
{
  {
    ...
    succeeded = mercury__char__int_to_extended_digit_2_p_0(Int_3, &DigitPrime_5);
    if (succeeded)
...
{
  {
    ...
    succeeded = mercury__char__int_to_extended_digit_2_p_0(N_3, &DigitPrime_7);
    if (succeeded)
      C_4 = DigitPrime_7;
    else
    {
...
{
  {
    ...
    succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_3, Digit_4);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__char__int_to_extended_digit_2_p_0(Int_3, Digit_4);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__char__lower_upper_2_p_0(Digit_3, &Upper_5);
    if (succeeded)
      succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_4, Upper_5);
    else
      succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_4, Digit_3);
    return succeeded;
  }
}
...
#undef MR_PROC_LABEL
...
}
    {
      ...
      if (succeeded)
      {
        Var_7 = (MR_Integer) 65007;
        succeeded = (Int_3 <= Var_7);
      }
    }
    if (!(succeeded))
    {
      MR_Integer Var_4 = (Int_3 & (MR_Integer) 65534);

      succeeded = (Var_4 == (MR_Integer) 65534);
    }
    return succeeded;
  }
}
...
#undef MR_PROC_LABEL
    ...
    succeeded = (Int_5 < (MR_Integer) 55296);
    if (succeeded)
    {
...

      {
        ...
        *CodeUnits_4 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Int_5));
    ...
    {
      succeeded = (Int_5 <= (MR_Integer) 57343);
      if (succeeded)
        succeeded = MR_FALSE;
      else
      {
        succeeded = (Int_5 <= (MR_Integer) 65535);
        if (succeeded)
        {
        ...
        else
        {
          ...
          succeeded = (Int_5 <= (MR_Integer) 1114111);
          if (succeeded)
          {
            Var_15 = (MR_Integer) 65536;
            U_6 = (MR_Integer) ((MR_Unsigned) Int_5 - (MR_Unsigned) Var_15);
            Var_16 = (MR_Integer) 55296;
            Var_18 = (MR_Integer) 10;
            Var_17 = mercury__int__f_62_62_2_f_0(U_6, Var_18);
            A_7 = (Var_16 | Var_17);
            Var_19 = (MR_Integer) 56320;
            Var_21 = (MR_Integer) 1023;
            Var_20 = (U_6 & Var_21);
            B_8 = (Var_19 | Var_20);
            Var_23 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (B_8));
...
#undef MR_PROC_LABEL
    ...
    succeeded = (Int_5 <= (MR_Integer) 127);
    if (succeeded)
    {
    ...
    {
      succeeded = (Int_5 <= (MR_Integer) 2047);
      if (succeeded)
      {
        MR_Integer A_6;
        MR_Integer B_7;
        ...
        Var_15 = mercury__int__f_62_62_2_f_0(Int_5, (MR_Integer) 6);
        Var_14 = (Var_15 & (MR_Integer) 31);
        A_6 = ((MR_Integer) 192 | Var_14);
        Var_19 = (Int_5 & (MR_Integer) 63);
        B_7 = ((MR_Integer) 128 | Var_19);
        Var_22 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
        {
          ...
          MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (B_7));
        ...
        }
        {
          ...
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *CodeUnits_4 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (A_6));
...
#undef MR_PROC_LABEL
	 Int_76  = Int;
          ...
          succeeded = (Int_76 >= (MR_Integer) 55296);
          if (succeeded)
          {
            Var_78 = (MR_Integer) 57343;
            succeeded = (Int_76 <= Var_78);
          }
          succeeded = !(succeeded);
          if (succeeded)
          {
            Var_24 = (MR_Integer) 224;
            Var_27 = (MR_Integer) 12;
            Var_26 = mercury__int__f_62_62_2_f_0(Int_5, Var_27);
            Var_28 = (MR_Integer) 15;
            Var_25 = (Var_26 & Var_28);
            A_63 = (Var_24 | Var_25);
            Var_29 = (MR_Integer) 128;
            Var_32 = (MR_Integer) 6;
            Var_31 = mercury__int__f_62_62_2_f_0(Int_5, Var_32);
            Var_33 = (MR_Integer) 63;
            Var_30 = (Var_31 & Var_33);
            B_64 = (Var_29 | Var_30);
            Var_34 = (MR_Integer) 128;
            Var_36 = (MR_Integer) 63;
            Var_35 = (Int_5 & Var_36);
            C_8 = (Var_34 | Var_35);
            Var_39 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (C_8));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (B_64));
            ...
            }
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *CodeUnits_4 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (A_63));
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_41 = (MR_Integer) 240;
            Var_44 = (MR_Integer) 18;
            Var_43 = mercury__int__f_62_62_2_f_0(Int_5, Var_44);
            Var_45 = (MR_Integer) 7;
            Var_42 = (Var_43 & Var_45);
            A_65 = (Var_41 | Var_42);
            Var_46 = (MR_Integer) 128;
            Var_49 = (MR_Integer) 12;
            Var_48 = mercury__int__f_62_62_2_f_0(Int_5, Var_49);
            Var_50 = (MR_Integer) 63;
            Var_47 = (Var_48 & Var_50);
            B_66 = (Var_46 | Var_47);
            Var_51 = (MR_Integer) 128;
            Var_54 = (MR_Integer) 6;
            Var_53 = mercury__int__f_62_62_2_f_0(Int_5, Var_54);
            Var_55 = (MR_Integer) 63;
            Var_52 = (Var_53 & Var_55);
            C_67 = (Var_51 | Var_52);
            Var_56 = (MR_Integer) 128;
            ...
            Var_62 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (D_9));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (C_67));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (B_66));
            ...
            }
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *CodeUnits_4 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (A_65));
...
{
  {
    ...
    if ((((MR_Unsigned) HeadVar__1_1) <= ((MR_Unsigned) (MR_Integer) 35)))
    {
...
{
  {
    ...
    if ((((MR_Unsigned) HeadVar__1_1) <= ((MR_Unsigned) (MR_Integer) 15)))
    {
...
{
  {
    ...
    if ((((MR_Unsigned) HeadVar__1_1) <= ((MR_Unsigned) (MR_Integer) 9)))
    {
...
{
  {
    ...
    if ((((MR_Unsigned) HeadVar__1_1) <= ((MR_Unsigned) (MR_Integer) 7)))
    {
...
{
  {
    ...
    succeeded = mercury__char__base_digit_to_int_3_p_0(Base_4, Digit_5, &IntPrime_7);
    if (succeeded)
      Int_6 = IntPrime_7;
    else
    {
...
{
  {
    ...
    succeeded = mercury__char__hex_digit_to_int_2_p_0(Digit_3, &IntPrime_5);
    if (succeeded)
      Int_4 = IntPrime_5;
    else
    {
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 54)))
      if ((((mercury__char_scalar_common_6[0])[(((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)) & (MR_Integer) 31))))))
      {
        *HeadVar__2_2 = ((&mercury__char_vector_common_7[61 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 9)))
    {
      *HeadVar__2_2 = ((&mercury__char_vector_common_7[51 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 7)))
    {
      *HeadVar__2_2 = ((&mercury__char_vector_common_7[43 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__char__lower_upper_2_p_0(Digit_5, &Upper_7);
      if (succeeded)
        succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_6, Upper_7);
      else
        succeeded = mercury__char__int_to_extended_digit_2_p_1(Int_6, Digit_5);
      if (succeeded)
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 42)))
      if ((((mercury__char_scalar_common_6[1])[(((MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 48)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 48)) & (MR_Integer) 31))))))
      {
        *HeadVar__1_1 = ((&mercury__char_vector_common_7[0 + (MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 48)]))->mercury__char__vector_common_type_7_0__vct_7_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) D_2 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 9)))
    {
      succeeded = MR_TRUE;
    }
    else
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) Char_2 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 74)))
      if ((((mercury__char_scalar_common_5[0])[(((MR_Integer) ((MR_Unsigned) Char_2 - (MR_Unsigned) (MR_Integer) 48)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) Char_2 - (MR_Unsigned) (MR_Integer) 48)) & (MR_Integer) 31))))))
      {
        succeeded = MR_TRUE;
      }
      else
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__char__lower_upper_2_p_0(Char_2, &Var_5);
      if (succeeded)
        succeeded = MR_TRUE;
      else
      {
        ...
        succeeded = mercury__char__lower_upper_2_p_1(&Var_7, Char_2);
      }
    }
    return succeeded;
  }
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) Char_2 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 9)))
    {
      succeeded = MR_TRUE;
    }
    else
...
{
  {
    ...
    succeeded = mercury__char__lower_upper_2_p_0(Char_2, &Var_4);
    if (succeeded)
      succeeded = MR_TRUE;
    else
    {
      ...
      succeeded = mercury__char__lower_upper_2_p_1(&Var_6, Char_2);
    }
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__char__lower_upper_2_p_0(C1_3, &UpperChar_7);
    if (succeeded)
      C2_4 = UpperChar_7;
    else
      C2_4 = C1_3;
...
{
  {
    ...
    succeeded = mercury__char__lower_upper_2_p_1(&LowerChar_7, C1_3);
    if (succeeded)
      C2_4 = LowerChar_7;
    else
      C2_4 = C1_3;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 65)) <= ((MR_Unsigned) (MR_Integer) 25)))
    {
      *HeadVar__1_1 = ((&mercury__char_vector_common_4[26 + (MR_Integer) ((MR_Unsigned) HeadVar__2_2 - (MR_Unsigned) (MR_Integer) 65)]))->mercury__char__vector_common_type_4_0__vct_4_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 97)) <= ((MR_Unsigned) (MR_Integer) 25)))
    {
      *HeadVar__2_2 = ((&mercury__char_vector_common_4[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 97)]))->mercury__char__vector_common_type_4_0__vct_4_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
