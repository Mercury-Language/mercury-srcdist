...
#undef MR_PROC_LABEL
    ...
    HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 8 - (MR_Unsigned) Var_5);
    return HeadVar__2_2;
  }
}
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      MR_Word Var_10 = (MR_Word) ((MR_Box) ((MR_String) "int8.(>>): second operand is out of range"));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_7 = (MR_Word) ((MR_Box) ((MR_String) "int8.rem: division by zero"));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_9 = (MR_Word) ((MR_Box) ((MR_String) "int8.\'//\': division by zero"));
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_9_9 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
      MR_Word Var_7 = (MR_Word) ((MR_Box) ((MR_String) "int8.\'//\': division by zero"));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_17 = (MR_Word) ((MR_Box) ((MR_String) "int8.\'//\': division by zero"));
    ...
    if (!(succeeded))
    {
      ...
      if (!(succeeded))
      {
        ...
        if (succeeded)
        {
          ...
          MR_Word Var_23 = (MR_Word) ((MR_Box) ((MR_String) "int8.rem: division by zero"));
    ...
    {
      Div_6 = (int8_t) ((uint8_t) Trunc_7 - (uint8_t) INT8_C(1));
    }
    return Div_6;
  }
}
...
{
  {
    int8_t HeadVar__2_2 = (int8_t) ((uint8_t) INT8_C(0) - (uint8_t) HeadVar__1_1);
...
{
  {
    ...
    if (succeeded)
      HeadVar__2_2 = (int8_t) ((uint8_t) INT8_C(0) - (uint8_t) Num_3);
    else
      HeadVar__2_2 = Num_3;
    return HeadVar__2_2;
  }
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_6_6 = (MR_Word) &mercury__exception__exception__type_ctor_info_software_error_0;
      MR_Word TypeCtorInfo_7_7 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int8_0;
      MR_Word Var_4 = (MR_Word) ((MR_Box) ((MR_String) "int8.abs: abs(min_int8) would overflow"));
      MR_Box conv0_HeadVar__2_2;

      conv0_HeadVar__2_2 = mercury__exception__throw_1_f_0(TypeCtorInfo_6_6, TypeCtorInfo_7_7, ((MR_Box) (Var_4)));
...
#undef MR_PROC_LABEL
    ...
    {
      mercury__require__error_1_p_0((MR_String) "int8.det_from_int: cannot convert int to int8");
    }
    return I8_4;
  }
}
