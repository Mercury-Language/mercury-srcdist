...
{
  {
    ...
    mercury__set_unordlist__divide_2_6_p_0(TypeInfo_for_T_11, Pred_5, Set_6, (MR_Word) ((MR_Integer) 0), &RevTruePart_7, (MR_Word) ((MR_Integer) 0), &RevFalsePart_8);
...
{
  {
    ...
    mercury__set_unordlist__divide_2_6_p_0(TypeInfo_for_T_9, Pred_5, Set_11, (MR_Word) ((MR_Integer) 0), &RevTruePart_12, (MR_Word) ((MR_Integer) 0), &RevFalsePart_13);
...
{
  {
    ...
    mercury__set_unordlist__divide_2_6_p_0(TypeInfo_for_T_8, Pred_4, Set_10, (MR_Word) ((MR_Integer) 0), &RevTruePart_11, (MR_Word) ((MR_Integer) 0), &RevFalsePart_12);
...
{
  {
    ...
    mercury__list__remove_dups_loop_3_p_0(TypeInfo_for_T_6, Set_3, (MR_Word) ((MR_Integer) 0), &Elems_5);
...
{
  {
    ...
    mercury__list__remove_dups_loop_3_p_0(TypeInfo_for_T_5, Set_7, (MR_Word) ((MR_Integer) 0), &Elems_8);
  ...
  MR_Word * C_3)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((Var_14 == (MR_Word) ((MR_Integer) 0)))
      *C_3 = HeadVar__2_2;
    else
    {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        S0_15 = (MR_Word) (S1_10);
        S1_16 = (MR_Word) (S0_5);
        mercury__set_unordlist__intersect_2_4_p_0(TypeInfo_for_T_13, S0_15, S1_16, (MR_Word) ((MR_Integer) 0), &S_17);
...
{
  {
    ...
    mercury__set_unordlist__intersect_2_4_p_0(TypeInfo_for_T_7, S0_8, S1_9, (MR_Word) ((MR_Integer) 0), &S_10);
    S3_6 = (MR_Word) (S_10);
    return S3_6;
  }
}
...
{
  {
    ...
    mercury__set_unordlist__intersect_2_4_p_0(TypeInfo_for_T_8, S0_4, S1_5, (MR_Word) ((MR_Integer) 0), &S_6);
...
{
  {
    ...
    mercury__set_unordlist__power_union_2_3_p_0(TypeInfo_for_T_8, PS_3, (MR_Word) (((MR_Box) ((MR_Integer) 0))), &Var_7);
    S1_6 = (MR_Word) (Var_7);
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Set_13)) == (MR_Integer) 1);
    if (succeeded)
    {
      V_5_21 = (MR_Integer) 0;
...
{
  {
    ...
    if (succeeded)
    {
      *X_4 = (MR_hl_field(MR_mktag(1), Var_5, (MR_Integer) 0));
      ...
      succeeded = mercury__list____Unify____list_1_0(TypeInfo_for_T_7, (MR_Word) ((MR_Integer) 0), Var_8);
    }
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      *X_1 = (MR_hl_field(MR_mktag(1), Var_15, (MR_Integer) 0));
      ...
      succeeded = mercury__list____Unify____list_1_0(TypeInfo_for_T_17, (MR_Word) ((MR_Integer) 0), Var_18);
    }
    return succeeded;
  }
}
