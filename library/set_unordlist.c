  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__2_2 = T_16;
          MR_Word next_value_of_STATE_VARIABLE_RevTrue_0_3 = STATE_VARIABLE_RevTrue_23_23;
          MR_Word next_value_of_STATE_VARIABLE_RevFalse_0_5 = STATE_VARIABLE_RevFalse_24_24;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Var_12;
          MR_Word next_value_of_HeadVar__2_2 = B_10;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = S0_8;
          MR_Word next_value_of_HeadVar__3_3 = S3_12;
  ...
  MR_Word * STATE_VARIABLE_S_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Ts_8;
        MR_Word next_value_of_STATE_VARIABLE_S_0_2 = STATE_VARIABLE_S_12_12;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Xs_8;
            MR_Word next_value_of_STATE_VARIABLE_S_0_2 = STATE_VARIABLE_S_12_12;
