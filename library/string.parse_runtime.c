...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_Chars_29_29)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_Chars_0_16)) == (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_Chars_20_20)) == (MR_Integer) 1);
      if (succeeded)
      {
