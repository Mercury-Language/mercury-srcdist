        ...
        case (MR_Char) 112:
          {
            ...
            MR_Word Var_132 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__5_5, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
            MR_Word Var_133 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__5_5, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
            MR_Word Var_134 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__5_5, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
            MR_Word Var_135 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__5_5, (MR_Integer) 0))) >> (MR_Integer) 4)) & (MR_Integer) 1);
            MR_Word Var_131 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__5_5, (MR_Integer) 0))) & (MR_Integer) 1);

            {
              STATE_VARIABLE_Flags_70_388 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_70_388, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) | (((((MR_Unsigned) (((MR_Box) (Var_132))) << (MR_Integer) 1)) | (((((MR_Unsigned) (((MR_Box) (Var_133))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (Var_134))) << (MR_Integer) 3)) | (((MR_Unsigned) (((MR_Box) (Var_135))) << (MR_Integer) 4))))))))));
            }
            if ((STATE_VARIABLE_PolyTypes_0_3 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              MR_Word Var_361;
