    ...
    if (succeeded)
    {
      ...
      if ((STATE_VARIABLE_PolyTypes_31_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MaybePrec_17 = (MR_Word) ((MR_Unsigned) 0U);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_75, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (SpecNum_10));
        }
        {
          PrecErrors_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), PrecErrors_18, 0) = ((MR_Box) (Var_75));
      ...
      else
      {
        ...
        else
        {
          ...
          MaybePrec_17 = (MR_Word) ((MR_Unsigned) 0U);
          Var_79 = mercury__string__parse_runtime__poly_type_to_kind_1_f_0(PolyType_68);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_78, 1) = ((MR_Box) (SpecNum_10));
            MR_hl_field(MR_mktag(3), Var_78, 2) = (MR_Box) ((MR_Unsigned) (Var_79));
          }
          {
            PrecErrors_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PrecErrors_18, 0) = ((MR_Box) (Var_78));
            MR_hl_field(MR_mktag(1), PrecErrors_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
      }
