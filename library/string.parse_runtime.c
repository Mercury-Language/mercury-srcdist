  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MaybeWidth_15 = (MR_Word) ((MR_Unsigned) 0U);
        Var_46 = mercury__string__parse_runtime__poly_type_to_kind_1_f_0(PolyType_38);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (SpecNum_10));
          MR_hl_field(MR_mktag(3), Var_45, 2) = (MR_Box) ((MR_Unsigned) (Var_46));
        }
        {
          WidthErrors_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), WidthErrors_16, 0) = ((MR_Box) (Var_45));
          MR_hl_field(MR_mktag(1), WidthErrors_16, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      }
    }
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          MaybePrec_17 = (MR_Word) ((MR_Unsigned) 0U);
          Var_59 = mercury__string__parse_runtime__poly_type_to_kind_1_f_0(PolyType_49);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_58, 1) = ((MR_Box) (SpecNum_10));
            MR_hl_field(MR_mktag(3), Var_58, 2) = (MR_Box) ((MR_Unsigned) (Var_59));
          }
          {
            PrecErrors_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PrecErrors_18, 0) = ((MR_Box) (Var_58));
            MR_hl_field(MR_mktag(1), PrecErrors_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
      }
  ...
  MR_Word * Errors_17)
{
  ...
  switch (SpecChar_10) {
    ...
    case (MR_Char) 112:
      {
        MR_Word STATE_VARIABLE_Flags_69_548;
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_0_50, (MR_Integer) 0)));

        {
          STATE_VARIABLE_Flags_69_548 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_69_548, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 16U)))) | (((MR_Unsigned) ((MR_Integer) 1) << 4))));
        }
        if ((STATE_VARIABLE_PolyTypes_0_48 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Error_463;
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  *Spec_16 = base;
                  MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (STATE_VARIABLE_Flags_69_548));
                  MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaybeWidth_13));
                  MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (MaybePrec_14));
                  MR_hl_field(MR_mktag(3), base, 4) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 4));
