...
{
  {
    ...
    if ((GatherEndedBy_12 == (MR_Word) ((MR_Integer) 0)))
    {
      Specs0_13 = (MR_Word) ((MR_Integer) 0);
      if ((STATE_VARIABLE_PolyTypes_0_28 == (MR_Word) ((MR_Integer) 0)))
        *Errors_10 = (MR_Word) ((MR_Integer) 0);
      else
      {
        MR_Word Error_16;
        MR_Integer Var_34;
    ...
    else
    {
      ...
      if ((HeadErrors_18 == (MR_Word) ((MR_Integer) 0)))
      {
        {
    ...
    if ((NonConversionSpecChars_11 == (MR_Word) ((MR_Integer) 0)))
      *Specs_9 = Specs0_13;
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((STATE_VARIABLE_PolyTypes_0_22 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_52;

        MaybeWidth_15 = (MR_Word) ((MR_Integer) 0);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), WidthErrors_16, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          WidthErrors_16 = (MR_Word) ((MR_Integer) 0);
        }
        else
        {
          MR_Word Var_55;
        ...
        case (MR_Char) 37:
          {
            ...
            ErrorsPrime_37 = (MR_Word) ((MR_Integer) 0);
        ...
        case (MR_Char) 69:
          {
            if ((STATE_VARIABLE_PolyTypes_0_3 == (MR_Word) ((MR_Integer) 0)))
            {
              ...
              SpecPrime_36 = (MR_Word) (&mercury__string__parse_runtime_scalar_common_4[1]);
              {
                ...
                MR_hl_field(MR_mktag(1), ErrorsPrime_37, 1) = ((MR_Box) ((MR_Integer) 0));
              }
              STATE_VARIABLE_PolyTypes_80_80 = STATE_VARIABLE_PolyTypes_0_3;
            }
            else
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        *STATE_VARIABLE_Chars_17 = STATE_VARIABLE_Chars_22_22;
        if ((STATE_VARIABLE_PolyTypes_0_18 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Var_24;
