        ...
        case (MR_Char) 112:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_70_388, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 4)) | (((((MR_Unsigned) (Var_132) << (MR_Integer) 3)) | (((((MR_Unsigned) (Var_133) << (MR_Integer) 2)) | (((((MR_Unsigned) (Var_134) << (MR_Integer) 1)) | (MR_Unsigned) (Var_135)))))))));
            }
            if ((STATE_VARIABLE_PolyTypes_0_3 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word Error_362;
