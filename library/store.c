...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo_9_9, 0) = ((MR_Box) (&mercury__store__store__type_ctor_info_store_1));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo_8_8, 0) = ((MR_Box) (&mercury__store__store__type_ctor_info_store_1));
