...
{
  {
    ...
    if (mercury__store__succeeded)
      *mercury__store__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mercury__store__Var_4 = (MR_Word) mercury__store__HeadVar__2_2;
        MR_Word mercury__store__Var_5 = (MR_Word) mercury__store__HeadVar__3_3;

        {
          mercury__private_builtin____Compare____ref_1_0(mercury__store__TypeInfo_for_T_8, mercury__store__HeadVar__1_1, mercury__store__Var_4, mercury__store__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__store__succeeded)
      ...
      {
        MR_Word mercury__store__Var_3 = (MR_Word) mercury__store__HeadVar__1_1;
        MR_Word mercury__store__Var_4 = (MR_Word) mercury__store__HeadVar__2_2;

        {
          mercury__store__succeeded = mercury__private_builtin____Unify____ref_1_0(mercury__store__TypeInfo_for_T_7, mercury__store__Var_3, mercury__store__Var_4);
        }
      }
    return mercury__store__succeeded;
  }
