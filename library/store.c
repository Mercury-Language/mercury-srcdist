...
const MR_PseudoTypeInfo mercury_data_store__field_types_store_1_0[] = {
	(MR_PseudoTypeInfo) &mercury_data_builtin__type_ctor_info_c_pointer_0
};

static const MR_DuFunctorDesc mercury_data_store__du_functor_desc_store_1_0 = {
	"mkstore",
	1,
	0,
	MR_SECTAG_NONE,
	...
	-1,
	0,
	(MR_PseudoTypeInfo *) mercury_data_store__field_types_store_1_0,
	NULL,
	NULL
};

const MR_DuFunctorDescPtr mercury_data_store__du_stag_ordered_store_1_0[] = {
	&mercury_data_store__du_functor_desc_store_1_0

};

const MR_DuPtagLayout mercury_data_store__du_ptag_ordered_store_1[] = {
	{ 1, MR_SECTAG_NONE,
	mercury_data_store__du_stag_ordered_store_1_0 }

};

const MR_DuFunctorDescPtr mercury_data_store__du_name_ordered_store_1[] = {
	&mercury_data_store__du_functor_desc_store_1_0
};
...
const MR_TypeCtorInfo_Struct mercury_data_store__type_ctor_info_store_1 = {
	...
	"store",
	"store",
	{ (void *)mercury_data_store__du_name_ordered_store_1 },
	{ (void *)mercury_data_store__du_ptag_ordered_store_1 },
	1,
	4,
