...
MR_decl_label6(list__remove_dups_2_3_0, 26,3,6,4,9,10)
...
MR_BEGIN_MODULE(list_module22)
	...
	MR_init_label6(list__remove_dups_2_3_0,26,3,6,4,9,10)
MR_BEGIN_CODE
...
MR_define_entry(mercury__list__remove_dups_2_3_0);
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(list__remove_dups_2_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(list__remove_dups_2_3_0,6)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(list__remove_dups_2_3_0_i26);
