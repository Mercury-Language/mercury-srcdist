...
#define MR_PROC_LABEL mercury__private_builtin__compare_local_int32_bitfields_4_p_0
	...
	TermVarX = (MR_Word) TermVarX_1 ;
	TermVarY = (MR_Word) TermVarY_2 ;
	ShiftVar = ShiftVar_3 ;
		{
...
#define MR_PROC_LABEL mercury__private_builtin__compare_local_uint_bitfields_5_p_0
	...
	MR_Word TermVarY;
	MR_Integer ShiftVar;
	MR_Integer NumBitsVar;
	MR_Word ResultVar;

	TermVarX = (MR_Word) TermVarX_1 ;
	TermVarY = (MR_Word) TermVarY_2 ;
	ShiftVar = ShiftVar_3 ;
	NumBitsVar = NumBitsVar_4 ;
		{
...
mercury__private_builtin__compare_remote_int32_bitfields_6_p_0(
  ...
  MR_Box TermVarY_2,
  MR_Integer Ptag_3,
  MR_Integer CellOffsetVar_4,
  MR_Integer ShiftVar_5,
  MR_Word * ResultVar_6)
{
  {
{
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      mercury__string__append_3_p_2((MR_String) " not implemented\n", (MR_String) "for this target language (or compiler back-end).", &Var_13);
      mercury__string__append_3_p_2((MR_String) "compare for foreign types", Var_13, &Var_12);
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      mercury__string__append_3_p_2((MR_String) " not implemented\n", (MR_String) "for this target language (or compiler back-end).", &Var_11);
      mercury__string__append_3_p_2((MR_String) "unify for foreign types", Var_11, &Var_10);
...
{
  {
    ...
    mercury__string__append_3_p_2((MR_String) " not implemented\n", (MR_String) "for this target language (or compiler back-end).", &Var_8);
    mercury__string__append_3_p_2((MR_String) "predicate \140private_builtin.builtin_compound_lt\'/2", Var_8, &Var_7);
...
{
  {
    ...
    mercury__string__append_3_p_2((MR_String) " not implemented\n", (MR_String) "for this target language (or compiler back-end).", &Var_8);
    mercury__string__append_3_p_2((MR_String) "predicate \140private_builtin.builtin_compound_eq\'/2", Var_8, &Var_7);
    mercury__string__append_3_p_2((MR_String) "sorry, ", Var_7, &Var_5);
    mercury__require__error_1_p_0(Var_5);
    return MR_TRUE;
  }
