...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_undo_1_0
	Ticket = MR_r1;
{
#line 799 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_undo);
#endif
;}
#line 1398 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_commit_1_0
	Ticket = MR_r1;
{
#line 808 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_commit);
#endif
;}
#line 1430 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_solve_1_0
	Ticket = MR_r1;
{
#line 817 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_solve);
#endif
;}
#line 1462 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 835 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_prune_ticket();
#endif
;}
#line 1522 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__prune_tickets_to_1_0
	TicketCounter = MR_r1;
{
#line 855 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_prune_tickets_to(TicketCounter);
#endif
;}
#line 1588 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__free_heap_1_0
	Val = MR_r2;
{
#line 1167 "private_builtin.m"

    MR_free_heap((void *) Val);
;}
#line 1673 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1188 "private_builtin.m"

#ifndef MR_CONSERVATIVE_GC
    MR_restore_hp(SavedHeapPointer);
#endif
;}
#line 1780 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
