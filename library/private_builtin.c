...
#define	MR_PROC_LABEL	mercury__private_builtin__superclass_from_typeclass_info_3_0
	...
	Index = MR_r2;
{
#line 665 "private_builtin.m"

    TypeClassInfo =
        MR_typeclass_info_superclass_info(TypeClassInfo0, Index);
;}
#line 1346 "private_builtin.c"
	MR_r1 = TypeClassInfo;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__private_builtin__instance_constraint_from_typeclass_info_3_0
	...
	Index = MR_r2;
{
#line 675 "private_builtin.m"

    TypeClassInfo =
        MR_typeclass_info_arg_typeclass_info(TypeClassInfo0, Index);
;}
#line 1381 "private_builtin.c"
	MR_r1 = TypeClassInfo;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_undo_1_0
	Ticket = MR_r1;
{
#line 843 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_undo);
#endif
;}
#line 1448 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_commit_1_0
	Ticket = MR_r1;
{
#line 852 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_commit);
#endif
;}
#line 1480 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_solve_1_0
	Ticket = MR_r1;
{
#line 861 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_solve);
#endif
;}
#line 1512 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 870 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_discard_ticket();
#endif
;}
#line 1542 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 879 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_prune_ticket();
#endif
;}
#line 1572 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__free_heap_1_0
	Val = MR_r2;
{
#line 1211 "private_builtin.m"

    MR_free_heap((void *) Val);
;}
#line 1723 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
