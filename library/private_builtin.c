...
#line 24 "private_builtin.c"
#include "private_builtin.mh"

#line 27 "private_builtin.c"
#line 520 "io.int"
#include "io.mh"

#line 31 "private_builtin.c"
#line 526 "io.int"
#include "string.mh"

#line 35 "private_builtin.c"
#line 23 "bitmap.int2"
#include "bitmap.mh"

#line 39 "private_builtin.c"
#line 26 "time.int2"
#include "time.mh"

#line 43 "private_builtin.c"
#line 28 "array.int2"
#include "array.mh"

#line 47 "private_builtin.c"
#line 4 "builtin.opt"
#include "builtin.mh"

#line 51 "private_builtin.c"
#line 103 "rtti_implementation.opt"
#include "rtti_implementation.mh"

#line 55 "private_builtin.c"
#line 14 "exception.opt"
#include "exception.mh"

#line 59 "private_builtin.c"
#line 3 "construct.opt"
#include "construct.mh"

#line 63 "private_builtin.c"
#line 22 "store.opt"
#include "store.mh"

#line 67 "private_builtin.c"
#line 4 "char.opt"
#include "char.mh"

#line 71 "private_builtin.c"
#line 3 "float.opt"
#include "float.mh"

#line 75 "private_builtin.c"
#line 3 "math.opt"
#include "math.mh"

#line 79 "private_builtin.c"
#line 4 "int.opt"
#include "int.mh"

#line 83 "private_builtin.c"
#line 131 "io.opt"
#include "dir.mh"
...
MR_decl_label2(__Compare___private_builtin__store_at_ref_type_1_0, 2,3)
...
MR_define_entry(mercury__private_builtin__builtin_unify_string_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (strcmp((char *)MR_r2, (char *)MR_r1) == 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_undo_1_0
	Ticket = MR_r1;
{
#line 711 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_undo);
#endif
;}
#line 1342 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__private_builtin__reset_ticket_commit_1_0
	Ticket = MR_r1;
{
#line 720 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_reset_ticket(Ticket, MR_commit);
#endif
;}
#line 1374 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 747 "private_builtin.m"

#ifdef MR_USE_TRAIL
    MR_prune_ticket();
#endif
;}
#line 1466 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__private_builtin__trailed_nondet_pragma_foreign_code_0_0);
	...
	MR_Word	Strs;
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__private_builtin__trailed_nondet_pragma_foreign_code_0_0
	Strs = (MR_Word) MR_TAG_COMMON(1,0,3);
{
#line 600 "string.opt"
{
    MR_Word list = Strs;
...
#define	MR_PROC_LABEL	mercury__private_builtin__free_heap_1_0
	Val = MR_r2;
{
#line 1015 "private_builtin.m"

    MR_free_heap((void *) Val);
;}
#line 1617 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1036 "private_builtin.m"

#ifndef MR_CONSERVATIVE_GC
    MR_restore_hp(SavedHeapPointer);
#endif
;}
#line 1724 "private_builtin.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__private_builtin__reclaim_heap_nondet_pragma_foreign_code_0_0);
	...
	MR_Word	Strs;
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__private_builtin__reclaim_heap_nondet_pragma_foreign_code_0_0
	Strs = (MR_Word) MR_TAG_COMMON(1,0,7);
{
#line 600 "string.opt"
{
    MR_Word list = Strs;
...
MR_BEGIN_MODULE(private_builtin_module63)
	...
	MR_init_label2(__Compare___private_builtin__store_at_ref_type_1_0,2,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___private_builtin__store_at_ref_type_1_0);
	...
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___private_builtin__store_at_ref_type_1_0_i2);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___private_builtin__store_at_ref_type_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
		MR_GOTO_LAB(__Compare___private_builtin__store_at_ref_type_1_0_i3);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___private_builtin__store_at_ref_type_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__private_builtin__write_out_proc_statics(FILE *fp);
#endif
