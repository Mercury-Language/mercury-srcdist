...
ifeq ($(TARGET_ASM),yes)
mdb.declarative_analyser.mh mdb.declarative_analyser.mih : mdb.declarative_analyser.s
else
mdb.declarative_analyser.mh mdb.declarative_analyser.mih : mdb.declarative_analyser.c
endif

ifeq ($(TARGET_ASM),yes)
mdb.declarative_analyser.module_dep : mdb.declarative_analyser.s
else
 ifeq ($(findstring il,$(GRADE)),il)
mdb.declarative_analyser.module_dep : mdb.declarative_analyser.il
  ifeq ($(findstring java,$(GRADE)),java)
mdb.declarative_analyser.module_dep : mercury/mdb_/declarative_analyser.java
  else
...
ifeq ($(TARGET_ASM),yes)
mdb.declarative_analyser.s_date : declarative_analyser.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdb.declarative_analyser $(ERR_REDIRECT)
mdb.declarative_analyser.pic_s_date : declarative_analyser.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdb.declarative_analyser $(ERR_REDIRECT)
endif # TARGET_ASM
