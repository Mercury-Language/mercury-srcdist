  ...
  *STATE_VARIABLE_DiffNum_20 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_DiffNum_0_19 + (MR_Unsigned) 1);
  ...
  else
  {
    ...
    PosnsStrs_87 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdb__diff_scalar_common_5[0]), Posns_85);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (PosnStr_86));
      MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) (PosnsStrs_87));
    }
    PathStr_14 = mercury__string__join_list_2_f_0((MR_String) "/", Var_90);
  }
  Var_25 = mercury__univ__univ_value_1_f_0(&TypeInfo__44_44, UnivA_12);
  mercury__deconstruct__functor_4_p_2(TypeInfo__44_44, Var_25, (MR_Integer) 2, &FunctorA_15, &ArityA_16);
  Var_27 = mercury__univ__univ_value_1_f_0(&TypeInfo__45_45, UnivB_13);
  mercury__deconstruct__functor_4_p_2(TypeInfo__45_45, Var_27, (MR_Integer) 2, &FunctorB_17, &ArityB_18);
  ...
  MR_Word Univ2_12)
{
  ...
  if (succeeded)
  {
    MR_Word TypeInfo__28_146;
    MR_Word TypeInfo__29_147;
    MR_Word RevDiffs_16;
    MR_Word AllDiffs_17;
    MR_Integer NumAllDiffs_18;
    MR_String Functor1_133;
    MR_Word Args1_135;
    MR_String Functor2_136;
    MR_Word Args2_138;
    MR_Box Var_140;
    MR_Box Var_142;
    MR_Integer Var_134;
    ...
    Var_140 = mercury__univ__univ_value_1_f_0(&TypeInfo__28_146, Univ1_11);
    mercury__deconstruct__deconstruct_5_p_2(TypeInfo__28_146, Var_140, (MR_Integer) 2, &Functor1_133, &Var_134, &Args1_135);
    Var_142 = mercury__univ__univ_value_1_f_0(&TypeInfo__29_147, Univ2_12);
    mercury__deconstruct__deconstruct_5_p_2(TypeInfo__29_147, Var_142, (MR_Integer) 2, &Functor2_136, &Var_137, &Args2_138);
    succeeded = (strcmp(Functor1_133, Functor2_136) == 0);
    if (succeeded)
      mdb__diff__compute_arg_diffs_6_p_0(Args1_135, Args2_138, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) ((MR_Unsigned) 0U), &RevDiffs_16);
    else
    {
      MR_Word Path_139;
      MR_Word Var_145;

      mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) ((MR_Unsigned) 0U), &Path_139);
      {
        Var_145 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_145, 0) = ((MR_Box) (Path_139));
        MR_hl_field(MR_mktag(0), Var_145, 1) = ((MR_Box) (Univ1_11));
        MR_hl_field(MR_mktag(0), Var_145, 2) = ((MR_Box) (Univ2_12));
      }
      {
        RevDiffs_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), RevDiffs_16, 0) = ((MR_Box) (Var_145));
        MR_hl_field(MR_mktag(1), RevDiffs_16, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
  ...
  MR_Word * STATE_VARIABLE_RevDiffs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word TypeInfo__28_58;
        MR_Word TypeInfo__29_59;
        ...
        Var_52 = mercury__univ__univ_value_1_f_0(&TypeInfo__28_58, Var_44);
        mercury__deconstruct__deconstruct_5_p_2(TypeInfo__28_58, Var_52, (MR_Integer) 2, &Functor1_45, &Var_46, &Args1_47);
        Var_54 = mercury__univ__univ_value_1_f_0(&TypeInfo__29_59, Arg2_30);
        mercury__deconstruct__deconstruct_5_p_2(TypeInfo__29_59, Var_54, (MR_Integer) 2, &Functor2_48, &Var_49, &Args2_50);
        ...
        else
        {
          ...
          mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_38, &Path_51);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Path_51));
            MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (Var_44));
            MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) (Arg2_30));
          }
          {
            STATE_VARIABLE_RevDiffs_39_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevDiffs_39_39, 0) = ((MR_Box) (Var_57));
