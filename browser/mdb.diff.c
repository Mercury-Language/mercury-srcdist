...
{
  {
    ...
    if (mdb__diff__succeeded)
      *mdb__diff__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mdb__diff__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__diff__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__diff__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mdb__diff__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdb__diff__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__diff__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mdb__diff__Var_10;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &mdb__diff_scalar_common_1[0], &mdb__diff__Var_10, ((MR_Box) (mdb__diff__Var_4)), ((MR_Box) (mdb__diff__Var_7)));
        }
        ...
        if (mdb__diff__succeeded)
          *mdb__diff__HeadVar__1_1 = mdb__diff__Var_10;
        else
          {
            ...
            {
              mercury__univ____Compare____univ_0_0(&mdb__diff__Var_11, mdb__diff__Var_5, mdb__diff__Var_8);
            }
            ...
            if (mdb__diff__succeeded)
              *mdb__diff__HeadVar__1_1 = mdb__diff__Var_11;
              ...
              {
                mercury__univ____Compare____univ_0_0(mdb__diff__HeadVar__1_1, mdb__diff__Var_6, mdb__diff__Var_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mdb__diff__succeeded)
      ...
      {
        MR_Word mdb__diff__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdb__diff__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__diff__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mdb__diff__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__diff__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__diff__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 2)));

        {
          mdb__diff__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &mdb__diff_scalar_common_1[0], ((MR_Box) (mdb__diff__Var_3)), ((MR_Box) (mdb__diff__Var_6)));
        }
        if (mdb__diff__succeeded)
          {
            {
              mdb__diff__succeeded = mercury__univ____Unify____univ_0_0(mdb__diff__Var_4, mdb__diff__Var_7);
            }
            if (mdb__diff__succeeded)
              {
                mdb__diff__succeeded = mercury__univ____Unify____univ_0_0(mdb__diff__Var_5, mdb__diff__Var_8);
              }
          }
      }
    return mdb__diff__succeeded;
