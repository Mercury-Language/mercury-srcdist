  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = Posns_8;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Var_43;
          MR_Word next_value_of_HeadVar__2_2 = Args2_31;
          MR_Integer next_value_of_ArgNum_4 = Var_40;
          MR_Word next_value_of_STATE_VARIABLE_RevDiffs_0_5 = STATE_VARIABLE_RevDiffs_39_39;
