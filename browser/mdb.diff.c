...
{
  {
    ...
    *STATE_VARIABLE_DiffNum_19 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_DiffNum_0_18 + (MR_Unsigned) 1);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer FirstShown_20 = (MR_Integer) ((MR_Unsigned) Drop_7 + (MR_Unsigned) 1);
