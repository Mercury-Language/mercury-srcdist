...
{
  {
    ...
    if (mdb__diff__succeeded)
      *mdb__diff__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mdb__diff__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__diff__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdb__diff__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__diff__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__diff__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mdb__diff__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mdb__diff__Var_10;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &mdb__diff_scalar_common_1[0], &mdb__diff__Var_10, ((MR_Box) (mdb__diff__ArgX1_4)), ((MR_Box) (mdb__diff__ArgY1_5)));
        }
        mdb__diff__succeeded = (mdb__diff__Var_10 == (MR_Integer) 0);
        mdb__diff__succeeded = !(mdb__diff__succeeded);
        if (mdb__diff__succeeded)
          *mdb__diff__HeadVar__1_1 = mdb__diff__Var_10;
        else
          {
            MR_Word mdb__diff__Var_11;

            {
              mercury__univ____Compare____univ_0_0(&mdb__diff__Var_11, mdb__diff__ArgX2_6, mdb__diff__ArgY2_7);
            }
            mdb__diff__succeeded = (mdb__diff__Var_11 == (MR_Integer) 0);
            mdb__diff__succeeded = !(mdb__diff__succeeded);
            if (mdb__diff__succeeded)
              *mdb__diff__HeadVar__1_1 = mdb__diff__Var_11;
            else
              {
                mercury__univ____Compare____univ_0_0(mdb__diff__HeadVar__1_1, mdb__diff__ArgX3_8, mdb__diff__ArgY3_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mdb__diff__succeeded)
      ...
      {
        MR_Word mdb__diff__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdb__diff__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__diff__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__diff__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__diff__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mdb__diff__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__diff__HeadVar__2_2, (MR_Integer) 2)));

        {
          mdb__diff__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &mdb__diff_scalar_common_1[0], ((MR_Box) (mdb__diff__ArgX1_3)), ((MR_Box) (mdb__diff__ArgY1_4)));
        }
        if (mdb__diff__succeeded)
          {
            {
              mdb__diff__succeeded = mercury__univ____Unify____univ_0_0(mdb__diff__ArgX2_5, mdb__diff__ArgY2_6);
            }
            if (mdb__diff__succeeded)
              {
                mdb__diff__succeeded = mercury__univ____Unify____univ_0_0(mdb__diff__ArgX3_7, mdb__diff__ArgY3_8);
              }
          }
      }
...
{
  {
    ...
    MR_Box mdb__diff__Var_35;
    MR_Box mdb__diff__Var_37;
    MR_String mdb__diff__Var_53;
    MR_Word mdb__diff__Var_59;
    MR_String mdb__diff__Var_65;
    MR_String mdb__diff__Var_78;

    *mdb__diff__STATE_VARIABLE_DiffNum_19 = (mdb__diff__STATE_VARIABLE_DiffNum_0_18 + (MR_Integer) 1);
    mdb__diff__Var_59 = (MR_Word) &mdb__diff_scalar_common_2[0];
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_59, *mdb__diff__STATE_VARIABLE_DiffNum_19, &mdb__diff__Var_53);
    }
    {
      mercury__io__write_string_3_p_0(mdb__diff__Var_53);
    }
    {
    ...
    {
      mdb__diff__Var_35 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_50_50, mdb__diff__Univ1_10);
    }
    {
      mercury__deconstruct__functor_4_p_2(mdb__diff__TypeInfo_50_50, mdb__diff__Var_35, (MR_Integer) 2, &mdb__diff__Functor1_14, &mdb__diff__Arity1_15);
    }
    {
      mdb__diff__Var_37 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_51_51, mdb__diff__Univ2_11);
    }
    {
      mercury__deconstruct__functor_4_p_2(mdb__diff__TypeInfo_51_51, mdb__diff__Var_37, (MR_Integer) 2, &mdb__diff__Functor2_16, &mdb__diff__Arity2_17);
    }
    {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_59, mdb__diff__Arity1_15, &mdb__diff__Var_65);
    }
    {
      mercury__io__write_string_3_p_0(mdb__diff__Var_65);
    }
    {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_59, mdb__diff__Arity2_17, &mdb__diff__Var_78);
    }
    {
      mercury__io__write_string_3_p_0(mdb__diff__Var_78);
    }
    {
      mercury__io__write_string_3_p_0((MR_String) "\n");
    }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdb__diff__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              MR_Word mdb__diff__next_value_of_HeadVar__1_1 = mdb__diff__Posns_8;

              mdb__diff__HeadVar__1_1 = mdb__diff__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
    ...
    if (mdb__diff__succeeded)
      {
        ...
        MR_Word mdb__diff__Var_18;
        MR_Word mdb__diff__Var_19;
        ...
        if (mdb__diff__succeeded)
          {
            ...
            if (mdb__diff__succeeded)
              {
                mdb__diff__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__diff__Diffs_17, (MR_Integer) 0)));
                mdb__diff__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__diff__Diffs_17, (MR_Integer) 1)));
              }
          }
        if (mdb__diff__succeeded)
          {
            ...
            MR_Integer mdb__diff__Var_29 = (mdb__diff__Drop_7 + mdb__diff__Max_8);
            MR_Integer mdb__diff__Var_23;
            MR_Box mdb__diff__conv2_Var_23;
            MR_Box mdb__diff__conv1_STATE_VARIABLE_IO_25;

            {
              mdb__diff__LastShown_21 = mercury__int__min_2_f_0(mdb__diff__Var_29, mdb__diff__NumAllDiffs_16);
            }
            mdb__diff__succeeded = (mdb__diff__FirstShown_20 == mdb__diff__LastShown_21);
            if (mdb__diff__succeeded)
              {
                MR_String mdb__diff__Var_70;
                MR_Word mdb__diff__Var_76;
                MR_String mdb__diff__Var_80;

                {
                  mercury__io__write_string_3_p_0((MR_String) "There are ");
                }
                mdb__diff__Var_76 = (MR_Word) &mdb__diff_scalar_common_2[0];
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_76, mdb__diff__NumAllDiffs_16, &mdb__diff__Var_70);
                }
                {
                  mercury__io__write_string_3_p_0(mdb__diff__Var_70);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) " diffs, showing diff ");
                }
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_76, mdb__diff__FirstShown_20, &mdb__diff__Var_80);
                }
                {
                  mercury__io__write_string_3_p_0(mdb__diff__Var_80);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) ":\n");
                }
              ...
              {
                MR_String mdb__diff__Var_91;
                MR_Word mdb__diff__Var_97;
                MR_String mdb__diff__Var_101;
                MR_String mdb__diff__Var_111;

                {
                  mercury__io__write_string_3_p_0((MR_String) "There are ");
                }
                mdb__diff__Var_97 = (MR_Word) &mdb__diff_scalar_common_2[0];
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_97, mdb__diff__NumAllDiffs_16, &mdb__diff__Var_91);
                }
                {
                  mercury__io__write_string_3_p_0(mdb__diff__Var_91);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) " diffs, showing diffs ");
                }
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_97, mdb__diff__FirstShown_20, &mdb__diff__Var_101);
                }
                {
                  mercury__io__write_string_3_p_0(mdb__diff__Var_101);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) "-");
                }
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mdb__diff__Var_97, mdb__diff__LastShown_21, &mdb__diff__Var_111);
                }
                {
                  mercury__io__write_string_3_p_0(mdb__diff__Var_111);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) ":\n");
                }
            ...
            {
              mercury__list__foldl2_6_p_11(mdb__diff__TypeCtorInfo_59_59, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &mercury__io__io__type_ctor_info_state_0, (MR_Word) &mdb__diff_scalar_common_4[0], mdb__diff__ShowDiffs_22, ((MR_Box) (mdb__diff__Drop_7)), &mdb__diff__conv2_Var_23, ((MR_Box) ((MR_Integer) 0)), &mdb__diff__conv1_STATE_VARIABLE_IO_25);
            }
            mdb__diff__Var_23 = ((MR_Integer) mdb__diff__conv2_Var_23);
          }
        else
          {
            ...
            if (mdb__diff__succeeded)
            ...
            else
              {
                ...
                if (mdb__diff__succeeded)
                  ...
                  {
                    MR_String mdb__diff__Var_122;

                    {
                      mercury__io__write_string_3_p_0((MR_String) "There are only ");
                    }
                    {
                      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdb__diff_scalar_common_2[0], mdb__diff__NumAllDiffs_16, &mdb__diff__Var_122);
                    }
                    {
                      mercury__io__write_string_3_p_0(mdb__diff__Var_122);
                    }
                    {
...
{
  {
    ...
    MR_Box mdb__diff__Var_20;
    MR_Box mdb__diff__Var_22;
    MR_Integer mdb__diff__Var_11;
    MR_Integer mdb__diff__Var_14;

    {
      mdb__diff__Var_20 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_28_28, mdb__diff__Univ1_6);
    }
    {
      mercury__deconstruct__deconstruct_5_p_2(mdb__diff__TypeInfo_28_28, mdb__diff__Var_20, (MR_Integer) 2, &mdb__diff__Functor1_10, &mdb__diff__Var_11, &mdb__diff__Args1_12);
    }
    {
      mdb__diff__Var_22 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_29_29, mdb__diff__Univ2_7);
    }
    {
      mercury__deconstruct__deconstruct_5_p_2(mdb__diff__TypeInfo_29_29, mdb__diff__Var_22, (MR_Integer) 2, &mdb__diff__Functor2_13, &mdb__diff__Var_14, &mdb__diff__Args2_15);
    }
    ...
    if (mdb__diff__succeeded)
    ...
    else
      {
        ...
        {
          mdb__diff__Var_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), mdb__diff__Var_27, 0) = ((MR_Box) (mdb__diff__Path_16));
          MR_hl_field(MR_mktag(0), mdb__diff__Var_27, 1) = ((MR_Box) (mdb__diff__Univ1_6));
          MR_hl_field(MR_mktag(0), mdb__diff__Var_27, 2) = ((MR_Box) (mdb__diff__Univ2_7));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *mdb__diff__STATE_VARIABLE_RevDiffs_19 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdb__diff__Var_27));
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdb__diff__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word mdb__diff__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__diff__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word mdb__diff__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__diff__HeadVar__1_1, (MR_Integer) 0)));
            ...
            if ((mdb__diff__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                MR_Word mdb__diff__Var_38;
                MR_Word mdb__diff__STATE_VARIABLE_RevDiffs_39_39;
                MR_Integer mdb__diff__Var_40;
                MR_String mdb__diff__Functor1_52;
                MR_Word mdb__diff__Args1_54;
                MR_String mdb__diff__Functor2_55;
                MR_Word mdb__diff__Args2_57;
                MR_Box mdb__diff__Var_59;
                MR_Box mdb__diff__Var_61;
                MR_Integer mdb__diff__Var_53;
                MR_Integer mdb__diff__Var_56;

                {
                  mdb__diff__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), mdb__diff__Var_38, 0) = ((MR_Box) (mdb__diff__ArgNum_4));
                  MR_hl_field(MR_mktag(1), mdb__diff__Var_38, 1) = ((MR_Box) (mdb__diff__STATE_VARIABLE_RevPath_0_3));
                }
                {
                  mdb__diff__Var_59 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_28_67, mdb__diff__Var_44);
                }
                {
                  mercury__deconstruct__deconstruct_5_p_2(mdb__diff__TypeInfo_28_67, mdb__diff__Var_59, (MR_Integer) 2, &mdb__diff__Functor1_52, &mdb__diff__Var_53, &mdb__diff__Args1_54);
                }
                {
                  mdb__diff__Var_61 = mercury__univ__univ_value_1_f_0(&mdb__diff__TypeInfo_29_68, mdb__diff__Arg2_30);
                }
                {
                  mercury__deconstruct__deconstruct_5_p_2(mdb__diff__TypeInfo_29_68, mdb__diff__Var_61, (MR_Integer) 2, &mdb__diff__Functor2_55, &mdb__diff__Var_56, &mdb__diff__Args2_57);
                }
                mdb__diff__succeeded = (strcmp(mdb__diff__Functor1_52, mdb__diff__Functor2_55) == 0);
                if (mdb__diff__succeeded)
                  {
                    {
                      mdb__diff__compute_arg_diffs_6_p_0(mdb__diff__Args1_54, mdb__diff__Args2_57, mdb__diff__Var_38, (MR_Integer) 1, mdb__diff__STATE_VARIABLE_RevDiffs_0_5, &mdb__diff__STATE_VARIABLE_RevDiffs_39_39);
                    }
                  }
                else
                  {
                    MR_Word mdb__diff__Path_58;
                    MR_Word mdb__diff__Var_66;

                    {
                      mercury__list__reverse_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, mdb__diff__Var_38, &mdb__diff__Path_58);
                    }
                    {
                      mdb__diff__Var_66 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), mdb__diff__Var_66, 0) = ((MR_Box) (mdb__diff__Path_58));
                      MR_hl_field(MR_mktag(0), mdb__diff__Var_66, 1) = ((MR_Box) (mdb__diff__Var_44));
                      MR_hl_field(MR_mktag(0), mdb__diff__Var_66, 2) = ((MR_Box) (mdb__diff__Arg2_30));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), mdb__diff__STATE_VARIABLE_RevDiffs_39_39, 0) = ((MR_Box) (mdb__diff__Var_66));
                      MR_hl_field(MR_mktag(1), mdb__diff__STATE_VARIABLE_RevDiffs_39_39, 1) = ((MR_Box) (mdb__diff__STATE_VARIABLE_RevDiffs_0_5));
                    }
                  }
                mdb__diff__Var_40 = (mdb__diff__ArgNum_4 + (MR_Integer) 1);
                /* direct tailcall eliminated */
                {
                  MR_Word mdb__diff__next_value_of_HeadVar__1_1 = mdb__diff__Var_43;
                  MR_Word mdb__diff__next_value_of_HeadVar__2_2 = mdb__diff__Args2_31;
                  MR_Integer mdb__diff__next_value_of_ArgNum_4 = mdb__diff__Var_40;
                  MR_Word mdb__diff__next_value_of_STATE_VARIABLE_RevDiffs_0_5 = mdb__diff__STATE_VARIABLE_RevDiffs_39_39;

                  mdb__diff__STATE_VARIABLE_RevDiffs_0_5 = mdb__diff__next_value_of_STATE_VARIABLE_RevDiffs_0_5;
                  mdb__diff__ArgNum_4 = mdb__diff__next_value_of_ArgNum_4;
                  mdb__diff__HeadVar__2_2 = mdb__diff__next_value_of_HeadVar__2_2;
                  mdb__diff__HeadVar__1_1 = mdb__diff__next_value_of_HeadVar__1_1;
                }
                continue;
              }
