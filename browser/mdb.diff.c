  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) ((MR_Unsigned) 0U), &Path_138);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_144, 0) = ((MR_Box) (Path_138));
        MR_hl_field(MR_mktag(0), Var_144, 1) = ((MR_Box) (Univ1_11));
        MR_hl_field(MR_mktag(0), Var_144, 2) = ((MR_Box) (Univ2_12));
      }
      {
        RevDiffs_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), RevDiffs_16, 0) = ((MR_Box) (Var_144));
