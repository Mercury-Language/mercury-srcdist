...
MR_decl_label8(mdb__diff__compute_arg_diffs_6_0, 40,3,9,10,11,12,14,13)
MR_decl_label2(mdb__diff__compute_arg_diffs_6_0, 15,8)
MR_decl_label6(mdb__diff__compute_diffs_5_0, 2,3,4,5,6,8)
MR_decl_label8(mdb__diff__report_diffs_6_0, 3,4,5,7,8,9,11,14)
MR_decl_label7(mdb__diff__report_diffs_6_0, 15,17,19,10,21,24,2)
MR_decl_label8(mdb__diff__show_diff_5_0, 2,4,6,7,8,9,10,11)
MR_decl_label2(mdb__diff__show_diff_5_0, 12,13)
MR_decl_label4(mdb__diff__show_path_rest_3_0, 12,4,5,14)
MR_decl_label3(__Unify___mdb__diff__term_path_diff_0_0, 2,4,1)
MR_decl_label3(__Compare___mdb__diff__term_path_diff_0_0, 3,7,12)
...
MR_BEGIN_MODULE(mdb__diff_module1)
	...
	MR_init_label8(mdb__diff__compute_arg_diffs_6_0,40,3,9,10,11,12,14,13)
	MR_init_label2(mdb__diff__compute_arg_diffs_6_0,15,8)
MR_BEGIN_CODE
...
MR_def_label(mdb__diff__compute_arg_diffs_6_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(mdb__diff__compute_arg_diffs_6_0,3)
	...
	MR_np_call_localret_ent(fn__univ__univ_value_1_0,
		mdb__diff__compute_arg_diffs_6_0_i9);
MR_def_label(mdb__diff__compute_arg_diffs_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = (MR_Integer) 2;
	MR_np_call_localret_ent(deconstruct__deconstruct_5_2,
...
MR_def_label(mdb__diff__compute_arg_diffs_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(9), (char *)MR_r1) != 0)) {
		MR_GOTO_LAB(mdb__diff__compute_arg_diffs_6_0_i13);
	}
	MR_r1 = MR_sv(10);
	MR_r2 = MR_r3;
	MR_r3 = MR_sv(6);
	...
	MR_np_localcall_lab(mdb__diff__compute_arg_diffs_6_0,
		mdb__diff__compute_arg_diffs_6_0_i14);
MR_def_label(mdb__diff__compute_arg_diffs_6_0,14)
	...
	MR_GOTO_LAB(mdb__diff__compute_arg_diffs_6_0_i40);
...
extern const MR_TypeCtorInfo_Struct mercury_data_io__type_ctor_info_state_0;
MR_decl_entry(list__foldl2_6_8);
MR_decl_entry(io__write_string_3_0);

MR_BEGIN_MODULE(mdb__diff_module2)
	MR_init_entry1(mdb__diff__report_diffs_6_0);
	MR_init_label8(mdb__diff__report_diffs_6_0,3,4,5,7,8,9,11,14)
	MR_init_label7(mdb__diff__report_diffs_6_0,15,17,19,10,21,24,2)
MR_BEGIN_CODE
...
MR_def_label(mdb__diff__report_diffs_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__diff, term_path_diff);
	MR_np_call_localret_ent(list__reverse_2_0,
...
MR_def_label(mdb__diff__report_diffs_6_0,14)
	...
	MR_r1 = (MR_Word) MR_string_const("There are %d diffs, showing diff %d:\n", 37);
	}
...
MR_def_label(mdb__diff__report_diffs_6_0,15)
	...
	MR_r1 = (MR_Word) MR_string_const("There are %d diffs, showing diffs %d-%d:\n", 41);
	}
	MR_np_call_localret_ent(io__format_4_0,
		mdb__diff__report_diffs_6_0_i17);
MR_def_label(mdb__diff__report_diffs_6_0,17)
	...
	MR_np_call_localret_ent(list__take_upto_3_0,
		mdb__diff__report_diffs_6_0_i19);
MR_def_label(mdb__diff__report_diffs_6_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__diff, term_path_diff);
	...
	MR_decr_sp(6);
	MR_np_tailcall_ent(list__foldl2_6_8);
MR_def_label(mdb__diff__report_diffs_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(mdb__diff__report_diffs_6_0_i21);
	}
	MR_r1 = (MR_Word) MR_string_const("There are no diffs.\n", 20);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(mdb__diff__report_diffs_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(mdb__diff__report_diffs_6_0_i24);
	}
...
MR_def_label(mdb__diff__report_diffs_6_0,24)
	...
	MR_r1 = (MR_Word) MR_string_const("There are only %d diffs.\n", 25);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
...
MR_BEGIN_MODULE(mdb__diff_module3)
	...
	MR_init_label4(mdb__diff__show_path_rest_3_0,12,4,5,14)
MR_BEGIN_CODE
...
MR_def_label(mdb__diff__show_path_rest_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__diff__show_path_rest_3_0_i14);
	}
...
MR_def_label(mdb__diff__show_path_rest_3_0,5)
	...
	MR_GOTO_LAB(mdb__diff__show_path_rest_3_0_i12);
MR_def_label(mdb__diff__show_path_rest_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__diff_module4)
	...
	MR_init_label8(mdb__diff__show_diff_5_0,2,4,6,7,8,9,10,11)
	MR_init_label2(mdb__diff__show_diff_5_0,12,13)
MR_BEGIN_CODE
...
MR_def_label(mdb__diff__show_diff_5_0,2)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(mdb__diff__show_diff_5_0_i4);
	}
	MR_tempr1 = MR_tempr2;
...
MR_def_label(mdb__diff__show_diff_5_0,12)
	...
	MR_r1 = (MR_Word) MR_string_const("%s/%d vs %s/%d\n", 15);
	}
	MR_np_call_localret_ent(io__format_4_0,
...
MR_BEGIN_MODULE(mdb__diff_module5)
	...
	MR_init_label3(__Unify___mdb__diff__term_path_diff_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___mdb__diff__term_path_diff_0_0)
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___mdb__diff__term_path_diff_0_0_i2);
MR_def_label(__Unify___mdb__diff__term_path_diff_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(mdb__diff_module6)
	...
	MR_init_label3(__Compare___mdb__diff__term_path_diff_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_def_static(__Compare___mdb__diff__term_path_diff_0_0)
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___mdb__diff__term_path_diff_0_0_i3);
MR_def_label(__Compare___mdb__diff__term_path_diff_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__diff__term_path_diff_0_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___univ__univ_0_0,
		__Compare___mdb__diff__term_path_diff_0_0_i7);
MR_def_label(__Compare___mdb__diff__term_path_diff_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__diff__term_path_diff_0_0_i12);
	}
...
MR_def_label(__Compare___mdb__diff__term_path_diff_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__mdb__diff__write_out_proc_statics(FILE *fp);
#endif
