...
MR_decl_label8(mdb__diff__compute_arg_diffs_6_0, 43,3,10,11,12,13,15,14)
MR_decl_label2(mdb__diff__compute_arg_diffs_6_0, 16,8)
MR_decl_label6(mdb__diff__compute_diffs_5_0, 2,3,4,5,6,8)
MR_decl_label8(mdb__diff__report_diffs_6_0, 3,4,5,7,8,9,11,14)
MR_decl_label7(mdb__diff__report_diffs_6_0, 15,27,29,10,32,35,2)
MR_decl_label8(mdb__diff__show_diff_5_0, 4,6,8,9,10,11,12,13)
MR_decl_label2(mdb__diff__show_diff_5_0, 14,23)
...
MR_BEGIN_MODULE(mdb__diff_module1)
	...
	MR_init_label8(mdb__diff__compute_arg_diffs_6_0,43,3,10,11,12,13,15,14)
	MR_init_label2(mdb__diff__compute_arg_diffs_6_0,16,8)
MR_BEGIN_CODE
...
extern const MR_TypeCtorInfo_Struct mercury_data_io__type_ctor_info_state_0;
MR_decl_entry(list__foldl2_6_10);
...
MR_BEGIN_MODULE(mdb__diff_module2)
	...
	MR_init_label7(mdb__diff__report_diffs_6_0,15,27,29,10,32,35,2)
MR_BEGIN_CODE
...
MR_def_label(mdb__diff__report_diffs_6_0,29)
	...
	MR_decr_sp(6);
	MR_np_tailcall_ent(list__foldl2_6_10);
	}
MR_def_label(mdb__diff__report_diffs_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(mdb__diff__report_diffs_6_0_i32);
	}
...
MR_def_label(mdb__diff__report_diffs_6_0,32)
	...
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(mdb__diff__report_diffs_6_0_i35);
	}
	MR_r1 = (MR_Word) MR_string_const("There is only one diff.\n", 24);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(mdb__diff__report_diffs_6_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_BEGIN_MODULE(mdb__diff_module4)
	...
	MR_init_label8(mdb__diff__show_diff_5_0,4,6,8,9,10,11,12,13)
	MR_init_label2(mdb__diff__show_diff_5_0,14,23)
MR_BEGIN_CODE
