...
{
  {
    ...
    *STATE_VARIABLE_DiffNum_19 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_DiffNum_0_18 + (MR_Unsigned) (MR_Integer) 1);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), *STATE_VARIABLE_DiffNum_19, &Var_53);
    ...
    mercury__io__write_string_3_p_0((MR_String) "/");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), Arity1_15, &Var_65);
    ...
    mercury__io__write_string_3_p_0((MR_String) "/");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), Arity2_17, &Var_78);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mdb__diff__compute_diffs_5_p_0(Univ1_9, Univ2_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &RevDiffs_14);
      mercury__list__reverse_2_p_0((MR_Word) (&mdb__diff__mdb__diff__type_ctor_info_term_path_diff_0), RevDiffs_14, &AllDiffs_15);
      mercury__list__length_2_p_0((MR_Word) (&mdb__diff__mdb__diff__type_ctor_info_term_path_diff_0), AllDiffs_15, &NumAllDiffs_16);
      succeeded = mercury__list__drop_3_p_0((MR_Word) (&mdb__diff__mdb__diff__type_ctor_info_term_path_diff_0), Drop_7, AllDiffs_15, &Diffs_17);
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Diffs_17)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
      if (succeeded)
      {
        MR_Integer FirstShown_20 = (MR_Integer) ((MR_Unsigned) Drop_7 + (MR_Unsigned) (MR_Integer) 1);
        MR_Integer LastShown_21;
        MR_Word ShowDiffs_22;
        MR_Integer Var_29 = (MR_Integer) ((MR_Unsigned) Drop_7 + (MR_Unsigned) Max_8);
        MR_Box conv2_Var_23;
        ...
        if (succeeded)
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), NumAllDiffs_16, &Var_70);
          mercury__io__write_string_3_p_0(Var_70);
          mercury__io__write_string_3_p_0((MR_String) " diffs, showing diff ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), FirstShown_20, &Var_80);
        ...
        else
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) "There are ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), NumAllDiffs_16, &Var_91);
          mercury__io__write_string_3_p_0(Var_91);
          mercury__io__write_string_3_p_0((MR_String) " diffs, showing diffs ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), FirstShown_20, &Var_101);
          mercury__io__write_string_3_p_0(Var_101);
          mercury__io__write_string_3_p_0((MR_String) "-");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdb__diff_scalar_common_2[0]), LastShown_21, &Var_111);
          mercury__io__write_string_3_p_0(Var_111);
          mercury__io__write_string_3_p_0((MR_String) ":\n");
        }
        mercury__list__take_upto_3_p_0((MR_Word) (&mdb__diff__mdb__diff__type_ctor_info_term_path_diff_0), Max_8, Diffs_17, &ShowDiffs_22);
        mercury__list__foldl2_6_p_11((MR_Word) (&mdb__diff__mdb__diff__type_ctor_info_term_path_diff_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), (MR_Word) (&mdb__diff_scalar_common_4[0]), ShowDiffs_22, ((MR_Box) (Drop_7)), &conv2_Var_23, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_25);
      }
      else
      {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_40 = (MR_Integer) ((MR_Unsigned) ArgNum_4 + (MR_Unsigned) (MR_Integer) 1);
        // direct tailcall eliminated
        ;
