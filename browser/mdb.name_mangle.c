...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mdb__name_mangle____Compare____sym_name_0_0(&Var_15, ArgX2_6, ArgY2_7);
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        mdb__name_mangle____Compare____sym_name_0_0(&Var_8, Var_23, ArgY1_5);
        succeeded = (Var_8 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
          *HeadVar__1_1 = Var_8;
        else
          mercury__private_builtin__builtin_compare_string_3_p_0(HeadVar__1_1, Var_22, ArgY2_7);
      }
      else
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_Word PredOrFunc_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), MercuryProc_3, (MR_Integer) 0)));
    ...
    {
      MR_Word PredOrFunc_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), MercuryProc_3, (MR_Integer) 0)));
      ...
      mdb__name_mangle__sym_name_mangle_2_p_0(Module_40, &ModuleName_44);
      {
        ...
        succeeded = ((MR_tag((MR_Word) Module_40)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
