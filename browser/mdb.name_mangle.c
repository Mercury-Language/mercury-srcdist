...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_25;
      MR_Word Var_27;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), MercuryProc_3, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Word Var_58;
      MR_Word Var_60;
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), MercuryProc_3, (MR_Integer) 0)));
