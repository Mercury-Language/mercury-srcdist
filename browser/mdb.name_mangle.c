...
MR_decl_label2(__Unify___mdb__name_mangle__mercury_proc_0_0, 2,1)
MR_decl_label4(__Unify___mdb__name_mangle__sym_name_0_0, 5,3,31,1)
MR_decl_label5(__Compare___mdb__name_mangle__mercury_proc_0_0, 3,7,11,15,22)
MR_decl_label5(__Compare___mdb__name_mangle__sym_name_0_0, 7,5,3,13,37)
...
MR_BEGIN_MODULE(mdb__name_mangle_module10)
	...
	MR_init_label2(__Unify___mdb__name_mangle__mercury_proc_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__name_mangle__mercury_proc_0_0);
	...
	MR_np_call_localret_ent(__Unify___mdb__name_mangle__sym_name_0_0,
		__Unify___mdb__name_mangle__mercury_proc_0_0_i2);
MR_def_label(__Unify___mdb__name_mangle__mercury_proc_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdb__name_mangle__mercury_proc_0_0_i1);
	}
...
MR_BEGIN_MODULE(mdb__name_mangle_module11)
	...
	MR_init_label5(__Compare___mdb__name_mangle__mercury_proc_0_0,3,7,11,15,22)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__name_mangle__mercury_proc_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdb__name_mangle__mercury_proc_0_0_i3);
MR_def_label(__Compare___mdb__name_mangle__mercury_proc_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__mercury_proc_0_0_i22);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___mdb__name_mangle__sym_name_0_0,
		__Compare___mdb__name_mangle__mercury_proc_0_0_i7);
MR_def_label(__Compare___mdb__name_mangle__mercury_proc_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__mercury_proc_0_0_i22);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdb__name_mangle__mercury_proc_0_0_i11);
MR_def_label(__Compare___mdb__name_mangle__mercury_proc_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__mercury_proc_0_0_i22);
	}
	...
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdb__name_mangle__mercury_proc_0_0_i15);
MR_def_label(__Compare___mdb__name_mangle__mercury_proc_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__mercury_proc_0_0_i22);
	}
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdb__name_mangle__mercury_proc_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__name_mangle_module18)
	...
	MR_init_label4(__Unify___mdb__name_mangle__sym_name_0_0,5,3,31,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__name_mangle__sym_name_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___mdb__name_mangle__sym_name_0_0_i3);
	}
	MR_incr_sp(3);
	...
	MR_np_localcall_lab(__Unify___mdb__name_mangle__sym_name_0_0,
		__Unify___mdb__name_mangle__sym_name_0_0_i5);
...
MR_def_label(__Unify___mdb__name_mangle__sym_name_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(__Unify___mdb__name_mangle__sym_name_0_0_i31);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(__Unify___mdb__name_mangle__sym_name_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(mdb__name_mangle_module19)
	...
	MR_init_label5(__Compare___mdb__name_mangle__sym_name_0_0,7,5,3,13,37)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__name_mangle__sym_name_0_0);
	...
	MR_np_localcall_lab(__Compare___mdb__name_mangle__sym_name_0_0,
		__Compare___mdb__name_mangle__sym_name_0_0_i7);
MR_def_label(__Compare___mdb__name_mangle__sym_name_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__sym_name_0_0_i37);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
...
MR_def_label(__Compare___mdb__name_mangle__sym_name_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___mdb__name_mangle__sym_name_0_0_i13);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdb__name_mangle__sym_name_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_r2 = MR_ctfield(1, MR_r2, 0);
	MR_np_tailcall_ent(private_builtin__builtin_compare_string_3_0);
MR_def_label(__Compare___mdb__name_mangle__sym_name_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
