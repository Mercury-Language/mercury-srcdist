...
MR_decl_label3(mdb__name_mangle__sym_name_mangle_2_0, 16,5,6)
...
MR_BEGIN_MODULE(mdb__name_mangle_module2)
	...
	MR_init_label3(mdb__name_mangle__sym_name_mangle_2_0,16,5,6)
MR_BEGIN_CODE
...
MR_def_static(mdb__name_mangle__sym_name_mangle_2_0)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(mdb__name_mangle__sym_name_mangle_2_0_i16);
	}
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_tailcall_ent(mdb__name_mangle__name_mangle_2_0);
MR_def_label(mdb__name_mangle__sym_name_mangle_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
