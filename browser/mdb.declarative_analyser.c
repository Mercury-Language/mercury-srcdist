        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Var_251 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word ArgY1_41 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0)));
              ...
              case (MR_Integer) 3:
                {
                  ...
                  MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 0)));
                  MR_Word Var_197;
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word ArgX1_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
            MR_Word ArgY1_8;
            ...
            if (succeeded)
            {
              ...
              ArgY1_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Integer ArgY3_34;
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 0)));
            MR_Unsigned packed_word_3;

            succeeded = ((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3);
            if (succeeded)
            {
              packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 4)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 4)));
                  MR_Word Var_28;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 4)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_75, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), SearchMode_3, (MR_Integer) 4)));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SearchMode_3, (MR_Integer) 0)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) Reason_3)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word PrimOpType_5 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason_3, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
          ...
          MR_String Var_86;
          MR_String Var_88;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason_3, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_3, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                SearchMode_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              STATE_VARIABLE_Analyser_32_32 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Answer_7, (MR_Integer) 1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word HowTrack_19 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Answer_7, (MR_Integer) 3))) >> 1)) & (MR_Integer) 1);
        ...
        MR_Word Var_32;
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Answer_7, (MR_Integer) 3)));
        MR_Word Var_21;
        MR_Word Var_109;
        MR_Word Var_110;
        MR_Word Var_111;
        ...
        {
          STATE_VARIABLE_Analyser_26_26 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if ((MaybeRequireExplicit_13 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          STATE_VARIABLE_Analyser_27_27 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        Var_52 = Var_41;
        {
          STATE_VARIABLE_Analyser_33_33 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      STATE_VARIABLE_Analyser_22_22 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), OldMode_12, (MR_Integer) 4)));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), OldMode_12, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), FindOriginResponse_27, (MR_Integer) 3)));
          ...
          if (succeeded)
            {
              NewLastUnknown_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word PrimOpType_31 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), FindOriginResponse_27, (MR_Integer) 3))) >> 1)) & (MR_Integer) 3);
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), FindOriginResponse_27, (MR_Integer) 3)));
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  MaybePath_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          if (succeeded)
          {
            ...
            {
              Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_59, 0) = (MR_Box) (((((MR_Unsigned) (PrimOpType_31) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                Reason_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Reason_38, 0) = (MR_Box) (((((MR_Unsigned) (PrimOpType_31) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  top_of_proc_1:;
    {
      ...
      {
        {
          Response_17 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  top_of_proc_2:;
    {
      ...
      if ((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          {
            Response_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            {
              NewMaybeLastUnknown_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((InadmissibleChildren_11 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        Bug_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        {
          ...
          {
            MaybeHeuristic_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), FallBackSearchMode_6, (MR_Integer) 0)));
          MR_Word Var_50;
          MR_Word Var_51;
          MR_Word Var_52;
          MR_Word Var_53;
