  ...
  MR_Integer * HeadVar__7_70)
{
  ...
  Weight_79 = mdb__declarative_edt__get_weight_2_f_0(TypeInfo_72_72, STATE_VARIABLE_SearchSpace_0_7, HeadVar__3_66);
  succeeded = (Weight_79 > HeadVar__4_67);
  if (succeeded)
  {
    *HeadVar__5_68 = Weight_79;
