...
{
  {
    ...
    MR_Integer mdb__declarative_analyser__V_12_12;
    MR_Integer mdb__declarative_analyser__V_13_13 = (mdb__declarative_analyser__Bottom_9 - mdb__declarative_analyser__Top_8);

    {
      mdb__declarative_analyser__V_12_12 = mercury__int__f_47_47_2_f_0(mdb__declarative_analyser__V_13_13, (MR_Integer) 2);
    }
    mdb__declarative_analyser__Middle_11 = (mdb__declarative_analyser__Top_8 + mdb__declarative_analyser__V_12_12);
    {
              ...
              if (mdb__declarative_analyser__succeeded)
                {
                  /* direct tailcall eliminated */
                  {
                    MR_Word mdb__declarative_analyser__OldMode__tmp_copy_12 = mdb__declarative_analyser__FallBackSearchMode_13;

                    mdb__declarative_analyser__OldMode_12 = mdb__declarative_analyser__OldMode__tmp_copy_12;
                  }
                  continue;
                }
              else
                {
                  ...
                  if (mdb__declarative_analyser__succeeded)
                    {
                      MR_Word mdb__declarative_analyser__V_54_54;
                      MR_Integer mdb__declarative_analyser__V_55_55;
                      MR_Word mdb__declarative_analyser__V_56_56;
                      MR_Box mdb__declarative_analyser__conv1_V_55_55;

                      {
                        mdb__declarative_analyser__V_54_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), mdb__declarative_analyser__V_54_54, 0) = ((MR_Box) (mdb__declarative_analyser__NewTop_47));
                        MR_hl_field(MR_mktag(0), mdb__declarative_analyser__V_54_54, 1) = ((MR_Box) (mdb__declarative_analyser__NewBottom_48));
                      }
                      {
                        MR_Word base;
                        ...
                        *mdb__declarative_analyser__NewMode_14 = base;
                        ...
                        MR_hl_field(MR_mktag(2), base, 1) = ((MR_Box) (mdb__declarative_analyser__V_54_54));
                        MR_hl_field(MR_mktag(2), base, 2) = ((MR_Box) (mdb__declarative_analyser__UnknownClosestToMiddle_49));
                      }
                      {
                        mdb__declarative_analyser__conv1_V_55_55 = mercury__array__elem_2_f_0(mdb__declarative_analyser__TypeCtorInfo_38_59, mdb__declarative_analyser__UnknownClosestToMiddle_49, (MR_ArrayPtr) mdb__declarative_analyser__PathArray_21);
                      }
                      mdb__declarative_analyser__V_55_55 = ((MR_Integer) mdb__declarative_analyser__conv1_V_55_55);
                      {
                        mdb__declarative_analyser__V_56_56 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), mdb__declarative_analyser__V_56_56, 0) = ((MR_Box) (mdb__declarative_analyser__NewBottom_48));
                        MR_hl_field(MR_mktag(2), mdb__declarative_analyser__V_56_56, 1) = ((MR_Box) (mdb__declarative_analyser__NewTop_47));
                        MR_hl_field(MR_mktag(2), mdb__declarative_analyser__V_56_56, 2) = ((MR_Box) (mdb__declarative_analyser__UnknownClosestToMiddle_49));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        *mdb__declarative_analyser__Response_15 = base;
                        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdb__declarative_analyser__V_55_55));
                        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (mdb__declarative_analyser__V_56_56));
                      }
