...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[5]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[6]), &SubResult5_18, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_20_20 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[5]);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_21_21 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[6]);
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[3]), &SubResult4_29, ((MR_Box) (Var_98)), ((MR_Box) (ArgY4_28)));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[1]), &SubResult1_59, ((MR_Box) (Var_95)), ((MR_Box) (ArgY1_58)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_30_30 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[3]);
              ...
              case (MR_Integer) 3:
                {
                  ...
                  else
                  {
                    ...
                    mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[0]), &SubResult2_64, ((MR_Box) (Var_76)), ((MR_Box) (ArgY2_63)));
                    succeeded = (SubResult2_64 != (MR_Integer) 0);
                    if (succeeded)
                      *HeadVar__1_1 = SubResult2_64;
                    else
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (Var_75)), ((MR_Box) (ArgY3_66)));
                    }
                  }
                }
                break;
        ...
        case (MR_Integer) 3:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_22_22 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[0]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_22_22, ((MR_Box) (ArgX2_15)), ((MR_Box) (ArgY2_16)));
                if (succeeded)
                {
                  TypeInfo_23_23 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[0]);
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_analyser_scalar_common_1[4]), &SubResult5_54, ((MR_Box) (Var_247)), ((MR_Box) (ArgY5_53)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_41_41 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[4]);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_61_61 = (MR_Word) (&mdb__declarative_analyser_scalar_common_1[0]);
...
{
  {
    ...
    else
    {
      ...
      Bug_17 = (MR_Word) ((MR_Word) (IBug_16));
    }
