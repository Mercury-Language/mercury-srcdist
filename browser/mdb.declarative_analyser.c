...
MR_decl_label8(mdb__declarative_analyser__change_search_mode_6_0, 3,5,7,8,9,12,15,13)
MR_decl_label8(mdb__declarative_analyser__change_search_mode_6_0, 17,21,23,24,20,26,11,2)
...
MR_decl_label8(mdb__declarative_analyser__search_for_question_8_0, 40,5,6,8,41,12,13,17)
MR_decl_label3(mdb__declarative_analyser__search_for_question_8_0, 15,11,21)
MR_decl_label2(mdb__declarative_analyser__set_fallback_search_mode_4_0, 17,8)
MR_decl_label8(mdb__declarative_analyser__show_info_5_0, 5,6,7,11,12,10,14,15)
MR_decl_label8(mdb__declarative_analyser__show_info_5_0, 16,17,18,19,20,21,22,23)
MR_decl_label8(mdb__declarative_analyser__show_info_5_0, 24,4,3,2,27,28,29,30)
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module7)
	...
	MR_init_label2(mdb__declarative_analyser__set_fallback_search_mode_4_0,17,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__declarative_analyser__set_fallback_search_mode_4_0);
	...
	if (MR_INT_EQ(MR_tag(MR_tempr3),3)) {
		MR_GOTO_LAB(mdb__declarative_analyser__set_fallback_search_mode_4_0_i17);
	}
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
MR_def_label(mdb__declarative_analyser__set_fallback_search_mode_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(mdb__declarative_edt__update_weighting_heuristic_4_0,
		mdb__declarative_analyser__set_fallback_search_mode_4_0_i8);
MR_def_label(mdb__declarative_analyser__set_fallback_search_mode_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_def_label(mdb__declarative_analyser__handle_search_response_5_0,12)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_2),
		mercury__mdb__declarative_analyser__handle_search_response_5_0_i13);
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module15)
	...
	MR_init_label8(mdb__declarative_analyser__search_for_question_8_0,40,5,6,8,41,12,13,17)
	MR_init_label3(mdb__declarative_analyser__search_for_question_8_0,15,11,21)
MR_BEGIN_CODE
...
MR_def_static(mdb__declarative_analyser__search_for_question_8_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r5),
		MR_LABEL_AP(mdb__declarative_analyser__search_for_question_8_0_i40) MR_AND
		MR_LABEL_AP(mdb__declarative_analyser__search_for_question_8_0_i6) MR_AND
		MR_LABEL_AP(mdb__declarative_analyser__search_for_question_8_0_i8) MR_AND
		MR_LABEL_AP(mdb__declarative_analyser__search_for_question_8_0_i41));
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r6;
	MR_np_call_localret_ent(mdb__declarative_analyser__top_down_search_5_0,
		mdb__declarative_analyser__search_for_question_8_0_i5);
...
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,12)
	...
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(mdb__declarative_edt__root_2_0,
		mdb__declarative_analyser__search_for_question_8_0_i13);
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_analyser__search_for_question_8_0_i11);
	}
	MR_sv(7) = MR_r2;
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
...
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_analyser__search_for_question_8_0_i15);
	}
	MR_r1 = MR_sv(6);
	MR_r8 = MR_r2;
	MR_r2 = MR_sv(1);
	...
	MR_np_call_localret_ent(mdb__declarative_analyser__find_middle_weight_9_0,
		mdb__declarative_analyser__search_for_question_8_0_i21);
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
	...
	MR_r1 = MR_sv(5);
	MR_decr_sp_and_return(8);
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_np_call_localret_ent(mdb__declarative_analyser__top_down_search_5_0,
		mdb__declarative_analyser__search_for_question_8_0_i21);
MR_def_label(mdb__declarative_analyser__search_for_question_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r2;
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(8);
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module23)
	...
	MR_init_label8(mdb__declarative_analyser__change_search_mode_6_0,3,5,7,8,9,12,15,13)
	MR_init_label8(mdb__declarative_analyser__change_search_mode_6_0,17,21,23,24,20,26,11,2)
...
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,9)
	...
	MR_np_call_localret_ent(private_builtin__type_info_from_typeclass_info_3_0,
		mdb__declarative_analyser__change_search_mode_6_0_i12);
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(mdb__declarative_edt__root_2_0,
...
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_analyser__change_search_mode_6_0_i13);
	}
	MR_r1 = MR_sv(6);
	MR_r4 = MR_r2;
	MR_r2 = MR_sv(7);
	...
	MR_np_call_localret_ent(mdb__declarative_edt__get_path_4_0,
		mdb__declarative_analyser__change_search_mode_6_0_i21);
...
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_analyser__change_search_mode_6_0_i20);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_edt, suspect_id);
...
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,24)
	...
	MR_r3 = MR_sv(2);
	MR_r1 = MR_sv(5);
	MR_GOTO_LAB(mdb__declarative_analyser__change_search_mode_6_0_i26);
	}
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_debugger, diagnoser_exception);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,8,3);
	MR_np_call_localret_ent(exception__throw_1_0,
		mdb__declarative_analyser__change_search_mode_6_0_i26);
MR_def_label(mdb__declarative_analyser__change_search_mode_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module25)
	...
	MR_init_label8(mdb__declarative_analyser__show_info_5_0,5,6,7,11,12,10,14,15)
	MR_init_label8(mdb__declarative_analyser__show_info_5_0,16,17,18,19,20,21,22,23)
	MR_init_label8(mdb__declarative_analyser__show_info_5_0,24,4,3,2,27,28,29,30)
...
MR_def_label(mdb__declarative_analyser__show_info_5_0,10)
	...
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
		mdb__declarative_analyser__show_info_5_0_i14);
MR_def_label(mdb__declarative_analyser__show_info_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(__Unify___mdb__declarative_analyser__reason_for_question_0_0,13)
	...
	MR_sv(1) = MR_ctfield(1, MR_tempr3, 4);
	MR_tempr1 = MR_tempr4;
