...
MR_def_label(mdb__declarative_analyser__follow_subterm_end_search_2_14_0,19)
	...
	MR_sv(11) = ((MR_Integer) MR_tfield(2, MR_tempr1, 3) & (MR_Integer) 3);
	MR_sv(12) = (((MR_Integer) MR_tfield(2, MR_tempr1, 3) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_sv(13) = MR_r1;
	MR_sv(14) = MR_r2;
	MR_r1 = MR_sv(15);
	MR_r2 = MR_sv(1);
...
MR_def_label(mdb__declarative_analyser__process_answer_5_0,6)
	...
	MR_sv(6) = ((MR_Integer) MR_tfield(1, MR_tempr1, 3) & (MR_Integer) 1);
	MR_sv(7) = (((MR_Integer) MR_tfield(1, MR_tempr1, 3) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(8) = MR_r5;
	MR_sv(9) = MR_r1;
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(4);
