        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__array__bounds_3_p_0((MR_Word) (&mdb__declarative_edt__mdb__declarative_edt__type_ctor_info_suspect_id_0), (MR_ArrayPtr) (PathArray_55), &Top_56, &Bottom_57);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (Top_56));
              MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (Bottom_57));
            }
            {
              SearchMode_28 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), SearchMode_28, 0) = ((MR_Box) (PathArray_55));
              MR_hl_field(MR_mktag(2), SearchMode_28, 1) = ((MR_Box) (Var_58));
              MR_hl_field(MR_mktag(2), SearchMode_28, 2) = ((MR_Box) (Bottom_57));
            }
          }
          else
            {
