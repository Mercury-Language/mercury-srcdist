...
mdb__declarative_analyser__find_middle_weight_if_children_9_p_0(
  MR_Word TypeClassInfo_for_mercury_edt_23,
  MR_Box Store_10,
  MR_Word Oracle_11,
  MR_Word Weighting_12,
  MR_Integer SuspectId_13,
  MR_Integer TopId_14,
  MR_Word MaybeLastUnknown_15,
  MR_Word STATE_VARIABLE_SearchSpace_0_19,
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mdb__declarative_analyser__find_middle_weight_if_children_9_p_0(TypeClassInfo_for_mercury_edt_57, Store_1, Oracle_2, Weighting_3, Heaviest_37, TopId_5, NewMaybeLastUnknown_38, STATE_VARIABLE_SearchSpace_0_7, STATE_VARIABLE_SearchSpace_8, Response_9);
      }
      else
      {
        MR_Word TypeInfo_76_76;
        ...
        else
        {
          ...
          {
            mdb__declarative_analyser__find_middle_weight_if_children_9_p_0(TypeClassInfo_for_mercury_edt_57, Store_1, Oracle_2, Weighting_3, Heaviest_37, TopId_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_SearchSpace_0_7, STATE_VARIABLE_SearchSpace_8, Response_9);
          }
        }
      }
    }
...
{
  {
    ...
    if (succeeded)
      mdb__declarative_analyser__find_middle_weight_9_p_0(TypeClassInfo_for_mercury_edt_23, Store_10, Oracle_11, Weighting_12, Children_18, TopId_14, MaybeLastUnknown_15, STATE_VARIABLE_SearchSpace_21_21, STATE_VARIABLE_SearchSpace_20, Response_17);
    else
    {
      {
        MR_Word base;
