...
MR_decl_label10(mdb__declarative_analyser__process_answer_5_0, 17,15,14,10,29,30,28,33,32,36)
MR_decl_label1(mdb__declarative_analyser__process_answer_5_0, 37)
...
MR_decl_label10(mdb__declarative_analyser__start_or_resume_analysis_6_0, 6,4,3,12,13,15,39,16,14,19)
MR_decl_label7(mdb__declarative_analyser__start_or_resume_analysis_6_0, 21,22,26,11,29,31,32)
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module20)
	...
	MR_init_label10(mdb__declarative_analyser__start_or_resume_analysis_6_0,6,4,3,12,13,15,39,16,14,19)
	MR_init_label7(mdb__declarative_analyser__start_or_resume_analysis_6_0,21,22,26,11,29,31,32)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,13)
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(mdb__declarative_analyser__start_or_resume_analysis_6_0_i15);
	}
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(3);
...
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(3);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
...
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,3)) {
		MR_GOTO_LAB(mdb__declarative_analyser__start_or_resume_analysis_6_0_i39);
	}
...
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,22)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_2),
		mercury__mdb__declarative_analyser__start_or_resume_analysis_6_0_i26);
...
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,11)
	...
	if (MR_LTAGS_TESTR(MR_r7,0,0)) {
		MR_GOTO_LAB(mdb__declarative_analyser__start_or_resume_analysis_6_0_i29);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	{
	...
	MR_np_call_localret_ent(mdb__declarative_edt__incorporate_explicit_supertree_5_0,
		mdb__declarative_analyser__start_or_resume_analysis_6_0_i32);
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,29)
	...
	MR_np_call_localret_ent(private_builtin__type_info_from_typeclass_info_3_0,
		mdb__declarative_analyser__start_or_resume_analysis_6_0_i31);
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,31)
	...
	MR_np_call_localret_ent(mdb__declarative_edt__incorporate_explicit_subtree_4_0,
		mdb__declarative_analyser__start_or_resume_analysis_6_0_i32);
MR_def_label(mdb__declarative_analyser__start_or_resume_analysis_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_r1;
...
MR_BEGIN_MODULE(mdb__declarative_analyser_module21)
	...
	MR_init_label10(mdb__declarative_analyser__process_answer_5_0,17,15,14,10,29,30,28,33,32,36)
	MR_init_label1(mdb__declarative_analyser__process_answer_5_0,37)
MR_BEGIN_CODE
