...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &mdb__io_action_scalar_common_1[0], HeadVar__1_1, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
        }
      }
    }
  }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            Var_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_7, 0) = ((MR_Box) (ProcName_1));
            MR_hl_field(MR_mktag(0), Var_7, 1) = ((MR_Box) ((MR_Integer) 1));
...
{
  {
    ...
    MR_Word PredFunc_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), IoAction_3, (MR_Integer) 1)));
...
#undef MR_PROC_LABEL
    ...
    if ((MaybeIoAction_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *MaybeTabledIoAction_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
