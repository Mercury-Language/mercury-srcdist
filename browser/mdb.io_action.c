...
MR_decl_label5(__Compare___mdb__io_action__io_action_0_0, 3,2,5,9,38)
...
MR_BEGIN_MODULE(mdb__io_action_module6)
	...
	MR_init_label5(__Compare___mdb__io_action__io_action_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__io_action__io_action_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__io_action__io_action_0_0_i38);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
...
MR_def_label(__Compare___mdb__io_action__io_action_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__mdb__io_action__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__io_action);
