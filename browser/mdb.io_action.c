  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mdb__io_action____Compare____io_action_0_0(HeadVar__1_1, ArgX1_4, ArgY1_5);
  }
}
...
{
  MR_Word Term_4;
  MR_String ProcName_5 = ((MR_String) ((MR_hl_field(0, IoAction_3, 0))));
  MR_Word PredFunc_6 = ((MR_Unsigned) ((MR_hl_field(0, IoAction_3, 1))) & (MR_Integer) 1);
  MR_Word Args_7 = ((MR_Word) ((MR_hl_field(0, IoAction_3, 2))));
  MR_Word IsFunc_8;
...
#undef MR_PROC_LABEL
  ...
  {
    MR_Word IoAction_9 = ((MR_Word) ((MR_hl_field(1, MaybeIoAction_8, 0))));
