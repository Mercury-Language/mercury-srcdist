...
{
  {
    ...
    if ((((MR_Unsigned) (C_2 - (MR_Integer) 33)) <= ((MR_Unsigned) (MR_Integer) 93)))
      if ((((mdb__percent_encoding_scalar_common_5[0])[(((C_2 - (MR_Integer) 33)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((C_2 - (MR_Integer) 33)) & (MR_Integer) 31))))))
      {
        succeeded = MR_TRUE;
      }
      else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        if ((((MR_Unsigned) (Char_7 - (MR_Integer) 33)) <= ((MR_Unsigned) (MR_Integer) 93)))
          if ((((mdb__percent_encoding_scalar_common_5[0])[(((Char_7 - (MR_Integer) 33)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((Char_7 - (MR_Integer) 33)) & (MR_Integer) 31))))))
          {
            succeeded = MR_TRUE;
          }
          else
