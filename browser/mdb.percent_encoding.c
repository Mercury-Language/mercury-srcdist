...
static /* final */ const MR_Integer mdb__percent_encoding_scalar_common_5[1][3] = {
  /* row 0 */
  {
    (MR_Integer) 2550120425,
    (MR_Integer) 1140850687,
    (MR_Integer) 603979775
  },
};
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) C_2 - (MR_Unsigned) (MR_Integer) 33)) <= ((MR_Unsigned) (MR_Integer) 93)))
      if ((((mdb__percent_encoding_scalar_common_5[0])[(((MR_Integer) ((MR_Unsigned) C_2 - (MR_Unsigned) (MR_Integer) 33)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) C_2 - (MR_Unsigned) (MR_Integer) 33)) & (MR_Integer) 31))))))
      {
        succeeded = MR_TRUE;
      }
      else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) Char_7 - (MR_Unsigned) (MR_Integer) 33)) <= ((MR_Unsigned) (MR_Integer) 93)))
          if ((((mdb__percent_encoding_scalar_common_5[0])[(((MR_Integer) ((MR_Unsigned) Char_7 - (MR_Unsigned) (MR_Integer) 33)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) Char_7 - (MR_Unsigned) (MR_Integer) 33)) & (MR_Integer) 31))))))
          {
            succeeded = MR_TRUE;
          }
          else
    ...
    if (succeeded)
      {
        ...
        *Encoded_6 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Encoded0_5));
      }
    else
    {
      MR_Char Hi_8;
      ...
      MR_Word Var_12;
      MR_Word Var_13;
      MR_Integer Int_Hi_18;
      MR_Integer Int_Lo_19;
      MR_Integer Var_20 = (Octet_4 & (MR_Integer) 240);

      Int_Hi_18 = (Var_20 >> (MR_Integer) 4);
      Int_Lo_19 = (Octet_4 & (MR_Integer) 15);
      Hi_8 = mercury__char__det_int_to_hex_digit_1_f_0(Int_Hi_18);
      Lo_9 = mercury__char__det_int_to_hex_digit_1_f_0(Int_Lo_19);
      {
        Var_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_13, 0) = ((MR_Box) (MR_Word) (Lo_9));
        MR_hl_field(MR_mktag(1), Var_13, 1) = ((MR_Box) (Encoded0_5));
      }
      {
        Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (MR_Word) (Hi_8));
      ...
      }
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        *Encoded_6 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MR_Word) ((MR_Char) 37));
...
{
  {
    ...
    else
    {
      ...
      mercury__list__foldr_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdb__percent_encoding_scalar_common_1[0]), (MR_Word) (&mdb__percent_encoding_scalar_common_3[1]), Octets_5, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_Encoded_6);
