...
{
  {
    ...
    else
    {
      ...
      mercury__list__foldr_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdb__percent_encoding_scalar_common_1[0]), (MR_Word) (&mdb__percent_encoding_scalar_common_3[1]), Octets_5, ((MR_Box) ((MR_Integer) 0)), &conv1_Encoded_6);
