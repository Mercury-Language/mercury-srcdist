...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mdb__util__zip_with_4_p_0(TypeInfo_for_T1_17, TypeInfo_for_T2_18, TypeInfo_for_T3_19, Pred_5, Xs_10, Ys_12, &ZippedTail_14);
        {
          MR_Word base;
        ...
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdb.util.zip_with\'/4", (MR_String) "list arguments are of unequal length");
          return;
        }
    }
  }
