...
{
  {
    MR_bool succeeded = (XXs_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));

    if (succeeded)
      succeeded = (YYs_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    if (succeeded)
      *Zipped_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Box X_9;
      MR_Word Xs_10;
      ...
      succeeded = ((MR_tag((MR_Word) XXs_6)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        X_9 = (MR_hl_field(MR_mktag(1), XXs_6, (MR_Integer) 0));
        Xs_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), XXs_6, (MR_Integer) 1)));
        succeeded = ((MR_tag((MR_Word) YYs_7)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
