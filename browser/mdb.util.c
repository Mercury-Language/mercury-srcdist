...
#line 184 "util.m"
    if ((mdb__util__Result_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
#line 186 "util.m"
      *mdb__util__String_8 = (MR_String) "quit";
#line 184 "util.m"
    else
#line 184 "util.m"
      if (((MR_tag((MR_Word) mdb__util__Result_12)) == (MR_mktag((MR_Integer) 2))))
#line 188 "util.m"
        {
#line 188 "util.m"
...
#line 65 "util.m"
    if ((mdb__util__HeadVar__1_1 == (MR_Integer) 1))
#line 66 "util.m"
