  ...
  switch (MR_tag((MR_Word) Result_12)) {
    ...
    case (MR_Integer) 0:
      *String_10 = (MR_String) "quit";
      break;
    case (MR_Integer) 1:
      *String_10 = ((MR_String) ((MR_hl_field(1, Result_12, 0))));
      break;
    case (MR_Integer) 2:
      {
        MR_Word Error_13 = ((MR_Word) ((MR_hl_field(2, Result_12, 0))));
        MR_String Var_20;
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  {
    MR_Word Var_29 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
    MR_Box Var_30 = (MR_hl_field(1, HeadVar__2_2, 0));
    ...
    {
      MR_Box Y_21 = (MR_hl_field(1, HeadVar__3_3, 0));
      MR_Word Ys_22 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 1))));
      MR_Box HeadXY_24;
      MR_Word TailXYs_25;
      void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, HeadVar__1_1, 1))));
      ...
      mdb__util__zip_with_4_p_0(TypeInfo_for_T1_26, TypeInfo_for_T2_27, TypeInfo_for_T3_28, HeadVar__1_1, Var_29, Ys_22, &TailXYs_25);
      {
        ...
        *HeadVar__4_4 = base;
        MR_hl_field(1, base, 0) = HeadXY_24;
        MR_hl_field(1, base, 1) = ((MR_Box) (TailXYs_25));
      }
    }
  }
}
