  ...
  switch (MR_tag((MR_Word) Result_12)) {
    ...
    case (MR_Integer) 0:
      *String_10 = (MR_String) "quit";
      break;
    case (MR_Integer) 1:
      *String_10 = ((MR_String) ((MR_hl_field(1, Result_12, (MR_Integer) 0))));
      break;
    case (MR_Integer) 2:
      {
        MR_Word Error_13 = ((MR_Word) ((MR_hl_field(2, Result_12, (MR_Integer) 0))));
        MR_String Var_20;
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  {
    MR_Word Var_29 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
    ...
    {
      MR_Box Y_21 = (MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0));
      MR_Word Ys_22 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
      MR_Box HeadXY_24;
      MR_Word TailXYs_25;
