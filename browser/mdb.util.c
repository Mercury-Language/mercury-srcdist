...
{
  {
    MR_bool succeeded = (XXs_6 == (MR_Word) ((MR_Integer) 0));

    if (succeeded)
      succeeded = (YYs_7 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
      *Zipped_8 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Box X_9;
      MR_Word Xs_10;
