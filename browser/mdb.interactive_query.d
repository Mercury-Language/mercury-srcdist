...
ifeq ($(TARGET_ASM),yes)
mdb.interactive_query.mh mdb.interactive_query.mih : mdb.interactive_query.s
else
mdb.interactive_query.mh mdb.interactive_query.mih : mdb.interactive_query.c
endif

ifeq ($(TARGET_ASM),yes)
mdb.interactive_query.module_dep : mdb.interactive_query.s
else
 ifeq ($(findstring il,$(GRADE)),il)
mdb.interactive_query.module_dep : mdb.interactive_query.il
  ifeq ($(findstring java,$(GRADE)),java)
mdb.interactive_query.module_dep : mercury/mdb_/interactive_query.java
  else
...
ifeq ($(TARGET_ASM),yes)
mdb.interactive_query.s_date : interactive_query.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdb.interactive_query $(ERR_REDIRECT)
mdb.interactive_query.pic_s_date : interactive_query.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdb.interactive_query $(ERR_REDIRECT)
endif # TARGET_ASM
