...
MR_decl_label4(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0, 8,6,18,1)
...
MR_decl_label6(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0, 36,12,29,6,31,9)
...
#line 1268 "declarative_edt.m"
    ...
    #endif
;}
#line 8220 "mdb.declarative_edt.c"
...
#line 1268 "declarative_edt.m"
    ...
    #endif
;}
#line 8265 "mdb.declarative_edt.c"
...
MR_BEGIN_MODULE(mdb__declarative_edt_module87)
	...
	MR_init_label4(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0,8,6,18,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__declarative_edt__maybe_found_descendent_0_0);
	...
	MR_incr_sp(2);
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0_i18);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	if (MR_PTAG_TEST(MR_r1,1)) {
	...
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0_i8);
	}
	MR_r1 = (MR_sv(2) == MR_r1);
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
...
MR_def_label(__Unify___mdb__declarative_edt__maybe_found_descendent_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp(2);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__declarative_edt_module88)
	...
	MR_init_label6(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,36,12,29,6,31,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__declarative_edt__maybe_found_descendent_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i36);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i6);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i12);
	}
	MR_tempr2 = MR_sv(2);
	if (MR_PTAG_TEST(MR_tempr2,1)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i29);
	}
	if (MR_PTAG_TEST(MR_tempr2,2)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i31);
	}
	}
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i9);
	}
	}
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(2);
	if (MR_PTAG_TEST(MR_r4,1)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0_i9);
	}
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdb__declarative_edt__maybe_found_descendent_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
