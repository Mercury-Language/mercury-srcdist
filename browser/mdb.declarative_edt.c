          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_edt_scalar_common_1[3]), HeadVar__1_1, ((MR_Box) (ArgX7_22)), ((MR_Box) (ArgY7_23)));
                }
              }
            }
          }
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_31_31 = (MR_Word) (&mdb__declarative_edt_scalar_common_1[3]);
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_edt_scalar_common_1[2]), &SubResult5_18, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_19_19 = (MR_Word) (&mdb__declarative_edt_scalar_common_1[2]);
