...
MR_decl_label10(mdb__declarative_edt__assert_suspect_is_valid_4_0, 2,4,6,9,5,10,12,14,17,15)
MR_decl_label1(mdb__declarative_edt__assert_suspect_is_valid_4_0, 11)
...
MR_decl_label4(mdb__declarative_edt__force_propagate_status_downwards_5_0, 2,5,12,8)
...
MR_decl_label6(mdb__declarative_edt__propagate_status_downwards_7_0, 2,6,10,13,4,17)
...
MR_decl_label10(mdb__declarative_edt__revise_root_3_0, 4,5,7,9,10,11,13,14,12,19)
MR_decl_label4(mdb__declarative_edt__revise_root_3_0, 20,22,24,3)
...
MR_decl_label9(__Compare___mdb__declarative_edt__search_space_1_0, 3,2,5,9,13,17,22,26,83)
...
MR_decl_label8(__Compare___mdb__declarative_edt__suspect_1_0, 3,2,5,9,13,17,21,71)
...
MR_BEGIN_MODULE(mdb__declarative_edt_module33)
	...
	MR_init_label10(mdb__declarative_edt__assert_suspect_is_valid_4_0,2,4,6,9,5,10,12,14,17,15)
	MR_init_label1(mdb__declarative_edt__assert_suspect_is_valid_4_0,11)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_edt__assert_suspect_is_valid_4_0,6)
	...
	MR_tfield(0, MR_tempr1, 5) = (MR_Word) MR_TAG_COMMON(1,0,5);
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_CTOR1_ADDR(mdb__declarative_edt, search_space);
	MR_tfield(0, MR_r2, 1) = MR_tempr3;
...
MR_def_label(mdb__declarative_edt__assert_suspect_is_valid_4_0,14)
	...
	MR_np_call_localret_ent(mdb__declarative_edt__suspect_erroneous_2_0,
		mdb__declarative_edt__assert_suspect_is_valid_4_0_i17);
...
MR_BEGIN_MODULE(mdb__declarative_edt_module72)
	...
	MR_init_label10(mdb__declarative_edt__revise_root_3_0,4,5,7,9,10,11,13,14,12,19)
	MR_init_label4(mdb__declarative_edt__revise_root_3_0,20,22,24,3)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_edt__revise_root_3_0,5)
	...
	MR_tempr2 = MR_sv(6);
	MR_tfield(0, MR_tempr1, 3) = MR_tempr2;
	MR_tfield(0, MR_tempr1, 4) = (MR_Word) MR_tbmkword(0, 6);
	MR_tfield(0, MR_tempr1, 5) = (MR_Word) MR_TAG_COMMON(1,0,5);
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_r1 = MR_tempr2;
...
MR_def_label(mdb__declarative_edt__revise_root_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_edt__revise_root_3_0_i12);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	...
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(7);
	MR_GOTO_LAB(mdb__declarative_edt__revise_root_3_0_i19);
	}
...
MR_def_label(mdb__declarative_edt__revise_root_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(private_builtin__type_info_from_typeclass_info_3_0,
		mdb__declarative_edt__revise_root_3_0_i20);
MR_def_label(mdb__declarative_edt__revise_root_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_CTOR1_ADDR(mdb__declarative_edt, suspect);
	MR_tfield(0, MR_r2, 1) = MR_r1;
...
#line 1257 "declarative_edt.m"
    ...
    #endif
;}
#line 8884 "mdb.declarative_edt.c"
...
#line 1257 "declarative_edt.m"
    ...
    #endif
;}
#line 8932 "mdb.declarative_edt.c"
...
MR_BEGIN_MODULE(mdb__declarative_edt_module80)
	...
	MR_init_label6(mdb__declarative_edt__propagate_status_downwards_7_0,2,6,10,13,4,17)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_edt__propagate_status_downwards_7_0,4)
	...
	MR_np_call_localret_ent(list__cons_3_0,
		mdb__declarative_edt__propagate_status_downwards_7_0_i17);
MR_def_label(mdb__declarative_edt__propagate_status_downwards_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__declarative_edt_module82)
	...
	MR_init_label4(mdb__declarative_edt__force_propagate_status_downwards_5_0,2,5,12,8)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_edt__force_propagate_status_downwards_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(6);
MR_def_label(mdb__declarative_edt__force_propagate_status_downwards_5_0,8)
	...
	MR_np_call_localret_ent(list__foldl2_6_0,
		mdb__declarative_edt__force_propagate_status_downwards_5_0_i12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__declarative_edt_module92)
	...
	MR_init_label9(__Compare___mdb__declarative_edt__search_space_1_0,3,2,5,9,13,17,22,26,83)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_edt__search_space_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__search_space_1_0_i83);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(7);
...
MR_def_label(__Compare___mdb__declarative_edt__search_space_1_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(14);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__declarative_edt_module98)
	...
	MR_init_label8(__Compare___mdb__declarative_edt__suspect_1_0,3,2,5,9,13,17,21,71)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_edt__suspect_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_edt__suspect_1_0_i71);
	}
	MR_r1 = MR_sv(11);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
...
MR_def_label(__Compare___mdb__declarative_edt__suspect_1_0,21)
	...
	MR_decr_sp(12);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdb__declarative_edt__suspect_1_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__mdb__declarative_edt__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__declarative_edt);
