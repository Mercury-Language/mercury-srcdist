  ...
  MR_Word * Result_8)
{
  ...
  (env).mdb__dl__mercury_sym_5_p_0_env_0__TypeInfo_for_T_23 = TypeInfo_for_T_23;
  {
    ...
    MR_Word Result0_15;
    MR_Word IsPredOrFunc_24 = ((MR_Unsigned) ((MR_hl_field(0, MercuryProc0_7, 0))) & (MR_Integer) 1);
    MR_Integer ProcArity_27 = ((MR_Integer) ((MR_hl_field(0, MercuryProc0_7, 3))));
    ...
    MR_String _Name_26;
    MR_Integer _Mode_28;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, MercuryProc0_7, 0)));
    MR_Box Var_10;
...
(env).mdb__dl__mercury_sym_5_p_0_env_0__succeeded  = SUCCESS_INDICATOR;
    ...
    {
      MR_Word Address_17 = ((MR_Word) ((MR_hl_field(0, Result0_15, 0))));
      MR_Box Closure_18;
      MR_Word Var_22;
