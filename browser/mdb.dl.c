  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__ArgTypeCtor_78 = mercury__type_desc__type_ctor_1_f_0((env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__ArgType_77);
  {
    ...
    (env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded = (strcmp(Var_81, (MR_String) "float") == 0);
  }
  if (!((env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded))
  {
    ...
    (env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded = (strcmp(Var_82, (MR_String) "char") == 0);
  }
  if ((env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
  {
