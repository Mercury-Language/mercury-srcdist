  ...
  MR_Word * Result_8)
{
  ...
  (env).mdb__dl__mercury_sym_5_p_0_env_0__TypeInfo_for_T_23 = TypeInfo_for_T_23;
  {
    ...
    if ((env).mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
      TypeProcArity_37 = (MR_Integer) ((MR_Unsigned) TypeArity_36 - (MR_Unsigned) 1);
    else
    ...
    if ((env).mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
    {
      ...
      Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "\')", (MR_String) " is not a higher-order type");
    ...
    else
    {
      ...
      if ((env).mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
      {
        ...
        Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "predicate/function mismatch: ", (MR_String) "argument is a predicate, result type is a function");
        {
      ...
      else
      {
        ...
        if ((env).mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
        {
          ...
          Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "predicate/function mismatch: ", (MR_String) "argument is a function, result type is a predicate");
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdb.dl.check_proc_spec_matches_result_type\'/4", Var_56);
            return;
          }
        }
        else
