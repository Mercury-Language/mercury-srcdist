...
MR_decl_label10(mdb__dl__mercury_sym_5_0, 2,3,4,5,7,10,18,19,20,9)
MR_decl_label10(mdb__dl__mercury_sym_5_0, 26,22,32,28,35,36,44,34,49,56)
MR_decl_label10(mdb__dl__mercury_sym_5_0, 57,58,59,62,61,64,66,52,53,68)
MR_decl_label9(mdb__dl__mercury_sym_5_0, 51,74,75,76,71,79,80,81,82)
...
MR_BEGIN_MODULE(mdb__dl_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__is_null_1_0);
	MR_init_label1(mdb__dl__is_null_1_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'is_null'/1 mode 0 */
...
MR_BEGIN_MODULE(mdb__dl_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__dlopen_6_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'dlopen'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__dlerror_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'dlerror'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__open_6_0);
	MR_init_label1(mdb__dl__open_6_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'open'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__dlsym_5_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'dlsym'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__sym_5_0);
	MR_init_label1(mdb__dl__sym_5_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'sym'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__dl__make_closure_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_closure'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__high_level_code_0_0);
...
MR_BEGIN_MODULE(mdb__dl_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__mercury_sym_5_0);
	MR_init_label10(mdb__dl__mercury_sym_5_0,2,3,4,5,7,10,18,19,20,9)
	MR_init_label10(mdb__dl__mercury_sym_5_0,26,22,32,28,35,36,44,34,49,56)
	MR_init_label10(mdb__dl__mercury_sym_5_0,57,58,59,62,61,64,66,52,53,68)
	MR_init_label9(mdb__dl__mercury_sym_5_0,51,74,75,76,71,79,80,81,82)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_sym'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(mdb__dl__mercury_sym_5_0,7)
	...
	if ((strcmp((char *) (MR_Word *) MR_sv(5), MR_string_const("pred", 4)) == 0)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i9);
	}
	if ((strcmp((char *) (MR_Word *) MR_sv(5), MR_string_const("func", 4)) == 0)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i9);
	}
...
MR_def_label(mdb__dl__mercury_sym_5_0,9)
	...
	MR_r1 = (MR_Word) MR_string_const("mercury_sym: predicate/function mismatch: ", 42);
	MR_r2 = (MR_Word) MR_string_const("argument is a predicate, result type is a function", 50);
	MR_np_call_localret_ent(string__append_3_2,
		mdb__dl__mercury_sym_5_0_i26);
MR_def_label(mdb__dl__mercury_sym_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(require__error_1_0,
		mdb__dl__mercury_sym_5_0_i49);
MR_def_label(mdb__dl__mercury_sym_5_0,22)
	...
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i28);
	}
	if ((strcmp((char *) (MR_Word *) MR_sv(5), MR_string_const("func", 4)) == 0)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i28);
	}
	MR_r1 = (MR_Word) MR_string_const("mercury_sym: predicate/function mismatch: ", 42);
	MR_r2 = (MR_Word) MR_string_const("argument is a function, result type is a predicate", 50);
	MR_np_call_localret_ent(string__append_3_2,
		mdb__dl__mercury_sym_5_0_i32);
MR_def_label(mdb__dl__mercury_sym_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(require__error_1_0,
		mdb__dl__mercury_sym_5_0_i49);
MR_def_label(mdb__dl__mercury_sym_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(4) == MR_sv(6))) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i34);
	}
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(string__int_to_string_2_0,
		mdb__dl__mercury_sym_5_0_i35);
MR_def_label(mdb__dl__mercury_sym_5_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(string__int_to_string_2_0,
		mdb__dl__mercury_sym_5_0_i36);
MR_def_label(mdb__dl__mercury_sym_5_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("result type has ", 16);
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_string_const(" argument(s), ", 14);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_sv(7);
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_string_const("argument has ", 13);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("mercury_sym: arity mismatch: ", 29);
	MR_tfield(1, MR_r1, 1) = MR_r2;
	}
	MR_np_call_localret_ent(string__append_list_2_0,
		mdb__dl__mercury_sym_5_0_i44);
MR_def_label(mdb__dl__mercury_sym_5_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(require__error_1_0,
		mdb__dl__mercury_sym_5_0_i49);
...
MR_def_label(mdb__dl__mercury_sym_5_0,49)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(mdb__dl__mercury_sym_5_0_i52);
	{
...
;}
#line 1108 "mdb.dl.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i53);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
...
MR_def_label(mdb__dl__mercury_sym_5_0,57)
	...
	MR_np_call_localret_ent(list__member_2_1,
		mdb__dl__mercury_sym_5_0_i58);
MR_def_label(mdb__dl__mercury_sym_5_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__type_desc__type_ctor_1_0,
		mdb__dl__mercury_sym_5_0_i59);
...
MR_def_label(mdb__dl__mercury_sym_5_0,62)
	...
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("float", 5)) != 0)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i61);
	}
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__type_desc__type_ctor_module_name_1_0,
		mdb__dl__mercury_sym_5_0_i66);
MR_def_label(mdb__dl__mercury_sym_5_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__type_desc__type_ctor_name_1_0,
...
MR_def_label(mdb__dl__mercury_sym_5_0,66)
	...
	MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i68);
MR_def_label(mdb__dl__mercury_sym_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
MR_def_label(mdb__dl__mercury_sym_5_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(8);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(9);
	MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i51);
MR_def_label(mdb__dl__mercury_sym_5_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
;}
#line 1200 "mdb.dl.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i71);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
...
MR_def_label(mdb__dl__mercury_sym_5_0,80)
	...
	MR_np_call_localret_ent(mdb__dl__sym_5_0,
		mdb__dl__mercury_sym_5_0_i81);
MR_def_label(mdb__dl__mercury_sym_5_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(mdb__dl__mercury_sym_5_0_i82);
	}
...
#undef	MR_PROC_LABEL
	...
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_r3;
MR_def_label(mdb__dl__mercury_sym_5_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__dl_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__dlclose_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'dlclose'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__dl_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__dl__close_4_0);
...
MR_BEGIN_MODULE(mdb__dl_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__dl__dl_result_0_0);
...
MR_BEGIN_MODULE(mdb__dl_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__dl__dl_result_0_0);
...
MR_BEGIN_MODULE(mdb__dl_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__dl__dl_result_1_0);
...
MR_BEGIN_MODULE(mdb__dl_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__dl__dl_result_1_0);
...
MR_BEGIN_MODULE(mdb__dl_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__dl__handle_0_0);
...
MR_BEGIN_MODULE(mdb__dl_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__dl__handle_0_0);
...
MR_BEGIN_MODULE(mdb__dl_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__dl__link_mode_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__dl_module18)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__dl__link_mode_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__dl_module19)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__dl__scope_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__dl_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__dl__scope_0_0);
MR_BEGIN_CODE
...
void mercury__mdb__dl__init_threadscope_string_table(void);
#endif
...
void mercury__mdb__dl__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__dl);
