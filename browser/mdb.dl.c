...
(env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded  = SUCCESS_INDICATOR;
        ...
        if ((env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__succeeded)
        {
          ...
          TypeCtorInfo__25_84 = (MR_Word) (&mercury__type_desc__type_desc__type_ctor_info_type_desc_0);
          mercury__list__member_2_p_1(TypeCtorInfo__25_84, &(env_ptr)->mdb__dl__mercury_sym_5_p_0_env_0__conv0_ArgType_69, Var_71, mdb__dl__mercury_sym_5_p_0_3, env_ptr);
        }
      }
