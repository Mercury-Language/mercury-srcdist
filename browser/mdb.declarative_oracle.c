      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_42, 0) = ((MR_Box) (Module_21));
            MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (Name_24));
            MR_hl_field(MR_mktag(3), Var_42, 2) = ((MR_Box) (Arity_25));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_42)), &conv0_Var_32);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_41, 0) = ((MR_Box) (Module_21));
            MR_hl_field(MR_mktag(2), Var_41, 1) = ((MR_Box) (Name_24));
            MR_hl_field(MR_mktag(2), Var_41, 2) = ((MR_Box) (Arity_25));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_41)), &conv1_Var_31);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
    ...
    {
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (Module_21));
        }
        succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_40)), &conv2_Var_30);
        if (succeeded)
          succeeded = MR_TRUE;
      }
      if (!(succeeded))
