...
MR_def_label(mdb__declarative_oracle__answer_known_3_0,4)
	...
	MR_tfield(3, MR_tempr2, 1) = MR_tfield(0, MR_tempr3, 3);
	MR_tfield(3, MR_tempr2, 2) = MR_tfield(0, MR_tempr3, 4);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_oracle, trusted_object);
	MR_r2 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r3 = MR_sv(4);
	}
...
MR_def_label(mdb__declarative_oracle__answer_known_3_0,11)
	...
	MR_tempr2 = MR_r1;
	MR_tfield(2, MR_tempr1, 1) = MR_tfield(0, MR_tempr2, 3);
	MR_tfield(2, MR_tempr1, 2) = MR_tfield(0, MR_tempr2, 4);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_oracle, trusted_object);
	MR_r2 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r3 = MR_sv(4);
	}
...
MR_def_static(mdb__declarative_oracle__add_atom_to_ground_map_5_0)
	...
	MR_tempr4 = MR_r2;
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(0, MR_tfield(0, MR_tempr4, 0), 1);
...
MR_def_label(mdb__declarative_oracle__query_oracle_user_6_0,5)
	...
	MR_sv(1) = MR_tempr1;
	MR_tempr2 = MR_r1;
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(1, MR_tempr2, 1);
	MR_sv(2) = MR_r2;
...
MR_def_label(mdb__declarative_oracle__query_oracle_user_6_0,35)
	...
	MR_tfield(3, MR_tempr2, 1) = MR_tfield(3, MR_tempr3, 1);
	MR_r1 = MR_tempr2;
	MR_sv(2) = MR_r2;
	MR_sv(1) = MR_sv(6);
	MR_GOTO_LAB(mdb__declarative_oracle__query_oracle_user_6_0_i3);
...
MR_def_static(mdb__declarative_oracle__remove_atom_from_ground_map_4_0)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_r2;
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(0, MR_tfield(0, MR_tempr3, 0), 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
