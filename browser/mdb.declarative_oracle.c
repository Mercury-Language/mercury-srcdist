          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Map_22;
              MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Atom_19, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_37, 0) = ((MR_Box) (Module_19));
            MR_hl_field(MR_mktag(3), Var_37, 1) = ((MR_Box) (Name_22));
            MR_hl_field(MR_mktag(3), Var_37, 2) = ((MR_Box) (Arity_23));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_37)), &conv0_Var_30);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          {
            Var_38 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_38, 0) = ((MR_Box) (Module_19));
            MR_hl_field(MR_mktag(2), Var_38, 1) = ((MR_Box) (Name_22));
            MR_hl_field(MR_mktag(2), Var_38, 2) = ((MR_Box) (Arity_23));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_38)), &conv1_Var_29);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
    ...
    {
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (Module_19));
        }
        succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_39)), &conv2_Var_28);
        if (succeeded)
          succeeded = MR_TRUE;
      }
      if (!(succeeded))
