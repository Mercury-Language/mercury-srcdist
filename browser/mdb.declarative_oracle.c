  ...
  MR_Word * STATE_VARIABLE_Oracle_12)
{
  ...
  switch (MR_tag((MR_Word) Question_4)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Box Node_36 = (MR_hl_field(MR_mktag(0), Question_4, (MR_Integer) 0));
        MR_Word Atom_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_4, (MR_Integer) 2))));
        MR_Word Map_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 0))));
        MR_Word Truth_40;
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_36;
            MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Truth_40));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 1:
      {
        MR_Word Call_41 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Question_4, (MR_Integer) 1))));
        MR_Word CMap_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 1))));
        MR_Box Node_53 = (MR_hl_field(MR_mktag(1), Question_4, (MR_Integer) 0));
        MR_Word Truth_54;
        ...
        if (succeeded)
        {
          {
            Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_53;
            MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Truth_54));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word Exception_44 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 2))));
        MR_Word XMap_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 2))));
        MR_Word X_46;
        MR_Word Possible_47;
        MR_Word Impossible_48;
        MR_Word Inadmissible_49;
        MR_Box Node_55 = (MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 0));
        MR_Word Call_56 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 1))));
        MR_Box conv1_X_46;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            {
              Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_55;
            ...
            else
            {
              ...
              if (succeeded)
              {
                Var_52 = (MR_Integer) 2;
                {
                  Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_55;
                  MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Var_52));
                }
                succeeded = MR_TRUE;
              }
            }
  ...
  MR_Word * STATE_VARIABLE_Oracle_16)
{
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Question_8)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Box Node_34 = (MR_hl_field(MR_mktag(0), Question_8, (MR_Integer) 0));
          MR_Word Atom_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_8, (MR_Integer) 2))));
          MR_Word Map_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 0))));
          MR_Word Truth_38;
          MR_Box conv2_Truth_38;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_final_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), Map_37, ((MR_Box) (Atom_36)), &conv2_Truth_38);
          if (succeeded)
          {
            Truth_38 = ((MR_Word) (conv2_Truth_38));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              Answer_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_28, 0) = Node_34;
              MR_hl_field(MR_mktag(0), Answer_28, 1) = (MR_Box) ((MR_Unsigned) (Truth_38));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 1:
        {
          MR_Word Call_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Question_8, (MR_Integer) 1))));
          MR_Word CMap_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 1))));
          MR_Box Node_51 = (MR_hl_field(MR_mktag(1), Question_8, (MR_Integer) 0));
          MR_Word Truth_52;
          MR_Box conv0_Truth_52;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), CMap_41, ((MR_Box) (Call_39)), &conv0_Truth_52);
          if (succeeded)
          {
            Truth_52 = ((MR_Word) (conv0_Truth_52));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              Answer_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_28, 0) = Node_51;
              MR_hl_field(MR_mktag(0), Answer_28, 1) = (MR_Box) ((MR_Unsigned) (Truth_52));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 2:
        {
          MR_Word Exception_42 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 2))));
          MR_Word XMap_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 2))));
          MR_Word X_44;
          MR_Word Possible_45;
          MR_Word Impossible_46;
          MR_Word Inadmissible_47;
          MR_Box Node_53 = (MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 0));
          MR_Word Call_54 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 1))));
          MR_Box conv1_X_44;
          MR_Word TypeCtorInfo_35_61;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), XMap_43, ((MR_Box) (Call_54)), &conv1_X_44);
          if (succeeded)
          {
            X_44 = ((MR_Word) (conv1_X_44));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            Possible_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_44, (MR_Integer) 0))));
            Impossible_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_44, (MR_Integer) 1))));
            Inadmissible_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_44, (MR_Integer) 2))));
            TypeCtorInfo_35_61 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
            succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_61, ((MR_Box) (Exception_42)), Possible_45);
            if (succeeded)
            {
              {
                Answer_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Answer_28, 0) = Node_53;
                MR_hl_field(MR_mktag(0), Answer_28, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              }
              succeeded = MR_TRUE;
            }
            else
            {
              succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_42)), Impossible_46);
              if (succeeded)
              {
                {
                  Answer_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Answer_28, 0) = Node_53;
                  MR_hl_field(MR_mktag(0), Answer_28, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_42)), Inadmissible_47);
                if (succeeded)
                {
                  Var_50 = (MR_Integer) 2;
                  {
                    Answer_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Answer_28, 0) = Node_53;
                    MR_hl_field(MR_mktag(0), Answer_28, 1) = (MR_Box) ((MR_Unsigned) (Var_50));
                  }
                  succeeded = MR_TRUE;
                }
              }
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Answer_28)) == (MR_Integer) 0);
      if (succeeded)
        DeclTruth_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Answer_28, (MR_Integer) 1))) & (MR_Integer) 3);
    }
    if (succeeded)
      {
        ...
        MR_hl_field(MR_mktag(1), UserQuestion_14, 1) = (MR_Box) ((MR_Unsigned) (DeclTruth_30));
      }
    else
      {
  ...
  MR_Word * Answer_6)
{
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_55, 0) = ((MR_Box) (Module_21));
            MR_hl_field(MR_mktag(3), Var_55, 1) = ((MR_Box) (Name_24));
            MR_hl_field(MR_mktag(3), Var_55, 2) = ((MR_Box) (Arity_25));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_55)), &conv0_Var_38);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_54, 0) = ((MR_Box) (Module_21));
            MR_hl_field(MR_mktag(2), Var_54, 1) = ((MR_Box) (Name_24));
            MR_hl_field(MR_mktag(2), Var_54, 2) = ((MR_Box) (Arity_25));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_54)), &conv1_Var_37);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
    ...
    {
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (Module_21));
        }
        succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_19, ((MR_Box) (Var_53)), &conv2_Var_36);
        if (succeeded)
          succeeded = MR_TRUE;
      }
      if (!(succeeded))
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word ParentModule_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Module_21, (MR_Integer) 0))));
            MR_String SubModuleNameStr_30 = ((MR_String) ((MR_hl_field(MR_mktag(1), Module_21, (MR_Integer) 1))));

            if (((MR_tag((MR_Word) ParentModule_29)) == (MR_Integer) 1))
            {
              MR_Word GrandParentModule_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ParentModule_29, (MR_Integer) 0))));
              MR_String GrandParentModuleNameStr_33;
              MR_String Var_48;
              MR_String Var_49;
              MR_String Var_50;
              MR_String Var_51;
              MR_String Var_52;
              MR_String ParentModuleNameStr_56 = ((MR_String) ((MR_hl_field(MR_mktag(1), ParentModule_29, (MR_Integer) 1))));

              succeeded = ((MR_tag((MR_Word) GrandParentModule_32)) == (MR_Integer) 0);
              if (succeeded)
              {
                GrandParentModuleNameStr_33 = ((MR_String) ((MR_hl_field(MR_mktag(0), GrandParentModule_32, (MR_Integer) 0))));
                Var_49 = (MR_String) ".";
                Var_52 = (MR_String) ".";
                Var_51 = mercury__string__f_43_43_2_f_0(Var_52, SubModuleNameStr_30);
                Var_50 = mercury__string__f_43_43_2_f_0(ParentModuleNameStr_56, Var_51);
                Var_48 = mercury__string__f_43_43_2_f_0(Var_49, Var_50);
                ModuleNameStr_28 = mercury__string__f_43_43_2_f_0(GrandParentModuleNameStr_33, Var_48);
                succeeded = MR_TRUE;
              }
            }
            else
            {
              MR_String ParentModuleNameStr_31 = ((MR_String) ((MR_hl_field(MR_mktag(0), ParentModule_29, (MR_Integer) 0))));
              MR_String Var_46;

              Var_46 = mercury__string__f_43_43_2_f_0((MR_String) ".", SubModuleNameStr_30);
              ModuleNameStr_28 = mercury__string__f_43_43_2_f_0(ParentModuleNameStr_31, Var_46);
              succeeded = MR_TRUE;
            }
          }
          else
          {
            ModuleNameStr_28 = ((MR_String) ((MR_hl_field(MR_mktag(0), Module_21, (MR_Integer) 0))));
            succeeded = MR_TRUE;
          }
          if (succeeded)
            succeeded = mercury__library__mercury_std_library_module_1_p_0(ModuleNameStr_28);
        }
      }
    }
  }
  ...
  else
  {
    ...
    succeeded = mdb__declarative_oracle__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_113_117_101_114_121_95_111_114_97_99_108_101_95_107_98_95_95_91_49_93_95_48_3_p_0(Var_10, Question_5, Answer_6);
  }
  return succeeded;
}
  ...
  MR_Word * Answer_6)
{
  ...
  switch (MR_tag((MR_Word) Question_5)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Box Node_7 = (MR_hl_field(MR_mktag(0), Question_5, (MR_Integer) 0));
        MR_Word Atom_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_5, (MR_Integer) 2))));
        MR_Word Map_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), KB_4, (MR_Integer) 0))));
        MR_Word Truth_11;
        MR_Box conv2_Truth_11;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_final_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), Map_10, ((MR_Box) (Atom_9)), &conv2_Truth_11);
        if (succeeded)
        {
          Truth_11 = ((MR_Word) (conv2_Truth_11));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          {
            ...
            *Answer_6 = base;
            MR_hl_field(MR_mktag(0), base, 0) = Node_7;
            MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) ((MR_Unsigned) (Truth_11));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word CMap_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), KB_4, (MR_Integer) 1))));
        MR_Box Node_24 = (MR_hl_field(MR_mktag(1), Question_5, (MR_Integer) 0));
        MR_Word Truth_25;
        MR_Box conv0_Truth_25;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), CMap_14, ((MR_Box) (Call_12)), &conv0_Truth_25);
        if (succeeded)
        {
          Truth_25 = ((MR_Word) (conv0_Truth_25));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          {
            ...
            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            *Answer_6 = base;
            MR_hl_field(MR_mktag(0), base, 0) = Node_24;
            MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) ((MR_Unsigned) (Truth_25));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word Exception_15 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 2))));
        MR_Word XMap_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), KB_4, (MR_Integer) 2))));
        MR_Word X_17;
        MR_Word Possible_18;
        MR_Word Impossible_19;
        MR_Word Inadmissible_20;
        MR_Box Node_26 = (MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 0));
        MR_Word Call_27 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 1))));
        MR_Box conv1_X_17;
        MR_Word TypeCtorInfo_35_35;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), XMap_16, ((MR_Box) (Call_27)), &conv1_X_17);
        if (succeeded)
        {
          X_17 = ((MR_Word) (conv1_X_17));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          Possible_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_17, (MR_Integer) 0))));
          Impossible_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_17, (MR_Integer) 1))));
          Inadmissible_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_17, (MR_Integer) 2))));
          TypeCtorInfo_35_35 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
          succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_35, ((MR_Box) (Exception_15)), Possible_18);
          if (succeeded)
          {
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              *Answer_6 = base;
              MR_hl_field(MR_mktag(0), base, 0) = Node_26;
          ...
          {
            succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_15)), Impossible_19);
            if (succeeded)
            {
              {
                MR_Word base;
            ...
            else
            {
              ...
              succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_15)), Inadmissible_20);
              if (succeeded)
              {
                Var_23 = (MR_Integer) 2;
                {
                  ...
                  *Answer_6 = base;
                  MR_hl_field(MR_mktag(0), base, 0) = Node_26;
                  MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) ((MR_Unsigned) (Var_23));
                }
                succeeded = MR_TRUE;
              }
            }
