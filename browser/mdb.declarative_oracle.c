...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Answer_30, (MR_Integer) 1)));
      }
      if (succeeded)
        {
          ...
          MR_hl_field(MR_mktag(1), UserQuestion_14, 1) = (MR_Box) (packed_args_0);
        }
      else
        {
    ...
    switch (MR_tag((MR_Word) UserResponse_12)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), UserResponse_12, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), UserResponse_12, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Answer_6, (MR_Integer) 1)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_20)) == (MR_Integer) 0))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_20, (MR_Integer) 1)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_9)) == (MR_Integer) 0))
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_9, (MR_Integer) 1)));
    ...
    else
    {
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ProcLabel_9, (MR_Integer) 1)));
