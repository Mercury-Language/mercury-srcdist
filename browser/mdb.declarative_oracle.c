    ...
    case (MR_Integer) 2:
      {
        ...
        Var_13 = mercury__string__f_43_43_2_f_0(ModuleNameStr_36, Var_14);
        CmdDisplay_8 = mercury__string__f_43_43_2_f_0((MR_String) "predicate ", Var_13);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        Var_28 = (MR_Integer) ((MR_Unsigned) Arity_40 - (MR_Unsigned) 1);
        Var_27 = mercury__string__int_to_string_1_f_0(Var_28);
        Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_27);
        Var_24 = mercury__string__f_43_43_2_f_0(Name_39, Var_25);
        Var_22 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_24);
        Var_21 = mercury__string__f_43_43_2_f_0(ModuleNameStr_38, Var_22);
        CmdDisplay_8 = mercury__string__f_43_43_2_f_0((MR_String) "function ", Var_21);
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_10 = mercury__string__f_43_43_2_f_0(ModuleNameStr_6, (MR_String) "\n");
        CmdStr_4 = mercury__string__f_43_43_2_f_0((MR_String) "trust ", Var_10);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_19);
        Var_16 = mercury__string__f_43_43_2_f_0(Name_7, Var_17);
        Var_14 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_16);
        Var_13 = mercury__string__f_43_43_2_f_0(ModuleNameStr_35, Var_14);
        CmdStr_4 = mercury__string__f_43_43_2_f_0((MR_String) "trust pred*", Var_13);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        Var_31 = (MR_Integer) ((MR_Unsigned) Arity_39 - (MR_Unsigned) 1);
        Var_30 = mercury__string__int_to_string_1_f_0(Var_31);
        Var_29 = mercury__string__f_43_43_2_f_0(Var_30, (MR_String) "\n");
        Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_29);
        Var_26 = mercury__string__f_43_43_2_f_0(Name_38, Var_27);
        Var_24 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_26);
        Var_23 = mercury__string__f_43_43_2_f_0(ModuleNameStr_37, Var_24);
        CmdStr_4 = mercury__string__f_43_43_2_f_0((MR_String) "trust func*", Var_23);
      }
      break;
  }
  return CmdStr_4;
  ...
  MR_Word * STATE_VARIABLE_Oracle_6)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), &X_25);
  {
    ...
    MR_hl_field(MR_mktag(0), EmptyKB_4, 0) = ((MR_Box) (G_23));
    MR_hl_field(MR_mktag(0), EmptyKB_4, 1) = ((MR_Box) (C_24));
    MR_hl_field(MR_mktag(0), EmptyKB_4, 2) = ((MR_Box) (X_25));
  }
  ...
  MR_Word * STATE_VARIABLE_Oracle_9)
{
  ...
  Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_8, (MR_Integer) 0))));
  Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_8, (MR_Integer) 1))));
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_8, (MR_Integer) 3))));
  Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_8, (MR_Integer) 4))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Oracle_8)
{
  ...
  Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_7, (MR_Integer) 0))));
  Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_7, (MR_Integer) 1))));
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_7, (MR_Integer) 3))));
  Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_7, (MR_Integer) 4))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Oracle_12)
{
  ...
  switch (MR_tag((MR_Word) Question_4)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Box Node_33 = (MR_hl_field(MR_mktag(0), Question_4, (MR_Integer) 0));
        MR_Word Atom_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_4, (MR_Integer) 2))));
        MR_Word Map_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 0))));
        MR_Word Truth_37;
        MR_Box conv2_Truth_37;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_final_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), Map_36, ((MR_Box) (Atom_35)), &conv2_Truth_37);
        if (succeeded)
        {
          Truth_37 = ((MR_Word) (conv2_Truth_37));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          {
            ...
            MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_33;
            MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Truth_37));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 1:
      {
        MR_Word Call_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Question_4, (MR_Integer) 1))));
        MR_Word CMap_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 1))));
        MR_Box Node_50 = (MR_hl_field(MR_mktag(1), Question_4, (MR_Integer) 0));
        MR_Word Truth_51;
        MR_Box conv0_Truth_51;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), CMap_40, ((MR_Box) (Call_38)), &conv0_Truth_51);
        if (succeeded)
        {
          Truth_51 = ((MR_Word) (conv0_Truth_51));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          {
            Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_50;
            MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Truth_51));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word Exception_41 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 2))));
        MR_Word XMap_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Current0_6, (MR_Integer) 2))));
        MR_Word X_43;
        MR_Word Possible_44;
        MR_Word Impossible_45;
        MR_Word Inadmissible_46;
        MR_Box Node_52 = (MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 0));
        MR_Word Call_53 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_4, (MR_Integer) 1))));
        MR_Box conv1_X_43;
        MR_Word TypeCtorInfo_35_60;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), XMap_42, ((MR_Box) (Call_53)), &conv1_X_43);
        if (succeeded)
        {
          X_43 = ((MR_Word) (conv1_X_43));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          Possible_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_43, (MR_Integer) 0))));
          Impossible_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_43, (MR_Integer) 1))));
          Inadmissible_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_43, (MR_Integer) 2))));
          TypeCtorInfo_35_60 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
          succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_60, ((MR_Box) (Exception_41)), Possible_44);
          if (succeeded)
          {
            {
              Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_52;
          ...
          {
            succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_41)), Impossible_45);
            if (succeeded)
            {
              {
                Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            else
            {
              ...
              succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_41)), Inadmissible_46);
              if (succeeded)
              {
                Var_49 = (MR_Integer) 2;
                {
                  Answer_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Answer_7, 0) = Node_52;
                  MR_hl_field(MR_mktag(0), Answer_7, 1) = (MR_Box) ((MR_Unsigned) (Var_49));
                }
                succeeded = MR_TRUE;
              }
            }
  ...
  if (succeeded)
  {
    ...
    Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 2))));
    Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 3))));
    Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 4))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Oracle_16)
{
  ...
  succeeded = mdb__declarative_oracle__answer_known_3_p_0(TypeInfo_for_T_24, STATE_VARIABLE_Oracle_0_15, Question_8, &Answer_13);
  if (succeeded)
  {
    {
      MR_Word base;
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Question_8)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Box Node_28 = (MR_hl_field(MR_mktag(0), Question_8, (MR_Integer) 0));
          MR_Word Atom_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_8, (MR_Integer) 2))));
          MR_Word Map_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 0))));
          MR_Word Truth_32;
          MR_Box conv2_Truth_32;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_final_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), Map_31, ((MR_Box) (Atom_30)), &conv2_Truth_32);
          if (succeeded)
          {
            Truth_32 = ((MR_Word) (conv2_Truth_32));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              Answer_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_25, 0) = Node_28;
              MR_hl_field(MR_mktag(0), Answer_25, 1) = (MR_Box) ((MR_Unsigned) (Truth_32));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 1:
        {
          MR_Word Call_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Question_8, (MR_Integer) 1))));
          MR_Word CMap_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 1))));
          MR_Box Node_45 = (MR_hl_field(MR_mktag(1), Question_8, (MR_Integer) 0));
          MR_Word Truth_46;
          MR_Box conv0_Truth_46;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), CMap_35, ((MR_Box) (Call_33)), &conv0_Truth_46);
          if (succeeded)
          {
            Truth_46 = ((MR_Word) (conv0_Truth_46));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              Answer_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Answer_25, 0) = Node_45;
              MR_hl_field(MR_mktag(0), Answer_25, 1) = (MR_Box) ((MR_Unsigned) (Truth_46));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 2:
        {
          MR_Word Exception_36 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 2))));
          MR_Word XMap_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 2))));
          MR_Word X_38;
          MR_Word Possible_39;
          MR_Word Impossible_40;
          MR_Word Inadmissible_41;
          MR_Box Node_47 = (MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 0));
          MR_Word Call_48 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_8, (MR_Integer) 1))));
          MR_Box conv1_X_38;
          MR_Word TypeCtorInfo_35_55;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), XMap_37, ((MR_Box) (Call_48)), &conv1_X_38);
          if (succeeded)
          {
            X_38 = ((MR_Word) (conv1_X_38));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            Possible_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_38, (MR_Integer) 0))));
            Impossible_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_38, (MR_Integer) 1))));
            Inadmissible_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_38, (MR_Integer) 2))));
            TypeCtorInfo_35_55 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
            succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_55, ((MR_Box) (Exception_36)), Possible_39);
            if (succeeded)
            {
              {
                Answer_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Answer_25, 0) = Node_47;
                MR_hl_field(MR_mktag(0), Answer_25, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              }
              succeeded = MR_TRUE;
            }
            else
            {
              succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_36)), Impossible_40);
              if (succeeded)
              {
                {
                  Answer_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Answer_25, 0) = Node_47;
                  MR_hl_field(MR_mktag(0), Answer_25, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_36)), Inadmissible_41);
                if (succeeded)
                {
                  Var_44 = (MR_Integer) 2;
                  {
                    Answer_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Answer_25, 0) = Node_47;
                    MR_hl_field(MR_mktag(0), Answer_25, 1) = (MR_Box) ((MR_Unsigned) (Var_44));
                  }
                  succeeded = MR_TRUE;
                }
              }
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Answer_25)) == (MR_Integer) 0);
      if (succeeded)
        DeclTruth_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Answer_25, (MR_Integer) 1))) & (MR_Integer) 3);
    }
    if (succeeded)
      {
        ...
        MR_hl_field(MR_mktag(1), UserQuestion_14, 1) = (MR_Box) ((MR_Unsigned) (DeclTruth_27));
      }
    else
      {
    ...
    mdb__declarative_oracle__query_oracle_user_6_p_0(TypeInfo_for_T_24, UserQuestion_14, Response_9, STATE_VARIABLE_Oracle_0_15, STATE_VARIABLE_Oracle_16);
  ...
  MR_Word * STATE_VARIABLE_Oracle_30)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          STATE_VARIABLE_Oracle_35_35 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, 2) = ((MR_Box) (Var_62));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, 3) = ((MR_Box) (Var_63));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, 4) = ((MR_Box) (Var_64));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_39 = mdb__declarative_debugger__get_decl_question_node_1_f_0(TypeInfo_for_T_77, Question_45);
        {
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_43 = mdb__declarative_debugger__get_decl_question_node_1_f_0(TypeInfo_for_T_77, Question_46);
            {
  ...
  Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, (MR_Integer) 0))));
  Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, (MR_Integer) 1))));
  Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, (MR_Integer) 3))));
  Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_35_35, (MR_Integer) 4))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&mdb__declarative_oracle_scalar_common_5[0]));
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&mdbcomp__rtti_access__mdbcomp__rtti_access__type_ctor_info_proc_layout_0), (MR_Word) (&mdb__declarative_oracle_scalar_common_1[1]), Var_30, Var_31, ((MR_Box) (Var_70)), &conv2_GroundMap_10);
                ...
                case (MR_Integer) 0:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&mdb__declarative_oracle_scalar_common_4[0]));
                    ...
                    mercury__list__foldl_4_p_0((MR_Word) (&mdbcomp__rtti_access__mdbcomp__rtti_access__type_ctor_info_proc_layout_0), (MR_Word) (&mdb__declarative_oracle_scalar_common_1[1]), Var_43, Var_44, ((MR_Box) (Map0_20)), &conv2_Map_22);
  ...
  MR_Word * Answer_6)
{
  ...
  Trusted_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Oracle_4, (MR_Integer) 3))));
  ProcLabel_18 = mdbcomp__rtti_access__get_proc_label_from_layout_1_f_0(Var_8);
  if (((MR_tag((MR_Word) ProcLabel_18)) == (MR_Integer) 0))
  {
    MR_Word Module_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_18, (MR_Integer) 0))));
    MR_Word PredOrFunc_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_18, (MR_Integer) 1))) & (MR_Integer) 1);
    MR_String Name_22 = ((MR_String) ((MR_hl_field(MR_mktag(0), ProcLabel_18, (MR_Integer) 3))));
    MR_Integer Arity_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_18, (MR_Integer) 4))));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_40, 0) = ((MR_Box) (Module_19));
            MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (Name_22));
            MR_hl_field(MR_mktag(3), Var_40, 2) = ((MR_Box) (Arity_23));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_40)), &conv0_Var_30);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          {
            Var_39 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_39, 0) = ((MR_Box) (Module_19));
            MR_hl_field(MR_mktag(2), Var_39, 1) = ((MR_Box) (Name_22));
            MR_hl_field(MR_mktag(2), Var_39, 2) = ((MR_Box) (Arity_23));
          }
          succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_39)), &conv1_Var_29);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        break;
    ...
    {
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (Module_19));
        }
        succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) (Var_38)), &conv2_Var_28);
        if (succeeded)
          succeeded = MR_TRUE;
      }
      if (!(succeeded))
      {
        MR_String ModuleNameStr_27;
        MR_Box conv3_Var_25;

        succeeded = mercury__bimap__search_3_p_0((MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Trusted_17, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_Var_25);
        if (succeeded)
          succeeded = MR_TRUE;
        if (succeeded)
        {
          if (((MR_tag((MR_Word) Module_19)) == (MR_Integer) 1))
            ModuleNameStr_27 = ((MR_String) ((MR_hl_field(MR_mktag(1), Module_19, (MR_Integer) 1))));
          else
            ModuleNameStr_27 = ((MR_String) ((MR_hl_field(MR_mktag(0), Module_19, (MR_Integer) 0))));
          succeeded = mercury__library__mercury_std_library_module_1_p_0(ModuleNameStr_27);
        }
      }
    }
  }
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Question_5)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Box Node_53 = (MR_hl_field(MR_mktag(0), Question_5, (MR_Integer) 0));
          MR_Word Atom_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Question_5, (MR_Integer) 2))));
          MR_Word Map_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_10, (MR_Integer) 0))));
          MR_Word Truth_57;
          MR_Box conv6_Truth_57;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_final_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), Map_56, ((MR_Box) (Atom_55)), &conv6_Truth_57);
          if (succeeded)
          {
            Truth_57 = ((MR_Word) (conv6_Truth_57));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              ...
              *Answer_6 = base;
              MR_hl_field(MR_mktag(0), base, 0) = Node_53;
              MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) ((MR_Unsigned) (Truth_57));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 1:
        {
          MR_Word Call_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Question_5, (MR_Integer) 1))));
          MR_Word CMap_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_10, (MR_Integer) 1))));
          MR_Box Node_70 = (MR_hl_field(MR_mktag(1), Question_5, (MR_Integer) 0));
          MR_Word Truth_71;
          MR_Box conv4_Truth_71;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_decl_truth_0), CMap_60, ((MR_Box) (Call_58)), &conv4_Truth_71);
          if (succeeded)
          {
            Truth_71 = ((MR_Word) (conv4_Truth_71));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              *Answer_6 = base;
              MR_hl_field(MR_mktag(0), base, 0) = Node_70;
              MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) ((MR_Unsigned) (Truth_71));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Integer) 2:
        {
          MR_Word Exception_61 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 2))));
          MR_Word XMap_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_10, (MR_Integer) 2))));
          MR_Word X_63;
          MR_Word Possible_64;
          MR_Word Impossible_65;
          MR_Word Inadmissible_66;
          MR_Box Node_72 = (MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 0));
          MR_Word Call_73 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Question_5, (MR_Integer) 1))));
          MR_Box conv5_X_63;
          MR_Word TypeCtorInfo_35_80;

          succeeded = mercury__map__search_3_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_init_decl_atom_0), (MR_Word) (&mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_known_exceptions_0), XMap_62, ((MR_Box) (Call_73)), &conv5_X_63);
          if (succeeded)
          {
            X_63 = ((MR_Word) (conv5_X_63));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            Possible_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_63, (MR_Integer) 0))));
            Impossible_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_63, (MR_Integer) 1))));
            Inadmissible_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_63, (MR_Integer) 2))));
            TypeCtorInfo_35_80 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
            succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_80, ((MR_Box) (Exception_61)), Possible_64);
            if (succeeded)
            {
              {
                MR_Word base;
            ...
            {
              succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_61)), Impossible_65);
              if (succeeded)
              {
                {
                  MR_Word base;
              ...
              else
              {
                ...
                succeeded = mercury__set__member_2_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), ((MR_Box) (Exception_61)), Inadmissible_66);
                if (succeeded)
                {
                  Var_69 = (MR_Integer) 2;
                  {
  ...
  MR_Word * STATE_VARIABLE_Oracle_10)
{
  ...
  if (succeeded)
  {
    ...
    Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 0))));
    Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 1))));
    Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 2))));
    Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 4))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Oracle_10)
{
  ...
  if (succeeded)
  {
    MR_Word Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 0))));
    MR_Word Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 1))));
    MR_Word Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_9, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Oracle_22)
{
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_24, 0) = ((MR_Box) (ModuleName_10));
          MR_hl_field(MR_mktag(3), Var_24, 1) = ((MR_Box) (Name_13));
          MR_hl_field(MR_mktag(3), Var_24, 2) = ((MR_Box) (Arity_14));
        }
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          Var_23 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_23, 0) = ((MR_Box) (ModuleName_10));
          MR_hl_field(MR_mktag(2), Var_23, 1) = ((MR_Box) (Name_13));
          MR_hl_field(MR_mktag(2), Var_23, 2) = ((MR_Box) (Arity_14));
        }
  ...
  if (succeeded)
  {
    MR_Word Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_21, (MR_Integer) 0))));
    MR_Word Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_21, (MR_Integer) 1))));
    MR_Word Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_21, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Oracle_12)
{
  ...
  if (succeeded)
  {
    MR_Word Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 0))));
    MR_Word Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 1))));
    MR_Word Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Oracle_0_11, (MR_Integer) 2))));
