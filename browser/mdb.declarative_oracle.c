...
{
  {
    ...
    mercury__bimap__set_4_p_0((MR_Word) &mdb__declarative_oracle__mdb__declarative_oracle__type_ctor_info_trusted_object_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), ((MR_Box) ((MR_Integer) 0)), Var_18, &Trusted_14);
