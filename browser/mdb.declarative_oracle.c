      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_35_57 = (MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0);
            succeeded = mercury__set__member_2_p_0(TypeCtorInfo_35_57, ((MR_Box) (Exception_38)), Possible_41);
            if (succeeded)
            {
              {
                Answer_27 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
