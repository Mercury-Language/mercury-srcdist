...
MR_decl_label7(__Compare___mdb__declarative_oracle__oracle_state_0_0, 3,2,5,9,13,17,60)
...
MR_BEGIN_MODULE(mdb__declarative_oracle_module36)
	...
	MR_init_label7(__Compare___mdb__declarative_oracle__oracle_state_0_0,3,2,5,9,13,17,60)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_oracle__oracle_state_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_oracle__oracle_state_0_0_i60);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___mdb__declarative_oracle__oracle_kb_0_0,
...
MR_def_label(__Compare___mdb__declarative_oracle__oracle_state_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
