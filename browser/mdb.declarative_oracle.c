...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_12_12 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
        if (succeeded)
        {
          TypeInfo_13_13 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_13_13, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        }
      }
    }
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]), &SubResult2_30, ((MR_Box) (ArgX2_28)), ((MR_Box) (ArgY2_29)));
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]), &SubResult1_6, ((MR_Box) (ArgX3_31)), ((MR_Box) (ArgY3_32)));
            succeeded = (SubResult1_6 != (MR_Integer) 0);
          }
        }
      }
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]), &SubResult2_43, ((MR_Box) (ArgX2_41)), ((MR_Box) (ArgY2_42)));
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]), &SubResult2_9, ((MR_Box) (ArgX3_44)), ((MR_Box) (ArgY3_45)));
              succeeded = (SubResult2_9 != (MR_Integer) 0);
            }
          }
        }
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_oracle_scalar_common_1[2]), &SubResult4_15, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeInfo_12_27 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_12_27, ((MR_Box) (ArgX2_20)), ((MR_Box) (ArgY2_21)));
          if (succeeded)
          {
            TypeInfo_13_28 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]);
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            TypeInfo_12_38 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[3]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_12_38, ((MR_Box) (ArgX2_31)), ((MR_Box) (ArgY2_32)));
            if (succeeded)
            {
              TypeInfo_13_39 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[4]);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_16_16 = (MR_Word) (&mdb__declarative_oracle_scalar_common_1[2]);
