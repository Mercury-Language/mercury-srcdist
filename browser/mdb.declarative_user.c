...
static const MR_EnumFunctorDescPtr mdb__declarative_user__mdb__declarative_user__enum_value_ordered_are_we_testing_0[2];
...
static const MR_EnumFunctorDescPtr mdb__declarative_user__mdb__declarative_user__enum_value_ordered_maybe_display_question_0[2];
...
const MR_TypeCtorInfo_Struct mdb__declarative_user__mdb__declarative_user__type_ctor_info_are_we_testing_0 = {
  ...
  {     mdb__declarative_user__mdb__declarative_user__enum_value_ordered_are_we_testing_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct mdb__declarative_user__mdb__declarative_user__type_ctor_info_maybe_display_question_0 = {
  ...
  {     mdb__declarative_user__mdb__declarative_user__enum_value_ordered_maybe_display_question_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    ...
    {
      *HeadVar__2_2 = (MR_Word) (MR_mkword(MR_mktag(3), &mdb__declarative_user_scalar_common_1[20]));
      succeeded = MR_TRUE;
    }
    else
    {
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Info0_34, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__declarative_user_scalar_common_5[15])));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), SubTermMode_24, 0) = ((MR_Box) (&mdb__declarative_user_scalar_common_2[0]));
