...
static /* final */ const MR_Box mdb__declarative_user_scalar_common_8[21][4];

static /* final */ const MR_Box mdb__declarative_user_scalar_common_10[1][9];


/* sealed */ struct mdb__declarative_user__vector_common_type_9_0_s {
...
static /* final */ const MR_Box mdb__declarative_user_scalar_common_2[18][3] = {
  ...
  /* row 14 */
  {
    ((MR_Box) (&mdb__declarative_user_scalar_common_8[20])),
...
static /* final */ const struct mdb__declarative_user__vector_common_type_9_0_s mdb__declarative_user_vector_common_9[33] = {
  /* row 0 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[1]) },
  /* row 1 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[0]) },
  /* row 2 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[1]) },
  /* row 3 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[2]) },
  /* row 4 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[3]) },
  /* row 5 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[4]) },
  /* row 6 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[2]) },
  /* row 7 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[5]) },
  /* row 8 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[6]) },
  /* row 9 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[7]) },
  /* row 10 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[3]) },
  /* row 11 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[4]) },
  /* row 12 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[5]) },
  /* row 13 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[6]) },
  /* row 14 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[8]) },
  /* row 15 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[9]) },
  /* row 16 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[7]) },
  /* row 17 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[8]) },
  /* row 18 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[10]) },
  /* row 19 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[9]) },
  /* row 20 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[10]) },
  /* row 21 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[11]) },
  /* row 22 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[11]) },
  /* row 23 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[12]) },
  /* row 24 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[13]) },
  /* row 25 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[14]) },
  /* row 26 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[15]) },
  /* row 27 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[12]) },
  /* row 28 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_2[13]) },
  /* row 29 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[16]) },
  /* row 30 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[17]) },
  /* row 31 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[18]) },
  /* row 32 */   {     (MR_Word) (&mdb__declarative_user_scalar_common_8[19]) },
};
          ...
          switch (MR_tag((MR_Word) Command_11)) {
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(Command_11)) {
                ...
                case (MR_Integer) 12:
                  {
                    MR_Word Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_User_30_30, (MR_Integer) 1))));
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_42 = mdb__declarative_user__decl_caller_type_0_f_0();
            {
            ...
            Var_44 = mdb__declarative_user__decl_caller_type_0_f_0();
            mdb__declarative_user__write_decl_final_atom_6_p_0(User_2, (MR_String) "", Var_44, Atom_9);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            mdb__declarative_user__write_decl_init_atom_6_p_0(User_2, (MR_String) "", Var_34, Atom_46);
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            mdb__declarative_user__write_decl_init_atom_6_p_0(User_2, (MR_String) "", Var_22, Atom_47);
      ...
      case (MR_Integer) 1:
        {
          ...
          Words_13 = mercury__string__words_separator_2_f_0((MR_Word) (&mdb__declarative_user_scalar_common_2[14]), String_12);
...
{
  {
...

    {
      ...
      else
      {
        // we found a match; look up the results
        ;
        *HeadVar__2_2 = ((&mdb__declarative_user_vector_common_9[0 + case_num_0]))->mdb__declarative_user__vector_common_type_9_0__vct_9_f_0;
        succeeded = MR_TRUE;
      }
    }
    return succeeded;
  ...
  MR_Word User0_10)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), User0_10, (MR_Integer) 1))));

      mercury__io__write_string_4_p_0(Var_31, (MR_String) "No such IO action.\n");
      OK_12 = (MR_Integer) 0;
    }
    else
    {
      ...
      {
        MR_Word Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), User0_10, (MR_Integer) 1))));

        mercury__io__write_string_4_p_0(Var_35, (MR_String) "No such IO action.\n");
        OK_12 = (MR_Integer) 0;
      }
      else
      {
