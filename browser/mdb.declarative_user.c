      ...
      case (MR_Integer) 1:
        {
          ...
          if ((MaybeArgNum_15 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            else
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeTrack_167, (MR_Integer) 0)));
              ...
              else
              {
                ...
                Node_151 = mdb__declarative_debugger__get_decl_question_node_1_f_0(TypeInfo_for_T_234, Question_174);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Answer_157, 3) = (MR_Box) (packed_args_0);
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            else
            {
              ...
              MR_Word Answer_24;
              MR_Box Node_148;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeTrack_19, (MR_Integer) 0)));
              ...
              Node_148 = mdb__declarative_debugger__get_decl_question_node_1_f_0(TypeInfo_for_T_234, Question_174);
              {
                ...
                MR_hl_field(MR_mktag(1), Answer_24, 3) = (MR_Box) (packed_args_1);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      MR_Word TermPath_73;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeTrackDirs_24, (MR_Integer) 0)));
