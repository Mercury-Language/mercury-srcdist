      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_29, Var_30);
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_31, Var_32);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_15, ArgX1_13, ArgY1_14);
                      succeeded = (SubResult1_15 != (MR_Integer) 0);
                      if (succeeded)
                        Var_6 = SubResult1_15;
                      else
                        mercury__private_builtin__builtin_compare_int_3_p_0(&Var_6, ArgX2_16, ArgY2_17);
                      succeeded = MR_TRUE;
                    }
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                        ...
                        mercury__private_builtin__builtin_compare_int_3_p_0(&Var_6, ArgX2_21, ArgY2_22);
                      succeeded = MR_TRUE;
                    }
                  }
                  break;
