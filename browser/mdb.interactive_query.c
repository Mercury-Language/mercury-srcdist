...
MR_decl_label4(__Unify___mdb__interactive_query__interactive_query_response_0_0, 10,6,26,1)
MR_decl_label4(__Unify___mdb__interactive_query__prog_0_0, 4,6,10,1)
MR_decl_label8(__Compare___mdb__interactive_query__interactive_query_response_0_0, 97,22,34,55,29,40,14,20)
MR_decl_label4(__Compare___mdb__interactive_query__interactive_query_response_0_0, 18,6,66,9)
...
;}
#line 1292 "mdb.interactive_query.c"
...
#line 638 "interactive_query.m"
    ...
    Y = X
;}
#line 1456 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 638 "interactive_query.m"
    ...
    Y = X
;}
#line 1520 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	}
...
MR_BEGIN_MODULE(mdb__interactive_query_module18)
	...
	MR_init_label4(__Unify___mdb__interactive_query__interactive_query_response_0_0,10,6,26,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___mdb__interactive_query__interactive_query_response_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdb__interactive_query__interactive_query_response_0_0_i26);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Unify___mdb__interactive_query__interactive_query_response_0_0_i10);
	}
	MR_r1 = (MR_sv(2) == MR_r1);
	MR_decr_sp(3);
	MR_proceed();
MR_def_label(__Unify___mdb__interactive_query__interactive_query_response_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___mdb__interactive_query__interactive_query_response_0_0,6)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___list__list_1_0);
MR_def_label(__Unify___mdb__interactive_query__interactive_query_response_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__interactive_query_module19)
	...
	MR_init_label8(__Compare___mdb__interactive_query__interactive_query_response_0_0,97,22,34,55,29,40,14,20)
	MR_init_label4(__Compare___mdb__interactive_query__interactive_query_response_0_0,18,6,66,9)
MR_BEGIN_CODE
...
MR_def_static(__Compare___mdb__interactive_query__interactive_query_response_0_0)
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i55);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	MR_r2 = MR_tempr1;
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i6);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i14);
	}
	if (MR_INT_NE(MR_unmkbody(MR_tempr1),0)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i22);
	}
	MR_tempr2 = MR_sv(2);
	if (MR_PTAG_TEST(MR_tempr2,1)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i97);
	}
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r2),1)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i29);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	MR_r2 = MR_tempr1;
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i66);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i97);
	}
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	if (MR_INT_NE(MR_unmkbody(MR_tempr1),0)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i40);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
	}
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r2),1)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i55);
	}
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
