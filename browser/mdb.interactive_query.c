...
#undef MR_PROC_LABEL
    ...
    switch (Loaded_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *Solution_8 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
          MR_Word base;
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      switch (Loaded_9) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *Solution_6 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 1:
          {
            MR_Word base;
...
{
  {
    ...
    switch ((env_ptr)->mdb__interactive_query__call_run_normal_3_p_0_env_0__Loaded_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *((env_ptr)->mdb__interactive_query__call_run_normal_3_p_0_env_0__Solution_6) = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
          MR_Word base;
      ...
      case (MR_Integer) 0:
        {
          ...
          mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) ((MR_Integer) 8), Var_46);
        }
        break;
      case (MR_Integer) 1:
        {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) ((MR_Integer) 4), Var_39);
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    ...
                    mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) ((MR_Integer) 0), Var_26);
                    // direct tailcall eliminated
                    ;
                    continue;
                  }
            ...
            case (MR_Integer) 1:
              {
                ...
                mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) ((MR_Integer) 0), Var_35);
...
{
  {
    ...
    if ((MaybeMercuryOptions_11 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      switch (QueryType_48) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 2:
          Outputs_55 = (MR_Word) ((MR_Integer) 0);
          break;
      }
...
mdb__interactive_query__write_solution_5_p_0(
  ...
  MR_Word Solution_8)
{
  if ((Solution_8 == (MR_Word) ((MR_Integer) 0)))
  {
...
{
  {
    ...
    else
    {
      ...
      if ((MaybeExcp_13 == (MR_Word) ((MR_Integer) 0)))
      {
...
mdb__interactive_query__write_import_list_4_p_0(
  ...
  MR_Word Imports_6)
{
  if (!((Imports_6 == (MR_Word) ((MR_Integer) 0))))
  {
