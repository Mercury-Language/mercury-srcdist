  ...
  MR_Word Varset_8)
{
  ...
  else
  {
    ...
    mdb__interactive_query__compile_file_5_p_0(Var_29, Var_53, &Succeeded_15);
    switch (Succeeded_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
  ...
  MR_Word Handle_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result_15)) == (MR_Integer) 2))
    {
      ...
      Var_29 = mercury__univ__univ_value_1_f_0(&TypeInfo_36_36, Excp_17);
      mercury__io__write_string_4_p_0(OutputStream_7, (MR_String) "*** caught exception: ");
      mercury__io__write_line_cc_4_p_0(TypeInfo_36_36, OutputStream_7, Var_29);
    }
  }
}
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_32 = mercury__univ__univ_value_1_f_0(&TypeInfo_37_37, Excp_17);
          mercury__io__write_string_4_p_0(OutputStream_7, (MR_String) "*** caught exception: ");
          mercury__io__write_line_cc_4_p_0(TypeInfo_37_37, OutputStream_7, Var_32);
        }
        break;
    }
  }
  ...
  MR_Word Handle_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_31 = mercury__univ__univ_value_1_f_0(&TypeInfo_44_44, Excp_17);
      mercury__io__write_string_4_p_0(OutputStream_7, (MR_String) "*** caught exception: ");
      mercury__io__write_line_cc_4_p_0(TypeInfo_44_44, OutputStream_7, Var_31);
    }
