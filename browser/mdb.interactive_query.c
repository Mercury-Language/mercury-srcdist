  ...
  MR_Word Varset_8)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result_75)) == (MR_Integer) 1))
    {
      ...
      mercury__io__write_string_4_p_0(Var_30, Progname_78);
      ...
      mercury__io__write_string_4_p_0(Var_30, ErrorMessage_79);
    ...
    mdb__interactive_query__compile_file_5_p_0(Var_32, Var_52, &Succeeded_15);
    switch (Succeeded_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  Var_75 = mercury__univ__univ_value_1_f_0(&TypeInfo_37_80, Excp_71);
                  mercury__io__write_string_4_p_0(OutputStream_5, (MR_String) "*** caught exception: ");
                  mercury__io__write_line_cc_4_p_0(TypeInfo_37_80, OutputStream_5, Var_75);
                }
                break;
            }
          }
