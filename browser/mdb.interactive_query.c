...
MR_decl_label10(mdb__interactive_query__query_external_7_0, 139,2,3,4,7,8,6,12,13,10)
MR_decl_label7(mdb__interactive_query__query_external_7_0, 16,22,35,37,33,42,43)
...
#line 645 "interactive_query.m"
    ...
    Y = X
;}
#line 1448 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 645 "interactive_query.m"
    ...
    Y = X
;}
#line 1547 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	}
...
MR_BEGIN_MODULE(mdb__interactive_query_module13)
	...
	MR_init_label10(mdb__interactive_query__query_external_7_0,139,2,3,4,7,8,6,12,13,10)
	MR_init_label7(mdb__interactive_query__query_external_7_0,16,22,35,37,33,42,43)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__interactive_query__query_external_7_0);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(mdb__interactive_query__query_external_7_0,139)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(mdb__interactive_query__query_external_7_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(7),0)) {
		MR_GOTO_LAB(mdb__interactive_query__query_external_7_0_i22);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_sv(7);
...
MR_def_label(mdb__interactive_query__query_external_7_0,22)
	...
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(mdb__interactive_query__term_to_list_2_0,
		mdb__interactive_query__query_external_7_0_i35);
MR_def_label(mdb__interactive_query__query_external_7_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__interactive_query__query_external_7_0_i33);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	{
	MR_Word MR_tempr1;
...
MR_def_label(mdb__interactive_query__query_external_7_0,37)
	...
	MR_np_call_localret_ent(mdb__interactive_query__send_term_to_socket_4_0,
		mdb__interactive_query__query_external_7_0_i43);
MR_def_label(mdb__interactive_query__query_external_7_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(mdb__interactive_query__run_query_4_0,
		mdb__interactive_query__query_external_7_0_i42);
MR_def_label(mdb__interactive_query__query_external_7_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(mdb__interactive_query__send_term_to_socket_4_0,
...
MR_def_label(mdb__interactive_query__query_external_7_0,43)
	...
	MR_r5 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(mdb__interactive_query__query_external_7_0_i139);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
