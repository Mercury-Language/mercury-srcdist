...
MR_decl_label8(mdb__interactive_query__query_7_0, 33,19,3,2,5,14,15,9)
MR_decl_label3(mdb__interactive_query__query_7_0, 10,11,12)
MR_decl_label8(mdb__interactive_query__query_2_8_0, 129,6,128,10,25,26,16,31)
MR_decl_label6(mdb__interactive_query__query_2_8_0, 33,34,36,29,39,41)
MR_decl_label8(mdb__interactive_query__query_external_7_0, 127,2,3,4,7,8,10,12)
MR_decl_label8(mdb__interactive_query__query_external_7_0, 13,16,17,23,36,38,34,43)
MR_decl_label1(mdb__interactive_query__query_external_7_0, 44)
...
MR_decl_label4(__Unify___mdb__interactive_query__interactive_query_response_0_0, 8,6,18,1)
MR_decl_label4(__Unify___mdb__interactive_query__prog_0_0, 4,6,10,1)
MR_decl_label8(__Compare___mdb__interactive_query__interactive_query_response_0_0, 121,64,60,79,5,14,28,32)
MR_decl_label3(__Compare___mdb__interactive_query__interactive_query_response_0_0, 16,135,19)
...
#line 645 "interactive_query.m"
    ...
    Y = X
;}
#line 1455 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__interactive_query_module10)
	...
	MR_init_label8(mdb__interactive_query__query_7_0,33,19,3,2,5,14,15,9)
	MR_init_label3(mdb__interactive_query__query_7_0,10,11,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__interactive_query_module11)
	...
	MR_init_label8(mdb__interactive_query__query_2_8_0,129,6,128,10,25,26,16,31)
	MR_init_label6(mdb__interactive_query__query_2_8_0,33,34,36,29,39,41)
MR_BEGIN_CODE
...
MR_def_label(mdb__interactive_query__query_2_8_0,6)
	...
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(io__nl_3_0,
		mdb__interactive_query__query_2_8_0_i41);
...
MR_def_label(mdb__interactive_query__query_2_8_0,39)
	...
	MR_np_call_localret_ent(mdb__interactive_query__run_query_4_0,
		mdb__interactive_query__query_2_8_0_i41);
MR_def_label(mdb__interactive_query__query_2_8_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(mdb__interactive_query_module13)
	...
	MR_init_label8(mdb__interactive_query__query_external_7_0,127,2,3,4,7,8,10,12)
	MR_init_label8(mdb__interactive_query__query_external_7_0,13,16,17,23,36,38,34,43)
	MR_init_label1(mdb__interactive_query__query_external_7_0,44)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__interactive_query_module18)
	...
	MR_init_label4(__Unify___mdb__interactive_query__interactive_query_response_0_0,8,6,18,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__interactive_query_module19)
	...
	MR_init_label8(__Compare___mdb__interactive_query__interactive_query_response_0_0,121,64,60,79,5,14,28,32)
	MR_init_label3(__Compare___mdb__interactive_query__interactive_query_response_0_0,16,135,19)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,64)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__interactive_query_response_0_0_i135);
	}
...
MR_def_label(__Compare___mdb__interactive_query__interactive_query_response_0_0,135)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
