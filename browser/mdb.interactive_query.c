...
{
  {
    ...
    MR_Char mdb__interactive_query__Var_56;

    mdb__interactive_query__succeeded = mercury__string__index_3_p_0(mdb__interactive_query__LambdaHeadVar__1_21, (MR_Integer) 0, &mdb__interactive_query__Var_56);
    if (mdb__interactive_query__succeeded)
      mdb__interactive_query__succeeded = ((MR_Char) 95 == mdb__interactive_query__Var_56);
...
{
  {
    ...
    {
      MR_Word mdb__interactive_query__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));

      if ((mdb__interactive_query__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *mdb__interactive_query__HeadVar__1_1 = (MR_Integer) 2;
      else
      {
        MR_Word mdb__interactive_query__ArgY1_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));

        mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_2[0], mdb__interactive_query__HeadVar__1_1, ((MR_Box) (mdb__interactive_query__Var_11)), ((MR_Box) (mdb__interactive_query__ArgY1_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__ArgY1_6;

      mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
        mdb__interactive_query__TypeInfo_9_9 = (MR_Word) &mdb__interactive_query_scalar_common_2[0];
        mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_9_9, ((MR_Box) (mdb__interactive_query__ArgX1_5)), ((MR_Box) (mdb__interactive_query__ArgY1_6)));
      }
    }
    return mdb__interactive_query__succeeded;
  }
...
{
  {
    ...
    {
      MR_Word mdb__interactive_query__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 1)));
      MR_String mdb__interactive_query__ArgX3_8 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 2)));
      MR_String mdb__interactive_query__ArgY3_9 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgX5_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgY5_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgX6_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgY6_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__Var_16;
      MR_Integer mdb__interactive_query__Var_29 = (MR_Integer) mdb__interactive_query__ArgX1_4;
      MR_Integer mdb__interactive_query__Var_30 = (MR_Integer) mdb__interactive_query__ArgY1_5;

      mercury__private_builtin__builtin_compare_int_3_p_0(&mdb__interactive_query__Var_16, mdb__interactive_query__Var_29, mdb__interactive_query__Var_30);
      mdb__interactive_query__succeeded = (mdb__interactive_query__Var_16 == (MR_Integer) 0);
      mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
      if (mdb__interactive_query__succeeded)
        *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_16;
      else
      {
        MR_Word mdb__interactive_query__Var_17;

        mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], &mdb__interactive_query__Var_17, ((MR_Box) (mdb__interactive_query__ArgX2_6)), ((MR_Box) (mdb__interactive_query__ArgY2_7)));
        mdb__interactive_query__succeeded = (mdb__interactive_query__Var_17 == (MR_Integer) 0);
        mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
        if (mdb__interactive_query__succeeded)
          *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_17;
        else
        {
          MR_Word mdb__interactive_query__Var_18;

          mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__interactive_query__Var_18, mdb__interactive_query__ArgX3_8, mdb__interactive_query__ArgY3_9);
          mdb__interactive_query__succeeded = (mdb__interactive_query__Var_18 == (MR_Integer) 0);
          mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
          if (mdb__interactive_query__succeeded)
            *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_18;
          else
          {
            MR_Word mdb__interactive_query__Var_19;

            mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_2[0], &mdb__interactive_query__Var_19, ((MR_Box) (mdb__interactive_query__ArgX4_10)), ((MR_Box) (mdb__interactive_query__ArgY4_11)));
            mdb__interactive_query__succeeded = (mdb__interactive_query__Var_19 == (MR_Integer) 0);
            mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
            if (mdb__interactive_query__succeeded)
              *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_19;
            else
            {
              MR_Word mdb__interactive_query__Var_20;

              mercury__io____Compare____input_stream_0_0(&mdb__interactive_query__Var_20, mdb__interactive_query__ArgX5_12, mdb__interactive_query__ArgY5_13);
              mdb__interactive_query__succeeded = (mdb__interactive_query__Var_20 == (MR_Integer) 0);
              mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
              if (mdb__interactive_query__succeeded)
                *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_20;
              else
                mercury__io____Compare____output_stream_0_0(mdb__interactive_query__HeadVar__1_1, mdb__interactive_query__ArgX6_14, mdb__interactive_query__ArgY6_15);
            }
          }
        }
      }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 1)));
      MR_String mdb__interactive_query__ArgX3_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 2)));
      MR_String mdb__interactive_query__ArgY3_8 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgX5_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgY5_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgX6_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgY6_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 5)));

      mdb__interactive_query__succeeded = (mdb__interactive_query__ArgX1_3 == mdb__interactive_query__ArgY1_4);
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__TypeInfo_17_17 = (MR_Word) &mdb__interactive_query_scalar_common_1[1];
        mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_17_17, ((MR_Box) (mdb__interactive_query__ArgX2_5)), ((MR_Box) (mdb__interactive_query__ArgY2_6)));
        if (mdb__interactive_query__succeeded)
        {
          mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__ArgX3_7, mdb__interactive_query__ArgY3_8) == 0);
          if (mdb__interactive_query__succeeded)
          {
            mdb__interactive_query__TypeInfo_18_18 = (MR_Word) &mdb__interactive_query_scalar_common_2[0];
            mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_18_18, ((MR_Box) (mdb__interactive_query__ArgX4_9)), ((MR_Box) (mdb__interactive_query__ArgY4_10)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__succeeded = mercury__io____Unify____input_stream_0_0(mdb__interactive_query__ArgX5_11, mdb__interactive_query__ArgY5_12);
              if (mdb__interactive_query__succeeded)
                mdb__interactive_query__succeeded = mercury__io____Unify____output_stream_0_0(mdb__interactive_query__ArgX6_13, mdb__interactive_query__ArgY6_14);
            }
          }
        }
      }
    ...
    if (mdb__interactive_query__succeeded)
      *mdb__interactive_query__HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String mdb__interactive_query__Var_25 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String mdb__interactive_query__ArgY1_8 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));

                  mercury__private_builtin__builtin_compare_string_3_p_0(mdb__interactive_query__HeadVar__1_1, mdb__interactive_query__Var_25, mdb__interactive_query__ArgY1_8);
                }
                break;
              case (MR_Integer) 2:
                *mdb__interactive_query__HeadVar__1_1 = (MR_Integer) 1;
        ...
        case (MR_Integer) 2:
          {
            MR_Word mdb__interactive_query__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word mdb__interactive_query__ArgY1_16 = ((MR_Word) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));

                  mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], mdb__interactive_query__HeadVar__1_1, ((MR_Box) (mdb__interactive_query__Var_24)), ((MR_Box) (mdb__interactive_query__ArgY1_16)));
                }
                break;
            }
          }
...
{
  {
    ...
    if (mdb__interactive_query__succeeded)
      ...
      switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String mdb__interactive_query__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
            MR_String mdb__interactive_query__ArgY1_6;

            mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
              mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__ArgX1_5, mdb__interactive_query__ArgY1_6) == 0);
            }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            MR_Word mdb__interactive_query__ArgX1_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word mdb__interactive_query__ArgY1_8;

            mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__ArgY1_8 = ((MR_Word) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
              mdb__interactive_query__TypeInfo_13_13 = (MR_Word) &mdb__interactive_query_scalar_common_1[1];
              mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_13_13, ((MR_Box) (mdb__interactive_query__ArgX1_7)), ((MR_Box) (mdb__interactive_query__ArgY1_8)));
            }
          }
          break;
      }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgX5_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgY5_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgX6_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgY6_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgX7_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 6)));
      MR_Word mdb__interactive_query__ArgY7_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 6)));
      MR_Word mdb__interactive_query__Var_18;
      MR_Integer mdb__interactive_query__Var_33 = (MR_Integer) mdb__interactive_query__ArgX1_4;
      MR_Integer mdb__interactive_query__Var_34 = (MR_Integer) mdb__interactive_query__ArgY1_5;

      mercury__private_builtin__builtin_compare_int_3_p_0(&mdb__interactive_query__Var_18, mdb__interactive_query__Var_33, mdb__interactive_query__Var_34);
      mdb__interactive_query__succeeded = (mdb__interactive_query__Var_18 == (MR_Integer) 0);
      mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
      if (mdb__interactive_query__succeeded)
        *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_18;
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], &mdb__interactive_query__Var_19, ((MR_Box) (mdb__interactive_query__ArgX2_6)), ((MR_Box) (mdb__interactive_query__ArgY2_7)));
        mdb__interactive_query__succeeded = (mdb__interactive_query__Var_19 == (MR_Integer) 0);
        mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
        if (mdb__interactive_query__succeeded)
          *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_19;
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_2[0], &mdb__interactive_query__Var_20, ((MR_Box) (mdb__interactive_query__ArgX3_8)), ((MR_Box) (mdb__interactive_query__ArgY3_9)));
          mdb__interactive_query__succeeded = (mdb__interactive_query__Var_20 == (MR_Integer) 0);
          mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
          if (mdb__interactive_query__succeeded)
            *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_20;
          ...
          {
            MR_Word mdb__interactive_query__Var_21;

            mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], &mdb__interactive_query__Var_21, ((MR_Box) (mdb__interactive_query__ArgX4_10)), ((MR_Box) (mdb__interactive_query__ArgY4_11)));
            mdb__interactive_query__succeeded = (mdb__interactive_query__Var_21 == (MR_Integer) 0);
            mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
            if (mdb__interactive_query__succeeded)
              *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_21;
            else
            {
              MR_Word mdb__interactive_query__Var_22;

              mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], &mdb__interactive_query__Var_22, ((MR_Box) (mdb__interactive_query__ArgX5_12)), ((MR_Box) (mdb__interactive_query__ArgY5_13)));
              mdb__interactive_query__succeeded = (mdb__interactive_query__Var_22 == (MR_Integer) 0);
              mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
              if (mdb__interactive_query__succeeded)
                *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_22;
              else
              {
                MR_Word mdb__interactive_query__Var_23;

                mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[2], &mdb__interactive_query__Var_23, ((MR_Box) (mdb__interactive_query__ArgX6_14)), ((MR_Box) (mdb__interactive_query__ArgY6_15)));
                mdb__interactive_query__succeeded = (mdb__interactive_query__Var_23 == (MR_Integer) 0);
                mdb__interactive_query__succeeded = !(mdb__interactive_query__succeeded);
                if (mdb__interactive_query__succeeded)
                  *mdb__interactive_query__HeadVar__1_1 = mdb__interactive_query__Var_23;
                else
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[3], mdb__interactive_query__HeadVar__1_1, ((MR_Box) (mdb__interactive_query__ArgX7_16)), ((MR_Box) (mdb__interactive_query__ArgY7_17)));
                }
              }
            }
          }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__ArgX5_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgY5_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__ArgX6_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgY6_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__ArgX7_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 6)));
      MR_Word mdb__interactive_query__ArgY7_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 6)));

      mdb__interactive_query__succeeded = (mdb__interactive_query__ArgX1_3 == mdb__interactive_query__ArgY1_4);
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__TypeInfo_19_19 = (MR_Word) &mdb__interactive_query_scalar_common_1[1];
        mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_19_19, ((MR_Box) (mdb__interactive_query__ArgX2_5)), ((MR_Box) (mdb__interactive_query__ArgY2_6)));
        if (mdb__interactive_query__succeeded)
        {
          mdb__interactive_query__TypeInfo_20_20 = (MR_Word) &mdb__interactive_query_scalar_common_2[0];
          mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_20_20, ((MR_Box) (mdb__interactive_query__ArgX3_7)), ((MR_Box) (mdb__interactive_query__ArgY3_8)));
          if (mdb__interactive_query__succeeded)
          {
            mdb__interactive_query__TypeInfo_21_21 = (MR_Word) &mdb__interactive_query_scalar_common_1[1];
            mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_21_21, ((MR_Box) (mdb__interactive_query__ArgX4_9)), ((MR_Box) (mdb__interactive_query__ArgY4_10)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__TypeInfo_22_22 = (MR_Word) &mdb__interactive_query_scalar_common_1[1];
              mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_22_22, ((MR_Box) (mdb__interactive_query__ArgX5_11)), ((MR_Box) (mdb__interactive_query__ArgY5_12)));
              if (mdb__interactive_query__succeeded)
              {
                mdb__interactive_query__TypeInfo_23_23 = (MR_Word) &mdb__interactive_query_scalar_common_1[2];
                mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_23_23, ((MR_Box) (mdb__interactive_query__ArgX6_13)), ((MR_Box) (mdb__interactive_query__ArgY6_14)));
                if (mdb__interactive_query__succeeded)
                {
                  mdb__interactive_query__TypeInfo_24_24 = (MR_Word) &mdb__interactive_query_scalar_common_1[3];
                  mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_24_24, ((MR_Box) (mdb__interactive_query__ArgX7_15)), ((MR_Box) (mdb__interactive_query__ArgY7_16)));
                }
              }
            }
          }
    ...
    if (mdb__interactive_query__succeeded)
      *mdb__interactive_query__HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word mdb__interactive_query__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word mdb__interactive_query__ArgY1_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));

                  mercury__builtin__compare_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_1[1], mdb__interactive_query__HeadVar__1_1, ((MR_Box) (mdb__interactive_query__Var_29)), ((MR_Box) (mdb__interactive_query__ArgY1_8)));
                }
                break;
              case (MR_Integer) 2:
                *mdb__interactive_query__HeadVar__1_1 = (MR_Integer) 1;
        ...
        case (MR_Integer) 2:
          {
            MR_String mdb__interactive_query__Var_28 = ((MR_String) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) mdb__interactive_query__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String mdb__interactive_query__ArgY1_23 = ((MR_String) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__3_3, (MR_Integer) 0)));

                  mercury__private_builtin__builtin_compare_string_3_p_0(mdb__interactive_query__HeadVar__1_1, mdb__interactive_query__Var_28, mdb__interactive_query__ArgY1_23);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 1:
          {
            ...
            if (mdb__interactive_query__succeeded)
            {
              ...
              mdb__interactive_query__succeeded = mercury__builtin__unify_2_p_0(mdb__interactive_query__TypeInfo_15_15, ((MR_Box) (mdb__interactive_query__ArgX1_5)), ((MR_Box) (mdb__interactive_query__ArgY1_6)));
            }
          }
          break;
        case (MR_Integer) 2:
          {
            MR_String mdb__interactive_query__ArgX1_11 = ((MR_String) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
            MR_String mdb__interactive_query__ArgY1_12;

            mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__ArgY1_12 = ((MR_String) (MR_hl_field(MR_mktag(2), mdb__interactive_query__HeadVar__2_2, (MR_Integer) 0)));
              mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__ArgX1_11, mdb__interactive_query__ArgY1_12) == 0);
            }
          }
          break;
      }
...
{
  {
    ...
    MR_Box mdb__interactive_query__Var_14;
    ...
    mdb__interactive_query__Var_14 = mercury__univ__univ_value_1_f_0(&mdb__interactive_query__TypeInfo_20_20, mdb__interactive_query__Univ_8);
    mercury__io__write_cc_3_p_0(mdb__interactive_query__TypeInfo_20_20, mdb__interactive_query__Var_14);
    mercury__io__write_string_3_p_0((MR_String) ", ");
  }
}
...
{
  {
    MR_Word mdb__interactive_query__TypeInfo_17_17;
    MR_Word mdb__interactive_query__Univ_8;
    MR_String mdb__interactive_query__Var_11;
    MR_Word mdb__interactive_query__Var_13;
    MR_Box mdb__interactive_query__conv0_Univ_8;
    MR_Box mdb__interactive_query__Var_14;
    MR_Box mdb__interactive_query__Var_18;
    ...
    mdb__interactive_query__Univ_8 = ((MR_Word) mdb__interactive_query__conv0_Univ_8);
    mdb__interactive_query__Var_14 = mercury__univ__univ_value_1_f_0(&mdb__interactive_query__TypeInfo_17_17, mdb__interactive_query__Univ_8);
    mdb__interactive_query__Var_13 = mercury__type_desc__type_of_1_f_0(mdb__interactive_query__TypeInfo_17_17);
    mdb__interactive_query__Var_11 = mercury__type_desc__type_name_1_f_0(mdb__interactive_query__Var_13);
    mercury__io__write_string_3_p_0(mdb__interactive_query__Var_11);
  }
}
...
{
  {
    MR_Word mdb__interactive_query__Var_8;
    MR_Word mdb__interactive_query__Var_11;
    MR_Word mdb__interactive_query__Var_12;
    MR_Word mdb__interactive_query__Var_14;

    {
      mdb__interactive_query__Var_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_14, 0) = ((MR_Box) (mdb__interactive_query__Var_4));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[26])));
    }
    {
      mdb__interactive_query__Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_12, 0) = ((MR_Box) ((MR_String) "\", univ.univ("));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_12, 1) = ((MR_Box) (mdb__interactive_query__Var_14));
    }
    {
      mdb__interactive_query__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_11, 0) = ((MR_Box) (mdb__interactive_query__Var_4));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_11, 1) = ((MR_Box) (mdb__interactive_query__Var_12));
    }
    {
      mdb__interactive_query__Var_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_8, 0) = ((MR_Box) ((MR_String) "       map.set(\""));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_8, 1) = ((MR_Box) (mdb__interactive_query__Var_11));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_8);
  }
}
...
{
  {
...

    {
      mdb__interactive_query__Var_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_14, 0) = ((MR_Box) (mdb__interactive_query__Var_4));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[22])));
    }
    {
      mdb__interactive_query__Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_12, 0) = ((MR_Box) ((MR_String) "\"), "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_12, 1) = ((MR_Box) (mdb__interactive_query__Var_14));
    }
    {
      mdb__interactive_query__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      mdb__interactive_query__Var_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_8, 0) = ((MR_Box) ((MR_String) "       univ.univ_to_type(!.Bindings ^ elem(\""));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_8, 1) = ((MR_Box) (mdb__interactive_query__Var_11));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_8);
  }
  ...
  MR_Word mdb__interactive_query__Env_4)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      MR_Word mdb__interactive_query__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
      MR_String mdb__interactive_query__Var_51 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__Var_8;

      mercury__io__set_input_stream_4_p_0(mdb__interactive_query__Var_20, &mdb__interactive_query__OldInputStream_6);
      mercury__term_io__read_term_3_p_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, &mdb__interactive_query__Result_7);
      mercury__io__set_input_stream_4_p_0(mdb__interactive_query__OldInputStream_6, &mdb__interactive_query__Var_8);
      switch (MR_tag((MR_Word) mdb__interactive_query__Result_7)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word mdb__interactive_query__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
            MR_Word mdb__interactive_query__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
            MR_Word mdb__interactive_query__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
            MR_String mdb__interactive_query__Var_56 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
            MR_Word mdb__interactive_query__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
            MR_Word mdb__interactive_query__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));

            mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), mdb__interactive_query__Var_46);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            MR_Word mdb__interactive_query__Var_41;
            MR_Word mdb__interactive_query__Var_42;
            ...
            MR_Word mdb__interactive_query__Var_59;
            MR_Word mdb__interactive_query__Var_60;
            MR_String mdb__interactive_query__Var_61;
            MR_Word mdb__interactive_query__Var_62;
            MR_Word mdb__interactive_query__Var_63;

            {
              mdb__interactive_query__Var_41 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), mdb__interactive_query__Var_41, 0) = ((MR_Box) (mdb__interactive_query__ErrorMsg_9));
            }
            mdb__interactive_query__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
            mdb__interactive_query__Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
            mdb__interactive_query__Var_61 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
            mdb__interactive_query__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
            mdb__interactive_query__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
            mdb__interactive_query__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
            mdb__interactive_query__send_term_to_socket_4_p_0(mdb__interactive_query__Var_41, mdb__interactive_query__Var_42);
            ...
            switch (MR_tag((MR_Word) mdb__interactive_query__Cmd_13)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(mdb__interactive_query__Cmd_13)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word mdb__interactive_query__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                      MR_Word mdb__interactive_query__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                      MR_Word mdb__interactive_query__Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                      MR_String mdb__interactive_query__Var_66 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                      MR_Word mdb__interactive_query__Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                      MR_Word mdb__interactive_query__Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));

                      mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)), mdb__interactive_query__Var_39);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      MR_Word mdb__interactive_query__Var_26;
                      MR_Word mdb__interactive_query__Var_96;
                      MR_Word mdb__interactive_query__Var_97;
                      MR_String mdb__interactive_query__Var_98;
                      MR_Word mdb__interactive_query__Var_99;
                      MR_Word mdb__interactive_query__Var_100;
                      ...
                      mdb__interactive_query__Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                      mdb__interactive_query__Var_97 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                      mdb__interactive_query__Var_98 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                      mdb__interactive_query__Var_99 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                      mdb__interactive_query__Var_100 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
                      mdb__interactive_query__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                      mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), mdb__interactive_query__Var_26);
                      /* direct tailcall eliminated */
                      continue;
                    }
                    break;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word mdb__interactive_query__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                  MR_Word mdb__interactive_query__Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                  MR_Word mdb__interactive_query__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                  MR_String mdb__interactive_query__Var_71 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                  MR_Word mdb__interactive_query__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                  MR_Word mdb__interactive_query__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
                  MR_Word mdb__interactive_query__Var_74;
                  MR_Word mdb__interactive_query__Var_75;
                  MR_Word mdb__interactive_query__Var_77;
                  MR_Word mdb__interactive_query__Var_78;
                  MR_Word mdb__interactive_query__Var_79;
                  MR_String mdb__interactive_query__Var_76;

                  mdb__interactive_query__send_term_to_socket_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), mdb__interactive_query__Var_35);
                  mdb__interactive_query__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                  mdb__interactive_query__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                  mdb__interactive_query__Var_76 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                  mdb__interactive_query__Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                  mdb__interactive_query__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
                  mdb__interactive_query__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                  {
                    mdb__interactive_query__Env1_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 0) = ((MR_Box) (mdb__interactive_query__Var_74));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 1) = ((MR_Box) (mdb__interactive_query__Var_75));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 2) = ((MR_Box) (mdb__interactive_query__NewOptions_14));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 3) = ((MR_Box) (mdb__interactive_query__Var_77));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 4) = ((MR_Box) (mdb__interactive_query__Var_78));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_15, 5) = ((MR_Box) (mdb__interactive_query__Var_79));
                  }
                  /* direct tailcall eliminated */
                  {
                    MR_Word mdb__interactive_query__next_value_of_Env_4 = mdb__interactive_query__Env1_15;

                    mdb__interactive_query__Env_4 = mdb__interactive_query__next_value_of_Env_4;
                  }
                  continue;
                }
                break;
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word mdb__interactive_query__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                  MR_Word mdb__interactive_query__Var_30;
                  MR_Word mdb__interactive_query__Env1_48;
                  MR_Word mdb__interactive_query__Var_90;
                  MR_Word mdb__interactive_query__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                  MR_String mdb__interactive_query__Var_81 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                  MR_Word mdb__interactive_query__Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                  MR_Word mdb__interactive_query__Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
                  MR_Word mdb__interactive_query__Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                  MR_Word mdb__interactive_query__Var_85;
                  MR_String mdb__interactive_query__Var_87;
                  MR_Word mdb__interactive_query__Var_88;
                  MR_Word mdb__interactive_query__Var_89;
                  MR_Word mdb__interactive_query__Var_86;

                  mdb__interactive_query__Imports_17 = mercury__list__f_43_43_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__interactive_query__Var_29, mdb__interactive_query__AddedImports_16);
                  mdb__interactive_query__Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
                  mdb__interactive_query__Var_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
                  mdb__interactive_query__Var_87 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
                  mdb__interactive_query__Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
                  mdb__interactive_query__Var_89 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
                  mdb__interactive_query__Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
                  {
                    mdb__interactive_query__Env1_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 0) = ((MR_Box) (mdb__interactive_query__Var_85));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 1) = ((MR_Box) (mdb__interactive_query__Imports_17));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 2) = ((MR_Box) (mdb__interactive_query__Var_87));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 3) = ((MR_Box) (mdb__interactive_query__Var_88));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 4) = ((MR_Box) (mdb__interactive_query__Var_89));
                    MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_48, 5) = ((MR_Box) (mdb__interactive_query__Var_90));
                  }
                  {
                    mdb__interactive_query__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 0) = ((MR_Box) (mdb__interactive_query__Imports_17));
                  }
                  mdb__interactive_query__send_term_to_socket_4_p_0(mdb__interactive_query__Var_30, mdb__interactive_query__Var_90);
                  /* direct tailcall eliminated */
                  {
                    MR_Word mdb__interactive_query__next_value_of_Env_4 = mdb__interactive_query__Env1_48;
  ...
  MR_Word mdb__interactive_query__ReadTerm_6)
{
  switch (MR_tag((MR_Word) mdb__interactive_query__ReadTerm_6)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word mdb__interactive_query__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
        MR_Word mdb__interactive_query__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
        MR_Word mdb__interactive_query__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
        MR_String mdb__interactive_query__Var_47 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
        MR_Word mdb__interactive_query__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
        MR_Word mdb__interactive_query__Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));

        mercury__io__nl_3_p_0(mdb__interactive_query__Var_42);
      }
      break;
    case (MR_Integer) 1:
      {
        MR_String mdb__interactive_query__Msg_8 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__ReadTerm_6, (MR_Integer) 0)));
        MR_Word mdb__interactive_query__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
        MR_Word mdb__interactive_query__Var_39;
        ...
        MR_Word mdb__interactive_query__Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
        MR_Word mdb__interactive_query__Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
        MR_String mdb__interactive_query__Var_52 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
        MR_Word mdb__interactive_query__Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
        MR_Word mdb__interactive_query__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
        MR_Word mdb__interactive_query__Var_55;
        MR_Word mdb__interactive_query__Var_56;
        MR_String mdb__interactive_query__Var_57;
        MR_Word mdb__interactive_query__Var_58;
        MR_Word mdb__interactive_query__Var_59;

        mercury__io__write_string_4_p_0(mdb__interactive_query__Var_37, mdb__interactive_query__Msg_8);
        mdb__interactive_query__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
        mdb__interactive_query__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
        mdb__interactive_query__Var_57 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
        mdb__interactive_query__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
        mdb__interactive_query__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
        mdb__interactive_query__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
        mercury__io__nl_3_p_0(mdb__interactive_query__Var_39);
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word mdb__interactive_query__Var_109;
        MR_Word mdb__interactive_query__Var_113;
        MR_Word mdb__interactive_query__Var_110;
        MR_Word mdb__interactive_query__Var_111;
        MR_String mdb__interactive_query__Var_112;
        MR_Word mdb__interactive_query__Var_114;

        mdb__interactive_query__parse_query_command_2_p_0(mdb__interactive_query__Term_11, &mdb__interactive_query__Cmd_12);
        mdb__interactive_query__Var_114 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
        mdb__interactive_query__Var_113 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
        mdb__interactive_query__Var_112 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
        mdb__interactive_query__Var_111 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
        mdb__interactive_query__Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
        mdb__interactive_query__Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
        switch (MR_tag((MR_Word) mdb__interactive_query__Cmd_12)) {
          ...
          case (MR_Integer) 0:
            switch (MR_unmkbody(mdb__interactive_query__Cmd_12)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                mercury__io__nl_3_p_0(mdb__interactive_query__Var_109);
                break;
              case (MR_Integer) 1:
                {
                  mercury__io__flush_output_3_p_0(mdb__interactive_query__Var_109);
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word mdb__interactive_query__Var_30;
              MR_Word mdb__interactive_query__Var_32;
              MR_Word mdb__interactive_query__Var_70;
              MR_Word mdb__interactive_query__Var_71;
              MR_String mdb__interactive_query__Var_72;
              MR_Word mdb__interactive_query__Var_73;
              MR_Word mdb__interactive_query__Var_74;
              MR_Word mdb__interactive_query__Var_75;
              MR_Word mdb__interactive_query__Var_76;
              MR_String mdb__interactive_query__Var_77;
              MR_Word mdb__interactive_query__Var_78;
              MR_Word mdb__interactive_query__Var_79;
              MR_Word mdb__interactive_query__Var_80;
              MR_Word mdb__interactive_query__Var_81;
              MR_Word mdb__interactive_query__Var_83;
              MR_Word mdb__interactive_query__Var_84;
              MR_Word mdb__interactive_query__Var_85;
              MR_String mdb__interactive_query__Var_82;

              mercury__io__print_4_p_0(mdb__interactive_query__TypeCtorInfo_107_107, mdb__interactive_query__Var_109, ((MR_Box) ((MR_String) "Compilation options: ")));
              mdb__interactive_query__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
              mdb__interactive_query__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
              mdb__interactive_query__Var_72 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
              mdb__interactive_query__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
              mdb__interactive_query__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
              mdb__interactive_query__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
              mercury__io__print_4_p_0(mdb__interactive_query__TypeCtorInfo_107_107, mdb__interactive_query__Var_30, ((MR_Box) (mdb__interactive_query__NewOptions_13)));
              mdb__interactive_query__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
              mdb__interactive_query__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
              mdb__interactive_query__Var_77 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
              mdb__interactive_query__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
              mdb__interactive_query__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
              mdb__interactive_query__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
              mercury__io__nl_3_p_0(mdb__interactive_query__Var_32);
              mdb__interactive_query__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
              mdb__interactive_query__Var_81 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
              mdb__interactive_query__Var_82 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
              mdb__interactive_query__Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
              mdb__interactive_query__Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
              mdb__interactive_query__Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
              {
                mdb__interactive_query__Env1_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 0) = ((MR_Box) (mdb__interactive_query__Var_80));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 1) = ((MR_Box) (mdb__interactive_query__Var_81));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 2) = ((MR_Box) (mdb__interactive_query__NewOptions_13));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 3) = ((MR_Box) (mdb__interactive_query__Var_83));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 4) = ((MR_Box) (mdb__interactive_query__Var_84));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_14, 5) = ((MR_Box) (mdb__interactive_query__Var_85));
              }
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word mdb__interactive_query__Var_96;
              MR_Word mdb__interactive_query__Var_91;
              MR_String mdb__interactive_query__Var_93;
              MR_Word mdb__interactive_query__Var_94;
              MR_Word mdb__interactive_query__Var_95;
              MR_Word mdb__interactive_query__Var_92;

              mdb__interactive_query__Imports_16 = mercury__list__f_43_43_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__interactive_query__Var_113, mdb__interactive_query__AddedImports_15);
              mdb__interactive_query__Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 0)));
              mdb__interactive_query__Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 1)));
              mdb__interactive_query__Var_93 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 2)));
              mdb__interactive_query__Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 3)));
              mdb__interactive_query__Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 4)));
              mdb__interactive_query__Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_5, (MR_Integer) 5)));
              {
                mdb__interactive_query__Env1_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 0) = ((MR_Box) (mdb__interactive_query__Var_91));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 1) = ((MR_Box) (mdb__interactive_query__Imports_16));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 2) = ((MR_Box) (mdb__interactive_query__Var_93));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 3) = ((MR_Box) (mdb__interactive_query__Var_94));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 4) = ((MR_Box) (mdb__interactive_query__Var_95));
                MR_hl_field(MR_mktag(0), mdb__interactive_query__Env1_44, 5) = ((MR_Box) (mdb__interactive_query__Var_96));
              }
              mdb__interactive_query__write_import_list_4_p_0(mdb__interactive_query__Var_96, mdb__interactive_query__Imports_16);
  ...
  MR_Word mdb__interactive_query__Env_4)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      MR_Word mdb__interactive_query__Result_7;
      MR_Word mdb__interactive_query__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
      MR_Word mdb__interactive_query__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
      MR_String mdb__interactive_query__Var_29 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
      MR_Word mdb__interactive_query__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));

      switch (mdb__interactive_query__Var_15) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
      ...
      mdb__util__trace_getline_6_p_0(mdb__interactive_query__Prompt_6, &mdb__interactive_query__Result_7, mdb__interactive_query__Var_31, mdb__interactive_query__Var_32);
      switch (MR_tag((MR_Word) mdb__interactive_query__Result_7)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word mdb__interactive_query__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
            MR_Word mdb__interactive_query__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
            MR_Word mdb__interactive_query__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
            MR_String mdb__interactive_query__Var_45 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
            MR_Word mdb__interactive_query__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
            MR_Word mdb__interactive_query__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));

            mercury__io__nl_3_p_0(mdb__interactive_query__Var_26);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            mercury__parser__read_term_from_string_4_p_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, (MR_String) "", mdb__interactive_query__Line_10, &mdb__interactive_query__Var_11, &mdb__interactive_query__ReadTerm_12);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word mdb__interactive_query__Var_21;
            MR_Word mdb__interactive_query__Var_23;
            MR_Word mdb__interactive_query__Var_48;
            MR_Word mdb__interactive_query__Var_49;
            MR_String mdb__interactive_query__Var_50;
            MR_Word mdb__interactive_query__Var_51;
            MR_Word mdb__interactive_query__Var_52;
            MR_Word mdb__interactive_query__Var_53;
            MR_Word mdb__interactive_query__Var_54;
            MR_String mdb__interactive_query__Var_55;
            MR_Word mdb__interactive_query__Var_56;
            MR_Word mdb__interactive_query__Var_57;

            mercury__io__error_message_2_p_0(mdb__interactive_query__Error_8, &mdb__interactive_query__Msg_9);
            mdb__interactive_query__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
            mdb__interactive_query__Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
            mdb__interactive_query__Var_50 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
            mdb__interactive_query__Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
            mdb__interactive_query__Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
            mdb__interactive_query__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
            mercury__io__write_string_4_p_0(mdb__interactive_query__Var_21, mdb__interactive_query__Msg_9);
            mdb__interactive_query__Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 0)));
            mdb__interactive_query__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 1)));
            mdb__interactive_query__Var_55 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 2)));
            mdb__interactive_query__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 3)));
            mdb__interactive_query__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 4)));
            mdb__interactive_query__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_4, (MR_Integer) 5)));
            mercury__io__nl_3_p_0(mdb__interactive_query__Var_23);
            /* direct tailcall eliminated */
            continue;
          }
          break;
...
{
  {
    ...
    else
    {
      ...
      MR_String mdb__interactive_query__Var_27;
      ...
      MR_Word mdb__interactive_query__Var_63;
      MR_Word mdb__interactive_query__Var_78;
      MR_Word mdb__interactive_query__Var_66;
      MR_String mdb__interactive_query__Var_67;
      MR_Word mdb__interactive_query__Var_68;
      MR_Word mdb__interactive_query__Var_69;
      MR_Word mdb__interactive_query__Var_70;
      MR_Word mdb__interactive_query__Var_71;
      MR_Word mdb__interactive_query__Var_72;
      MR_String mdb__interactive_query__Var_73;
      MR_Word mdb__interactive_query__Var_74;
      MR_Word mdb__interactive_query__Var_75;
      MR_Word mdb__interactive_query__Var_76;
      MR_String mdb__interactive_query__Var_77;
      MR_Word mdb__interactive_query__Var_79;
      MR_Word mdb__interactive_query__Var_80;
      MR_Word mdb__interactive_query__Var_34;
      MR_Word mdb__interactive_query__Var_35;
      MR_Word mdb__interactive_query__Var_36;
      MR_Word mdb__interactive_query__Var_37;
      MR_Word mdb__interactive_query__Var_38;
      ...
      mdb__interactive_query__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 1)));
      mdb__interactive_query__Var_67 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 2)));
      mdb__interactive_query__Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 3)));
      mdb__interactive_query__Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 4)));
      mdb__interactive_query__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 5)));
      ...
      {
        mdb__interactive_query__Var_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_56, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_5[2]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_56, 1) = ((MR_Box) (mdb__interactive_query__run_query_5_p_0_1));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_56, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_56, 3) = ((MR_Box) (mdb__interactive_query__Varset_8));
      }
      mdb__interactive_query__TypeCtorInfo_52_91 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      mercury__list__filter_map_3_p_0(mdb__interactive_query__TypeInfo_48_87, mdb__interactive_query__TypeCtorInfo_52_91, mdb__interactive_query__Var_56, mdb__interactive_query__Vars1_50, &mdb__interactive_query__Vars_51);
      mdb__interactive_query__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 0)));
      mdb__interactive_query__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 1)));
      mdb__interactive_query__Var_73 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 2)));
      mdb__interactive_query__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 3)));
      mdb__interactive_query__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 4)));
      mdb__interactive_query__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 5)));
      {
        mdb__interactive_query__Var_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_57, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_3[3]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_57, 1) = ((MR_Box) (mdb__interactive_query__run_query_5_p_0_2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_57, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_57, 3) = ((MR_Box) (mdb__interactive_query__Var_58));
      }
      mercury__list__filter_4_p_0(mdb__interactive_query__TypeCtorInfo_52_91, mdb__interactive_query__Var_57, mdb__interactive_query__Vars_51, &mdb__interactive_query__Inputs_52, &mdb__interactive_query__Outputs0_53);
      switch (mdb__interactive_query__QueryType_48) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
        case (MR_Integer) 0:
          {
            mercury__list__filter_3_p_0(mdb__interactive_query__TypeCtorInfo_52_91, (MR_Word) &mdb__interactive_query_scalar_common_2[8], mdb__interactive_query__Outputs0_53, &mdb__interactive_query__Outputs_55);
          }
          break;
        case (MR_Integer) 2:
      ...
      mdb__interactive_query__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 0)));
      mdb__interactive_query__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 1)));
      mdb__interactive_query__Var_77 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 2)));
      mdb__interactive_query__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 3)));
      mdb__interactive_query__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 4)));
      mdb__interactive_query__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 5)));
      {
        ...
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_13, 1) = ((MR_Box) (mdb__interactive_query__Var_63));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_13, 2) = ((MR_Box) (mdb__interactive_query__Var_78));
      ...
      mdb__interactive_query__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 0)));
      mdb__interactive_query__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 1)));
      mdb__interactive_query__Var_27 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 2)));
      mdb__interactive_query__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 3)));
      mdb__interactive_query__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 4)));
      mdb__interactive_query__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Env_6, (MR_Integer) 5)));
      mdb__interactive_query__compile_file_4_p_0(mdb__interactive_query__Var_27, &mdb__interactive_query__Succeeded_14);
...
{
  {
    MR_Word mdb__interactive_query__Var_50;
    MR_Word mdb__interactive_query__Var_60;
    MR_Word mdb__interactive_query__Var_70;
    MR_Word mdb__interactive_query__Var_80;
    MR_Word mdb__interactive_query__Var_90;

    mercury__io__remove_file_4_p_0((MR_String) "mdb_query.m", &mdb__interactive_query__Var_50);
    mercury__io__remove_file_4_p_0((MR_String) "mdb_query.mh", &mdb__interactive_query__Var_60);
    mercury__io__remove_file_4_p_0((MR_String) "mdb_query.d", &mdb__interactive_query__Var_70);
    mercury__io__remove_file_4_p_0((MR_String) "Mercury/ds/mdb_query.d", &mdb__interactive_query__Var_80);
    mercury__io__remove_file_4_p_0((MR_String) "mdb_query.c", &mdb__interactive_query__Var_90);
  ...
  MR_String mdb__interactive_query__Suffix_6)
{
  {
    MR_String mdb__interactive_query__Var_11;
    MR_String mdb__interactive_query__Var_13;
    MR_Word mdb__interactive_query__Var_8;

    mdb__interactive_query__Var_13 = mercury__string__f_43_43_2_f_0((MR_String) "mdb_query", mdb__interactive_query__Suffix_6);
    mdb__interactive_query__Var_11 = mercury__string__f_43_43_2_f_0(mdb__interactive_query__Prefix_5, mdb__interactive_query__Var_13);
    mercury__io__remove_file_4_p_0(mdb__interactive_query__Var_11, &mdb__interactive_query__Var_8);
  }
}
...
{
  {
    ...
    MR_String mdb__interactive_query__Var_18;
    MR_String mdb__interactive_query__Var_20;
...
mdb__interactive_query__succeeded  = SUCCESS_INDICATOR;
    ...
    if (mdb__interactive_query__succeeded)
      mdb__interactive_query__Var_20 = (MR_String) ".dylib";
    else
      mdb__interactive_query__Var_20 = (MR_String) ".so";
    mdb__interactive_query__Var_18 = mercury__string__f_43_43_2_f_0((MR_String) "mdb_query", mdb__interactive_query__Var_20);
    mdb__interactive_query__Filename_6 = mercury__string__f_43_43_2_f_0((MR_String) "./lib", mdb__interactive_query__Var_18);
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_4, (MR_Integer) 1)));
      MR_Word mdb__interactive_query__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_4, (MR_Integer) 3)));
      MR_Word mdb__interactive_query__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_4, (MR_Integer) 5)));
      MR_Word mdb__interactive_query__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Program_4, (MR_Integer) 6)));
...
{
  {
    ...
    mdb__dl__mercury_sym_5_p_0((MR_Word) &mdb__interactive_query_scalar_common_4[0], mdb__interactive_query__Handle_8, (MR_Word) &mdb__interactive_query_scalar_common_3[2], &mdb__interactive_query__MaybeQuery_10);
    if (((MR_tag((MR_Word) mdb__interactive_query__MaybeQuery_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_Word mdb__interactive_query__Var_24;
      MR_Word mdb__interactive_query__Var_27;

      {
        mdb__interactive_query__Var_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_27, 0) = ((MR_Box) (mdb__interactive_query__Msg_11));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_27, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[23])));
      }
      {
        mdb__interactive_query__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_24, 0) = ((MR_Box) ((MR_String) "dlsym failed: "));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_24, 1) = ((MR_Box) (mdb__interactive_query__Var_27));
      }
      mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_24);
    }
    else
    {
      ...
      {
        mdb__interactive_query__Var_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_7[1]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 1) = ((MR_Box) (mdb__interactive_query__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_108_105_110_107_95_97_110_100_95_114_117_110_95_105_111_95_95_91_50_93_95_48_5_p_0_1));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 3) = ((MR_Box) (mdb__interactive_query__QueryPred_12));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 4) = ((MR_Box) (mdb__interactive_query__Bindings_6));
      }
      mercury__exception__try_io_4_p_1((MR_Word) &mdb__interactive_query__mdb__interactive_query__type_ctor_info_solution_0, mdb__interactive_query__Var_20, &mdb__interactive_query__Result_13);
      if (((MR_tag((MR_Word) mdb__interactive_query__Result_13)) == (MR_mktag((MR_Integer) 2))))
      {
        ...
        MR_Box mdb__interactive_query__Var_22;

        mdb__interactive_query__Var_22 = mercury__univ__univ_value_1_f_0(&mdb__interactive_query__TypeInfo_36_36, mdb__interactive_query__Excp_15);
        mercury__io__write_string_3_p_0((MR_String) "*** caught exception: ");
        mercury__io__write_cc_3_p_0(mdb__interactive_query__TypeInfo_36_36, mdb__interactive_query__Var_22);
...
{
  {
    ...
    mdb__dl__mercury_sym_5_p_0((MR_Word) &mdb__interactive_query_scalar_common_3[0], mdb__interactive_query__Handle_8, (MR_Word) &mdb__interactive_query_scalar_common_3[1], &mdb__interactive_query__MaybeQuery_10);
    if (((MR_tag((MR_Word) mdb__interactive_query__MaybeQuery_10)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String mdb__interactive_query__Msg_11 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__MaybeQuery_10, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__Var_27;
      ...
      {
        mdb__interactive_query__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 0) = ((MR_Box) (mdb__interactive_query__Msg_11));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[23])));
      }
      {
        mdb__interactive_query__Var_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_27, 0) = ((MR_Box) ((MR_String) "dlsym failed: "));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_27, 1) = ((MR_Box) (mdb__interactive_query__Var_30));
      }
      mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_27);
    }
    else
    {
      MR_Word mdb__interactive_query__QueryPred_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__MaybeQuery_10, (MR_Integer) 0)));
      ...
      {
        mdb__interactive_query__Var_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 1) = ((MR_Box) (mdb__interactive_query__link_and_run_cc_5_p_0_1));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 3) = ((MR_Box) (mdb__interactive_query__QueryPred_12));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 4) = ((MR_Box) (mdb__interactive_query__Bindings_6));
      }
      mercury__exception__try_2_p_3((MR_Word) &mdb__interactive_query__mdb__interactive_query__type_ctor_info_solution_0, mdb__interactive_query__Var_20, &mdb__interactive_query__Result_13);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word mdb__interactive_query__Excp_15 = ((MR_Word) (MR_hl_field(MR_mktag(2), mdb__interactive_query__Result_13, (MR_Integer) 0)));
            MR_Box mdb__interactive_query__Var_21;

            mdb__interactive_query__Var_21 = mercury__univ__univ_value_1_f_0(&mdb__interactive_query__TypeInfo_37_37, mdb__interactive_query__Excp_15);
            mercury__io__write_string_3_p_0((MR_String) "*** caught exception: ");
            mercury__io__write_cc_3_p_0(mdb__interactive_query__TypeInfo_37_37, mdb__interactive_query__Var_21);
            mercury__io__nl_2_p_0();
          }
          break;
      }
  ...
  MR_Word mdb__interactive_query__Solution_8)
{
  ...
  else
  {
    ...
    {
      mdb__interactive_query__Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_13, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_13, 1) = ((MR_Box) (mdb__interactive_query__write_solution_5_p_0_1));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_13, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_13, 3) = ((MR_Box) (mdb__interactive_query__Bindings_10));
    }
    mercury__list__foldl_4_p_10((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &mercury__io__io__type_ctor_info_state_0, mdb__interactive_query__Var_13, mdb__interactive_query__Outputs_6, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv0_STATE_VARIABLE_IO_14_14);
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__interactive_query__MaybeQuery_10)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String mdb__interactive_query__Msg_11 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__interactive_query__MaybeQuery_10, (MR_Integer) 0)));
      MR_Word mdb__interactive_query__Var_30;
      MR_Word mdb__interactive_query__Var_33;

      {
        mdb__interactive_query__Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_33, 0) = ((MR_Box) (mdb__interactive_query__Msg_11));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_33, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[23])));
      }
      {
        mdb__interactive_query__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 0) = ((MR_Box) ((MR_String) "dlsym failed: "));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 1) = ((MR_Box) (mdb__interactive_query__Var_33));
      }
      mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_30);
    }
    else
    {
...

      {
        mdb__interactive_query__Var_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 1) = ((MR_Box) (mdb__interactive_query__link_and_run_normal_5_p_0_2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 3) = ((MR_Box) (mdb__interactive_query__QueryPred_12));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_20, 4) = ((MR_Box) (mdb__interactive_query__Bindings_6));
      }
      ...
      mercury__exception__try_all_3_p_3(mdb__interactive_query__TypeCtorInfo_39_39, mdb__interactive_query__Var_20, &mdb__interactive_query__MaybeExcp_13, &mdb__interactive_query__Solutions_14);
      {
        mdb__interactive_query__Var_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_21, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_7[0]));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_21, 1) = ((MR_Box) (mdb__interactive_query__link_and_run_normal_5_p_0_3));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_21, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_21, 3) = ((MR_Box) (mdb__interactive_query__Outputs_7));
        MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_21, 4) = ((MR_Box) ((MR_String) "true ;"));
      }
      mercury__list__foldl_4_p_10(mdb__interactive_query__TypeCtorInfo_39_39, (MR_Word) &mercury__io__io__type_ctor_info_state_0, mdb__interactive_query__Var_21, mdb__interactive_query__Solutions_14, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv1_STATE_VARIABLE_IO_22_22);
      ...
      else
      {
        ...
        MR_Box mdb__interactive_query__Var_26;

        mdb__interactive_query__Var_26 = mercury__univ__univ_value_1_f_0(&mdb__interactive_query__TypeInfo_44_44, mdb__interactive_query__Excp_15);
        mercury__io__write_string_3_p_0((MR_String) "*** caught exception: ");
        mercury__io__write_cc_3_p_0(mdb__interactive_query__TypeInfo_44_44, mdb__interactive_query__Var_26);
        mercury__io__nl_2_p_0();
      }
...
{
  {
    ...
    MR_Word mdb__interactive_query__Var_11;
    MR_Word mdb__interactive_query__Var_13;
    MR_Word mdb__interactive_query__Var_15;
    MR_Word mdb__interactive_query__Var_17;
    MR_Word mdb__interactive_query__Var_19;
    MR_Word mdb__interactive_query__Var_20;
    MR_Word mdb__interactive_query__Var_22;
    MR_String mdb__interactive_query__Var_23;
...
#define MR_PROC_LABEL mdb__interactive_query__compile_file_4_p_0
    ...
    MR_make_aligned_string(GradeOpt, (MR_String) MR_GRADE_OPT);
		...
		;}
#undef MR_PROC_LABEL
	 mdb__interactive_query__Var_23  = GradeOpt;
}
    {
      mdb__interactive_query__Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_22, 0) = ((MR_Box) (mdb__interactive_query__Var_23));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[25])));
    }
    {
      mdb__interactive_query__Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_20, 0) = ((MR_Box) ((MR_String) " --grade "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_20, 1) = ((MR_Box) (mdb__interactive_query__Var_22));
    }
    {
      mdb__interactive_query__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_19, 0) = ((MR_Box) (mdb__interactive_query__Options_5));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_19, 1) = ((MR_Box) (mdb__interactive_query__Var_20));
    }
    {
      mdb__interactive_query__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_17, 0) = ((MR_Box) ((MR_String) "--allow-undefined "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_17, 1) = ((MR_Box) (mdb__interactive_query__Var_19));
    }
    {
      mdb__interactive_query__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_15, 0) = ((MR_Box) ((MR_String) "--output-compile-error-lines 10000 "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_15, 1) = ((MR_Box) (mdb__interactive_query__Var_17));
    }
    {
      mdb__interactive_query__Var_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_13, 0) = ((MR_Box) ((MR_String) "--no-warn-simple-code --no-warn-det-decls-too-lax "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_13, 1) = ((MR_Box) (mdb__interactive_query__Var_15));
    }
    {
      mdb__interactive_query__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_11, 0) = ((MR_Box) ((MR_String) "mmc --infer-all --no-verbose-make -O0 --no-c-optimize "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_11, 1) = ((MR_Box) (mdb__interactive_query__Var_13));
    }
    mercury__string__append_list_2_p_0(mdb__interactive_query__Var_11, &mdb__interactive_query__Command_8);
...
{
  {
    ...
    MR_Word mdb__interactive_query__Var_10;
    ...
    if (((MR_tag((MR_Word) mdb__interactive_query__Result_23)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_Word mdb__interactive_query__Var_37;
      MR_Word mdb__interactive_query__Var_38;
      MR_Word mdb__interactive_query__Var_40;
      ...
      {
        mdb__interactive_query__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_40, 0) = ((MR_Box) (mdb__interactive_query__ErrorMessage_27));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[23])));
      }
      {
        mdb__interactive_query__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_38, 0) = ((MR_Box) ((MR_String) "\' for output:\n\t"));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_38, 1) = ((MR_Box) (mdb__interactive_query__Var_40));
      }
      {
        mdb__interactive_query__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_37, 0) = ((MR_Box) (mdb__interactive_query__FileName_6));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_37, 1) = ((MR_Box) (mdb__interactive_query__Var_38));
      }
      {
        mdb__interactive_query__Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_35, 0) = ((MR_Box) ((MR_String) "error opening file \140"));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_35, 1) = ((MR_Box) (mdb__interactive_query__Var_37));
      }
      {
        mdb__interactive_query__Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_33, 0) = ((MR_Box) ((MR_String) ": "));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_33, 1) = ((MR_Box) (mdb__interactive_query__Var_35));
      }
      {
        mdb__interactive_query__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_32, 0) = ((MR_Box) (mdb__interactive_query__Progname_26));
        MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_32, 1) = ((MR_Box) (mdb__interactive_query__Var_33));
      }
      mercury__string__append_list_2_p_0(mdb__interactive_query__Var_32, &mdb__interactive_query__Message_28);
    ...
    mercury__io__set_output_stream_4_p_0(mdb__interactive_query__OldStream_9, &mdb__interactive_query__Var_10);
...
{
  {
    ...
    MR_Word mdb__interactive_query__Var_26;
    MR_String mdb__interactive_query__Var_27;
    MR_Word mdb__interactive_query__Var_28;
    MR_Word mdb__interactive_query__Var_30;
    MR_Word mdb__interactive_query__Var_32;
    MR_Word mdb__interactive_query__Var_34;
    MR_Word mdb__interactive_query__Var_36;
    MR_Word mdb__interactive_query__Var_38;
    MR_String mdb__interactive_query__Var_39;
    MR_Word mdb__interactive_query__Var_40;
    MR_Word mdb__interactive_query__Var_42;
    MR_String mdb__interactive_query__Var_43;
    MR_Word mdb__interactive_query__Var_44;
    MR_Word mdb__interactive_query__Var_46;
    MR_Word mdb__interactive_query__Var_48;
    MR_Word mdb__interactive_query__Var_50;
    MR_Word mdb__interactive_query__Var_52;
    MR_Word mdb__interactive_query__Var_54;
    ...
    MR_Word mdb__interactive_query__Var_68;
    MR_Word mdb__interactive_query__Var_70;
    MR_String mdb__interactive_query__Var_71;
    MR_Word mdb__interactive_query__Var_78;
    MR_String mdb__interactive_query__Var_80;
    MR_Word mdb__interactive_query__Var_127;
    MR_String mdb__interactive_query__Var_129;
    MR_Word mdb__interactive_query__Var_130;
    MR_Word mdb__interactive_query__Var_132;
    MR_String mdb__interactive_query__Var_133;
    MR_Word mdb__interactive_query__Var_144;
    MR_Word mdb__interactive_query__Var_147;
    MR_String mdb__interactive_query__Var_148;
    ...
    mdb__interactive_query__Var_27 = mdb__interactive_query__query_type_extra_imports_1_f_0(mdb__interactive_query__QueryType_6);
    mdb__interactive_query__Var_39 = mdb__interactive_query__query_type_extra_decls_1_f_0(mdb__interactive_query__QueryType_6);
    mdb__interactive_query__Var_43 = mdb__interactive_query__query_type_detism_1_f_0(mdb__interactive_query__QueryType_6);
    mdb__interactive_query__Var_55 = mdb__interactive_query__query_type_extra_args_1_f_0(mdb__interactive_query__QueryType_6);
    {
      mdb__interactive_query__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_54, 0) = ((MR_Box) (mdb__interactive_query__Var_55));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[5])));
    }
    {
      mdb__interactive_query__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_52, 0) = ((MR_Box) ((MR_String) "run(!Bindings, Loaded"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_52, 1) = ((MR_Box) (mdb__interactive_query__Var_54));
    }
    {
      mdb__interactive_query__Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_50, 0) = ((MR_Box) ((MR_String) "\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_50, 1) = ((MR_Box) (mdb__interactive_query__Var_52));
    }
    {
      mdb__interactive_query__Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_48, 0) = ((MR_Box) ((MR_String) ":- implementation.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_48, 1) = ((MR_Box) (mdb__interactive_query__Var_50));
    }
    {
      mdb__interactive_query__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_46, 0) = ((MR_Box) ((MR_String) "\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_46, 1) = ((MR_Box) (mdb__interactive_query__Var_48));
    }
    {
      mdb__interactive_query__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_44, 0) = ((MR_Box) ((MR_String) ".\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_44, 1) = ((MR_Box) (mdb__interactive_query__Var_46));
    }
    {
      mdb__interactive_query__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_42, 0) = ((MR_Box) (mdb__interactive_query__Var_43));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_42, 1) = ((MR_Box) (mdb__interactive_query__Var_44));
    }
    {
      mdb__interactive_query__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_40, 0) = ((MR_Box) ((MR_String) ") is "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_40, 1) = ((MR_Box) (mdb__interactive_query__Var_42));
    }
    {
      mdb__interactive_query__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_38, 0) = ((MR_Box) (mdb__interactive_query__Var_39));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_38, 1) = ((MR_Box) (mdb__interactive_query__Var_40));
    }
    {
      mdb__interactive_query__Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_36, 0) = ((MR_Box) ((MR_String) "   bool::out"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_36, 1) = ((MR_Box) (mdb__interactive_query__Var_38));
    }
    {
      mdb__interactive_query__Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_34, 0) = ((MR_Box) ((MR_String) ":- pred run(map(string, univ)::in, map(string, univ)::out,\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_34, 1) = ((MR_Box) (mdb__interactive_query__Var_36));
    }
    {
      mdb__interactive_query__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_32, 0) = ((MR_Box) ((MR_String) "\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_32, 1) = ((MR_Box) (mdb__interactive_query__Var_34));
    }
    {
      mdb__interactive_query__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 0) = ((MR_Box) ((MR_String) ":- import_module univ.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_30, 1) = ((MR_Box) (mdb__interactive_query__Var_32));
    }
    {
      mdb__interactive_query__Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_28, 0) = ((MR_Box) ((MR_String) ":- import_module map.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_28, 1) = ((MR_Box) (mdb__interactive_query__Var_30));
    }
    {
      mdb__interactive_query__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_26, 0) = ((MR_Box) (mdb__interactive_query__Var_27));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_26, 1) = ((MR_Box) (mdb__interactive_query__Var_28));
    }
    {
      mdb__interactive_query__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_24, 0) = ((MR_Box) ((MR_String) ":- import_module bool.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_24, 1) = ((MR_Box) (mdb__interactive_query__Var_26));
    }
    {
      mdb__interactive_query__Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_22, 0) = ((MR_Box) ((MR_String) "\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_22, 1) = ((MR_Box) (mdb__interactive_query__Var_24));
    }
    {
      mdb__interactive_query__Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_20, 0) = ((MR_Box) ((MR_String) ":- interface.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_20, 1) = ((MR_Box) (mdb__interactive_query__Var_22));
    }
    {
      mdb__interactive_query__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_17, 0) = ((MR_Box) ((MR_String) ":- module mdb_query.\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_17, 1) = ((MR_Box) (mdb__interactive_query__Var_20));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_17);
    ...
    mercury__list__foldl_4_p_2(mdb__interactive_query__TypeCtorInfo_163_163, mdb__interactive_query__TypeCtorInfo_164_164, (MR_Word) &mdb__interactive_query_scalar_common_2[3], mdb__interactive_query__Inputs_9, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv0_STATE_VARIABLE_IO_62_62);
    mdb__interactive_query__Var_71 = mdb__interactive_query__query_module_name_0_f_0();
    {
      mdb__interactive_query__Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_70, 0) = ((MR_Box) (mdb__interactive_query__Var_71));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[21])));
    }
    {
      mdb__interactive_query__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_68, 0) = ((MR_Box) ((MR_String) "       "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_68, 1) = ((MR_Box) (mdb__interactive_query__Var_70));
    }
    {
      mdb__interactive_query__Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_66, 0) = ((MR_Box) ((MR_String) "   then\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_66, 1) = ((MR_Box) (mdb__interactive_query__Var_68));
    }
    {
      mdb__interactive_query__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_63, 0) = ((MR_Box) ((MR_String) "       true\n"));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_63, 1) = ((MR_Box) (mdb__interactive_query__Var_66));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_63);
    mdb__interactive_query__write_args_3_p_0(mdb__interactive_query__Inputs_9);
    mercury__list__foldl_4_p_2(mdb__interactive_query__TypeCtorInfo_163_163, mdb__interactive_query__TypeCtorInfo_164_164, (MR_Word) &mdb__interactive_query_scalar_common_2[4], mdb__interactive_query__Outputs_10, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv1_STATE_VARIABLE_IO_77_77);
    mdb__interactive_query__Var_80 = mdb__interactive_query__query_type_extra_args_1_f_0(mdb__interactive_query__QueryType_6);
    {
      mdb__interactive_query__Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_78, 0) = ((MR_Box) (mdb__interactive_query__Var_80));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_78, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[22])));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_78);
    mercury__list__foldl_4_p_2(mdb__interactive_query__TypeCtorInfo_163_163, mdb__interactive_query__TypeCtorInfo_164_164, (MR_Word) &mdb__interactive_query_scalar_common_2[5], mdb__interactive_query__Outputs_10, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv2_STATE_VARIABLE_IO_85_85);
    ...
    mercury__list__foldl_4_p_2(mdb__interactive_query__TypeCtorInfo_163_163, mdb__interactive_query__TypeCtorInfo_164_164, (MR_Word) &mdb__interactive_query_scalar_common_2[6], mdb__interactive_query__Outputs_10, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv3_STATE_VARIABLE_IO_120_120);
    mdb__interactive_query__Var_129 = mdb__interactive_query__query_type_extra_modes_1_f_0(mdb__interactive_query__QueryType_6);
    mdb__interactive_query__Var_133 = mdb__interactive_query__query_type_detism_1_f_0(mdb__interactive_query__QueryType_6);
    {
      mdb__interactive_query__Var_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_132, 0) = ((MR_Box) (mdb__interactive_query__Var_133));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_132, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__interactive_query_scalar_common_1[20])));
    }
    {
      mdb__interactive_query__Var_130 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_130, 0) = ((MR_Box) ((MR_String) ") is "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_130, 1) = ((MR_Box) (mdb__interactive_query__Var_132));
    }
    {
      mdb__interactive_query__Var_127 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_127, 0) = ((MR_Box) (mdb__interactive_query__Var_129));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_127, 1) = ((MR_Box) (mdb__interactive_query__Var_130));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_127);
    mdb__interactive_query__write_args_3_p_0(mdb__interactive_query__Inputs_9);
    mercury__list__foldl_4_p_2(mdb__interactive_query__TypeCtorInfo_163_163, mdb__interactive_query__TypeCtorInfo_164_164, (MR_Word) &mdb__interactive_query_scalar_common_2[7], mdb__interactive_query__Outputs_10, ((MR_Box) ((MR_Integer) 0)), &mdb__interactive_query__conv4_STATE_VARIABLE_IO_143_143);
    mdb__interactive_query__Var_148 = mdb__interactive_query__query_type_rule_1_f_0(mdb__interactive_query__QueryType_6);
    {
      mdb__interactive_query__Var_147 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_147, 0) = ((MR_Box) (mdb__interactive_query__Var_148));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_147, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      mdb__interactive_query__Var_144 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_144, 0) = ((MR_Box) ((MR_String) ") "));
      MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_144, 1) = ((MR_Box) (mdb__interactive_query__Var_147));
    }
    mercury__io__write_strings_3_p_0(mdb__interactive_query__Var_144);
  ...
  MR_Word mdb__interactive_query__Imports_6)
{
  if (!((mdb__interactive_query__Imports_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
  {
    ...
    mercury__io__write_list_6_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__interactive_query__Out_5, mdb__interactive_query__Imports_6, (MR_String) ", ", (MR_Word) &mdb__interactive_query_scalar_common_2[2]);
  ...
  MR_Word mdb__interactive_query__Vars_4)
{
  ...
  {
    mercury__io__write_string_3_p_0((MR_String) "(");
    mercury__io__write_list_5_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__interactive_query__Vars_4, (MR_String) ", ", (MR_Word) &mdb__interactive_query_scalar_common_2[1]);
    mercury__io__write_string_3_p_0((MR_String) ")");
  }
}
  ...
  MR_Word mdb__interactive_query__Vars_6)
{
  if (!((mdb__interactive_query__Vars_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "(");
    {
      mdb__interactive_query__Var_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, 1) = ((MR_Box) (mdb__interactive_query__write_arg_types_4_p_0_1));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, 3) = ((MR_Box) (mdb__interactive_query__Bindings_5));
    }
    mercury__io__write_list_5_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__interactive_query__Vars_6, (MR_String) ", ", mdb__interactive_query__Var_15);
    mercury__io__write_string_3_p_0((MR_String) ")");
  }
}
...
{
  {
    ...
    MR_Word mdb__interactive_query__Var_11;
    MR_String mdb__interactive_query__Var_12;
    MR_Word mdb__interactive_query__Var_13;
    MR_Word mdb__interactive_query__Var_5;

    if (mdb__interactive_query__succeeded)
    {
      mdb__interactive_query__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 0)));
      mdb__interactive_query__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 1)));
      mdb__interactive_query__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 2)));
      mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_11)) == (MR_mktag((MR_Integer) 0)));
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__Var_12 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_11, (MR_Integer) 0)));
        mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__Var_12, (MR_String) "quit") == 0);
        if (mdb__interactive_query__succeeded)
          mdb__interactive_query__succeeded = (mdb__interactive_query__Var_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    if (mdb__interactive_query__succeeded)
    ...
    else
    {
      ...
      MR_Word mdb__interactive_query__Var_14;
      MR_String mdb__interactive_query__Var_15;
      MR_Word mdb__interactive_query__Var_16;
      MR_Word mdb__interactive_query__Var_17;
      MR_Word mdb__interactive_query__Var_18;
      MR_Word mdb__interactive_query__Var_19;
      MR_Word mdb__interactive_query__Var_7;
      MR_Word mdb__interactive_query__Var_9;

      mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Term_3)) == (MR_mktag((MR_Integer) 0)));
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 0)));
        mdb__interactive_query__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 1)));
        mdb__interactive_query__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Term_3, (MR_Integer) 2)));
        mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_14)) == (MR_mktag((MR_Integer) 0)));
        if (mdb__interactive_query__succeeded)
        {
          mdb__interactive_query__Var_15 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_14, (MR_Integer) 0)));
          mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__Var_15, (MR_String) "options") == 0);
          if (mdb__interactive_query__succeeded)
          {
            mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_16)) == (MR_mktag((MR_Integer) 1)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__Subterm_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_16, (MR_Integer) 0)));
              mdb__interactive_query__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_16, (MR_Integer) 1)));
              mdb__interactive_query__succeeded = (mdb__interactive_query__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              if (mdb__interactive_query__succeeded)
              {
                mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Subterm_6)) == (MR_mktag((MR_Integer) 0)));
                if (mdb__interactive_query__succeeded)
                {
                  mdb__interactive_query__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Subterm_6, (MR_Integer) 0)));
                  mdb__interactive_query__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Subterm_6, (MR_Integer) 1)));
                  mdb__interactive_query__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Subterm_6, (MR_Integer) 2)));
                  mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_18)) == (MR_mktag((MR_Integer) 2)));
                  if (mdb__interactive_query__succeeded)
                  {
                    mdb__interactive_query__Options_8 = ((MR_String) (MR_hl_field(MR_mktag(2), mdb__interactive_query__Var_18, (MR_Integer) 0)));
                    mdb__interactive_query__succeeded = (mdb__interactive_query__Var_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                }
              }
            }
...
{
  {
    ...
    if (mdb__interactive_query__succeeded)
    {
      mdb__interactive_query__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 0)));
      mdb__interactive_query__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 1)));
      mdb__interactive_query__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__HeadVar__1_1, (MR_Integer) 2)));
      mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_22)) == (MR_mktag((MR_Integer) 0)));
      if (mdb__interactive_query__succeeded)
      {
        mdb__interactive_query__Var_23 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_22, (MR_Integer) 0)));
        if ((mdb__interactive_query__Var_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          mdb__interactive_query__succeeded = (strcmp(mdb__interactive_query__Var_23, (MR_String) "[]") == 0);
          if (mdb__interactive_query__succeeded)
          {
        ...
        else
        {
          ...
          if (mdb__interactive_query__succeeded)
          {
            mdb__interactive_query__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_21, (MR_Integer) 0)));
            mdb__interactive_query__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_21, (MR_Integer) 1)));
            mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_15)) == (MR_mktag((MR_Integer) 0)));
            if (mdb__interactive_query__succeeded)
            {
              mdb__interactive_query__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, (MR_Integer) 0)));
              mdb__interactive_query__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, (MR_Integer) 1)));
              mdb__interactive_query___C1_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_15, (MR_Integer) 2)));
              mdb__interactive_query__succeeded = (mdb__interactive_query__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              if (mdb__interactive_query__succeeded)
              {
                mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_16)) == (MR_mktag((MR_Integer) 0)));
                if (mdb__interactive_query__succeeded)
                {
                  mdb__interactive_query__Module_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__interactive_query__Var_16, (MR_Integer) 0)));
                  mdb__interactive_query__succeeded = ((MR_tag((MR_Word) mdb__interactive_query__Var_18)) == (MR_mktag((MR_Integer) 1)));
                  if (mdb__interactive_query__succeeded)
                  {
                    mdb__interactive_query__Rest_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_18, (MR_Integer) 0)));
                    mdb__interactive_query__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__interactive_query__Var_18, (MR_Integer) 1)));
                    mdb__interactive_query__succeeded = (mdb__interactive_query__Var_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    if (mdb__interactive_query__succeeded)
                    {
