...
MR_decl_label10(mdb__interactive_query__dynamically_load_and_run_2_0, 2,5,4,10,13,14,12,16,17,20)
MR_decl_label2(mdb__interactive_query__dynamically_load_and_run_2_0, 21,3)
...
MR_decl_label3(mdb__interactive_query__write_args_4_0, 4,6,18)
...
MR_decl_label10(mdb__interactive_query__write_prog_to_stream_3_0, 2,3,5,6,9,10,11,12,13,15)
MR_decl_label10(mdb__interactive_query__write_prog_to_stream_3_0, 16,17,18,19,20,8,24,23,27,28)
MR_decl_label10(mdb__interactive_query__write_prog_to_stream_3_0, 29,30,31,32,33,34,35,36,38,39)
MR_decl_label9(mdb__interactive_query__write_prog_to_stream_3_0, 40,41,42,43,44,45,46,47,48)
...
MR_decl_label6(__Compare___mdb__interactive_query__prog_0_0, 3,2,5,9,13,49)
...
MR_BEGIN_MODULE(mdb__interactive_query_module2)
	...
	MR_init_label3(mdb__interactive_query__write_args_4_0,4,6,18)
MR_BEGIN_CODE
...
MR_def_static(mdb__interactive_query__write_args_4_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__interactive_query__write_args_4_0_i18);
	}
	MR_incr_sp(3);
...
MR_def_label(mdb__interactive_query__write_args_4_0,4)
	...
	MR_np_call_localret_ent(io__write_list_5_0,
		mdb__interactive_query__write_args_4_0_i6);
MR_def_label(mdb__interactive_query__write_args_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const(")", 1);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(mdb__interactive_query__write_args_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__interactive_query_module4)
	...
	MR_init_label10(mdb__interactive_query__write_prog_to_stream_3_0,2,3,5,6,9,10,11,12,13,15)
	MR_init_label10(mdb__interactive_query__write_prog_to_stream_3_0,16,17,18,19,20,8,24,23,27,28)
	MR_init_label10(mdb__interactive_query__write_prog_to_stream_3_0,29,30,31,32,33,34,35,36,38,39)
	MR_init_label9(mdb__interactive_query__write_prog_to_stream_3_0,40,41,42,43,44,45,46,47,48)
MR_BEGIN_CODE
...
MR_def_label(mdb__interactive_query__write_prog_to_stream_3_0,8)
	...
	if (MR_INT_NE(MR_sv(4),2)) {
		MR_GOTO_LAB(mdb__interactive_query__write_prog_to_stream_3_0_i23);
	}
	MR_np_call_localret_ent(mdb__interactive_query__write_line_directive_2_0,
...
MR_def_label(mdb__interactive_query__write_prog_to_stream_3_0,28)
	...
	MR_r1 = (MR_Word) MR_string_const("\n            unsorted_aggregate(\n                (pred(res", 58);
	MR_np_call_localret_ent(io__write_string_3_0,
		mdb__interactive_query__write_prog_to_stream_3_0_i29);
MR_def_label(mdb__interactive_query__write_prog_to_stream_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(mdb__interactive_query__write_args_4_0,
...
;}
#line 1398 "mdb.interactive_query.c"
...
#line 523 "interactive_query.m"
    ...
    MR_make_aligned_string(GradeOpt, (MR_String) MR_GRADE_OPT);
;}
#line 1439 "mdb.interactive_query.c"
	MR_tempr1 = (MR_Word) GradeOpt;
#undef	MR_PROC_LABEL
	}
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,5,1);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(mdb__interactive_query_module8)
	...
	MR_init_label10(mdb__interactive_query__dynamically_load_and_run_2_0,2,5,4,10,13,14,12,16,17,20)
	MR_init_label2(mdb__interactive_query__dynamically_load_and_run_2_0,21,3)
MR_BEGIN_CODE
...
MR_def_label(mdb__interactive_query__dynamically_load_and_run_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(mdb__interactive_query__dynamically_load_and_run_2_0_i12);
	}
	...
	MR_np_call_localret_ent(io__print_3_0,
		mdb__interactive_query__dynamically_load_and_run_2_0_i13);
...
MR_def_label(mdb__interactive_query__dynamically_load_and_run_2_0,14)
	...
	MR_np_call_localret_ent(io__nl_2_0,
		mdb__interactive_query__dynamically_load_and_run_2_0_i16);
...
#line 645 "interactive_query.m"
    ...
    Y = X
;}
#line 1627 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	}
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_1),
		mercury__mdb__interactive_query__dynamically_load_and_run_2_0_i16);
MR_def_label(mdb__interactive_query__dynamically_load_and_run_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
...
MR_def_label(mdb__interactive_query__dynamically_load_and_run_2_0,17)
	...
	MR_np_call_localret_ent(io__print_3_0,
		mdb__interactive_query__dynamically_load_and_run_2_0_i20);
MR_def_label(mdb__interactive_query__dynamically_load_and_run_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(io__print_3_0,
...
MR_def_label(mdb__interactive_query__run_query_4_0,11)
	...
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,5,2);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(mdb__interactive_query__query_external_7_0,6)
	...
	MR_tfield(2, MR_r3, 0) = MR_tfield(1, MR_sv(4), 0);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__interactive_query, interactive_query_response);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(io__write_4_0,
...
MR_BEGIN_MODULE(mdb__interactive_query_module25)
	...
	MR_init_label6(__Compare___mdb__interactive_query__prog_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__interactive_query__prog_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__interactive_query__prog_0_0_i49);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(__Compare___mdb__interactive_query__prog_0_0,13)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___mdb__interactive_query__prog_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__mdb__interactive_query__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__interactive_query);
