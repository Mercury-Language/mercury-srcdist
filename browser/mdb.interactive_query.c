  ...
  MR_String ModuleName_6)
{
  ...
  mercury__term_io__format_quoted_atom_4_p_0((MR_Word) (&mdb__interactive_query_scalar_common_4[0]), (MR_Word) (&mdb__interactive_query_scalar_common_4[1]), ((MR_Box) (OutputStream_5)), ModuleName_6, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_12_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          mdb__dl__mercury_sym_5_p_0((MR_Word) (&mdb__interactive_query_scalar_common_4[2]), Handle_11, (MR_Word) (&mdb__interactive_query_scalar_common_4[4]), &MaybeQuery_66);
  ...
  MR_Word * Program_8)
{
  ...
  Var_19 = ((MR_Word) ((MR_hl_field(0, Env_5, (MR_Integer) 3))));
  {
    ...
    MR_hl_field(0, Var_18, 0) = ((MR_Box) (&mdb__interactive_query_scalar_common_4[3]));
