    ...
    if (((MR_tag((MR_Word) mdb__interactive_query__MaybeHandle_7)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String mdb__interactive_query__V_70_70;

        {
          mercury__io__write_string_3_p_0((MR_String) "dlopen failed: ");
        }
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_7[0], mdb__interactive_query__Msg_8, &mdb__interactive_query__V_70_70);
        }
        {
          mercury__io__write_string_3_p_0(mdb__interactive_query__V_70_70);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) "\n");
        }
    ...
    else
      {
        ...
        if ((mdb__interactive_query__Result_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mercury__string__format__format_string_component_nowidth_noprec_3_p_0((MR_Word) &mdb__interactive_query_scalar_common_7[0], mdb__interactive_query__CloseMsg_14, &mdb__interactive_query__V_59_59);
            }
            {
              mercury__io__write_string_3_p_0(mdb__interactive_query__V_59_59);
            }
            {
              mercury__io__write_string_3_p_0((MR_String) "\n");
            }
