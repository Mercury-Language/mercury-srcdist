              ...
              case (MR_Integer) 1:
                {
                  ...
                  /* direct tailcall eliminated */
                  {
                    MR_Word next_value_of_Env_4 = Env1_15;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  /* direct tailcall eliminated */
                  {
                    MR_Word next_value_of_Env_4 = Env1_48;
    ...
    case (MR_Integer) 1:
      {
        ...
        mdb__interactive_query__query_2_3_p_0(Env_5);
      }
      break;
    case (MR_Integer) 2:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              mdb__interactive_query__query_2_3_p_0(Env1_14);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              mdb__interactive_query__query_2_3_p_0(Env1_44);
            }
            break;
        }
      }
        ...
        case (MR_Integer) 1:
          {
            ...
            mdb__interactive_query__query_3_4_p_0(Env_4, ReadTerm_12);
          }
          break;
        case (MR_Integer) 2:
          {
