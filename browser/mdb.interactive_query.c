...
#undef	MR_PROC_LABEL
	...
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const("mmc --infer-all --no-verbose-make -O0 --no-c-optimize ", 54);
...
#line 638 "interactive_query.m"
    ...
    Y = X
;}
#line 1462 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 638 "interactive_query.m"
    ...
    Y = X
;}
#line 1526 "mdb.interactive_query.c"
	MR_r1 = Y;
#undef	MR_PROC_LABEL
	}
	}
