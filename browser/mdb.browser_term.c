...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word mdb__browser_term__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word mdb__browser_term__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__univ____Compare____univ_0_0(mdb__browser_term__HeadVar__1_1, mdb__browser_term__Var_28, mdb__browser_term__ArgY1_5);
            }
          }
        else
      ...
      {
        MR_Word mdb__browser_term__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mdb__browser_term__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 1)));
        MR_String mdb__browser_term__Var_31 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *mdb__browser_term__HeadVar__1_1 = (MR_Integer) 2;
        else
          {
            MR_String mdb__browser_term__ArgY1_15 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 0)));
            MR_Word mdb__browser_term__ArgY2_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 1)));
            MR_Word mdb__browser_term__ArgY3_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 2)));
            MR_Word mdb__browser_term__Var_20;

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__browser_term__Var_20, mdb__browser_term__Var_31, mdb__browser_term__ArgY1_15);
            }
            mdb__browser_term__succeeded = (mdb__browser_term__Var_20 == (MR_Integer) 0);
            mdb__browser_term__succeeded = !(mdb__browser_term__succeeded);
            if (mdb__browser_term__succeeded)
              *mdb__browser_term__HeadVar__1_1 = mdb__browser_term__Var_20;
            else
              {
                MR_Word mdb__browser_term__Var_21;

                {
                  mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[0], &mdb__browser_term__Var_21, ((MR_Box) (mdb__browser_term__Var_30)), ((MR_Box) (mdb__browser_term__ArgY2_17)));
                }
                mdb__browser_term__succeeded = (mdb__browser_term__Var_21 == (MR_Integer) 0);
                mdb__browser_term__succeeded = !(mdb__browser_term__succeeded);
                if (mdb__browser_term__succeeded)
                  *mdb__browser_term__HeadVar__1_1 = mdb__browser_term__Var_21;
                else
                  {
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[1], mdb__browser_term__HeadVar__1_1, ((MR_Box) (mdb__browser_term__Var_29)), ((MR_Box) (mdb__browser_term__ArgY3_19)));
                    }
                  }
              }
          }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word mdb__browser_term__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdb__browser_term__ArgY1_4;

        mdb__browser_term__succeeded = ((MR_tag((MR_Word) mdb__browser_term__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (mdb__browser_term__succeeded)
          {
            mdb__browser_term__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));
            {
              mdb__browser_term__succeeded = mercury__univ____Unify____univ_0_0(mdb__browser_term__ArgX1_3, mdb__browser_term__ArgY1_4);
            }
          }
      }
    else
      {
        ...
        MR_String mdb__browser_term__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mdb__browser_term__ArgY1_6;
        MR_Word mdb__browser_term__ArgX2_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__browser_term__ArgY2_8;
        MR_Word mdb__browser_term__ArgX3_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mdb__browser_term__ArgY3_10;

        mdb__browser_term__succeeded = ((MR_tag((MR_Word) mdb__browser_term__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mdb__browser_term__succeeded)
          {
            mdb__browser_term__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));
            mdb__browser_term__ArgY2_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 1)));
            mdb__browser_term__ArgY3_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 2)));
            mdb__browser_term__succeeded = (strcmp(mdb__browser_term__ArgX1_5, mdb__browser_term__ArgY1_6) == 0);
            if (mdb__browser_term__succeeded)
              {
                mdb__browser_term__TypeInfo_14_14 = (MR_Word) &mdb__browser_term_scalar_common_1[0];
                {
                  mdb__browser_term__succeeded = mercury__builtin__unify_2_p_0(mdb__browser_term__TypeInfo_14_14, ((MR_Box) (mdb__browser_term__ArgX2_7)), ((MR_Box) (mdb__browser_term__ArgY2_8)));
                }
                if (mdb__browser_term__succeeded)
                  {
                    mdb__browser_term__TypeInfo_15_15 = (MR_Word) &mdb__browser_term_scalar_common_1[1];
                    {
                      mdb__browser_term__succeeded = mercury__builtin__unify_2_p_0(mdb__browser_term__TypeInfo_15_15, ((MR_Box) (mdb__browser_term__ArgX3_9)), ((MR_Box) (mdb__browser_term__ArgY3_10)));
                    }
                  }
              }
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word mdb__browser_term__Var_11;
          ...
          {
            mdb__browser_term__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mdb__browser_term__Var_11, 0) = ((MR_Box) (mdb__browser_term__Return_10));
          }
          {
            mdb__browser_term__BrowserTerm_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mdb__browser_term__BrowserTerm_8, 0) = ((MR_Box) (mdb__browser_term__FunctorString_5));
            MR_hl_field(MR_mktag(1), mdb__browser_term__BrowserTerm_8, 1) = ((MR_Box) (mdb__browser_term__FuncArgs_9));
            MR_hl_field(MR_mktag(1), mdb__browser_term__BrowserTerm_8, 2) = ((MR_Box) (mdb__browser_term__Var_11));
          }
        }
        break;
    }
...
{
  {
    MR_bool mdb__browser_term__succeeded;
    MR_Word mdb__browser_term__HeadVar__2_2;
    MR_Word mdb__browser_term__Var_4;

    {
      mdb__browser_term__Var_4 = mercury__univ__univ_1_f_0(mdb__browser_term__TypeInfo_for_T_5, mdb__browser_term__Term_3);
    }
    {
      mdb__browser_term__HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__2_2, 0) = ((MR_Box) (mdb__browser_term__Var_4));
    }
