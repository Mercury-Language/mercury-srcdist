...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_string_3_p_0(&Var_20, Var_31, ArgY1_15);
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[0], &Var_21, ((MR_Box) (Var_30)), ((MR_Box) (ArgY2_17)));
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[1], HeadVar__1_1, ((MR_Box) (Var_29)), ((MR_Box) (ArgY3_19)));
          }
        }
      }
    }
...
{
  {
    ...
    switch (IsFunc_7) {
      ...
      case (MR_Integer) 0:
        {
          {
            BrowserTerm_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 0) = ((MR_Box) (FunctorString_5));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 1) = ((MR_Box) (Args_6));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          Return_10 = ((MR_Word) conv0_Return_10);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (Return_10));
          }
          {
            BrowserTerm_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 0) = ((MR_Box) (FunctorString_5));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 1) = ((MR_Box) (FuncArgs_9));
            MR_hl_field(MR_mktag(1), BrowserTerm_8, 2) = ((MR_Box) (Var_11));
          }
        }
        break;
    }
...
{
  {
    ...
    {
      HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), HeadVar__2_2, 0) = ((MR_Box) (Univ_3));
    }
    return HeadVar__2_2;
  }
}
