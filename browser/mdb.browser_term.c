...
#line 24 "mdb.browser_term.c"
#include "mdb.browser_term.mh"

#line 27 "mdb.browser_term.c"
#line 3 "mdb.int0"
#include "mdb.mh"

#line 31 "mdb.browser_term.c"
#line 130 "../library/io.int2"
#include "io.mh"

#line 35 "mdb.browser_term.c"
#line 136 "../library/io.int2"
#include "string.mh"

#line 39 "mdb.browser_term.c"
#line 23 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "mdb.browser_term.c"
#line 26 "../library/time.int2"
#include "time.mh"

#line 47 "mdb.browser_term.c"
#line 48 "mdb.browser_term.c"
#ifndef MDB__BROWSER_TERM_DECL_GUARD
#define MDB__BROWSER_TERM_DECL_GUARD

#line 52 "mdb.browser_term.c"
#line 53 "mdb.browser_term.c"

#endif
#line 56 "mdb.browser_term.c"
...
MR_decl_label2(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0, 12,4)
MR_decl_label4(__Unify___mdb__browser_term__browser_term_0_0, 38,8,39,1)
MR_decl_label6(__Compare___mdb__browser_term__browser_term_0_0, 5,3,49,10,14,46)
...
MR_BEGIN_MODULE(mdb__browser_term_module2)
	...
	MR_init_label2(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0,12,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__mdb__browser_term__synthetic_term_to_browser_term_3_0);
	...
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0_i12);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	...
	MR_np_call_localret_ent(list__split_last_det_3_0,
		fn__mdb__browser_term__synthetic_term_to_browser_term_3_0_i4);
MR_def_label(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(mdb__browser_term_module3)
	...
	MR_init_label4(__Unify___mdb__browser_term__browser_term_0_0,38,8,39,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__browser_term__browser_term_0_0);
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___mdb__browser_term__browser_term_0_0_i38);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Unify___mdb__browser_term__browser_term_0_0_i39);
	}
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_r2 = MR_ctfield(0, MR_r2, 0);
	MR_np_tailcall_ent(__Unify___univ__univ_0_0);
MR_def_label(__Unify___mdb__browser_term__browser_term_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___mdb__browser_term__browser_term_0_0_i8);
MR_def_label(__Unify___mdb__browser_term__browser_term_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdb__browser_term__browser_term_0_0_i1);
	}
...
MR_def_label(__Unify___mdb__browser_term__browser_term_0_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(mdb__browser_term_module4)
	...
	MR_init_label6(__Compare___mdb__browser_term__browser_term_0_0,5,3,49,10,14,46)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__browser_term__browser_term_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___mdb__browser_term__browser_term_0_0_i49);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdb__browser_term__browser_term_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdb__browser_term__browser_term_0_0_i10);
MR_def_label(__Compare___mdb__browser_term__browser_term_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__browser_term__browser_term_0_0_i46);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(univ, univ);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___mdb__browser_term__browser_term_0_0_i14);
MR_def_label(__Compare___mdb__browser_term__browser_term_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__browser_term__browser_term_0_0_i46);
	}
...
MR_def_label(__Compare___mdb__browser_term__browser_term_0_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__mdb__browser_term__write_out_proc_statics(FILE *fp);
#endif
