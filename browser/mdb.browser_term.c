    ...
    if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word mdb__browser_term__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__univ____Compare____univ_0_0(mdb__browser_term__HeadVar__1_1, mdb__browser_term__Var_28, mdb__browser_term__Var_5);
            }
          }
        else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *mdb__browser_term__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_String mdb__browser_term__Var_17 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 0)));
            MR_Word mdb__browser_term__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 1)));
            MR_Word mdb__browser_term__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__3_3, (MR_Integer) 2)));
            MR_Word mdb__browser_term__Var_20;

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__browser_term__Var_20, mdb__browser_term__Var_31, mdb__browser_term__Var_17);
            }
            ...
            if (mdb__browser_term__succeeded)
              *mdb__browser_term__HeadVar__1_1 = mdb__browser_term__Var_20;
            else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[0], &mdb__browser_term__Var_21, ((MR_Box) (mdb__browser_term__Var_30)), ((MR_Box) (mdb__browser_term__Var_18)));
                }
                ...
                if (mdb__browser_term__succeeded)
                  *mdb__browser_term__HeadVar__1_1 = mdb__browser_term__Var_21;
                  ...
                  {
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) &mdb__browser_term_scalar_common_1[1], mdb__browser_term__HeadVar__1_1, ((MR_Box) (mdb__browser_term__Var_29)), ((MR_Box) (mdb__browser_term__Var_19)));
                    }
                  }
              }
          }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__browser_term__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word mdb__browser_term__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__1_1, (MR_Integer) 0)));
        ...
        if (mdb__browser_term__succeeded)
          {
            mdb__browser_term__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));
            {
              mdb__browser_term__succeeded = mercury__univ____Unify____univ_0_0(mdb__browser_term__Var_3, mdb__browser_term__Var_4);
            }
          }
      }
    else
      {
        ...
        MR_String mdb__browser_term__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdb__browser_term__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__browser_term__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__1_1, (MR_Integer) 2)));
        MR_String mdb__browser_term__Var_8;
        MR_Word mdb__browser_term__Var_9;
        MR_Word mdb__browser_term__Var_10;

        mdb__browser_term__succeeded = ((MR_tag((MR_Word) mdb__browser_term__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mdb__browser_term__succeeded)
          {
            mdb__browser_term__Var_8 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 0)));
            mdb__browser_term__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 1)));
            mdb__browser_term__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browser_term__HeadVar__2_2, (MR_Integer) 2)));
            mdb__browser_term__succeeded = (strcmp(mdb__browser_term__Var_5, mdb__browser_term__Var_8) == 0);
            if (mdb__browser_term__succeeded)
              {
                mdb__browser_term__TypeInfo_14_14 = (MR_Word) &mdb__browser_term_scalar_common_1[0];
                {
                  mdb__browser_term__succeeded = mercury__builtin__unify_2_p_0(mdb__browser_term__TypeInfo_14_14, ((MR_Box) (mdb__browser_term__Var_6)), ((MR_Box) (mdb__browser_term__Var_9)));
                }
                if (mdb__browser_term__succeeded)
                  {
                    mdb__browser_term__TypeInfo_15_15 = (MR_Word) &mdb__browser_term_scalar_common_1[1];
                    {
                      mdb__browser_term__succeeded = mercury__builtin__unify_2_p_0(mdb__browser_term__TypeInfo_15_15, ((MR_Box) (mdb__browser_term__Var_7)), ((MR_Box) (mdb__browser_term__Var_10)));
                    }
                  }
              }
          }
