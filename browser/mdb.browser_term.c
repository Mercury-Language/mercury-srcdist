...
MR_decl_label2(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0, 15,5)
...
MR_BEGIN_MODULE(mdb__browser_term_module2)
	...
	MR_init_label2(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0,15,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__mdb__browser_term__synthetic_term_to_browser_term_3_0);
	...
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0_i15);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__mdb__browser_term__synthetic_term_to_browser_term_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
