...
static MR_bool MR_CALL 
mdb__declarative_tree__IntroducedFrom__pred__traverse_primitives__1651__1_2_p_0(
  MR_Integer Var0_2,
  MR_Integer ToVar_43);
...
{
  {
    ...
    succeeded = mdb__declarative_tree__IntroducedFrom__pred__traverse_primitives__1663__1_2_p_0(Var_9, Var_10);
    if (!(succeeded))
    {
      MR_Word Var_7;
...
{
  {
    ...
    succeeded = mdb__declarative_tree__IntroducedFrom__pred__traverse_primitives__1651__1_2_p_0(Var_9, Var_10);
    if (!(succeeded))
    {
      MR_Word Var_7;
