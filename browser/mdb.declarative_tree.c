    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_tree_scalar_common_1[7]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_18_18 = (MR_Word) (&mdb__declarative_tree_scalar_common_1[7]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_tree_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&mdb__declarative_tree_scalar_common_1[4]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
