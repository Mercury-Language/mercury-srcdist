...
static MR_bool MR_CALL 
mdb__declarative_tree____Unify______mdb__declarative_executiontrace_node_1_1(
...
{
  {
    ...
    succeeded = mdb__declarative_tree____Unify______mdb__declarative_executiontrace_node_1_1(TypeInfo_39_39, Var_35, Var_37);
    return succeeded;
  }
}
