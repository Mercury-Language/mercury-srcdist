...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    Dir_68 = mercury__dir__this_directory_0_f_0();
    Var_77 = mercury__dir__f_slash_2_f_0(Dir_68, FileName_12);
    mercury__io__open_input_4_p_0(Var_77, &Result0_72);
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word InStream_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_72, (MR_Integer) 0))));
      MR_Box InStrm_85;
...
#undef MR_PROC_LABEL
      ...
      mercury__io__close_input_3_p_0(InStream_84);
    }
  }
}
