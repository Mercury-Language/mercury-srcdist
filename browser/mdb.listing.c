  ...
  MR_Word Path_18)
{
  ...
  else
  {
    ...
    MR_Word FileTypeRes_92;

    Dir_86 = mercury__dir__this_directory_0_f_0();
    FileName_90 = mercury__dir__f_slash_2_f_0(Dir_86, FileName_14);
    mercury__io__file__file_type_5_p_0((MR_Integer) 1, FileName_90, &FileTypeRes_92);
    if (((MR_tag((MR_Word) FileTypeRes_92)) == (MR_Integer) 1))
      mdb__listing__find_file_5_p_0(Path_18, FileName_14, &FindResult_21);
    else
    {
      MR_Word FileType_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FileTypeRes_92, (MR_Integer) 0))));
      ...
      switch (FileType_93) {
        ...
        case (MR_Integer) 10:
          {
            FindResult_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), FindResult_21, 0) = ((MR_Box) (FileName_90));
          }
          break;
        case (MR_Integer) 1:
          mdb__listing__find_file_5_p_0(Path_18, FileName_14, &FindResult_21);
...
#undef MR_PROC_LABEL
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (FoundFileName_22));
      MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) (LineArgs_20));
    }
    ...
    if (succeeded)
    {
      MR_String Message_63;

      mercury__io__make_err_msg_5_p_0(Error0_62, (MR_String) "error invoking system command: ", &Message_63);
      {
        CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Message_63));
      }
    }
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Error_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Result0_64, (MR_Integer) 0))));
          MR_String Var_80;

          Var_80 = mercury__io__error_message_1_f_0(Error_67);
          {
            CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_80));
          }
        }
        else
        {
          MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_64, (MR_Integer) 0))));

          if (((MR_tag((MR_Word) Var_82)) == (MR_Integer) 0))
          {
            MR_Integer ExitStatus_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_82, (MR_Integer) 0))));
            ...
            else
            {
              ...
              Var_75 = mercury__string__from_int_1_f_0(ExitStatus_65);
              Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "exit status ", Var_75);
              {
                CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_73));
              }
            }
          }
          else
          {
            MR_Integer Signal_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0))));
            MR_String Var_77;
            MR_String Var_79;

            Var_79 = mercury__string__from_int_1_f_0(Signal_66);
            Var_77 = mercury__string__f_43_43_2_f_0((MR_String) "received signal ", Var_79);
            {
              CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_77));
            }
          }
        }
      }
  ...
  MR_Word Path_16)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result0_66)) == (MR_Integer) 1))
    {
      ...
      {
        MR_Word InStream_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Result_22, (MR_Integer) 0))));
    ...
    {
      MR_Word InStream_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_66, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word InStream_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_68, (MR_Integer) 0))));
      MR_Box InStreamC_81;
