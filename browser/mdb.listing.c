...
#line 24 "mdb.listing.c"
#include "mdb.listing.mh"

#line 27 "mdb.listing.c"
#line 3 "mdb.int0"
#include "mdb.mh"

#line 31 "mdb.listing.c"
#line 532 "../library/io.int"
#include "io.mh"

#line 35 "mdb.listing.c"
#line 540 "../library/io.int"
#include "string.mh"

#line 39 "mdb.listing.c"
#line 55 "../library/dir.int"
#include "dir.mh"

#line 43 "mdb.listing.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 47 "mdb.listing.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 51 "mdb.listing.c"
...
MR_decl_label5(mdb__listing__find_and_open_file_5_0, 16,3,4,5,7)
MR_decl_label8(mdb__listing__list_file_9_0, 4,6,8,9,2,10,11,12)
MR_decl_label3(mdb__listing__list_file_9_0, 14,15,17)
MR_decl_label1(mdb__listing__pop_list_path_2_0, 3)
MR_decl_label1(fn__mdb__listing__listing_type_0_0, 2)
...
MR_decl_static(mdb__listing__print_lines_in_range_8_0)
...
MR_BEGIN_MODULE(mdb__listing_module8)
	...
	MR_init_label5(mdb__listing__find_and_open_file_5_0,16,3,4,5,7)
MR_BEGIN_CODE
...
MR_def_label(mdb__listing__find_and_open_file_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(mdb__listing__find_and_open_file_5_0,5)
	...
	MR_Word	InStream;
	FILE *	InStrm;
#define	MR_PROC_LABEL	mercury__mdb__listing__find_and_open_file_5_0
	InStream = MR_tempr1;
{
#line 212 "listing.m"
    ...
    InStrm = MR_file(*(MR_unwrap_input_stream(InStream)));
;}
#line 454 "mdb.listing.c"
	MR_tempr1 = (MR_Word) InStrm;
#undef	MR_PROC_LABEL
	}
...
MR_def_label(mdb__listing__find_and_open_file_5_0,7)
	...
	MR_GOTO_LAB(mdb__listing__find_and_open_file_5_0_i16);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__listing_module9)
	MR_init_entry1(mdb__listing__print_lines_in_range_8_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mdb__listing__print_lines_in_range_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	FILE *	InStrm;
	FILE *	OutStrm;
	...
	MR_Word	IO0;
	MR_Word	IO;
#define	MR_PROC_LABEL	mercury__mdb__listing__print_lines_in_range_8_0
	InStrm = (FILE *) MR_r1;
	OutStrm = (FILE *) MR_r2;
	ThisLine = MR_r3;
	FirstLine = MR_r4;
...
MR_BEGIN_MODULE(mdb__listing_module10)
	...
	MR_init_label8(mdb__listing__list_file_9_0,4,6,8,9,2,10,11,12)
	MR_init_label3(mdb__listing__list_file_9_0,14,15,17)
MR_BEGIN_CODE
...
MR_def_label(mdb__listing__list_file_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(mdb__listing__list_file_9_0_i8);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
...
MR_def_label(mdb__listing__list_file_9_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
...
MR_def_label(mdb__listing__list_file_9_0,2)
	...
	MR_np_call_localret_ent(fn__dir__this_directory_0_0,
		mdb__listing__list_file_9_0_i10);
MR_def_label(mdb__listing__list_file_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__f_100_105_114_95_95_47_2_0,
...
MR_def_label(mdb__listing__list_file_9_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(mdb__listing__list_file_9_0_i14);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
...
#line 234 "listing.m"
    ...
    IO = IO0;
;}
#line 829 "mdb.listing.c"
#undef	MR_PROC_LABEL
	}
	MR_decr_sp_and_return(8);
	}
MR_def_label(mdb__listing__list_file_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(mdb__listing__find_and_open_file_5_0,
		mdb__listing__list_file_9_0_i15);
MR_def_label(mdb__listing__list_file_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__listing__list_file_9_0_i17);
	}
	{
	MR_Word MR_tempr1;
	{
...
#line 181 "listing.m"
    ...
    IO = IO0;
;}
#line 895 "mdb.listing.c"
#undef	MR_PROC_LABEL
	}
	MR_decr_sp_and_return(8);
	}
MR_def_label(mdb__listing__list_file_9_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(mdb__listing_module11)
	...
	MR_init_label1(fn__mdb__listing__listing_type_0_0,2)
MR_BEGIN_CODE
...
MR_def_static(fn__mdb__listing__listing_type_0_0)
	...
	MR_np_call_localret_ent(fn__type_desc__type_of_1_0,
		fn__mdb__listing__listing_type_0_0_i2);
MR_def_label(fn__mdb__listing__listing_type_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
