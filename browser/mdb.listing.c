...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    Var_68 = mercury__list__length_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_42);
    mdb__listing__do_posix_spawnp_9_p_0(Command_13, Var_68, Var_42, OutStrm_11, ErrStrm_12, &Status_61, &Error0_62);
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) Result0_64)) == (MR_Integer) 1))
        {
          ...
          Var_72 = mercury__io__error_message_1_f_0(Error_67);
          {
            CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_72));
          }
        }
        else
        {
          ...
          if (((MR_tag((MR_Word) Var_82)) == (MR_Integer) 0))
          {
            ...
            else
            {
              ...
              Var_80 = mercury__string__from_int_1_f_0(ExitStatus_65);
              Var_78 = mercury__string__f_43_43_2_f_0((MR_String) "exit status ", Var_80);
              {
                CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            Var_76 = mercury__string__from_int_1_f_0(Signal_66);
            Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "received signal ", Var_76);
            {
              CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word Path_16)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) Result0_18)) == (MR_Integer) 1))
    {
      ...
      Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot open file ", Var_56);
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result0_68)) == (MR_Integer) 1))
    {
      ...
      if ((Result_23 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_41 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot find file ", Var_59);
{
#define MR_PROC_LABEL mdb__listing__list_file_9_p_0
