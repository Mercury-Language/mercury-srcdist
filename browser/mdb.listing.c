  ...
  MR_Word Path_18)
{
  ...
  else
  {
    ...
    {
      MR_Word FileType_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FileTypeRes_93, (MR_Integer) 0))));
      ...
      switch (FileType_94) {
        ...
        case (MR_Integer) 10:
          {
            FindResult_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), FindResult_21, 0) = ((MR_Box) (FileName_91));
          }
          break;
        case (MR_Integer) 1:
          mdb__listing__find_file_5_p_0(Path_18, FileName_14, &FindResult_21);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_71 = mercury__io__error_message_1_f_0(IOError_63);
      {
        ...
        MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_71));
      }
    }
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_64, (MR_Integer) 0))));

          if (((MR_tag((MR_Word) Var_83)) == (MR_Integer) 0))
          {
            MR_Integer ExitStatus_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_83, (MR_Integer) 0))));
            ...
            else
            {
              ...
              {
                CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_74));
              }
            }
          }
          else
          {
            MR_Integer Signal_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_83, (MR_Integer) 0))));
            MR_String Var_78;
            MR_String Var_80;
            ...
            {
              CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_78));
            }
          }
        }
      }
