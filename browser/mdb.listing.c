...
MR_decl_label10(mdb__listing__print_lines_in_range_m_8_0, 44,2,6,7,8,5,11,13,10,47)
...
MR_BEGIN_MODULE(mdb__listing_module11)
	...
	MR_init_label10(mdb__listing__print_lines_in_range_m_8_0,44,2,6,7,8,5,11,13,10,47)
MR_BEGIN_CODE
...
MR_def_static(mdb__listing__print_lines_in_range_m_8_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,13)
	...
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(io__write_string_4_0,
		mdb__listing__print_lines_in_range_m_8_0_i10);
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,10)
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(mdb__listing__print_lines_in_range_m_8_0_i44);
