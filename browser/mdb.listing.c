...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    mdb__listing__do_posix_spawnp_9_p_0(Command_13, Var_68, Var_36, OutStrm_11, ErrStrm_12, &Status_61, &Error0_62);
  ...
  MR_Word Path_16)
{
  ...
  else
  {
    ...
    Dir_52 = mercury__dir__this_directory_0_f_0();
    Var_61 = mercury__dir__f_slash_2_f_0(Dir_52, FileName_12);
    mercury__io__open_input_4_p_0(Var_61, &Result0_56);
    if (((MR_tag((MR_Word) Result0_56)) == (MR_Integer) 1))
    {
      MR_Word Result_22;
    ...
    {
      MR_Word InStrm_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_56, (MR_Integer) 0))));

      mdb__listing__print_lines_in_range_m_8_p_0(InStrm_68, OutStrm_10, (MR_Integer) 1, FirstLine_13, LastLine_14, MarkLine_15);
      mercury__io__close_input_3_p_0(InStrm_68);
    }
  }
}
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_32 = mercury__io__error_message_1_f_0(Error_18);
          mercury__io__write_string_4_p_0(OutStrm_10, Var_32);
          mercury__io__write_string_4_p_0(OutStrm_10, (MR_String) "\n");
        }
        break;
    }
  ...
  MR_Word Path_16)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) Result0_18)) == (MR_Integer) 1))
    {
      ...
      Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot open file ", Var_56);
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result0_68)) == (MR_Integer) 1))
    {
      ...
      if ((Result_23 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot find file ", Var_59);
{
#define MR_PROC_LABEL mdb__listing__list_file_9_p_0
