...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Result0_60)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word Result_22;

        mdb__listing__find_and_open_file_5_p_0(Path_16, FileName_12, &Result_22);
        if ((Result_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_33 = (ThisLine_11 + (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_ThisLine_11 = Var_33;
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Result0_64)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word Result_23;

        mdb__listing__find_and_open_file_5_p_0(Path_16, FileName_12, &Result_23);
        if ((Result_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
{
#define MR_PROC_LABEL mdb__listing__list_file_9_p_0
