...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    mdb__listing__do_posix_spawnp_9_p_0(Command_13, Var_76, Var_36, OutStrm_11, ErrStrm_12, &Status_69, &Error0_70);
  ...
  MR_Word Path_16)
{
  ...
  else
  {
    ...
    Dir_53 = mercury__dir__this_directory_0_f_0();
    Var_63 = mercury__dir__f_slash_2_f_0(Dir_53, FileName_12);
    mercury__io__open_input_4_p_0(Var_63, &Result0_58);
    ...
    {
      MR_Word InStrm_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_58, (MR_Integer) 0))));

      mdb__listing__print_lines_in_range_m_8_p_0(InStrm_70, OutStrm_10, (MR_Integer) 1, FirstLine_13, LastLine_14, MarkLine_15);
      mercury__io__close_input_3_p_0(InStrm_70);
    }
  }
}
