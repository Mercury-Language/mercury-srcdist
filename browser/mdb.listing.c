...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    Var_76 = mercury__list__length_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_36);
    mdb__listing__do_posix_spawnp_9_p_0(Command_13, Var_76, Var_36, OutStream_11, ErrorStream_12, &Status_69, &Error0_70);
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) Result0_72)) == (MR_Integer) 1))
        {
          ...
          Var_89 = mercury__io__error_message_1_f_0(Error_75);
          {
            CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_89));
          }
        }
        else
        {
          ...
          if (((MR_tag((MR_Word) Var_91)) == (MR_Integer) 0))
          {
            ...
            else
            {
              ...
              Var_84 = mercury__string__from_int_1_f_0(ExitStatus_73);
              Var_82 = mercury__string__f_43_43_2_f_0((MR_String) "exit status ", Var_84);
              {
                CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_82));
              }
            }
          }
          else
          {
            ...
            Var_88 = mercury__string__from_int_1_f_0(Signal_74);
            Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "received signal ", Var_88);
            {
              CallResult_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CallResult_23, 0) = ((MR_Box) (Var_86));
            }
          }
        }
      }
  ...
  MR_Word Path_16)
{
  ...
  else
  {
    ...
    Dir_63 = mercury__dir__this_directory_0_f_0();
    Var_73 = mercury__dir__f_slash_2_f_0(Dir_63, FileName_12);
    ...
    else
    {
      ...
      mdb__listing__print_lines_in_range_m_8_p_0(InStream_80, OutStream_10, (MR_Integer) 1, FirstLine_13, LastLine_14, MarkLine_15);
...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    Dir_65 = mercury__dir__this_directory_0_f_0();
    Var_75 = mercury__dir__f_slash_2_f_0(Dir_65, FileName_12);
    mercury__io__open_input_4_p_0(Var_75, &Result0_70);
    if (((MR_tag((MR_Word) Result0_70)) == (MR_Integer) 1))
    {
      MR_Word Result_23;
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word InStream_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_70, (MR_Integer) 0))));
      MR_Box InStreamC_83;
...
#undef MR_PROC_LABEL
      ...
      mercury__io__close_input_3_p_0(InStream_82);
    }
  }
}
