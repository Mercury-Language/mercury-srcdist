...
MR_decl_label5(mdb__listing__find_and_open_file_5_0, 17,3,4,5,7)
MR_decl_label10(mdb__listing__list_file_9_0, 4,6,9,8,2,10,11,12,15,17)
MR_decl_label1(mdb__listing__list_file_9_0, 14)
...
MR_BEGIN_MODULE(mdb__listing_module8)
	...
	MR_init_label5(mdb__listing__find_and_open_file_5_0,17,3,4,5,7)
MR_BEGIN_CODE
...
MR_def_label(mdb__listing__find_and_open_file_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(mdb__listing__find_and_open_file_5_0,7)
	...
	MR_GOTO_LAB(mdb__listing__find_and_open_file_5_0_i17);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__listing_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__listing__print_lines_in_range_8_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'print_lines_in_range'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__listing_module10)
	...
	MR_init_label10(mdb__listing__list_file_9_0,4,6,9,8,2,10,11,12,15,17)
	MR_init_label1(mdb__listing__list_file_9_0,14)
MR_BEGIN_CODE
