...
MR_decl_label6(mdb__listing__list_file_portable_9_0, 19,22,25,26,21,30)
MR_decl_label1(mdb__listing__pop_list_path_2_0, 3)
MR_decl_label10(mdb__listing__print_lines_in_range_m_8_0, 47,2,12,14,11,5,6,7,8,50)
...
MR_BEGIN_MODULE(mdb__listing_module11)
	...
	MR_init_label10(mdb__listing__print_lines_in_range_m_8_0,47,2,12,14,11,5,6,7,8,50)
MR_BEGIN_CODE
...
MR_def_static(mdb__listing__print_lines_in_range_m_8_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,2)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(mdb__listing__print_lines_in_range_m_8_0_i50);
	}
	...
	if ((MR_sv(3) != MR_sv(6))) {
		MR_GOTO_LAB(mdb__listing__print_lines_in_range_m_8_0_i12);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("> ", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
		mdb__listing__print_lines_in_range_m_8_0_i14);
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("  ", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
		mdb__listing__print_lines_in_range_m_8_0_i14);
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(io__write_string_4_0,
		mdb__listing__print_lines_in_range_m_8_0_i11);
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,11)
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(mdb__listing__print_lines_in_range_m_8_0_i47);
...
MR_def_label(mdb__listing__print_lines_in_range_m_8_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__listing_module12)
	...
	MR_init_label6(mdb__listing__list_file_portable_9_0,19,22,25,26,21,30)
MR_BEGIN_CODE
