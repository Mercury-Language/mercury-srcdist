...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word InStream_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Result0_74, (MR_Integer) 0))));
      MR_Box InStrm_87;
...
#undef MR_PROC_LABEL
      ...
      mercury__io__close_input_3_p_0(InStream_86);
    }
  }
}
