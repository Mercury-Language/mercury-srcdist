  ...
  MR_Word Path_16)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) Result0_18)) == (MR_Integer) 1))
    {
      ...
      Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot open file ", Var_60);
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Result0_74)) == (MR_Integer) 1))
    {
      ...
      if ((Result_23 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "mdb: cannot find file ", Var_63);
{
#define MR_PROC_LABEL mdb__listing__list_file_9_p_0
