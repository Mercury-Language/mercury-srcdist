...
MR_decl_label8(mdb__listing__list_file_9_0, 4,6,9,8,2,10,11,12)
MR_decl_label3(mdb__listing__list_file_9_0, 15,17,14)
...
MR_BEGIN_MODULE(mdb__listing_module10)
	...
	MR_init_label8(mdb__listing__list_file_9_0,4,6,9,8,2,10,11,12)
	MR_init_label3(mdb__listing__list_file_9_0,15,17,14)
MR_BEGIN_CODE
