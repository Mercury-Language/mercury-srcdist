...
MR_decl_label5(mdb__listing__find_and_open_file_5_0, 18,3,4,5,7)
MR_decl_label6(mdb__listing__list_file_9_0, 2,3,4,6,7,9)
...
MR_BEGIN_MODULE(mdb__listing_module8)
	...
	MR_init_label5(mdb__listing__find_and_open_file_5_0,18,3,4,5,7)
MR_BEGIN_CODE
...
MR_def_label(mdb__listing__find_and_open_file_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(mdb__listing__find_and_open_file_5_0,5)
	...
	MR_GOTO_LAB(mdb__listing__find_and_open_file_5_0_i18);
...
MR_BEGIN_MODULE(mdb__listing_module10)
	...
	MR_init_label6(mdb__listing__list_file_9_0,2,3,4,6,7,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__listing__list_file_9_0);
	...
	MR_np_call_localret_ent(fn__dir__this_directory_0_0,
		mdb__listing__list_file_9_0_i2);
MR_def_label(mdb__listing__list_file_9_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__f_100_105_114_95_95_47_2_0,
		mdb__listing__list_file_9_0_i3);
MR_def_label(mdb__listing__list_file_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__open_input_4_0,
...
MR_def_label(mdb__listing__list_file_9_0,4)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(mdb__listing__list_file_9_0_i6);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
...
MR_def_label(mdb__listing__list_file_9_0,6)
	...
	MR_np_call_localret_ent(mdb__listing__find_and_open_file_5_0,
		mdb__listing__list_file_9_0_i7);
MR_def_label(mdb__listing__list_file_9_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__listing__list_file_9_0_i9);
	}
	{
	MR_Word MR_tempr1;
	{
...
void mercury__mdb__listing__write_out_proc_statics(FILE *fp);
#endif
