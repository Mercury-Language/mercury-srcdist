...
mdb__collect_lib__unlink_collect_3_p_0(
  MR_Word MaybeHandle_4)
{
  if (!(((MR_tag((MR_Word) MaybeHandle_4)) == (MR_mktag((MR_Integer) 1)))))
  {
    MR_Word Handle_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeHandle_4, (MR_Integer) 0)));
    MR_Word Result_8;

    mdb__dl__close_4_p_0(Handle_7, &Result_8);
    if (!((Result_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) *MaybeHandle_17)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_Word TypeCtorInfo_51_51 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      MR_String Msg_20 = ((MR_String) (MR_hl_field(MR_mktag(1), *MaybeHandle_17, (MR_Integer) 0)));

      mercury__io__print_3_p_0(TypeCtorInfo_51_51, ((MR_Box) ((MR_String) "dlopen failed: ")));
      mercury__io__print_3_p_0(TypeCtorInfo_51_51, ((MR_Box) (Msg_20)));
      mercury__io__nl_2_p_0();
{
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeInitialize_22)) == (MR_mktag((MR_Integer) 0)));
      if (succeeded)
      {
        Initialize0_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeInitialize_22, (MR_Integer) 0)));
        succeeded = ((MR_tag((MR_Word) MaybeFilter_23)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          Filter0_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeFilter_23, (MR_Integer) 0)));
          succeeded = ((MR_tag((MR_Word) MaybePostProcess_24)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
            PostProcess0_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybePostProcess_24, (MR_Integer) 0)));
            succeeded = ((MR_tag((MR_Word) MaybeSendResult_25)) == (MR_mktag((MR_Integer) 0)));
            if (succeeded)
            {
              SendResult0_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeSendResult_25, (MR_Integer) 0)));
              succeeded = ((MR_tag((MR_Word) MaybeType_26)) == (MR_mktag((MR_Integer) 0)));
              if (succeeded)
