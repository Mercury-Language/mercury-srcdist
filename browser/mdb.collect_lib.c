...
void mercury__mdb__collect_lib__init_threadscope_string_table(void);
#endif
...
void mercury__mdb__collect_lib__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__collect_lib);
