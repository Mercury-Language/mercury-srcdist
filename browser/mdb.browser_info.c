...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeXMLBrowserCmd_9)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeXMLTmpFileName_10)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeWebBrowserCmd_11)) == (MR_Integer) 1);
    if (succeeded)
    {
