...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_24 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      ...
      else
      {
        ...
        MR_Word ArgY2_13 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
