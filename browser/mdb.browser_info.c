...
{
  {
    ...
    MR_String Var_41;
    MR_String Var_42;
    MR_Word Format_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), PrintParams_5, (MR_Integer) 0)));
    ...
    succeeded = ((MR_tag((MR_Word) MaybeXMLBrowserCmd_9)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeXMLTmpFileName_10)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeWebBrowserCmd_11)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
