  ...
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      ...
      mercury__io____Compare____output_stream_0_0(HeadVar__1_1, Var_16, ArgY1_11);
    }
    else
      *HeadVar__1_1 = (MR_Integer) 2;
  }
  else
  {
    ...
    else
    {
      ...
      mercury__io____Compare____output_stream_0_0(HeadVar__1_1, Var_17, ArgY1_5);
    }
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__io____Unify____output_stream_0_0(ArgX1_3, ArgY1_4);
    }
  }
  return succeeded;
}
  ...
  MR_Word * IsFunc_10)
{
  ...
  if (((MR_tag((MR_Word) BrowserTerm_7)) == (MR_Integer) 0))
  {
    ...
    succeeded = mercury__univ__univ_to_type_2_p_0((MR_Word) (&mercury__io__io__type_ctor_info_input_stream_0), Univ_11, &conv0_InputStream_20);
    if (succeeded)
    {
    ...
    else
    {
      ...
      succeeded = mercury__univ__univ_to_type_2_p_0((MR_Word) (&mercury__io__io__type_ctor_info_output_stream_0), Univ_11, &conv1_OutputStream_23);
      if (succeeded)
      {
  ...
  MR_Word * MaybeReturn_12)
{
  ...
  if (((MR_tag((MR_Word) BrowserTerm_8)) == (MR_Integer) 0))
  {
    ...
    succeeded = mercury__univ__univ_to_type_2_p_0((MR_Word) (&mercury__io__io__type_ctor_info_input_stream_0), Univ_13, &conv0_InputStream_19);
    if (succeeded)
    {
    ...
    else
    {
      ...
      succeeded = mercury__univ__univ_to_type_2_p_0((MR_Word) (&mercury__io__io__type_ctor_info_output_stream_0), Univ_13, &conv1_OutputStream_22);
      if (succeeded)
      {
