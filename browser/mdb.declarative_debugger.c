...
{
  {
    mdb__declarative_debugger__diagnosis_9_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_2[0]), ((MR_Box) (Store_9)), (MR_Word) ((MR_Integer) 0), Response_10, STATE_VARIABLE_State_0_14, STATE_VARIABLE_State_15, STATE_VARIABLE_Browser_0_16, STATE_VARIABLE_Browser_17);
  }
}
...
{
  {
    ...
    switch (Confirmation_16) {
      ...
      case (MR_Integer) 2:
        {
          *Response_12 = (MR_Word) ((MR_Integer) 0);
    ...
    switch (MR_tag((MR_Word) OracleResponse_9)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(OracleResponse_9)) {
          ...
          case (MR_Integer) 1:
            {
              *DiagnoserResponse_10 = (MR_Word) ((MR_Integer) 0);
  ...
  MR_Word * STATE_VARIABLE_Diagnoser_34)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) AnalyserResponse_10)) {
      ...
      case (MR_Integer) 0:
        {
          *DiagnoserResponse_12 = (MR_Word) ((MR_Integer) 0);
          ...
          case (MR_Integer) 2:
            {
              ...
              MaybeOrigin_11 = (MR_Word) ((MR_Integer) 0);
    ...
    case (MR_Integer) 0:
      {
        ...
        *Response_2 = (MR_Word) ((MR_Integer) 0);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * MaybeIoActions_6)
{
  ...
  else
  {
    ...
    *MaybeIoActions_6 = (MR_Word) ((MR_Integer) 0);
  }
}
