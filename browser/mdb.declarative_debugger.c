...
MR_def_label(__Unify___mdb__declarative_debugger__decl_answer_1_0,9)
	...
	MR_sv(2) = MR_tfield(1, MR_tempr1, 2);
	MR_tempr3 = MR_sv(3);
	MR_sv(3) = ((MR_Integer) MR_tfield(1, MR_tempr1, 3) & (MR_Integer) 1);
	MR_sv(4) = (((MR_Integer) MR_tfield(1, MR_tempr1, 3) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(5) = MR_tfield(1, MR_tempr2, 1);
	MR_sv(6) = MR_tfield(1, MR_tempr2, 2);
	MR_sv(7) = ((MR_Integer) MR_tfield(1, MR_tempr2, 3) & (MR_Integer) 1);
	MR_sv(8) = (((MR_Integer) MR_tfield(1, MR_tempr2, 3) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_r1 = MR_tempr3;
