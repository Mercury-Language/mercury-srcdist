            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Word next_value_of_AnalyserResponse_10 = Var_38;
                  MR_Word next_value_of_STATE_VARIABLE_Diagnoser_0_33 = STATE_VARIABLE_Diagnoser_37_37;

                  AnalyserResponse_10 = next_value_of_AnalyserResponse_10;
                  MaybeOrigin_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
