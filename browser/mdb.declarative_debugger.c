...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]), &SubResult3_12, ((MR_Box) (Var_76)), ((MR_Box) (ArgY3_11)));
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_23_23 = (MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (Var_73)), ((MR_Box) (ArgY3_37)));
                    }
                  }
                }
                break;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_24_24 = (MR_Word) (&mdb__declarative_debugger_scalar_common_1[4]);
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_debugger_scalar_common_1[3]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) (&mdb__declarative_debugger_scalar_common_1[3]);
