...
MR_BEGIN_MODULE(mdb_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__version_1_0);
MR_BEGIN_CODE
...
void mercury__mdb__init_threadscope_string_table(void);
#endif
...
void mercury__mdb__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb);
