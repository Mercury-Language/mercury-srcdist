...
MR_def_label(mdb__browse__run_command_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = ((MR_Integer) MR_tfield(3, MR_r2, 1) & (MR_Integer) 1);
	MR_sv(3) = (((MR_Integer) MR_tfield(3, MR_r2, 1) >> (MR_Integer) 1) & (MR_Integer) 1);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
	MR_sv(4) = MR_tempr1;
