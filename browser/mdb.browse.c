...
MR_decl_label8(mdb__browse__browser_term_to_string_pretty_8_0, 3,9,10,11,7,14,6,4)
MR_decl_label8(mdb__browse__browser_term_to_string_pretty_8_0, 16,17,35,19,20,22,25,2)
MR_decl_label2(mdb__browse__browser_term_to_string_pretty_8_0, 26,27)
...
MR_decl_label8(mdb__browse__portray_6_0, 2,3,4,8,10,11,12,14)
MR_decl_label8(mdb__browse__portray_6_0, 16,6,18,21,22,23,19,29)
MR_decl_label5(mdb__browse__portray_6_0, 27,28,30,31,32)
...
MR_decl_label5(fn__mdb__browse__qualified_functor_to_doc_1_0, 20,6,7,5,8)
...
MR_decl_static(mdb__browse__portray_pretty_5_0)
...
MR_BEGIN_MODULE(mdb__browse_module14)
	...
	MR_init_label5(fn__mdb__browse__qualified_functor_to_doc_1_0,20,6,7,5,8)
MR_BEGIN_CODE
...
MR_def_static(fn__mdb__browse__qualified_functor_to_doc_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__mdb__browse__qualified_functor_to_doc_1_0_i20);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,5,1);
	MR_proceed();
MR_def_label(fn__mdb__browse__qualified_functor_to_doc_1_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	MR_tempr1 = MR_ctfield(1, MR_r1, 1);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(fn__mdb__browse__qualified_functor_to_doc_1_0_i5);
	}
	MR_sv(1) = MR_tempr1;
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	}
	MR_np_call_localret_ent(fn__term_io__quoted_atom_1_0,
		fn__mdb__browse__qualified_functor_to_doc_1_0_i6);
MR_def_label(fn__mdb__browse__qualified_functor_to_doc_1_0,6)
	...
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,5,2);
	}
...
MR_def_label(fn__mdb__browse__qualified_functor_to_doc_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(fn__term_io__quoted_atom_1_0,
		fn__mdb__browse__qualified_functor_to_doc_1_0_i8);
MR_def_label(fn__mdb__browse__qualified_functor_to_doc_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_decl_entry(pretty_printer__format_8_0);

MR_BEGIN_MODULE(mdb__browse_module15)
	MR_init_entry1(mdb__browse__browser_term_to_string_pretty_8_0);
	MR_init_label8(mdb__browse__browser_term_to_string_pretty_8_0,3,9,10,11,7,14,6,4)
	MR_init_label8(mdb__browse__browser_term_to_string_pretty_8_0,16,17,35,19,20,22,25,2)
	MR_init_label2(mdb__browse__browser_term_to_string_pretty_8_0,26,27)
MR_BEGIN_CODE
...
MR_def_static(mdb__browse__browser_term_to_string_pretty_8_0)
	...
	MR_tfield(3, MR_tempr1, 1) = MR_ctfield(0, MR_r3, 0);
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
	MR_sv(4) = MR_r6;
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,3)
	...
	if ((strcmp((char *)MR_sv(6), (char *)(MR_Word) MR_string_const("!.", 2)) != 0)) {
		MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i9);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
	...
	MR_sv(5) = MR_r7;
	MR_sv(9) = MR_r1;
	MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i6);
	}
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(6), (char *)(MR_Word) MR_string_const(".", 1)) != 0)) {
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(6), (char *)(MR_Word) MR_string_const("=..", 3)) != 0)) {
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,7)
	...
	MR_np_call_localret_ent(string__contains_char_2_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i14);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i4);
	}
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_sv(6) = MR_tempr1;
	MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i22);
	}
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	MR_np_call_localret_ent(fn__string__split_at_char_2_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i16);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__mdb__browse__qualified_functor_to_doc_1_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i17);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(7),0,0)) {
		MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i19);
	}
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i22);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(10) = (MR_Word) MR_TAG_COMMON(1,5,3);
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,11,1);
	MR_np_call_localret_ent(fn__pretty_printer__group_1_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i20);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,11,2);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__pretty_printer__indent_1_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i35);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	MR_tfield(3, MR_tempr1, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr1, 1) = MR_ctfield(1, MR_sv(8), 0);
	MR_sv(7) = (MR_Word) MR_TAG_COMMON(1,5,6);
	MR_r1 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__pretty_printer__format_arg_1_0,
		mdb__browse__browser_term_to_string_pretty_8_0_i25);
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,26)
	...
	if (MR_INT_LE(MR_sv(5),0)) {
		MR_GOTO_LAB(mdb__browse__browser_term_to_string_pretty_8_0_i27);
	}
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__browse_module16)
	MR_init_entry1(mdb__browse__portray_pretty_5_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mdb__browse__portray_pretty_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
	...
	MR_np_tailcall_ent(mdb__browse__browser_term_to_string_pretty_8_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(mdb__browse_module24)
	...
	MR_init_label8(mdb__browse__portray_6_0,2,3,4,8,10,11,12,14)
	MR_init_label8(mdb__browse__portray_6_0,16,6,18,21,22,23,19,29)
	MR_init_label5(mdb__browse__portray_6_0,27,28,30,31,32)
MR_BEGIN_CODE
...
MR_def_label(mdb__browse__portray_6_0,4)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(2),
		...
		MR_LABEL_AP(mdb__browse__portray_6_0_i14) MR_AND
		MR_LABEL_AP(mdb__browse__portray_6_0_i16));
...
MR_def_label(mdb__browse__portray_6_0,16)
	...
	MR_np_call_localret_ent(mdb__browse__portray_pretty_5_0,
		mdb__browse__portray_6_0_i32);
...
MR_def_label(mdb__browse__portray_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(2),0,0)) {
		MR_GOTO_LAB(mdb__browse__portray_6_0_i19);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__mdb__browse__dirs_to_string_1_0,
...
MR_def_label(mdb__browse__portray_6_0,22)
	...
	MR_r1 = (MR_Word) MR_string_const("in subdir ", 10);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		mdb__browse__portray_6_0_i23);
MR_def_label(mdb__browse__portray_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(mdb__browser_info__write_string_debugger_4_0,
...
MR_def_label(mdb__browse__portray_6_0,19)
	...
	MR_r3 = MR_tempr1;
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(mdb__browse__portray_6_0_i27);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
...
MR_def_label(mdb__browse__portray_6_0,31)
	...
	MR_np_call_localret_ent(mdb__browser_info__write_string_debugger_4_0,
		mdb__browse__portray_6_0_i32);
MR_def_label(mdb__browse__portray_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_def_label(mdb__browse__write_term_mode_debugger_5_0,5)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_12_0, ((MR_Integer) MR_r1 * (MR_Integer) 2));
	MR_tempr2 = MR_r1;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_r2 = MR_ctfield(0, MR_tempr1, 1);
	}
