    ...
    if ((mdb__browse__FileStreamRes_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        if (((MR_tag((MR_Word) mdb__browse__BrowserTerm_9)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word mdb__browse__TypeInfo_12_55;
            MR_Word mdb__browse__Term_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__BrowserTerm_9, (MR_Integer) 0)));
            MR_Box mdb__browse__V_53_53;

            {
              mdb__browse__V_53_53 = mercury__univ__univ_value_1_f_0(&mdb__browse__TypeInfo_12_55, mdb__browse__Term_14);
            }
            {
              mdb__browse__save_term_4_p_0(mdb__browse__TypeInfo_12_55, (MR_Integer) 0, mdb__browse__V_53_53);
            }
            {
        ...
        else
          {
            ...
            if ((mdb__browse__MaybeRes_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              {
                MR_Word mdb__browse__TypeInfo_12_63;
                MR_Word mdb__browse__Result_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__MaybeRes_17, (MR_Integer) 0)));
                MR_Box mdb__browse__V_61_61;

                {
                  mercury__io__write_string_3_p_0((MR_String) "=\n");
                }
                {
                  mdb__browse__V_61_61 = mercury__univ__univ_value_1_f_0(&mdb__browse__TypeInfo_12_63, mdb__browse__Result_18);
                }
                {
                  mdb__browse__save_term_4_p_0(mdb__browse__TypeInfo_12_63, (MR_Integer) 1, mdb__browse__V_61_61);
                }
                {
                  mercury__io__write_string_3_p_0((MR_String) "\n");
                }
