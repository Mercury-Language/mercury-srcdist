...
MR_decl_label10(mdb__browse__args_to_string_verbose_list_9_0, 39,7,8,11,5,15,16,17,20,21)
...
MR_decl_label10(mdb__browse__browser_term_to_string_3_10_0, 9,10,12,2,87,20,22,23,21,29)
...
MR_decl_label10(mdb__browse__deref_subterm_2_4_0, 52,3,9,11,12,13,15,17,10,19)
MR_decl_label6(mdb__browse__deref_subterm_2_4_0, 6,7,5,28,27,30)
MR_decl_label9(mdb__browse__do_portray_7_0, 49,9,8,10,11,3,51,17,19)
MR_decl_label10(mdb__browse__do_print_memory_addr_5_0, 3,6,5,7,8,9,12,15,16,17)
MR_decl_label10(mdb__browse__do_print_memory_addr_5_0, 13,21,22,20,26,27,28,11,32,35)
MR_decl_label1(mdb__browse__do_print_memory_addr_5_0, 31)
MR_decl_label1(mdb__browse__help_3_0, 2)
MR_decl_label4(mdb__browse__interpret_format_options_2_0, 2,5,7,10)
MR_decl_label10(mdb__browse__list_tail_to_string_list_8_0, 2,4,7,77,8,12,6,29,41,42)
MR_decl_label10(mdb__browse__list_tail_to_string_list_8_0, 39,33,48,47,51,91,52,56,58,69)
MR_decl_label7(mdb__browse__maybe_save_term_to_file_xml_5_0, 2,7,6,13,23,24,3)
MR_decl_label10(mdb__browse__portray_6_0, 2,3,4,7,10,11,12,8,16,17)
MR_decl_label10(mdb__browse__portray_6_0, 15,21,22,6,25,27,29,30,31,33)
MR_decl_label1(mdb__browse__portray_6_0, 34)
...
MR_decl_label10(mdb__browse__report_deref_error_5_0, 2,5,6,7,3,11,12,10,16,17)
MR_decl_label10(mdb__browse__run_command_7_0, 50,27,18,53,3,5,6,7,8,10)
MR_decl_label10(mdb__browse__run_command_7_0, 13,15,16,20,21,23,29,30,32,33)
MR_decl_label10(mdb__browse__run_command_7_0, 35,38,39,41,45,46,48,49,2,56)
MR_decl_label1(mdb__browse__run_command_7_0, 55)
...
MR_decl_label9(fn__mdb__browse__dirs_to_string_1_0, 3,8,7,55,15,16,14,20,21)
...
MR_BEGIN_MODULE(mdb__browse_module5)
	...
	MR_init_label10(mdb__browse__browser_term_to_string_3_10_0,9,10,12,2,87,20,22,23,21,29)
...
MR_BEGIN_MODULE(mdb__browse_module6)
	...
	MR_init_label10(mdb__browse__list_tail_to_string_list_8_0,2,4,7,77,8,12,6,29,41,42)
	MR_init_label10(mdb__browse__list_tail_to_string_list_8_0,39,33,48,47,51,91,52,56,58,69)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__browse__browser_term_to_string_5_0);
...
MR_BEGIN_MODULE(mdb__browse_module11)
	...
	MR_init_label10(mdb__browse__args_to_string_verbose_list_9_0,39,7,8,11,5,15,16,17,20,21)
...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,34)
	...
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	MR_tfield(3, MR_tempr1, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr1, 1) = MR_tfield(1, MR_sv(8), 0);
...
MR_BEGIN_MODULE(mdb__browse_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__browse__portray_pretty_5_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module17)
	...
	MR_init_label9(fn__mdb__browse__dirs_to_string_1_0,3,8,7,55,15,16,14,20,21)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module18)
	...
	MR_init_label10(mdb__browse__report_deref_error_5_0,2,5,6,7,3,11,12,10,16,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module22)
	...
	MR_init_label10(mdb__browse__deref_subterm_2_4_0,52,3,9,11,12,13,15,17,10,19)
	MR_init_label6(mdb__browse__deref_subterm_2_4_0,6,7,5,28,27,30)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module24)
	...
	MR_init_label10(mdb__browse__portray_6_0,2,3,4,7,10,11,12,8,16,17)
	MR_init_label10(mdb__browse__portray_6_0,15,21,22,6,25,27,29,30,31,33)
	MR_init_label1(mdb__browse__portray_6_0,34)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module28)
	...
	MR_init_label9(mdb__browse__do_portray_7_0,49,9,8,10,11,3,51,17,19)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module30)
	...
	MR_init_label10(mdb__browse__do_print_memory_addr_5_0,13,21,22,20,26,27,28,11,32,35)
	MR_init_label1(mdb__browse__do_print_memory_addr_5_0,31)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module33)
	...
	MR_init_label10(mdb__browse__run_command_7_0,50,27,18,53,3,5,6,7,8,10)
	MR_init_label10(mdb__browse__run_command_7_0,13,15,16,20,21,23,29,30,32,33)
	MR_init_label10(mdb__browse__run_command_7_0,35,38,39,41,45,46,48,49,2,56)
	MR_init_label1(mdb__browse__run_command_7_0,55)
MR_BEGIN_CODE
...
MR_def_label(mdb__browse__run_command_7_0,33)
	...
	MR_tempr4 = MR_r3;
	MR_tfield(1, MR_tempr1, 2) = MR_tfield(0, MR_tempr4, 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 7);
	MR_sv(2) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_tfield(0, MR_tempr4, 0);
	MR_tfield(0, MR_tempr2, 1) = MR_tfield(1, MR_tempr1, 2);
