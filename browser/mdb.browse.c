...
MR_decl_label8(mdb__browse__deref_subterm_3_0, 2,3,6,5,12,19,20,21)
MR_decl_label8(mdb__browse__deref_subterm_3_0, 22,23,18,17,27,26,30,16)
MR_decl_label3(mdb__browse__deref_subterm_3_0, 34,15,4)
MR_decl_label8(mdb__browse__deref_subterm_2_4_0, 52,3,9,11,12,13,15,17)
MR_decl_label8(mdb__browse__deref_subterm_2_4_0, 10,19,6,7,5,28,27,30)
MR_decl_label8(mdb__browse__do_portray_7_0, 49,9,8,10,11,3,51,17)
MR_decl_label1(mdb__browse__do_portray_7_0, 19)
MR_decl_label8(mdb__browse__do_print_memory_addr_5_0, 3,6,5,7,8,9,12,15)
MR_decl_label8(mdb__browse__do_print_memory_addr_5_0, 16,17,13,21,22,20,26,27)
MR_decl_label5(mdb__browse__do_print_memory_addr_5_0, 28,11,32,35,31)
MR_decl_label1(mdb__browse__help_3_0, 39)
...
MR_decl_label8(mdb__browse__portray_6_0, 16,17,15,21,22,6,25,27)
...
MR_decl_label8(mdb__browse__report_deref_error_5_0, 2,5,6,7,3,11,12,10)
MR_decl_label2(mdb__browse__report_deref_error_5_0, 16,17)
MR_decl_label8(mdb__browse__run_command_7_0, 50,27,18,53,3,5,6,7)
MR_decl_label8(mdb__browse__run_command_7_0, 8,10,13,15,16,20,21,23)
MR_decl_label8(mdb__browse__run_command_7_0, 29,30,32,33,35,38,39,41)
MR_decl_label7(mdb__browse__run_command_7_0, 45,46,48,49,2,56,55)
...
MR_decl_label3(mdb__browse__simplify_rev_dirs_4_0, 3,5,6)
...
MR_decl_label8(fn__mdb__browse__dirs_to_string_1_0, 3,8,7,55,15,16,14,20)
...
static const struct mercury_type_10 mercury_common_10[42] =
{
{
MR_string_const("+1", 2),
MR_tbmkword(0, 0)
...
/*-------------------------------------------------------------------------*/
/* code for 'portray_flat_write_browser_term'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'portray_pretty'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__browse_module17)
	...
	MR_init_label8(fn__mdb__browse__dirs_to_string_1_0,3,8,7,55,15,16,14,20)
...
MR_BEGIN_MODULE(mdb__browse_module18)
	...
	MR_init_label8(mdb__browse__report_deref_error_5_0,2,5,6,7,3,11,12,10)
...
MR_BEGIN_MODULE(mdb__browse_module19)
	...
	MR_init_label3(mdb__browse__simplify_rev_dirs_4_0,3,5,6)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module22)
	...
	MR_init_label8(mdb__browse__deref_subterm_2_4_0,52,3,9,11,12,13,15,17)
	MR_init_label8(mdb__browse__deref_subterm_2_4_0,10,19,6,7,5,28,27,30)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__browse_module23)
	...
	MR_init_label8(mdb__browse__deref_subterm_3_0,2,3,6,5,12,19,20,21)
	MR_init_label8(mdb__browse__deref_subterm_3_0,22,23,18,17,27,26,30,16)
	MR_init_label3(mdb__browse__deref_subterm_3_0,34,15,4)
MR_BEGIN_CODE
...
MR_def_label(mdb__browse__deref_subterm_3_0,12)
	...
	MR_sv(2) = MR_ctfield(1, MR_sv(1), 2);
	MR_r2 = MR_ctfield(1, MR_tempr2, 1);
...
MR_BEGIN_MODULE(mdb__browse_module24)
	...
	MR_init_label8(mdb__browse__portray_6_0,16,17,15,21,22,6,25,27)
...
MR_BEGIN_MODULE(mdb__browse_module30)
	...
	MR_init_label8(mdb__browse__do_print_memory_addr_5_0,3,6,5,7,8,9,12,15)
	MR_init_label8(mdb__browse__do_print_memory_addr_5_0,16,17,13,21,22,20,26,27)
	MR_init_label5(mdb__browse__do_print_memory_addr_5_0,28,11,32,35,31)
MR_BEGIN_CODE
...
MR_def_label(mdb__browse__do_print_memory_addr_5_0,13)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		mdb__browse__do_print_memory_addr_5_0_i26);
...
MR_def_label(mdb__browse__do_print_memory_addr_5_0,20)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		mdb__browse__do_print_memory_addr_5_0_i26);
MR_def_label(mdb__browse__do_print_memory_addr_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		mdb__browse__do_print_memory_addr_5_0_i27);
MR_def_label(mdb__browse__do_print_memory_addr_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(mdb__browser_info__write_string_debugger_4_0,
		mdb__browse__do_print_memory_addr_5_0_i28);
...
MR_def_label(mdb__browse__do_print_memory_addr_5_0,11)
	...
	if (MR_PTAG_TESTR(MR_tempr1,0)) {
		MR_GOTO_LAB(mdb__browse__do_print_memory_addr_5_0_i31);
	}
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	}
	MR_np_call_localret_ent(fn__univ__univ_value_1_0,
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(string__format_3_0,
		mdb__browse__do_print_memory_addr_5_0_i35);
MR_def_label(mdb__browse__do_print_memory_addr_5_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(mdb__browse__do_print_memory_addr_5_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(mdb__browse_module31)
	...
	MR_init_label1(mdb__browse__help_3_0,39)
MR_BEGIN_CODE
...
MR_def_static(mdb__browse__help_3_0)
	...
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,10,41);
	MR_np_call_localret_ent(string__append_list_2_0,
		mdb__browse__help_3_0_i39);
MR_def_label(mdb__browse__help_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mdb__browse_module33)
	...
	MR_init_label8(mdb__browse__run_command_7_0,50,27,18,53,3,5,6,7)
	MR_init_label8(mdb__browse__run_command_7_0,8,10,13,15,16,20,21,23)
	MR_init_label8(mdb__browse__run_command_7_0,29,30,32,33,35,38,39,41)
	MR_init_label7(mdb__browse__run_command_7_0,45,46,48,49,2,56,55)
MR_BEGIN_CODE
...
MR_def_label(mdb__browse__run_command_7_0,27)
	...
	MR_np_call_localret_ent(mdb__browse__do_portray_7_0,
		mdb__browse__run_command_7_0_i49);
MR_def_label(mdb__browse__run_command_7_0,18)
	...
	MR_np_call_localret_ent(mdb__browse__do_print_memory_addr_5_0,
		mdb__browse__run_command_7_0_i49);
MR_def_label(mdb__browse__run_command_7_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(mdb__browse__run_command_7_0,29)
	...
	MR_np_call_localret_ent(mdb__browser_info__write_path_4_0,
		mdb__browse__run_command_7_0_i30);
...
MR_def_label(mdb__browse__run_command_7_0,33)
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(mdb__browse__run_command_7_0_i35);
	}
...
MR_def_label(mdb__browse__run_command_7_0,35)
	...
	MR_np_call_localret_ent(mdb__browse__change_dir_3_0,
		mdb__browse__run_command_7_0_i38);
MR_def_label(mdb__browse__run_command_7_0,38)
	...
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(mdb__browse__deref_subterm_3_0,
		mdb__browse__run_command_7_0_i39);
MR_def_label(mdb__browse__run_command_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(mdb__browse__run_command_7_0_i41);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(mdb__browse__run_command_7_0,48)
	...
	MR_np_call_localret_ent(mdb__browser_info__write_string_debugger_4_0,
		mdb__browse__run_command_7_0_i49);
MR_def_label(mdb__browse__run_command_7_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_sv(2) = MR_sv(4);
