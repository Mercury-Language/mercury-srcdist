  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_52 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_47, (MR_Integer) 0))));
          Functor_49 = ((MR_String) ((MR_hl_field(0, Var_52, (MR_Integer) 0))));
          Args_51 = ((MR_Word) ((MR_hl_field(0, Var_52, (MR_Integer) 2))));
          succeeded = MR_TRUE;
        }
      }
    }
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_99 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_94, (MR_Integer) 0))));
                  Functor_96 = ((MR_String) ((MR_hl_field(0, Var_99, (MR_Integer) 0))));
                  Args_98 = ((MR_Word) ((MR_hl_field(0, Var_99, (MR_Integer) 2))));
                  succeeded = MR_TRUE;
                }
              }
            }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_34 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_29, (MR_Integer) 0))));
          Functor_31 = ((MR_String) ((MR_hl_field(0, Var_34, (MR_Integer) 0))));
          Args_33 = ((MR_Word) ((MR_hl_field(0, Var_34, (MR_Integer) 2))));
          succeeded = MR_TRUE;
        }
      }
    }
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_57 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_52, (MR_Integer) 0))));
                Functor_54 = ((MR_String) ((MR_hl_field(0, Var_57, (MR_Integer) 0))));
                Args_56 = ((MR_Word) ((MR_hl_field(0, Var_57, (MR_Integer) 2))));
                succeeded = MR_TRUE;
              }
            }
          }
  ...
  MR_String * Str_20)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_66 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_61, (MR_Integer) 0))));
          Functor_63 = ((MR_String) ((MR_hl_field(0, Var_66, (MR_Integer) 0))));
          Args_65 = ((MR_Word) ((MR_hl_field(0, Var_66, (MR_Integer) 2))));
          succeeded = MR_TRUE;
        }
      }
    }
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_String HeadArg_67 = ((MR_String) ((MR_hl_field(1, ArgStrs_29, (MR_Integer) 0))));
        MR_Word TailArgs_68 = ((MR_Word) ((MR_hl_field(1, ArgStrs_29, (MR_Integer) 1))));
        MR_String Var_70;
        MR_String Var_71;
        MR_String Var_72;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_79 = ((MR_Tuple) ((MR_hl_field(1, MaybeFunctorArityArgs_74, (MR_Integer) 0))));
              Functor_76 = ((MR_String) ((MR_hl_field(0, Var_79, (MR_Integer) 0))));
              Args_78 = ((MR_Word) ((MR_hl_field(0, Var_79, (MR_Integer) 2))));
              succeeded = MR_TRUE;
            }
          }
        }
  ...
  MR_Word Params_8)
{
  ...
  Var_16 = ((MR_Integer) ((MR_hl_field(0, Params_8, (MR_Integer) 2))));
  Var_20 = ((MR_Integer) ((MR_hl_field(0, Params_8, (MR_Integer) 3))));
