...
{
  {
    ...
    {
      MR_String mdb__browse__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 0)));
      MR_String mdb__browse__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word mdb__browse__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word mdb__browse__Var_8;

      mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__browse__Var_8, mdb__browse__ArgX1_4, mdb__browse__ArgY1_5);
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &mdb__browse_scalar_common_4[1], mdb__browse__HeadVar__1_1, ((MR_Box) (mdb__browse__ArgX2_6)), ((MR_Box) (mdb__browse__ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_String mdb__browse__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__1_1, (MR_Integer) 0)));
      MR_String mdb__browse__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word mdb__browse__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 1)));

      mdb__browse__succeeded = (strcmp(mdb__browse__ArgX1_3, mdb__browse__ArgY1_4) == 0);
      if (mdb__browse__succeeded)
      {
        mdb__browse__TypeInfo_9_9 = (MR_Word) &mdb__browse_scalar_common_4[1];
        mdb__browse__succeeded = mercury__builtin__unify_2_p_0(mdb__browse__TypeInfo_9_9, ((MR_Box) (mdb__browse__ArgX2_5)), ((MR_Box) (mdb__browse__ArgY2_6)));
      }
    }
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__browse__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word mdb__browse__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__3_3, (MR_Integer) 2)));
      MR_Word mdb__browse__Var_10;

      mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__browse__Var_10, mdb__browse__ArgX1_4, mdb__browse__ArgY1_5);
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &mdb__browse_scalar_common_4[1], &mdb__browse__Var_11, ((MR_Box) (mdb__browse__ArgX2_6)), ((MR_Box) (mdb__browse__ArgY2_7)));
        mdb__browse__succeeded = (mdb__browse__Var_11 == (MR_Integer) 0);
        mdb__browse__succeeded = !(mdb__browse__succeeded);
        if (mdb__browse__succeeded)
          *mdb__browse__HeadVar__1_1 = mdb__browse__Var_11;
        else
          mercury__univ____Compare____univ_0_0(mdb__browse__HeadVar__1_1, mdb__browse__ArgX3_8, mdb__browse__ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word mdb__browse__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__1_1, (MR_Integer) 2)));
      MR_Word mdb__browse__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 2)));

      mdb__browse__succeeded = (strcmp(mdb__browse__ArgX1_3, mdb__browse__ArgY1_4) == 0);
      if (mdb__browse__succeeded)
      {
        mdb__browse__TypeInfo_11_11 = (MR_Word) &mdb__browse_scalar_common_4[1];
        mdb__browse__succeeded = mercury__builtin__unify_2_p_0(mdb__browse__TypeInfo_11_11, ((MR_Box) (mdb__browse__ArgX2_5)), ((MR_Box) (mdb__browse__ArgY2_6)));
        if (mdb__browse__succeeded)
          mdb__browse__succeeded = mercury__univ____Unify____univ_0_0(mdb__browse__ArgX3_7, mdb__browse__ArgY3_8);
      }
    }
    return mdb__browse__succeeded;
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__browse__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      {
        MR_Word mdb__browse__ArgY1_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdb__browse__ArgY2_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__browse__Var_16;

        mercury__builtin__compare_3_p_0((MR_Word) &mdb__browse_scalar_common_4[0], &mdb__browse__Var_16, ((MR_Box) (mdb__browse__Var_23)), ((MR_Box) (mdb__browse__ArgY1_13)));
        mdb__browse__succeeded = (mdb__browse__Var_16 == (MR_Integer) 0);
        mdb__browse__succeeded = !(mdb__browse__succeeded);
        if (mdb__browse__succeeded)
          *mdb__browse__HeadVar__1_1 = mdb__browse__Var_16;
        else
          mdb__browser_info____Compare____down_dir_0_0(mdb__browse__HeadVar__1_1, mdb__browse__Var_22, mdb__browse__ArgY2_15);
      }
      else
    ...
    else
    {
      ...
      {
        MR_Box mdb__browse__ArgY1_5 = (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__3_3, (MR_Integer) 0));

        mercury__builtin__compare_3_p_0(mdb__browse__TypeInfo_for_T_19, mdb__browse__HeadVar__1_1, mdb__browse__Var_24, mdb__browse__ArgY1_5);
      }
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdb__browse__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_Word mdb__browse__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word mdb__browse__ArgY1_6;
      MR_Word mdb__browse__ArgX2_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mdb__browse__ArgY2_8;

      mdb__browse__succeeded = ((MR_tag((MR_Word) mdb__browse__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (mdb__browse__succeeded)
      {
        mdb__browse__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__2_2, (MR_Integer) 0)));
        mdb__browse__ArgY2_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__HeadVar__2_2, (MR_Integer) 1)));
        mdb__browse__TypeInfo_12_12 = (MR_Word) &mdb__browse_scalar_common_4[0];
        mdb__browse__succeeded = mercury__builtin__unify_2_p_0(mdb__browse__TypeInfo_12_12, ((MR_Box) (mdb__browse__ArgX1_5)), ((MR_Box) (mdb__browse__ArgY1_6)));
        if (mdb__browse__succeeded)
          mdb__browse__succeeded = mdb__browser_info____Unify____down_dir_0_0(mdb__browse__ArgX2_7, mdb__browse__ArgY2_8);
      }
    }
    else
    {
      MR_Box mdb__browse__ArgX1_3 = (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__1_1, (MR_Integer) 0));
      MR_Box mdb__browse__ArgY1_4;

      mdb__browse__succeeded = ((MR_tag((MR_Word) mdb__browse__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
      if (mdb__browse__succeeded)
      {
        mdb__browse__ArgY1_4 = (MR_hl_field(MR_mktag(0), mdb__browse__HeadVar__2_2, (MR_Integer) 0));
        mdb__browse__succeeded = mercury__builtin__unify_2_p_0(mdb__browse__TypeInfo_for_T_11, mdb__browse__ArgX1_3, mdb__browse__ArgY1_4);
      }
    }
    return mdb__browse__succeeded;
  }
  ...
  MR_String mdb__browse__HeadVar__1_1)
{
  {
    MR_bool mdb__browse__succeeded;
    MR_Integer mdb__browse__lo_0 = (MR_Integer) 0;
    MR_Integer mdb__browse__hi_1 = (MR_Integer) 5;
    ...
    do
    {
      ...
      mdb__browse__result_3 = MR_strcmp(mdb__browse__HeadVar__1_1, ((&mdb__browse_vector_common_8[14 + mdb__browse__mid_2]))->mdb__browse__vector_common_type_8_0__vct_8_f_0);
    ...
    switch (MR_tag((MR_Word) mdb__browse__Command_9)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(mdb__browse__Command_9)) {
          ...
          case (MR_Integer) 2:
            {
              mdb__browse__set_path_3_p_0((MR_Word) &mdb__browse_scalar_common_5[9], mdb__browse__STATE_VARIABLE_Info_0_29, mdb__browse__STATE_VARIABLE_Info_30);
              *mdb__browse__Quit_10 = (MR_Integer) 0;
            }
            break;
          case (MR_Integer) 3:
  ...
  MR_Word mdb__browse__Dirs_8)
{
  ...
  else
  {
    ...
    mdb__browse__ModeStr_12 = ((&mdb__browse_vector_common_8[10 + mdb__browse__Mode_11]))->mdb__browse__vector_common_type_8_0__vct_8_f_0;
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) mdb__browse__BrowserTerm_14)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) &mdb__browse_scalar_common_5[8], (MR_Integer) 2, mdb__browse__Addr_17, &mdb__browse__Var_48);
...
{
  {
    ...
    {
      *mdb__browse__MaybeMaybeFormat_4 = (MR_Word) &mdb__browse_scalar_common_5[6];
    }
    else
    {
      ...
      {
        MR_Word mdb__browse__Format_8 = ((&mdb__browse_vector_common_9[0 + mdb__browse__Var_24]))->mdb__browse__vector_common_type_9_0__vct_9_f_0;
        MR_Word mdb__browse__Var_16;
      ...
      {
        *mdb__browse__MaybeMaybeFormat_4 = (MR_Word) MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[7]);
      }
    }
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) mdb__browse__Step_13)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          {
            mdb__browse__mid_2 = (((mdb__browse__lo_0 + mdb__browse__hi_1)) / (MR_Integer) 2);
            mdb__browse__result_3 = MR_strcmp(mdb__browse__Name_18, ((&mdb__browse_vector_common_8[4 + mdb__browse__mid_2]))->mdb__browse__vector_common_type_8_0__vct_8_f_0);
            if ((mdb__browse__result_3 == (MR_Integer) 0))
            {
              mdb__browse__succeeded = MR_TRUE;
              /* jump out of search loop */
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Integer mdb__browse__lo_0 = (MR_Integer) 0;
        MR_Integer mdb__browse__hi_1 = (MR_Integer) 3;
        MR_Integer mdb__browse__mid_2;
        MR_Integer mdb__browse__result_3;
        ...
        {
          mdb__browse__mid_2 = (((mdb__browse__lo_0 + mdb__browse__hi_1)) / (MR_Integer) 2);
          mdb__browse__result_3 = MR_strcmp(mdb__browse__Functor_41, ((&mdb__browse_vector_common_8[0 + mdb__browse__mid_2]))->mdb__browse__vector_common_type_8_0__vct_8_f_0);
          if ((mdb__browse__result_3 == (MR_Integer) 0))
          {
            mdb__browse__succeeded = MR_TRUE;
            /* jump out of search loop */
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), mdb__browse__Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[47])));
          }
          {
            mdb__browse__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mdb__browse__Var_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[3])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), mdb__browse__Var_81, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[5])));
...
{
  {
    ...
    if ((mdb__browse__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      mdb__browse__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[1]);
    }
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), mdb__browse__Var_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[2])));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), mdb__browse__Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
              }
              {
                mdb__browse__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    if ((mdb__browse__Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      mercury__string__int_to_string_2_p_0(mdb__browse__HeadVar__3_3, &mdb__browse__ArgNumS_27);
      {
        ...
        MR_hl_field(MR_mktag(1), mdb__browse__Var_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[46])));
      }
    ...
    else
    {
      ...
      mercury__string__int_to_string_2_p_0(mdb__browse__HeadVar__3_3, &mdb__browse__ArgNumS_53);
      {
        ...
        MR_hl_field(MR_mktag(1), mdb__browse__Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[46])));
      }
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), mdb__browse__Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
              }
              {
      ...
      else
      {
        ...
        if (!((mdb__browse__Args_38 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) "(");
          {
            ...
            MR_hl_field(MR_mktag(0), mdb__browse__Var_52, 0) = ((MR_Box) (&mdb__browse_scalar_common_7[0]));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), mdb__browse__Var_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
              }
              {
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), mdb__browse__Var_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
                }
                {
    ...
    else
    {
      ...
      else
      {
        ...
        if (mdb__browse__succeeded)
        {
          ...
          {
            *mdb__browse__Size_13 = mdb__browse__Size0_12;
            *mdb__browse__TailStrs_16 = (MR_Word) MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[45]);
          }
        }
        else
        {
                ...
                case (MR_Integer) 1:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), mdb__browse__Var_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
                    }
                    {
                      mdb__browse__Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (mdb__browse__succeeded)
    {
      ...
      mercury__list__append_3_p_1((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, mdb__browse__TailStrs_27, (MR_Word) MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[43]), &mdb__browse__Strs_28);
      {
        mdb__browse__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        else
        {
          ...
          mdb__browse__Var_71 = mdb__browse__comma_string_list_1_f_0(mdb__browse__ArgStrs_29);
          {
            ...
            MR_hl_field(MR_mktag(1), mdb__browse__Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[44])));
          }
          {
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), mdb__browse__Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
              }
              {
                mdb__browse__Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), mdb__browse__Var_36, 0) = ((MR_Box) ((MR_String) "/"));
