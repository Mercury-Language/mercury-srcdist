...
{
  {
        ...
        if (mdb__browse__succeeded)
          {
            ...
            if (mdb__browse__succeeded)
              {
                mdb__browse__V_41_41 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), mdb__browse__MaybeFunctorArityArgs_29, (MR_Integer) 0)));
                mdb__browse__Functor_31 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__V_41_41, (MR_Integer) 0)));
                mdb__browse___Arity_32 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__browse__V_41_41, (MR_Integer) 1)));
                mdb__browse__Args0_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__V_41_41, (MR_Integer) 2)));
                mdb__browse__succeeded = MR_TRUE;
              }
          }
      }
    if (mdb__browse__succeeded)
      {
        ...
        if ((mdb__browse__MaybeReturn_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mdb__browse__V_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mdb__browse__V_42_42, 0) = ((MR_Box) (mdb__browse__Return_34));
              MR_hl_field(MR_mktag(1), mdb__browse__V_42_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              mercury__list__append_3_p_1((MR_Word) &mercury__univ__univ__type_ctor_info_univ_0, mdb__browse__Args0_33, mdb__browse__V_42_42, &mdb__browse__Args_35);
            }
          }
        {
        ...
        {
          mdb__browse__V_46_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdb__browse__V_46_46, 0) = ((MR_Box) (mdb__browse__Functor_31));
          MR_hl_field(MR_mktag(1), mdb__browse__V_46_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mdb__browse__Frame_18 = mdb__frame__vglue_2_f_0(mdb__browse__V_46_46, mdb__browse__ArgsFrame_39);
        }
      }
    else
      {
              ...
              case (MR_Integer) 0:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), mdb__browse__V_60_60, 0) = ((MR_Box) (mdb__browse__ArityStr_56));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_60_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    mdb__browse__V_58_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_58_58, 0) = ((MR_Box) ((MR_String) "/"));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_58_58, 1) = ((MR_Box) (mdb__browse__V_60_60));
                  }
                  {
                    mdb__browse__V_57_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_57_57, 0) = ((MR_Box) (mdb__browse__Functor_53));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_57_57, 1) = ((MR_Box) (mdb__browse__V_58_58));
                  }
                  {
                    mercury__string__append_list_2_p_0(mdb__browse__V_57_57, &mdb__browse__Line_40);
                  }
                }
                break;
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), mdb__browse__V_65_65, 0) = ((MR_Box) (mdb__browse__ArityStr_56));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_65_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[43])));
                  }
                  {
                    mdb__browse__V_63_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_63_63, 0) = ((MR_Box) ((MR_String) "/"));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_63_63, 1) = ((MR_Box) (mdb__browse__V_65_65));
                  }
                  {
                    mdb__browse__V_62_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_62_62, 0) = ((MR_Box) (mdb__browse__Functor_53));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_62_62, 1) = ((MR_Box) (mdb__browse__V_63_63));
                  }
                  {
                    mercury__string__append_list_2_p_0(mdb__browse__V_62_62, &mdb__browse__Line_40);
                  }
                }
                break;
            }
    ...
    {
      mdb__browse__V_20_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__browse__V_20_20, 0) = ((MR_Box) (mdb__browse__X_12));
      MR_hl_field(MR_mktag(0), mdb__browse__V_20_20, 1) = ((MR_Box) (mdb__browse__Y_13));
    }
    {
      mdb__browse__ClippedFrame_19 = mdb__frame__clip_2_f_0(mdb__browse__V_20_20, mdb__browse__Frame_18);
    }
    {
...
{
  {
    ...
    if ((mdb__browse__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          mdb__browser_info__limited_deconstruct_browser_term_cc_5_p_0(mdb__browse__HeadVar__1_1, mdb__browse__V_28_28, mdb__browse__HeadVar__3_3, &mdb__browse__MaybeFunctorArityArgs_37, &mdb__browse__MaybeReturn_38);
        }
            ...
            if (mdb__browse__succeeded)
              {
                ...
                if (mdb__browse__succeeded)
                  {
                    mdb__browse__V_42_42 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), mdb__browse__MaybeFunctorArityArgs_37, (MR_Integer) 0)));
                    mdb__browse__Functor_39 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__V_42_42, (MR_Integer) 0)));
                    mdb__browse___Arity_40 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__browse__V_42_42, (MR_Integer) 1)));
                    mdb__browse__Args_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__V_42_42, (MR_Integer) 2)));
                    mdb__browse__succeeded = MR_TRUE;
                  }
              }
          }
        if (mdb__browse__succeeded)
        ...
        else
          {
            ...
            {
              mdb__browser_info__functor_browser_term_cc_5_p_0(mdb__browse__HeadVar__1_1, mdb__browse__V_28_28, &mdb__browse__Functor_46, &mdb__browse__Arity_47, &mdb__browse__IsFunc_48);
            }
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      {
                        mdb__browse__V_53_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_53_53, 0) = ((MR_Box) (mdb__browse__ArityStr_49));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_53_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        mdb__browse__V_51_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_51_51, 0) = ((MR_Box) ((MR_String) "/"));
                      ...
                      {
                        mdb__browse__V_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_50_50, 0) = ((MR_Box) (mdb__browse__Functor_46));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_50_50, 1) = ((MR_Box) (mdb__browse__V_51_51));
                      }
                      {
                        mercury__string__append_list_2_p_0(mdb__browse__V_50_50, &mdb__browse__Str_26);
                      }
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      {
                        mdb__browse__V_58_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_58_58, 0) = ((MR_Box) (mdb__browse__ArityStr_49));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_58_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[43])));
                      }
                      {
                        mdb__browse__V_56_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_56_56, 0) = ((MR_Box) ((MR_String) "/"));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_56_56, 1) = ((MR_Box) (mdb__browse__V_58_58));
                      }
                      {
                        mdb__browse__V_55_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_55_55, 0) = ((MR_Box) (mdb__browse__Functor_46));
                        MR_hl_field(MR_mktag(1), mdb__browse__V_55_55, 1) = ((MR_Box) (mdb__browse__V_56_56));
                      }
                      {
                        mercury__string__append_list_2_p_0(mdb__browse__V_55_55, &mdb__browse__Str_26);
                      }
                    }
                    break;
                }
        ...
        if (mdb__browse__succeeded)
          {
            ...
            if (mdb__browse__succeeded)
              {
                mdb__browse__V_27_27 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), mdb__browse__MaybeFunctorArityArgs_22, (MR_Integer) 0)));
                mdb__browse__Functor_24 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__browse__V_27_27, (MR_Integer) 0)));
                mdb__browse___Arity_25 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__browse__V_27_27, (MR_Integer) 1)));
                mdb__browse__Args_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__browse__V_27_27, (MR_Integer) 2)));
                mdb__browse__succeeded = MR_TRUE;
              }
          }
      }
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    mdb__browse__V_38_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_38_38, 0) = ((MR_Box) (mdb__browse__ArityStr_34));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_38_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    mdb__browse__V_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_36_36, 0) = ((MR_Box) ((MR_String) "/"));
                  ...
                  {
                    mdb__browse__V_35_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_35_35, 0) = ((MR_Box) (mdb__browse__Functor_31));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_35_35, 1) = ((MR_Box) (mdb__browse__V_36_36));
                  }
                  {
                    mercury__string__append_list_2_p_0(mdb__browse__V_35_35, mdb__browse__Str_10);
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  {
                    mdb__browse__V_43_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_43_43, 0) = ((MR_Box) (mdb__browse__ArityStr_34));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_43_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[43])));
                  }
                  {
                    mdb__browse__V_41_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_41_41, 0) = ((MR_Box) ((MR_String) "/"));
                  ...
                  {
                    mdb__browse__V_40_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_40_40, 0) = ((MR_Box) (mdb__browse__Functor_31));
                    MR_hl_field(MR_mktag(1), mdb__browse__V_40_40, 1) = ((MR_Box) (mdb__browse__V_41_41));
                  }
                  {
                    mercury__string__append_list_2_p_0(mdb__browse__V_40_40, mdb__browse__Str_10);
                  }
                }
                break;
            }
...
{
  {
    ...
    MR_Integer mdb__browse__V_48_48;
    MR_Word mdb__browse__V_49_49;
    ...
    else
      {
        ...
        if (mdb__browse__succeeded)
        ...
        else
          {
            ...
            {
              mdb__browse__V_61_61 = mercury__string__split_at_char_2_f_0((MR_Char) 46, mdb__browse__Functor_41);
            }
            {
              mdb__browse__FunctorDoc_56 = mdb__browse__qualified_functor_to_doc_1_f_0(mdb__browse__V_61_61);
            }
            if ((mdb__browse__Args_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  mdb__browse__V_69_69 = mercury__pretty_printer__group_1_f_0((MR_Word) MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[41]));
                }
                {
                  mdb__browse__V_68_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), mdb__browse__V_68_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(3), mdb__browse__V_68_68, 1) = ((MR_Box) (mdb__browse__Args_42));
                  MR_hl_field(MR_mktag(3), mdb__browse__V_68_68, 2) = ((MR_Box) (mdb__browse__V_69_69));
                }
                {
                  mdb__browse__V_67_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_67_67, 0) = ((MR_Box) (mdb__browse__V_68_68));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_67_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[42])));
                }
                {
                  mdb__browse__V_64_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_64_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[5])));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_64_64, 1) = ((MR_Box) (mdb__browse__V_67_67));
                }
                {
                  mdb__browse__V_63_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_63_63, 0) = ((MR_Box) (mdb__browse__FunctorDoc_56));
                  MR_hl_field(MR_mktag(1), mdb__browse__V_63_63, 1) = ((MR_Box) (mdb__browse__V_64_64));
                }
                {
                  mdb__browse__Doc0_55 = mercury__pretty_printer__indent_1_f_0(mdb__browse__V_63_63);
                }
              }
          }
        if ((mdb__browse__MaybeReturn_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mdb__browse__V_86_86 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), mdb__browse__V_86_86, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), mdb__browse__V_86_86, 1) = ((MR_Box) (mdb__browse__Return_59));
            }
            {
              mdb__browse__V_85_85 = mercury__pretty_printer__format_arg_1_f_0(mdb__browse__V_86_86);
            }
            {
              mdb__browse__V_84_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mdb__browse__V_84_84, 0) = ((MR_Box) (mdb__browse__V_85_85));
              MR_hl_field(MR_mktag(1), mdb__browse__V_84_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              mdb__browse__V_81_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mdb__browse__V_81_81, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[7])));
              MR_hl_field(MR_mktag(1), mdb__browse__V_81_81, 1) = ((MR_Box) (mdb__browse__V_84_84));
            }
            {
              mdb__browse__V_80_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mdb__browse__V_80_80, 0) = ((MR_Box) (mdb__browse__Doc0_55));
              MR_hl_field(MR_mktag(1), mdb__browse__V_80_80, 1) = ((MR_Box) (mdb__browse__V_81_81));
            }
            {
              mdb__browse__Doc_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), mdb__browse__Doc_40, 0) = ((MR_Box) (mdb__browse__V_80_80));
            }
          }
      }
    {
    ...
    mdb__browse__V_48_48 = (MR_Integer) 0;
    mdb__browse__succeeded = (mdb__browse__V_17_17 > mdb__browse__V_48_48);
    if (mdb__browse__succeeded)
      {
      ...
      }
    {
      ...
      MR_hl_field(MR_mktag(0), mdb__browse__Params_46, 0) = ((MR_Box) (mdb__browse__V_12_12));
      MR_hl_field(MR_mktag(0), mdb__browse__Params_46, 1) = ((MR_Box) (mdb__browse__V_19_19));
      MR_hl_field(MR_mktag(0), mdb__browse__Params_46, 2) = ((MR_Box) (mdb__browse__Limit_45));
    }
    mdb__browse__V_49_49 = (MR_Integer) 2;
    {
      mercury__pretty_printer__put_doc_7_p_1((MR_Word) &mdb__browse_scalar_common_3[2], ((MR_Box) (mdb__browse__Debugger_6)), mdb__browse__V_49_49, mdb__browse__Formatters_44, mdb__browse__Params_46, mdb__browse__Doc_40, ((MR_Box) ((MR_Integer) 0)), &mdb__browse__conv0_STATE_VARIABLE_IO_11);
    }
  }
}
...
{
  {
    ...
    {
      mdb__browse__browser_term_to_string_verbose_7_p_0(mdb__browse__BrowserDb_11, mdb__browse__BrowserTerm_7, mdb__browse__V_16_16, mdb__browse__V_21_21, mdb__browse__V_22_22, mdb__browse__V_23_23, &mdb__browse__Str_12);
    }
    {
...
{
  {
    ...
    if (mdb__browse__succeeded)
    ...
    else
      {
        ...
        {
          mdb__browse__browser_term_to_string_5_p_0(mdb__browse__BrowserDb_12, mdb__browse__BrowserTerm_7, mdb__browse__V_20_20, mdb__browse__V_23_23, &mdb__browse__Str_13);
        }
        {
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdb__browse__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mdb__browse__succeeded = mdb__browse__dynamic_cast_to_list_2_p_0(mdb__browse__TypeInfo_12_28, &mdb__browse__TypeInfo_53_76, mdb__browse__V_26_26, &mdb__browse__List_34);
            }
            if (mdb__browse__succeeded)
              if ((mdb__browse__List_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              else
                {
                  ...
                  MR_Integer mdb__browse__V_51_51;
                  ...
                  mdb__browse__V_51_51 = (mdb__browse__HeadVar__1_1 + (MR_Integer) 1);
                  {
                    mdb__browse__save_args_4_p_0(mdb__browse__V_51_51, mdb__browse__Univs_40);
                  }
                  {
                    mercury__io__write_string_3_p_0((MR_String) "\n");
                  }
            ...
            else
              {
                ...
                {
                  mercury__deconstruct__deconstruct_5_p_2(mdb__browse__TypeInfo_12_28, mdb__browse__V_26_26, (MR_Integer) 2, &mdb__browse__Functor_41, &mdb__browse___Arity_42, &mdb__browse__Args_43);
                }
                {
                  mdb__browse__write_indent_3_p_0(mdb__browse__HeadVar__1_1);
                }
                ...
                if ((mdb__browse__Args_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    mdb__browse__V_67_67 = (mdb__browse__HeadVar__1_1 + (MR_Integer) 1);
                    {
                      mdb__browse__save_args_4_p_0(mdb__browse__V_67_67, mdb__browse__Args_43);
                    }
                    {
                      mercury__io__write_string_3_p_0((MR_String) "\n");
                    }
            ...
            if ((mdb__browse__Univs_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word mdb__browse__HeadVar__2__tmp_copy_2 = mdb__browse__Univs_11;
...
{
  {
    ...
    MR_Word mdb__browse__V_18_18;
    MR_Box mdb__browse__V_17_17;
    MR_Box mdb__browse__V_11_11;
    MR_Box mdb__browse__conv0_L_4;

    {
      mdb__browse__V_10_10 = mercury__type_desc__type_of_1_f_0(mdb__browse__TypeInfo_for_T1_14);
    }
    {
      mdb__browse__V_8_8 = mercury__type_desc__type_args_1_f_0(mdb__browse__V_10_10);
    }
    mdb__browse__succeeded = ((MR_tag((MR_Word) mdb__browse__V_8_8)) == (MR_mktag((MR_Integer) 1)));
    if (mdb__browse__succeeded)
      {
        mdb__browse__ArgTypeDesc_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__V_8_8, (MR_Integer) 0)));
        mdb__browse__V_18_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__browse__V_8_8, (MR_Integer) 1)));
        mdb__browse__TypeInfo_19_19 = (MR_Word) &mdb__browse_scalar_common_4[2];
        {
          mdb__browse__succeeded = mercury__builtin__unify_2_p_0(mdb__browse__TypeInfo_19_19, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), ((MR_Box) (mdb__browse__V_18_18)));
        }
        if (mdb__browse__succeeded)
          {
            {
...
{
  {
    MR_bool mdb__browse__succeeded;
    MR_Word mdb__browse__TypeInfo_12_12;
    MR_Box mdb__browse__V_10_10;
    MR_Word mdb__browse__TypeInfo_53_60;
    MR_Word mdb__browse__List_18;

    {
      mdb__browse__V_10_10 = mercury__univ__univ_value_1_f_0(&mdb__browse__TypeInfo_12_12, mdb__browse__Univ_6);
    }
    {
      mdb__browse__succeeded = mdb__browse__dynamic_cast_to_list_2_p_0(mdb__browse__TypeInfo_12_12, &mdb__browse__TypeInfo_53_60, mdb__browse__V_10_10, &mdb__browse__List_18);
    }
    if (mdb__browse__succeeded)
      if ((mdb__browse__List_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
        {
          ...
          MR_Integer mdb__browse__V_35_35;
          ...
          mdb__browse__V_35_35 = (mdb__browse__Indent_5 + (MR_Integer) 1);
          {
            mdb__browse__save_args_4_p_0(mdb__browse__V_35_35, mdb__browse__Univs_24);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
    ...
    else
      {
        ...
        {
          mercury__deconstruct__deconstruct_5_p_2(mdb__browse__TypeInfo_12_12, mdb__browse__V_10_10, (MR_Integer) 2, &mdb__browse__Functor_25, &mdb__browse___Arity_26, &mdb__browse__Args_27);
        }
        {
          mdb__browse__write_indent_3_p_0(mdb__browse__Indent_5);
        }
        ...
        if ((mdb__browse__Args_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            mdb__browse__V_51_51 = (mdb__browse__Indent_5 + (MR_Integer) 1);
            {
              mdb__browse__save_args_4_p_0(mdb__browse__V_51_51, mdb__browse__Args_27);
            }
            {
              mercury__io__write_string_3_p_0((MR_String) "\n");
            }
