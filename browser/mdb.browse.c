...
MR_decl_label4(mdb__browse__portray_pretty_5_0, 3,5,6,7)
...
static const struct mercury_type_11 mercury_vector_common_11_0[4] =
{
{
...
MR_BEGIN_MODULE(mdb__browse_module14)
	...
	MR_init_label4(mdb__browse__portray_pretty_5_0,3,5,6,7)
MR_BEGIN_CODE
...
MR_def_static(mdb__browse__portray_pretty_5_0)
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(mdb__browse__portray_pretty_5_0_i3);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_sv(6) = (MR_Word) MR_TAG_COMMON(0,8,2);
	}
	MR_np_call_localret_ent(pretty_printer__get_default_formatter_map_3_0,
		mdb__browse__portray_pretty_5_0_i6);
MR_def_label(mdb__browse__portray_pretty_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr2 = MR_r2;
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(mdb__browse__portray_pretty_5_0_i5);
	}
	...
	MR_np_call_localret_ent(pretty_printer__get_default_formatter_map_3_0,
		mdb__browse__portray_pretty_5_0_i6);
MR_def_label(mdb__browse__portray_pretty_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_tfield(3, MR_tempr2, 1) = MR_ctfield(1, MR_r5, 0);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = MR_tempr2;
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(1,5,1);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr3;
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_sv(7), 2, (MR_Integer) 1);
	MR_tfield(2, MR_sv(7), 0) = MR_tempr3;
	MR_sv(1) = MR_r1;
	MR_tempr5 = MR_r3;
	...
	MR_np_call_localret_ent(pretty_printer__get_default_formatter_map_3_0,
		mdb__browse__portray_pretty_5_0_i6);
MR_def_label(mdb__browse__portray_pretty_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LE(MR_sv(4),0)) {
		MR_GOTO_LAB(mdb__browse__portray_pretty_5_0_i7);
	}
...
MR_def_label(mdb__browse__portray_pretty_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r6, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r6, 0) = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(2);
	MR_r5 = MR_sv(5);
	MR_r3 = MR_r1;
...
MR_def_label(mdb__browse__write_term_mode_debugger_5_0,5)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_11_0, ((MR_Integer) MR_r1 * (MR_Integer) 2));
	MR_tempr2 = MR_r1;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_r2 = MR_ctfield(0, MR_tempr1, 1);
	}
