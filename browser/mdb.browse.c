...
MR_def_label(mdb__browse__browser_term_to_string_pretty_8_0,34)
	...
	MR_tfield(3, MR_r2, 1) = MR_tfield(1, MR_sv(8), 0);
...
MR_def_label(mdb__browse__run_command_7_0,33)
	...
	MR_tempr3 = MR_r3;
	MR_tfield(1, MR_tempr1, 2) = MR_tfield(0, MR_tempr3, 1);
...
MR_BEGIN_MODULE(mdb__browse_module63)
