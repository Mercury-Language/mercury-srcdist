    ...
    switch (MR_tag((MR_Word) Command_9)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Command_9)) {
          ...
          case (MR_Integer) 2:
            {
              mdb__browse__set_path_3_p_0((MR_Word) (&mdb__browse_scalar_common_5[9]), STATE_VARIABLE_Info_0_31, STATE_VARIABLE_Info_32);
              *Quit_10 = (MR_Integer) 0;
            }
            break;
          case (MR_Integer) 3:
...
{
  {
    ...
    if ((TrueFormatOptions_6 == (MR_Word) ((MR_Unsigned) 0U)))
      *MaybeMaybeFormat_4 = (MR_Word) (&mdb__browse_scalar_common_5[7]);
    else
    {
      ...
      if ((Var_23 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        *MaybeMaybeFormat_4 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[8]));
    }
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[6])));
...
{
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
      HeadVar__2_2 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[2]));
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_5[3])));
  ...
  else
  {
    ...
    if ((Var_73 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mercury__string__int_to_string_2_p_0(HeadVar__3_3, &ArgNumS_27);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[44])));
      }
    ...
    else
    {
      ...
      mercury__string__int_to_string_2_p_0(HeadVar__3_3, &ArgNumS_53);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[44])));
      }
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            *Size_13 = Size0_12;
            *TailStrs_16 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__browse_scalar_common_4[43]));
          }
        }
        else
        {
