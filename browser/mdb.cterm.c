...
MR_decl_label5(mdb__cterm__match_with_cterms_3_0, 43,8,9,3,14)
...
#undef	MR_PROC_LABEL
	...
	if ((strcmp((char *)MR_r1, (char *)MR_r4) != 0)) {
...
MR_def_label(mdb__cterm__match_with_cterm_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_r4, (char *)(MR_Word) MR_string_const("_", 1)) != 0)) {
...
MR_BEGIN_MODULE(mdb__cterm_module3)
	...
	MR_init_label5(mdb__cterm__match_with_cterms_3_0,43,8,9,3,14)
MR_BEGIN_CODE
...
MR_def_label(mdb__cterm__match_with_cterms_3_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_CArgs	Args;
	MR_CTerm	Head;
...
#undef	MR_PROC_LABEL
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__cterm__match_with_cterms_3_0_i14);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
...
MR_def_label(mdb__cterm__match_with_cterms_3_0,9)
	...
	MR_GOTO_LAB(mdb__cterm__match_with_cterms_3_0_i43);
...
MR_def_label(mdb__cterm__match_with_cterms_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__mdb__cterm__write_out_proc_statics(FILE *fp);
#endif
