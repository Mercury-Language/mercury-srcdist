  ...
  if (!(succeeded))
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (mdb__term_to_html__write_browser_term_in_script_4_p_1_1));
        MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (Stream_5));
      }
      mercury__list__foldl2_6_p_11((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_53, ElementUnivs_23, ((MR_Box) ((MR_Integer) 1)), &conv2__ElementNumber_24, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_55_55);
    }
  ...
  if (!(succeeded))
  {
    ...
    else
    {
...

      {
        Var_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&mdb__term_to_html_scalar_common_3[1]));
        MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (mdb__term_to_html__write_browser_term_in_script_4_p_0_1));
        MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (Stream_5));
      }
      mercury__list__foldl2_6_p_11((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_53, ElementUnivs_23, ((MR_Box) ((MR_Integer) 1)), &conv2__ElementNumber_24, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_55_55);
