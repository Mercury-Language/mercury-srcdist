...
{
  {
    ...
    if (mdb__help__succeeded)
      *mdb__help__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mdb__help__Var_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__help__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_String mdb__help__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdb__help__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__help__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__help__Var_8, mdb__help__Var_4, mdb__help__Var_6);
        }
        ...
        if (mdb__help__succeeded)
          *mdb__help__HeadVar__1_1 = mdb__help__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &mdb__help_scalar_common_1[0], mdb__help__HeadVar__1_1, ((MR_Box) (mdb__help__Var_5)), ((MR_Box) (mdb__help__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
    ...
    else
      {
        ...
        MR_String mdb__help__Var_3 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdb__help__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 1)));
        MR_String mdb__help__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__help__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));

        mdb__help__succeeded = (strcmp(mdb__help__Var_3, mdb__help__Var_5) == 0);
        if (mdb__help__succeeded)
          {
            mdb__help__TypeInfo_9_9 = (MR_Word) &mdb__help_scalar_common_1[0];
            {
              mdb__help__succeeded = mercury__builtin__unify_2_p_0(mdb__help__TypeInfo_9_9, ((MR_Box) (mdb__help__Var_4)), ((MR_Box) (mdb__help__Var_6)));
            }
          }
      }
    return mdb__help__succeeded;
    ...
    else
      {
        ...
        if ((mdb__help__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mdb__help__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_String mdb__help__Var_7 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(mdb__help__HeadVar__1_1, mdb__help__Var_11, mdb__help__Var_7);
            }
          }
      }
  }
...
{
  {
    ...
    if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_String mdb__help__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mdb__help__Var_6;

        mdb__help__succeeded = ((MR_tag((MR_Word) mdb__help__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mdb__help__succeeded)
          {
            mdb__help__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
            mdb__help__succeeded = (strcmp(mdb__help__Var_5, mdb__help__Var_6) == 0);
          }
      }
    return mdb__help__succeeded;
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
      *mdb__help__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mdb__help__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_String mdb__help__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__help__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 2)));
        MR_Integer mdb__help__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 0)));
        MR_String mdb__help__Var_8 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__help__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mdb__help__Var_10;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&mdb__help__Var_10, mdb__help__Var_4, mdb__help__Var_7);
        }
        ...
        if (mdb__help__succeeded)
          *mdb__help__HeadVar__1_1 = mdb__help__Var_10;
        else
          {
            ...
            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__help__Var_11, mdb__help__Var_5, mdb__help__Var_8);
            }
            ...
            if (mdb__help__succeeded)
              *mdb__help__HeadVar__1_1 = mdb__help__Var_11;
              ...
              {
                mdb__help____Compare____node_0_0(mdb__help__HeadVar__1_1, mdb__help__Var_6, mdb__help__Var_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
      ...
      {
        MR_Integer mdb__help__Var_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mdb__help__Var_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__help__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer mdb__help__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_String mdb__help__Var_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__help__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 2)));

        mdb__help__succeeded = (mdb__help__Var_3 == mdb__help__Var_6);
        if (mdb__help__succeeded)
          {
            mdb__help__succeeded = (strcmp(mdb__help__Var_4, mdb__help__Var_7) == 0);
            if (mdb__help__succeeded)
              {
                mdb__help__succeeded = mdb__help____Unify____node_0_0(mdb__help__Var_5, mdb__help__Var_8);
              }
          }
      }
    return mdb__help__succeeded;
