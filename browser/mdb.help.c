...
static const MR_DuFunctorDescPtr mdb__help__mdb__help__du_stag_ordered_help_node_0_0[1] = {
  &mdb__help__mdb__help__du_functor_desc_help_node_0_0
};
  ...
  MR_Word * STATE_VARIABLE_RevMatchedNodes_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Node_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))));
      MR_Word Nodes_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      MR_String Var_25 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node_9, (MR_Integer) 1))));

      succeeded = (strcmp(Name_2, Var_25) == 0);
      if (succeeded)
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_RevMatchedNodes_4 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Node_9));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_RevMatchedNodes_0_3));
        }
      else
      {
        MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Node_9, (MR_Integer) 3))));
  ...
  MR_Word * Result_10)
{
  while (MR_TRUE)
  {
    ...
    if ((Path_9 == (MR_Word) ((MR_Unsigned) 0U)))
      *Result_10 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__help_scalar_common_2[0]));
    else
    {
      MR_String Step_12 = ((MR_String) ((MR_hl_field(MR_mktag(1), Path_9, (MR_Integer) 0))));
      MR_Word Tail_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Path_9, (MR_Integer) 1))));
      MR_Word Node_14;
      ...
      if (succeeded)
        ...
        {
          MR_String Text_37 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node_14, (MR_Integer) 2))));

          mercury__io__write_string_4_p_0(Stream_7, Text_37);
          *Result_10 = (MR_Word) ((MR_Unsigned) 0U);
        }
        else
        {
          MR_Word SubNodes_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Node_14, (MR_Integer) 3))));
      ...
      else
      {
        ...
        Var_25 = mercury__string__f_43_43_2_f_0(Step_12, (MR_String) "\"");
        Msg_18 = mercury__string__f_43_43_2_f_0((MR_String) "error at path component \"", Var_25);
        {
          MR_Word base;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word Node_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word Nodes_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
      MR_String Text_24 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node_10, (MR_Integer) 2))));
      MR_Word next_value_of_HeadVar__2_2;

      mercury__io__write_string_4_p_0(Stream_1, Text_24);
      // direct tailcall eliminated
      ;
  ...
  MR_Word * STATE_VARIABLE_Sys_16)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Node_14, 0) = ((MR_Box) (Index_9));
    MR_hl_field(MR_mktag(0), Node_14, 1) = ((MR_Box) (Name_10));
    MR_hl_field(MR_mktag(0), Node_14, 2) = ((MR_Box) (Text_11));
    MR_hl_field(MR_mktag(0), Node_14, 3) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->mdb__help__add_node_5_p_0_env_0__Var_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_30, (MR_Integer) 0))));
    Var_32 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_30, (MR_Integer) 1))));
    Var_33 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_30, (MR_Integer) 2))));
    Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_30, (MR_Integer) 3))));
    (env_ptr)->mdb__help__add_node_5_p_0_env_0__Var_46 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 0))));
    Var_35 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 1))));
    Var_36 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 2))));
    Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 3))));
  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Integer Var_38 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_31, (MR_Integer) 0))));
    MR_String Var_39;
    MR_Word Var_40;
    MR_Integer Var_41;
    MR_String Var_42;
    ...
    (env_ptr)->mdb__help__add_node_5_p_0_env_0__Var_28 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_31, (MR_Integer) 1))));
    Var_39 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_31, (MR_Integer) 2))));
    Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__MemberNode_31, (MR_Integer) 3))));
    Var_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 0))));
    (env_ptr)->mdb__help__add_node_5_p_0_env_0__Var_47 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 1))));
    Var_42 = ((MR_String) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 2))));
    Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->mdb__help__add_node_5_p_0_env_0__NewNode_2, (MR_Integer) 3))));
  ...
  MR_Word * Nodes_5)
{
  ...
  if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      *Res_3 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__help_scalar_common_2[1]));
    ...
    else
    {
      ...
      if ((env).mdb__help__add_node_5_p_0_env_0__succeeded)
      {
        *Res_3 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__help_scalar_common_2[2]));
        *Nodes_5 = (env).mdb__help__add_node_5_p_0_env_0__Nodes0_4;
      }
      else
      {
  ...
  {
    MR_String Step_6 = ((MR_String) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))));
    MR_Word Steps_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
    MR_Word Node0_12;
    ...
    if ((env).mdb__help__add_node_5_p_0_env_0__succeeded)
    {
      MR_Integer NodeIndex_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Node0_12, (MR_Integer) 0))));
      MR_String NodeName_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node0_12, (MR_Integer) 1))));
      MR_String Text_15 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node0_12, (MR_Integer) 2))));
      MR_Word SubNodes0_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Node0_12, (MR_Integer) 3))));
      MR_Word SubNodes_17;
      MR_Word Node_18;
      ...
      mdb__help__add_node_5_p_0(Steps_7, (env).mdb__help__add_node_5_p_0_env_0__NewNode_2, Res_3, SubNodes0_16, &SubNodes_17);
      {
        ...
        MR_hl_field(MR_mktag(0), Node_18, 0) = ((MR_Box) (NodeIndex_13));
        MR_hl_field(MR_mktag(0), Node_18, 1) = ((MR_Box) (NodeName_14));
        MR_hl_field(MR_mktag(0), Node_18, 2) = ((MR_Box) (Text_15));
        MR_hl_field(MR_mktag(0), Node_18, 3) = ((MR_Box) (SubNodes_17));
      }
    ...
    else
    {
      ...
      Msg_19 = mercury__string__f_43_43_2_f_0((MR_String) "invalid path component ", Step_6);
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Res_3 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Msg_19));
      }
      *Nodes_5 = (env).mdb__help__add_node_5_p_0_env_0__Nodes0_4;
    }
  }
  ...
  MR_Word * Node_7)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_11 = ((MR_String) ((MR_hl_field(MR_mktag(0), Head_4, (MR_Integer) 1))));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Node_1));
  ...
  else
  {
    ...
    MR_Integer Var_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Head_7, (MR_Integer) 0))));
    MR_Integer Var_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Node_1, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      mdb__help__insert_into_node_list_3_p_0(Node_1, Tail_8, &NewTail_10);
      {
        ...
        *HeadVar__3_3 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (NewTail_10));
      }
    }
    else
      {
  ...
  MR_Word * List_3)
{
  ...
  {
    MR_Word Head_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
    MR_Word Tail_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
    MR_Integer Var_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Head_9, (MR_Integer) 0))));
    MR_Integer Var_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Node_1, (MR_Integer) 0))));
    ...
    else
    {
      ...
      mdb__help__replace_node_at_index_3_p_0(Node_1, Tail_10, &NewTail_12);
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *List_3 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Head_9));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (NewTail_12));
      }
    }
  }
}
