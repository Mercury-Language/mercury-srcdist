...
MR_decl_label4(__Compare___mdb__help__node_0_0, 3,2,5,27)
...
MR_BEGIN_MODULE(mdb__help_module19)
	...
	MR_init_label4(__Compare___mdb__help__node_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__help__node_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__help__node_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___mdb__help__node_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__mdb__help__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__help);
