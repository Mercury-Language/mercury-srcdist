...
{
  {
    ...
    if ((mdb__help__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_String mdb__help__Var_11 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__2_2, (MR_Integer) 0)));

        if ((mdb__help__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mdb__help__HeadVar__1_1 = (MR_Integer) 2;
        else
          {
            MR_String mdb__help__ArgY1_7 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(mdb__help__HeadVar__1_1, mdb__help__Var_11, mdb__help__ArgY1_7);
            }
          }
      }
  }
...
{
  {
    ...
    if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_String mdb__help__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mdb__help__ArgY1_6;

        mdb__help__succeeded = ((MR_tag((MR_Word) mdb__help__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mdb__help__succeeded)
          {
            mdb__help__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
            mdb__help__succeeded = (strcmp(mdb__help__ArgX1_5, mdb__help__ArgY1_6) == 0);
          }
      }
    return mdb__help__succeeded;
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
      *mdb__help__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer mdb__help__ArgX1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mdb__help__ArgY1_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 0)));
        MR_String mdb__help__ArgX2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_String mdb__help__ArgY2_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__help__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mdb__help__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mdb__help__Var_10;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&mdb__help__Var_10, mdb__help__ArgX1_4, mdb__help__ArgY1_5);
        }
        mdb__help__succeeded = (mdb__help__Var_10 == (MR_Integer) 0);
        mdb__help__succeeded = !(mdb__help__succeeded);
        if (mdb__help__succeeded)
          *mdb__help__HeadVar__1_1 = mdb__help__Var_10;
        else
          {
            MR_Word mdb__help__Var_11;

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__help__Var_11, mdb__help__ArgX2_6, mdb__help__ArgY2_7);
            }
            mdb__help__succeeded = (mdb__help__Var_11 == (MR_Integer) 0);
            mdb__help__succeeded = !(mdb__help__succeeded);
            if (mdb__help__succeeded)
              *mdb__help__HeadVar__1_1 = mdb__help__Var_11;
            else
              {
                mdb__help____Compare____node_0_0(mdb__help__HeadVar__1_1, mdb__help__ArgX3_8, mdb__help__ArgY3_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
      *mdb__help__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mdb__help__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_String mdb__help__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdb__help__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__help__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdb__help__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&mdb__help__Var_8, mdb__help__ArgX1_4, mdb__help__ArgY1_5);
        }
        mdb__help__succeeded = (mdb__help__Var_8 == (MR_Integer) 0);
        mdb__help__succeeded = !(mdb__help__succeeded);
        if (mdb__help__succeeded)
          *mdb__help__HeadVar__1_1 = mdb__help__Var_8;
        else
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &mdb__help_scalar_common_1[0], mdb__help__HeadVar__1_1, ((MR_Box) (mdb__help__ArgX2_6)), ((MR_Box) (mdb__help__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (mdb__help__succeeded)
      ...
      {
        MR_Integer mdb__help__ArgX1_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer mdb__help__ArgY1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_String mdb__help__ArgX2_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 1)));
        MR_String mdb__help__ArgY2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdb__help__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mdb__help__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 2)));

        mdb__help__succeeded = (mdb__help__ArgX1_3 == mdb__help__ArgY1_4);
        if (mdb__help__succeeded)
          {
            mdb__help__succeeded = (strcmp(mdb__help__ArgX2_5, mdb__help__ArgY2_6) == 0);
            if (mdb__help__succeeded)
              {
                mdb__help__succeeded = mdb__help____Unify____node_0_0(mdb__help__ArgX3_7, mdb__help__ArgY3_8);
              }
          }
      }
    return mdb__help__succeeded;
...
{
  {
    ...
    if (mdb__help__succeeded)
    ...
    else
      {
        ...
        MR_String mdb__help__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mdb__help__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdb__help__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdb__help__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__HeadVar__2_2, (MR_Integer) 1)));

        mdb__help__succeeded = (strcmp(mdb__help__ArgX1_3, mdb__help__ArgY1_4) == 0);
        if (mdb__help__succeeded)
          {
            mdb__help__TypeInfo_9_9 = (MR_Word) &mdb__help_scalar_common_1[0];
            {
              mdb__help__succeeded = mercury__builtin__unify_2_p_0(mdb__help__TypeInfo_9_9, ((MR_Box) (mdb__help__ArgX2_5)), ((MR_Box) (mdb__help__ArgY2_6)));
            }
          }
      }
    return mdb__help__succeeded;
        ...
        if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mdb__help__STATE_VARIABLE_C_4 = mdb__help__STATE_VARIABLE_C_0_3;
        else
          {
            ...
            MR_Integer mdb__help__Var_22 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__Entry_16, (MR_Integer) 0)));
            ...
            if (mdb__help__succeeded)
            ...
            else
              {
                ...
                MR_Word mdb__help__SubNodes_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Node_24, (MR_Integer) 1)));
                MR_String mdb__help__Var_49 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Node_24, (MR_Integer) 0)));

                {
                  mdb__help__search_entry_list_7_p_0(mdb__help__SubNodes_50, mdb__help__Name_2, mdb__help__STATE_VARIABLE_C_0_3, &mdb__help__STATE_VARIABLE_C_32_32, mdb__help__Stream_5);
                }
                /* direct tailcall eliminated */
                {
                  MR_Word mdb__help__next_value_of_HeadVar__1_1 = mdb__help__Tail_17;
                  MR_Integer mdb__help__next_value_of_STATE_VARIABLE_C_0_3 = mdb__help__STATE_VARIABLE_C_32_32;

                  mdb__help__STATE_VARIABLE_C_0_3 = mdb__help__next_value_of_STATE_VARIABLE_C_0_3;
                  mdb__help__HeadVar__1_1 = mdb__help__next_value_of_HeadVar__1_1;
                }
                continue;
              }
          }
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdb__help__Path_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            *mdb__help__Result_10 = (MR_Word) MR_mkword(MR_mktag(1), &mdb__help_scalar_common_2[2]);
          }
        else
          {
            ...
            if (mdb__help__succeeded)
              {
                ...
                MR_Word mdb__help__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__EntryNode_17, (MR_Integer) 1)));
                MR_String mdb__help__Var_34 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__EntryNode_17, (MR_Integer) 0)));
                MR_Integer mdb__help__Var_15 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__Entry_14, (MR_Integer) 0)));
                MR_String mdb__help__Var_16 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Entry_14, (MR_Integer) 1)));

                if ((mdb__help__Tail_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    {
                      mercury__io__write_string_4_p_0(mdb__help__Stream_9, mdb__help__Var_34);
                    }
                ...
                else
                  {
                    /* direct tailcall eliminated */
                    {
                      MR_Word mdb__help__next_value_of_Entries_7 = mdb__help__Var_33;
                      MR_Word mdb__help__next_value_of_Path_8 = mdb__help__Tail_13;

                      mdb__help__Path_8 = mdb__help__next_value_of_Path_8;
                      mdb__help__Entries_7 = mdb__help__next_value_of_Entries_7;
                    }
                    continue;
                  }
              }
            else
              {
                ...
                MR_String mdb__help__Var_31;

                {
                  mdb__help__Var_31 = mercury__string__f_43_43_2_f_0(mdb__help__Step_12, (MR_String) "\"");
                }
                {
                  mdb__help__Msg_24 = mercury__string__f_43_43_2_f_0((MR_String) "error at path component \"", mdb__help__Var_31);
                }
                {
                  MR_Word base;
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word mdb__help__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdb__help__HeadVar__1_1, (MR_Integer) 0)));
            MR_String mdb__help__Text_23;
            MR_Integer mdb__help__Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__Var_17, (MR_Integer) 0)));
            MR_String mdb__help__Var_10 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Var_17, (MR_Integer) 1)));
            MR_Word mdb__help___Nodes_24;

            mdb__help__Node_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Var_17, (MR_Integer) 2)));
            ...
            /* direct tailcall eliminated */
            {
              MR_Word mdb__help__next_value_of_HeadVar__1_1 = mdb__help__Nodes_12;
...
{
  {
    ...
    {
      MR_String mdb__help__Var_34;
      MR_Word mdb__help__Var_35;

      (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Var_44 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_33, (MR_Integer) 0)));
      mdb__help__Var_34 = ((MR_String) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_33, (MR_Integer) 1)));
      mdb__help__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_33, (MR_Integer) 2)));
      (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__succeeded = ((mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Index_3 == (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Var_44);
...
{
  {
    ...
    {
      MR_Integer mdb__help__Var_36 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_40, (MR_Integer) 0)));
      MR_Word mdb__help__Var_37;

      (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Var_45 = ((MR_String) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_40, (MR_Integer) 1)));
      mdb__help__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Entry1_40, (MR_Integer) 2)));
      (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__succeeded = (strcmp((mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Name_4, (mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__Var_45) == 0);
      if ((mdb__help__env_ptr)->mdb__help__add_node_7_p_0_env_0__succeeded)
        {
    ...
    if ((mdb__help__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if ((mdb__help__env).mdb__help__add_node_7_p_0_env_0__succeeded)
          {
            *mdb__help__Res_6 = (MR_Word) MR_mkword(MR_mktag(1), &mdb__help_scalar_common_2[0]);
...
{
  {
    ...
    if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_String mdb__help__Var_12 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Head_7, (MR_Integer) 1)));
        MR_Word mdb__help__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Head_7, (MR_Integer) 2)));
        MR_String mdb__help__Var_15 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Entry_2, (MR_Integer) 1)));
        MR_Word mdb__help__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Entry_2, (MR_Integer) 2)));
        ...
        if (mdb__help__succeeded)
          {
            ...
            mdb__help__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdb__help__Head_4, (MR_Integer) 0)));
            mdb__help__HeadName_9 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Head_4, (MR_Integer) 1)));
            mdb__help__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Head_4, (MR_Integer) 2)));
            ...
            if (mdb__help__succeeded)
            ...
            else
              {
                /* direct tailcall eliminated */
                {
                  MR_Word mdb__help__next_value_of_HeadVar__1_1 = mdb__help__Tail_5;
...
{
  {
    ...
    if ((mdb__help__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_String mdb__help__Var_18 = ((MR_String) (MR_hl_field(MR_mktag(0), mdb__help__Head_11, (MR_Integer) 1)));
        MR_Word mdb__help__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdb__help__Head_11, (MR_Integer) 2)));
