...
MR_decl_label8(mdb__help__add_node_7_0, 8,6,9,5,14,12,15,11)
MR_decl_label7(mdb__help__add_node_7_0, 16,3,21,23,24,19,25)
MR_decl_label1(mdb__help__help_system_type_1_0, 2)
MR_decl_label3(mdb__help__insert_into_entry_list_5_0, 3,5,4)
MR_decl_label3(mdb__help__name_5_0, 2,5,7)
MR_decl_label2(mdb__help__one_path_step_3_0, 3,1)
MR_decl_label8(mdb__help__path_6_0, 28,3,6,9,11,4,12,13)
MR_decl_label3(mdb__help__print_entry_list_4_0, 11,4,13)
MR_decl_label3(mdb__help__replace_entry_3_0, 21,5,6)
MR_decl_label1(mdb__help__result_is_error_2_0, 1)
MR_decl_label5(mdb__help__search_entry_list_7_0, 16,3,5,4,6)
MR_decl_label1(__Unify___mdb__help__entry_0_0, 1)
MR_decl_label2(__Unify___mdb__help__help_res_0_0, 3,1)
MR_decl_label1(__Unify___mdb__help__node_0_0, 1)
MR_decl_label3(__Compare___mdb__help__entry_0_0, 3,7,12)
MR_decl_label3(__Compare___mdb__help__help_res_0_0, 5,3,7)
MR_decl_label2(__Compare___mdb__help__node_0_0, 3,7)
...
MR_BEGIN_MODULE(mdb__help_module1)
	...
	MR_init_label3(mdb__help__insert_into_entry_list_5_0,3,5,4)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__insert_into_entry_list_5_0,3)
	...
	if (((MR_Integer) MR_tempr1 >= (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(mdb__help__insert_into_entry_list_5_0_i4);
	}
	MR_incr_sp(2);
	...
	MR_np_localcall_lab(mdb__help__insert_into_entry_list_5_0,
		mdb__help__insert_into_entry_list_5_0_i5);
MR_def_label(mdb__help__insert_into_entry_list_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(mdb__help__insert_into_entry_list_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_static(mdb__help__one_path_step_3_0)
	...
	if ((strcmp((char *)MR_tempr1, (char *)MR_r2) != 0)) {
...
MR_BEGIN_MODULE(mdb__help_module3)
	...
	MR_init_label3(mdb__help__replace_entry_3_0,21,5,6)
MR_BEGIN_CODE
...
MR_def_static(mdb__help__replace_entry_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__help__replace_entry_3_0_i21);
	}
	MR_r1 = (MR_Word) MR_string_const("replace_entry: entry to be replaced not found", 45);
	MR_np_tailcall_ent(require__error_1_0);
MR_def_label(mdb__help__replace_entry_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_r3 = MR_ctfield(1, MR_r1, 1);
	...
	if ((MR_tempr1 != MR_tempr2)) {
		MR_GOTO_LAB(mdb__help__replace_entry_3_0_i5);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_def_label(mdb__help__replace_entry_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
...
MR_BEGIN_MODULE(mdb__help_module4)
	...
	MR_init_label8(mdb__help__add_node_7_0,8,6,9,5,14,12,15,11)
	MR_init_label7(mdb__help__add_node_7_0,16,3,21,23,24,19,25)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__add_node_7_0,5)
	...
	MR_save_maxfr(MR_sv(9));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(mdb__help__add_node_7_0_i12);
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(list__member_2_1,
		mdb__help__add_node_7_0_i14);
MR_def_label(mdb__help__add_node_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_ctfield(0, MR_r1, 1);
	if ((strcmp((char *)MR_sv(3), (char *)MR_r3) != 0)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	MR_restore_maxfr(MR_sv(9));
	MR_redoip_slot_word(MR_maxfr) = MR_sv(7);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(8);
	MR_GOTO_LAB(mdb__help__add_node_7_0_i15);
...
MR_def_label(mdb__help__add_node_7_0,3)
	...
	MR_np_call_localret_ent(mdb__help__one_path_step_3_0,
		mdb__help__add_node_7_0_i21);
MR_def_label(mdb__help__add_node_7_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__help__add_node_7_0_i19);
	}
	MR_r3 = MR_sv(2);
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(mdb__help__add_node_7_0,23)
	...
	MR_np_call_localret_ent(mdb__help__replace_entry_3_0,
		mdb__help__add_node_7_0_i24);
MR_def_label(mdb__help__add_node_7_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(10);
MR_def_label(mdb__help__add_node_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(mdb__help_module6)
	...
	MR_init_label3(mdb__help__print_entry_list_4_0,11,4,13)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__print_entry_list_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__help__print_entry_list_4_0_i13);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r2;
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_tempr2;
	MR_r2 = MR_ctfield(0, MR_ctfield(0, MR_ctfield(1, MR_tempr1, 0), 2), 0);
	}
...
MR_def_label(mdb__help__print_entry_list_4_0,4)
	...
	MR_GOTO_LAB(mdb__help__print_entry_list_4_0_i11);
MR_def_label(mdb__help__print_entry_list_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__help_module8)
	...
	MR_init_label8(mdb__help__path_6_0,28,3,6,9,11,4,12,13)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__path_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(mdb__help__path_6_0,3)
	...
	MR_np_call_localret_ent(mdb__help__one_path_step_3_0,
		mdb__help__path_6_0_i6);
MR_def_label(mdb__help__path_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__help__path_6_0_i4);
	}
	if (MR_LTAGS_TEST(MR_sv(3),0,0)) {
		MR_GOTO_LAB(mdb__help__path_6_0_i9);
	}
	MR_r1 = MR_ctfield(0, MR_ctfield(0, MR_r2, 2), 1);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(mdb__help__path_6_0_i28);
MR_def_label(mdb__help__path_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_ctfield(0, MR_ctfield(0, MR_r2, 2), 0);
	MR_np_call_localret_ent(io__write_string_4_0,
...
MR_def_label(mdb__help__path_6_0,11)
	...
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(4);
MR_def_label(mdb__help__path_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		mdb__help__path_6_0_i12);
MR_def_label(mdb__help__path_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
...
MR_def_label(mdb__help__search_entry_list_7_0,3)
	...
	if ((strcmp((char *)MR_r2, (char *)MR_tempr2) != 0)) {
...
MR_BEGIN_MODULE(mdb__help_module12)
	...
	MR_init_label1(mdb__help__help_system_type_1_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__help__help_system_type_1_0);
	...
	MR_np_call_localret_ent(fn__type_desc__type_of_1_0,
		mdb__help__help_system_type_1_0_i2);
MR_def_label(mdb__help__help_system_type_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(mdb__help_module14)
	...
	MR_init_label1(__Unify___mdb__help__entry_0_0,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__help__entry_0_0);
	...
	if ((strcmp((char *)MR_tempr1, (char *)MR_tempr4) != 0)) {
		MR_GOTO_LAB(__Unify___mdb__help__entry_0_0_i1);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__help, entry);
...
MR_BEGIN_MODULE(mdb__help_module15)
	...
	MR_init_label3(__Compare___mdb__help__entry_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__help__entry_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdb__help__entry_0_0_i3);
MR_def_label(__Compare___mdb__help__entry_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__help__entry_0_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdb__help__entry_0_0_i7);
MR_def_label(__Compare___mdb__help__entry_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__help__entry_0_0_i12);
	}
...
MR_def_label(__Compare___mdb__help__entry_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__help_module16)
	...
	MR_init_label2(__Unify___mdb__help__help_res_0_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__help__help_res_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Unify___mdb__help__help_res_0_0_i3);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___mdb__help__help_res_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__help_module17)
	...
	MR_init_label3(__Compare___mdb__help__help_res_0_0,5,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__help__help_res_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Compare___mdb__help__help_res_0_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(__Compare___mdb__help__help_res_0_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___mdb__help__help_res_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_BEGIN_MODULE(mdb__help_module18)
	...
	MR_init_label1(__Unify___mdb__help__node_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__help_module19)
	...
	MR_init_label2(__Compare___mdb__help__node_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___mdb__help__node_0_0)
	...
	MR_r2 = MR_ctfield(0, MR_r2, 0);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdb__help__node_0_0_i3);
MR_def_label(__Compare___mdb__help__node_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__help__node_0_0_i7);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__help, entry);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___mdb__help__node_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__mdb__help__write_out_proc_statics(FILE *fp);
#endif
