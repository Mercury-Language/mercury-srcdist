      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_11;
          ...
          mdb__help____Compare____node_0_0(HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &mdb__help_scalar_common_1[0], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Integer Var_22 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Entry_16, (MR_Integer) 0)));

        succeeded = (strcmp(Name_2, EntryName_23) == 0);
        if (succeeded)
        {
          MR_String Text_39 = ((MR_String) (MR_hl_field(MR_mktag(0), Node_24, (MR_Integer) 0)));
          MR_Word _Nodes_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), Node_24, (MR_Integer) 1)));

          mercury__io__write_string_4_p_0(Stream_5, Text_39);
          *STATE_VARIABLE_C_4 = (STATE_VARIABLE_C_0_3 + (MR_Integer) 1);
        }
        else
        {
          MR_Integer STATE_VARIABLE_C_32_32;
          MR_Word SubNodes_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), Node_24, (MR_Integer) 1)));
          MR_String Var_49 = ((MR_String) (MR_hl_field(MR_mktag(0), Node_24, (MR_Integer) 0)));

          mdb__help__search_entry_list_7_p_0(SubNodes_50, Name_2, STATE_VARIABLE_C_0_3, &STATE_VARIABLE_C_32_32, Stream_5);
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Tail_17;
            MR_Integer next_value_of_STATE_VARIABLE_C_0_3 = STATE_VARIABLE_C_32_32;
  ...
  MR_Word * Result_10)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if ((Path_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          MR_Integer Var_15 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Entry_14, (MR_Integer) 0)));
          MR_String Var_16 = ((MR_String) (MR_hl_field(MR_mktag(0), Entry_14, (MR_Integer) 1)));

          if ((Tail_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
  ...
  MR_Word Stream_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      MR_String Text_23;
      MR_Integer Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 0)));
      MR_String Var_10 = ((MR_String) (MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 1)));
      MR_Word _Nodes_24;

      Node_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 2)));
      Text_23 = ((MR_String) (MR_hl_field(MR_mktag(0), Node_11, (MR_Integer) 0)));
      _Nodes_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), Node_11, (MR_Integer) 1)));
      mercury__io__write_string_4_p_0(Stream_2, Text_23);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Nodes_12;
...
{
  {
    ...
    {
      Node_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Node_15, 0) = ((MR_Box) (Text_12));
      MR_hl_field(MR_mktag(0), Node_15, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
...
{
  {
    ...
    else
    {
      ...
      if ((env).mdb__help__add_node_7_p_0_env_0__succeeded)
      {
        ...
        {
          EntryNode_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), EntryNode_23, 0) = ((MR_Box) (Text_20));
          MR_hl_field(MR_mktag(0), EntryNode_23, 1) = ((MR_Box) (SubNodes_22));
        }
        {
          Entry_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    else
    {
      ...
      MR_String Var_12 = ((MR_String) (MR_hl_field(MR_mktag(0), Head_7, (MR_Integer) 1)));
      MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Head_7, (MR_Integer) 2)));
      MR_String Var_15 = ((MR_String) (MR_hl_field(MR_mktag(0), Entry_2, (MR_Integer) 1)));
      MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_2, (MR_Integer) 2)));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Head_4, (MR_Integer) 0)));
        HeadName_9 = ((MR_String) (MR_hl_field(MR_mktag(0), Head_4, (MR_Integer) 1)));
        Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), Head_4, (MR_Integer) 2)));
...
{
  {
    ...
    if ((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        Entry_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      MR_String Var_18 = ((MR_String) (MR_hl_field(MR_mktag(0), Head_11, (MR_Integer) 1)));
      MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Head_11, (MR_Integer) 2)));
      ...
      else
      {
        ...
        {
          Entry_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
