  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__13_13 = (MR_Word) (&mdb__help_scalar_common_1[0]);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        {
          MR_String Text_32 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node_14, (MR_Integer) 2))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_String Text_18 = ((MR_String) ((MR_hl_field(MR_mktag(0), Node_10, (MR_Integer) 2))));
