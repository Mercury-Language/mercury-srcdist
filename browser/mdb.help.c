...
MR_decl_label8(mdb__help__add_node_7_0, 8,6,9,5,15,13,16,12)
MR_decl_label7(mdb__help__add_node_7_0, 18,3,23,25,28,21,29)
...
MR_decl_label8(mdb__help__path_6_0, 30,3,7,11,10,5,13,14)
...
MR_BEGIN_MODULE(mdb__help_module4)
	...
	MR_init_label8(mdb__help__add_node_7_0,8,6,9,5,15,13,16,12)
	MR_init_label7(mdb__help__add_node_7_0,18,3,23,25,28,21,29)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__add_node_7_0,15)
	...
	if ((strcmp((char *) (MR_Word *) MR_sv(3), (char *) (MR_Word *) MR_r3) != 0)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	MR_restore_maxfr(MR_sv(9));
	MR_redoip_slot_word(MR_maxfr) = MR_sv(7);
...
MR_def_label(mdb__help__add_node_7_0,23)
	...
	MR_tempr3 = MR_sv(4);
	MR_tempr4 = MR_ctfield(0, MR_tempr5, 2);
...
MR_BEGIN_MODULE(mdb__help_module8)
	...
	MR_init_label8(mdb__help__path_6_0,30,3,7,11,10,5,13,14)
MR_BEGIN_CODE
...
MR_def_label(mdb__help__path_6_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(mdb__help__path_6_0,10)
	...
	MR_GOTO_LAB(mdb__help__path_6_0_i30);
