...
MR_def_static(mdb__debugger_interface__output_current_slots_user_16_0)
	...
	MR_tfield(1, MR_tempr1, 3) = ((MR_Integer) MR_r4 | ((MR_Integer) MR_r5 << (MR_Integer) 5));
...
MR_def_label(__Unify___mdb__debugger_interface__debugger_response_0_0,24)
	...
	MR_tempr1 = ((MR_Integer) MR_tfield(1, MR_tempr3, 3) & (MR_Integer) 31);
	MR_tempr2 = ((MR_Integer) MR_tfield(1, MR_tempr4, 3) & (MR_Integer) 31);
	if ((MR_tempr1 != MR_tempr2)) {
		MR_GOTO_LAB(__Unify___mdb__debugger_interface__debugger_response_0_0_i1);
	}
	MR_tempr1 = (((MR_Integer) MR_tfield(1, MR_tempr3, 3) >> (MR_Integer) 5) & (MR_Integer) 1);
	MR_tempr2 = (((MR_Integer) MR_tfield(1, MR_tempr4, 3) >> (MR_Integer) 5) & (MR_Integer) 1);
	if ((MR_tempr1 != MR_tempr2)) {
		MR_GOTO_LAB(__Unify___mdb__debugger_interface__debugger_response_0_0_i1);
	}
...
MR_def_label(__Compare___mdb__debugger_interface__debugger_response_0_0,29)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6;
	MR_tempr5 = MR_sv(2);
	MR_sv(24) = MR_tfield(1, MR_tempr5, 11);
	MR_sv(23) = MR_tfield(1, MR_tempr5, 10);
	MR_sv(22) = MR_tfield(1, MR_tempr5, 9);
	MR_sv(21) = MR_tfield(1, MR_tempr5, 8);
	MR_sv(20) = MR_tfield(1, MR_tempr5, 7);
	MR_sv(19) = MR_tfield(1, MR_tempr5, 6);
	MR_sv(18) = MR_tfield(1, MR_tempr5, 5);
	MR_sv(17) = MR_tfield(1, MR_tempr5, 4);
	MR_sv(16) = (((MR_Integer) MR_tfield(1, MR_tempr5, 3) >> (MR_Integer) 5) & (MR_Integer) 1);
	MR_sv(15) = ((MR_Integer) MR_tfield(1, MR_tempr5, 3) & (MR_Integer) 31);
	MR_sv(14) = MR_tfield(1, MR_tempr5, 2);
	MR_sv(13) = MR_tfield(1, MR_tempr5, 1);
	MR_tempr6 = MR_sv(1);
	MR_sv(12) = MR_tfield(1, MR_tempr6, 11);
	MR_sv(11) = MR_tfield(1, MR_tempr6, 10);
	MR_sv(10) = MR_tfield(1, MR_tempr6, 9);
	MR_sv(9) = MR_tfield(1, MR_tempr6, 8);
	...
	MR_sv(4) = (((MR_Integer) MR_tfield(1, MR_tempr6, 3) >> (MR_Integer) 5) & (MR_Integer) 1);
	MR_sv(3) = ((MR_Integer) MR_tfield(1, MR_tempr6, 3) & (MR_Integer) 31);
	MR_tempr1 = MR_tfield(1, MR_tempr6, 2);
	MR_tempr2 = MR_tfield(1, MR_tempr6, 1);
	MR_tempr3 = MR_tempr6;
	MR_sv(1) = MR_tempr2;
