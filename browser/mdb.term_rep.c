...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeFunctorNum_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
      ...
      else
      {
        ...
        MR_Word ArgNames_20;
        MR_Integer Var_27 = (FunctorNum_16 - (MR_Integer) 1);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            {
              MaybePos_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybePos_7, 0) = ((MR_Box) (Pos0_21));
            }
          else
            MaybePos_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        }
        else
        {
    ...
    succeeded = ((MR_tag((MR_Word) MaybePos_7)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
  ...
  MR_Word * MaybeFunctorNum_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_14 = (Current_7 - (MR_Integer) 1);
      MR_String Var_18;
      MR_Integer Var_19;
      MR_Word Var_13;
      ...
      {
        MR_Integer Var_16 = (Current_7 + (MR_Integer) 1);
      ...
      *MaybeFunctorNum_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    break;
  }
}
  ...
  MR_Word * SubTerm_6)
{
  while (MR_TRUE)
  {
    ...
    /* setup for tailcalls optimized into a loop */
    if ((Path_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *SubTerm_6 = Term_4;
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      if (succeeded)
      {
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Term_4 = NextSubTerm_9;
          MR_Word next_value_of_Path_5 = Tail_8;
...
{
  {
    ...
    Var_13 = (N_5 - (MR_Integer) 1);
    mercury__deconstruct__arg_cc_3_p_0(TypeInfo_16_16, Var_12, Var_13, &MaybeSubUniv_9);
    if ((MaybeSubUniv_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      MaybeArg_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      ...
      {
        Arg0_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Arg0_11, 0) = ((MR_Box) (Univ_21));
      }
      {
        MaybeArg_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeArg_7, 0) = ((MR_Box) (Arg0_11));
      }
    }
    succeeded = ((MR_tag((MR_Word) MaybeArg_7)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
