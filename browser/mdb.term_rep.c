...
MR_decl_label8(mdb__term_rep__field_pos_3_0, 2,3,4,5,7,9,13,16)
MR_decl_label5(mdb__term_rep__field_pos_3_0, 15,12,6,23,1)
...
MR_BEGIN_MODULE(mdb__term_rep_module5)
	...
	MR_init_label8(mdb__term_rep__field_pos_3_0,2,3,4,5,7,9,13,16)
	MR_init_label5(mdb__term_rep__field_pos_3_0,15,12,6,23,1)
MR_BEGIN_CODE
...
MR_def_label(mdb__term_rep__field_pos_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i6);
	}
	MR_r1 = (MR_Integer) 1;
	MR_r3 = MR_sv(4);
	MR_r4 = MR_sv(2);
...
MR_def_label(mdb__term_rep__field_pos_3_0,9)
	...
	MR_np_call_localret_ent(construct__get_functor_with_names_6_0,
		mdb__term_rep__field_pos_3_0_i13);
MR_def_label(mdb__term_rep__field_pos_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i12);
	}
	...
	MR_np_call_localret_ent(list__nth_member_search_3_0,
		mdb__term_rep__field_pos_3_0_i16);
MR_def_label(mdb__term_rep__field_pos_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i15);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(mdb__term_rep__field_pos_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i23);
MR_def_label(mdb__term_rep__field_pos_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
