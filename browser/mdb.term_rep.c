...
#line 27 "mdb.term_rep.c"
#line 134 "../library/io.int2"
#include "io.mh"

#line 31 "mdb.term_rep.c"
#line 142 "../library/io.int2"
#include "string.mh"

#line 35 "mdb.term_rep.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 39 "mdb.term_rep.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 43 "mdb.term_rep.c"
#line 61 "mdb.declarative_execution.int2"
#include "mdb.declarative_execution.mh"

#line 47 "mdb.term_rep.c"
#line 30 "../library/array.int2"
#include "array.mh"

#line 51 "mdb.term_rep.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 55 "mdb.term_rep.c"
#line 56 "mdb.term_rep.c"
#include "mdb.term_rep.mh"

#line 59 "mdb.term_rep.c"
...
MR_decl_label8(mdb__term_rep__argument_3_0, 2,3,4,6,7,8,5,1)
MR_decl_label4(mdb__term_rep__deref_path_3_0, 18,3,4,1)
MR_decl_label8(mdb__term_rep__field_pos_3_0, 2,3,4,5,7,9,26,11)
MR_decl_label6(mdb__term_rep__field_pos_3_0, 14,17,16,13,23,1)
MR_decl_label4(mdb__term_rep__find_functor_6_0, 26,4,3,2)
MR_decl_label3(__Unify___mdb__term_rep__term_rep_0_0, 4,5,1)
...
static const MR_NotagFunctorDesc mercury_data_mdb__term_rep__notag_functor_desc_term_rep_0 = {
	"term_rep",
...
const MR_TypeCtorInfo_Struct mercury_data_mdb__term_rep__type_ctor_info_term_rep_0 = {
	...
	"mdb.term_rep",
	"term_rep",
	{ (void *)&mercury_data_mdb__term_rep__notag_functor_desc_term_rep_0 },
	{ (void *)&mercury_data_mdb__term_rep__notag_functor_desc_term_rep_0 },
	1,
	4,
...
MR_BEGIN_MODULE(mdb__term_rep_module2)
	...
	MR_init_label8(mdb__term_rep__argument_3_0,2,3,4,6,7,8,5,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__term_rep__argument_3_0);
	...
	MR_np_call_localret_ent(fn__builtin__promise_only_solution_1_0,
		mdb__term_rep__argument_3_0_i2);
MR_def_label(mdb__term_rep__argument_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(mdb__term_rep__argument_3_0,4)
	...
	MR_GOTO_LAB(mdb__term_rep__argument_3_0_i5);
MR_def_label(mdb__term_rep__argument_3_0,6)
	...
	MR_np_call_localret_ent(fn__univ__univ_1_0,
		mdb__term_rep__argument_3_0_i7);
...
MR_BEGIN_MODULE(mdb__term_rep_module4)
	...
	MR_init_label4(mdb__term_rep__find_functor_6_0,26,4,3,2)
MR_BEGIN_CODE
...
MR_def_label(mdb__term_rep__find_functor_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(mdb__term_rep__find_functor_6_0,4)
	...
	if ((strcmp((char *)MR_sv(4), (char *)MR_r2) != 0)) {
		MR_GOTO_LAB(mdb__term_rep__find_functor_6_0_i3);
	}
	if ((MR_sv(5) != MR_r3)) {
		MR_GOTO_LAB(mdb__term_rep__find_functor_6_0_i3);
...
MR_def_label(mdb__term_rep__find_functor_6_0,3)
	...
	MR_GOTO_LAB(mdb__term_rep__find_functor_6_0_i26);
...
MR_BEGIN_MODULE(mdb__term_rep_module5)
	...
	MR_init_label8(mdb__term_rep__field_pos_3_0,2,3,4,5,7,9,26,11)
	MR_init_label6(mdb__term_rep__field_pos_3_0,14,17,16,13,23,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__term_rep__field_pos_3_0);
	...
	MR_np_call_localret_ent(fn__builtin__promise_only_solution_1_0,
		mdb__term_rep__field_pos_3_0_i2);
MR_def_label(mdb__term_rep__field_pos_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__univ__univ_value_1_0,
...
MR_def_label(mdb__term_rep__field_pos_3_0,5)
	...
	MR_np_call_localret_ent(fn__construct__num_functors_1_0,
		mdb__term_rep__field_pos_3_0_i7);
MR_def_label(mdb__term_rep__field_pos_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i26);
	}
	MR_r1 = (MR_Integer) 1;
	MR_r3 = MR_sv(4);
	MR_r4 = MR_sv(2);
	...
	MR_np_call_localret_ent(mdb__term_rep__find_functor_6_0,
		mdb__term_rep__field_pos_3_0_i9);
MR_def_label(mdb__term_rep__field_pos_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i11);
	}
MR_def_label(mdb__term_rep__field_pos_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(exception__throw_1_0,
		mdb__term_rep__field_pos_3_0_i23);
MR_def_label(mdb__term_rep__field_pos_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(mdb__term_rep__field_pos_3_0,14)
	...
	MR_np_call_localret_ent(list__nth_member_search_3_0,
		mdb__term_rep__field_pos_3_0_i17);
MR_def_label(mdb__term_rep__field_pos_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r1 = MR_tempr1;
	MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i23);
	}
...
MR_def_label(mdb__term_rep__field_pos_3_0,13)
	...
	MR_np_call_localret_ent(exception__throw_1_0,
		mdb__term_rep__field_pos_3_0_i23);
MR_def_label(mdb__term_rep__field_pos_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_BEGIN_MODULE(mdb__term_rep_module7)
	...
	MR_init_label3(__Unify___mdb__term_rep__term_rep_0_0,4,5,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__term_rep__term_rep_0_0);
	...
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdb__term_rep__term_rep_0_0_i5);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(mdb__term_rep__comp_rep_2_3_0);
	...
	MR_np_call_localret_ent(fn__builtin__promise_only_solution_1_1,
		__Unify___mdb__term_rep__term_rep_0_0_i4);
MR_def_label(__Unify___mdb__term_rep__term_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__mdb__term_rep__write_out_proc_statics(FILE *fp);
#endif
