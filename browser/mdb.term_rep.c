...
MR_decl_label8(mdb__term_rep__field_pos_3_0, 3,4,5,6,8,10,14,19)
MR_decl_label5(mdb__term_rep__field_pos_3_0, 16,13,7,30,1)
MR_decl_label4(mdb__term_rep__find_functor_6_0, 27,4,3,2)
...
MR_BEGIN_MODULE(mdb__term_rep_module4)
	...
	MR_init_label4(mdb__term_rep__find_functor_6_0,27,4,3,2)
MR_BEGIN_CODE
...
MR_def_label(mdb__term_rep__find_functor_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(mdb__term_rep__find_functor_6_0,3)
	...
	MR_GOTO_LAB(mdb__term_rep__find_functor_6_0_i27);
...
MR_BEGIN_MODULE(mdb__term_rep_module5)
	...
	MR_init_label8(mdb__term_rep__field_pos_3_0,3,4,5,6,8,10,14,19)
	MR_init_label5(mdb__term_rep__field_pos_3_0,16,13,7,30,1)
MR_BEGIN_CODE
