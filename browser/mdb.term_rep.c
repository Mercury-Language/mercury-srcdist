  ...
  MR_Integer * Pos_6)
{
  ...
  MR_Word Univ_8 = ((MR_Word) ((MR_hl_field(0, Term_5, 0))));
  MR_Box Value_9;
  ...
  if (succeeded)
  {
    ...
    {
      MR_Integer FunctorNum_16 = ((MR_Integer) ((MR_hl_field(1, MaybeFunctorNum_15, 0))));
      MR_Word ArgNames_20;
  ...
  if (succeeded)
    *Pos_6 = ((MR_Integer) ((MR_hl_field(1, MaybePos_7, 0))));
  return succeeded;
}
  ...
  MR_Word * SubTerm_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Head_7 = ((MR_Integer) ((MR_hl_field(1, Path_5, 0))));
      MR_Word Tail_8 = ((MR_Word) ((MR_hl_field(1, Path_5, 1))));
  ...
  MR_Word * Arg_6)
{
  ...
  MR_Word Univ_8 = ((MR_Word) ((MR_hl_field(0, Term_4, 0))));
  ...
  {
    MR_Word TypeInfo_17_17 = ((MR_Word) ((MR_hl_field(1, MaybeSubUniv_9, 0))));
    MR_Box SubValue_10 = (MR_hl_field(1, MaybeSubUniv_9, 1));
    MR_Word Arg0_11;
    MR_Word Var_15;
    MR_Word Univ_18;
  ...
  if (succeeded)
    *Arg_6 = ((MR_Word) ((MR_hl_field(1, MaybeArg_7, 0))));
  return succeeded;
}
...
mdb__term_rep__rep_to_univ_2_p_0(
  ...
  MR_Word * Univ_4)
{
  *Univ_4 = ((MR_Word) ((MR_hl_field(0, Rep_3, 0))));
}
