...
MR_decl_label10(mdb__term_rep__field_pos_3_0, 3,4,5,6,8,10,14,18,16,13)
MR_decl_label3(mdb__term_rep__field_pos_3_0, 7,29,1)
...
MR_BEGIN_MODULE(mdb__term_rep_module5)
	...
	MR_init_label10(mdb__term_rep__field_pos_3_0,3,4,5,6,8,10,14,18,16,13)
	MR_init_label3(mdb__term_rep__field_pos_3_0,7,29,1)
MR_BEGIN_CODE
...
MR_def_label(mdb__term_rep__field_pos_3_0,14)
	...
	MR_np_call_localret_ent(list__nth_member_search_3_0,
		mdb__term_rep__field_pos_3_0_i18);
MR_def_label(mdb__term_rep__field_pos_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r1 = MR_tempr1;
	MR_GOTO_LAB(mdb__term_rep__field_pos_3_0_i29);
	}
...
MR_def_label(mdb__term_rep__field_pos_3_0,13)
	...
	MR_np_call_localret_ent(exception__throw_1_0,
		mdb__term_rep__field_pos_3_0_i29);
MR_def_label(mdb__term_rep__field_pos_3_0,7)
	...
	MR_np_call_localret_ent(exception__throw_1_0,
		mdb__term_rep__field_pos_3_0_i29);
MR_def_label(mdb__term_rep__field_pos_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
void mercury__mdb__term_rep__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__term_rep);
