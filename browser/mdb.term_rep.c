...
static const MR_PseudoTypeInfo mdb__term_rep__mdb__term_rep__field_types_term_rep_0_0[1] = { (MR_PseudoTypeInfo) (&mercury__univ__univ__type_ctor_info_univ_0) };
...
static const MR_DuFunctorDescPtr mdb__term_rep__mdb__term_rep__du_stag_ordered_term_rep_0_0[1] = { &mdb__term_rep__mdb__term_rep__du_functor_desc_term_rep_0_0 };
...
static const MR_DuFunctorDescPtr mdb__term_rep__mdb__term_rep__du_name_ordered_term_rep_0[1] = { &mdb__term_rep__mdb__term_rep__du_functor_desc_term_rep_0_0 };

static const MR_Integer mdb__term_rep__mdb__term_rep__functor_number_map_term_rep_0[1] = { (MR_Integer) 0 };
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_representation_3_p_0((MR_Word) (&mdb__term_rep__mdb__term_rep__type_ctor_info_term_rep_0), &Result_5, ((MR_Box) (HeadVar__1_1)), ((MR_Box) (HeadVar__2_2)));
    succeeded = (Result_5 == (MR_Integer) 0);
  }
  return succeeded;
}
  ...
  MR_Integer * Pos_6)
{
  ...
  MR_Word Univ_8 = ((MR_Word) ((MR_hl_field(0, Term_5, (MR_Integer) 0))));
  MR_Box Value_9;
  ...
  succeeded = mercury__construct__num_functors_2_p_0(Type_13, &NumFunctors_14);
  if (succeeded)
  {
    ...
    {
      MR_Integer FunctorNum_16 = ((MR_Integer) ((MR_hl_field(1, MaybeFunctorNum_15, (MR_Integer) 0))));
      MR_Word ArgNames_20;
      MR_Integer Var_24 = (MR_Integer) ((MR_Unsigned) FunctorNum_16 - (MR_Unsigned) 1);
      MR_String _FunctorName_17;
      MR_Integer _Arity_18;
      MR_Word _ArgTypes_19;

      succeeded = mercury__construct__get_functor_with_names_6_p_0(Type_13, Var_24, &_FunctorName_17, &_Arity_18, &_ArgTypes_19, &ArgNames_20);
      if (succeeded)
      {
        MR_Integer Pos0_21;
        MR_Word Var_26;

        {
          ...
          MR_hl_field(1, Var_26, 0) = ((MR_Box) (FieldName_4));
        }
        succeeded = mercury__list__index1_of_first_occurrence_3_p_0((MR_Word) (&mdb__term_rep_scalar_common_1[0]), ArgNames_20, ((MR_Box) (Var_26)), &Pos0_21);
        if (succeeded)
          {
            MaybePos_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybePos_7, 0) = ((MR_Box) (Pos0_21));
          }
        else
    ...
    mercury__exception__throw_1_p_0((MR_Word) (&mdb__declarative_debugger__mdb__declarative_debugger__type_ctor_info_diagnoser_exception_0), ((MR_Box) (&mdb__term_rep_scalar_common_1[1])));
  succeeded = (MaybePos_7 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    *Pos_6 = ((MR_Integer) ((MR_hl_field(1, MaybePos_7, (MR_Integer) 0))));
  return succeeded;
}
  ...
  MR_Word * MaybeFunctorNum_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_14 = (MR_Integer) ((MR_Unsigned) Current_7 - (MR_Unsigned) 1);
      MR_String Var_18;
      MR_Integer Var_19;
      MR_Word Var_13;
      ...
      if (succeeded)
        {
          ...
          *MaybeFunctorNum_12 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (Current_7));
        }
      else
      {
        MR_Integer Var_16 = (MR_Integer) ((MR_Unsigned) Current_7 + (MR_Unsigned) 1);
  ...
  MR_Word * SubTerm_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Head_7 = ((MR_Integer) ((MR_hl_field(1, Path_5, (MR_Integer) 0))));
      MR_Word Tail_8 = ((MR_Word) ((MR_hl_field(1, Path_5, (MR_Integer) 1))));
  ...
  MR_Word * Arg_6)
{
  ...
  MR_Word Univ_8 = ((MR_Word) ((MR_hl_field(0, Term_4, (MR_Integer) 0))));
  MR_Word MaybeSubUniv_9;
  MR_Box Var_12;
  MR_Integer Var_13;

  Var_12 = mercury__univ__univ_value_1_f_0(&TypeInfo_16_16, Univ_8);
  Var_13 = (MR_Integer) ((MR_Unsigned) N_5 - (MR_Unsigned) 1);
  ...
  {
    MR_Word TypeInfo_17_17 = ((MR_Word) ((MR_hl_field(1, MaybeSubUniv_9, (MR_Integer) 0))));
    MR_Box SubValue_10 = (MR_hl_field(1, MaybeSubUniv_9, (MR_Integer) 1));
    MR_Word Arg0_11;
    MR_Word Var_15;
    MR_Word Univ_18;
    MR_Box conv0_Univ_18;

    Var_15 = mercury__univ__univ_1_f_0(TypeInfo_17_17, SubValue_10);
    mercury__builtin__cc_multi_equal_2_p_1((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), ((MR_Box) (Var_15)), &conv0_Univ_18);
    Univ_18 = ((MR_Word) (conv0_Univ_18));
    {
      Arg0_11 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Arg0_11, 0) = ((MR_Box) (Univ_18));
    }
    {
      MaybeArg_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeArg_7, 0) = ((MR_Box) (Arg0_11));
    }
  }
  succeeded = (MaybeArg_7 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    *Arg_6 = ((MR_Word) ((MR_hl_field(1, MaybeArg_7, (MR_Integer) 0))));
  return succeeded;
}
...
mdb__term_rep__rep_to_univ_2_p_0(
  ...
  MR_Word * Univ_4)
{
  *Univ_4 = ((MR_Word) ((MR_hl_field(0, Rep_3, (MR_Integer) 0))));
}
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  Univ_4 = ((MR_Word) (conv0_Univ_4));
  {
    ...
    *HeadVar__2_2 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (Univ_4));
  }
}
