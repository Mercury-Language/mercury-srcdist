...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeFunctorNum_15 == (MR_Word) ((MR_Integer) 0)))
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            ...
            MaybePos_7 = (MR_Word) ((MR_Integer) 0);
        }
        else
        {
  ...
  MR_Word * MaybeFunctorNum_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      *MaybeFunctorNum_12 = (MR_Word) ((MR_Integer) 0);
    break;
  }
}
  ...
  MR_Word * SubTerm_6)
{
  while (MR_TRUE)
  {
    ...
    ;
    if ((Path_5 == (MR_Word) ((MR_Integer) 0)))
    {
      *SubTerm_6 = Term_4;
      succeeded = MR_TRUE;
    }
...
{
  {
    ...
    if ((MaybeSubUniv_9 == (MR_Word) ((MR_Integer) 0)))
      MaybeArg_7 = (MR_Word) ((MR_Integer) 0);
    else
    {
