                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            N_44 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_81, (MR_Integer) 0))));
                            {
                              ...
                              MR_hl_field(MR_mktag(0), Setting_142, 0) = ((MR_Box) (N_44));
                            }
                            {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            {
                              Setting_331 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(3), Setting_331, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                              MR_hl_field(MR_mktag(3), Setting_331, 1) = ((MR_Box) (N_319));
                            }
                            {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            {
                              Setting_215 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), Setting_215, 0) = ((MR_Box) (N_203));
                            }
                            {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            {
                              Setting_273 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(2), Setting_273, 0) = ((MR_Box) (N_261));
                            }
                            {
        ...
        else
        {
          ...
          if (succeeded)
          {
              ...
              mercury__string__from_char_list_2_p_0(Cs_4, &ArgName_24);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_26, 1) = ((MR_Box) (ArgName_24));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              mdb__parse__lexer_word_chars_2_p_0(TailCs_32, &TailTokens_34);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (Num_33));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *HeadVar__2_2 = base;
                ...
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TailTokens_34));
              }
            }
            else
            {
              ...
              if (succeeded)
              {
                ...
                mercury__list__take_while_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mdb__parse_scalar_common_4[1]), Cs_4, &LetterCs_38, &TailCs_39);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (MR_Word) (C_3));
                  MR_hl_field(MR_mktag(1), Var_43, 1) = ((MR_Box) (LetterCs_38));
                }
                ...
                mdb__parse__lexer_word_chars_2_p_0(TailCs_39, &TailTokens_41);
                {
                  ...
                  MR_hl_field(MR_mktag(2), Var_44, 0) = ((MR_Box) (Name_40));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__2_2 = base;
                  ...
                  MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TailTokens_41));
                }
              }
              else
              {
