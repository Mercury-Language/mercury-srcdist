...
/* sealed */ struct mdb__parse__vector_common_type_8_0_s {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    mercury__list__take_while_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mdb__parse_scalar_common_4[0]), Cs_4, &Digits_50, &Rest_51);
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__list__take_while_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mdb__parse_scalar_common_4[1]), Cs_4, &Letters_61, &Rest_62);
                      {
