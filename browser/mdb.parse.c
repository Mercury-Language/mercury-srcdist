...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__getopt__process_options_4_p_0((MR_Word) (&mdb__parse__mdb__parse__type_ctor_info_format_option_0), (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[5])), ArgWords_11, &RemainingWords_13, &MaybeOptionTable0_14);
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      mid_2 = (((MR_Integer) ((MR_Unsigned) lo_0 + (MR_Unsigned) hi_1)) / (MR_Integer) 2);
                      result_3 = MR_strcmp(Var_278, ((&mdb__parse_vector_common_5[0 + mid_2]))->mdb__parse__vector_common_type_5_0__vct_5_f_0);
                      if ((result_3 == (MR_Integer) 0))
                      {
                        AssertInvalid_29 = ((&mdb__parse_vector_common_5[0 + mid_2]))->mdb__parse__vector_common_type_5_0__vct_5_f_1;
                        succeeded = MR_TRUE;
                        // jump out of search loop
                        ;
                        goto label_0;
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            OptionOps_118 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[9]));
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          do
                          {
                            ...
                            result_7 = MR_strcmp(Var_280, ((&mdb__parse_vector_common_6[0 + mid_6]))->mdb__parse__vector_common_type_6_0__vct_6_f_0);
                            if ((result_7 == (MR_Integer) 0))
                            {
                              ParamCmd_41 = ((&mdb__parse_vector_common_6[0 + mid_6]))->mdb__parse__vector_common_type_6_0__vct_6_f_1;
                              succeeded = MR_TRUE;
                              // jump out of search loop
                              ;
                              goto label_1;
                        ...
                        if (succeeded)
                        {
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              OptionOps_136 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[13]));
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  OptionOps_156 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[17]));
