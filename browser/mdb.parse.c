  ...
  MR_Word * Command_8)
{
  ...
  if (succeeded)
  {
    Var_191 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
    if ((strcmp(Var_191, (MR_String) "p") == 0))
      succeeded = MR_TRUE;
    else
    if ((strcmp(Var_191, (MR_String) "ls") == 0))
      succeeded = MR_TRUE;
    else
    if ((strcmp(Var_191, (MR_String) "print") == 0))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
  }
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_192 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
      if ((strcmp(Var_192, (MR_String) "d") == 0))
        succeeded = MR_TRUE;
      else
      if ((strcmp(Var_192, (MR_String) "display") == 0))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_193 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
        if ((strcmp(Var_193, (MR_String) "w") == 0))
          succeeded = MR_TRUE;
        else
        if ((strcmp(Var_193, (MR_String) "write") == 0))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
      }
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_194 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
          if ((strcmp(Var_194, (MR_String) "addr") == 0))
            succeeded = MR_TRUE;
          else
          if ((strcmp(Var_194, (MR_String) "memory_addr") == 0))
            succeeded = MR_TRUE;
          else
            succeeded = MR_FALSE;
        }
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_168_168 = (MR_Word) (&mdb__parse_scalar_common_1[0]);
                mercury__list__duplicate_3_p_0(TypeInfo_168_168, Repetitions_22, ((MR_Box) (TokenPath_23)), &DupTokenPath_24);
                TypeCtorInfo_169_169 = (MR_Word) (&mdb__parse__mdb__parse__type_ctor_info_token_0);
                mercury__list__condense_2_p_0(TypeCtorInfo_169_169, DupTokenPath_24, &RepeatedTokenPath_25);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Var_195 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
                  // binary string simple lookup switch
                  ;
                  lo_0 = (MR_Integer) 0;
                  hi_1 = (MR_Integer) 3;
                  ...
                  {
                    mid_2 = (((MR_Integer) ((MR_Unsigned) lo_0 + (MR_Unsigned) hi_1)) / (MR_Integer) 2);
                    result_3 = MR_strcmp(Var_195, ((&mdb__parse_vector_common_6[0 + mid_2]))->mdb__parse__vector_common_type_6_0__vct_6_f_0);
                    if ((result_3 == (MR_Integer) 0))
                    {
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      Var_196 = ((MR_String) ((MR_hl_field(MR_mktag(3), HeadArgToken_31, (MR_Integer) 1))));
                      if ((strcmp(Var_196, (MR_String) "a") == 0))
                        succeeded = MR_TRUE;
                      else
                      if ((strcmp(Var_196, (MR_String) "accurate") == 0))
                        succeeded = MR_TRUE;
                      else
                        succeeded = MR_FALSE;
                    }
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          TypeCtorInfo_176_176 = (MR_Word) (&mdb__parse__mdb__parse__type_ctor_info_setting_option_0);
                          OptionOps_118 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_4[9]));
                          mercury__getopt__process_options_4_p_0(TypeCtorInfo_176_176, OptionOps_118, ArgWords_117, &RemainingWords_119, &MaybeOptionTable0_120);
                          MaybeOptionTable_121 = mercury__getopt__convert_to_maybe_option_table_1_f_0(TypeCtorInfo_176_176, MaybeOptionTable0_120);
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        Var_197 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));
                        // binary string simple lookup switch
                        ;
                        lo_4 = (MR_Integer) 0;
                        hi_5 = (MR_Integer) 3;
                        do
                        {
                          ...
                          result_7 = MR_strcmp(Var_197, ((&mdb__parse_vector_common_7[0 + mid_6]))->mdb__parse__vector_common_type_7_0__vct_7_f_0);
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            TypeCtorInfo_183_183 = (MR_Word) (&mdb__parse__mdb__parse__type_ctor_info_setting_option_0);
                            OptionOps_136 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_4[13]));
                            mercury__getopt__process_options_4_p_0(TypeCtorInfo_183_183, OptionOps_136, ArgWords_135, &RemainingWords_137, &MaybeOptionTable0_138);
                            MaybeOptionTable_139 = mercury__getopt__convert_to_maybe_option_table_1_f_0(TypeCtorInfo_183_183, MaybeOptionTable0_138);
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                TypeCtorInfo_190_190 = (MR_Word) (&mdb__parse__mdb__parse__type_ctor_info_setting_option_0);
                                OptionOps_156 = (MR_Word) (MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_4[17]));
                                mercury__getopt__process_options_4_p_0(TypeCtorInfo_190_190, OptionOps_156, Var_88, &Var_46, &MaybeOptionTable0_157);
                                MaybeOptionTable_158 = mercury__getopt__convert_to_maybe_option_table_1_f_0(TypeCtorInfo_190_190, MaybeOptionTable0_157);
                                {
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              if (((MR_tag((MR_Word) CmdToken_5)) == (MR_Integer) 2))
                              {
                                MR_String Var_198 = ((MR_String) ((MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0))));

                                if ((strcmp(Var_198, (MR_String) "h") == 0))
                                  succeeded = MR_TRUE;
                                else
                                if ((strcmp(Var_198, (MR_String) "help") == 0))
                                  succeeded = MR_TRUE;
                                else
                                  succeeded = MR_FALSE;
                              }
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  MR_String ArgName_31;
                  MR_Word Var_33;

                  succeeded = (H_7 == (MR_Char) 45);
                  if (succeeded)
                    mercury__string__from_char_list_2_p_0(T_8, &ArgName_31);
                  else
                    mercury__string__from_char_list_2_p_0(Cs_4, &ArgName_31);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_33, 1) = ((MR_Box) (ArgName_31));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    mercury__char__to_int_2_p_0((MR_Char) 48, &Zero_37);
                    mercury__char__to_int_2_p_0(C_3, &CN_38);
                    N_9 = (MR_Integer) ((MR_Unsigned) CN_38 - (MR_Unsigned) Zero_37);
                    mercury__list__take_while_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mdb__parse_scalar_common_4[0]), Cs_4, &Digits_43, &Rest_44);
                    mdb__parse__digits_to_int_acc_3_p_0(N_9, Digits_43, &Num_45);
                    {
                      Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (Num_45));
                    }
                    mdb__parse__lexer_word_chars_2_p_0(Rest_44, &Toks2_46);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      *HeadVar__2_2 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Var_48));
                      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_46));
                    }
                  }
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__list__take_while_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mdb__parse_scalar_common_4[1]), Cs_4, &Letters_54, &Rest_55);
                      {
                        Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (MR_Word) (C_3));
                        MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (Letters_54));
                      }
                      mercury__string__from_char_list_2_p_0(Var_59, &Name_56);
                      mdb__parse__lexer_word_chars_2_p_0(Rest_55, &Toks2_57);
                      {
                        Var_60 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), Var_60, 0) = ((MR_Box) (Name_56));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        *HeadVar__2_2 = base;
                        ...
                        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_57));
                      }
                    }
                    else
                    {
