...
MR_decl_label10(mdb__parse__parse_cmd_4_0, 690,9,14,8,18,20,2,26,24,32)
MR_decl_label10(mdb__parse__parse_cmd_4_0, 30,38,694,44,36,53,54,55,48,59)
MR_decl_label10(mdb__parse__parse_cmd_4_0, 697,65,58,68,75,76,77,74,80,85)
MR_decl_label10(mdb__parse__parse_cmd_4_0, 84,88,90,82,94,72,704,104,99,706)
MR_decl_label10(mdb__parse__parse_cmd_4_0, 118,119,120,107,127,128,129,126,132,139)
MR_decl_label10(mdb__parse__parse_cmd_4_0, 140,144,124,156,147,160,168,173,172,691)
...
MR_decl_label7(__Unify___mdb__parse__command_0_0, 20,18,24,28,74,32,1)
...
MR_decl_label10(__Compare___mdb__parse__command_0_0, 16,17,93,18,19,25,22,30,33,36)
MR_decl_label4(__Compare___mdb__parse__command_0_0, 41,45,8,55)
...
MR_def_label(mdb__parse__digits_to_int_acc_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (((MR_Integer) 10 * (MR_Integer) MR_sv(1)) + ((MR_Integer) MR_r1 - (MR_Integer) MR_sv(3)));
	MR_r2 = MR_sv(2);
...
MR_def_label(mdb__parse__parse_format_2_0,11)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(3,3,3);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__parse_module10)
	...
	MR_init_label10(mdb__parse__parse_cmd_4_0,690,9,14,8,18,20,2,26,24,32)
	MR_init_label10(mdb__parse__parse_cmd_4_0,30,38,694,44,36,53,54,55,48,59)
	MR_init_label10(mdb__parse__parse_cmd_4_0,697,65,58,68,75,76,77,74,80,85)
	MR_init_label10(mdb__parse__parse_cmd_4_0,84,88,90,82,94,72,704,104,99,706)
	MR_init_label10(mdb__parse__parse_cmd_4_0,118,119,120,107,127,128,129,126,132,139)
	MR_init_label10(mdb__parse__parse_cmd_4_0,140,144,124,156,147,160,168,173,172,691)
...
MR_def_static(mdb__parse__parse_cmd_4_0)
	...
	if ((strcmp((char *) (MR_Word *) MR_tempr1, MR_string_const("p", 1)) == 0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i690);
	}
...
MR_def_label(mdb__parse__parse_cmd_4_0,690)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(mdb__parse__parse_cmd_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i694);
	}
	MR_r2 = (MR_Word) MR_TAG_COMMON(2,6,0);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdb__parse__parse_cmd_4_0,694)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = MR_r2;
...
MR_def_label(mdb__parse__parse_cmd_4_0,48)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i58);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r1, 0);
...
MR_def_label(mdb__parse__parse_cmd_4_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i697);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 2);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdb__parse__parse_cmd_4_0,697)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(mdb__parse__parse_path_2_0,
		mdb__parse__parse_cmd_4_0_i65);
MR_def_label(mdb__parse__parse_cmd_4_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i1);
	}
...
MR_def_label(mdb__parse__parse_cmd_4_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
...
MR_def_label(mdb__parse__parse_cmd_4_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i72);
	}
	...
	MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i74);
...
MR_def_label(mdb__parse__parse_cmd_4_0,80)
	...
	MR_r1 = MR_r2;
	MR_r2 = MR_tfield(1, MR_r1, 1);
	MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i84);
	}
MR_def_label(mdb__parse__parse_cmd_4_0,85)
	...
	MR_r1 = MR_r2;
	MR_r2 = MR_tfield(1, MR_r1, 1);
MR_def_label(mdb__parse__parse_cmd_4_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i88);
	}
	MR_tag_alloc_heap(MR_r2, 3, (MR_Integer) 3);
	MR_tfield(3, MR_r2, 0) = (MR_Integer) 1;
...
MR_def_label(mdb__parse__parse_cmd_4_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i99);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r1, 0);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i704);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 4);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
MR_def_label(mdb__parse__parse_cmd_4_0,704)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(mdb__parse__parse_path_2_0,
		mdb__parse__parse_cmd_4_0_i104);
MR_def_label(mdb__parse__parse_cmd_4_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i1);
	}
...
MR_def_label(mdb__parse__parse_cmd_4_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i706);
	}
	MR_r2 = (MR_Word) MR_TAG_COMMON(3,7,0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
MR_def_label(mdb__parse__parse_cmd_4_0,706)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_r3 = MR_tfield(1, MR_r3, 0);
	MR_np_call_localret_ent(getopt__process_options_4_0,
		mdb__parse__parse_cmd_4_0_i118);
MR_def_label(mdb__parse__parse_cmd_4_0,118)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(mdb__parse__lexer_words_2_0,
...
MR_def_label(mdb__parse__parse_cmd_4_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i124);
	}
	MR_r4 = MR_tfield(2, MR_r1, 0);
...
MR_def_label(mdb__parse__parse_cmd_4_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i132);
	}
	MR_r2 = (MR_Word) MR_TAG_COMMON(3,7,0);
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(3);
MR_def_label(mdb__parse__parse_cmd_4_0,132)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i1);
	}
	...
	MR_r3 = MR_tfield(1, MR_r3, 0);
	MR_np_call_localret_ent(getopt__process_options_4_0,
		mdb__parse__parse_cmd_4_0_i139);
MR_def_label(mdb__parse__parse_cmd_4_0,139)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	MR_np_call_localret_ent(mdb__parse__lexer_words_2_0,
...
MR_def_label(mdb__parse__parse_cmd_4_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,5)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i147);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_def_label(mdb__parse__parse_cmd_4_0,147)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i160);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(2, MR_r1, 0);
...
MR_def_label(mdb__parse__parse_cmd_4_0,160)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i168);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r1, 0);
...
MR_def_label(mdb__parse__parse_cmd_4_0,168)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i172);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r1, 0);
...
MR_def_label(mdb__parse__parse_cmd_4_0,173)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdb__parse__parse_cmd_4_0,172)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(mdb__parse__parse_cmd_4_0_i691);
	}
...
MR_BEGIN_MODULE(mdb__parse_module23)
	...
	MR_init_label7(__Unify___mdb__parse__command_0_0,20,18,24,28,74,32,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdb__parse__command_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdb__parse__command_0_0_i74);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___mdb__parse__command_0_0,14)
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___mdb__parse__command_0_0_i20);
...
MR_def_label(__Unify___mdb__parse__command_0_0,18)
	...
	if (MR_RTAGS_TESTR(MR_sv(1),3,0)) {
		MR_GOTO_LAB(__Unify___mdb__parse__command_0_0_i24);
	}
...
MR_def_label(__Unify___mdb__parse__command_0_0,24)
	...
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Unify___mdb__parse__command_0_0_i28);
	}
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___mdb__parse__path_0_0);
MR_def_label(__Unify___mdb__parse__command_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Unify___mdb__parse__command_0_0_i32);
	}
...
MR_def_label(__Unify___mdb__parse__command_0_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(__Unify___mdb__parse__command_0_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__parse_module25)
	...
	MR_init_label10(__Compare___mdb__parse__command_0_0,16,17,93,18,19,25,22,30,33,36)
	MR_init_label4(__Compare___mdb__parse__command_0_0,41,45,8,55)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdb__parse__command_0_0);
	...
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___mdb__parse__command_0_0_i93);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(__Compare___mdb__parse__command_0_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(5);
...
MR_def_label(__Compare___mdb__parse__command_0_0,19)
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___mdb__parse__command_0_0_i25);
MR_def_label(__Compare___mdb__parse__command_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
...
MR_def_label(__Compare___mdb__parse__command_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,0)) {
		MR_GOTO_LAB(__Compare___mdb__parse__command_0_0_i30);
	}
	if (MR_RTAGS_TESTR(MR_sv(2),3,0)) {
		MR_GOTO_LAB(__Compare___mdb__parse__command_0_0_i8);
	}
...
MR_def_label(__Compare___mdb__parse__command_0_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Compare___mdb__parse__command_0_0_i36);
	}
	if (MR_RTAGS_TESTR(MR_sv(2),3,3)) {
		MR_GOTO_LAB(__Compare___mdb__parse__command_0_0_i8);
	}
...
void mercury__mdb__parse__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__parse);
