              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_92, ArgY1_35);
                }
                break;
              case (MR_Integer) 2:
                *HeadVar__1_1 = (MR_Integer) 1;
          ...
          switch (MR_tag((MR_Word) HeadVar__2_2)) {
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  mercury__builtin__compare_3_p_0(TypeInfo_30_30, &Var_11, ((MR_Box) (ArgX1_7)), ((MR_Box) (ArgY1_8)));
                  ...
                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &mdb__parse_scalar_common_1[3], &Var_6, ((MR_Box) (ArgX2_9)), ((MR_Box) (ArgY2_10)));
                  }
                  succeeded = MR_TRUE;
                }
              }
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0)))) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word ArgX1_16 = (((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
                    MR_Word ArgY1_17;
                    MR_Word ArgX2_18 = (((((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
                    MR_Word ArgY2_19;
                    MR_Word ArgX3_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2)));
                    MR_Word ArgY3_21;
                    MR_Word Var_22;
                    MR_Integer Var_39;
                    MR_Integer Var_40;
                    ...
                    if (succeeded)
                    {
                      ArgY1_17 = (((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 1);
                      ArgY2_19 = (((((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
                      ArgY3_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2)));
                      ...
                      {
                        MR_Word Var_23;
                        MR_Integer Var_41 = (MR_Integer) ArgX2_18;
                        MR_Integer Var_42 = (MR_Integer) ArgY2_19;
                        ...
                        {
                          mercury__builtin__compare_3_p_0((MR_Word) &mdb__parse_scalar_common_1[3], &Var_6, ((MR_Box) (ArgX3_20)), ((MR_Box) (ArgY3_21)));
                        }
                      }
                      succeeded = MR_TRUE;
                    }
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word ArgX1_19 = (((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 1);
                MR_Word ArgY1_20;
                MR_Word ArgX2_21 = (((((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
                MR_Word ArgY2_22;
                ...
                if (succeeded)
                {
                  ArgY1_20 = (((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
                  ArgY2_22 = (((((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    {
      mid_2 = (((MR_Integer) ((MR_Unsigned) lo_0 + (MR_Unsigned) hi_1)) / (MR_Integer) 2);
      result_3 = MR_strcmp(HeadVar__1_1, ((&mdb__parse_vector_common_7[0 + mid_2]))->mdb__parse__vector_common_type_7_0__vct_7_f_0);
      if ((result_3 == (MR_Integer) 0))
      {
        *HeadVar__2_2 = ((&mdb__parse_vector_common_7[0 + mid_2]))->mdb__parse__vector_common_type_7_0__vct_7_f_1;
        succeeded = MR_TRUE;
        // jump out of search loop
        goto label_0;
      }
...
{
  {
    ...
    mercury__io__read_3_p_0((MR_Word) &mdb__parse__mdb__parse__type_ctor_info_external_request_0, &Result_6);
    switch (MR_tag((MR_Word) Result_6)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *Command_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
        break;
      case (MR_Integer) 1:
        {
          MR_String StringToParse_7;
          MR_Word Words_8;
          MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), Result_6, (MR_Integer) 0)));
          MR_Word CommandPrime_9;

          StringToParse_7 = (MR_String) Var_15;
          Words_8 = mercury__string__words_separator_2_f_0((MR_Word) &mdb__parse_scalar_common_3[19], StringToParse_7);
          succeeded = mdb__parse__parse_2_p_0(Words_8, &CommandPrime_9);
          if (succeeded)
            *Command_4 = CommandPrime_9;
          else
            *Command_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
        }
        break;
      case (MR_Integer) 2:
        *Command_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
...
{
  {
    ...
    MR_String Line_8;
    MR_Word Words_9;
    MR_Word CommandPrime_10;

    mdb__util__trace_get_command_4_p_0(Prompt_5, &Line_8);
    Words_9 = mercury__string__words_separator_2_f_0((MR_Word) &mdb__parse_scalar_common_3[18], Line_8);
    succeeded = mdb__parse__parse_2_p_0(Words_9, &CommandPrime_10);
    if (succeeded)
      *Command_6 = CommandPrime_10;
    else
      *Command_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
  }
}
...
{
  {
    ...
    if ((Words_3 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
    {
      *Command_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      mercury__string__to_char_list_2_p_0(CmdWord_5, &Chars_18);
      mdb__parse__lexer_word_chars_2_p_0(Chars_18, &CmdTokens_7);
      mdb__parse__lexer_words_2_p_0(ArgWords_6, &ArgTokens_8);
      succeeded = ((MR_tag((MR_Word) CmdTokens_7)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), CmdTokens_7, (MR_Integer) 0)));
      ...
      if (succeeded)
        {
          MaybeArgWords_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeArgWords_10, 0) = ((MR_Box) (ArgWords_6));
        }
      else
        MaybeArgWords_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      mercury__list__append_3_p_1((MR_Word) &mdb__parse__mdb__parse__type_ctor_info_token_0, CmdTokens_7, ArgTokens_8, &AllTokens_11);
      if ((AllTokens_11 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      {
        *Command_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
        succeeded = MR_TRUE;
      }
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) CmdToken_5)) == (MR_mktag((MR_Integer) 2)));
    MR_String Var_255;

    if (succeeded)
    {
      Var_255 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
      if ((strcmp(Var_255, (MR_String) "p") == 0))
        succeeded = MR_TRUE;
      else
      if ((strcmp(Var_255, (MR_String) "ls") == 0))
        succeeded = MR_TRUE;
      else
      if ((strcmp(Var_255, (MR_String) "print") == 0))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
    }
    if (succeeded)
    {
      ...
      MR_Word MaybePath_15;

      if ((MaybeArgWords_7 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      {
        MaybeMaybeOptionTable_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      else
      {
        ...
        MR_Word MaybeOptionTable_14;

        mercury__getopt__process_options_4_p_0((MR_Word) &mdb__parse__mdb__parse__type_ctor_info_format_option_0, (MR_Word) MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[5]), ArgWords_11, &RemainingWords_13, &MaybeOptionTable_14);
        {
          MaybeMaybeOptionTable_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeMaybeOptionTable_9, 0) = ((MR_Box) (MaybeOptionTable_14));
        }
        mdb__parse__lexer_words_2_p_0(RemainingWords_13, &RemainingTokens_10);
      }
      if ((RemainingTokens_10 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      {
        MaybePath_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        succeeded = mdb__parse__parse_path_2_p_0(RemainingTokens_10, &Path_18);
        if (succeeded)
        {
          {
            MaybePath_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybePath_15, 0) = ((MR_Box) (Path_18));
          }
          succeeded = MR_TRUE;
        }
      }
      ...
      {
        {
          ...
          *Command_8 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MaybePath_15));
        }
        succeeded = MR_TRUE;
      }
    }
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) CmdToken_5)) == (MR_mktag((MR_Integer) 2)));
      if (succeeded)
      {
        Var_256 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
        if ((strcmp(Var_256, (MR_String) "d") == 0))
          succeeded = MR_TRUE;
        else
        if ((strcmp(Var_256, (MR_String) "display") == 0))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
      }
      if (succeeded)
      {
        succeeded = (ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
        if (succeeded)
        {
          *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          succeeded = MR_TRUE;
        }
      }
      else
      {
        ...
        if (succeeded)
        {
          Var_257 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
          if ((strcmp(Var_257, (MR_String) "w") == 0))
            succeeded = MR_TRUE;
          else
          if ((strcmp(Var_257, (MR_String) "write") == 0))
            succeeded = MR_TRUE;
          else
            succeeded = MR_FALSE;
        }
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
            succeeded = MR_TRUE;
          }
        }
        else
        {
          ...
          if (succeeded)
          {
            Var_258 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
            if ((strcmp(Var_258, (MR_String) "addr") == 0))
              succeeded = MR_TRUE;
            else
            if ((strcmp(Var_258, (MR_String) "memory_addr") == 0))
              succeeded = MR_TRUE;
            else
              succeeded = MR_FALSE;
          }
          if (succeeded)
          {
            MR_Word MaybePath_100;

            if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
            {
              MaybePath_100 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              succeeded = MR_TRUE;
            }
            else
            {
              ...
              succeeded = mdb__parse__parse_path_2_p_0(ArgTokens_6, &Path_98);
              if (succeeded)
              {
                {
                  MaybePath_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePath_100, 0) = ((MR_Box) (Path_98));
                }
                succeeded = MR_TRUE;
              }
            }
            ...
            {
              {
                ...
                *Command_8 = base;
                MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (MaybePath_100));
              }
              succeeded = MR_TRUE;
            }
          }
          else
          {
            ...
            if (succeeded)
            {
              Var_58 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
              succeeded = (strcmp(Var_58, (MR_String) "cdr") == 0);
            }
            if (succeeded)
            {
              MR_Word TypeInfo_232_232;
              MR_Word TypeCtorInfo_233_233;
              MR_Integer Repetitions_21;
              MR_Word TokenPath_22;
              MR_Word DupTokenPath_23;
              MR_Word RepeatedTokenPath_24;
              MR_Word RepeatedPath_25;
              MR_Word Var_59;

              succeeded = ((MR_tag((MR_Word) ArgTokens_6)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
                Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 0)));
                TokenPath_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 1)));
                succeeded = ((MR_tag((MR_Word) Var_59)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                  Repetitions_21 = ((MR_Integer) (MR_hl_field(MR_mktag(1), Var_59, (MR_Integer) 0)));
                  TypeInfo_232_232 = (MR_Word) &mdb__parse_scalar_common_1[0];
                  mercury__list__duplicate_3_p_0(TypeInfo_232_232, Repetitions_21, ((MR_Box) (TokenPath_22)), &DupTokenPath_23);
                  TypeCtorInfo_233_233 = (MR_Word) &mdb__parse__mdb__parse__type_ctor_info_token_0;
                  mercury__list__condense_2_p_0(TypeCtorInfo_233_233, DupTokenPath_23, &RepeatedTokenPath_24);
                  succeeded = mdb__parse__parse_path_2_p_0(RepeatedTokenPath_24, &RepeatedPath_25);
                  if (succeeded)
                  {
                    {
                      MR_Word base;
                      ...
                      *Command_8 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (RepeatedPath_25));
                    }
                    succeeded = MR_TRUE;
                  }
                }
            ...
            {
              if ((CmdToken_5 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4))))
                succeeded = MR_TRUE;
              else
              if (((MR_tag((MR_Word) CmdToken_5)) == (MR_mktag((MR_Integer) 2))))
              {
                MR_String Var_60 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));

                succeeded = (strcmp(Var_60, (MR_String) "cd") == 0);
              }
              else
                succeeded = MR_FALSE;
              if (succeeded)
                if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                {
                  *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
                  succeeded = MR_TRUE;
                }
                else
                {
                  ...
                  succeeded = mdb__parse__parse_path_2_p_0(ArgTokens_6, &Path_102);
                  if (succeeded)
                  {
                    {
                      MR_Word base;
                      ...
                      *Command_8 = base;
                      MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Path_102));
                    }
                    succeeded = MR_TRUE;
                  }
                }
              else
              {
                ...
                if (succeeded)
                {
                  Var_61 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                  succeeded = (strcmp(Var_61, (MR_String) "pwd") == 0);
                }
                if (succeeded)
                {
                  succeeded = (ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
                  if (succeeded)
                  {
                    *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
                    succeeded = MR_TRUE;
                  }
                }
                else
                {
                  MR_Word AssertInvalid_28;
                  MR_String Var_259;
                  MR_Integer lo_0;
                  MR_Integer hi_1;
                  MR_Integer mid_2;
                  ...
                  if (succeeded)
                  {
                    Var_259 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                    // binary string simple lookup switch
                    lo_0 = (MR_Integer) 0;
                    hi_1 = (MR_Integer) 3;
                    do
                    {
                      mid_2 = (((MR_Integer) ((MR_Unsigned) lo_0 + (MR_Unsigned) hi_1)) / (MR_Integer) 2);
                      result_3 = MR_strcmp(Var_259, ((&mdb__parse_vector_common_5[0 + mid_2]))->mdb__parse__vector_common_type_5_0__vct_5_f_0);
                      if ((result_3 == (MR_Integer) 0))
                      {
                        AssertInvalid_28 = ((&mdb__parse_vector_common_5[0 + mid_2]))->mdb__parse__vector_common_type_5_0__vct_5_f_1;
                        succeeded = MR_TRUE;
                        // jump out of search loop
                        goto label_0;
                      }
                  ...
                  {
                    MR_Word HowTrack_29;
                    MR_Word MaybePath_111;

                    if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                    {
                      HowTrack_29 = (MR_Integer) 1;
                      MaybePath_111 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                      succeeded = MR_TRUE;
                    }
                    else
                    {
                      MR_Word HeadArgToken_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 0)));
                      MR_Word TailArgTokens_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 1)));
                      MR_String Var_260;

                      succeeded = ((((MR_tag((MR_Word) HeadArgToken_30)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadArgToken_30, (MR_Integer) 0))) == (MR_Integer) 0)));
                      if (succeeded)
                      {
                        Var_260 = ((MR_String) (MR_hl_field(MR_mktag(3), HeadArgToken_30, (MR_Integer) 1)));
                        if ((strcmp(Var_260, (MR_String) "a") == 0))
                          succeeded = MR_TRUE;
                        else
                        if ((strcmp(Var_260, (MR_String) "accurate") == 0))
                          succeeded = MR_TRUE;
                        else
                          succeeded = MR_FALSE;
                      }
                      if (succeeded)
                      {
                        HowTrack_29 = (MR_Integer) 0;
                        if ((TailArgTokens_31 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                        {
                          MaybePath_111 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                          succeeded = MR_TRUE;
                        }
                        else
                        {
                          ...
                          succeeded = mdb__parse__parse_path_2_p_0(TailArgTokens_31, &Path_104);
                          if (succeeded)
                          {
                            {
                              MaybePath_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), MaybePath_111, 0) = ((MR_Box) (Path_104));
                            }
                            succeeded = MR_TRUE;
                          }
                        }
                      ...
                      else
                      {
                        ...
                        HowTrack_29 = (MR_Integer) 1;
                        succeeded = mdb__parse__parse_path_2_p_0(ArgTokens_6, &Path_107);
                        if (succeeded)
                        {
                          {
                            MaybePath_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), MaybePath_111, 0) = ((MR_Box) (Path_107));
                          }
                          succeeded = MR_TRUE;
                        }
                      }
                    ...
                    {
                      {
                        ...
                        *Command_8 = base;
                        ...
                        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) ((HowTrack_29 | ((AssertInvalid_28 << (MR_Integer) 1)))));
                        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaybePath_111));
                      }
                      succeeded = MR_TRUE;
                    }
                  }
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      Var_68 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                      succeeded = (strcmp(Var_68, (MR_String) "mode") == 0);
                    }
                    if (succeeded)
                      if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                      {
                        *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4));
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                        ...
                        succeeded = mdb__parse__parse_path_2_p_0(ArgTokens_6, &Path_113);
                        if (succeeded)
                        {
                          {
                            MR_Word base;
                            ...
                            *Command_8 = base;
                            ...
                            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Path_113));
                          }
                          succeeded = MR_TRUE;
                        }
                      }
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = (strcmp(Var_69, (MR_String) "format") == 0);
                      }
                      if (succeeded)
                      {
                        MR_Word FormatCmd_36;

                        if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                        {
                          FormatCmd_36 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                          succeeded = MR_TRUE;
                        }
                        else
                        {
                          ...
                          MR_Word Var_71;
                          MR_Word Var_72;
                          MR_Word RemainingTokens_115;
                          MR_Word ArgWords_116;
                          MR_Word OptionOps_117;
                          MR_Word RemainingWords_118;
                          MR_Word MaybeOptionTable_119;

                          succeeded = ((MR_tag((MR_Word) MaybeArgWords_7)) == (MR_mktag((MR_Integer) 1)));
                          if (succeeded)
                          {
                            ArgWords_116 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeArgWords_7, (MR_Integer) 0)));
                            Var_70 = (MR_Word) &mdb__parse_scalar_common_3[6];
                            Var_71 = (MR_Word) &mdb__parse_scalar_common_3[7];
                            Var_72 = (MR_Word) &mdb__parse_scalar_common_3[8];
                            TypeCtorInfo_240_240 = (MR_Word) &mdb__parse__mdb__parse__type_ctor_info_setting_option_0;
                            OptionOps_117 = (MR_Word) MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[9]);
                            mercury__getopt__process_options_4_p_0(TypeCtorInfo_240_240, OptionOps_117, ArgWords_116, &RemainingWords_118, &MaybeOptionTable_119);
                            mdb__parse__lexer_words_2_p_0(RemainingWords_118, &RemainingTokens_115);
                            succeeded = mdb__parse__parse_format_2_p_0(RemainingTokens_115, &Setting_39);
                            if (succeeded)
                            {
                              {
                                FormatCmd_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), FormatCmd_36, 0) = ((MR_Box) (MaybeOptionTable_119));
                                MR_hl_field(MR_mktag(1), FormatCmd_36, 1) = ((MR_Box) (Setting_39));
                              }
                              succeeded = MR_TRUE;
                            }
                          }
                        ...
                        {
                          {
                            ...
                            *Command_8 = base;
                            ...
                            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (FormatCmd_36));
                          }
                          succeeded = MR_TRUE;
                        }
                      }
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          Var_261 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                          // binary string simple lookup switch
                          lo_4 = (MR_Integer) 0;
                          hi_5 = (MR_Integer) 3;
                          do
                          {
                            ...
                            result_7 = MR_strcmp(Var_261, ((&mdb__parse_vector_common_6[0 + mid_6]))->mdb__parse__vector_common_type_6_0__vct_6_f_0);
                            if ((result_7 == (MR_Integer) 0))
                            {
                              ParamCmd_40 = ((&mdb__parse_vector_common_6[0 + mid_6]))->mdb__parse__vector_common_type_6_0__vct_6_f_1;
                              succeeded = MR_TRUE;
                              // jump out of search loop
                              goto label_1;
                            }
                        ...
                        if (succeeded)
                        {
                          MR_Word FormatCmd_147;

                          if ((ArgTokens_6 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
                          {
                            FormatCmd_147 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                            succeeded = MR_TRUE;
                          }
                          else
                          {
                            ...
                            MR_Word Var_80;
                            MR_Word Var_81;
                            MR_Word RemainingTokens_130;
                            MR_Word ArgWords_131;
                            MR_Word OptionOps_132;
                            MR_Word RemainingWords_133;
                            MR_Word MaybeOptionTable_134;
                            MR_Word Setting_135;

                            succeeded = ((MR_tag((MR_Word) MaybeArgWords_7)) == (MR_mktag((MR_Integer) 1)));
                            if (succeeded)
                            {
                              ArgWords_131 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeArgWords_7, (MR_Integer) 0)));
                              Var_77 = (MR_Word) &mdb__parse_scalar_common_3[10];
                              Var_78 = (MR_Word) &mdb__parse_scalar_common_3[11];
                              Var_79 = (MR_Word) &mdb__parse_scalar_common_3[12];
                              TypeCtorInfo_247_247 = (MR_Word) &mdb__parse__mdb__parse__type_ctor_info_setting_option_0;
                              OptionOps_132 = (MR_Word) MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[13]);
                              mercury__getopt__process_options_4_p_0(TypeCtorInfo_247_247, OptionOps_132, ArgWords_131, &RemainingWords_133, &MaybeOptionTable_134);
                              mdb__parse__lexer_words_2_p_0(RemainingWords_133, &RemainingTokens_130);
                              succeeded = ((MR_tag((MR_Word) RemainingTokens_130)) == (MR_mktag((MR_Integer) 1)));
                              if (succeeded)
                              {
                                Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(1), RemainingTokens_130, (MR_Integer) 0)));
                                Var_81 = ((MR_Word) (MR_hl_field(MR_mktag(1), RemainingTokens_130, (MR_Integer) 1)));
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    N_43 = ((MR_Integer) (MR_hl_field(MR_mktag(1), Var_80, (MR_Integer) 0)));
                                    mdb__parse__param_cmd_to_setting_3_p_0(ParamCmd_40, N_43, &Setting_135);
                                    {
                                      FormatCmd_147 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                      MR_hl_field(MR_mktag(2), FormatCmd_147, 0) = ((MR_Box) (MaybeOptionTable_134));
                                      MR_hl_field(MR_mktag(2), FormatCmd_147, 1) = ((MR_Box) (Setting_135));
                                    }
                                    succeeded = MR_TRUE;
                                  }
                                }
                          ...
                          {
                            {
                              ...
                              *Command_8 = base;
                              MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (FormatCmd_147));
                            }
                            succeeded = MR_TRUE;
                          }
                        }
                        ...
                        {
                          succeeded = (CmdToken_5 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
                          if (succeeded)
                          {
                            ...
                            MR_Word Var_87;
                            MR_Word Var_88;
                            MR_Word OptionOps_149;
                            MR_Word MaybeOptionTable_150;
                            MR_Word FormatCmd_151;
                            MR_Word Var_45;

                            succeeded = ((MR_tag((MR_Word) ArgTokens_6)) == (MR_mktag((MR_Integer) 1)));
                            if (succeeded)
                            {
                              Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 0)));
                              Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 1)));
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  Depth_44 = ((MR_Integer) (MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0)));
                                  Var_84 = (MR_Word) &mdb__parse_scalar_common_3[14];
                                  Var_85 = (MR_Word) &mdb__parse_scalar_common_3[15];
                                  Var_86 = (MR_Word) &mdb__parse_scalar_common_3[16];
                                  Var_87 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                  TypeCtorInfo_254_254 = (MR_Word) &mdb__parse__mdb__parse__type_ctor_info_setting_option_0;
                                  OptionOps_149 = (MR_Word) MR_mkword(MR_mktag(2), &mdb__parse_scalar_common_3[17]);
                                  mercury__getopt__process_options_4_p_0(TypeCtorInfo_254_254, OptionOps_149, Var_87, &Var_45, &MaybeOptionTable_150);
                                  {
                                    Var_88 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                                    MR_hl_field(MR_mktag(0), Var_88, 0) = ((MR_Box) (Depth_44));
                                  }
                                  {
                                    FormatCmd_151 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                    MR_hl_field(MR_mktag(2), FormatCmd_151, 0) = ((MR_Box) (MaybeOptionTable_150));
                                    MR_hl_field(MR_mktag(2), FormatCmd_151, 1) = ((MR_Box) (Var_88));
                                  }
                                  {
                                    MR_Word base;
                                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                    *Command_8 = base;
                                    MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                                    MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (FormatCmd_151));
                                  }
                                  succeeded = MR_TRUE;
                                }
                              }
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              Var_89 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                              succeeded = (strcmp(Var_89, (MR_String) "num_io_actions") == 0);
                            }
                            if (succeeded)
                            {
                              MR_Word Var_90;
                              ...
                              if (succeeded)
                              {
                                Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 0)));
                                Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTokens_6, (MR_Integer) 1)));
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    N_152 = ((MR_Integer) (MR_hl_field(MR_mktag(1), Var_90, (MR_Integer) 0)));
                                    {
                                      Var_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                                      MR_hl_field(MR_mktag(3), Var_92, 0) = ((MR_Box) (N_152));
                                    }
                                    {
                                      MR_Word base;
                                      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            ...
                            else
                            {
                              ...
                              if (succeeded)
                              {
                                Var_93 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                                succeeded = (strcmp(Var_93, (MR_String) "params") == 0);
                              }
                              if (succeeded)
                              {
                                *Command_8 = (MR_Word) MR_mkword(MR_mktag(3), &mdb__parse_scalar_common_1[9]);
                                succeeded = MR_TRUE;
                              }
                              else
                              {
                                if ((CmdToken_5 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))))
                                  succeeded = MR_TRUE;
                                else
                                if (((MR_tag((MR_Word) CmdToken_5)) == (MR_mktag((MR_Integer) 2))))
                                {
                                  MR_String Var_262 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));

                                  if ((strcmp(Var_262, (MR_String) "h") == 0))
                                    succeeded = MR_TRUE;
                                  else
                                  if ((strcmp(Var_262, (MR_String) "help") == 0))
                                    succeeded = MR_TRUE;
                                  else
                                    succeeded = MR_FALSE;
                                }
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
                                    succeeded = MR_TRUE;
                                  }
                                }
                                else
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      Var_97 = ((MR_String) (MR_hl_field(MR_mktag(2), CmdToken_5, (MR_Integer) 0)));
                                      succeeded = (strcmp(Var_97, (MR_String) "quit") == 0);
                                      if (succeeded)
                                      {
                                        *Command_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
                                        succeeded = MR_TRUE;
                                      }
                                    }
                                  }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Token_3)) == (MR_mktag((MR_Integer) 2)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            *Setting_4 = (MR_Word) MR_mkword(MR_mktag(3), &mdb__parse_scalar_common_1[5]);
            succeeded = MR_TRUE;
          }
          else
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Token_3 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)));
      if (succeeded)
      {
        MR_Word Dirs_6;
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    mercury__string__to_char_list_2_p_0(Word_3, &Chars_11);
    mdb__parse__lexer_word_chars_2_p_0(Chars_11, &WordTokens_6);
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
        if ((Cs_4 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
          *HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        else
        {
          MR_Char C_27 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Cs_4, (MR_Integer) 0)));
          MR_Word Cs_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), Cs_4, (MR_Integer) 1)));

          succeeded = (C_27 == (MR_Char) 46);
          if (succeeded)
          {
            MR_Word Toks2_30;

            mdb__parse__lexer_word_chars_2_p_0(Cs_28, &Toks2_30);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__2_2 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_30));
            }
          }
          else
          {
            ...
            mdb__parse__lexer_word_chars_2_p_0(Cs_4, &Toks2_34);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__2_2 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_34));
            }
          }
        }
      else
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) Cs_4)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                    mercury__string__from_char_list_2_p_0(T_8, &ArgName_38);
                  else
                    mercury__string__from_char_list_2_p_0(Cs_4, &ArgName_38);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (ArgName_38));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    mercury__char__to_int_2_p_0((MR_Char) 48, &Zero_44);
                    mercury__char__to_int_2_p_0(C_3, &CN_45);
                    N_9 = (MR_Integer) ((MR_Unsigned) CN_45 - (MR_Unsigned) Zero_44);
                    mercury__list__take_while_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &mdb__parse_scalar_common_3[0], Cs_4, &Digits_50, &Rest_51);
                    mdb__parse__digits_to_int_acc_3_p_0(N_9, Digits_50, &Num_52);
                    {
                      Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (Num_52));
                    }
                    mdb__parse__lexer_word_chars_2_p_0(Rest_51, &Toks2_53);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      *HeadVar__2_2 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Var_55));
                      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_53));
                    }
                  }
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__list__take_while_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &mdb__parse_scalar_common_3[1], Cs_4, &Letters_61, &Rest_62);
                      {
                        Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (MR_Word) (C_3));
                        MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Letters_61));
                      }
                      mercury__string__from_char_list_2_p_0(Var_66, &Name_63);
                      mdb__parse__lexer_word_chars_2_p_0(Rest_62, &Toks2_64);
                      {
                        Var_67 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), Var_67, 0) = ((MR_Box) (Name_63));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        *HeadVar__2_2 = base;
                        ...
                        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Toks2_64));
                      }
                    }
                    else
                    {
  ...
  MR_Integer * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__char__to_int_2_p_0((MR_Char) 48, &Zero_15);
      mercury__char__to_int_2_p_0(C_6, &CN_16);
      D_9 = (MR_Integer) ((MR_Unsigned) CN_16 - (MR_Unsigned) Zero_15);
      Var_11 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 10 * (MR_Unsigned) Acc_1);
