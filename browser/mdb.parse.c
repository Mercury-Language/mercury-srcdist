                                ...
                                if (mdb__parse__succeeded)
                                  {
                                    ...
                                    {
                                      mdb__parse__V_40_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                      MR_hl_field(MR_mktag(3), mdb__parse__V_40_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                                      MR_hl_field(MR_mktag(3), mdb__parse__V_40_40, 1) = ((MR_Box) (mdb__parse__ArgName_38));
                                    }
                                    {
                                      MR_Word base;
                                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                      *mdb__parse__HeadVar__2_2 = base;
                                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdb__parse__V_40_40));
                                    ...
                                    if (mdb__parse__succeeded)
                                      {
                                        ...
                                        {
                                          mdb__parse__V_55_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                                          MR_hl_field(MR_mktag(1), mdb__parse__V_55_55, 0) = ((MR_Box) (mdb__parse__Num_52));
                                        }
                                        {
                                        ...
                                        }
                                        {
                                          ...
                                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                          *mdb__parse__HeadVar__2_2 = base;
                                          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdb__parse__V_55_55));
                                        ...
                                        if (mdb__parse__succeeded)
                                          {
                                            ...
                                            MR_Word mdb__parse__V_66_66;
                                            MR_Word mdb__parse__V_67_67;
                                            ...
                                            {
                                              mdb__parse__V_66_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                              MR_hl_field(MR_mktag(1), mdb__parse__V_66_66, 0) = ((MR_Box) (MR_Word) (mdb__parse__C_3));
                                              MR_hl_field(MR_mktag(1), mdb__parse__V_66_66, 1) = ((MR_Box) (mdb__parse__Letters_61));
                                            }
                                            {
                                              mercury__string__from_char_list_2_p_0(mdb__parse__V_66_66, &mdb__parse__Name_63);
                                            }
                                            {
                                              mdb__parse__lexer_word_chars_2_p_0(mdb__parse__Rest_62, &mdb__parse__Toks2_64);
                                            }
                                            {
                                              mdb__parse__V_67_67 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                                              MR_hl_field(MR_mktag(2), mdb__parse__V_67_67, 0) = ((MR_Box) (mdb__parse__Name_63));
                                            }
                                            {
                                              MR_Word base;
                                              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                              *mdb__parse__HeadVar__2_2 = base;
                                              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdb__parse__V_67_67));
