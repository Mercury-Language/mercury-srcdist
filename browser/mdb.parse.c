...
{
  {
    ...
    {
      mercury__list__take_while_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &mdb__parse_scalar_common_3[3], mdb__parse__Cs_5, &mdb__parse__Letters_7, &mdb__parse__Rest_8);
    }
    {
...
{
  {
    ...
    {
      mercury__list__take_while_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &mdb__parse_scalar_common_3[2], mdb__parse__Cs_5, &mdb__parse__Digits_7, &mdb__parse__Rest_8);
    }
    {
