...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) CmdTokens_7)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((MR_tag((MR_Word) ArgTokens_6)) == (MR_Integer) 1);
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      succeeded = ((((MR_tag((MR_Word) HeadArgToken_30)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadArgToken_30, (MR_Integer) 0))) == (MR_Integer) 0)));
                      if (succeeded)
                      {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          succeeded = ((MR_tag((MR_Word) MaybeArgWords_7)) == (MR_Integer) 1);
                          if (succeeded)
                          {
                        ...
                        if (succeeded)
                        {
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = ((MR_tag((MR_Word) RemainingTokens_130)) == (MR_Integer) 1);
                              if (succeeded)
                              {
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) Cs_4)) == (MR_Integer) 1);
                  if (succeeded)
                  {
