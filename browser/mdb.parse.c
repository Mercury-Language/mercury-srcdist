            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_30_30 = (MR_Word) (&mdb__parse_scalar_common_1[3]);
                  ...
                  {
                    mercury__builtin__compare_3_p_0((MR_Word) (&mdb__parse_scalar_common_1[4]), &Var_6, ((MR_Box) (ArgX2_10)), ((MR_Box) (ArgY2_11)));
                  }
                  succeeded = MR_TRUE;
                }
              }
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_32_32 = (MR_Word) (&mdb__parse_scalar_common_1[4]);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        {
                          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__parse_scalar_common_1[4]), &Var_6, ((MR_Box) (ArgX3_22)), ((MR_Box) (ArgY3_23)));
                        }
                      }
                      succeeded = MR_TRUE;
                    }
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_43_43 = (MR_Word) (&mdb__parse_scalar_common_1[3]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_43_43, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
              if (succeeded)
              {
                TypeInfo_44_44 = (MR_Word) (&mdb__parse_scalar_common_1[4]);
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_41_41 = (MR_Word) (&mdb__parse_scalar_common_1[4]);
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_45_45 = (MR_Word) (&mdb__parse_scalar_common_1[4]);
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__parse_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (Var_16)), ((MR_Box) (ArgY1_11)));
      }
      else
        *HeadVar__1_1 = (MR_Integer) 2;
    }
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdb__parse_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY1_5)));
      }
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) (&mdb__parse_scalar_common_1[1]);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_10_10 = (MR_Word) (&mdb__parse_scalar_common_1[1]);
                        ...
                        if (succeeded)
                        {
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = (RemainingTokens_130 != (MR_Word) ((MR_Unsigned) 0U));
                              if (succeeded)
                              {
