...
{
  {
    ...
    switch (MR_tag((MR_Word) Result_6)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *Command_4 = (MR_Word) ((MR_Integer) 24);
        break;
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
            ...
            *Command_4 = (MR_Word) ((MR_Integer) 32);
        }
        break;
      case (MR_Integer) 2:
        *Command_4 = (MR_Word) ((MR_Integer) 32);
...
{
  {
    ...
    if (succeeded)
      ...
      *Command_6 = (MR_Word) ((MR_Integer) 32);
  }
}
...
{
  {
    ...
    if ((Words_3 == (MR_Word) ((MR_Integer) 0)))
    {
      *Command_4 = (MR_Word) ((MR_Integer) 28);
      succeeded = MR_TRUE;
    }
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeArgWords_7 == (MR_Word) ((MR_Integer) 0)))
      {
        MaybeMaybeOptionTable_9 = (MR_Word) ((MR_Integer) 0);
      ...
      if ((RemainingTokens_10 == (MR_Word) ((MR_Integer) 0)))
      {
        MaybePath_15 = (MR_Word) ((MR_Integer) 0);
        succeeded = MR_TRUE;
      }
      else
      {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = (ArgTokens_6 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
          *Command_8 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            *Command_8 = (MR_Word) ((MR_Integer) 4);
            succeeded = MR_TRUE;
          }
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
            {
              MaybePath_100 = (MR_Word) ((MR_Integer) 0);
              succeeded = MR_TRUE;
            }
            else
            {
          ...
          else
          {
            ...
            {
              if ((CmdToken_5 == (MR_Word) ((MR_Integer) 16)))
                succeeded = MR_TRUE;
              else
              ...
              if (succeeded)
                if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
                {
                  *Command_8 = (MR_Word) ((MR_Integer) 8);
                  succeeded = MR_TRUE;
                }
                else
                {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    *Command_8 = (MR_Word) ((MR_Integer) 12);
                    succeeded = MR_TRUE;
                  }
                }
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
                    {
                      ...
                      MaybePath_111 = (MR_Word) ((MR_Integer) 0);
                      succeeded = MR_TRUE;
                    }
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if ((TailArgTokens_31 == (MR_Word) ((MR_Integer) 0)))
                        {
                          MaybePath_111 = (MR_Word) ((MR_Integer) 0);
                          succeeded = MR_TRUE;
                        }
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                      if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
                      {
                        *Command_8 = (MR_Word) ((MR_Integer) 16);
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
                        {
                          FormatCmd_36 = (MR_Word) ((MR_Integer) 0);
                          succeeded = MR_TRUE;
                        }
                        else
                        {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if ((ArgTokens_6 == (MR_Word) ((MR_Integer) 0)))
                          {
                            FormatCmd_147 = (MR_Word) ((MR_Integer) 0);
                            succeeded = MR_TRUE;
                          }
                          else
                          {
                        ...
                        {
                          succeeded = (CmdToken_5 == (MR_Word) ((MR_Integer) 20));
                          if (succeeded)
                          {
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              {
                                if ((CmdToken_5 == (MR_Word) ((MR_Integer) 12)))
                                  succeeded = MR_TRUE;
                                else
                                if (((MR_tag((MR_Word) CmdToken_5)) == (MR_mktag((MR_Integer) 2))))
                                {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    *Command_8 = (MR_Word) ((MR_Integer) 20);
                                    succeeded = MR_TRUE;
                                  }
                                }
                                else
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        *Command_8 = (MR_Word) ((MR_Integer) 24);
                                        succeeded = MR_TRUE;
                                      }
                                    }
                                  }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Token_3 == (MR_Word) ((MR_Integer) 8));
      if (succeeded)
      {
        MR_Word Dirs_6;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mdb__parse__lexer_word_chars_2_p_0(Cs_28, &Toks2_30);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__2_2 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 4));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mdb__parse__lexer_word_chars_2_p_0(Cs_4, &Toks2_6);
          {
            ...
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__2_2 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 8));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mdb__parse__lexer_word_chars_2_p_0(Cs_4, &Toks2_16);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__2_2 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 12));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              mdb__parse__lexer_word_chars_2_p_0(Cs_4, &Toks2_17);
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *HeadVar__2_2 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 16));
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                mdb__parse__lexer_word_chars_2_p_0(Cs_4, &Toks2_18);
                {
                  ...
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__2_2 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 20));
