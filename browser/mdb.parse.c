...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        {
          {
            MaybePath_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              {
                {
                  MaybePath_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          {
                            {
                              MaybePath_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    {
                      {
                        ...
                        *Command_8 = base;
                        ...
                        MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) (((((MR_Unsigned) (HowTrack_29) << 1)) | (MR_Unsigned) (AssertInvalid_28)));
                      ...
                      if (succeeded)
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            {
                              {
                                FormatCmd_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    {
                                      FormatCmd_147 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  {
                                    FormatCmd_151 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    {
                                      Var_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
