  ...
  MR_Word HeadVar__2_67)
{
  ...
  {
    MR_Word Term_72;
    MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_67, (MR_Integer) 0))));

    Term_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_82, (MR_Integer) 1))));
    if (((MR_tag((MR_Word) Term_72)) == (MR_Integer) 1))
      HeadVar__3_68 = (MR_Integer) 0;
    else
