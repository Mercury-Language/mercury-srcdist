...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Limit_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((MaybeFunctorArityArgs_57 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        SizedTerm1_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      switch (Exact_68) {
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
            SizedTerm1_50 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if ((MaybeFunctorArityArgs_19 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        SizedTerm1_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      switch (Exact_30) {
        ...
        case (MR_Integer) 1:
          {
            SizedTerm1_11 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            NewHeadArg_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((MaybeFunctorArityArgs_64 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            Size_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  Size_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  Size_99 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          MaybeArgSize_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
