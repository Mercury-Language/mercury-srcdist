...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Term_75)) == (MR_Integer) 1))
        HeadVar__3_68 = (MR_Integer) 0;
      else
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) NewArgs_13)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) OldSizeTerm_7)) == (MR_Integer) 1))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) Result_37)) == (MR_Integer) 1);
            if (succeeded)
            {
