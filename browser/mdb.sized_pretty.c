...
static /* final */ const MR_Box mdb__sized_pretty_scalar_common_7[1][3];
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
          HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &mdb__sized_pretty_scalar_common_3[1]));
        else
          {
...
mdb__sized_pretty__ClassMethod_for_mdb__sized_pretty__measure____mdb__sized_pretty__size_count__arity0______mdb__sized_pretty__zero_measure_0_0_f_0(void)
{
  return (MR_Word) (MR_mkword(MR_mktag(1), &mdb__sized_pretty_scalar_common_3[1]));
}
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&mdb__sized_pretty_scalar_common_5[1]));
        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (&mdb__sized_pretty_scalar_common_5[0]));
