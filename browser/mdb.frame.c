  ...
  MR_Word RightFrame_5)
{
  ...
  MaxLen_35 = ((MR_Integer) (conv2_MaxLen_35));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&mdb__frame_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (mdb__frame__hglue_2_f_0_3));
    MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (MaxLen_35));
  }
