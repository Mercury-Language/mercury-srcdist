...
MR_decl_label4(fn__mdb__frame__hglue_2_0, 17,19,20,23)
...
MR_BEGIN_MODULE(mdb__frame_module4)
	...
	MR_init_label4(fn__mdb__frame__hglue_2_0,17,19,20,23)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__frame__hglue_2_0,20)
	...
	MR_np_call_localret_ent(list__map_3_0,
		fn__mdb__frame__hglue_2_0_i23);
MR_def_label(fn__mdb__frame__hglue_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
