...
{
  {
    ...
    {
      mdb__frame__Var_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__frame__Var_9, 0) = ((MR_Box) (&mdb__frame_scalar_common_4[2]));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_9, 1) = ((MR_Box) (mdb__frame__clip_2_f_0_1));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_9, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_9, 3) = ((MR_Box) (mdb__frame__X_4));
    }
    {
      mercury__list__map_3_p_0(mdb__frame__TypeCtorInfo_10_10, mdb__frame__TypeCtorInfo_10_10, mdb__frame__Var_9, mdb__frame__YClippedFrame_8, &mdb__frame__ClippedFrame_7);
    }
...
{
  {
    ...
    MR_Word mdb__frame__Var_55;
    MR_Word mdb__frame__Var_57;
    ...
    {
      mdb__frame__Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), mdb__frame__Var_55, 0) = ((MR_Box) (&mdb__frame_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_55, 1) = ((MR_Box) (mdb__frame__hglue_2_f_0_3));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_55, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), mdb__frame__Var_55, 3) = ((MR_Box) (mdb__frame__MaxLen_48));
    }
    {
      mercury__list__map_3_p_0(mdb__frame__TypeCtorInfo_19_60, mdb__frame__TypeCtorInfo_19_60, mdb__frame__Var_55, mdb__frame__Lengths_46, &mdb__frame__Paddings_49);
    }
    {
      mdb__frame__Var_57 = mercury__assoc_list__from_corresponding_lists_2_f_0(mdb__frame__TypeCtorInfo_18_59, mdb__frame__TypeCtorInfo_19_60, mdb__frame__LeftFrameNew_11, mdb__frame__Paddings_49);
    }
    {
      mercury__list__map_3_p_0((MR_Word) &mdb__frame_scalar_common_1[0], mdb__frame__TypeCtorInfo_18_59, (MR_Word) &mdb__frame_scalar_common_1[6], mdb__frame__Var_57, &mdb__frame__PaddedLeftFrameNew_12);
    }
