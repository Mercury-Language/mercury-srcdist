...
MR_decl_label10(fn__mdb__frame__hglue_2_0, 2,3,5,6,4,9,10,8,14,15)
MR_decl_label4(fn__mdb__frame__hglue_2_0, 17,19,20,22)
MR_decl_label1(fn__mdb__frame__hsize_1_0, 3)
...
MR_BEGIN_MODULE(mdb__frame_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__hsize_1_0);
	MR_init_label1(fn__mdb__frame__hsize_1_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'hsize'/2 mode 0 */
...
MR_define_entry(mercury__fn__mdb__frame__hsize_1_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__mdb__frame__hsize_1_0_i3);
MR_def_label(fn__mdb__frame__hsize_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mdb__frame_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__vsize_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'vsize'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__frame_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__from_string_1_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__frame_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__vglue_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'vglue'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__frame_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__hglue_2_0);
	MR_init_label10(fn__mdb__frame__hglue_2_0,2,3,5,6,4,9,10,8,14,15)
	MR_init_label4(fn__mdb__frame__hglue_2_0,17,19,20,22)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'hglue'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__mdb__frame__hglue_2_0,3)
	...
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = ((MR_Integer) MR_tempr2 - (MR_Integer) MR_tempr1);
...
MR_def_label(fn__mdb__frame__hglue_2_0,6)
	...
	MR_GOTO_LAB(fn__mdb__frame__hglue_2_0_i14);
MR_def_label(fn__mdb__frame__hglue_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r1 >= (MR_Integer) MR_sv(3))) {
		MR_GOTO_LAB(fn__mdb__frame__hglue_2_0_i8);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(3);
...
MR_def_label(fn__mdb__frame__hglue_2_0,9)
	...
	MR_np_call_localret_ent(list__append_3_1,
		fn__mdb__frame__hglue_2_0_i10);
MR_def_label(fn__mdb__frame__hglue_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_sv(2);
	MR_r4 = MR_r1;
...
MR_def_label(fn__mdb__frame__hglue_2_0,15)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		fn__mdb__frame__hglue_2_0_i17);
MR_def_label(fn__mdb__frame__hglue_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__map_3_0,
		fn__mdb__frame__hglue_2_0_i19);
MR_def_label(fn__mdb__frame__hglue_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__assoc_list__from_corresponding_lists_2_0,
		fn__mdb__frame__hglue_2_0_i20);
MR_def_label(fn__mdb__frame__hglue_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__map_3_0,
		fn__mdb__frame__hglue_2_0_i22);
MR_def_label(fn__mdb__frame__hglue_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mdb__frame_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdb__frame__clip_2_0);
	MR_init_label1(fn__mdb__frame__clip_2_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'clip'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__frame_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__frame__add_right_padding_2_0);
	MR_init_label2(mdb__frame__add_right_padding_2_0,2,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_right_padding'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__frame_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__frame__subtract_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__frame_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdb__frame__left_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'left'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdb__frame_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__frame__clip_rect_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__frame_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__frame__clip_rect_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__frame_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdb__frame__frame_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__frame_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdb__frame__frame_0_0);
MR_BEGIN_CODE
...
void mercury__mdb__frame__init_threadscope_string_table(void);
#endif
...
void mercury__mdb__frame__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__frame);
