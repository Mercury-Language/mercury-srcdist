...
{
  {
    ...
    mercury__list__take_upto_3_p_0(TypeCtorInfo_10_10, Y_5, Frame_6, &YClippedFrame_8);
    {
    ...
    mercury__list__map_3_p_0(TypeCtorInfo_10_10, TypeCtorInfo_10_10, Var_9, YClippedFrame_8, &ClippedFrame_7);
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_9_37 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      MR_Integer PadLines_9 = (LVSize_8 - RVSize_7);
      MR_Word Padding_35;

      mercury__list__duplicate_3_p_0(TypeCtorInfo_9_37, PadLines_9, ((MR_Box) ((MR_String) "")), &Padding_35);
      mercury__list__append_3_p_1(TypeCtorInfo_9_37, RightFrame_5, Padding_35, &RightFrameNew_10);
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word TypeCtorInfo_9_43 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        MR_Integer PadLines_20 = (RVSize_7 - LVSize_8);
        MR_Word Padding_41;

        mercury__list__duplicate_3_p_0(TypeCtorInfo_9_43, PadLines_20, ((MR_Box) ((MR_String) "")), &Padding_41);
        mercury__list__append_3_p_1(TypeCtorInfo_9_43, LeftFrame_4, Padding_41, &LeftFrameNew_11);
    ...
    TypeCtorInfo_18_59 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    TypeCtorInfo_19_60 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
    Lengths_46 = mercury__list__map_2_f_0(TypeCtorInfo_18_59, TypeCtorInfo_19_60, (MR_Word) &mdb__frame_scalar_common_1[4], LeftFrameNew_11);
    mercury__list__foldl_4_p_0(TypeCtorInfo_19_60, TypeCtorInfo_19_60, (MR_Word) &mdb__frame_scalar_common_1[5], Lengths_46, ((MR_Box) ((MR_Integer) 0)), &conv2_MaxLen_48);
    ...
    mercury__list__map_3_p_0(TypeCtorInfo_19_60, TypeCtorInfo_19_60, Var_55, Lengths_46, &Paddings_49);
    Var_57 = mercury__assoc_list__from_corresponding_lists_2_f_0(TypeCtorInfo_18_59, TypeCtorInfo_19_60, LeftFrameNew_11, Paddings_49);
    mercury__list__map_3_p_0((MR_Word) &mdb__frame_scalar_common_1[0], TypeCtorInfo_18_59, (MR_Word) &mdb__frame_scalar_common_1[6], Var_57, &PaddedLeftFrameNew_12);
    TypeCtorInfo_25_25 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    mdb__util__zip_with_4_p_0(TypeCtorInfo_25_25, TypeCtorInfo_25_25, TypeCtorInfo_25_25, (MR_Word) &mdb__frame_scalar_common_1[7], PaddedLeftFrameNew_12, RightFrameNew_10, &GluedFrame_6);
    return GluedFrame_6;
  }
}
...
{
  {
    ...
    Lengths_5 = mercury__list__map_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, TypeCtorInfo_15_15, (MR_Word) &mdb__frame_scalar_common_1[2], Frame_3);
    mercury__list__foldl_4_p_0(TypeCtorInfo_15_15, TypeCtorInfo_15_15, (MR_Word) &mdb__frame_scalar_common_1[3], Lengths_5, ((MR_Box) ((MR_Integer) 0)), &conv2_HSize_4);
