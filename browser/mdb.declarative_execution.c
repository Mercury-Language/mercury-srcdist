...
MR_decl_label5(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0, 41,9,11,10,2)
...
;}
#line 1818 "mdb.declarative_execution.c"
...
;}
#line 1873 "mdb.declarative_execution.c"
...
;}
#line 1917 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__declarative_execution_module8)
	...
	MR_init_label5(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0,41,9,11,10,2)
MR_BEGIN_CODE
...
;}
#line 1968 "mdb.declarative_execution.c"
...
if (!MercurySuccessIndicator) MR_GOTO_LAB(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0_i41);
...
MR_def_label(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
	...
	MR_np_call_localret_ent(fn__mdbcomp__rtti_access__proc_bytecode_bytes_1_0,
		mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0_i9);
MR_def_label(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(mdbcomp__program_representation__trace_read_proc_defn_rep_3_0,
		mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0_i11);
MR_def_label(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdb__declarative_execution__call_node_maybe_proc_defn_rep_2_0_i10);
	}
	{
	const MR_ProcLayout *	ProcLayout;
	MR_Word	ProcDefnRep;
...
#line 1251 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4296 "mdb.declarative_execution.c"
	MR_r1 = Id;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 1251 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4330 "mdb.declarative_execution.c"
	MR_r2 = Id;
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
...
#line 1400 "declarative_execution.m"
    ...
    N2 = N1;
;}
#line 4519 "mdb.declarative_execution.c"
	MR_tempr1 = N2;
#undef	MR_PROC_LABEL
	}
	MR_r2 = MR_r1;
