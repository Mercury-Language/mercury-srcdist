...
;}
#line 1924 "mdb.declarative_execution.c"
...
;}
#line 1971 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
;}
#line 2058 "mdb.declarative_execution.c"
...
#line 602 "declarative_execution.m"
    ...
    MR_insert_proc_defn_rep(ProcLayout, ProcDefnRep);
;}
#line 2102 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
...
#line 1316 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4729 "mdb.declarative_execution.c"
	MR_r1 = Id;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 1465 "declarative_execution.m"
    ...
    N2 = N1;
;}
#line 4960 "mdb.declarative_execution.c"
	MR_tempr1 = N2;
#undef	MR_PROC_LABEL
	}
	MR_tempr2 = MR_r1;
...
#line 897 "declarative_execution.m"
    ...
    SUCCESS_INDICATOR = (Id != (MR_Word) NULL);
;}
#line 8390 "mdb.declarative_execution.c"
