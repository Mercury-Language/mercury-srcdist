...
#line 96 "../mdbcomp/mdbcomp.rtti_access.int"
...
MR_decl_label10(mdb__declarative_execution__node_map_4_0, 88,6,8,9,10,11,12,13,14,15)
MR_decl_label2(mdb__declarative_execution__node_map_4_0, 16,3)
...
MR_decl_label5(mdb__declarative_execution__trace_node_call_3_0, 3,5,4,6,1)
MR_decl_label2(mdb__declarative_execution__trace_node_first_disj_2_0, 3,1)
MR_decl_label4(mdb__declarative_execution__trace_node_seqno_3_0, 25,4,6,1)
...
MR_decl_label6(fn__mdb__declarative_execution__call_node_set_last_interface_2_0, 2,6,7,10,11,12)
MR_decl_label6(fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0, 2,7,8,11,12,13)
MR_decl_label6(fn__mdb__declarative_execution__cond_node_set_status_2_0, 2,6,7,10,11,12)
...
MR_decl_label9(fn__mdb__declarative_execution__find_prev_contour_store_2_0, 2,6,9,8,11,10,12,15,4)
...
MR_decl_label6(fn__mdb__declarative_execution__neg_node_set_status_2_0, 2,6,7,10,11,12)
...
MR_decl_label4(__Compare___mdb__declarative_execution__trace_atom_0_0, 3,2,5,27)
MR_decl_label5(__Compare___mdb__declarative_execution__trace_atom_arg_0_0, 3,2,5,9,38)
...
MR_decl_label8(__Compare___mdb__declarative_execution__trace_node_1_0, 260,253,269,266,276,280,772,773)
...
{
MR_CTOR1_ADDR(maybe, maybe),
MR_CTOR0_ADDR(mdbcomp__rtti_access, label_layout)
}
},
};
...
;}
#line 1891 "mdb.declarative_execution.c"
...
;}
#line 1949 "mdb.declarative_execution.c"
...
;}
#line 2050 "mdb.declarative_execution.c"
...
#line 602 "declarative_execution.m"
    ...
    MR_insert_proc_defn_rep(ProcLayout, ProcDefnRep);
;}
#line 2127 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module26)
	...
	MR_init_label10(mdb__declarative_execution__node_map_4_0,88,6,8,9,10,11,12,13,14,15)
	MR_init_label2(mdb__declarative_execution__node_map_4_0,16,3)
MR_BEGIN_CODE
...
MR_def_static(mdb__declarative_execution__node_map_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(mdb__declarative_execution__node_map_4_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(mdb__declarative_execution__node_map_4_0,6)
	...
	if (MR_PTAG_TESTR(MR_sv(2),0)) {
		MR_GOTO_LAB(mdb__declarative_execution__node_map_4_0_i8);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(mdb__declarative_execution__node_map_4_0_i88);
	}
MR_def_label(mdb__declarative_execution__node_map_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__declarative_execution_module37)
	...
	MR_init_label6(fn__mdb__declarative_execution__call_node_set_last_interface_2_0,2,6,7,10,11,12)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__declarative_execution__call_node_set_last_interface_2_0,7)
	...
	MR_np_call_localret_ent(store__new_ref_4_0,
		fn__mdb__declarative_execution__call_node_set_last_interface_2_0_i10);
MR_def_label(fn__mdb__declarative_execution__call_node_set_last_interface_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module38)
	...
	MR_init_label6(fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0,2,7,8,11,12,13)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0,8)
	...
	MR_np_call_localret_ent(store__new_ref_4_0,
		fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0_i11);
MR_def_label(fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	...
	MR_r5 = (MR_Integer) 5;
	MR_np_call_localret_ent(store__arg_ref_5_0,
		fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0_i12);
MR_def_label(fn__mdb__declarative_execution__call_node_update_implicit_tree_info_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mdb__declarative_execution_module40)
	...
	MR_init_label6(fn__mdb__declarative_execution__cond_node_set_status_2_0,2,6,7,10,11,12)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__declarative_execution__cond_node_set_status_2_0,7)
	...
	MR_np_call_localret_ent(store__new_ref_4_0,
		fn__mdb__declarative_execution__cond_node_set_status_2_0_i10);
MR_def_label(fn__mdb__declarative_execution__cond_node_set_status_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module41)
	...
	MR_init_label6(fn__mdb__declarative_execution__neg_node_set_status_2_0,2,6,7,10,11,12)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__declarative_execution__neg_node_set_status_2_0,7)
	...
	MR_np_call_localret_ent(store__new_ref_4_0,
		fn__mdb__declarative_execution__neg_node_set_status_2_0_i10);
MR_def_label(fn__mdb__declarative_execution__neg_node_set_status_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_execution, goal_status);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module44)
	...
	MR_init_label5(mdb__declarative_execution__trace_node_call_3_0,3,5,4,6,1)
MR_BEGIN_CODE
...
MR_def_label(mdb__declarative_execution__trace_node_call_3_0,3)
	...
	MR_np_call_localret_ent(mdb__declarative_execution__exit_node_from_id_3_0,
		mdb__declarative_execution__trace_node_call_3_0_i5);
...
MR_def_label(mdb__declarative_execution__trace_node_call_3_0,4)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(mdb__declarative_execution__trace_node_call_3_0_i6);
	}
...
MR_BEGIN_MODULE(mdb__declarative_execution_module45)
	...
	MR_init_label4(mdb__declarative_execution__trace_node_seqno_3_0,25,4,6,1)
MR_BEGIN_CODE
...
MR_def_static(mdb__declarative_execution__trace_node_seqno_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(mdb__declarative_execution__trace_node_seqno_3_0_i25);
	}
	MR_r2 = MR_tfield(0, MR_r2, 3);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdb__declarative_execution__trace_node_seqno_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
#line 1316 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4753 "mdb.declarative_execution.c"
	MR_r1 = Id;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__declarative_execution_module49)
	...
	MR_init_label9(fn__mdb__declarative_execution__find_prev_contour_store_2_0,2,6,9,8,11,10,12,15,4)
MR_BEGIN_CODE
...
MR_def_label(fn__mdb__declarative_execution__find_prev_contour_store_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(fn__mdb__declarative_execution__find_prev_contour_store_2_0_i6);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(mdb__declarative_execution__call_node_from_id_3_0,
		fn__mdb__declarative_execution__find_prev_contour_store_2_0_i11);
MR_def_label(fn__mdb__declarative_execution__find_prev_contour_store_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,10)) {
		MR_GOTO_LAB(fn__mdb__declarative_execution__find_prev_contour_store_2_0_i8);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__mdb__declarative_execution__find_prev_contour_store_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(fn__mdb__declarative_execution__find_prev_contour_store_2_0_i10);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__mdb__declarative_execution__find_prev_contour_store_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__mdb__declarative_execution__find_prev_contour_store_2_0_i12);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_debugger, diagnoser_exception);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,2,25);
...
MR_def_label(fn__mdb__declarative_execution__find_prev_contour_store_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(fn__mdb__declarative_execution__find_prev_contour_store_2_0_i15);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdb__declarative_debugger, diagnoser_exception);
...
#line 1465 "declarative_execution.m"
    ...
    N2 = N1;
;}
#line 4984 "mdb.declarative_execution.c"
	MR_tempr1 = N2;
#undef	MR_PROC_LABEL
	}
	MR_tempr2 = MR_r1;
...
MR_BEGIN_MODULE(mdb__declarative_execution_module81)
	...
	MR_init_label4(__Compare___mdb__declarative_execution__trace_atom_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_execution__trace_atom_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_execution__trace_atom_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___mdb__declarative_execution__trace_atom_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdb__declarative_execution_module83)
	...
	MR_init_label5(__Compare___mdb__declarative_execution__trace_atom_arg_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_execution__trace_atom_arg_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_execution__trace_atom_arg_0_0_i38);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___mdb__declarative_execution__trace_atom_arg_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___mdb__declarative_execution__trace_atom_arg_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdb__declarative_execution_module86)
	...
	MR_init_label8(__Compare___mdb__declarative_execution__trace_node_1_0,260,253,269,266,276,280,772,773)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdb__declarative_execution__trace_node_1_0,7)
	...
	if (MR_PTAG_TESTR(MR_sv(17),0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_execution__trace_node_1_0_i772);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6;
	MR_tempr5 = MR_sv(17);
...
MR_def_label(__Compare___mdb__declarative_execution__trace_node_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdb__declarative_execution__trace_node_1_0_i773);
	}
	MR_r1 = MR_sv(19);
	MR_r2 = MR_sv(16);
	MR_r3 = MR_sv(11);
...
MR_def_label(__Compare___mdb__declarative_execution__trace_node_1_0,280)
	...
	MR_decr_sp(20);
	MR_np_tailcall_ent(__Compare___mdbcomp__rtti_access__label_layout_0_0);
MR_def_label(__Compare___mdb__declarative_execution__trace_node_1_0,772)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(20);
	MR_decr_sp(20);
	MR_np_tailcall_ent(private_builtin__compare_error_0_0);
MR_def_label(__Compare___mdb__declarative_execution__trace_node_1_0,773)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(20);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__mdb__declarative_execution__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdb__declarative_execution);
