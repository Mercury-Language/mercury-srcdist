...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_execution_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_11_11 = (MR_Word) (&mdb__declarative_execution_scalar_common_1[5]);
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              mercury__builtin__compare_3_p_0((MR_Word) (&mdb__declarative_execution_scalar_common_1[4]), &SubResult7_24, ((MR_Box) (Var_1799)), ((MR_Box) (ArgY7_23)));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeInfo_130_130 = (MR_Word) (&mdb__declarative_execution_scalar_common_1[4]);
