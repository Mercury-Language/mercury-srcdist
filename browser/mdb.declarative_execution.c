...
MR_decl_label3(mdb__declarative_execution__absolute_arg_num_3_0, 23,5,3)
...
MR_decl_label7(mdb__declarative_execution__load_trace_node_map_5_0, 2,7,10,3,13,18,21)
...
MR_decl_label4(mdb__declarative_execution__select_arg_at_pos_3_0, 8,4,5,3)
MR_decl_label5(mdb__declarative_execution__trace_node_call_3_0, 8,4,10,5,1)
...
MR_decl_label3(mdb__declarative_execution__user_arg_num_3_0, 24,6,3)
...
MR_decl_label8(fn__mdb__declarative_execution__find_prev_contour_store_2_0, 3,7,23,10,13,14,15,18)
...
;}
#line 1823 "mdb.declarative_execution.c"
...
{
#line 551 "declarative_execution.m"
...
;}
#line 1878 "mdb.declarative_execution.c"
...
#define	MR_PROC_LABEL	mercury__mdb__declarative_execution__cache_proc_defn_rep_2_0
	...
	ProcDefnRep = MR_r2;
{
#line 574 "declarative_execution.m"
...
;}
#line 1922 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#line 574 "declarative_execution.m"
    ...
    MR_insert_proc_defn_rep(ProcLayout, ProcDefnRep);
;}
#line 2054 "mdb.declarative_execution.c"
#undef	MR_PROC_LABEL
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module22)
	...
	MR_init_label7(mdb__declarative_execution__load_trace_node_map_5_0,2,7,10,3,13,18,21)
MR_BEGIN_CODE
...
#define SUCCESS_INDICATOR MercurySuccessIndicator
	Id = MR_r2;
{
#line 869 "declarative_execution.m"

    Node = Id;
    SUCCESS_INDICATOR = (Id != (MR_Word) NULL);
;}
#line 2989 "mdb.declarative_execution.c"
...
#line 1424 "declarative_execution.m"
    ...
    Key = (MR_Integer) Id;
;}
#line 3029 "mdb.declarative_execution.c"
	MR_r1 = Key;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
MR_BEGIN_MODULE(mdb__declarative_execution_module31)
	...
	MR_init_label4(mdb__declarative_execution__select_arg_at_pos_3_0,8,4,5,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdb__declarative_execution_module33)
	...
	MR_init_label3(mdb__declarative_execution__absolute_arg_num_3_0,23,5,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__declarative_execution__absolute_arg_num_3_0);
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(mdb__declarative_execution__absolute_arg_num_3_0_i23);
	}
	MR_tempr2 = MR_tempr3;
...
MR_def_label(mdb__declarative_execution__absolute_arg_num_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(mdb__declarative_execution_module35)
	...
	MR_init_label3(mdb__declarative_execution__user_arg_num_3_0,24,6,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdb__declarative_execution__user_arg_num_3_0);
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(mdb__declarative_execution__user_arg_num_3_0_i24);
	}
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_proceed();
	}
MR_def_label(mdb__declarative_execution__user_arg_num_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(2, MR_r1, 0);
...
MR_BEGIN_MODULE(mdb__declarative_execution_module44)
	...
	MR_init_label5(mdb__declarative_execution__trace_node_call_3_0,8,4,10,5,1)
MR_BEGIN_CODE
...
MR_def_static(mdb__declarative_execution__trace_node_call_3_0)
	...
	MR_tempr3 = MR_r2;
	MR_r2 = MR_tempr2;
	MR_r3 = MR_ctfield(2, MR_tempr3, 1);
	}
	MR_np_call_localret_ent(mdb__declarative_execution__exit_node_from_id_3_0,
...
#line 1288 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4355 "mdb.declarative_execution.c"
	MR_r1 = Id;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 1288 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4389 "mdb.declarative_execution.c"
	MR_r2 = Id;
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
...
MR_BEGIN_MODULE(mdb__declarative_execution_module49)
	...
	MR_init_label8(fn__mdb__declarative_execution__find_prev_contour_store_2_0,3,7,23,10,13,14,15,18)
...
#line 1288 "declarative_execution.m"
    ...
    Id = (MR_Word) NULL;
;}
#line 4639 "mdb.declarative_execution.c"
	MR_tempr1 = Id;
#undef	MR_PROC_LABEL
	}
...
#line 869 "declarative_execution.m"
    ...
    SUCCESS_INDICATOR = (Id != (MR_Word) NULL);
;}
#line 7840 "mdb.declarative_execution.c"
