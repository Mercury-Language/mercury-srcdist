...
{
  {
      ...
      Var_9 = (MR_Integer) 1;
    {
      ...
      MR_hl_field(MR_mktag(0), Arg_8, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      MR_Word base;
...
{
  {
    ...
    switch (AtMaxDepth_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeImplicitTreeInfo_21 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeImplicitTreeInfo_5 == (MR_Word) ((MR_Integer) 0)))
      {
...
#undef MR_PROC_LABEL
      ...
      *MaybeProcDefnRep_4 = (MR_Word) ((MR_Integer) 0);
  }
}
